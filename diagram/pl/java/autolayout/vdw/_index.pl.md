...
{{% blocks/products/pf/agp/content h2="Jak automatycznie układać plik VDW za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dla plików VDW z automatycznym układem w Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Pliki VDW z automatycznym układem — Java" offSpacer="" %}}
