...
{{% blocks/products/pf/agp/content h2="Jak automatycznie układać plik VSX przy użyciu Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki automatycznego układu VSX Pliki w Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Układ automatyczny VSX Pliki — Java" offSpacer="" %}}
