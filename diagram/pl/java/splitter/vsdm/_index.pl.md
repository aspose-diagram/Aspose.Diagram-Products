...
{{% blocks/products/pf/agp/content h2="Jak podzielić VSDM pliki za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapy dzielenia VSDM plików w Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Podziel pliki VSDM — Java" offSpacer="" %}}
