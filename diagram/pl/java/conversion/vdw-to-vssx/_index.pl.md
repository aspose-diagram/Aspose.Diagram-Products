...
description: Przykładowy kod konwersji Java dla formatu VDW do pliku VSSX. Użyj tego przykładowego kodu, aby przekonwertować VDW na VSSX w dowolnej aplikacji internetowej lub desktopowej Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDW na VSSX za pomocą Java" %}}
...
1. Załaduj plik VDW z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VSSX zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VDW do VSSX Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VDW do VSSX" sectionDescription="[Konwertuj VDW na VSSX](https://products.aspose.app/diagram/conversion/vdw-to-vssx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
