...
description: Przykładowy kod konwersji Java dla formatu VSDX na plik VSX. Użyj tego przykładowego kodu, aby przekonwertować VSDX na VSX w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java programiści mogą łatwo przekonwertować plik VSDX na VSX w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/code-block title="VSDX do VSX Java Kodu źródła konwersji" offSpacer="" %}}
