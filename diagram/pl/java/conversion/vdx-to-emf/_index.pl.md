...
description: Przykładowy kod konwersji Java dla formatu VDX do pliku EMF. Użyj tego przykładowego kodu, aby przekonwertować VDX na EMF w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na EMF przez Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX na EMF Java Kod źródłowy konwersji" offSpacer="" %}}
