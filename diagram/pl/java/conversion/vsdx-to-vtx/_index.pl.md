...
description: Przykładowy kod konwersji Java dla formatu VSDX na plik VTX. Użyj tego przykładowego kodu, aby przekonwertować VSDX na VTX w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java programiści mogą łatwo przekonwertować plik VSDX na VTX w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/code-block title="VSDX do VTX Java Kodu źródła konwersji" offSpacer="" %}}
