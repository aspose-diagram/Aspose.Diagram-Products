...
description: Przykładowy kod konwersji Java dla formatu VSTM do pliku VTX. Użyj tego przykładowego kodu, aby przekonwertować VSTM na VTX w dowolnej aplikacji internetowej lub desktopowej Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTM na VTX za pomocą Java" %}}
...
1. Załaduj plik VSTM z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VTX zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji VSTM do VTX Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VSTM do VTX" sectionDescription="[Konwertuj VSTM na VTX](https://products.aspose.app/diagram/conversion/vstm-to-vtx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
