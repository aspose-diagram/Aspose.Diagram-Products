---
title: Konwertuj VSTM na SWF przez Java 
url: /pl/java/conversion/vstm-to-swf/ 
description: Przykładowy kod konwersji Java dla formatu VSTM do pliku SWF. Użyj tego przykładowego kodu, aby przekonwertować VSTM na SWF w dowolnej aplikacji opartej na sieci Web lub na komputerze Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSTM na SWF przez Java" h2="Natywna biblioteka Java do odczytu, zapisu i eksportu VSTM do SWF bez potrzeby korzystania z Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="Aspose.DIAGRAM" subTitlepfName="" downloadUrl="" fileiconsmall1="SWF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTM na SWF przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.DIAGRAM API ułatwia programistom konwersję pliku VSTM do SWF w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="VSTM do SWF Java Kod źródłowy konwersji" offSpacer="" %}}
