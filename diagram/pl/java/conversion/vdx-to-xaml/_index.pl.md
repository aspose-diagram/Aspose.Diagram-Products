---
title: Konwertuj VDX na XAML przez Java 
weight: 1770
url: /pl/java/conversion/vdx-to-xaml/ 
description: Przykładowy kod konwersji Java dla formatu VDX do pliku XAML. Użyj tego przykładowego kodu, aby przekonwertować VDX na XAML w dowolnej aplikacji opartej na sieci Web lub na komputerze Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VDX na XAML przez Java" h2="Eksportuj Microsoft Visio VDX do XAML przy użyciu natywnej biblioteki Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VDX na XAML przy użyciu Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na XAML za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik VDX na XAML w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/code-block title="VDX do XAML Java Kod źródłowy konwersji" offSpacer="" %}}
