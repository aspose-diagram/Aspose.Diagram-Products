...
description: Przykładowy kod konwersji Java dla formatu VSDX na plik VSDM. Użyj tego przykładowego kodu, aby przekonwertować VSDX na VSDM w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSDX na VSDM przez Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX do VSDM Java Kodu źródła konwersji" offSpacer="" %}}
