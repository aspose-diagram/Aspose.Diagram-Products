...
description: Przykładowy kod konwersji Java dla formatu VSTX na plik VSDX. Użyj tego przykładowego kodu, aby przekonwertować VSTX na VSDX w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSTX na VSDX za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTX na VSDX przez Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTX do VSDX Java Kodu źródła konwersji" offSpacer="" %}}
