---
title: Konwertuj VSTM na VSTX przez Java 
weight: 4750
url: /pl/java/conversion/vstm-to-vstx/ 
description: Przykładowy kod konwersji Java dla formatu VSTM do pliku VSTX. Użyj tego przykładowego kodu, aby przekonwertować VSTM na VSTX w dowolnej aplikacji opartej na sieci Web lub na komputerze Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSTM na VSTX przez Java" h2="Eksportuj Microsoft Visio VSTM do VSTX przy użyciu natywnej biblioteki Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSTM na VSTX za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTM na VSTX za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik VSTM na VSTX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSTM z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VSTX zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Kod źródłowy konwersji VSTM do VSTX Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VSTM do VSTX" sectionDescription="[Konwertuj VSTM na VSTX](https://products.aspose.app/diagram/conversion/vstm-to-vstx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
