...
description: Przykładowy kod konwersji Java dla formatu VSDM do pliku EMF. Użyj tego przykładowego kodu, aby przekonwertować VSDM na EMF w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSDM na EMF przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik VSDM na EMF w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="VSDM na EMF Java Kod źródłowy konwersji" offSpacer="" %}}
