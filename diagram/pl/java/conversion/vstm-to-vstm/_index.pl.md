---
title: Konwertuj VSTM na VSTM przez Java 
url: /pl/java/conversion/vstm-to-vstm/ 
description: Przykładowy kod konwersji Java dla formatu VSTM na plik VSTM. Użyj tego przykładowego kodu, aby przekonwertować VSTM na VSTM w dowolnej aplikacji internetowej lub na komputerze Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSTM na VSTM przez Java" h2="Natywna biblioteka Java do odczytu, zapisu i eksportu VSTM do VSTM bez konieczności korzystania z Adobe." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="Aspose.DIAGRAM" subTitlepfName="" downloadUrl="" fileiconsmall1="VSTM" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTM na VSTM przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.DIAGRAM API ułatwia programistom konwersję pliku VSTM na VSTM w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/code-block title="VSTM do VSTM Java Kodu źródła konwersji" offSpacer="" %}}
