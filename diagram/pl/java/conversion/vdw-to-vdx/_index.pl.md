...
description: Przykładowy kod konwersji Java dla formatu VDW do pliku VDX. Użyj tego przykładowego kodu, aby przekonwertować VDW na VDX w dowolnej aplikacji internetowej lub desktopowej Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDW na VDX za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik VDW na VDX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VDW z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VDX zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VDW do VDX Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VDW do VDX" sectionDescription="[Konwertuj VDW na VDX](https://products.aspose.app/diagram/conversion/vdw-to-vdx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
