...
description: Przykładowy kod konwersji Java dla formatu VDX do pliku BMP. Użyj tego przykładowego kodu, aby przekonwertować VDX na BMP w dowolnej aplikacji opartej na sieci Web lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VDX na BMP przy użyciu Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na BMP przez Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik VDX na BMP w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="VDX na BMP Java Kod źródłowy konwersji" offSpacer="" %}}
