...
description: Przykładowy kod konwersji Java dla formatu VSDM na plik VSDX. Użyj tego przykładowego kodu, aby przekonwertować VSDM na VSDX w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSDM na VSDX za pomocą Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDM do VSDX Java Kodu źródła konwersji" offSpacer="" %}}
