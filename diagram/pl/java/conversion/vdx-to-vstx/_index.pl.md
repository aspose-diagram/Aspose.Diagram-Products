...
description: Przykładowy kod konwersji Java dla formatu VDX na plik VSTX. Użyj tego przykładowego kodu, aby przekonwertować VDX na VSTX w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na VSTX przez Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX do VSTX Java Kodu źródła konwersji" offSpacer="" %}}
