...
description: Przykładowy kod konwersji Java dla formatu VSDX na plik VDX. Użyj tego przykładowego kodu, aby przekonwertować VSDX na VDX w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java programiści mogą łatwo przekonwertować plik VSDX na VDX w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/code-block title="VSDX do VDX Java Kodu źródła konwersji" offSpacer="" %}}
