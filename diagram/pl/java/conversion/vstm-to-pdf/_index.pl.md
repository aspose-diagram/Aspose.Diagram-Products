---
title: Konwertuj VSTM na PDF przez Java 
weight: 1670
url: /pl/java/conversion/vstm-to-pdf/ 
description: Przykładowy kod konwersji Java dla formatu VSTM do pliku PDF. Użyj tego przykładowego kodu, aby przekonwertować VSTM na PDF w dowolnej aplikacji internetowej lub na komputerze Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSTM na PDF przez Java" h2="Eksportuj Microsoft Visio VSTM do pliku PDF przy użyciu rodzimej biblioteki Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTM na PDF za pośrednictwem Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik VSTM na PDF w zaledwie kilku wierszach kodu.
