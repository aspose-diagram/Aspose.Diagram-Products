---
title: Konwertuj VSTM na VSSX przez Java 
weight: 400
url: /pl/java/conversion/vstm-to-vssx/ 
description: Przykładowy kod konwersji Java dla formatu VSTM do pliku VSSX. Użyj tego przykładowego kodu, aby przekonwertować VSTM na VSSX w dowolnej aplikacji opartej na sieci Web lub komputerowej Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSTM na VSSX przez Java" h2="Eksportuj Microsoft Visio VSTM do VSSX przy użyciu natywnej biblioteki Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSTM na VSSX przy użyciu Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTM na VSSX za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik VSTM na VSSX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSTM z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VSSX zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VSTM do VSSX Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VSTM do VSSX" sectionDescription="[Konwertuj VSTM na VSSX](https://products.aspose.app/diagram/conversion/vstm-to-vssx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik VSTM, zostanie on natychmiast przekonwertowany do VSSX." >}}
