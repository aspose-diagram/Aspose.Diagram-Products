...
description: Przykładowy kod konwersji Java dla formatu VSTM do pliku VSX. Użyj tego przykładowego kodu, aby przekonwertować VSTM na VSX w dowolnej aplikacji internetowej lub desktopowej Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTM na VSX za pomocą Java" %}}
...
1. Załaduj plik VSTM z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VSX zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VSTM do VSX Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VSTM do VSX" sectionDescription="[Konwertuj VSTM na VSX](https://products.aspose.app/diagram/conversion/vstm-to-vsx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik VSTM, zostanie on natychmiast przekonwertowany do VSX." >}}
