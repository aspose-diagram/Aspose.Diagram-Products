...
description: Przykładowy kod konwersji Java dla formatu VSTX na plik VSSX. Użyj tego przykładowego kodu, aby przekonwertować VSTX na VSSX w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSTX na VSSX za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTX na VSSX przez Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTX do VSSX Java Kodu źródła konwersji" offSpacer="" %}}
