...
description: Przykładowy kod konwersji Java dla formatu VDX na plik VSDM. Użyj tego przykładowego kodu, aby przekonwertować VDX na VSDM w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na VSDM przez Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX do VSDM Java Kodu źródła konwersji" offSpacer="" %}}
