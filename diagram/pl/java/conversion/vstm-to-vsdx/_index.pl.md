...
description: Przykładowy kod konwersji Java dla formatu VSTM na plik VSDX. Użyj tego przykładowego kodu, aby przekonwertować VSTM na VSDX w dowolnej aplikacji internetowej lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSTM na VSDX za pomocą Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM do VSDX Java Kodu źródła konwersji" offSpacer="" %}}
