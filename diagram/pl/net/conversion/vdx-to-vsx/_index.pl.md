---
title: Konwertuj VDX na VSX przez C# 
weight: 1740
url: /pl/net/conversion/vdx-to-vsx/ 
description: Przykładowy kod konwersji VDX do VSX C#. Użyj przykładowego kodu API dla plików wsadowych VDX do konwersji VSX w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VDX na VSX przez C#" h2="Eksportuj pliki Microsoft® Visio VDX do VSX na .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VDX na VSX za pomocą C#" %}}

 Aby przekonwertować VDX na VSX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na VSX za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VDX do VSX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VDX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSX jako parametrami1. Plik VSX zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję VDX do VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VDX na VSX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VDX do VSX](https://products.aspose.app/diagram/conversion/vdx-to-vsx) z następującymi korzyściami." >}}
