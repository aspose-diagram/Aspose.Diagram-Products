...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSSX na XPS za pomocą C#" %}}
...
1. Załaduj plik VSSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.XPS jako parametrami1. Plik XPS zostanie zapisany pod określoną ścieżką
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSSX na XPS" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VSSX do XPS](https://products.aspose.app/diagram/conversion/vssx-to-xps) z następującymi korzyściami." >}}
