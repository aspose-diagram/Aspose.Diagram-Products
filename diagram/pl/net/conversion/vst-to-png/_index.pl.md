---
title: Konwertuj VST na PNG za pomocą C# 
weight: 5320
url: /pl/net/conversion/vst-to-png/ 
description: Przykładowy kod konwersji VST do PNG C#. Użyj przykładowego kodu API dla wsadowych plików VST do konwersji PNG w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VST na PNG za pomocą C#" h2="Eksportuj pliki Microsoft® Visio VST do PNG w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VST na PNG za pomocą C#" %}}

 Aby przekonwertować VST na PNG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VST na PNG za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VST na PNG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VST z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.PNG jako parametrami1. Plik PNG zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VST do PNG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VST na PNG" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VST do PNG](https://products.aspose.app/diagram/conversion/vst-to-png) z następującymi korzyściami." >}}
