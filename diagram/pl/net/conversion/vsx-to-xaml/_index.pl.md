...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSX na XAML przy użyciu C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSX na XAML za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSX na XAML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.XAML jako parametrami1. Plik XAML zostanie zapisany pod określoną ścieżką
