---
title: Konwertuj VST na VSTM przez C# 
weight: 750
url: /pl/net/conversion/vst-to-vstm/ 
description: Przykładowy kod konwersji VST na VSTM C#. Użyj API przykładowego kodu dla wsadowych plików VST do VSTM konwersji w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VST na VSTM przez C#" h2="Eksportuj pliki Microsoft® Visio VST do VSTM w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VST na VSTM za pomocą C#" %}}

 Aby przekonwertować VST na VSTM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VST na VSTM przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VST do VSTM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VST z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSTM jako parametrami1. VSTM plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje od VST do VSTM C# konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VST na VSTM" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VST do VSTM](https://products.aspose.app/diagram/conversion/vst-to-vstm) z następującymi korzyściami." >}}
