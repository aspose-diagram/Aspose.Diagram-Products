...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VTX na PNG za pomocą C#" %}}
...
1. Załaduj plik VTX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.PNG jako parametrami1. Plik PNG zostanie zapisany pod określoną ścieżką
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VTX na PNG" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VTX do PNG](https://products.aspose.app/diagram/conversion/vtx-to-png) z następującymi korzyściami." >}}
