---
title: Konwertuj VSX na PDF przez C# 
weight: 4360
url: /pl/net/conversion/vsx-to-pdf/ 
description: Przykładowy kod konwersji VSX na PDF C#. Użyj API przykładowego kodu dla plików wsadowych VSX do konwersji PDF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSX na PDF przez C#" h2="Eksportuj pliki Microsoft® Visio VSX do PDF w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSX na PDF za pomocą C#" %}}

 Aby przekonwertować VSX na PDF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSX na PDF za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować VSX pliki do formatu PDF za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.PDF jako parametrami1. Plik PDF zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSX na PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSX na PDF" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VSX do PDF](https://products.aspose.app/diagram/conversion/vsx-to-pdf) z następującymi korzyściami." >}}
