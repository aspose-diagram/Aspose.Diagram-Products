...
description: Przykładowy kod konwersji VTX na SWF C#. Użyj API przykładowego kodu dla plików wsadowych VTX do konwersji SWF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VTX na SWF przez C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VTX do SWF C#" offSpacer="" %}}
