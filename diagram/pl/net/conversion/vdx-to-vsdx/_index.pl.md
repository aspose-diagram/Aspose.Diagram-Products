...
description: Przykładowy kod konwersji VDX na VSDX C#. Użyj API przykładowego kodu dla plików wsadowych VDX do konwersji VSDX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki VDX na VSDX w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VDX do VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VDX na VSDX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VDX do VSDX](https://products.aspose.app/diagram/conversion/vdx-to-vsdx) z następującymi korzyściami." >}}
