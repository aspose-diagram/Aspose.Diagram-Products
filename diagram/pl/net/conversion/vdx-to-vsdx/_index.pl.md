...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VDX na VSDX za pomocą C#" %}}

 Aby przekonwertować VDX na VSDX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na VSDX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VDX na VSDX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VDX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSDX jako parametrami1. VSDX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje VDX do VSDX C# konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VDX na VSDX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VDX do VSDX](https://products.aspose.app/diagram/conversion/vdx-to-vsdx) z następującymi korzyściami." >}}
