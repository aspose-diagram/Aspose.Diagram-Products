...
description: Przykładowy kod konwersji VSX na VSDX C#. Użyj API przykładowego kodu dla plików wsadowych VSX do konwersji VSDX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki VSX na VSDX w zaledwie kilku linijkach kodu.
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VSX do VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSX na VSDX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VSX do VSDX](https://products.aspose.app/diagram/conversion/vsx-to-vsdx) z następującymi korzyściami." >}}
