...
description: Przykładowy kod konwersji VSX na VSDM C#. Użyj API przykładowego kodu dla plików wsadowych VSX do konwersji VSDM w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSX na VSDM przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSX na VSDM w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSDM jako parametrami1. VSDM plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VSX do VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSX na VSDM" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VSX do VSDM](https://products.aspose.app/diagram/conversion/vsx-to-vsdm) z następującymi korzyściami." >}}
