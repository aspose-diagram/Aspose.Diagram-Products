---
title: Konwertuj VST na XAML za pomocą C# 
weight: 4630
url: /pl/net/conversion/vst-to-xaml/ 
description: Przykładowy kod konwersji VST do XAML C#. Użyj przykładowego kodu API dla wsadowych plików VST do konwersji XAML w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VST na XAML za pomocą C#" h2="Eksportuj pliki VST Microsoft® Visio do XAML w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VST na XAML przy użyciu C#" %}}

 Aby przekonwertować VST na XAML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VST na XAML za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VST na XAML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VST z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.XAML jako parametrami1. Plik XAML zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję VST na XAML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VST na XAML" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VST do XAML](https://products.aspose.app/diagram/conversion/vst-to-xaml) z następującymi korzyściami." >}}
