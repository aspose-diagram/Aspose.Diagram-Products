...
description: Przykładowy kod konwersji VSD na VDX C#. Użyj API przykładowego kodu dla plików wsadowych VSD do konwersji VDX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
1. Załaduj plik VSD z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VDX jako parametrami1. VDX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VSD do VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSD na VDX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VSD do VDX](https://products.aspose.app/diagram/conversion/vsd-to-vdx) z następującymi korzyściami." >}}
