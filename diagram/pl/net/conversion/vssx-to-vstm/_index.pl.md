...
description: Przykładowy kod konwersji VSSX na VSTM C#. Użyj API przykładowego kodu dla plików wsadowych VSSX do konwersji VSTM w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSSX na VSTM przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSSX na VSTM w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSTM jako parametrami1. VSTM plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VSSX do VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSSX na VSTM" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VSSX do VSTM](https://products.aspose.app/diagram/conversion/vssx-to-vstm) z następującymi korzyściami." >}}
