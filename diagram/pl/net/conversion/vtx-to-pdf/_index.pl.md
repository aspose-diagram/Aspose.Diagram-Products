---
title: Konwertuj VTX na PDF przez C# 
weight: 1570
url: /pl/net/conversion/vtx-to-pdf/ 
description: Przykładowy kod do konwersji VTX na PDF C#. Użyj przykładowego kodu API dla plików wsadowych VTX do konwersji PDF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VTX na PDF przez C#" h2="Eksportuj pliki Microsoft® Visio VTX do formatu PDF w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VTX na PDF za pomocą C#" %}}

 Aby przekonwertować VTX na PDF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VTX na PDF za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VTX do formatu PDF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VTX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.PDF jako parametrami1. Plik PDF zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję VTX do PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VTX na PDF" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VTX do PDF](https://products.aspose.app/diagram/conversion/vtx-to-pdf) z następującymi korzyściami." >}}
