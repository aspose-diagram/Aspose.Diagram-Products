---
title: Konwertuj VST na VTX przez C# 
weight: 1380
url: /pl/net/conversion/vst-to-vtx/ 
description: Przykładowy kod konwersji VST na VTX C#. Użyj API przykładowego kodu dla wsadowych plików VST do VTX konwersji w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VST na VTX przez C#" h2="Eksportuj pliki Microsoft® Visio VST do VTX w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VST na VTX za pomocą C#" %}}

 Aby przekonwertować VST na VTX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VST na VTX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VST do VTX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VST z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VTX jako parametrami1. VTX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje od VST do VTX C# konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VST na VTX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VST do VTX](https://products.aspose.app/diagram/conversion/vst-to-vtx) z następującymi korzyściami." >}}
