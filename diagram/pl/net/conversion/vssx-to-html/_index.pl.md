---
title: Konwertuj VSSX na HTML przez C# 
weight: 4240
url: /pl/net/conversion/vssx-to-html/ 
description: Przykładowy kod konwersji VSSX na HTML C#. Użyj API przykładowego kodu dla plików wsadowych VSSX do konwersji HTML w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSSX na HTML przez C#" h2="Eksportuj pliki Microsoft® Visio VSSX do HTML na .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSSX na HTML za pomocą C#" %}}

 Aby przekonwertować VSSX na HTML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSSX na HTML za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSSX na HTML za pomocą zaledwie kilku linijek kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.HTML jako parametrami1. Plik HTML zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSSX na HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSSX na HTML" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VSSX do HTML](https://products.aspose.app/diagram/conversion/vssx-to-html) z następującymi korzyściami." >}}
