...
description: Przykładowy kod konwersji VSD na VSTX C#. Użyj API przykładowego kodu dla plików wsadowych VSD do konwersji VSTX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki VSD na VSTX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSD z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSTX jako parametrami1. VSTX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VSD do VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSD na VSTX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VSD do VSTX](https://products.aspose.app/diagram/conversion/vsd-to-vstx) z następującymi korzyściami." >}}
