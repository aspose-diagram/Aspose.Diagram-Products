...
description: Przykładowy kod konwersji VDW na VDX C#. Użyj API przykładowego kodu dla wsadowych plików VDW do VDX konwersji w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDW na VDX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VDW do VDX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VDW z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VDX jako parametrami1. VDX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje VDW do VDX C# konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezpłatna aplikacja do konwersji VDW na VDX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [VDW do VDX konwersji](https://products.aspose.app/diagram/conversion/vdw-to-vdx) z następującymi korzyściami." >}}
