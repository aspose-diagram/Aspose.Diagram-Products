---
title: Konwertuj VST na XPS przez C# 
weight: 3700
url: /pl/net/conversion/vst-to-xps/ 
description: Przykładowy kod konwersji VST do XPS C#. Użyj przykładowego kodu API dla wsadowych plików VST do konwersji XPS w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VST na XPS przez C#" h2="Eksportuj pliki VST Microsoft® Visio do XPS w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VST na XPS za pomocą C#" %}}

 Aby przekonwertować VST na XPS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VST na XPS za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VST do XPS w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VST z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.XPS jako parametrami1. Plik XPS zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję z VST na XPS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VST na XPS" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VST do XPS](https://products.aspose.app/diagram/conversion/vst-to-xps) z następującymi korzyściami." >}}
