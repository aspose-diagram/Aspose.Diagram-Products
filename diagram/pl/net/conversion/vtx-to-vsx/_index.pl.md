...
description: Przykładowy kod konwersji VTX na VSX C#. Użyj API przykładowego kodu dla plików wsadowych VTX do konwersji VSX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VTX na VSX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VTX na VSX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VTX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSX jako parametrami1. VSX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VTX do VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VTX na VSX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VTX do VSX](https://products.aspose.app/diagram/conversion/vtx-to-vsx) z następującymi korzyściami." >}}
