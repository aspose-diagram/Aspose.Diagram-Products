...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VTX na VSDX przy użyciu C#" %}}

 Aby przekonwertować VTX na VSDX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VTX na VSDX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VTX na VSDX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VTX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSDX jako parametrami1. VSDX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje VTX do VSDX C# konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VTX na VSDX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VTX do VSDX](https://products.aspose.app/diagram/conversion/vtx-to-vsdx) z następującymi korzyściami." >}}
