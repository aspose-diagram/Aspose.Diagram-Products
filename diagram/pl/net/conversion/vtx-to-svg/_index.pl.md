---
title: Konwertuj VTX na SVG przez C# 
weight: 3630
url: /pl/net/conversion/vtx-to-svg/ 
description: Przykładowy kod konwersji VTX do SVG C#. Użyj API przykładowego kodu dla plików wsadowych VTX do konwersji SVG w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VTX na SVG przez C#" h2="Eksportuj pliki Microsoft® Visio VTX do SVG w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VTX na SVG przy użyciu C#" %}}

 Aby przekonwertować VTX na SVG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VTX na SVG za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować VTX pliki do formatu SVG w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VTX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.SVG jako parametrami1. Plik SVG zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VTX na SVG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VTX na SVG" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VTX do SVG](https://products.aspose.app/diagram/conversion/vtx-to-svg) z następującymi korzyściami." >}}
