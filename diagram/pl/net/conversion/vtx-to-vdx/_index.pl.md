...
description: Przykładowy kod konwersji VTX na VDX C#. Użyj API przykładowego kodu dla plików wsadowych VTX do konwersji VDX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VTX na VDX przez C#" %}}
...
1. Załaduj plik VTX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VDX jako parametrami1. VDX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VTX do VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VTX na VDX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VTX do VDX](https://products.aspose.app/diagram/conversion/vtx-to-vdx) z następującymi korzyściami." >}}
