---
title: Konwertuj VSD na XPS przez C# 
weight: 660
url: /pl/net/conversion/vsd-to-xps/ 
description: Przykładowy kod konwersji VSD na XPS C#. Użyj API przykładowego kodu dla plików wsadowych VSD do konwersji XPS w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSD na XPS przez C#" h2="Eksportuj pliki Microsoft® Visio VSD do XPS na .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSD na XPS za pomocą C#" %}}

 Aby przekonwertować VSD na XPS, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSD na XPS za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować VSD pliki do XPS w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSD z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.XPS jako parametrami1. Plik XPS zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSD na XPS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSD na XPS" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VSD do XPS](https://products.aspose.app/diagram/conversion/vsd-to-xps) z następującymi korzyściami." >}}
