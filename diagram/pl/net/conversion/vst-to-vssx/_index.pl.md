---
title: Konwertuj VST na VSSX przez C# 
weight: 500
url: /pl/net/conversion/vst-to-vssx/ 
description: Przykładowy kod konwersji VST na VSSX C#. Użyj API przykładowego kodu dla wsadowych plików VST do VSSX konwersji w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VST na VSSX przez C#" h2="Eksportuj pliki Microsoft® Visio VST do VSSX w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VST na VSSX za pomocą C#" %}}

 Aby przekonwertować VST na VSSX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VST na VSSX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VST do VSSX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VST z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSSX jako parametrami1. VSSX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje od VST do VSSX C# konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VST na VSSX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VST do VSSX](https://products.aspose.app/diagram/conversion/vst-to-vssx) z następującymi korzyściami." >}}
