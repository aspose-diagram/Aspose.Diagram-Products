...
description: Przykładowy kod konwersji VSD na VSX C#. Użyj API przykładowego kodu dla plików wsadowych VSD do konwersji VSX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować pliki VSD na VSX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSD z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSX jako parametrami1. VSX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VSD do VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSD na VSX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VSD do VSX](https://products.aspose.app/diagram/conversion/vsd-to-vsx) z następującymi korzyściami." >}}
