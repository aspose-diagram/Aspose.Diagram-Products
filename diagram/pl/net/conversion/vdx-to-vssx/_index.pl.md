...
description: Przykładowy kod konwersji VDX na VSSX C#. Użyj API przykładowego kodu dla plików wsadowych VDX do konwersji VSSX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na VSSX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VDX na VSSX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VDX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSSX jako parametrami1. VSSX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VDX do VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VDX na VSSX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VDX do VSSX](https://products.aspose.app/diagram/conversion/vdx-to-vssx) z następującymi korzyściami." >}}
