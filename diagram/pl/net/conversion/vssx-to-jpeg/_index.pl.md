---
title: Konwertuj VSSX na JPEG przez C# 
weight: 3810
url: /pl/net/conversion/vssx-to-jpeg/ 
description: Przykładowy kod konwersji VSSX na JPEG C#. Użyj API przykładowego kodu dla plików wsadowych VSSX do konwersji JPEG w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSSX na JPEG przez C#" h2="Eksportuj pliki Microsoft® Visio VSSX do JPEG na .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSSX na JPEG przy użyciu C#" %}}

 Aby przekonwertować VSSX na JPEG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSSX na JPEG przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować VSSX pliki do formatu JPEG w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.JPEG jako parametrami1. Plik JPEG zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSSX na JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSSX na JPEG" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VSSX do JPEG](https://products.aspose.app/diagram/conversion/vssx-to-jpeg) z następującymi korzyściami." >}}
