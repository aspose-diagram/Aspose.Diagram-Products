---
title: Konwertuj VSD na SWF przez C# 
weight: 2590
url: /pl/net/conversion/vsd-to-swf/ 
description: Przykładowy kod konwersji VSD na SWF C#. Użyj API przykładowego kodu dla plików wsadowych VSD do konwersji SWF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSD na SWF przez C#" h2="Eksportuj pliki Microsoft® Visio VSD do SWF na .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSD na SWF za pomocą C#" %}}

 Aby przekonwertować VSD na SWF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSD na SWF przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSD na SWF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSD z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.SWF jako parametrami1. Plik SWF zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSD do SWF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSD na SWF" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VSD do SWF](https://products.aspose.app/diagram/conversion/vsd-to-swf) z następującymi korzyściami." >}}
