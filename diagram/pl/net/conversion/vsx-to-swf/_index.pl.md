...
description: Przykładowy kod konwersji VSX na SWF C#. Użyj API przykładowego kodu dla plików wsadowych VSX do konwersji SWF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSX na SWF przez C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSX do SWF C#" offSpacer="" %}}
