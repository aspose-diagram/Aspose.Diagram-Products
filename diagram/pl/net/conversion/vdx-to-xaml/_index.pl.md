...
description: Przykładowy kod konwersji VDX na XAML C#. Użyj API przykładowego kodu dla plików wsadowych VDX do konwersji XAML w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na XAML za pośrednictwem C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VDX na XAML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezpłatna aplikacja do konwersji VDX na XAML" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VDX na XAML](https://products.aspose.app/diagram/conversion/vdx-to-xaml) z następującymi korzyściami." >}}
