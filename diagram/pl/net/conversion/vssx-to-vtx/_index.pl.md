...
description: Przykładowy kod konwersji VSSX na VTX C#. Użyj API przykładowego kodu dla plików wsadowych VSSX do konwersji VTX w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSSX na VTX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSSX na VTX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VTX jako parametrami1. VTX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VSSX do VTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSSX na VTX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VSSX do VTX](https://products.aspose.app/diagram/conversion/vssx-to-vtx) z następującymi korzyściami." >}}
