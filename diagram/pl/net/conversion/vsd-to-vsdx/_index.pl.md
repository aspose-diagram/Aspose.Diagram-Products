...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSD na VSDX za pomocą C#" %}}

 Aby przekonwertować VSD na VSDX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSD na VSDX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSD na VSDX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSD z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSDX jako parametrami1. VSDX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VSD do VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSD na VSDX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VSD do VSDX](https://products.aspose.app/diagram/conversion/vsd-to-vsdx) z następującymi korzyściami." >}}
