...
description: Przykładowy kod konwersji VTX na VSTM C#. Użyj API przykładowego kodu dla plików wsadowych VTX do konwersji VSTM w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VTX na VSTM przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VTX na VSTM w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VTX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSTM jako parametrami1. VSTM plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję od VTX do VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VTX na VSTM" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja z VTX do VSTM](https://products.aspose.app/diagram/conversion/vtx-to-vstm) z następującymi korzyściami." >}}
