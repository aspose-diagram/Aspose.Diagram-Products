---
title: Konwertuj VSX na JPEG przez C# 
weight: 4410
url: /pl/net/conversion/vsx-to-jpeg/ 
description: Przykładowy kod konwersji VSX do JPEG C#. Użyj przykładowego kodu API dla plików wsadowych VSX do konwersji JPEG w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSX na JPEG przez C#" h2="Eksportuj pliki Microsoft® Visio VSX do formatu JPEG w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSX na JPEG za pomocą C#" %}}

 Aby przekonwertować VSX na JPEG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSX na JPEG za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSX na JPEG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.JPEG jako parametrami1. Plik JPEG zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSX do JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSX na JPEG" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VSX do JPEG](https://products.aspose.app/diagram/conversion/vsx-to-jpeg) z następującymi korzyściami." >}}
