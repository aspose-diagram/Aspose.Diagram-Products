---
title: Konwertuj VSSX na SVG przez C# 
weight: 4570
url: /pl/net/conversion/vssx-to-svg/ 
description: Przykładowy kod konwersji VSSX do SVG C#. Użyj API przykładowego kodu dla plików wsadowych VSSX do konwersji SVG w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSSX na SVG przez C#" h2="Eksportuj pliki Microsoft® Visio VSSX do SVG w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSSX na SVG przy użyciu C#" %}}

 Aby przekonwertować VSSX na SVG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSSX na SVG za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować VSSX pliki do formatu SVG w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.SVG jako parametrami1. Plik SVG zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSSX na SVG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSSX na SVG" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VSSX do SVG](https://products.aspose.app/diagram/conversion/vssx-to-svg) z następującymi korzyściami." >}}
