---
title: Konwertuj VSD na XAML przez C# 
weight: 1470
url: /pl/net/conversion/vsd-to-xaml/ 
description: Przykładowy kod konwersji VSD na XAML C#. Użyj API przykładowego kodu dla plików wsadowych VSD do konwersji XAML w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSD na XAML przez C#" h2="Eksportuj pliki Microsoft® Visio VSD do XAML w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSD na XAML przy użyciu C#" %}}

 Aby przekonwertować VSD na XAML, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSD na XAML za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSD na XAML w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSD z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.XAML jako parametrami1. Plik XAML zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSD na XAML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezpłatna aplikacja do konwersji VSD na XAML" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VSD na XAML](https://products.aspose.app/diagram/conversion/vsd-to-xaml) z następującymi korzyściami." >}}
