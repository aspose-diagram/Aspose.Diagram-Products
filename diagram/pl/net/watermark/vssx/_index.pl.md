---
title: Znak wodny dokumentu VSSX za pośrednictwem .NET 
weight: 3050
url: /pl/net/watermark/vssx/ 
description: C# kod źródłowy, aby dodać znak wodny do pliku vssx na .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dodaj tekstowy znak wodny do VSSX w C#" h2="Natywny i wydajny znak wodny dokumentu VSSX przy użyciu interfejsów API Aspose.Diagramfor .NET po stronie serwera, bez użycia oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak oznaczyć plik VSSX znakiem wodnym za pomocą C#" %}}

 Aby oznaczyć plik VSSX znakiem wodnym, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dodawania znaków wodnych do plików VSSX w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Pliki VSSX ze znakami wodnymi — C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram to manipulacja formatem dokumentów firmy Microsoft Visio API. Można łatwo ładować, tworzyć, modyfikować, manipulować, w tym elementami daigramów i konwertować Visio diagramy do innych formatów, takich jak PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF i inne. Jest to samodzielny API i nie wymaga instalacji Microsoft Visio ani żadnego innego oprogramowania.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online demonstracje na żywo VSSX WaterMark" sectionDescription="Dokumenty WaterMark VSSX już teraz, odwiedzając nasze [Witryna demonstracyjna na żywo](https://products.aspose.app/diagram/watermark). Demo na żywo ma następujące zalety" >}}
