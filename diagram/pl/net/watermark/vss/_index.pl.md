---
title: Znak wodny dokumentu VSS za pośrednictwem .NET 
weight: 3050
url: /pl/net/watermark/vss/ 
description: C# kod źródłowy, aby dodać znak wodny do pliku vss na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dodaj tekstowy znak wodny do usługi VSS w C#" h2="Natywny i wydajny znak wodny dokumentu VSS przy użyciu interfejsów API Aspose.Diagramfor .NET po stronie serwera, bez użycia oprogramowania, takiego jak Microsoft lub OpenOffice, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak dodać znak wodny do pliku VSS za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dotyczące znakowania plików VSS ze znakami wodnymi w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Pliki VSS ze znakiem wodnym — C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/watermark/vsd/" name="Vsd" description="Microsoft Visio Rysunki" >}}
