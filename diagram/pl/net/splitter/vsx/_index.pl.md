...
{{% blocks/products/pf/agp/content h2="Jak podzielić plik VSX za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dzielenia plików VSX w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Podziel pliki VSX — C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram to manipulacja formatem dokumentów firmy Microsoft Visio API. Można łatwo ładować, tworzyć, modyfikować, manipulować, w tym elementami daigramów i konwertować Visio diagramy do innych formatów, takich jak PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF i inne. Jest to samodzielny API i nie wymaga instalacji Microsoft Visio ani żadnego innego oprogramowania.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Dema na żywo w trybie online VSX" sectionDescription="Podziel dokumenty VSX już teraz, odwiedzając naszą [Witryna demonstracyjna na żywo](https://products.aspose.app/diagram/splitter). Demo na żywo ma następujące zalety" >}}
