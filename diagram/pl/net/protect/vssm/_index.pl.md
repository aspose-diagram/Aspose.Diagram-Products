---
title: Chroń i blokuj VSSM dokument przez .NET 
weight: 5580
url: /pl/net/protect/vssm/ 
description: C# kod źródłowy do blokowania pliku VSSM na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chroń VSSM pliki przez C#" h2="Chroń Visio, w tym format VSSM, korzystając z Biblioteki .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak chronić VSSM plik za pomocą C#" %}}

 Aby chronić plik VSSM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dotyczące ochrony VSSM plików w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Chroń VSSM pliki - C#" offSpacer="" %}}
