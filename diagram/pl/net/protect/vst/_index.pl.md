---
title: Chroń i blokuj dokument VST za pomocą .NET 
weight: 5580
url: /pl/net/protect/vst/ 
description: C# kod źródłowy do blokowania pliku VST na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chroń pliki VST przez C#" h2="Chroń Visio, w tym format VST, korzystając z Biblioteki .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak chronić plik VST za pomocą C#" %}}

 W celu ochrony pliku VST użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dotyczące ochrony plików VST w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Chroń pliki VST — C#" offSpacer="" %}}
