---
title: Chroń i blokuj VSDM dokument przez .NET 
weight: 5580
url: /pl/net/protect/vsdm/ 
description: C# kod źródłowy do blokowania pliku VSDM na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chroń VSDM pliki przez C#" h2="Chroń Visio, w tym format VSDM, korzystając z Biblioteki .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak chronić VSDM plik za pomocą C#" %}}

 Aby chronić plik VSDM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dotyczące ochrony VSDM plików w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Chroń VSDM pliki - C#" offSpacer="" %}}
