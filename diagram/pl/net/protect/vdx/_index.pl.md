---
title: Chroń i blokuj VDX dokument przez .NET 
weight: 5580
url: /pl/net/protect/vdx/ 
description: C# kod źródłowy do blokowania pliku VDX na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chroń VDX pliki przez C#" h2="Chroń Visio, w tym format VDX, korzystając z Biblioteki .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak chronić VDX plik za pomocą C#" %}}

 Aby chronić plik VDX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dotyczące ochrony VDX plików w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Chroń VDX pliki - C#" offSpacer="" %}}
