---
title: Skompresuj VSSM dokument przez .NET 
weight: 3050
url: /pl/net/compress/vssm/ 
description: C# kod źródłowy do skompresowania pliku vssm na platformach .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki kompresji VSSM plików w C#" %}}
