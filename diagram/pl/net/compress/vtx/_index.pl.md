---
title: Skompresuj dokument VTX przez .NET 
weight: 3050
url: /pl/net/compress/vtx/ 
description: C# kod źródłowy do kompresji pliku vtx na platformach .NET Framework, .NET Core, Mono.
---
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram to manipulacja formatem dokumentów firmy Microsoft Visio API. Można łatwo ładować, tworzyć, modyfikować, manipulować, w tym elementami daigramów i konwertować Visio diagramy do innych formatów, takich jak PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF i inne. Jest to samodzielny API i nie wymaga instalacji Microsoft Visio ani żadnego innego oprogramowania.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z kompresją VTX online" sectionDescription="Kompresuj dokumenty VTX już teraz, odwiedzając nasz [Witryna demonstracyjna na żywo](https://products.aspose.app/diagram/compress). Demo na żywo ma następujące zalety" >}}
