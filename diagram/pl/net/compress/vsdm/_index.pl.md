---
title: Kompresuj dokument VSDM za pomocą .NET 
weight: 3050
url: /pl/net/compress/vsdm/ 
description: C# kod źródłowy do kompresji pliku vsdm na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Kompresuj VSDM w C#" h2="Natywny i wydajny kompresor dokumentów VSDM wykorzystujący interfejsy API Aspose.Diagramfor .NET po stronie serwera, bez użycia oprogramowania, takiego jak Microsoft lub Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak skompresować plik VSDM za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki kompresji VSD plików w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Kompresuj pliki VSDM — C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram to manipulacja formatem dokumentów firmy Microsoft Visio API. Można łatwo ładować, tworzyć, modyfikować, manipulować, w tym elementami daigramów i konwertować Visio diagramy do innych formatów, takich jak PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF i inne. Jest to samodzielny API i nie wymaga instalacji Microsoft Visio ani żadnego innego oprogramowania.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z kompresją VSDM online" sectionDescription="Kompresuj dokumenty VSDM już teraz, odwiedzając nasz [Witryna demonstracyjna na żywo](https://products.aspose.app/diagram/compress). Demo na żywo ma następujące zalety" >}}
