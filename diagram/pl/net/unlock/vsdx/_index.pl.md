---
title: Odblokuj dokument VSDX przez .NET 
weight: 5680
url: /pl/net/unlock/vsdx/ 
description: C# kod źródłowy do odblokowania pliku VSDX na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj VSDX pliki przez C#" h2="Usuń ochronę z Visio, w tym formatu VSDX, korzystając z Biblioteki .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak odblokować plik VSDX za pomocą C#" %}}

 Aby odblokować plik VSDX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki do odblokowania VSDX plików w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Odblokuj VSDX pliki - C#" offSpacer="" %}}
