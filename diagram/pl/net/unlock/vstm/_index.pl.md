---
title: Odblokuj dokument VSTM przez .NET 
weight: 5680
url: /pl/net/unlock/vstm/ 
description: C# kod źródłowy do odblokowania pliku VSTM na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj VSTM pliki przez C#" h2="Usuń ochronę z Visio, w tym formatu VSTM, korzystając z Biblioteki .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak odblokować plik VSTM za pomocą C#" %}}

 Aby odblokować plik VSTM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki do odblokowania VSTM plików w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Odblokuj VSTM pliki - C#" offSpacer="" %}}
