---
title: Odblokuj dokument VTX przez .NET 
weight: 5680
url: /pl/net/unlock/vtx/ 
description: C# kod źródłowy do odblokowania pliku VTX na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj VTX pliki przez C#" h2="Usuń ochronę z Visio, w tym formatu VDW, korzystając z Biblioteki .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak odblokować plik VTX za pomocą C#" %}}

 Aby odblokować plik VTX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki do odblokowania VTX plików w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Odblokuj VTX pliki - C#" offSpacer="" %}}
