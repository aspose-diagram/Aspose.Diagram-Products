---
title: Odblokuj dokument VST przez .NET 
weight: 5680
url: /pl/net/unlock/vst/ 
description: C# kod źródłowy do odblokowania pliku VST na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odblokuj pliki VST przez C#" h2="Usuń ochronę z Visio, w tym formatu VST, korzystając z biblioteki .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak odblokować plik VST za pomocą C#" %}}

 Aby odblokować plik VST, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki odblokowania plików VST w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Odblokuj pliki VST — C#" offSpacer="" %}}
