---
title: Wyświetl VSX formaty plików za pośrednictwem .NET 
weight: 1720
url: /pl/net/viewer/vsx/ 
description: C# kod źródłowy do ładowania, renderowania i wyświetlania VSX dokumentów w .NET Framework, .NET Core, Mono lub COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSX Przeglądarka plików for .NET" h2="Wyświetlaj pliki Microsoft Visio VSX w przeglądarce bez konieczności Visio aplikacji lub Office automatyzacji." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
// przekonwertuj VSX na format HTML
