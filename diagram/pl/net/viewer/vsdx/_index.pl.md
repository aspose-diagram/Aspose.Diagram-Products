---
title: Wyświetl VSDX formaty plików za pośrednictwem .NET 
weight: 5350
url: /pl/net/viewer/vsdx/ 
description: C# kod źródłowy do ładowania, renderowania i wyświetlania VSDX dokumentów w .NET Framework, .NET Core, Mono lub COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDX Przeglądarka plików for .NET" h2="Wyświetlaj pliki Microsoft Visio VSDX w przeglądarce bez konieczności Visio aplikacji lub automatyzacji pakietu Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wyświetlić VSDX przez C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kod do wyświetlenia VSDX" offSpacer="" %}}

```cs

// załaduj plik VSDX przez wystąpienie Diagram
var diagram = new Aspose.Diagram.Diagram("template.vsdx");
// przekonwertuj VSDX na format HTML
