---
title: Narysuj geometrię do VSTX dokumentu przez .NET 
weight: 3050
url: /pl/net/drawing/vstx/ 
description: C# kod źródłowy do rysowania geometrii do pliku vstx na platformach .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Narysuj geometrię do VSTX w C#" h2="Natywna i wysoce wydajna geometria rysowania VSTXdokumentu przy użyciu interfejsów API Aspose.Diagram for .NET po stronie serwera, bez użycia oprogramowania takiego jak Microsoft lub Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak narysować geometrię do pliku VSTX za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapy rysowania geometrii do VSTX plików w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Narysuj geometrię do VSTX plików — C#" offSpacer="" %}}
