...
{{% blocks/products/pf/agp/content h2="Jak dodawać adnotacje do pliku VSDM za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dotyczące adnotacji VSDM plików w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Usuń komentarz z VSDM plików — C#" offSpacer="" %}}
