---
title: Scal pliki VST przez Python 
weight: 230
url: /pl/python-java/merger/vst/ 
description: Python przykładowy kod do łączenia dokumentów VST w dowolnej aplikacji opartej na Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Scal formaty VST w Python" h2="Natywne scalanie dokumentów VST przy użyciu interfejsów API Python po stronie serwera." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Jak scalić pliki VST za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki scalania plików VST w Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Scal pliki VST — Python" offSpacer="" %}}
