---
title: Scal VSTM pliki przez Python 
weight: 230
url: /pl/python-java/merger/vstm/ 
description: Python przykładowy kod do łączenia VSTM dokumentów w dowolnej aplikacji opartej na Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Scal VSTM formaty w Python" h2="Natywne scalanie dokumentów VSTM przy użyciu interfejsów API Python po stronie serwera." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak scalić VSTM pliki za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki scalania VSTM plików w Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Scal VSTM pliki — Python" offSpacer="" %}}
