---
title: Scal VSX pliki przez Python 
weight: 230
url: /pl/python-java/merger/vsx/ 
description: Python przykładowy kod do łączenia VSX dokumentów w dowolnej aplikacji opartej na Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Scal VSX formaty w Python" h2="Natywne scalanie dokumentów VSX przy użyciu interfejsów API Python po stronie serwera." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak scalić VSX pliki za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki scalania VSX plików w Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Scal VSX pliki — Python" offSpacer="" %}}
