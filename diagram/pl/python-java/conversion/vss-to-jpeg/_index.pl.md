---
title: Konwertuj VSS na JPEG przez Python 
weight: 1960
url: /pl/python-java/conversion/vss-to-jpeg/ 
description: Przykładowy kod konwersji Python dla formatu VSS do pliku JPEG. Użyj tego przykładowego kodu, aby przekonwertować VSS na JPEG w dowolnej aplikacji opartej na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSS na JPEG przez Python" h2="Eksportuj MicrosoftVisio VSS do JPEG przy użyciu Python interfejsów API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSS na JPEG za pomocą Python" %}}

 Aby wyrenderować VSS do JPEG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSS na JPEG za pomocą Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python programiści mogą łatwo przekonwertować plik VSS na JPEG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSS z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik JPEG zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VSS do JPEG Python Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją VSS do JPEG" sectionDescription="[Konwertuj VSS na JPEG](https://products.aspose.app/diagram/conversion/vss-to-jpeg) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik VSS, zostanie on natychmiast przekonwertowany do formatu JPEG." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/python-java/conversion/vss-to-html/" name="VSS DO HTML" description="hipertekstowy język znaczników" >}}
