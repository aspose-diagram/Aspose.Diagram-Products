---
title: Dodaj, edytuj i usuń adnotację z VSDM przez Python 
weight: 3250
url: /pl/python-java/annotation/vsdm/ 
description: Python kod źródłowy do adnotacji VSDM pliku w dowolnej aplikacji opartej na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Opisz VSDM formaty w Python" h2="Natywna adnotacja dokumentu VSDM przy użyciu interfejsów API Python po stronie serwera." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak dodawać adnotacje do VSDM plików za pomocą Python" %}}

 Aby dodać adnotację do pliku VSDM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dotyczące adnotacji VSDM Pliki w Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Opisz VSDM pliki - Python" offSpacer="" %}}
