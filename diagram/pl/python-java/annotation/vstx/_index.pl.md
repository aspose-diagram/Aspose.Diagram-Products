---
title: Dodaj, edytuj i usuń adnotację z VSTX przez Python 
weight: 3250
url: /pl/python-java/annotation/vstx/ 
description: Python kod źródłowy do adnotacji VSTX pliku w dowolnej aplikacji opartej na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Opisz VSTX formaty w Python" h2="Natywna adnotacja dokumentu VSTX przy użyciu interfejsów API Python po stronie serwera." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak dodawać adnotacje do VSTX plików za pomocą Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Opisz VSTX pliki - Python" offSpacer="" %}}
