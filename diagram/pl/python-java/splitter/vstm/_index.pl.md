---
title: Podziel VSTM pliki przez Python
weight: 1400
url: /pl/python-java/splitter/vstm/ 
description: Python kod źródłowy, aby podzielić plik vstm w dowolnej aplikacji opartej na Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Podziel format VSTM na Python" h2="Twórz własne Python aplikacje do dzielenia VSTM plików " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak podzielić VSTM pliki za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapy dzielenia VSTM plików w Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Podziel pliki VSTM — Python" offSpacer="" %}}
