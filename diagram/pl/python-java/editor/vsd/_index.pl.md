...
{{% blocks/products/pf/agp/content h2="Jak edytować VSD pliki za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki edycji VSD plików w Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Edytuj VSD pliki — Python" offSpacer="" %}}
