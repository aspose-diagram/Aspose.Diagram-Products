---
title: Znak wodny dokumentu VST za pośrednictwem Python 
weight: 3050
url: /pl/python-java/watermark/vst/ 
description: Python przykładowy kod do dodawania znaku wodnego do dokumentów VST w dowolnej aplikacji opartej na Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Formaty znaku wodnego VST w Python" h2="Natywny znak wodny dokumentu VST przy użyciu interfejsów API Python po stronie serwera." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Jak oznaczyć pliki VST znakiem wodnym za pomocą Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dotyczące znakowania plików VST w Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Pliki VST ze znakiem wodnym — Python" offSpacer="" %}}
