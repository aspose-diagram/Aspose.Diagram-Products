---
title: Добавить, изменить и удалить аннотацию из VSSX через Python 
weight: 3250
url: /ru/python-java/annotation/vssx/ 
description: Исходный код Python для аннотирования файла VSSX в любом приложении на основе Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Аннотировать форматы VSSX в Python" h2="Собственные аннотации к документам VSSX с использованием серверных Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Как аннотировать файлы VSSX с помощью Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Аннотировать файлы VSSX – Python" offSpacer="" %}}
