---
title: Добавить, изменить и удалить аннотацию из VDX через Python 
weight: 3250
url: /ru/python-java/annotation/vdx/ 
description: Исходный код Python для аннотирования файла VDX в любом приложении на основе Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Аннотировать форматы VDX в Python" h2="Собственные аннотации к документам VDX с использованием серверных Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как аннотировать файлы VDX с помощью Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Аннотировать файлы VDX – Python" offSpacer="" %}}
