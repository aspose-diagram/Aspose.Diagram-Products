---
title: Разделить VDX файлов через Python
weight: 1400
url: /ru/python-java/splitter/vdx/ 
description: Исходный код Python для разделения файла vdx в любом приложении на основе Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Разделить формат VDX на Python" h2="Создайте свои собственные приложения Python для разделения файлов VDX " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как разделить файлы VDX с помощью Python" %}}

 Чтобы разделить файл VDX, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разделению VDX файлов в Python" %}}
...
+ Загрузите файл VDX с полным путем для разделения.
...
{{% blocks/products/pf/agp/code-block title="Разделить VDX файлов - Python" offSpacer="" %}}
