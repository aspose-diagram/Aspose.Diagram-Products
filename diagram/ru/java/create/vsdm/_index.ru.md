---
title: Создать VSDM файлов через Java 
url: /ru/java/create-vsdm/ 
description: Java Пример кода для создания VSDM документов. Используйте этот код для создания файлов VSDM в настольном или веб-приложении на основе Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Создайте VSDM документов через Java" h2="Нативное и высокопроизводительное создание VSDM (Portable Document Format) программным путем с использованием библиотеки Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="VSDM" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Как создать VSDM через Java" %}}
