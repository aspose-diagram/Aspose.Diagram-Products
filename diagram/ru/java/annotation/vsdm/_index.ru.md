---
title: Добавить, изменить и удалить аннотацию из VSDM через Java 
weight: 3250
url: /ru/java/annotation/vsdm/ 
description: Исходный код Java для аннотирования VSDM файла в Java среде выполнения для приложений JSP/JSF и настольных приложений.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Аннотировать форматы VSDM в Java" h2="Собственные аннотации к документам VSDM с использованием серверных Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Как аннотировать файлы VSDM с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для аннотации VSDM файлов в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Аннотировать файлы VSDM – Java" offSpacer="" %}}
