---
title: Объединить VSD файлов через Java 
weight: 3600
url: /ru/java/merger/vsd/ 
description: Пример кода Java для объединения VSD документов в Java среде выполнения для приложений JSP/JSF и настольных приложений.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Объединить форматы VSD в Java" h2="Встроенное слияние документов VSD с использованием серверных Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Как объединить файлы VSD с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению VSD файлов в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Объединить VSD файлов - Java" offSpacer="" %}}
