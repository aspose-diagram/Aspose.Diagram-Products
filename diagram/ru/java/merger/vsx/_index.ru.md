...
{{% blocks/products/pf/agp/content h2="Как объединить файлы VSX с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению VSX файлов в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Объединить VSX файлов - Java" offSpacer="" %}}
