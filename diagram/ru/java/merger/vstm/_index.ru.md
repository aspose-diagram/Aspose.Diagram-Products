---
title: Объединить VSTM файлов через Java 
weight: 3750
url: /ru/java/merger/vstm/ 
description: Пример кода Java для объединения VSTM документов в Java среде выполнения для приложений JSP/JSF и настольных приложений.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Объединить форматы VSTM в Java" h2="Встроенное слияние документов VSTM с использованием серверных Java API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Как объединить файлы VSTM с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению VSTM файлов в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Объединить VSTM файлов - Java" offSpacer="" %}}
