...
description: Пример кода преобразования Java для формата VSS в файл VSTX. Используйте этот пример кода для преобразования VSS в VSTX в любом веб-приложении или настольном Java приложении.
---
...
{{% blocks/products/pf/agp/code-block title="Преобразование VSS в исходный код VSTX Java" offSpacer="" %}}
