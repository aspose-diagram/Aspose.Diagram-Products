...
description: Пример кода преобразования Java для формата VSS в файл VTX. Используйте этот пример кода для преобразования VSS в VTX в любом веб-приложении или настольном Java приложении.
---
...
{{% blocks/products/pf/agp/code-block title="Преобразование VSS в исходный код VTX Java" offSpacer="" %}}
