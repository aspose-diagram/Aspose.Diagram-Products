...
description: Пример кода преобразования Java для формата VDX в файл VSSX. Используйте этот пример кода для преобразования VDX в VSSX в любом веб-приложении или настольном приложении Java.
---
...
{{% blocks/products/pf/agp/code-block title="VDX в VSSX Java Исходный код преобразования" offSpacer="" %}}
