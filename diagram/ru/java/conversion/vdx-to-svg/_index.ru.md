...
description: Пример кода преобразования Java для формата VDX в файл SVG. Используйте этот пример кода для преобразования VDX в SVG в любом веб-приложении или настольном Java приложении.
---
