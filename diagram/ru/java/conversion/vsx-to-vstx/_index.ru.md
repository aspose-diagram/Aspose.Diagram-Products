...
description: Пример кода преобразования Java для формата VSX в файл VSTX. Используйте этот пример кода для преобразования VSX в VSTX в любом веб-приложении или настольном приложении Java.
---
...
{{% blocks/products/pf/agp/code-block title="VSX в VSTX Java Исходный код преобразования" offSpacer="" %}}
