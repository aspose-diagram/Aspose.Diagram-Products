...
{{% blocks/products/pf/agp/content h2="Как разделить файлы VSTX с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разделению VSTX файлов в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Разделить VSTX файлов - Java" offSpacer="" %}}
