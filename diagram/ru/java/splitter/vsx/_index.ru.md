...
{{% blocks/products/pf/agp/content h2="Как разделить файлы VSX с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разделению VSX файлов в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Разделить VSX файлов - Java" offSpacer="" %}}
