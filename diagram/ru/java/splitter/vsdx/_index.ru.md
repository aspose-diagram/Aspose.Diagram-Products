...
{{% blocks/products/pf/agp/content h2="Как разделить файлы VSDX с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разделению VSDX файлов в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Разделить VSDX файлов - Java" offSpacer="" %}}
