...
{{% blocks/products/pf/agp/content h2="Как разделить файлы VSDM с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разделению VSDM файлов в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Разделить VSDM файлов - Java" offSpacer="" %}}
