...
{{% blocks/products/pf/agp/content h2="Как разделить файлы VSTM с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разделению VSTM файлов в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Разделить VSTM файлов - Java" offSpacer="" %}}
