...
{{% blocks/products/pf/agp/content h2="Как разделить файлы VDW с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разделению файлов VDW в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Разделить файлы VDW — Java" offSpacer="" %}}
