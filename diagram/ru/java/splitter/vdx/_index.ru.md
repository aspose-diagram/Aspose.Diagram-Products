...
{{% blocks/products/pf/agp/content h2="Как разделить файлы VDX с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разделению VDX файлов в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Разделить VDX файлов - Java" offSpacer="" %}}
