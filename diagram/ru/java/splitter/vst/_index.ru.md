...
{{% blocks/products/pf/agp/content h2="Как разделить файлы VST с помощью Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разделению файлов VST в Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Разделить VST-файлы — Java" offSpacer="" %}}
