---
title: Разблокировать документ VSS через .NET 
weight: 5680
url: /ru/net/unlock/vss/ 
description: Исходный код C# для разблокировки файла VSS на платформах .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Разблокировать файлы VSS через C#" h2="Снимите защиту с Visio, включая формат VSS, с помощью библиотеки .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как разблокировать файл VSS с помощью C#" %}}

 Чтобы разблокировать файл VSS, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разблокировке файлов VSS в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Разблокировать файлы VSS — C#" offSpacer="" %}}
