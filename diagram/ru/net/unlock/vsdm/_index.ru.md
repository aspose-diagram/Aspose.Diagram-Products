---
title: Разблокировать VSDM документ через .NET 
weight: 5680
url: /ru/net/unlock/vsdm/ 
description: Исходный код C# для разблокировки файла VSDM на платформах .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Разблокировать VSDM файлов через C#" h2="Снять защиту с Visio, включая формат VSDM, с помощью библиотеки .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как разблокировать файл VSDM с помощью C#" %}}

 Чтобы разблокировать файл VSDM, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по разблокировке VSDM файлов в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Разблокировать VSDM файлов - C#" offSpacer="" %}}
