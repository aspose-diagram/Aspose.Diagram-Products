...
{{% blocks/products/pf/agp/content h2="Как выполнить автоматическую компоновку файла VSX с помощью C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия для автоматической компоновки VSX файлов в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Автомакет VSX файлов - C#" offSpacer="" %}}
