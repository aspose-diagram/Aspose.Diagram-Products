---
title: Просмотр форматов файлов VSDM через .NET 
weight: 1210
url: /ru/net/viewer/vsdm/ 
description: Исходный код C# для загрузки, обработки и отображения VSDM документов в .NET Framework, .NET Core, Mono или COM-взаимодействии.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDM Средство просмотра файлов for .NET" h2="Просматривайте файлы Microsoft Visio VSDM в браузере, не требуя приложения Visio или Office автоматизации." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для просмотра VSDM через C#" %}}
...
1. Загрузить файл VSDM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с SaveFileFormat.HTML в качестве параметров.1. Загрузите результирующий HTML в браузере по умолчанию через Process.Start
...
{{% blocks/products/pf/agp/code-block title="C# код для просмотра VSDM" offSpacer="" %}}

```cs

// загрузить файл VSDM через экземпляр Diagram
var diagram = new Aspose.Diagram.Diagram("template.vsdm");
// преобразовать VSDM в формат HTML
