---
title: Просмотр форматов файлов VSTX через .NET 
weight: 3560
url: /ru/net/viewer/vstx/ 
description: Исходный код C# для загрузки, обработки и отображения VSTX документов в .NET Framework, .NET Core, Mono или COM-взаимодействии.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTX Средство просмотра файлов for .NET" h2="Просматривайте файлы Microsoft Visio VSTX в браузере, не требуя приложения Visio или Office автоматизации." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для просмотра VSTX через C#" %}}
...
1. Загрузить файл VSTX с экземпляром класса Diagram1. Вызовите метод Diagram.Save с SaveFileFormat.HTML в качестве параметров.1. Загрузите результирующий HTML в браузере по умолчанию через Process.Start
...
{{% blocks/products/pf/agp/code-block title="C# код для просмотра VSTX" offSpacer="" %}}

```cs

// загрузить файл VSTX через экземпляр Diagram
var diagram = new Aspose.Diagram.Diagram("template.vstx");
// преобразовать VSTX в формат HTML
