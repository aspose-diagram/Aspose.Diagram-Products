---
title: Объединить файлы VDX через .NET 
weight: 3260
url: /ru/net/merger/vdx/ 
description: Исходный код C# для объединения документов VDX на .NET Framework, .NET Core, Mono или COM Interop.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению файлов VDX в C#" %}}
...
+ Загрузите все файлы VDX с полным путем.
...
Вызвать метод Save() и передать в качестве параметра имя файла (полный путь) и формат (VDX).
...
{{% blocks/products/pf/agp/code-block title="Объединить файлы VDX — C#" offSpacer="" %}}
