---
title: Добавить, изменить и удалить аннотацию из VSDX через C# 
weight: 3050
url: /ru/net/annotation/vsdx/ 
description: Исходный код C# для аннотирования файла VSDX на платформах .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Как аннотировать файл VSDX с помощью C#" h2="Нативная и высокопроизводительная аннотация документов VSDX с использованием API-интерфейсов Aspose.Diagram for .NET на стороне сервера без использования какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как аннотировать файл VSDX с помощью C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги для аннотирования VSDX файлов в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Удалить комментарий из VSDX файлов - C#" offSpacer="" %}}
