---
title: Преобразование VSTM в PNG с помощью C# 
weight: 4150
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию VSTM в PNG с помощью C#" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики .NET могут легко загружать и преобразовывать файлы VSTM в PNG, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузить файл VSTM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.PNG в качестве параметров.1. Файл PNG будет сохранен по указанному пути
