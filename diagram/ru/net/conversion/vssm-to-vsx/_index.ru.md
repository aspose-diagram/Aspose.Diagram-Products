...
description: Пример кода для преобразования VSSM в VSX C#. Используйте пример кода API для пакетного преобразования файлов VSSM в VSX в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузите файл VSSM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSX в качестве параметров.1. Файл VSX будет сохранен по указанному пути
