...
description: Пример кода для преобразования VSSM в VDX C#. Используйте пример кода API для пакетного преобразования VSSM файлов в VDX в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузить файл VSSM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VDX в качестве параметров.1. VDX файл будет сохранен по указанному пути
