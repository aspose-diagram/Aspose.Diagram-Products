...
description: Пример кода для преобразования VDW в VTX C#. Используйте пример кода API для пакетного преобразования файлов VDW в VTX в рамках VB.NET, Asp.NET или любого приложения на основе .NET.
---
...
1. Загрузить файл VDW с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VTX в качестве параметров.1. VTX файл будет сохранен по указанному пути
