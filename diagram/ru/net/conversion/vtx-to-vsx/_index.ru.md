...
description: Пример кода для преобразования VTX в VSX C#. Используйте пример кода API для пакетного преобразования VTX файлов в VSX в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузить файл VTX с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSX в качестве параметров.1. VSX файл будет сохранен по указанному пути
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для преобразования VTX в VSX" sectionDescription="Проверьте наши живые демонстрации для [Преобразование VTX в VSX](https://products.aspose.app/diagram/conversion/vtx-to-vsx) со следующими преимуществами." >}}
