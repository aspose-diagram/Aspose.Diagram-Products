...
description: Пример кода для преобразования VSSM в VTX C#. Используйте пример кода API для пакетного преобразования VSSM файлов в VTX в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузить файл VSSM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VTX в качестве параметров.1. VTX файл будет сохранен по указанному пути
