---
title: Преобразование VSDX в SWF через C# 
weight: 4030
url: /ru/net/conversion/vsdx-to-swf/ 
description: Пример кода для преобразования VSDX в SWF C#. Используйте пример кода API для пакетного преобразования файлов VSDX в SWF в VB.NET, Asp.NET или любом приложении на основе .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование VSDX в SWF через C#" h2="Экспортируйте файлы Microsoft® Visio VSDX в SWF на .NET Framework, .NET Core, Mono или COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать VSDX в SWF с помощью C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию VSDX в SWF через C#" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики .NET могут легко загружать и преобразовывать файлы VSDX в SWF, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузить файл VSDX с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.SWF в качестве параметров.1. SWF-файл будет сохранен по указанному пути
...
{{% blocks/products/pf/agp/code-block title="В этом примере кода показано преобразование VSDX в SWF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для преобразования VSDX в SWF" sectionDescription="Проверьте наши живые демонстрации для [Преобразование VSDX в SWF](https://products.aspose.app/diagram/conversion/vsdx-to-swf) со следующими преимуществами." >}}
