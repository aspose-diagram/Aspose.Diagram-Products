...
description: Пример кода для преобразования VTX в VTX C#. Используйте пример кода API для пакетного преобразования VTX файлов в VTX в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
{{% blocks/products/pf/agp/content h2="Как преобразовать VTX в VTX с помощью C#" %}}
...
1. Загрузить файл VTX с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VTX в качестве параметров.1. VTX файл будет сохранен по указанному пути
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для преобразования VTX в VTX" sectionDescription="Проверьте наши живые демонстрации для [Преобразование VTX в VTX](https://products.aspose.app/diagram/conversion/vtx-to-vtx) со следующими преимуществами." >}}
