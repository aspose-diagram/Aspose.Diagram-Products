...
1. Загрузить файл VSTX с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.SWF в качестве параметров.1. SWF-файл будет сохранен по указанному пути
