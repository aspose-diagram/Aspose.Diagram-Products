...
description: Пример кода для преобразования VTX в VSSX C#. Используйте пример кода API для пакетного преобразования VTX файлов в VSSX в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузить файл VTX с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSSX в качестве параметров.1. VSSX файл будет сохранен по указанному пути
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для преобразования VTX в VSSX" sectionDescription="Проверьте наши живые демонстрации для [Преобразование VTX в VSSX](https://products.aspose.app/diagram/conversion/vtx-to-vssx) со следующими преимуществами." >}}
