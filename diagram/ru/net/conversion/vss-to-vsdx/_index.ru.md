---
title: Преобразование VSS в VSDX через C# 
weight: 860
url: /ru/net/conversion/vss-to-vsdx/ 
description: Пример кода для преобразования VSS в VSDX C#. Используйте API пример кода для пакетного преобразования файлов VSS в VSDX преобразование в VB.NET, Asp.NET или любом приложении на основе .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование VSS в VSDX через C#" h2="Экспорт файлов Microsoft® Visio VSS в VSDX на .NET Framework, .NET Core, Mono или COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать VSS в VSDX с помощью C#" %}}

 Чтобы преобразовать VSS в VSDX, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию VSS в VSDX через C#" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики .NET могут легко загружать и преобразовывать файлы VSS в VSDX, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузить файл VSS с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSDX в качестве параметров.1. VSDX файл будет сохранен по указанному пути
...
{{% blocks/products/pf/agp/code-block title="В этом примере кода показано преобразование VSS в VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для преобразования VSS в VSDX" sectionDescription="Проверьте наши живые демонстрации для [Преобразование VSS в VSDX](https://products.aspose.app/diagram/conversion/vss-to-vsdx) со следующими преимуществами." >}}
