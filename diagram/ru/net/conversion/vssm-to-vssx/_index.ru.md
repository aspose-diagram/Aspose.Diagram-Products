...
description: Пример кода для преобразования VSSM в VSSX C#. Используйте пример кода API для пакетного преобразования файлов VSSM в VSSX в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузите файл VSSM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSSX в качестве параметров.1. Файл VSSX будет сохранен по указанному пути
