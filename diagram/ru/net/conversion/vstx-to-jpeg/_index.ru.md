---
title: Преобразование VSTX в JPEG через C# 
weight: 2810
...
1. Загрузите файл VSTX с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.JPEG в качестве параметров.1. Файл JPEG будет сохранен по указанному пути
