...
description: Пример кода для преобразования VSTM в VSSM C#. Используйте пример кода API для пакетного преобразования файлов VSTM в VSSM в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузите файл VSTM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSSM в качестве параметров.1. Файл VSSM будет сохранен по указанному пути
