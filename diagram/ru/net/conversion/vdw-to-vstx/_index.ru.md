...
description: Пример кода для преобразования VDW в VSTX C#. Используйте пример кода API для пакетного преобразования файлов VDW в VSTX в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузить файл VDW с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSTX в качестве параметров.1. Файл VSTX будет сохранен по указанному пути
