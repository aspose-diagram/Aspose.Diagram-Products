...
description: Пример кода для преобразования VSTX в VSDM C#. Используйте пример кода API для пакетного преобразования VSTX файлов в VSDM в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузить файл VSTX с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSDM в качестве параметров.1. VSDM файл будет сохранен по указанному пути
