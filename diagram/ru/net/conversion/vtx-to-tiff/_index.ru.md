---
title: Преобразование VTX в TIFF через C# 
weight: 2820
...
{{% blocks/products/pf/agp/text %}}
 ...
 Разработчики .NET могут легко загружать и преобразовывать файлы VTX в формат TIFF, написав всего несколько строк кода.
