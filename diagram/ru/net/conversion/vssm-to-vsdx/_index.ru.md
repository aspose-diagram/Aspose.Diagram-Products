...
description: Пример кода для преобразования VSSM в VSDX C#. Используйте пример кода API для пакетного преобразования VSSM файлов в VSDX в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузить файл VSSM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSDX в качестве параметров.1. VSDX файл будет сохранен по указанному пути
