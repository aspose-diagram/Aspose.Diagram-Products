...
description: Пример кода для преобразования VDW в VDX C#. Используйте пример кода API для пакетного преобразования файлов VDW в VDX в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузить файл VDW с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VDX в качестве параметров.1. Файл VDX будет сохранен по указанному пути
