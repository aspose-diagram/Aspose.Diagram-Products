---
title: Разделить VSTX файлов через .NET 
weight: 1300
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по разделению VSTX файлов в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Разделить VSTX файлов - C#" offSpacer="" %}}
