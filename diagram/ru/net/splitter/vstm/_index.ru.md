---
title: Разделить VSTM файлов через .NET 
weight: 1300
url: /ru/net/splitter/vstm/ 
description: Исходный код C# для разделения файла vstm на платформах .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Шаги по разделению VSTM файлов в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Разделить VSTM файлов - C#" offSpacer="" %}}
