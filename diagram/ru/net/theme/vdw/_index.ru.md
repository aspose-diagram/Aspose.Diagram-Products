---
title: Применить предустановленную тему к документу VDW через .NET 
weight: 3050
url: /ru/net/theme/vdw/ 
description: Исходный код C# для применения предустановленной темы к файлу vdw на платформах .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Применить предустановленную тему к VDW в C#" h2="Собственная и высокопроизводительная версия применяет предустановленную тему к документу VDW с помощью API-интерфейсов Aspose.Diagram for .NET на стороне сервера без использования какого-либо программного обеспечения, такого как Microsoft или Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как применить предустановленную тему к файлу VDW с помощью C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по применению предустановленной темы к файлам VDW в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Применить предустановленную тему к файлам VDW — C#" offSpacer="" %}}
