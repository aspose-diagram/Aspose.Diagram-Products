---
title: Защитите и заблокируйте VDX документ через .NET 
weight: 5580
url: /ru/net/protect/vdx/ 
description: Исходный код C# для блокировки файла VDX на платформах .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Защитить VDX файлов с помощью C#" h2="Защитите Visio, включая формат VDX, с помощью библиотеки .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как защитить файл VDX с помощью C#" %}}

 Чтобы защитить файл VDX, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по защите VDX файлов в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Защитить файлы VDX – C#" offSpacer="" %}}
