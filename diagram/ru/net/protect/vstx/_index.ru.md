---
title: Защитите и заблокируйте VSTX документ через .NET 
weight: 5580
url: /ru/net/protect/vstx/ 
description: Исходный код C# для блокировки файла VSTX на платформах .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Защитить VSTX файлов с помощью C#" h2="Защитите электронные таблицы Visio, включая формат VSTX, с помощью библиотеки .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как защитить файл VSTX с помощью C#" %}}

 Чтобы защитить файл VSTX, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по защите VSTX файлов в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Защитить файлы VSTX – C#" offSpacer="" %}}
