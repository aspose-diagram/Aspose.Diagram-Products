---
title: Защитите и заблокируйте VTX документ через .NET 
weight: 5580
url: /ru/net/protect/vtx/ 
description: Исходный код C# для блокировки файла VTX на платформах .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Защитить VTX файлов с помощью C#" h2="Защитите Visio, включая формат VTX, с помощью библиотеки .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как защитить файл VTX с помощью C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Защитить файлы VTX – C#" offSpacer="" %}}
