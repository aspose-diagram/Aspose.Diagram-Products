---
title: Защитите и заблокируйте документ VST через .NET 
weight: 5580
url: /ru/net/protect/vst/ 
description: Исходный код C# для блокировки файла VST на платформах .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Защитите файлы VST с помощью C#" h2="Защитите Visio, включая формат VST, с помощью библиотеки .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как защитить файл VST с помощью C#" %}}

 Чтобы защитить файл VST, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по защите файлов VST в C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Защитить VST-файлы — C#" offSpacer="" %}}
