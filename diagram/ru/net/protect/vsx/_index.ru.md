---
title: Защитите и заблокируйте VSX документ через .NET 
weight: 5580
url: /ru/net/protect/vsx/ 
description: Исходный код C# для блокировки файла VSX на платформах .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Защитить VSX файлов с помощью C#" h2="Защитите Visio, включая формат VSX, с помощью библиотеки .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Как защитить файл VDW с помощью C#" %}}
 ...
 Чтобы защитить файл VSX, мы будем использовать
...
{{% blocks/products/pf/agp/code-block title="Защитить файлы VSX – C#" offSpacer="" %}}
