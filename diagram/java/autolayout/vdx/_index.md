---
title: Auto layout VDX document via Java 
weight: 3050
url: /Java/autolayout/vdx/ 
description: Java source code to auto layout vdx file on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Auto layout VDX document in Java" h2="Native and high performance auto layout VDX document using server-side Aspose.Diagram for Java APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Auto Layout VDX File Using Java" %}}

 In order to auto layout VDX file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Auto Layout VDX Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Auto Layout VDX Files - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram is a Microsoft Visio document format manipulation API. One can easily load, create, modify, manipulate including daigram elements and convert Visio diagrams to other formats such as PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF and more. It is a standalone API and does not require Microsoft Visio or any other software to be installed.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VDX Auto Layout Live Demos" sectionDescription="Auto Layout VDX documents right now by visiting our [Live Demos website](https://products.aspose.app/diagram/autolayout). The live demo has the following benefits" >}}
