...
description: Sample Java conversion code for VDX format to BMP file. Use this example code to convert VDX to BMP within any Web or Desktop Java based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert VDX to BMP via Java" h2="Export Microsoft Visio VDX to BMP using native Java library." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java developers can easily convert VDX file to BMP in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="VDX to BMP Java Conversion Source Code" offSpacer="" %}}
