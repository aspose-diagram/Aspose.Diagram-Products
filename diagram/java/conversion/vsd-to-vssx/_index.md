---
title: Convert VSD to VSSX via Java 
weight: 4650
...
{{< blocks/products/pf/upper-banner h1="Convert VSD to VSSX via Java" h2="Native Java library to export Microsoft Visio VSD to VSSX." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert VSD to VSSX Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert VSD to VSSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Diagram API makes it easy for the developers to convert VSD file to VSSX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Convert VSD to VSSX - Java‎" offSpacer="" %}}
