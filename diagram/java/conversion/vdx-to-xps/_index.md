---
title: Convert VDX to XPS via Java 
weight: 220
url: /java/conversion/vdx-to-xps/ 
description: Try our On-Premise APIs for your document conversion on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert VDX to XPS via Java" h2="Native Java library to export Microsoft Visio VDX to XPS." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert VDX to XPS Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert VDX to XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Diagram API makes it easy for the developers to convert VDX file to XPS in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="Convert VDX to XPS - Java‎" offSpacer="" %}}
