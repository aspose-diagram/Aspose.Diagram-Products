---
title: Merge VSDX Files via Java 
weight: 760
url: /java/merger/vsdx/ 
description: Try our On-Premise document merger APIs to combine VSDX documents on Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge VSDX Formats in Java" h2="Native VSDX document merger using server-side Java APIs." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge VSDX Files Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Merging VSDX Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Merge VSDX Files - Java" offSpacer="" %}}
