---
title: ปลดล็อกเอกสาร VSD ผ่าน .NET 
weight: 5680
url: /th/net/unlock/vsd/ 
description: C# ซอร์สโค้ดเพื่อปลดล็อก VSD ไฟล์บน .NET Framework, .NET Core, Mono Platforms
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ปลดล็อก VSD ไฟล์ผ่าน C#" h2="ลบการป้องกันจาก Visio รวมถึงรูปแบบ VSD โดยใช้ .NET Library" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีปลดล็อก VSD ไฟล์โดยใช้ C#" %}}

 เพื่อปลดล็อกไฟล์ VSD เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการปลดล็อก VSD ไฟล์ใน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ปลดล็อก VSD ไฟล์ - C#" offSpacer="" %}}
