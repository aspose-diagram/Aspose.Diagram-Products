---
title: แปลง VSSX เป็น PDF ผ่าน C# 
weight: 800
url: /th/net/conversion/vssx-to-pdf/ 
description: โค้ดตัวอย่างสำหรับการแปลง VSSX เป็น PDF C# ใช้โค้ดตัวอย่าง API สำหรับไฟล์แบทช์ VSSX เพื่อแปลงเป็น PDF ภายใน VB.NET, Asp.NET หรือแอปพลิเคชันที่ใช้ .NET
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง VSSX เป็น PDF ผ่าน C#" h2="ส่งออกไฟล์ Microsoft® Visio VSSX เป็น PDF บน .NET Framework, .NET Core, Mono หรือ COM Interop" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง VSSX เป็น PDF โดยใช้ C#" %}}

 ในการแปลง VSSX เป็น PDF เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง VSSX เป็น PDF ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET นักพัฒนาซอฟต์แวร์สามารถโหลดและแปลงไฟล์ VSSX เป็น PDF ได้อย่างง่ายดายโดยใช้โค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ VSSX ด้วยอินสแตนซ์ของ Diagram class1. เรียกใช้เมธอด Diagram.Save ด้วยพาธไฟล์เอาต์พุตและ SaveFileFormat.PDF เป็นพารามิเตอร์1. ไฟล์ PDF จะถูกบันทึกตามเส้นทางที่ระบุ
...
{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่างนี้แสดงการแปลง VSSX เป็น PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="แอพฟรีสำหรับแปลง VSSX เป็น PDF" sectionDescription="ตรวจสอบการสาธิตสดของเราสำหรับ [การแปลง VSSX เป็น PDF](https://products.aspose.app/diagram/conversion/vssx-to-pdf) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
