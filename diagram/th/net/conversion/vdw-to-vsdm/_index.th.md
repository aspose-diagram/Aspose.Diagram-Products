---
title: แปลง VDW เป็น VSDM ผ่าน C# 
weight: 2500
url: /th/net/conversion/vdw-to-vsdm/ 
description: โค้ดตัวอย่างสำหรับการแปลง VDW เป็น VSDM C# ใช้โค้ดตัวอย่าง API สำหรับไฟล์แบตช์ VDW เป็น VSDM การแปลงภายใน VB.NET, Asp.NET หรือแอปพลิเคชันที่ใช้ .NET
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง VDW เป็น VSDM ผ่าน C#" h2="ส่งออกไฟล์ Microsoft® Visio VDW เป็น VSDM บน .NET Framework, .NET Core, Mono หรือ COM Interop" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง VDW เป็น VSDM โดยใช้ C#" %}}

 ในการแปลง VDW เป็น VSDM เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง VDW เป็น VSDM ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET นักพัฒนาซอฟต์แวร์สามารถโหลดและแปลงไฟล์ VDW เป็น VSDM ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ VDW ด้วยอินสแตนซ์ของ Diagram class1. เรียก Diagram.Save method ด้วยพาธไฟล์เอาต์พุตและ SaveFileFormat.VSDM เป็นพารามิเตอร์1. VSDM ไฟล์จะถูกบันทึกที่เส้นทางที่ระบุ
...
{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่างนี้แสดง VDW ถึง VSDM C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="แอพฟรีสำหรับแปลง VDW เป็น VSDM" sectionDescription="ตรวจสอบการสาธิตสดของเราสำหรับ [VDW เป็น VSDM แปลง](https://products.aspose.app/diagram/conversion/vdw-to-vsdm) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
