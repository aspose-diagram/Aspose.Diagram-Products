...
description: โค้ดตัวอย่างสำหรับการแปลง VSSX ถึง VDX C# ใช้ API โค้ดตัวอย่างสำหรับแบตช์ VSSX ไฟล์เป็น VDX การแปลงภายใน VB.NET, Asp.NET หรือแอปพลิเคชันตาม .NET ใดๆ
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 นักพัฒนา .NET สามารถโหลดและแปลงไฟล์ VSSX เป็น VDX ได้อย่างง่ายดายในโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ VSSX ด้วยอินสแตนซ์ของ Diagram class1. เรียก Diagram.Save method ด้วยพาธไฟล์เอาต์พุตและ SaveFileFormat.VDX เป็นพารามิเตอร์1. VDX ไฟล์จะถูกบันทึกที่เส้นทางที่ระบุ
...
{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่างนี้แสดงการแปลง VSSX ถึง VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="แอปฟรีสำหรับแปลง VSSX เป็น VDX" sectionDescription="ตรวจสอบการสาธิตสดของเราสำหรับ [VSSX เป็น VDX แปลง](https://products.aspose.app/diagram/conversion/vssx-to-vdx) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
