---
title: แปลง VSSM เป็น VSTM ผ่าน C# 
weight: 2330
url: /th/net/conversion/vssm-to-vstm/ 
description: โค้ดตัวอย่างสำหรับการแปลง VSSM ถึง VSTM C# ใช้ API โค้ดตัวอย่างสำหรับแบตช์ VSSM ไฟล์เป็น VSTM การแปลงภายใน VB.NET, Asp.NET หรือแอปพลิเคชันตาม .NET ใดๆ
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แปลง VSSM เป็น VSTM ผ่าน C#" h2="ส่งออกไฟล์ Microsoft® Visio VSSM เป็น VSTM บน .NET Framework, .NET Core, Mono หรือ COM Interop" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง VSSM เป็น VSTM โดยใช้ C#" %}}

 ในการแปลง VSSM เป็น VSTM เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง VSSM เป็น VSTM ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 นักพัฒนา .NET สามารถโหลดและแปลงไฟล์ VSSM เป็น VSTM ได้อย่างง่ายดายในโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ VSSM ด้วยอินสแตนซ์ของ Diagram class1. เรียก Diagram.Save method ด้วยพาธไฟล์เอาต์พุตและ SaveFileFormat.VSTM เป็นพารามิเตอร์1. VSTM ไฟล์จะถูกบันทึกที่เส้นทางที่ระบุ
...
{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่างนี้แสดงการแปลง VSSM ถึง VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="แอปฟรีสำหรับแปลง VSSM เป็น VSTM" sectionDescription="ตรวจสอบการสาธิตสดของเราสำหรับ [VSSM เป็น VSTM แปลง](https://products.aspose.app/diagram/conversion/vssm-to-vstm) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
