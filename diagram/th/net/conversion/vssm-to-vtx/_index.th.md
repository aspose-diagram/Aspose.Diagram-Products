---
title: แปลง VSSM เป็น VTX ผ่าน C# 
weight: 4960
url: /th/net/conversion/vssm-to-vtx/ 
description: โค้ดตัวอย่างสำหรับการแปลง VSSM ถึง VTX C# ใช้ API โค้ดตัวอย่างสำหรับแบตช์ VSSM ไฟล์เป็น VTX การแปลงภายใน VB.NET, Asp.NET หรือแอปพลิเคชันตาม .NET ใดๆ
---
...
{{% blocks/products/pf/agp/content h2="วิธีแปลง VSSM เป็น VTX โดยใช้ C#" %}}

 ในการแปลง VSSM เป็น VTX เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง VSSM เป็น VTX ผ่าน C#" %}}

{{% blocks/products/pf/agp/text %}}

 นักพัฒนา .NET สามารถโหลดและแปลงไฟล์ VSSM เป็น VTX ได้อย่างง่ายดายในโค้ดเพียงไม่กี่บรรทัด

{{% /blocks/products/pf/agp/text %}}

1. โหลดไฟล์ VSSM ด้วยอินสแตนซ์ของ Diagram class1. เรียก Diagram.Save method ด้วยพาธไฟล์เอาต์พุตและ SaveFileFormat.VTX เป็นพารามิเตอร์1. VTX ไฟล์จะถูกบันทึกที่เส้นทางที่ระบุ
...
{{% blocks/products/pf/agp/code-block title="โค้ดตัวอย่างนี้แสดงการแปลง VSSM ถึง VTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="แอปฟรีสำหรับแปลง VSSM เป็น VTX" sectionDescription="ตรวจสอบการสาธิตสดของเราสำหรับ [VSSM เป็น VTX แปลง](https://products.aspose.app/diagram/conversion/vssm-to-vtx) พร้อมสิทธิประโยชน์ดังต่อไปนี้" >}}
