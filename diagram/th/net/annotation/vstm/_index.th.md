---
title: เพิ่ม แก้ไข และลบคำอธิบายประกอบจาก VSTM ผ่าน C# 
weight: 3050
url: /th/net/annotation/vstm/ 
description: C# ซอร์สโค้ดสำหรับใส่คำอธิบายประกอบไฟล์ VSTM บน .NET Framework, .NET Core, Mono Platforms
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="วิธีการใส่คำอธิบายประกอบ VSTM ไฟล์โดยใช้ C#" h2="การทำหมายเหตุประกอบเอกสาร VSTM ดั้งเดิมและประสิทธิภาพสูงโดยใช้ API ฝั่งเซิร์ฟเวอร์ Aspose.Diagram for .NET โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีการใส่คำอธิบายประกอบ VSTM ไฟล์โดยใช้ C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนสำหรับใส่คำอธิบายประกอบ VSTM ไฟล์ใน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ลบความคิดเห็นจาก VSTM ไฟล์ - C#" offSpacer="" %}}
