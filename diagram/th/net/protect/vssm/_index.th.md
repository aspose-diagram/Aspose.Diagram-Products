---
title: ป้องกันและล็อกเอกสาร VSSM ผ่าน .NET 
weight: 5580
url: /th/net/protect/vssm/ 
description: C# ซอร์สโค้ดเพื่อล็อกไฟล์ VSSM บนแพลตฟอร์ม .NET Framework, .NET Core, Mono
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="ปกป้อง VSSM ไฟล์ผ่าน C#" h2="ป้องกัน Visio รวมถึงรูปแบบ VSSM โดยใช้ .NET Library" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีป้องกันไฟล์ VSSM โดยใช้ C#" %}}

 เพื่อป้องกันไฟล์ VSSM เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการปกป้องไฟล์ VSSM ใน C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ปกป้อง VSSM ไฟล์ - C#" offSpacer="" %}}
