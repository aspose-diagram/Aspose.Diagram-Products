---
title: วาดเรขาคณิตไปที่เอกสาร VSTM ผ่าน Java 
weight: 3050
url: /th/Java/drawing/vstm/ 
description: Java ซอร์สโค้ดเพื่อวาด geomtry ไปยังไฟล์ vstm บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="วาด Geomtry ไปที่ VSTM ใน Java" h2="เนทีฟและมีประสิทธิภาพสูงวาด geomtry ไปยังเอกสาร VSTM โดยใช้ API ฝั่งเซิร์ฟเวอร์ Aspose.Diagram for Java โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีการวาด Geomtry ไปยัง VSTM ไฟล์โดยใช้ Java" %}}

 ในการวาด geomtry ไปยังไฟล์ VSTM เราจะใช้
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการวาด Geomtry ไปที่ VSTM ไฟล์ใน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="วาด Geomtry ไปที่ VSTM ไฟล์ - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram คือการจัดการรูปแบบเอกสาร Microsoft Visio API สามารถโหลด สร้าง แก้ไข จัดการ ซึ่งรวมถึงองค์ประกอบไดแกรมและแปลงไดอะแกรม Visio เป็นรูปแบบอื่นๆ เช่น PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF และอื่นๆ ได้อย่างง่ายดาย เป็นแบบสแตนด์อโลน API และไม่ต้องติดตั้ง Microsoft Visio หรือซอฟต์แวร์อื่นใด  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="วาด Geomtry ออนไลน์เพื่อ VSTM จัดทำเอกสารสาธิตสด" sectionDescription="วาด geomtry ไปที่เอกสาร VSTM ทันทีโดยไปที่ [เว็บไซต์สาธิตสด](https://products.aspose.app/diagram/drawing). การสาธิตสดมีประโยชน์ดังต่อไปนี้" >}}
