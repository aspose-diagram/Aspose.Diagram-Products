---
title: รวมไฟล์ VSSX ผ่าน Java 
weight: 2720
url: /th/java/merger/vssx/ 
description: Java โค้ดตัวอย่างเพื่อรวมเอกสาร VSSX บน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="รวมรูปแบบ VSSX ใน Java" h2="การรวมเอกสาร VSSX ดั้งเดิมโดยใช้ API ฝั่งเซิร์ฟเวอร์ Java" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีผสานไฟล์ VSSX โดยใช้ Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการรวมไฟล์ VSSX ใน Java" %}}
...
+ โหลดเอกสาร VSSX ที่สองด้วยอินสแตนซ์ของคลาส Diagram
+ ผสานไฟล์โดยใช้วิธีรวม ()
+ บันทึกไฟล์ VSSX ที่ผสานที่เส้นทางที่ระบุ
...
{{% blocks/products/pf/agp/code-block title="รวมไฟล์ VSSX - Java" offSpacer="" %}}
