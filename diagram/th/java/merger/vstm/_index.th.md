---
title: รวม VSTM ไฟล์ผ่าน Java 
weight: 3750
url: /th/java/merger/vstm/ 
description: Java ตัวอย่างโค้ดเพื่อรวมเอกสาร VSTM ใน Java Runtime Environment สำหรับแอปพลิเคชัน JSP/JSF และแอปพลิเคชันเดสก์ท็อป
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="รวม VSTM รูปแบบใน Java" h2="การรวมเอกสารดั้งเดิม VSTM โดยใช้ Java API ฝั่งเซิร์ฟเวอร์" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีรวมไฟล์ VSTM โดยใช้ Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการรวม VSTM ไฟล์ใน Java" %}}
...
{{% blocks/products/pf/agp/code-block title="รวม VSTM ไฟล์ - Java" offSpacer="" %}}
