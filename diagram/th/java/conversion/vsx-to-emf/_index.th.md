...
{{% blocks/products/pf/agp/text %}}
 ...
 นักพัฒนา Java สามารถแปลงไฟล์ VSX เป็น EMF ได้อย่างง่ายดายด้วยโค้ดเพียงไม่กี่บรรทัด
...
{{% blocks/products/pf/agp/code-block title="VSX ถึง EMF Java รหัสแหล่งที่มาของการแปลง" offSpacer="" %}}
