...
weight: 4630
url: /th/python-java/ 
description: Aspose.Diagram สำหรับ Python ผ่าน Java เป็น visio javascript API เพื่ออ่าน เขียน และแปลง Microsoft Visio เอกสารต่างๆ เช่น VSDX, VDX และรูปแบบอื่นๆ
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python Visio ไฟล์ API" h2="สร้าง อ่าน เขียน และส่งออก Microsoft Visio รูปแบบต่างๆ รวมถึง VSDX, VDX, VSX, VTX และรูปแบบอื่นๆ โดยใช้ Python API" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/headers/aspose_diagram-for-python-java.svg" pfName="Aspose.Diagram " subTitlepfName="for Python via Java" downloadUrl="https://downloads.aspose.com/diagram/python" >}}
...
<p>
 Aspose.Diagram สำหรับ Python ผ่าน Java เป็นโซลูชันการจัดการเอกสาร Microsoft Visio หนึ่งสามารถอ่าน เขียน ป้องกัน ส่งออกและพิมพ์รูปแบบเนทีฟ Visio รวมทั้งสนับสนุนรูปแบบภาพที่ใช้กันทั่วไปและรูปแบบการจัดวางคงที่ ง่ายต่อการโหลดไฟล์ที่มีอยู่ แก้ไของค์ประกอบไดอะแกรมเพื่อส่งออกเป็นรูปแบบที่ต้องการ รวมถึงรูปภาพหรือรูปแบบเค้าโครงคงที่ เช่น PDF หรือ XPS
</p>

<p>
 Aspose.Diagram สำหรับ Python ผ่าน Java เป็นแบบสแตนด์อโลน API และไม่ต้องการ Microsoft Visio หรือการติดตั้งซอฟต์แวร์อื่นๆ ยิ่งไปกว่านั้น งานบางอย่างที่สามารถทำได้ง่าย ๆ เช่น สร้างไดอะแกรมใหม่ทั้งหมด อ่านหรือเขียนรูปแบบต่างๆ เข้าถึงและอ่านคุณสมบัติต่างๆ รวมถึงสูตรอ็อบเจ็กต์ Visio การส่งออกไดอะแกรมไปยังหลายรูปแบบ พิมพ์ไดอะแกรมที่มีความเที่ยงตรงสูง และอื่นๆ อีกมากมาย
</p>
...
diagram.save("output.vsdx", SaveFileFormat.VSDX)</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Python ไดอะแกรม API อนุญาตให้อ่านรูปแบบดั้งเดิม Microsoft Visio รวมทั้งให้การเข้าถึงข้อมูลไดอะแกรม เช่น เอกสาร หน้า ต้นแบบ รูปร่าง สไตล์ชีต เชื่อมต่อ และอื่นๆ ออบเจ็กต์เหล่านี้สามารถจัดการได้ผ่าน API และสามารถเขียนผลลัพธ์ไปยังดิสก์ในรูปแบบที่รองรับได้
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
