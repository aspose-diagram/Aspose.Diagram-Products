---
title: รวมไฟล์ VSS ผ่าน Python 
weight: 230
url: /th/python-java/merger/vss/ 
description: Python โค้ดตัวอย่างเพื่อรวมเอกสาร VSS ภายในแอปพลิเคชันที่ใช้ Python 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="รวมรูปแบบ VSS ใน Python" h2="การรวมเอกสาร VSS ดั้งเดิมโดยใช้ API ฝั่งเซิร์ฟเวอร์ Python" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีผสานไฟล์ VSS โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการรวมไฟล์ VSS ใน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="รวมไฟล์ VSS - Python" offSpacer="" %}}
