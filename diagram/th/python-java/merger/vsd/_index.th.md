...
{{% blocks/products/pf/agp/content h2="วิธีรวมไฟล์ VSD โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการรวม VSD ไฟล์ใน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="รวม VSD ไฟล์ - Python" offSpacer="" %}}
