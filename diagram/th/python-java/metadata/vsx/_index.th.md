---
title: ดูหรือแก้ไข VSX ข้อมูลเมตาของไฟล์ผ่าน Python 
weight: 3150
url: /th/python-java/metadata/vsx/ 
description: Python ตัวอย่างโค้ดเพื่อแก้ไขหรือดูข้อมูลเมตาของ VSX ภายในแอปพลิเคชันที่ใช้ Python 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="แยกข้อมูลเมตา VSX ใน Python" h2="สร้างแอป Python ของคุณเองเพื่อเพิ่ม แก้ไข ลบ หรือแยกข้อมูลเมตาจากไฟล์ VSX " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีแยกข้อมูลเมตา VSX โดยใช้ Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแยกข้อมูลเมตา VSX ใน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="กำลังแยกข้อมูลเมตา VSX - Python" offSpacer="" %}}
