---
title: ดู VDX รูปแบบไฟล์ผ่าน Python 
weight: 3480
url: /th/python-java/viewer/vdx/ 
description: Python ซอร์สโค้ดเพื่อโหลด แสดงผล และแสดงเอกสาร VDX ภายในแอปพลิเคชันที่ใช้ Python
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDX โปรแกรมดูไฟล์สำหรับ Python" h2="โปรแกรมดูเอกสารดั้งเดิม VDX โดยใช้ API ฝั่งเซิร์ฟเวอร์ Python" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการดู VDX ผ่าน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python รหัสเพื่อดู VDX" offSpacer="" %}}

```cs

// โหลดไฟล์ VDX ผ่านอินสแตนซ์ของ Diagram
diagram =  Aspose.Diagram.Diagram("template.vdx");
// แปลง VDX เป็นรูปแบบ HTML จากนั้นโหลด HTML ที่เป็นผลลัพธ์ในเบราว์เซอร์เริ่มต้น
