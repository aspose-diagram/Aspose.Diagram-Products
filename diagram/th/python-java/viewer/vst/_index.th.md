---
title: ดูรูปแบบไฟล์ VST ผ่าน Python 
weight: 3480
url: /th/python-java/viewer/vst/ 
description: Python ซอร์สโค้ดสำหรับโหลด แสดงผล และแสดงเอกสาร VST ภายในแอปพลิเคชันที่ใช้ Python
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="โปรแกรมดูไฟล์ VST สำหรับ Python" h2="โปรแกรมดูเอกสาร VST ดั้งเดิมโดยใช้ API ฝั่งเซิร์ฟเวอร์ Python" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการดู VST ผ่าน Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python รหัสเพื่อดู VST" offSpacer="" %}}

```cs

// โหลดไฟล์ VST ผ่านอินสแตนซ์ของ Diagram
diagram =  Aspose.Diagram.Diagram("template.vst");
// แปลง VST เป็นรูปแบบ HTML จากนั้นโหลด HTML ที่เป็นผลลัพธ์ในเบราว์เซอร์เริ่มต้น
