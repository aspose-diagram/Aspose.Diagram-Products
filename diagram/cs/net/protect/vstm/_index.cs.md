---
title: Chránit a uzamknout dokument VSTM prostřednictvím .NET 
weight: 5580
url: /cs/net/protect/vstm/ 
description: Zdrojový kód C# k uzamčení souboru VSTM na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chránit soubory VSTM prostřednictvím C#" h2="Chránit Visio včetně formátu VSTM pomocí knihovny .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak chránit soubor VDW pomocí C#" %}}
 ...
 Za účelem ochrany souboru VSTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro ochranu VSTM souborů v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Chránit soubory VSTM – C#" offSpacer="" %}}
