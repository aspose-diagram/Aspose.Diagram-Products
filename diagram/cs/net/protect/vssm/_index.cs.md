---
title: Chránit a uzamknout dokument VSSM prostřednictvím .NET 
weight: 5580
url: /cs/net/protect/vssm/ 
description: Zdrojový kód C# k uzamčení souboru VSSM na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chránit soubory VSSM prostřednictvím C#" h2="Chránit Visio včetně formátu VSSM pomocí knihovny .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak chránit soubor VSSM pomocí C#" %}}

 Za účelem ochrany souboru VSSM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro ochranu VSSM souborů v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Chránit soubory VSSM – C#" offSpacer="" %}}
