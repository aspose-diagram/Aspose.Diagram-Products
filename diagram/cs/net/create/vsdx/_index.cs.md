---
title: Vytvořit VSDX souborů prostřednictvím C# 
url: /cs/net/create-vsdx/ 
description: C# Ukázkový kód pro generování VSDX dokumentů. Tento kód použijte k vytvoření VSDX souborů v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořit VSDX dokumentů prostřednictvím C#" h2="Nativní a vysoce výkonné vytváření VSDX (Portable Document Format) programově pomocí rozhraní API .NET na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="VSDX" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Jak vytvořit VSDX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Pro vývojáře je snadné vytvářet, načítat, upravovat a převádět VSDX v rámci různých aplikací pro vytváření sestav pro zpracování dat pomocí pouhých několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Zahrňte jmenný prostor do souboru třídy1. Vytvořte instanci třídy Diagram.1. Přejděte na první stránku diagram.1. Přidejte text na stránku.1. Pomocí metody Uložit uložte soubor diagram jako soubor VSDX.
...
{{% blocks/products/pf/agp/code-block title="Následující zdrojový kód ukazuje, jak vytvořit soubor VSDX pomocí C#." offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Knihovna programování Visio schopná vytvářet aplikace pro různé platformy se schopností generovat, upravovat, převádět, vykreslovat a tisknout soubory VSDX. .NET Visio API nejen převádí mezi tabulkovými formáty, ale umí také vykreslovat Visio souborů jako obrázky, VSDX, HTML a další, takže je ideální volbou pro výměnu dokumentů ve standardních formátech.
