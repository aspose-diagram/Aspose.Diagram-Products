---
title: Přidat, upravit a odstranit poznámku z VSDM prostřednictvím C# 
weight: 3050
url: /cs/net/annotation/vsdm/ 
description: Zdrojový kód C# k anotaci souboru VSDM na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Jak anotovat soubor VSDM pomocí C#" h2="Nativní a vysoce výkonná anotace dokumentu VSDM pomocí rozhraní API Aspose.Diagram for .NET na straně serveru, bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak anotovat soubor VSDM pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro anotaci souborů VSDM v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Smazat komentář ze souborů VSDM – C#" offSpacer="" %}}
