...
description: Zdrojový kód C# pro kombinaci dokumentů VSTX na platformě .NET Framework, .NET Core, Mono nebo COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Sloučit formáty VSTX v C#" h2="Nativní a vysoce výkonné slučování dokumentů VSTX pomocí rozhraní API Aspose.Diagram for .NET na straně serveru, bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro sloučení souborů VSTX v C#" %}}
...
+ Načtěte všechny soubory VSTX s úplnou cestou.
...
+ Nyní můžete otevřít a používat soubor VSTX v Microsoft Office, Adobe PDF nebo jakémkoli jiném kompatibilním programu.
