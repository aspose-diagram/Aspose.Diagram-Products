---
title: Sloučit soubory VSDX přes .NET 
weight: 460
url: /cs/net/merger/vsdx/ 
description: Zdrojový kód C# pro kombinaci VSDX dokumentů na .NET Framework, .NET Core, Mono nebo COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Sloučit VSDX formátů v C#" h2="Nativní a vysoce výkonné VSDX slučování dokumentů pomocí rozhraní API Aspose.Diagram for .NET na straně serveru, bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak sloučit soubor VSDX pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro sloučení VSDX souborů v C#" %}}
...
+ Načíst všechny soubory VSDX s úplnou cestou.
...
{{% blocks/products/pf/agp/code-block title="Sloučit soubory VSDX – C#" offSpacer="" %}}
