...
{{% blocks/products/pf/agp/content h2="Jak sloučit soubor VSS pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro sloučení souborů VSS v C#" %}}
...
+ Načtěte všechny soubory VSS s úplnou cestou.
