---
title: Sloučit soubory VSSX přes .NET 
weight: 3770
url: /cs/net/merger/vssx/ 
description: Zdrojový kód C# pro kombinaci dokumentů VSSX na platformě .NET Framework, .NET Core, Mono nebo COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Sloučit formáty VSSX v C#" h2="Nativní a vysoce výkonné slučování dokumentů VSSX pomocí rozhraní API Aspose.Diagram for .NET na straně serveru bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak sloučit soubor VSSX pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro sloučení souborů VSSX v C#" %}}
...
+ Načtěte všechny soubory VSSX s úplnou cestou.
+ Vytvořte jeden dokument jako základní soubor
+ Zavolejte příslušnou metodu pro zřetězení a sloučení souborů jeden po druhém.
+ Zavolejte metodu Save() a předejte název souboru (úplnou cestu) a formát (VSSX) jako parametr.
+ Nyní můžete otevřít a používat soubor VSSX v Microsoft Office, Adobe PDF nebo jakémkoli jiném kompatibilním programu.
...
{{% blocks/products/pf/agp/code-block title="Sloučit soubory VSSX – C#" offSpacer="" %}}
