---
title: Vytvořit organizační schéma v dokumentu VDX prostřednictvím .NET 
weight: 3050
url: /cs/net/organizationchart/vdx/ 
description: Zdrojový kód C# k vytvoření organizačního diagramu v souboru vdx na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vytvořit organizační schéma v VDX v C#" h2="Nativní a vysoce výkonné vytváření organizačního schématu v dokumentu VDX pomocí rozhraní API Aspose.Diagram for .NET na straně serveru, bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit organizační schéma v souboru VDX pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vytvoření organizačního diagramu v VDX souborech v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vytvořit organizační schéma v souborech Vdx – C#" offSpacer="" %}}
