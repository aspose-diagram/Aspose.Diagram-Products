---
title: Vodoznak VSDM dokumentu prostřednictvím .NET 
weight: 3050
url: /cs/net/watermark/vsdm/ 
description: Zdrojový kód C# pro přidání vodoznaku do souboru vsdm na platformách .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit soubor vodoznaku VSDM pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vodoznakové soubory VSDM v C#" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram je Microsoft Visio manipulace s formátem dokumentu API. Lze snadno načítat, vytvářet, upravovat, manipulovat včetně prvků daigramu a převádět Visio diagramy do jiných formátů, jako jsou PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF a další. Je to samostatný API a nevyžaduje instalaci Microsoft Visio ani jiného softwaru.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online živé ukázky VSDM WaterMarker" sectionDescription="Dokumenty WaterMark VSDM právě teď navštivte naše [Web živé ukázky](https://products.aspose.app/diagram/watermark). Živé demo má následující výhody" >}}
