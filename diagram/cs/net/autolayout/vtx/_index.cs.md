---
title: Automatické rozložení dokumentu VTX prostřednictvím .NET 
weight: 3050
url: /cs/net/autolayout/vtx/ 
description: Zdrojový kód C# pro automatické rozložení souboru VTX na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Automatické rozložení dokumentu VTX v jazyce C#" h2="Nativní a vysoce výkonný dokument VTX s automatickým rozložením pomocí rozhraní API Aspose.Diagram for .NET na straně serveru, bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro automatické rozložení souborů VTX v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Automatické rozložení souborů VTX – C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram je manipulace s formátem dokumentu společnosti Microsoft VisioAPI. Lze snadno načítat, vytvářet, upravovat, manipulovat včetně prvků daigramu a převádět Visio diagramy do jiných formátů, jako jsou PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF a další. Jedná se o samostatný API a nevyžaduje instalaci Microsoft Visio ani jiného softwaru.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online živé ukázky automatického rozložení VTX" sectionDescription="Auto Layout VTX dokumenty právě teď, když navštívíte naše [Web živé ukázky](https://products.aspose.app/diagram/autolayout). Živé demo má následující výhody" >}}
