---
title: Automatické rozložení dokumentu VST prostřednictvím .NET 
weight: 3050
url: /cs/net/autolayout/vst/ 
description: Zdrojový kód C# do souboru vst s automatickým rozložením na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Automatické rozložení dokumentu VST v jazyce C#" h2="Nativní a vysoce výkonný dokument VST s automatickým rozložením pomocí rozhraní API Aspose.Diagram for .NET na straně serveru, bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak automaticky rozložit soubor VST pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro automatické rozvržení souborů VST v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Automatické rozložení souborů VST – C#" offSpacer="" %}}
