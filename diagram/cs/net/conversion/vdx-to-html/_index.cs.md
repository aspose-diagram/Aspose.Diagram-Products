---
title: Převést VDX na HTML pomocí C# 
weight: 2970
...
{{% blocks/products/pf/agp/content h2="Jak převést VDX do HTML pomocí C#" %}}
 ...
 K převodu VDX do HTML použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VDX na HTML prostřednictvím C#" %}}
...
1. Načtěte soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.HTML jako parametry1. Soubor HTML bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VDX na HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX do HTML" sectionDescription="Podívejte se na naše živé ukázky [Převod VDX do HTML](https://products.aspose.app/diagram/conversion/vdx-to-html) s následujícími výhodami." >}}
