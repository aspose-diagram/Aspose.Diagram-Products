---
title: Převést VSD na VSSM prostřednictvím C# 
weight: 1620
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VSD na VSSM prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD na VSSM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVSSM jako parametry1. Soubor VSSM bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na VSSM" sectionDescription="Podívejte se na naše živé ukázky [Konverze VSD na VSSM](https://products.aspose.app/diagram/conversion/vsd-to-vssm) s následujícími výhodami." >}}
