---
title: Převést VTX do PDF přes C# 
weight: 1570
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX do PDF prostřednictvím C#" %}}
...
1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.PDF jako parametry1. Soubor PDF bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX do PDF C#" offSpacer="" %}}
