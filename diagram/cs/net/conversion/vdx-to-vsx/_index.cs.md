...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VDX na VSX prostřednictvím C#" %}}
...
1. Načtěte soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSX jako parametry1. Soubor VSX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VDX na VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX na VSX" sectionDescription="Podívejte se na naše živé ukázky [Převod VDX na VSX](https://products.aspose.app/diagram/conversion/vdx-to-vsx) s následujícími výhodami." >}}
