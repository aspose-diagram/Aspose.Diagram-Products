---
title: Převést VTX na BMP prostřednictvím C# 
weight: 670
url: /cs/net/conversion/vtx-to-bmp/ 
description: Ukázkový kód pro konverzi VTX na BMP C#. Použijte API ukázkový kód pro dávkový převod souborů VTX na BMP v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VTX na BMP prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VTX do BMP na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na BMP pomocí C#" %}}

 Abychom převedli VTX do BMP, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VTX na BMP prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX do formátu BMP pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.BMP jako parametry1. Soubor BMP bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VTX na BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX do BMP" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na BMP](https://products.aspose.app/diagram/conversion/vtx-to-bmp) s následujícími výhodami." >}}
