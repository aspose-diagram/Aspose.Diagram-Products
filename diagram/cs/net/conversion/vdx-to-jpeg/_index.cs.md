---
title: Převést VDX na JPEG přes C# 
weight: 4760
...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na JPEG pomocí C#" %}}
 ...
 K převodu VDX do JPEG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VDX na JPEG přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VDX na JPEG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VDX s instancí třídy Diagram1. Volejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.JPEG jako parametry1. Soubor JPEG bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX do JPEG" sectionDescription="Podívejte se na naše živé ukázky [Převod VDX na JPEG](https://products.aspose.app/diagram/conversion/vdx-to-jpeg) s následujícími výhodami." >}}
