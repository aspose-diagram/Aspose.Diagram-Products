---
title: Převést VTX na VSTX prostřednictvím C# 
weight: 1250
url: /cs/net/conversion/vtx-to-vstx/ 
description: Ukázkový kód pro konverzi VTX na VSTX C#. Použijte API ukázkový kód pro dávkový převod souborů VTX na VSTX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VTX na VSTX prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VTX do VSTX na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na VSTX pomocí C#" %}}

 Abychom převedli VTX na VSTX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VTX na VSTX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX na VSTX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVSTX jako parametry1. Soubor VSTX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VTX na VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na VSTX" sectionDescription="Podívejte se na naše živé ukázky [Konverze VTX na VSTX](https://products.aspose.app/diagram/conversion/vtx-to-vstx) s následujícími výhodami." >}}
