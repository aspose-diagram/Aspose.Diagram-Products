...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na BMP pomocí C#" %}}
 ...
 K převodu VDX na BMP použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VDX na BMP prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VDX na BMP pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.BMP jako parametry1. Soubor BMP bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VDX na BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX na BMP" sectionDescription="Podívejte se na naše živé ukázky [Převod VDX na BMP](https://products.aspose.app/diagram/conversion/vdx-to-bmp) s následujícími výhodami." >}}
