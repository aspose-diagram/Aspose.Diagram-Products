---
title: Převést VSD na VSSX prostřednictvím C# 
weight: 2880
url: /cs/net/conversion/vsd-to-vssx/ 
description: Ukázkový kód pro konverzi VSD na VSSX C#. Použijte API ukázkový kód pro dávkový převod souborů VSD na VSSX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSD na VSSX prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VSD do VSSX na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSD na VSSX pomocí C#" %}}

 Abychom převedli VSD na VSSX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VSD na VSSX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD na VSSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVSSX jako parametry1. Soubor VSSX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VSD na VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na VSSX" sectionDescription="Podívejte se na naše živé ukázky [Konverze VSD na VSSX](https://products.aspose.app/diagram/conversion/vsd-to-vssx) s následujícími výhodami." >}}
