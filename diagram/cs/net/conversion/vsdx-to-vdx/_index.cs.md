---
title: Převést VSDX na VDX prostřednictvím C# 
weight: 130
url: /cs/net/conversion/vsdx-to-vdx/ 
description: Ukázkový kód pro konverzi VSDX na VDX C#. Použijte API ukázkový kód pro dávkový převod souborů VSDX na VDX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSDX na VDX prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VSDX do VDX na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSDX na VDX pomocí C#" %}}

 Abychom převedli VSDX na VDX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VSDX na VDX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSDX na VDX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVDX jako parametry1. Soubor VDX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VSDX na VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSDX na VDX" sectionDescription="Podívejte se na naše živé ukázky [Konverze VSDX na VDX](https://products.aspose.app/diagram/conversion/vsdx-to-vdx) s následujícími výhodami." >}}
