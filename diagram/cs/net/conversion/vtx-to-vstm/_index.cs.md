...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na VSTM pomocí C#" %}}
 ...
 K převodu VTX na VSTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VTX na VSTM prostřednictvím C#" %}}
...
1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSTM jako parametry1. Soubor VSTM bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na VSTM" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na VSTM](https://products.aspose.app/diagram/conversion/vtx-to-vstm) s následujícími výhodami." >}}
