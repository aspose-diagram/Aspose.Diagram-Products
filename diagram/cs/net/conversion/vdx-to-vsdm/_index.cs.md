...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VDX na VSDM přes C#" %}}
...
1. Načtěte soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSDM jako parametry1. Soubor VSDM bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VDX na VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX na VSDM" sectionDescription="Podívejte se na naše živé ukázky [Převod VDX na VSDM](https://products.aspose.app/diagram/conversion/vdx-to-vsdm) s následujícími výhodami." >}}
