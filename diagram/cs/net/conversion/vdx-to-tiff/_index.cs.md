---
title: Převést VDX na TIFF přes C# 
weight: 2920
...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na TIFF pomocí C#" %}}
 ...
 K převodu VDX na TIFF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VDX na TIFF přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VDX na TIFF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VDX s instancí třídy Diagram1. Volejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.TIFF jako parametry1. Soubor TIFF bude uložen do zadané cesty
