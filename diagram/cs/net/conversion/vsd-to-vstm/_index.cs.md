---
title: Převést VSD na VSTM prostřednictvím C# 
weight: 3960
url: /cs/net/conversion/vsd-to-vstm/ 
description: Ukázkový kód pro konverzi VSD na VSTM C#. Použijte API ukázkový kód pro dávkový převod souborů VSD na VSTM v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSD na VSTM prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VSD do VSTM na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSD na VSTM pomocí C#" %}}

 Abychom převedli VSD na VSTM, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSD na VSTM prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD do VSTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSTM jako parametry1. Soubor VSTM bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VSD na VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na VSTM" sectionDescription="Podívejte se na naše živé ukázky [Převod VSD na VSTM](https://products.aspose.app/diagram/conversion/vsd-to-vstm) s následujícími výhodami." >}}
