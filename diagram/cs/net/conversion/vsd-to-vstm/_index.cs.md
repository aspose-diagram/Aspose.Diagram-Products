...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VSD na VSTM prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD na VSTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVSTM jako parametry1. Soubor VSTM bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na VSTM" sectionDescription="Podívejte se na naše živé ukázky [Konverze VSD na VSTM](https://products.aspose.app/diagram/conversion/vsd-to-vstm) s následujícími výhodami." >}}
