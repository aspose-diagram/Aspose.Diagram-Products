...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na SVG pomocí C#" %}}
 ...
 K převodu VDX na SVG použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři .NET mohou snadno načíst a převést soubory VDX na SVG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.SVG jako parametry1. Soubor SVG bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VDX na SVG C#" offSpacer="" %}}
