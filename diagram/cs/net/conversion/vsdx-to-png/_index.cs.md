---
title: Převést VSDX na PNG prostřednictvím C# 
weight: 4920
url: /cs/net/conversion/vsdx-to-png/ 
description: Ukázkový kód pro konverzi VSDX na PNG C#. Použijte API ukázkový kód pro dávkový převod souborů VSDX na PNG v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSDX na PNG prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VSDX do PNG na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSDX na PNG pomocí C#" %}}

 Abychom převedli VSDX do PNG, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSDX na PNG prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSDX do formátu PNG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.PNG jako parametry1. Soubor PNG bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VSDX na PNG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSDX na PNG" sectionDescription="Podívejte se na naše živé ukázky [Převod VSDX na PNG](https://products.aspose.app/diagram/conversion/vsdx-to-png) s následujícími výhodami." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/conversion/vsdx-to-vstx/" name="VSDX DO VSTX" description="Microsoft Visio Šablona výkresu" >}}
