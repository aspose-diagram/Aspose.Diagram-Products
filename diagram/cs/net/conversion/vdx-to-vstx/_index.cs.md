...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na VSTX pomocí C#" %}}
 ...
 K převodu VDX na VSTX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VDX na VSTX prostřednictvím C#" %}}
...
1. Načtěte soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSTX jako parametry1. Soubor VSTX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VDX na VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX na VSTX" sectionDescription="Podívejte se na naše živé ukázky [Převod VDX na VSTX](https://products.aspose.app/diagram/conversion/vdx-to-vstx) s následujícími výhodami." >}}
