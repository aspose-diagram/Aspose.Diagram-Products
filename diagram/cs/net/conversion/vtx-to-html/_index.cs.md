...
{{% blocks/products/pf/agp/content h2="Jak převést VTX do HTML pomocí C#" %}}
 ...
 Abychom převedli VTX do HTML, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VTX do HTML pomocí C#" %}}
...
1. Načíst soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.HTML jako parametry1. Soubor HTML bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX do HTML" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na HTML](https://products.aspose.app/diagram/conversion/vtx-to-html) s následujícími výhodami." >}}
