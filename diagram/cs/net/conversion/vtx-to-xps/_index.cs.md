---
title: Převést VTX na XPS prostřednictvím C# 
weight: 4320
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři .NET mohou snadno načíst a převést soubory VTX do formátu XPS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.XPS jako parametry1. Soubor XPS bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VTX na XPS C#" offSpacer="" %}}
