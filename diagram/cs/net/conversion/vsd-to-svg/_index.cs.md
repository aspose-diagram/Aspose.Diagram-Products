...
{{% blocks/products/pf/agp/content h2="Jak převést VSD na SVG pomocí C#" %}}

 Abychom převedli VSD na SVG, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSD na SVG prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD do SVG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.SVG jako parametry1. Soubor SVG bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VSD na SVG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na SVG" sectionDescription="Podívejte se na naše živé ukázky [Převod VSD na SVG](https://products.aspose.app/diagram/conversion/vsd-to-svg) s následujícími výhodami." >}}
