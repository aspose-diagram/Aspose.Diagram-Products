...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na VSTM pomocí C#" %}}
 ...
 K převodu VDX na VSTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VDX na VSTM přes C#" %}}
...
1. Načtěte soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSTM jako parametry1. Soubor VSTM bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VDX na VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX na VSTM" sectionDescription="Podívejte se na naše živé ukázky [Převod VDX na VSTM](https://products.aspose.app/diagram/conversion/vdx-to-vstm) s následujícími výhodami." >}}
