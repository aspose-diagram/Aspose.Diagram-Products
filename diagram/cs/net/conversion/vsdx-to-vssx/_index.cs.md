---
title: Převést VSDX na VSSX prostřednictvím C# 
weight: 3270
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VSDX na VSSX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSDX na VSSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVSSX jako parametry1. Soubor VSSX bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSDX na VSSX" sectionDescription="Podívejte se na naše živé ukázky [Konverze VSDX na VSSX](https://products.aspose.app/diagram/conversion/vsdx-to-vssx) s následujícími výhodami." >}}
