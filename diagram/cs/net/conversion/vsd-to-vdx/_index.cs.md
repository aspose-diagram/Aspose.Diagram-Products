---
title: Převést VSD na VDX prostřednictvím C# 
weight: 3840
url: /cs/net/conversion/vsd-to-vdx/ 
description: Ukázkový kód pro konverzi VSD na VDX C#. Použijte API ukázkový kód pro dávkový převod souborů VSD na VDX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSD na VDX prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VSD do VDX na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSD na VDX pomocí C#" %}}

 Abychom převedli VSD na VDX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VSD na VDX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD na VDX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVDX jako parametry1. Soubor VDX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VSD na VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na VDX" sectionDescription="Podívejte se na naše živé ukázky [Konverze VSD na VDX](https://products.aspose.app/diagram/conversion/vsd-to-vdx) s následujícími výhodami." >}}
