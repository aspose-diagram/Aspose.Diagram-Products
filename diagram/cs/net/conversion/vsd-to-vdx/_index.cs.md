---
title: Převést VSD na VDX přes C# 
weight: 3840
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSD na VDX přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD do formátu VDX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VDX jako parametry1. Soubor VDX bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na VDX" sectionDescription="Podívejte se na naše živé ukázky [Převod VSD na VDX](https://products.aspose.app/diagram/conversion/vsd-to-vdx) s následujícími výhodami." >}}
