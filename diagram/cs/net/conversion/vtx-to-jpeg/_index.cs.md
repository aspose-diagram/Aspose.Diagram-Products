---
title: Převést VTX na JPEG prostřednictvím C# 
weight: 4730
url: /cs/net/conversion/vtx-to-jpeg/ 
description: Ukázkový kód pro převod VTX na JPEG C#. Použijte API ukázkový kód pro dávkový převod souborů VTX na JPEG v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VTX na JPEG prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VTX do JPEG na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na JPEG pomocí C#" %}}

 K převodu souboru VTX do formátu JPEG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VTX na JPEG prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX do formátu JPEG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VTX s instancí třídy Diagram1. Volejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.JPEG jako parametry1. Soubor JPEG bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na JPEG" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na JPEG](https://products.aspose.app/diagram/conversion/vtx-to-jpeg) s následujícími výhodami." >}}
