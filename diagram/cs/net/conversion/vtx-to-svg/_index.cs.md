...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na SVG pomocí C#" %}}
 ...
 K převodu VTX na SVG použijeme
...
{{% blocks/products/pf/agp/text %}}
 ...
 Vývojáři .NET mohou snadno načíst a převést soubory VTX na SVG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.SVG jako parametry1. Soubor SVG bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na SVG C#" offSpacer="" %}}
