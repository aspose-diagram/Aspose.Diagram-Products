---
title: Převést VSDX do HTML pomocí C# 
weight: 5270
url: /cs/net/conversion/vsdx-to-html/ 
description: Ukázkový kód pro převod VSDX na HTML C#. Použijte API ukázkový kód pro dávkový převod souborů VSDX do HTML v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSDX do HTML pomocí C#" h2="Exportujte soubory Microsoft® Visio VSDX do HTML na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSDX do HTML pomocí C#" %}}

 Abychom převedli VSDX do HTML, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSDX do HTML pomocí C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSDX do HTML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.HTML jako parametry1. Soubor HTML bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VSDX na HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSDX do HTML" sectionDescription="Podívejte se na naše živé ukázky [Převod VSDX na HTML](https://products.aspose.app/diagram/conversion/vsdx-to-html) s následujícími výhodami." >}}
