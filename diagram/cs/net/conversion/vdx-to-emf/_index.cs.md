---
title: Převést VDX na EMF prostřednictvím C# 
weight: 3440
url: /cs/net/conversion/vdx-to-emf/ 
description: Ukázkový kód pro konverzi VDX na EMF C#. Použijte API ukázkový kód pro dávkové soubory VDX na převod EMF v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VDX na EMF prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VDX do EMF na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na EMF pomocí C#" %}}

 Abychom převedli VDX na EMF, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VDX na EMF prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VDX do EMF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VDX s instancí třídy Diagram1. Volejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.EMF jako parametry1. Soubor EMF bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VDX na EMF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX na EMF" sectionDescription="Podívejte se na naše živé ukázky [Převod VDX na EMF](https://products.aspose.app/diagram/conversion/vdx-to-emf) s následujícími výhodami." >}}
