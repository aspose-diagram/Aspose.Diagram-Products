...
description: Ukázkový kód pro konverzi VTX na VSDX C#. Použijte API ukázkový kód pro dávkový převod souborů VTX na VSDX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na VSDX pomocí C#" %}}
 ...
 Abychom převedli VTX na VSDX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VTX na VSDX prostřednictvím C#" %}}
...
1. Načíst soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVSDX jako parametry1. Soubor VSDX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VTX na VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na VSDX" sectionDescription="Podívejte se na naše živé ukázky [Konverze VTX na VSDX](https://products.aspose.app/diagram/conversion/vtx-to-vsdx) s následujícími výhodami." >}}
