---
title: Převést VDX na VSDX prostřednictvím C# 
weight: 2190
url: /cs/net/conversion/vdx-to-vsdx/ 
description: Ukázkový kód pro konverzi VDX na VSDX C#. Použijte API ukázkový kód pro dávkový převod souborů VDX na VSDX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na VSDX pomocí C#" %}}
 ...
 Abychom převedli VDX na VSDX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VDX na VSDX prostřednictvím C#" %}}
...
1. Načíst soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVSDX jako parametry1. Soubor VSDX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VDX na VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX na VSDX" sectionDescription="Podívejte se na naše živé ukázky [Konverze VDX na VSDX](https://products.aspose.app/diagram/conversion/vdx-to-vsdx) s následujícími výhodami." >}}
