---
title: Převést VTX na XAML přes C# 
weight: 150
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na XAML pomocí C#" %}}

 Abychom převedli VTX na XAML, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na XAML prostřednictvím C#" %}}
...
1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.XAML jako parametry1. Soubor XAML bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na XAML C#" offSpacer="" %}}
