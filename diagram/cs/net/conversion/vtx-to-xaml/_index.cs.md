---
title: Převést VTX na XAML prostřednictvím C# 
weight: 150
url: /cs/net/conversion/vtx-to-xaml/ 
description: Ukázkový kód pro konverzi VTX na XAML C#. Použijte API ukázkový kód pro dávkový převod souborů VTX na XAML v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VTX na XAML prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VTX do XAML na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX do XAML pomocí C#" %}}

 Abychom převedli VTX do XAML, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VTX na XAML prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX do XAML pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.XAML jako parametry1. Soubor XAML bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VTX na XAML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX do XAML" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na XAML](https://products.aspose.app/diagram/conversion/vtx-to-xaml) s následujícími výhodami." >}}
