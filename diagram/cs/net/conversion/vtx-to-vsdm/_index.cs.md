---
title: Převést VTX na VSDM prostřednictvím C# 
weight: 3550
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VTX na VSDM prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX na VSDM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVSDM jako parametry1. Soubor VSDM bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VTX na VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na VSDM" sectionDescription="Podívejte se na naše živé ukázky [Konverze VTX na VSDM](https://products.aspose.app/diagram/conversion/vtx-to-vsdm) s následujícími výhodami." >}}
