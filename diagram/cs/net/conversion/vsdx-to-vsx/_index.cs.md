---
title: Převést VSDX na VSX prostřednictvím C# 
weight: 3370
url: /cs/net/conversion/vsdx-to-vsx/ 
description: Ukázkový kód pro konverzi VSDX na VSX C#. Použijte API ukázkový kód pro dávkový převod souborů VSDX na VSX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSDX na VSX prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VSDX do VSX na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSDX na VSX pomocí C#" %}}

 Abychom převedli VSDX na VSX, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VSDX na VSX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSDX na VSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormatVSX jako parametry1. Soubor VSX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VSDX na VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSDX na VSX" sectionDescription="Podívejte se na naše živé ukázky [Konverze VSDX na VSX](https://products.aspose.app/diagram/conversion/vsdx-to-vsx) s následujícími výhodami." >}}
