---
title: Převést VSD na XPS prostřednictvím C# 
weight: 660
url: /cs/net/conversion/vsd-to-xps/ 
description: Ukázkový kód pro konverzi VSD na XPS C#. Použijte API ukázkový kód pro dávkový převod souborů VSD na XPS v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSD na XPS prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VSD do XPS na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSD na XPS pomocí C#" %}}

 K převodu VSD na XPS použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSD na XPS prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD do formátu XPS pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.XPS jako parametry1. Soubor XPS bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VSD na XPS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na XPS" sectionDescription="Podívejte se na naše živé ukázky [Převod VSD na XPS](https://products.aspose.app/diagram/conversion/vsd-to-xps) s následujícími výhodami." >}}
