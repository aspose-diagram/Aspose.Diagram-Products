---
title: Převést VSD na EMF prostřednictvím C# 
weight: 4710
url: /cs/net/conversion/vsd-to-emf/ 
description: Ukázkový kód pro konverzi VSD na EMF C#. Použijte API ukázkový kód pro dávkové soubory VSD na převod EMF v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSD na EMF prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VSD do EMF na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSD na EMF pomocí C#" %}}

 Abychom převedli VSD na EMF, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSD na EMF prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD do EMF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Volejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.EMF jako parametry1. Soubor EMF bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VSD na EMF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na EMF" sectionDescription="Podívejte se na naše živé ukázky [Převod VSD na EMF](https://products.aspose.app/diagram/conversion/vsd-to-emf) s následujícími výhodami." >}}
