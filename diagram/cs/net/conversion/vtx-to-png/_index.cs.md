---
title: Převést VTX na PNG prostřednictvím C# 
weight: 2790
url: /cs/net/conversion/vtx-to-png/ 
description: Ukázkový kód pro konverzi VTX na PNG C#. Použijte API ukázkový kód pro dávkový převod souborů VTX na PNG v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VTX na PNG prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VTX do PNG na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na PNG pomocí C#" %}}

 Abychom převedli VTX do PNG, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VTX na PNG prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX do formátu PNG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.PNG jako parametry1. Soubor PNG bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na PNG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na PNG" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na PNG](https://products.aspose.app/diagram/conversion/vtx-to-png) s následujícími výhodami." >}}
