---
title: Převést VSDX na TIFF prostřednictvím C# 
weight: 4790
url: /cs/net/conversion/vsdx-to-tiff/ 
description: Ukázkový kód pro převod VSDX na TIFF C#. Použijte API ukázkový kód pro dávkový převod souborů VSDX na TIFF v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSDX na TIFF prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VSDX do TIFF na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSDX na TIFF pomocí C#" %}}

 Abychom převedli VSDX na TIFF, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSDX na TIFF prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSDX do formátu TIFF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSDX s instancí třídy Diagram1. Volejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.TIFF jako parametry1. Soubor TIFF bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VSDX na TIFF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSDX na TIFF" sectionDescription="Podívejte se na naše živé ukázky [Převod VSDX na TIFF](https://products.aspose.app/diagram/conversion/vsdx-to-tiff) s následujícími výhodami." >}}
