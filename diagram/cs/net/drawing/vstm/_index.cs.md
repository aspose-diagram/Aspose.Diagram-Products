---
title: Kreslit geometrii do dokumentu VSTM prostřednictvím .NET 
weight: 3050
url: /cs/net/drawing/vstm/ 
description: Zdrojový kód C# pro kreslení geometrie do souboru vstm na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Kreslit geometrii do VSTM v C#" h2="Nativní a vysoce výkonné vykreslování geometrie do dokumentu VSTM pomocí rozhraní API Aspose.Diagram for .NET na straně serveru, bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak nakreslit geomtry do souboru VSTM pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro Draw Geomtry do souborů VSTM v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Draw Geomtry to VSTM Files – C#" offSpacer="" %}}
