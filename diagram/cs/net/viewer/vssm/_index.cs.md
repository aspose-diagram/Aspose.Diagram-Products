---
title: Zobrazit VSSM formátů souborů prostřednictvím .NET 
weight: 3180
url: /cs/net/viewer/vssm/ 
description: C# zdrojový kód pro načtení, vykreslení a zobrazení VSSM dokumentů na .NET Framework, .NET Core, Mono nebo COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSM Prohlížeč souborů for .NET" h2="Zobrazte Microsoft Visio VSSM souborů v prohlížeči bez nutnosti aplikace Visio nebo automatizace Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/code-block title="C# kód k zobrazení VSSM" offSpacer="" %}}
