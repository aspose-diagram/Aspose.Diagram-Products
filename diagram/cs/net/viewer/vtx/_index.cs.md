---
title: Zobrazit VTX formátů souborů prostřednictvím .NET 
weight: 3320
url: /cs/net/viewer/vtx/ 
description: C# zdrojový kód pro načtení, vykreslení a zobrazení VTX dokumentů na .NET Framework, .NET Core, Mono nebo COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VTX Prohlížeč souborů for .NET" h2="Zobrazte Microsoft Visio VTX souborů v prohlížeči bez nutnosti aplikace Visio nebo automatizace Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/code-block title="C# kód k zobrazení VTX" offSpacer="" %}}
