---
title: Odemknout dokument VSDM prostřednictvím .NET 
weight: 5680
url: /cs/net/unlock/vsdm/ 
description: Zdrojový kód C# k odemknutí souboru VSDM na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odemknout VSDM souborů prostřednictvím C#" h2="Odstraňte ochranu z formátu Visio včetně VSDM pomocí knihovny .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak odemknout soubor VSDM pomocí C#" %}}

 K odemknutí souboru VSDM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro odemknutí VSDM souborů v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Odemknout VSDM souborů – C#" offSpacer="" %}}
