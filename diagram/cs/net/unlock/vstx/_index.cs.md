---
title: Odemknout dokument VSTX prostřednictvím .NET 
weight: 5680
url: /cs/net/unlock/vstx/ 
description: Zdrojový kód C# k odemknutí souboru VSTX na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odemknout VSTX souborů prostřednictvím C#" h2="Odstraňte ochranu z formátu Visio včetně VSTX pomocí knihovny .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak odemknout soubor VSTX pomocí C#" %}}

 K odemknutí souboru VSTX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro odemknutí VSTX souborů v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Odemknout VSTX souborů – C#" offSpacer="" %}}
