...
{{% blocks/products/pf/agp/content h2="Jak odemknout soubor VSTM pomocí C#" %}}

 K odemknutí souboru VSTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro odemknutí VSTM souborů v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Odemknout VSTM souborů – C#" offSpacer="" %}}
