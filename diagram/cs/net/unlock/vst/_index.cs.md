---
title: Odemknout dokument VST přes .NET 
weight: 5680
url: /cs/net/unlock/vst/ 
description: Zdrojový kód C# k odemknutí souboru VST na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Odemknout soubory VST přes C#" h2="Odeberte ochranu z Visio včetně formátu VST pomocí knihovny .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak odemknout soubor VST pomocí C#" %}}

 Abychom odemkli soubor VST, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro odemknutí souborů VST v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Odemknout soubory VST – C#" offSpacer="" %}}
