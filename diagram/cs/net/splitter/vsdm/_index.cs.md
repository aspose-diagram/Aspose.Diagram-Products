---
title: Rozdělit VSDM souborů prostřednictvím .NET 
weight: 1300
url: /cs/net/splitter/vsdm/ 
description: Zdrojový kód C# k rozdělení souboru vsdm na platformách .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro rozdělení VSDM souborů v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Rozdělit VSDM souborů – C#" offSpacer="" %}}
