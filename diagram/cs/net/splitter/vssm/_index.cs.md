---
title: Rozdělit VSSM souborů prostřednictvím .NET 
weight: 1300
url: /cs/net/splitter/vssm/ 
description: Zdrojový kód C# k rozdělení souboru vssm na platformách .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro rozdělení VSSM souborů v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Rozdělit VSSM souborů – C#" offSpacer="" %}}
