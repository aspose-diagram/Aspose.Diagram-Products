---
title: Rozdělit VSTM souborů prostřednictvím .NET 
weight: 1300
url: /cs/net/splitter/vstm/ 
description: Zdrojový kód C# k rozdělení souboru vstm na platformách .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro rozdělení VSTM souborů v C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Rozdělit VSTM souborů – C#" offSpacer="" %}}
