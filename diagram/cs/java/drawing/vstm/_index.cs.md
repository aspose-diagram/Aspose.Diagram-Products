...
{{% blocks/products/pf/agp/content h2="Jak nakreslit geomtry do souboru VSTM pomocí Java" %}}

 K vykreslení geometrie do souboru VSTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro Draw Geomtry do souborů VSTM v Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Draw Geomtry to VSTM Files – Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram je Microsoft Visio manipulace s formátem dokumentu API. Lze snadno načítat, vytvářet, upravovat, manipulovat včetně prvků daigramu a převádět Visio diagramy do jiných formátů, jako jsou PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF a další. Je to samostatný API a nevyžaduje instalaci Microsoft Visio ani jiného softwaru.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online Draw Geomtry pro dokumentování živých ukázek VSTM" sectionDescription="Nakreslete geometrii do VSTM dokumentů právě teď, když navštívíte naše [Web živé ukázky](https://products.aspose.app/diagram/drawing). Živé demo má následující výhody" >}}
