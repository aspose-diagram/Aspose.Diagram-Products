...
{{% blocks/products/pf/agp/content h2="Jak extrahovat VSSX metadata pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro extrahování VSSX metadat v Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Extrahování VSSX metadat – Java" offSpacer="" %}}
