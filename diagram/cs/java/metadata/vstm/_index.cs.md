---
title: Zobrazit nebo upravit metadata souborů VSTM prostřednictvím Java 
weight: 3150
url: /cs/java/metadata/vstm/ 
description: Java ukázkový kód k úpravě nebo zobrazení VSTM metadat v Java Runtime Environment pro JSP/JSF aplikace a desktopové aplikace.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extrahovat VSTM metadat do Java" h2="Vytvářejte své vlastní aplikace Java a přidávejte, upravujte, odebírejte nebo extrahujte metadata ze souborů VSTM " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak extrahovat VSTM metadata pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro extrahování VSTM metadat v Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Extrahování VSTM metadat – Java" offSpacer="" %}}
