...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VSDM na VDX prostřednictvím Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze VSDM na VDX Java" offSpacer="" %}}
