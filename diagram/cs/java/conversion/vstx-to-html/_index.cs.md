---
title: Převést VSTX do HTML pomocí Java 
weight: 3200
url: /cs/java/conversion/vstx-to-html/ 
description: Ukázkový konverzní kód Java pro formát VSTX na soubor HTML. Pomocí tohoto příkladu kódu převeďte VSTX do HTML v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSTX do HTML pomocí Java" h2="Exportujte Microsoft Visio VSTX do HTML pomocí nativní knihovny Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSTX do HTML pomocí Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze VSTX na HTML Java" offSpacer="" %}}
