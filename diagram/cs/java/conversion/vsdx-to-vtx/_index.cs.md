---
title: Převést VSDX na VTX prostřednictvím Java 
weight: 190
url: /cs/java/conversion/vsdx-to-vtx/ 
description: Ukázkový konverzní kód Java pro formát VSDX na soubor VTX. Pomocí tohoto příkladu kódu převeďte VSDX na VTX v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSDX na VTX prostřednictvím Java" h2="Exportujte Microsoft Visio VSDX do VTX pomocí nativní knihovny Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSDX na VTX pomocí Java" %}}

 K vykreslení VSDX do VTX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSDX na VTX prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor VSDX na VTX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSDX s instancí třídy Diagram1. Volejte metodu Diagram.save s cestou k výstupnímu souboru a SaveFileFormat jako parametry1. Soubor VTX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze VSDX na VTX Java" offSpacer="" %}}

```cs
// načíst VSDX do objektu Diagram 
Diagram visio = new Diagram("template.vsdx");
// uložit VSDX jako VTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze VSDX na VTX" sectionDescription="[Převést VSDX na VTX](https://products.aspose.app/diagram/conversion/vsdx-to-vtx) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor VSDX, bude okamžitě převeden na VTX." >}}
