---
title: Převést VSTX do PDF prostřednictvím Java 
weight: 4860
url: /cs/java/conversion/vstx-to-pdf/ 
description: Ukázkový konverzní kód Java pro formát VSTX na soubor PDF. Pomocí tohoto příkladu kódu převeďte VSTX do PDF v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSTX do PDF prostřednictvím Java" h2="Exportujte Microsoft Visio VSTX do PDF pomocí nativní knihovny Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSTX do PDF pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSTX do PDF prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor VSTX do PDF pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu VSTX na PDF Java" offSpacer="" %}}
