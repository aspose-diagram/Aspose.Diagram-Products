---
title: Převést VSTX na VSSX přes Java 
weight: 4130
url: /cs/java/conversion/vstx-to-vssx/ 
description: Ukázkový konverzní kód Java pro formát VSTX na soubor VSSX. Tento příklad kódu použijte k převodu VSTX na VSSX v jakékoli webové nebo desktopové aplikaci založené na Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést VSTX na VSSX pomocí Java" %}}
 ...
 K vykreslení VSTX na VSSX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSTX na VSSX přes Java" %}}
...
1. Načtěte soubor VSTX s instancí třídy Diagram1. Volejte metodu Diagram.save s cestou k výstupnímu souboru a SaveFileFormat jako parametry1. Soubor VSSX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu VSTX na VSSX Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze VSTX na VSSX" sectionDescription="[Převést VSTX na VSSX](https://products.aspose.app/diagram/conversion/vstx-to-vssx) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor VSTX a bude okamžitě převeden na VSSX." >}}
