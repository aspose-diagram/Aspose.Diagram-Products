...
{{% blocks/products/pf/agp/content h2="Jak převést VSTX na TIFF pomocí Java" %}}
 ...
 K vykreslení VSTX do TIFF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSTX na TIFF přes Java" %}}
...
1. Načtěte soubor VSTX s instancí třídy Diagram1. Volejte metodu Diagram.save s cestou k výstupnímu souboru a SaveFileFormat jako parametry1. Soubor TIFF bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze VSTX na TIFF" sectionDescription="[Převést VSTX na TIFF](https://products.aspose.app/diagram/conversion/vstx-to-tiff) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor VSTX, bude okamžitě převeden na TIFF." >}}
