---
title: Převést VSTX na PNG prostřednictvím Java 
weight: 720
url: /cs/java/conversion/vstx-to-png/ 
description: Ukázkový konverzní kód Java pro formát VSTX na soubor PNG. Pomocí tohoto příkladu kódu převeďte VSTX na PNG v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSTX na PNG prostřednictvím Java" h2="Exportujte Microsoft Visio VSTX do PNG pomocí nativní knihovny Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSTX na PNG pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSTX na PNG prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor VSTX na PNG pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu VSTX na PNG Java" offSpacer="" %}}
