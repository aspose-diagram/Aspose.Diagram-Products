---
title: Převést VSDX na VSTM prostřednictvím Java 
weight: 5130
url: /cs/java/conversion/vsdx-to-vstm/ 
description: Ukázkový konverzní kód Java pro formát VSDX na soubor VSTM. Pomocí tohoto příkladu kódu převeďte VSDX na VSTM v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSDX na VSTM prostřednictvím Java" h2="Exportujte Microsoft Visio VSDX do VSTM pomocí nativní knihovny Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSDX na VSTM pomocí Java" %}}

 K vykreslení VSDX do VSTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSDX na VSTM prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor VSDX na VSTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSDX s instancí třídy Diagram1. Volejte metodu Diagram.save s cestou k výstupnímu souboru a SaveFileFormat jako parametry1. Soubor VSTM bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze VSDX na VSTM Java" offSpacer="" %}}

```cs
// načíst VSDX do objektu Diagram 
Diagram visio = new Diagram("template.vsdx");
// uložit VSDX jako VSTM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDX na živé ukázky konverze VSTM" sectionDescription="[Převést VSDX na VSTM](https://products.aspose.app/diagram/conversion/vsdx-to-vstm) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor VSDX, bude okamžitě převeden na VSTM." >}}
