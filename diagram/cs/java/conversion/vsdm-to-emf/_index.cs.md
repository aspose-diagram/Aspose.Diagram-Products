...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSDM na EMF prostřednictvím Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze VSDM na EMF Java" offSpacer="" %}}
