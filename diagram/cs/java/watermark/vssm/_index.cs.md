---
title: Vodoznak VSSM dokumentu prostřednictvím Java 
weight: 3050
url: /cs/java/watermark/vssm/ 
description: Java ukázkový kód pro přidání vodoznaku do VSSM dokumentů v Java Runtime Environment pro JSP/JSF aplikace a desktopové aplikace.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Formáty vodoznaku VSSM v Java" h2="Nativní vodoznak dokumentu VSSM využívající rozhraní API Java na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak vodoznak VSSM souborů pomocí Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vodoznak VSSM Soubory v Java" %}}
