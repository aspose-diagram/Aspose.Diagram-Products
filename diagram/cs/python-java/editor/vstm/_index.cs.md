---
title: Upravit VSTM souborů prostřednictvím Python 
weight: 3390
url: /cs/python-java/editor/vstm/ 
description: Ukázkový kód Python pro úpravu VSTM dokumentů v jakékoli aplikaci založené na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Upravit VSTM formátů v Python" h2="Nativní editor dokumentů VSTM využívající rozhraní API Python na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak upravit soubory VSTM pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro úpravu VSTM souborů v Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Upravit soubory VSTM – Python" offSpacer="" %}}
