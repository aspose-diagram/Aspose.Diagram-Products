---
title: Sloučit soubory VSD přes Python 
weight: 230
url: /cs/python-java/merger/vsd/ 
description: Ukázkový kód Python pro kombinaci dokumentů VSD v jakékoli aplikaci založené na Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Sloučit VSD formátů v Python" h2="Nativní sloučení dokumentů VSD pomocí rozhraní API Python na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak sloučit soubory VSD pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro sloučení VSD souborů v Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Sloučit soubory VSD – Python" offSpacer="" %}}
