---
title: Zobrazit VSDX formátů souborů prostřednictvím Python 
weight: 3480
url: /cs/python-java/viewer/vsdx/ 
description: Zdrojový kód Python pro načtení, vykreslení a zobrazení dokumentů VSDX v jakékoli aplikaci založené na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDX Prohlížeč souborů pro Python" h2="Nativní prohlížeč dokumentů VSDX využívající rozhraní API Python na straně serveru." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k zobrazení VSDX prostřednictvím Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python kód k zobrazení VSDX" offSpacer="" %}}

```cs

// načíst soubor VSDX prostřednictvím instance Diagram
diagram =  Aspose.Diagram.Diagram("template.vsdx");
// převeďte VSDX do formátu HTML a poté načtěte výsledný HTML ve výchozím prohlížeči
