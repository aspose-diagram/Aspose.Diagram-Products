---
title: Převést VDW na VSTM prostřednictvím Python 
weight: 1960
url: /cs/python-java/conversion/vdw-to-vstm/ 
description: Ukázkový konverzní kód Python pro formát VDW na soubor VSTM. Pomocí tohoto příkladu kódu převeďte VDW na VSTM v jakékoli aplikaci založené na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VDW na VSTM prostřednictvím Python" h2="Exportovat Microsoft Visio VDW do VSTM pomocí Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VDW na VSTM pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VDW na VSTM prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno převést soubor VDW na VSTM pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu VDW na VSTM Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze VDW na VSTM" sectionDescription="[Převést VDW na VSTM](https://products.aspose.app/diagram/conversion/vdw-to-vstm) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát svůj soubor VDW, bude okamžitě převeden na VSTM." >}}
