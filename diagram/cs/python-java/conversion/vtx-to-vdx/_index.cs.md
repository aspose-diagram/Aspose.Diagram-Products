---
title: Převést VTX na VDX prostřednictvím Python 
weight: 1960
url: /cs/python-java/conversion/vtx-to-vdx/ 
description: Ukázkový konverzní kód Python pro formát VTX na soubor VDX. Pomocí tohoto příkladu kódu převeďte VTX na VDX v jakékoli aplikaci založené na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VTX na VDX prostřednictvím Python" h2="Exportovat Microsoft Visio VTX do VDX pomocí Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na VDX pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VTX na VDX prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno převést soubor VTX na VDX pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze VTX na VDX Python" offSpacer="" %}}
