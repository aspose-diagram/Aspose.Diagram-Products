---
title: Převést VSX na VSTM prostřednictvím Python 
weight: 1960
url: /cs/python-java/conversion/vsx-to-vstm/ 
description: Ukázkový konverzní kód Python pro formát VSX na soubor VSTM. Pomocí tohoto příkladu kódu převeďte VSX na VSTM v jakékoli aplikaci založené na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSX na VSTM prostřednictvím Python" h2="Exportovat Microsoft Visio VSX do VSTM pomocí Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSX na VSTM pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VSX na VSTM prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno převést soubor VSX na VSTM pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze VSX na VSTM Python" offSpacer="" %}}
