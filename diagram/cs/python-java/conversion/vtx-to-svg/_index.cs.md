---
title: Převést VTX na SVG prostřednictvím Python 
weight: 1960
url: /cs/python-java/conversion/vtx-to-svg/ 
description: Ukázkový konverzní kód Python pro formát VTX na soubor SVG. Pomocí tohoto příkladu kódu převeďte VTX na SVG v jakékoli aplikaci založené na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VTX na SVG prostřednictvím Python" h2="Exportujte Microsoft Visio VTX do SVG pomocí Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na SVG pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VTX na SVG prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno převést soubor VTX na SVG pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu VTX na SVG Python" offSpacer="" %}}
