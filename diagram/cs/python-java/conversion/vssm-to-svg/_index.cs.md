---
title: Převést VSSM na SVG prostřednictvím Python 
weight: 1960
url: /cs/python-java/conversion/vssm-to-svg/ 
description: Ukázkový konverzní kód Python pro formát VSSM na soubor SVG. Pomocí tohoto příkladu kódu převeďte VSSM na SVG v jakékoli aplikaci založené na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSSM na SVG prostřednictvím Python" h2="Exportujte Microsoft Visio VSSM do SVG pomocí Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSSM na SVG pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSSM na SVG prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno převést soubor VSSM na SVG pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu VSSM na SVG Python" offSpacer="" %}}
