---
title: Převést VSSM na VTX prostřednictvím Python 
weight: 1960
url: /cs/python-java/conversion/vssm-to-vtx/ 
description: Ukázkový konverzní kód Python pro formát VSSM na soubor VTX. Pomocí tohoto příkladu kódu převeďte VSSM na VTX v jakékoli aplikaci založené na Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSSM na VTX prostřednictvím Python" h2="Exportovat Microsoft Visio VSSM do VTX pomocí Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSSM na VTX pomocí Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky ke konverzi VSSM na VTX prostřednictvím Python" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Python mohou snadno převést soubor VSSM na VTX pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze VSSM na VTX Python" offSpacer="" %}}
