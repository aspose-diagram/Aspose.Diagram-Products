...
{{% blocks/products/pf/agp/content h2="How to Convert VSSX to XAML Using C#" %}}
 ...
 In order to convert VSSX to XAML, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET developers can easily load & convert VSSX files to XAML in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows VSSX to XAML C# Conversion" offSpacer="" %}}
