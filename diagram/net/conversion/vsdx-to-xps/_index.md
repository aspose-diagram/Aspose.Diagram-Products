---
title: Convert VSDX to XPS via C# 
weight: 3310
url: /net/conversion/vsdx-to-xps/ 
description: Sample code for VSDX to XPS C# conversion. Use API example code for batch VSDX files to XPS conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows VSDX to XPS C# Conversion" offSpacer="" %}}
