---
title: Convert VSDX to VSSM via C# 
weight: 2040
url: /net/conversion/vsdx-to-vssm/ 
description: Sample code for VSDX to VSSM C# conversion. Use API example code for batch VSDX files to VSSM conversion within VB.NET, Asp.NET or any .NET based application.
---
...
{{% blocks/products/pf/agp/code-block title="This sample code shows VSDX to VSSM C# Conversion" offSpacer="" %}}
