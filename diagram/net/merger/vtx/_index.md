---
title: Merge VTX Files via .NET 
weight: 4330
url: /net/merger/vtx/ 
description: Try our On-Premise document merger APIs to combine VTX documents on .NET Framework, .NET Core, Mono or COM Interop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge VTX Formats in C#" h2="Native and high performance VTX document merger using server-side Aspose.Diagram for .NET APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge VTX File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Merging VTX Files in C#" %}}
...
+  Load all the VTX files with full path.
+  Make one document as the base file
+  Call the relevant method for concatenating and merging files one by one.
+  Call the Save() method and pass the file name (full path) and format (VTX) as a parameter.
+  Now you can open and use the VTX file in Microsoft Office, Adobe PDF or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Merge VTX Files - C#" offSpacer="" %}}
