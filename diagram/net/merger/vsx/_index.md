---
title: Merge VSX Files via .NET 
weight: 1260
url: /net/merger/vsx/ 
description: Try our On-Premise document merger APIs to combine VSX documents on .NET Framework, .NET Core, Mono or COM Interop.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge VSX Formats in C#" h2="Native and high performance VSX document merger using server-side Aspose.Diagram for .NET APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge VSX File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Merging VSX Files in C#" %}}
...
+  Load all the VSX files with full path.
+  Make one document as the base file
+  Call the relevant method for concatenating and merging files one by one.
+  Call the Save() method and pass the file name (full path) and format (VSX) as a parameter.
+  Now you can open and use the VSX file in Microsoft Office, Adobe PDF or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Merge VSX Files - C#" offSpacer="" %}}
