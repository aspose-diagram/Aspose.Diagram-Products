---
title: Convert VSTM to DRAWIO via C# 
weight: 3310
url: /net/conversion/vstm-to-drawio/ 
description: Sample code for VSTM to DRAWIO C# conversion. Use API example code for batch VSTM files to DRAWIO conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert VSTM to DRAWIO via C#" h2="Export Microsoft® Visio VSTM files to DRAWIO on .NET Framework, .NET Core, Mono or COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRAWIO" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert VSTM to DRAWIO Using C#" %}}

 In order to convert VSTM to DRAWIO, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert VSTM to DRAWIO via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert VSTM files to DRAWIO in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows VSTM to DRAWIO C# Conversion" offSpacer="" %}}

```cs
// For complete examples and data files, please go to https://github.com/aspose-diagram/Aspose.Diagram-for-.NET
// The path to the documents directory.
string dataDir = RunExamples.GetDataDir_Intro();
// Load an existing vstm
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert VSTM to DRAWIO" sectionDescription="Check our live demos for [VSTM to DRAWIO conversion](https://products.aspose.app/diagram/conversion/vstm-to-drawio) with following benefits." >}}
