---
title: Convert Visio to IMAGE via C# 
linktitle: Convert Visio to IMAGE
weight: 10
url: /net/conversion/visio-to-image/
description: Convert Visio to IMAGE format in C# code. Save Visio as IMAGE using VB.NET, Asp.NET or any .NET based application..
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert Visio to IMAGE via C#" h2="Export Visio to PDF format on .NET Framework, .NET Core, Mono Platforms." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="IMAGE" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="IMAGE" fileiconsmall4="XML" fileiconsmall5="Visio" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert Visio to IMAGE Using C#" %}}

 In order to convert Visio to IMAGE, we will use [Aspose.Diagram for .NET](https://products.aspose.com/diagram/net) API which is a feature-rich, powerful and easy to use document manipulation and conversion API for C# platform. Open [NuGet](https://www.nuget.org/packages/aspose.diagram) package manager, search for Aspose.Diagram and install. You may also use the following command from the Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert Visio to IMAGE via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert Visio files to IMAGE in just a few lines of code.

{{% /blocks/products/pf/agp/text %}}

1.  Load Visio file with an instance of Diagram
1.  Call the Diagram.Save method
1.  Pass output path with IMAGE extension as parameter
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert VSDX to IMAGE" sectionDescription="Check our live demos for [VSDX to IMAGE conversion](https://products.aspose.app/diagram/conversion/vsdx-to-bmp) with following benefits." >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-download" text=" You will instantly get the download link for resultant IMAGE file." >}}
