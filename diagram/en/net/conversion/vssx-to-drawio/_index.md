---
title: Convert VSSX to DRAWIO via C# 
weight: 3310
url: /net/conversion/vssx-to-drawio/ 
description: Sample code for VSSX to DRAWIO C# conversion. Use API example code for batch VSSX files to DRAWIO conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert VSSX to DRAWIO via C#" h2="Export Microsoft® Visio VSSX files to DRAWIO on .NET Framework, .NET Core, Mono or COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="DRAWIO" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert VSSX to DRAWIO Using C#" %}}

 In order to convert VSSX to DRAWIO, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert VSSX to DRAWIO via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert VSSX files to DRAWIO in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows VSSX to DRAWIO C# Conversion" offSpacer="" %}}

```cs
// For complete examples and data files, please go to https://github.com/aspose-diagram/Aspose.Diagram-for-.NET
// The path to the documents directory.
string dataDir = RunExamples.GetDataDir_Intro();
// Load an existing vssx
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert VSSX to DRAWIO" sectionDescription="Check our live demos for [VSSX to DRAWIO conversion](https://products.aspose.app/diagram/conversion/vssx-to-drawio) with following benefits." >}}
