---
title: Convert VSDX to VSD via C# 
weight: 2390
url: /net/conversion/vsdx-to-vsd/ 
description: Sample code for VSDX to VSD C# conversion. Use API example code for batch VSDX files to VSD conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert VSDX to VSD via C#" h2="Export Microsoft® Visio VSDX files to VSD on .NET Framework, .NET Core, Mono or COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert VSDX to VSD Using C#" %}}

 In order to convert VSDX to VSD, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert VSDX to VSD via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert VSDX files to VSD in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows VSDX to VSD C# Conversion" offSpacer="" %}}

{{< gist "aspose-diagram-gists" "efd56218048f8b0ab925efd494227fdd" "Examples-CSharp-Load-Save-Convert-ConvertVsdxToVsd.cs" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert VSDX to VSD" sectionDescription="Check our live demos for [VSDX to VSD conversion](https://products.aspose.app/diagram/conversion/vsdx-to-vsd) with following benefits." >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/conversion/vsdx-to-vsdx/" name="VSDX TO VSDX" description="Microsoft Visio Format" >}}
