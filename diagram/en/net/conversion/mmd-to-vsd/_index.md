---
title: Convert MMD to VSD via C# 
weight: 2390
url: /net/conversion/mmd-to-vsd/ 
description: Sample code for MMD to VSD C# conversion. Use API example code for batch MMD files to VSD conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MMD to VSD via C#" h2="Export Microsoft® Visio MMD files to VSD on .NET Framework, .NET Core, Mono or COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MMD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MMD to VSD Using C#" %}}

 In order to convert MMD to VSD, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MMD to VSD via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert MMD files to VSD in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MMD to VSD C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MMD to VSD" sectionDescription="Check our live demos for [MMD to VSD conversion](https://products.aspose.app/diagram/conversion/mmd-to-vsd) with following benefits." >}}
