---
title: Convert MMD to VSSX via C# 
weight: 2390
url: /net/conversion/mmd-to-vssx/ 
description: Sample code for MMD to VSSX C# conversion. Use API example code for batch MMD files to VSSX conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MMD to VSSX via C#" h2="Export Microsoft® Visio MMD files to VSSX on .NET Framework, .NET Core, Mono or COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MMD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MMD to VSSX Using C#" %}}

 In order to convert MMD to VSSX, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MMD to VSSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert MMD files to VSSX in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MMD to VSSX C# Conversion" offSpacer="" %}}
...
diagram.Save(dataDir + "out.vssx", SaveFileFormat.VSSX);
```
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MMD to VSSX" sectionDescription="Check our live demos for [MMD to VSSX conversion](https://products.aspose.app/diagram/conversion/mmd-to-vssx) with following benefits." >}}
...
Files with .VSSX extension are drawing stencils created with Microsoft Visio 2013 and above. The VSSX file format can be opened with Microsoft Visio 2013 and above. Visio files are known for representation of a variety of drawing elements such as collection of shapes, connectors, flowcharts, network layout, UML diagrams, software diagrams, database models, objects mapping and other similar information.
