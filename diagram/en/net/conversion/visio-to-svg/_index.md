---
title: Convert Visio to SVG via C# 
linktitle: Convert Visio to SVG
weight: 10
url: /net/conversion/visio-to-svg/
description: Convert Visio to SVG format in C# code. Save Visio as SVG using VB.NET, Asp.NET or any .NET based application..
---


{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert Visio to SVG via C#" h2="Export Visio to SVG format on .NET Framework, .NET Core, Mono Platforms." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="SVG" fileiconsmall4="XML" fileiconsmall5="Visio" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert Visio to SVG Using C#" %}}

 In order to convert Visio to SVG, we will use [Aspose.Diagram for .NET](https://products.aspose.com/diagram/net) API which is a feature-rich, powerful and easy to use document manipulation and conversion API for C# platform. Open [NuGet](https://www.nuget.org/packages/aspose.diagram) package manager, search for Aspose.Diagram and install. You may also use the following command from the Package Manager Console.
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert Visio to SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert Visio files to SVG in just a few lines of code.
