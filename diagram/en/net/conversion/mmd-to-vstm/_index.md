---
title: Convert MMD to VSTM via C# 
weight: 2390
url: /net/conversion/mmd-to-vstm/ 
description: Sample code for MMD to VSTM C# conversion. Use API example code for batch MMD files to VSTM conversion within VB.NET, Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert MMD to VSTM via C#" h2="Export Microsoft® Visio MMD files to VSTM on .NET Framework, .NET Core, Mono or COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="MMD" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert MMD to VSTM Using C#" %}}

 In order to convert MMD to VSTM, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert MMD to VSTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET developers can easily load & convert MMD files to VSTM in just a few lines of code.
...
{{% blocks/products/pf/agp/code-block title="This sample code shows MMD to VSTM C# Conversion" offSpacer="" %}}
...
diagram.Save(dataDir + "out.vstm", SaveFileFormat.VSTM);
```
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert MMD to VSTM" sectionDescription="Check our live demos for [MMD to VSTM conversion](https://products.aspose.app/diagram/conversion/mmd-to-vstm) with following benefits." >}}
...
Files with .VSTM extension are template files created with Microsoft Visio that support macros. Unlike VSTX files, files created from VSTM templates can run macros that are developed in Visual Basic for Applications (VBA) code.
