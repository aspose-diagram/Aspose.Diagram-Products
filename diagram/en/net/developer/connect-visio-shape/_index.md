...
{{% blocks/products/pf/agp/content h2="How to Connect shapes in Visio File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to connect shapes in Visio file via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Connect shapes - C#" offSpacer="" %}}
