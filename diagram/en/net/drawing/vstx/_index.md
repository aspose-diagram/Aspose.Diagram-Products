---
title: Draw geomtry to visio VSTX document via .NET 
weight: 3050
url: /net/drawing/vstx/ 
description: C# source code to draw geomtry to visio vstx file on .NET Framework, .NET Core, Mono Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Draw Geomtry to  VSTX in C#" h2="Native and high performance draw geomtry to VSTX document using server-side Aspose.Diagram for .NET APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Draw Geomtry to  VSTX File Using C#" %}}

 In order to draw geomtry to VSTX file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Draw Geomtry to  VSTX Files in C#" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram is a Microsoft Visio document format manipulation API. One can easily load, create, modify, manipulate including daigram elements and convert Visio diagrams to other formats such as PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF and more. It is a standalone API and does not require Microsoft Visio or any other software to be installed.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online Draw Geomtry to  VSTX Document Live Demos" sectionDescription="Draw geomtry to VSTX documents right now by visiting our [Live Demos website](https://products.aspose.app/diagram/drawing). The live demo has the following benefits" >}}
