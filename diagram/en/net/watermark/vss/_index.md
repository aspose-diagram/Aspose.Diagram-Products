---
title: Watermark VSS document via .NET 
weight: 3050
url: /net/watermark/vss/ 
description: C# source code to add watermark to vss file on .NET Framework, .NET Core, Mono Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Add Text Watermark to VSS in C#" h2="Native and high performance VSS document watermark using server-side Aspose.Diagram for .NET APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Watermark VSS File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Watermarking VSS Files in C#" %}}
