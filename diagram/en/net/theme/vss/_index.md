---
title: Apply preset theme to VSS document via .NET 
weight: 3050
url: /net/theme/vss/ 
description: C# source code to apply preset theme to vss file on .NET Framework, .NET Core, Mono Platforms.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Apply Preset Theme to VSS in C#" h2="Native and high performance apply preset theme to VSS document using server-side Aspose.Diagram for .NET APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Apply Preset Theme to VSS File Using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Apply Preset Theme to VSS Files in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Apply Preset Theme to VSS Files - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/theme/vsdx/" name="VSDX" description="Visio drawing File" >}}
