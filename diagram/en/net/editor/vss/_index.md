---
title: Edit Visio VSS files via .NET 
url: /net/editor/vss/ 
description: C# source code to edit Visio VSS document on .NET Framework, .NET Core, Windows Azure, Mono or Xamarin Platforms.
---
