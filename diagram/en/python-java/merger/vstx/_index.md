---
title: Merge VSTX Files via Python 
weight: 230
url: /python-java/merger/vstx/ 
description: Python sample code to combine VSTX documents within any Python based application. 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge VSTX Formats in Python" h2="Native VSTX document merger using server-side Python APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge VSTX Files Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Merging VSTX Files in Python" %}}
...
+  Load the first VSTX file with an instance of Diagram class.
+  Load the second VSTX document with an instance of Diagram class.
+  Merge files using combine() method.
+  save the merged VSTX file at specified path
...
{{% blocks/products/pf/agp/code-block title="Merge VSTX Files - Python" offSpacer="" %}}
