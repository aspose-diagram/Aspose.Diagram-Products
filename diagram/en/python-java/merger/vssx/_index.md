---
title: Merge VSSX Files via Python 
weight: 230
url: /python-java/merger/vssx/ 
description: Python sample code to combine VSSX documents within any Python based application. 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge VSSX Formats in Python" h2="Native VSSX document merger using server-side Python APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge VSSX Files Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Merging VSSX Files in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Merge VSSX Files - Python" offSpacer="" %}}
