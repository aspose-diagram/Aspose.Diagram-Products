...
{{% blocks/products/pf/agp/content h2="How to Annotate VSS Files Using Python" %}}

 In order to annotate VSS file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for annotation VSS Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Annotate VSS Files - Python" offSpacer="" %}}
