...
{{% blocks/products/pf/agp/content h2="How to Annotate VSTX Files Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for annotation VSTX Files in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Annotate VSTX Files - Python" offSpacer="" %}}
