...
{{% blocks/products/pf/agp/content h2="How to Annotate VSSM Files Using Python" %}}

 In order to annotate VSSM file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for annotation VSSM Files in Java" %}}
...
+  Load VSSM file by creating an instance of Diagram
...
{{% blocks/products/pf/agp/code-block title="Annotate VSSM Files - Python" offSpacer="" %}}
