---
title: View Visio VTX File Formats via Python 
weight: 3480
url: /python-java/viewer/vtx/ 
description: Python source code to load, render and display Visio VTX documents within any Python based application.
---
