---
title: Change Background of VSS File via Python 
weight: 3480
url: /python-java/changebackground/vss/ 
description: Python source code to change background of VSS documents within any Python based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Change background of VSS File for Python" h2="Change background of Microsoft Visio VSS files in browser without requiring Visio application or Office Automation." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSS" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Change background of VSS File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Change background of VSS via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python code to change background of VSS" offSpacer="" %}}

```cs
        diagram = new Diagram(dataDir+"Drawing1.vss");
