---
title: Change Background of VTX File via Python 
weight: 3480
url: /python-java/changebackground/vtx/ 
description: Python source code to change background of VTX documents within any Python based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Change background of VTX File for Python" h2="Change background of Microsoft Visio VTX files in browser without requiring Visio application or Office Automation." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Change background of VTX File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Change background of VTX via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python code to change background of VTX" offSpacer="" %}}

```cs
        diagram = new Diagram(dataDir+"Drawing1.vtx");
