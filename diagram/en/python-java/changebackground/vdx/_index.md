---
title: Change Background of VDX File via Python 
weight: 3480
url: /python-java/changebackground/vdx/ 
description: Python source code to change background of VDX documents within any Python based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Change background of VDX File for Python" h2="Change background of Microsoft Visio VDX files in browser without requiring Visio application or Office Automation." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-python-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Change background of VDX File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Change background of VDX via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python code to change background of VDX" offSpacer="" %}}

```cs
        diagram = new Diagram(dataDir+"Drawing1.vdx");
