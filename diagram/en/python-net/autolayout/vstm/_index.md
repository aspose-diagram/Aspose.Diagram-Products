...
{{% blocks/products/pf/agp/content h2="How to Auto Layout VSTM File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Auto Layout VSTM Files in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Auto Layout VSTM Files - Python" offSpacer="" %}}
