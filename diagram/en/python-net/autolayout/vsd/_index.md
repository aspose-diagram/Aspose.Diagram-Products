...
{{% blocks/products/pf/agp/content h2="How to Auto Layout VSD File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Auto Layout VSD Files in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Auto Layout VSD Files - Python" offSpacer="" %}}
