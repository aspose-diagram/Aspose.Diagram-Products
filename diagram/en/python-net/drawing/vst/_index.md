---
title: Draw geomtry to visio VST document via Python 
weight: 3050
url: /python-net/drawing/vst/ 
description: Python source code to draw geomtry to visio vst file within any Python based application.
---
