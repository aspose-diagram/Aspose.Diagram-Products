---
title: Draw geomtry to visio VSDM document via Python 
weight: 3050
url: /python-net/drawing/vsdm/ 
description: Python source code to draw geomtry to visio vsdm file within any Python based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Draw Geomtry to VSDM document in Python" h2="Native and high performance draw geomtry to VSDM document using server-side Aspose.Diagram for Python APIs, without the use of any software like Microsoft or Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-python-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Draw Geomtry to VSDM File Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Draw Geomtry to VSDM Files in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Draw Geomtry to VSDM Files - Python" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram is a Microsoft Visio document format manipulation API. One can easily load, create, modify, manipulate including daigram elements and convert Visio diagrams to other formats such as PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF and more. It is a standalone API and does not require Microsoft Visio or any other software to be installed.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VSDM Draw Geomtry to Live Demos" sectionDescription="Draw Geomtry to VSDM documents right now by visiting our [Live Demos website](https://products.aspose.app/diagram/drawing). The live demo has the following benefits" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/python-net/drawing/vssm/" name="VSSM" description="Visio macro-enabled stencil File" >}}
