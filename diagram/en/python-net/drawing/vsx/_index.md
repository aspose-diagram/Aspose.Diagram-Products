---
title: Draw geomtry to VSX document via Python 
weight: 3050
url: /python-net/drawing/vsx/ 
description: Python source code to draw geomtry to vsx file within any Python based application.
---
