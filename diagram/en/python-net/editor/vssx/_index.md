---
title: Edit VSSX files via Python 
weight: 3390
url: /python-net/editor/vssx/ 
description: Python sample code to edit VSSX documents within any Python based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Edit VSSX Formats in Python" h2="Native VSSX document editor using server-side Python APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Edit VSSX Files Using Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for editing VSSX Files in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Edit VSSX Files - Python" offSpacer="" %}}
