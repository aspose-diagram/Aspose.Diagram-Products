...
{{% blocks/products/pf/agp/content h2="How to Annotate VSD Files Using Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Annotate VSD Files - Java" offSpacer="" %}}
