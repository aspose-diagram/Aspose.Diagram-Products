...
{{% blocks/products/pf/agp/content h2="How to Connect visio shapes Using Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for Connect visio shapes in Java" %}}

{{% blocks/products/pf/agp/text %}}

 Connect visio shapes with
 [Aspose.Diagram for Java](https://products.aspose.com/diagram/java) 
...
+  Use the [connectShapesViaConnector method](https://reference.aspose.com/diagram/java/com.aspose.diagram/page/#connectShapesViaConnector) to Connect visio shapes in the selected page
