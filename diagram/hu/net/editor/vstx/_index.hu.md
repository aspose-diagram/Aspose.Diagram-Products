---
title: "VSTX fájl szerkesztése a következőn keresztül: .NET "
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSTX fájlok szerkesztéséhez itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTX fájl szerkesztése - C#" offSpacer="" %}}
...
A Aspose.Diagram egy Microsoft Visio dokumentumformátum-manipuláció API. Könnyen betölthető, létrehozható, módosítható, manipulálható, beleértve a daigram elemeket, és konvertálható a Visio diagramok más formátumokba, mint például PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF stb. Ez egy önálló API, és nem szükséges a Microsoft Visio vagy más szoftver telepítése.    
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VSTX Szerkesztő élő bemutatók" sectionDescription="Szerkesszen most VSTX dokumentumot a webhelyünkön [Élő bemutatók weboldala](https://products.aspose.app/diagram/editor). Az élő demónak a következő előnyei vannak" >}}
