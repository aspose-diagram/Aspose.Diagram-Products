---
title: "VSDX dokumentum zárolásának feloldása a következőn keresztül: .NET "
weight: 5680
url: /hu/net/unlock/vsdx/ 
description: C# forráskód a VSDX fájl zárolásának feloldásához .NET Framework, .NET Core, Mono platformokon.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Oldja fel a(z) VSDX fájl zárolását a következőn keresztül: C#" h2="Távolítsa el a(z) Visio védelmét, beleértve a VSDX formátumot is a .NET könyvtár használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="A(z) VSDX fájl feloldása a(z) C# használatával" %}}

 A(z) VSDX fájl feloldásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSDX fájlok feloldásához itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX Fájl zárolásának feloldása – C#" offSpacer="" %}}
