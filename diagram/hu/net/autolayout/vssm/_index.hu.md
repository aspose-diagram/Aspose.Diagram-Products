...
description: C# forráskód az automatikus elrendezésű vssm fájlhoz .NET Framework, .NET Core, Mono platformokon.
---
...
{{% blocks/products/pf/agp/content h2="A VSSM fájl automatikus elrendezése a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSSM fájlok automatikus elrendezéséhez itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Automatikus elrendezés VSSM Fájlok - C#" offSpacer="" %}}
