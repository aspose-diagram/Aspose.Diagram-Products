...
description: C# forráskód az automatikus elrendezésű vtx fájlhoz .NET Framework, .NET Core, Mono platformokon.
---
...
{{% blocks/products/pf/agp/content h2="A VTX fájl automatikus elrendezése a C# használatával" %}}
...
{{% blocks/products/pf/agp/code-block title="Automatikus elrendezés VTX Fájlok - C#" offSpacer="" %}}
