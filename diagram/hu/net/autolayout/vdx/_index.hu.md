...
{{% blocks/products/pf/agp/content h2="A VDX fájl automatikus elrendezése a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VDX fájlok automatikus elrendezéséhez itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Automatikus elrendezés VDX Fájlok - C#" offSpacer="" %}}
