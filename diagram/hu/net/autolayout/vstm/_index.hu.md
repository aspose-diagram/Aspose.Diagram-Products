...
description: C# forráskód az automatikus elrendezésű vstm fájlhoz .NET Framework, .NET Core, Mono platformokon.
---
...
{{% blocks/products/pf/agp/content h2="A VSTM fájl automatikus elrendezése a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSTM fájlok automatikus elrendezéséhez itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Automatikus elrendezés VSTM Fájlok - C#" offSpacer="" %}}
