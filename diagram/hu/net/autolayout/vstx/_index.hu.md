...
description: C# forráskód az automatikus elrendezésű vstx fájlhoz .NET Framework, .NET Core, Mono platformokon.
---
...
{{% blocks/products/pf/agp/content h2="A VSTX fájl automatikus elrendezése a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSTX fájlok automatikus elrendezéséhez itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Automatikus elrendezés VSTX Fájlok - C#" offSpacer="" %}}
