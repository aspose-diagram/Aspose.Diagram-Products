...
{{% blocks/products/pf/agp/content h2="Szervezeti diagram létrehozása VSTM-fájlban a C# használatával" %}}

 A szervezeti diagram VSTM fájlban történő létrehozásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a szervezeti diagram létrehozásához a VSTM-fájlokban itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Szervezeti diagram létrehozása VSTM-fájlokban - C#" offSpacer="" %}}
