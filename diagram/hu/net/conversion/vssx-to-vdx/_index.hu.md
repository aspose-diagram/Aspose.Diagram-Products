---
title: "VSSX konvertálása VDX-vé a következőn keresztül: C# "
weight: 90
url: /hu/net/conversion/vssx-to-vdx/ 
description: Mintakód a VSSX-ből VDX-be való C# konverzióhoz. Használjon API példakódot a VSSX-fájlok kötegelt VDX-vé konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX konvertálása VDX-vé a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSSX fájlokat VDX-be .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="VSSX konvertálása VDX-vé a következővel: C#" %}}

 A VSSX VDX-vé konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSSX konvertálása VDX-vé a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a VSSX fájlokat VDX formátumba.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be VSSX-fájlt a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.VDX paraméterrel1. A VDX fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSSX-ből VDX-be való C# átalakítást mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSSX konvertálásához VDX-vé" sectionDescription="Tekintse meg élő bemutatóinkat [VSSX konvertálás VDX-be](https://products.aspose.app/diagram/conversion/vssx-to-vdx) a következő előnyökkel." >}}
