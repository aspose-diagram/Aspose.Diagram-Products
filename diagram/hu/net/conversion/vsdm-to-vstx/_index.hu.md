...
description: Mintakód a VSDM–VSTX C# konverzióhoz. Használjon API példakódot a VSDM-fájlok kötegelt konvertálásához VSTX-vé VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDM konvertálása VSTX-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSDM fájlokat VSTX-be .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="VSDM konvertálása VSTX-re a következővel: C#" %}}

 A VSDM VSTX-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSDM VSTX-re konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetik és konvertálhatják a VSDM fájlokat VSTX-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSDM-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.VSTX paraméterrel1. A VSTX fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSDM–VSTX C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSDM konvertálásához VSTX-vé" sectionDescription="Tekintse meg élő bemutatóinkat [VSDM-VSTX átalakítás](https://products.aspose.app/diagram/conversion/vsdm-to-vstx) a következő előnyökkel." >}}
