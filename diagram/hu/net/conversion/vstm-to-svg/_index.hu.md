---
title: "VSTM konvertálása SVG-vé a következőn keresztül: C# "
weight: 5280
url: /hu/net/conversion/vstm-to-svg/ 
description: Mintakód a VSTM-ből SVG-be való C# konverzióhoz. Használjon API példakódot a VSTM-fájlok kötegelt konvertálásához SVG-vé VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM konvertálása SVG-vé a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSTM fájlokat SVG formátumba .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="VSTM konvertálása SVG-vé a következővel: C#" %}}

 A VSTM SVG-vé konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSTM SVG-vé konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a VSTM fájlokat SVG formátumba.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.SVG paraméterrel1. Az SVG fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSTM-ből SVG-be való C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSTM konvertálásához SVG-vé" sectionDescription="Tekintse meg élő bemutatóinkat [VSTM SVG konvertálás](https://products.aspose.app/diagram/conversion/vstm-to-svg) a következő előnyökkel." >}}
