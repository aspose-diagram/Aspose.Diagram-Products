---
title: "VSD konvertálása BMP-re a következőn keresztül: C# "
weight: 4310
url: /hu/net/conversion/vsd-to-bmp/ 
description: Mintakód a VSD BMP C# konverzióhoz. Használjon API példakódot a kötegelt VSD fájlok BMP konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazásban.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSD konvertálása BMP-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSD fájlokat BMP-be .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="A(z) VSD konvertálása BMP-re a(z) C# használatával" %}}

 A(z) VSD BMP-re konvertálásához ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSD BMP-re konvertálásához a(z) C# segítségével" %}}
...
1. VSD fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.BMP paraméterrel1. A BMP fájl a megadott elérési úton kerül mentésre
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a(z) VSD BMP-vé konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VSD BMP konverzió](https://products.aspose.app/diagram/conversion/vsd-to-bmp) a következő előnyökkel." >}}
