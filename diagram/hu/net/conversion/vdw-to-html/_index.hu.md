---
title: "VDW konvertálása HTML formátumba a következőn keresztül: C# "
weight: 1350
url: /hu/net/conversion/vdw-to-html/ 
description: Mintakód a VDW-ből HTML-be C# konvertáláshoz. Használjon API példakódot a VDW-fájlok kötegelt HTML-vé konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW konvertálása HTML formátumba a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VDW fájlokat HTML formátumba a .NET Framework, a .NET Core, a Mono vagy a COM Interop felületeken." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="VDW konvertálása HTML formátumba a következővel: C#" %}}

 VDW HTML formátumba konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VDW konvertálása HTML-be a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetik és néhány kódsor segítségével HTML-formátumba konvertálhatják a VDW-fájlokat.

{{% /blocks/products/pf/agp/text %}}

1. VDW-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.HTML paraméterrel1. A HTML fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VDW-ből HTML-be való C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás VDW konvertálásához HTML-vé" sectionDescription="Tekintse meg élő bemutatóinkat [VDW konvertálás HTML-be](https://products.aspose.app/diagram/conversion/vdw-to-html) a következő előnyökkel." >}}
