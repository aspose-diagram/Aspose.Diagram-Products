---
title: "VSDM konvertálása SVG-re a következőn keresztül: C# "
weight: 2130
url: /hu/net/conversion/vsdm-to-svg/ 
description: Mintakód a(z) VSDM SVG C# konvertáláshoz. Használjon API példakódot a VSDM fájlok kötegelt konvertálásához SVG-vé VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDM konvertálása SVG-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSDM fájlokat SVG-be a .NET Framework, a .NET Core, a Mono vagy a COM interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="VSDM konvertálása SVG-vé a C# használatával" %}}

 A(z) VSDM SVG formátumba konvertálásához ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) VSDM SVG-vé konvertálásának lépései a(z) C# segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetnek és konvertálhatnak VSDM fájlt SVG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSDM fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.SVG paraméterrel1. Az SVG fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSDM SVG C# átalakítást mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a(z) VSDM SVG formátumba konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VSDM SVG átalakítás](https://products.aspose.app/diagram/conversion/vsdm-to-svg) a következő előnyökkel." >}}
