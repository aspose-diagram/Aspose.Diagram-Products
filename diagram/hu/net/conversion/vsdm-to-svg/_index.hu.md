---
title: "VSDM konvertálása SVG-vé a következőn keresztül: C# "
weight: 2130
url: /hu/net/conversion/vsdm-to-svg/ 
description: Mintakód a VSDM-ből SVG-be C#. Használjon API példakódot a VSDM-fájlok kötegelt konvertálásához SVG-vé VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDM konvertálása SVG-vé a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSDM fájlokat SVG formátumba .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="VSDM konvertálása SVG-vé a következővel: C#" %}}

 A VSDM SVG-vé konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSDM SVG-vé konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a VSDM fájlokat SVG formátumba.

{{% /blocks/products/pf/agp/text %}}

1. VSDM-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.SVG paraméterrel1. Az SVG fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSDM-ből SVG-vé C# konverziót mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSDM SVG-vé konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VSDM-SVG konvertálás](https://products.aspose.app/diagram/conversion/vsdm-to-svg) a következő előnyökkel." >}}
