---
title: "VST konvertálása JPEG formátumba a következőn keresztül: C# "
weight: 1130
url: /hu/net/conversion/vst-to-jpeg/ 
description: Mintakód a VST-ből JPEG-be C# konverzióhoz. Használjon API példakódot a VST-fájlok kötegelt JPEG-té konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VST konvertálása JPEG formátumba a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VST fájlokat JPEG formátumba .NET Framework, .NET Core, Mono vagy COM-együttműködés esetén." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="VST konvertálása JPEG formátumba a következővel: C#" %}}

 A VST JPEG formátumba konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VST konvertálása JPEG formátumba a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET fejlesztői könnyedén betölthetik és konvertálhatják a VST fájlokat JPEG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VST-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.JPEG paraméterekkel1. A JPEG fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VST-ből JPEG-be való C# átalakítást mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VST JPEG formátumba konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VST konvertálás JPEG formátumba](https://products.aspose.app/diagram/conversion/vst-to-jpeg) a következő előnyökkel." >}}
