...
description: Mintakód a VSTM XPS C# konverzióhoz. Használjon API példakódot a kötegelt VSTM fájlok XPS átalakításhoz VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="VSTM konvertálása XPS-re a C# használatával" %}}

 A(z) VSTM XPS-re konvertálásához ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSTM XPS-re konvertálásához a(z) C# segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetnek és konvertálhatnak VSTM fájlt XPS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSTM fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.XPS paraméterrel1. Az XPS fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSTM XPS C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a(z) VSTM XPS-re konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VSTM XPS konverzió](https://products.aspose.app/diagram/conversion/vstm-to-xps) a következő előnyökkel." >}}
