---
title: "VSDM konvertálása VSSX-re a következőn keresztül: C# "
weight: 2410
url: /hu/net/conversion/vsdm-to-vssx/ 
description: Mintakód a(z) VSDM–VSSX C# konverzióhoz. Használjon API példakódot a kötegelt VSDM fájlok VSSX konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDM konvertálása VSSX-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSDM fájlokat ide: VSSX a .NET Framework, a .NET Core, a Mono vagy a COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="VSDM konvertálása VSSX-re a C# használatával" %}}

 A(z) VSDM VSSX-re konvertálásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSDM konvertálásához VSSX-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen betölthetnek és konvertálhatnak VSDM fájlt VSSX formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSDM fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormatVSSX paraméterrel1. VSSX fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód VSDM–VSSX C# konverziót mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a(z) VSDM konvertálásához VSSX-re" sectionDescription="Tekintse meg élő bemutatóinkat [VSDM–VSSX konverzió](https://products.aspose.app/diagram/conversion/vsdm-to-vssx) a következő előnyökkel." >}}
