---
title: "VDW konvertálása TIFF-re a következőn keresztül: C# "
weight: 2010
url: /hu/net/conversion/vdw-to-tiff/ 
description: Mintakód a VDW-ből TIFF-be való C# konverzióhoz. Használjon API példakódot a VDW-fájlok kötegelt konvertálásához TIFF-be VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW konvertálása TIFF-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VDW fájlokat TIFF formátumba .NET Framework, .NET Core, Mono vagy COM-együttműködés esetén." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="VDW konvertálása TIFF-re a következővel: C#" %}}

 A VDW TIFF-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VDW konvertálása TIFF-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a VDW-fájlokat TIFF-formátumba.

{{% /blocks/products/pf/agp/text %}}

1. VDW-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.TIFF paraméterrel1. A TIFF fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VDW-ből TIFF-be való C# átalakítást mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VDW TIFF formátumba konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VDW-TIFF konvertálás](https://products.aspose.app/diagram/conversion/vdw-to-tiff) a következő előnyökkel." >}}
