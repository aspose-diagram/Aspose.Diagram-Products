---
title: "VDW konvertálása BMP-vé a következőn keresztül: C# "
weight: 80
url: /hu/net/conversion/vdw-to-bmp/ 
description: Mintakód a VDW-ből BMP-be C# konverzióhoz. Használjon API példakódot a VDW fájlok kötegelt BMP konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW konvertálása BMP-vé a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VDW fájlokat BMP-be .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="VDW konvertálása BMP-vé a következővel: C#" %}}

 A VDW BMP-vé konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VDW konvertálása BMP-vé a következőn keresztül: C#" %}}
...
1. VDW-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.BMP paraméterrel1. A BMP fájl a megadott elérési úton kerül mentésre
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás VDW konvertálásához BMP-vé" sectionDescription="Tekintse meg élő bemutatóinkat [VDW konvertálás BMP-be](https://products.aspose.app/diagram/conversion/vdw-to-bmp) a következő előnyökkel." >}}
