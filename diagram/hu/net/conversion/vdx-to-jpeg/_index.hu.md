...
description: Mintakód a(z) VDX JPEG C# konvertáláshoz. Használjon API példakódot a VDX fájlok kötegelt JPEG formátumú konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDX konvertálása JPEG formátumba a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VDX fájlokat JPEG formátumba .NET Framework, .NET Core, Mono vagy COM-együttműködés esetén." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="VDX konvertálása JPEG formátumba a következővel: C#" %}}
 ...
 A(z) VDX JPEG formátumba konvertálásához ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VDX JPEG formátumba konvertálásához a(z) C# segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetnek és konvertálhatnak VDX fájlt JPEG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VDX fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.JPEG paraméterekkel1. A JPEG fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VDX JPEG C# formátumú átalakítást mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás VDX JPEG formátumba konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VDX konvertálása JPEG formátumba](https://products.aspose.app/diagram/conversion/vdx-to-jpeg) a következő előnyökkel." >}}
