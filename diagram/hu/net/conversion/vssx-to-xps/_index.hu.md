...
description: Mintakód a VSSX-ről XPS-re C#. Használjon API példakódot a VSSX-fájlok kötegelt XPS-s konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="A VSSX konvertálása XPS-re a következővel: C#" %}}

 A VSSX XPS-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSSX XPS-re konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetik és konvertálhatják a VSSX fájlokat XPS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be VSSX-fájlt a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.XPS paraméterrel1. Az XPS fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSSX-ből XPS-be való C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSSX XPS-re konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VSSX konvertálás XPS-re](https://products.aspose.app/diagram/conversion/vssx-to-xps) a következő előnyökkel." >}}
