...
description: Mintakód a VSDM-ből JPEG-be való C# konverzióhoz. Használjon API példakódot a VSDM fájlok kötegelt JPEG formátumú konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="VSDM konvertálása JPEG formátumba a következővel: C#" %}}
 ...
 A VSDM JPEG formátumba konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSDM konvertálása JPEG formátumba a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a VSDM fájlokat JPEG formátumba.

{{% /blocks/products/pf/agp/text %}}

1. VSDM-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.JPEG paraméterekkel1. A JPEG fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSDM-ből JPEG-be való C# átalakítást mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSDM konvertálásához JPEG formátumba" sectionDescription="Tekintse meg élő bemutatóinkat [VSDM konvertálás JPEG formátumba](https://products.aspose.app/diagram/conversion/vsdm-to-jpeg) a következő előnyökkel." >}}
