---
title: "VSDM konvertálása JPEG formátumba a következőn keresztül: C# "
weight: 1920
url: /hu/net/conversion/vsdm-to-jpeg/ 
description: Mintakód a(z) VSDM JPEG C# konvertáláshoz. Használjon API példakódot a VSDM fájlok kötegelt JPEG formátumú konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDM konvertálása JPEG formátumba a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSDM fájlokat JPEG formátumba .NET Framework, .NET Core, Mono vagy COM-együttműködés esetén." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="VSDM konvertálása JPEG formátumba a következővel: C#" %}}

 A(z) VSDM JPEG formátumba konvertálásához ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSDM JPEG formátumba konvertálásához a(z) C# segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetnek és konvertálhatnak VSDM fájlt JPEG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSDM fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.JPEG paraméterekkel1. A JPEG fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSDM JPEG C# formátumú átalakítást mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás VSDM JPEG formátumba konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VSDM konvertálása JPEG formátumba](https://products.aspose.app/diagram/conversion/vsdm-to-jpeg) a következő előnyökkel." >}}
