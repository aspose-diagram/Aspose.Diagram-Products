...
description: Mintakód a VSDM-ből XPS-be C# konverzióhoz. Használjon API példakódot a VSDM-fájlok kötegelt XPS-konverziójához VB-n.NET, Asp-n.NET vagy bármely .NET-alapú alkalmazáson belül.
---
...
{{% blocks/products/pf/agp/content h2="VSDM konvertálása XPS-re a következővel: C#" %}}

 A VSDM XPS-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSDM XPS-re konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetik és konvertálhatják a VSDM fájlokat XPS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSDM-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.XPS paraméterrel1. Az XPS fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSDM-ből XPS-be való C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSDM XPS-re konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VSDM konvertálás XPS-re](https://products.aspose.app/diagram/conversion/vsdm-to-xps) a következő előnyökkel." >}}
