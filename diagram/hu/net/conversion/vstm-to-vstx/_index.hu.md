...
description: Mintakód a(z) VSTM–VSTX C# konverzióhoz. Használjon API példakódot a kötegelt VSTM fájlok VSTX konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM konvertálása VSTX-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSTM fájlokat ide: VSTX a .NET Framework, a .NET Core, a Mono vagy a COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="VSTM konvertálása VSTX-re a C# használatával" %}}

 A(z) VSTM VSTX-re konvertálásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSTM konvertálásához VSTX-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen betölthetnek és konvertálhatnak VSTM fájlt VSTX formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSTM fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormatVSTX paraméterrel1. VSTX fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód VSTM–VSTX C# konverziót mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a(z) VSTM konvertálásához VSTX-re" sectionDescription="Tekintse meg élő bemutatóinkat [VSTM–VSTX konverzió](https://products.aspose.app/diagram/conversion/vstm-to-vstx) a következő előnyökkel." >}}
