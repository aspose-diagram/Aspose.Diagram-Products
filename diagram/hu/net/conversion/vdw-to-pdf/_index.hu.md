---
title: "VDW konvertálása PDF-be a következőn keresztül: C# "
weight: 1700
url: /hu/net/conversion/vdw-to-pdf/ 
description: Mintakód a VDW-ből PDF-be C# konvertáláshoz. Használjon API példakódot a VDW-fájlok kötegelt PDF-vé konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW konvertálása PDF-be a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VDW fájlokat PDF formátumba a .NET Framework, a .NET Core, a Mono vagy a COM Interop felületeken." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="VDW konvertálása PDF-be a következővel: C#" %}}

 A VDW PDF-be konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VDW PDF-vé konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják PDF-formátumba a VDW-fájlokat.

{{% /blocks/products/pf/agp/text %}}

1. VDW-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.PDF paraméterrel1. A PDF fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VDW-ből PDF-be C# konvertálást mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VDW PDF-be konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VDW konvertálás PDF-be](https://products.aspose.app/diagram/conversion/vdw-to-pdf) a következő előnyökkel." >}}
