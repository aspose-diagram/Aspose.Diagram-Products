---
title: "VSSX konvertálása VSX-re a következőn keresztül: C# "
weight: 3340
url: /hu/net/conversion/vssx-to-vsx/ 
description: Mintakód a(z) VSSX–VSX C# konverzióhoz. Használjon API példakódot a kötegelt VSSX fájlok VSX konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX konvertálása VSX-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSSX fájlokat ide: VSX a .NET Framework, a .NET Core, a Mono vagy a COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="VSSX konvertálása VSX-re a C# használatával" %}}

 A(z) VSSX VSX-re konvertálásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSSX konvertálásához VSX-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői egyszerűen betölthetnek és konvertálhatnak VSSX fájlt VSX formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSSX fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormatVSX paraméterrel1. VSX fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód VSSX–VSX C# konverziót mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a(z) VSSX konvertálásához VSX-re" sectionDescription="Tekintse meg élő bemutatóinkat [VSSX–VSX konverzió](https://products.aspose.app/diagram/conversion/vssx-to-vsx) a következő előnyökkel." >}}
