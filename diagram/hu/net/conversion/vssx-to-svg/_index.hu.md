---
title: "VSSX konvertálása SVG-vé a következőn keresztül: C# "
weight: 4570
url: /hu/net/conversion/vssx-to-svg/ 
description: Mintakód a VSSX-ből SVG-be C#. Használjon API példakódot a VSSX-fájlok kötegelt konvertálásához SVG-vé VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX konvertálása SVG-vé a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSSX fájlokat SVG formátumba .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="A VSSX konvertálása SVG-vé a C# használatával" %}}

 A VSSX SVG-vé konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSSX SVG-vé konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetik és néhány kódsor segítségével SVG-formátumba konvertálhatják a VSSX fájlokat.

{{% /blocks/products/pf/agp/text %}}

1. Töltsön be VSSX-fájlt a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.SVG paraméterrel1. Az SVG fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSSX-ből SVG-be való C# átalakítást mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSSX SVG-vé konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VSSX SVG konvertálás](https://products.aspose.app/diagram/conversion/vssx-to-svg) a következő előnyökkel." >}}
