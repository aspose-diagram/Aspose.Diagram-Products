...
description: Mintakód a(z) VDX PNG C# konvertáláshoz. Használjon API példakódot a VDX fájlok kötegelt konvertálásához PNG-be VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDX konvertálása PNG-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VDX fájlokat PNG-be a .NET Framework, a .NET Core, a Mono vagy a COM-együttműködésen." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="VDX konvertálása PNG-re a következővel: C#" %}}
 ...
 A(z) VDX PNG-re konvertálásához ezt használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) VDX PNG-re konvertálásának lépései a(z) C# segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetnek és konvertálhatnak VDX fájlt PNG formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VDX fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.PNG paraméterrel1. A PNG fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VDX PNG-re C# konvertálást mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a(z) VDX PNG-re konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VDX konvertálás PNG-re](https://products.aspose.app/diagram/conversion/vdx-to-png) a következő előnyökkel." >}}
