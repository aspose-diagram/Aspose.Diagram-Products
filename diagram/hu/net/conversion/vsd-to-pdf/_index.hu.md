---
title: "VSD konvertálása PDF-be a következőn keresztül: C# "
weight: 3150
url: /hu/net/conversion/vsd-to-pdf/ 
description: Mintakód a VSD PDF-re C# konvertálásához. Használjon API példakódot a VSD fájlok kötegelt PDF formátumú konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazásban.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSD konvertálása PDF-be a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSD fájlokat PDF formátumba a .NET Framework, a .NET Core, a Mono vagy a COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="VSD konvertálása PDF-be a C# használatával" %}}

 A(z) VSD PDF-be konvertálásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSD PDF-be konvertálásához a(z) C# segítségével" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetnek és konvertálhatnak VSD fájlt PDF formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSD fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.PDF paraméterrel1. A PDF fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSD PDF-re C# konvertálást mutat be" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a(z) VSD PDF formátumba konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VSD konvertálás PDF-be](https://products.aspose.app/diagram/conversion/vsd-to-pdf) a következő előnyökkel." >}}
