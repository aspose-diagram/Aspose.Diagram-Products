---
title: "Rajzoljon geometriát VSTM dokumentumhoz a következőn keresztül: .NET "
weight: 3050
url: /hu/net/drawing/vstm/ 
description: C# forráskód a vstm fájl geometriájának megrajzolásához .NET Framework, .NET Core, Mono platformokon.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Rajzoljon geometriát a(z) VSTM ponthoz itt: C#" h2="Natív és nagy teljesítményű geometriát rajzol a VSTM dokumentumhoz szerveroldali Aspose.Diagram for .NET API-k segítségével, olyan szoftverek használata nélkül, mint a Microsoft vagy Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Geomtria rajzolása VSTM fájlba a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A geometria rajzolásának lépései VSTM fájlokhoz itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Geomtria rajzolása VSTM fájlba - C#" offSpacer="" %}}
