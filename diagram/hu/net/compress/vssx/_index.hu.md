---
title: "VSSX dokumentum tömörítése a következőn keresztül: .NET "
weight: 3050
url: /hu/net/compress/vssx/ 
description: C# forráskód a vssx fájl tömörítéséhez .NET Framework, .NET Core, Mono platformokon.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX tömörítése itt: C#" h2="Natív és nagy teljesítményű VSSX dokumentumtömörítő szerveroldali Aspose.Diagram for .NET API-kkal, olyan szoftverek használata nélkül, mint a Microsoft vagy az Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="A VSSX fájl tömörítése a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSSX fájlok tömörítéséhez itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX fájl tömörítése - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 A Aspose.Diagram egy Microsoft Visio dokumentumformátum-manipuláció API. Könnyen betölthető, létrehozható, módosítható, manipulálható, beleértve a daigram elemeket, és konvertálható a Visio diagramok más formátumokba, mint például PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF stb. Ez egy önálló API, és nem szükséges a Microsoft Visio vagy más szoftver telepítése.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VSSX Élő bemutatók tömörítése" sectionDescription="Tömörítsen VSSM dokumentumot most, látogasson el oldalunkra [Élő bemutatók weboldala](https://products.aspose.app/diagram/compress). Az élő demónak a következő előnyei vannak" >}}
