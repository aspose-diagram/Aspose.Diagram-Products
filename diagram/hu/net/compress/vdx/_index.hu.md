...
{{% blocks/products/pf/agp/content h2="A VDX fájl tömörítése a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VDX fájlok tömörítéséhez itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX fájl tömörítése - C#" offSpacer="" %}}
