---
title: "A VSTM-fájlok metaadatainak megtekintése vagy szerkesztése a következőn keresztül: .NET "
weight: 3050
url: /hu/net/metadata/vstm/ 
description: C# forráskód a VSTM formátumú metaadatok szerkesztéséhez vagy megtekintéséhez a .NET Framework, .NET Core, Mono Platforms felületeken.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM metaadatok kibontása itt: C#" h2="Készítse el saját .NET-alkalmazásait a VSTM-fájlok metaadatainak hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához szerveroldali API-k segítségével." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="VDW-metaadatok kinyerése a következővel: C#" %}}
 ...
 A VSTM metaadatok kinyeréséhez a következőket fogjuk használni
...
{{% blocks/products/pf/agp/feature-section-col title="A VSTM-metaadatok kinyerésének lépései itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM-metaadatok kibontása – C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram egy Microsoft Visio dokumentumformátum-manipuláció API. Könnyedén betölthető, létrehozható, módosítható, manipulálható, beleértve a daigram elemeket, és konvertálható a Visio diagramok más formátumokba, mint például PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF stb. Ez egy önálló API, és nem szükséges Microsoft Visio vagy más szoftver telepítése.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Kivonja a VSTM metaadatait az online alkalmazáson keresztül" sectionDescription="Tekintse meg és szerkessze a VSTM-dokumentumok metaadatait a weboldalunkon [Élő bemutatók weboldala](https://products.aspose.app/diagram/metadata). Az élő demónak a következő előnyei vannak" >}}
