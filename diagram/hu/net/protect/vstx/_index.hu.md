---
title: "VSTX dokumentum védelme és zárolása a következőn keresztül: .NET "
weight: 5580
url: /hu/net/protect/vstx/ 
description: C# forráskód a VSTX fájl zárolásához .NET Framework, .NET Core, Mono platformokon.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTX fájlok védelme a következőn keresztül: C#" h2="Védje meg a(z) Visio táblázatokat, beleértve a(z) VSTX formátumot is a(z) .NET Library segítségével." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="A(z) VSTX fájl védelme a(z) C# használatával" %}}

 A(z) VSTX fájl védelme érdekében a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSTX fájlok védelméhez itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTX fájlok védelme – C#" offSpacer="" %}}
