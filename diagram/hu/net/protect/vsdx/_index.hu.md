---
title: "VSDX dokumentum védelme és zárolása a következőn keresztül: .NET "
weight: 5580
url: /hu/net/protect/vsdx/ 
description: C# forráskód a VSDX fájl zárolásához .NET Framework, .NET Core, Mono platformokon.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDX fájlok védelme a következőn keresztül: C#" h2="Védje a(z) Visio fájlt, beleértve a(z) VSDX formátumot is a(z) .NET Library használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="A(z) VSDX fájl védelme a(z) C# használatával" %}}

 A(z) VSDX fájl védelme érdekében a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSDX fájlok védelméhez itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX fájlok védelme – C#" offSpacer="" %}}
