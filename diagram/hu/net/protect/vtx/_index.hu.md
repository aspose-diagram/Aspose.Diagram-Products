---
title: "VTX dokumentum védelme és zárolása a következőn keresztül: .NET "
weight: 5580
url: /hu/net/protect/vtx/ 
description: C# forráskód a VTX fájl zárolásához .NET Framework, .NET Core, Mono platformokon.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VTX fájlok védelme a következőn keresztül: C#" h2="Védje a(z) Visio fájlt, beleértve a(z) VTX formátumot is a(z) .NET Library használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="A(z) VTX fájl védelme a(z) C# használatával" %}}

 A VDW fájl védelme érdekében használjuk
...
{{% blocks/products/pf/agp/code-block title="VTX fájlok védelme – C#" offSpacer="" %}}
