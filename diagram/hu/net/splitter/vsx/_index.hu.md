---
title: "VSX fájl felosztása a következőn keresztül: .NET "
weight: 1300
url: /hu/net/splitter/vsx/ 
description: C# forráskód felosztása vsx fájlra .NET Framework, .NET Core, Mono platformokon.
---
...
{{% blocks/products/pf/agp/content h2="VSX fájl felosztása a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSX fájlok felosztásához itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSX fájl felosztása - C#" offSpacer="" %}}
