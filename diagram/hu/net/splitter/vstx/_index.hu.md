---
title: "VSTX fájl felosztása a következőn keresztül: .NET "
weight: 1300
...
{{% blocks/products/pf/agp/content h2="VSTX fájl felosztása a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSTX fájlok felosztásához itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTX fájl felosztása - C#" offSpacer="" %}}
