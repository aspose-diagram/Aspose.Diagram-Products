---
title: "VDX fájl felosztása a következőn keresztül: .NET "
weight: 1300
url: /hu/net/splitter/vdx/ 
description: C# forráskód felosztása vdx fájlra .NET Framework, .NET Core, Mono platformokon.
---
...
{{% blocks/products/pf/agp/content h2="VDX fájl felosztása a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VDX fájlok felosztásához itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX fájl felosztása - C#" offSpacer="" %}}
