...
{{% blocks/products/pf/agp/content h2="VTX fájl felosztása a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VTX fájlok felosztásához itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VTX fájl felosztása - C#" offSpacer="" %}}
