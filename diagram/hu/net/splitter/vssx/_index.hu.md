---
title: "VSSX fájl felosztása a következőn keresztül: .NET "
weight: 1300
url: /hu/net/splitter/vssx/ 
description: C# forráskód felosztása vssx fájlra .NET Framework, .NET Core, Mono platformokon.
---
...
{{% blocks/products/pf/agp/content h2="VSSX fájl felosztása a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSSX fájlok felosztásához itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX fájl felosztása - C#" offSpacer="" %}}
