---
title: "Megjegyzés hozzáadása, szerkesztése és törlése innen: VSTM a következőn keresztül: C# "
weight: 3050
url: /hu/net/annotation/vstm/ 
description: C# forráskód a(z) VSTM fájl megjegyzéséhez a(z) .NET Framework, .NET Core, Mono platformokon.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hogyan fűzz megjegyzéseket a VSTM fájlhoz a C# használatával" h2="Natív és nagy teljesítményű VSTM dokumentum megjegyzések kiszolgálóoldali Aspose.Diagram for .NET API-kkal, olyan szoftverek használata nélkül, mint a Microsoft vagy Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hogyan fűzz megjegyzéseket a VSTM fájlhoz a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a megjegyzések VSTM fájljaihoz itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Megjegyzés törlése a(z) VSTM fájlból – C#" offSpacer="" %}}
