---
title: "Vízjel VSTX dokumentum a következőn keresztül: .NET "
weight: 3050
url: /hu/net/watermark/vstx/ 
description: C# forráskód vízjel hozzáadásához a vstx fájlhoz .NET Framework, .NET Core, Mono Platforms rendszeren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Szöveges vízjel hozzáadása a VSTX-hez itt: C#" h2="Natív és nagy teljesítményű VSTX dokumentum vízjel szerveroldali Aspose.Diagram for .NET API-k használatával, olyan szoftverek használata nélkül, mint a Microsoft vagy az Open Office, az Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="VSTX fájl vízjelezése a következővel: C#" %}}

 A VSTX fájl vízjelezéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSTX fájlok vízjelezésének lépései itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vízjel VSTX fájlok – C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram egy Microsoft Visio dokumentumformátum-manipuláció API. Könnyedén betölthető, létrehozható, módosítható, manipulálható, beleértve a daigram elemeket, és konvertálható a Visio diagramok más formátumokba, mint például PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF stb. Ez egy önálló API, és nem szükséges Microsoft Visio vagy más szoftver telepítése.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VSTX WaterMark élő bemutatók" sectionDescription="A WaterMark VSTX dokumentumokat most meglátogathatja [Élő bemutatók weboldala](https://products.aspose.app/diagram/watermark). Az élő demónak a következő előnyei vannak" >}}
