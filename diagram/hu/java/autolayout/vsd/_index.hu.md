...
{{% blocks/products/pf/agp/content h2="A VSD fájl automatikus elrendezése a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSD fájlok automatikus elrendezéséhez itt: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Automatikus elrendezés VSD Fájlok - Java" offSpacer="" %}}
