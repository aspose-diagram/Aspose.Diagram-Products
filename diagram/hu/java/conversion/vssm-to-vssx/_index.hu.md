...
{{% blocks/products/pf/agp/content h2="VSSM konvertálása VSSX-re a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSSM konvertálásához VSSX-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A(z) Java fejlesztői könnyedén konvertálhatják a(z) VSSM fájlt VSSX formátumba, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="VSSM – VSSX Java Konverziós forráskód" offSpacer="" %}}
