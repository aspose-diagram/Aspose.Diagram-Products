...
{{% blocks/products/pf/agp/content h2="VSTX konvertálása VSSX-re a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSTX konvertálásához VSSX-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A(z) Java fejlesztői könnyedén konvertálhatják a(z) VSTX fájlt VSSX formátumba, mindössze néhány sornyi kóddal.
...
{{% blocks/products/pf/agp/code-block title="VSTX – VSSX Java Konverziós forráskód" offSpacer="" %}}
