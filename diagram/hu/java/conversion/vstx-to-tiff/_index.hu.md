---
title: "VSTX konvertálása TIFF-re a következőn keresztül: Java "
weight: 2670
url: /hu/java/conversion/vstx-to-tiff/ 
description: Minta Java konverziós kód VSTX formátumhoz TIFF fájlba. Ezzel a példakóddal konvertálhatja a VSTX-et TIFF-re bármely web- vagy asztali Java-alapú alkalmazásban.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTX konvertálása TIFF-re a következőn keresztül: Java" h2="Exportálja a Microsoft Visio VSTX-et TIFF formátumba a natív Java könyvtár használatával." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="A VSTX konvertálása TIFF-re a következővel: Java" %}}

 A VSTX TIFF formátumba történő megjelenítéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSTX konvertálása TIFF-re a következőn keresztül: Java" %}}

{{% blocks/products/pf/agp/text %}}

 A Java fejlesztői egyszerűen, néhány sornyi kóddal konvertálhatják a VSTX fájlt TIFF formátumba.

{{% /blocks/products/pf/agp/text %}}

1. VSTX fájl betöltése Diagram osztályú példánysal1. Hívja meg a Diagram.save metódust a kimeneti fájl elérési útjával és a SaveFileFormat paraméterekkel1. A TIFF fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="VSTX-ből TIFF-be Java konverziós forráskód" offSpacer="" %}}

```cs
// a VSTX betöltése a(z) Diagram objektumába 
Diagram visio = new Diagram("template.vstx");
// mentse a VSTX-et TIFF-ként 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX-ből TIFF-be konvertáló élő bemutatók" sectionDescription="[VSTX konvertálása TIFF-re](https://products.aspose.app/diagram/conversion/vstx-to-tiff) most keresse fel az Élő bemutatók webhelyét.Az élő bemutató a következő előnyökkel jár" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nincs szükség a(z) Aspose API letöltésére." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nem kell kódot írni." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Csak töltse fel a VSTX fájlt, amely azonnal TIFF formátumba konvertálódik." >}}
