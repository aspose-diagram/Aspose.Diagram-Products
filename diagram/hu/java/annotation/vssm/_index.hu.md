---
title: "Megjegyzés hozzáadása, szerkesztése és törlése innen: VSSM a következőn keresztül: Java "
weight: 3250
url: /hu/java/annotation/vssm/ 
description: Java forráskód a VSSM fájl megjegyzéseinek megjegyzéséhez a Java Futókörnyezetben JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Megjegyzés VSSM formátumhoz itt: Java" h2="Natív VSSM dokumentumkommentár szerveroldali Java API-kkal." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="VSSM fájlok megjegyzése a Java használatával" %}}
...
{{% blocks/products/pf/agp/code-block title="Megjegyzés VSSM fájlhoz - Java" offSpacer="" %}}
