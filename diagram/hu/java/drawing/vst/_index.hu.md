---
title: "Rajzoljon geometriát a VST-dokumentumba a következőn keresztül: Java "
weight: 3050
url: /hu/Java/drawing/vst/ 
description: Java forráskód, amely geometriát rajzol a vst fájlba a Java Futókörnyezetben JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Geomtria rajzolása VST-re itt: Java" h2="Natív és nagy teljesítményű geometriát rajzol a VST-dokumentumhoz szerveroldali Aspose.Diagram for Java API-kkal, olyan szoftverek használata nélkül, mint a Microsoft vagy az Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Geomtria rajzolása VST-fájlba a következővel: Java" %}}

 Ahhoz, hogy geometriát rajzoljunk a VST fájlba, használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a Geomtria rajzolásához VST-fájlokhoz a következőben: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Geomtria rajzolása VST-fájlokba – Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 A Aspose.Diagram egy Microsoft Visio dokumentumformátum-manipuláció API. Könnyen betölthető, létrehozható, módosítható, manipulálható, beleértve a daigram elemeket, és konvertálható a Visio diagramok más formátumokba, mint például PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF stb. Ez egy önálló API, és nem szükséges a Microsoft Visio vagy más szoftver telepítése.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online rajzoljon geometriát a VST élő bemutatóihoz" sectionDescription="Rajzoljon geometriát a VST-dokumentumokhoz most, látogassa meg weboldalunkat [Élő bemutatók weboldala](https://products.aspose.app/diagram/drawing). Az élő demónak a következő előnyei vannak" >}}
