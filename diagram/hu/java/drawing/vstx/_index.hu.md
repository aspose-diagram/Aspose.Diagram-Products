---
title: "Rajzoljon geometriát VSTX dokumentumhoz a következőn keresztül: Java "
weight: 3050
url: /hu/Java/drawing/vstx/ 
description: Java forráskód, hogy geometriát rajzoljon a vstx fájlba a Java Runtime Environment for JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Rajzolja le a geometriát a következőre: VSTX itt: Java" h2="Natív és nagy teljesítményű geometriát rajzol a VSTX dokumentumhoz szerveroldali Aspose.Diagram for Java API-k segítségével, olyan szoftverek használata nélkül, mint a Microsoft vagy Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Geomtria rajzolása VSTX fájlba a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A geometria rajzolásának lépései VSTX fájlokhoz itt: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Geomtria rajzolása VSTX fájlba - Java" offSpacer="" %}}
