...
{{% blocks/products/pf/agp/content h2="Szervezeti diagram létrehozása VDW-fájlban a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a szervezeti diagram létrehozásához a VDW-fájlokban itt: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Szervezeti diagram létrehozása VDW-fájlokban - Java" offSpacer="" %}}
