...
{{% blocks/products/pf/agp/content h2="Szervezeti diagram létrehozása a VDX fájlban a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A szervezeti diagram létrehozásának lépései a VDX Fájlokban itt: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Szervezeti diagram létrehozása a Vdx Fájlokban - Java" offSpacer="" %}}
