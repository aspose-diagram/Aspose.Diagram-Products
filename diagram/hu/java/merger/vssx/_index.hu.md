---
title: "VSSX fájl egyesítése a következőn keresztül: Java "
weight: 2720
url: /hu/java/merger/vssx/ 
description: Java mintakód a VSSX dokumentumok kombinálásához a Java Futókörnyezet JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX formátum egyesítése itt: Java" h2="Natív VSSX dokumentum-egyesítés szerveroldali Java API-kkal." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="VSSX fájlok egyesítése a Java használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSSX fájlok egyesítéséhez itt: Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX fájl egyesítése - Java" offSpacer="" %}}
