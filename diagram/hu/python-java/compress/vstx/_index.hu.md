...
{{% blocks/products/pf/agp/content h2="VSTX fájlok tömörítése a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSTX fájlok tömörítéséhez itt: Python" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTX fájl tömörítése - Python" offSpacer="" %}}
