---
title: "A VSDM fájlok metaadatainak megtekintése vagy szerkesztése a következőn keresztül: Python "
weight: 3150
url: /hu/python-java/metadata/vsdm/ 
description: Python mintakód a VSDM metaadatok szerkesztéséhez vagy megtekintéséhez bármely Python alapú alkalmazásban. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="A(z) VSDM metaadatok kibontása a(z) Python mappában" h2="Készítse el saját Python alkalmazásait metaadatok hozzáadásához, szerkesztéséhez, eltávolításához vagy kibontásához VSDM fájlból " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="A VSDM metaadatok kinyerése a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A(z) VSDM metaadatok kinyerésének lépései a(z) Python alkalmazásban" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDM metaadatok kibontása – Python" offSpacer="" %}}
