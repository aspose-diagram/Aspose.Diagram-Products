---
title: "Megjegyzés hozzáadása, szerkesztése és törlése innen: VSTX a következőn keresztül: Python "
weight: 3250
url: /hu/python-java/annotation/vstx/ 
description: Python forráskód a VSTX fájl megjegyzésekkel való kiegészítéséhez bármely Python alapú alkalmazásban.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Megjegyzés VSTX formátumhoz itt: Python" h2="Natív VSTX dokumentumkommentár szerveroldali Python API-kkal." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="VSTX fájlok megjegyzése a Python használatával" %}}
...
{{% blocks/products/pf/agp/code-block title="Megjegyzés VSTX fájlhoz - Python" offSpacer="" %}}
