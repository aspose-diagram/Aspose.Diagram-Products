...
{{% blocks/products/pf/agp/content h2="VSTM fájlok megjegyzése a Python használatával" %}}
...
{{% blocks/products/pf/agp/code-block title="Megjegyzés VSTM fájlhoz - Python" offSpacer="" %}}
