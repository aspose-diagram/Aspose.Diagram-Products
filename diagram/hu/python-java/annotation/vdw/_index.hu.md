---
title: "Megjegyzés hozzáadása, szerkesztése és törlése a VDW-ről a következőn keresztül: Python "
weight: 3250
url: /hu/python-java/annotation/vdw/ 
description: Python forráskód a VDW-fájl megjegyzésekkel való kiegészítéséhez bármely Python alapú alkalmazásban.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Megjegyzések VDW formátumokhoz itt: Python" h2="Natív VDW-dokumentum annotáció szerveroldali Python API-kkal." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="A VDW-fájlok megjegyzései a Python használatával" %}}
...
{{% blocks/products/pf/agp/code-block title="VDW-fájlok megjegyzése – Python" offSpacer="" %}}
