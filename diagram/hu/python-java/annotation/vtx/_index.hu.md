...
{{% blocks/products/pf/agp/content h2="VTX fájlok megjegyzése a Python használatával" %}}
...
{{% blocks/products/pf/agp/code-block title="Megjegyzés VTX fájlhoz - Python" offSpacer="" %}}
