---
title: "Megjegyzés hozzáadása, szerkesztése és törlése a VSS-ből a következőn keresztül: Python "
weight: 3250
url: /hu/python-java/annotation/vss/ 
description: Python forráskód a VSS-fájl megjegyzéseihez bármely Python alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSS formátumok megjegyzése itt: Python" h2="Natív VSS-dokumentum annotáció szerveroldali Python API-kkal." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="VSS-fájlok megjegyzései a Python használatával" %}}
...
{{% blocks/products/pf/agp/code-block title="VSS-fájlok megjegyzése – Python" offSpacer="" %}}
