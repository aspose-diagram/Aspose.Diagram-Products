...
{{% blocks/products/pf/agp/content h2="VSSX fájlok szerkesztése a Python használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSSX fájlok szerkesztéséhez itt: Python" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX fájl szerkesztése - Python" offSpacer="" %}}
