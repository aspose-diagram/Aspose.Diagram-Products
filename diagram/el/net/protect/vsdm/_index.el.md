---
title: Προστασία και κλείδωμα εγγράφου VSDM μέσω .NET 
weight: 5580
url: /el/net/protect/vsdm/ 
description: C# πηγαίος κώδικας για το κλείδωμα του αρχείου VSDM σε πλατφόρμες .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Προστασία αρχείων VSDM μέσω C#" h2="Προστατέψτε τη μορφή Visio συμπεριλαμβανομένου του VSDM χρησιμοποιώντας τη Βιβλιοθήκη .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να προστατέψετε το αρχείο VSDM χρησιμοποιώντας το C#" %}}

 Για να προστατεύσουμε το αρχείο VSDM, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για την προστασία των αρχείων VSDM στο C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Προστασία αρχείων VSDM - C#" offSpacer="" %}}
