---
title: Προσθήκη, επεξεργασία και διαγραφή σχολιασμού από VSDM μέσω C# 
weight: 3050
url: /el/net/annotation/vsdm/ 
description: C# πηγαίος κώδικας για σχολιασμό αρχείου VSDM σε πλατφόρμες .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Πώς να σχολιάσετε VSDM αρχείο χρησιμοποιώντας C#" h2="Εγγενής και υψηλής απόδοσης VSDM Σχολιασμός εγγράφων με χρήση API από την πλευρά του διακομιστή Aspose.Diagram for .NET, χωρίς τη χρήση οποιουδήποτε λογισμικού όπως Microsoft ή Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να σχολιάσετε VSDM αρχείο χρησιμοποιώντας C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για Σχολιασμό αρχείων VSDM σε C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Διαγραφή σχολίου από VSDM Αρχεία - C#" offSpacer="" %}}
