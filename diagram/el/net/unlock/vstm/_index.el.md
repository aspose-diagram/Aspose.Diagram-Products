---
title: Ξεκλείδωμα εγγράφου VSTM μέσω .NET 
weight: 5680
url: /el/net/unlock/vstm/ 
description: C# πηγαίος κώδικας για ξεκλείδωμα αρχείου VSTM σε πλατφόρμες .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ξεκλείδωμα VSTM αρχείων μέσω C#" h2="Καταργήστε την προστασία από το Visio συμπεριλαμβανομένης της μορφής VSTM χρησιμοποιώντας τη Βιβλιοθήκη .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να ξεκλειδώσετε το αρχείο VSTM χρησιμοποιώντας το C#" %}}

 Για να ξεκλειδώσουμε το αρχείο VSTM, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για ξεκλείδωμα VSTM αρχείων σε C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ξεκλείδωμα VSTM αρχείων - C#" offSpacer="" %}}
