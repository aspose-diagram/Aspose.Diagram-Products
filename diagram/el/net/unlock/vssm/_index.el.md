---
title: Ξεκλείδωμα εγγράφου VSSM μέσω .NET 
weight: 5680
url: /el/net/unlock/vssm/ 
description: C# πηγαίος κώδικας για ξεκλείδωμα αρχείου VSSM σε πλατφόρμες .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ξεκλείδωμα VSSM αρχείων μέσω C#" h2="Καταργήστε την προστασία από το Visio συμπεριλαμβανομένης της μορφής VSSM χρησιμοποιώντας τη Βιβλιοθήκη .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να ξεκλειδώσετε το αρχείο VSSM χρησιμοποιώντας το C#" %}}

 Για να ξεκλειδώσουμε το αρχείο VSSM, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για ξεκλείδωμα VSSM αρχείων σε C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ξεκλείδωμα VSSM αρχείων - C#" offSpacer="" %}}
