---
title: Ξεκλείδωμα εγγράφου VSTX μέσω .NET 
weight: 5680
url: /el/net/unlock/vstx/ 
description: C# πηγαίος κώδικας για ξεκλείδωμα αρχείου VSTX σε πλατφόρμες .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ξεκλείδωμα VSTX αρχείων μέσω C#" h2="Καταργήστε την προστασία από το Visio συμπεριλαμβανομένης της μορφής VSTX χρησιμοποιώντας τη Βιβλιοθήκη .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να ξεκλειδώσετε το αρχείο VSTX χρησιμοποιώντας το C#" %}}

 Για να ξεκλειδώσουμε το αρχείο VSTX, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για ξεκλείδωμα VSTX αρχείων σε C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ξεκλείδωμα VSTX αρχείων - C#" offSpacer="" %}}
