...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή VSTX σε JPEG μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν αρχεία VSTX σε JPEG σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου VSTX με μια παρουσία κλάσης Diagram1. Καλέστε τη μέθοδο Diagram.Save με τη διαδρομή αρχείου εξόδου και SaveFileFormat.JPEG ως παραμέτρους1. Το αρχείο JPEG θα αποθηκευτεί στην καθορισμένη διαδρομή
