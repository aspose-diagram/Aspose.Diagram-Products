---
title: Μετατροπή VSTX σε VSSM μέσω C# 
weight: 2060
url: /el/net/conversion/vstx-to-vssm/ 
description: Δείγμα κώδικα για μετατροπή VSTX σε VSSM C#. Χρησιμοποιήστε API παράδειγμα κώδικα για ομαδικά αρχεία VSTX σε VSSM μετατροπή εντός VB.NET, Asp.NET ή οποιασδήποτε εφαρμογής που βασίζεται σε .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή VSTX σε VSSM μέσω C#" h2="Εξαγωγή αρχείων Microsoft® Visio VSTX σε VSSM σε .NET Framework, .NET Core, Mono ή COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το VSTX σε VSSM χρησιμοποιώντας το C#" %}}

 Για να μετατρέψουμε το VSTX σε VSSM, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή VSTX σε VSSM μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν αρχεία VSTX σε VSSM σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου VSTX με μια παρουσία της τάξης Diagram1. Καλέστε τη μέθοδο Diagram.Save με διαδρομή αρχείου εξόδου και SaveFileFormat.VSSM ως παραμέτρους.1. Το αρχείο VSSM θα αποθηκευτεί στην καθορισμένη διαδρομή
...
{{% blocks/products/pf/agp/code-block title="Αυτό το δείγμα κώδικα δείχνει τη μετατροπή VSTX σε VSSM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Δωρεάν εφαρμογή για μετατροπή VSTX σε VSSM" sectionDescription="Ελέγξτε τις ζωντανές επιδείξεις μας για [μετατροπή VSTX σε VSSM](https://products.aspose.app/diagram/conversion/vstx-to-vssm) με τα ακόλουθα οφέλη." >}}
