...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε VDX σε VSSX χρησιμοποιώντας το C#" %}}
...
1. Φόρτωση αρχείου VDX με μια παρουσία της κλάσης Diagram1. Καλέστε τη μέθοδο Diagram.Save με τη διαδρομή αρχείου εξόδου και SaveFileFormat.VSSX ως παραμέτρους1. Το αρχείο VSSX θα αποθηκευτεί στην καθορισμένη διαδρομή
...
{{% blocks/products/pf/agp/code-block title="Αυτό το δείγμα κώδικα δείχνει τη μετατροπή C# VDX σε VSSX" offSpacer="" %}}
