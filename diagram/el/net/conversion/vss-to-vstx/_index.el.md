...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το VSS σε VSTX χρησιμοποιώντας το C#" %}}
...
1. Φόρτωση αρχείου VSS με μια παρουσία κλάσης Diagram1. Καλέστε τη μέθοδο Diagram.Save με διαδρομή αρχείου εξόδου και SaveFileFormat.VSTX ως παραμέτρους.1. Το αρχείο VSTX θα αποθηκευτεί στην καθορισμένη διαδρομή
...
{{% blocks/products/pf/agp/code-block title="Αυτό το δείγμα κώδικα δείχνει τη μετατροπή VSS σε VSTX C#" offSpacer="" %}}
