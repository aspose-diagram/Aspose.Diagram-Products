...
1. Φόρτωση αρχείου VSTM με μια παρουσία της τάξης Diagram1. Καλέστε τη μέθοδο Diagram.Save με διαδρομή αρχείου εξόδου και SaveFileFormat.VSDX ως παραμέτρους.1. Το αρχείο VSDX θα αποθηκευτεί στην καθορισμένη διαδρομή
