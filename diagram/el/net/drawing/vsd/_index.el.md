---
title: Σχεδιάστε τη γεωμετρία στο έγγραφο VSD μέσω του .NET 
weight: 3050
url: /el/net/drawing/vsd/ 
description: C# πηγαίος κώδικας για τη σχεδίαση γεωμετρίας σε αρχείο vsd σε πλατφόρμες .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Σχεδιάστε τη γεωμετρία στο VSD στο C#" h2="Εγγενής και υψηλής απόδοσης σχεδίαση γεωμετρίας σε έγγραφο VSD χρησιμοποιώντας API από την πλευρά του διακομιστή Aspose.Diagram for .NET, χωρίς τη χρήση οποιουδήποτε λογισμικού όπως Microsoft ή Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να σχεδιάσετε τη γεωμετρία στο αρχείο VSD χρησιμοποιώντας το C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για Σχεδίαση γεωμετρίας σε αρχεία VSD στο C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Σχεδιάστε τη γεωμετρία σε VSD αρχεία - C#" offSpacer="" %}}
