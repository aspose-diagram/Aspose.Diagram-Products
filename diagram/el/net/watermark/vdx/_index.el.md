---
title: Υδατογράφημα VDX εγγράφου μέσω .NET 
weight: 3050
url: /el/net/watermark/vdx/ 
description: C# πηγαίος κώδικας για προσθήκη υδατογραφήματος σε αρχείο vdx σε πλατφόρμες .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Προσθήκη υδατογραφήματος κειμένου στο VDX στο C#" h2="Εγγενές και υψηλής απόδοσης VDX υδατογράφημα εγγράφου χρησιμοποιώντας API από την πλευρά του διακομιστή Aspose.Diagram for .NET, χωρίς τη χρήση λογισμικού όπως το Microsoft ή το Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Τρόπος υδατογραφήματος VDX αρχείου χρησιμοποιώντας C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη υδατοσήμανση VDX αρχείων σε C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Υδατογράφημα Vdx Αρχεία - C#" offSpacer="" %}}
