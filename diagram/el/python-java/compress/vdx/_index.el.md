---
title: Συμπίεση εγγράφου VDX μέσω Python 
weight: 3350
url: /el/python-java/compress/vdx/ 
description: Python πηγαίος κώδικας για συμπίεση αρχείου vdx σε οποιαδήποτε εφαρμογή που βασίζεται σε Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Συμπίεση VDX μορφών σε Python" h2="Συμπίεση εγγενούς εγγράφου VDX με χρήση API Python από την πλευρά του διακομιστή." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Τρόπος συμπίεσης αρχείων VDX χρησιμοποιώντας Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη συμπίεση VDX Αρχείων σε Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Συμπίεση VDX αρχείων - Python" offSpacer="" %}}
