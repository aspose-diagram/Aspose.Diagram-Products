...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε VSS σε VSSX χρησιμοποιώντας το Java" %}}

 Για να αποδώσουμε το VSS σε VSSX, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή VSS σε VSSX μέσω Java" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του Java μπορούν εύκολα να μετατρέψουν το αρχείο VSS σε VSSX σε λίγες μόνο γραμμές κώδικα.
...
{{% blocks/products/pf/agp/code-block title="Πηγαίος κώδικας μετατροπής VSS σε VSSX Java" offSpacer="" %}}

```cs
// φορτώστε το VSS σε ένα αντικείμενο Diagram 
Diagram visio = new Diagram("template.vss");
// αποθηκεύστε το VSS ως VSSX 
