...
description: Δείγμα κώδικα μετατροπής Java για μορφή VDW σε αρχείο VSTX. Χρησιμοποιήστε αυτό το παράδειγμα κώδικα για να μετατρέψετε το VDW σε VSTX σε οποιαδήποτε εφαρμογή που βασίζεται στο Web ή στην επιφάνεια εργασίας Java.
---
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το VDW σε VSTX χρησιμοποιώντας το Java" %}}
