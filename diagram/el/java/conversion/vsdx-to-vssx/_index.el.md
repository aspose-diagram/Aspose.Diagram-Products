...
description: Δείγμα κώδικα μετατροπής Java για μορφή VSDX σε αρχείο VSSX. Χρησιμοποιήστε αυτό το παράδειγμα κώδικα για να μετατρέψετε το VSDX σε VSSX σε οποιαδήποτε εφαρμογή που βασίζεται στο Web ή στην επιφάνεια εργασίας Java.
---
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το VSDX σε VSSX χρησιμοποιώντας το Java" %}}
 ...
 Για να αποδώσουμε το VSDX σε VSSX, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή του VSDX σε VSSX μέσω Java" %}}
