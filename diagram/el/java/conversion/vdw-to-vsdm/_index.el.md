...
description: Δείγμα κώδικα μετατροπής Java για μορφή VDW σε αρχείο VSDM. Χρησιμοποιήστε αυτό το παράδειγμα κώδικα για να μετατρέψετε VDW σε VSDM σε οποιαδήποτε εφαρμογή που βασίζεται στο Web ή στην επιφάνεια εργασίας Java.
---
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε VDW σε VSDM χρησιμοποιώντας το Java" %}}

 Για να αποδώσουμε το VDW σε VSDM, θα χρησιμοποιήσουμε
