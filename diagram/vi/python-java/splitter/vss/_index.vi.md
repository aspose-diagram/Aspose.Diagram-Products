---
title: Tách các tệp VSS qua Python
weight: 1400
url: /vi/python-java/splitter/vss/ 
description: Python mã nguồn để Tách tệp vss trong bất kỳ ứng dụng dựa trên Python nào. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tách định dạng VSS trong Python" h2="Tạo ứng dụng Python của riêng bạn để chia nhỏ các tệp VSS " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tách các tệp VSS bằng cách sử dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tách Tệp VSS trong Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Tách các tệp VSS - Python" offSpacer="" %}}
