---
title: Tách các tệp VDW qua Python
weight: 1400
url: /vi/python-java/splitter/vdw/ 
description: Python mã nguồn để Tách tệp vdw trong bất kỳ ứng dụng dựa trên Python nào. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tách định dạng VDW trong Python" h2="Tạo ứng dụng Python của riêng bạn để chia nhỏ các tệp VDW " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tách các tệp VDW bằng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tách Tệp VDW trong Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Tách các tệp VDW - Python" offSpacer="" %}}
