---
title: Xem hoặc Chỉnh sửa VSTM Siêu dữ liệu Tệp qua Python 
weight: 3150
url: /vi/python-java/metadata/vstm/ 
description: Python mã mẫu để chỉnh sửa hoặc xem VSTM siêu dữ liệu trong bất kỳ ứng dụng dựa trên Python nào. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất VSTM Siêu dữ liệu trong Python" h2="Tạo ứng dụng Python của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ VSTM tệp " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Cách trích xuất VSTM siêu dữ liệu bằng cách sử dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để trích xuất VSTM siêu dữ liệu trong Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Giải nén VSTM Siêu dữ liệu - Python" offSpacer="" %}}
