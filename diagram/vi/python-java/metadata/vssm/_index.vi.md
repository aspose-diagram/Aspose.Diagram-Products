---
title: Xem hoặc Chỉnh sửa VSSM Siêu dữ liệu Tệp qua Python 
weight: 3150
url: /vi/python-java/metadata/vssm/ 
description: Python mã mẫu để chỉnh sửa hoặc xem VSSM siêu dữ liệu trong bất kỳ ứng dụng dựa trên Python nào. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất VSSM Siêu dữ liệu trong Python" h2="Tạo ứng dụng Python của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ VSSM tệp " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cách trích xuất VSSM siêu dữ liệu bằng cách sử dụng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để trích xuất VSSM siêu dữ liệu trong Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Giải nén VSSM Siêu dữ liệu - Python" offSpacer="" %}}
