---
title: Chuyển đổi VSSX sang VSX qua Python 
weight: 1960
url: /vi/python-java/conversion/vssx-to-vsx/ 
description: Mã chuyển đổi Python mẫu cho định dạng VSSX thành VSX tệp. Sử dụng mã ví dụ này để chuyển đổi VSSX thành VSX trong bất kỳ ứng dụng dựa trên Python nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSSX thành VSX bằng cách sử dụng Python" %}}

 Để hiển thị VSSX thành VSX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VSSX thành VSX qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng chuyển đổi tệp VSSX thành VSX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSSX bằng một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. VSX tệp sẽ được lưu tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi VSSX thành VSX Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSX thành VSX Bản trình diễn Trực tiếp Chuyển đổi" sectionDescription="[Chuyển đổi VSSX thành VSX](https://products.aspose.app/diagram/conversion/vssx-to-vsx) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp VSSX của bạn, tệp sẽ được chuyển đổi ngay lập tức thành VSX." >}}
