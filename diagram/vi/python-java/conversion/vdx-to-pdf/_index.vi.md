---
title: Chuyển đổi VDX sang PDF qua Python 
weight: 1960
url: /vi/python-java/conversion/vdx-to-pdf/ 
description: Mã chuyển đổi Python mẫu cho định dạng VDX sang tệp PDF. Sử dụng mã ví dụ này để chuyển đổi VDX sang PDF trong bất kỳ ứng dụng dựa trên Python nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi VDX sang PDF qua Python" h2="Xuất Microsoft Visio VDX sang PDF bằng Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển VDX sang PDF bằng Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VDX sang PDF qua Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python các nhà phát triển có thể dễ dàng chuyển đổi tệp VDX sang PDF chỉ trong một vài dòng mã.
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi VDX sang PDF Python" offSpacer="" %}}
