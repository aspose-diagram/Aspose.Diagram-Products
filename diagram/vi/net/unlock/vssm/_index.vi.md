---
title: Mở khóa tài liệu VSSM qua .NET 
weight: 5680
url: /vi/net/unlock/vssm/ 
description: C# mã nguồn để mở khóa VSSM tệp trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mở khóa VSSM Tệp qua C#" h2="Xóa bảo vệ khỏi định dạng Visio bao gồm VSSM bằng cách sử dụng Thư viện .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách mở khóa VSSM Tệp bằng C#" %}}

 Để Mở khóa tệp VSSM, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Mở khóa VSSM Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Mở khóa VSSM Tệp - C#" offSpacer="" %}}
