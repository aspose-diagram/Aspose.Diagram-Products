---
title: Mở khóa tài liệu VSTX qua .NET 
weight: 5680
url: /vi/net/unlock/vstx/ 
description: C# mã nguồn để mở khóa VSTX tệp trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mở khóa VSTX Tệp qua C#" h2="Xóa bảo vệ khỏi định dạng Visio bao gồm VSTX bằng cách sử dụng Thư viện .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách mở khóa VSTX Tệp bằng C#" %}}

 Để Mở khóa tệp VSTX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Mở khóa VSTX Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Mở khóa VSTX Tệp - C#" offSpacer="" %}}
