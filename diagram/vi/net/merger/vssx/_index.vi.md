...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất VSSX tệp bằng cách sử dụng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Hợp nhất VSSX Tệp trong C#" %}}
...
+ Tải tất cả VSSX tệp với đường dẫn đầy đủ.
+ Tạo một tài liệu làm tệp cơ sở
+ Gọi phương thức liên quan để nối và hợp nhất từng tệp một.
+ Gọi phương thức Save () và chuyển tên tệp (đường dẫn đầy đủ) và định dạng (VSSX) làm tham số.
+ Giờ đây, bạn có thể mở và sử dụng VSSX tệp trong Microsoft Office, Adobe PDF hoặc bất kỳ chương trình tương thích nào khác.
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất VSSX Tệp - C#" offSpacer="" %}}
