---
title: Hợp nhất các tệp VSTM qua .NET 
weight: 2740
url: /vi/net/merger/vstm/ 
description: C# mã nguồn để kết hợp các tài liệu VSTM trên .NET Framework, .NET Core, Mono hoặc COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các Định dạng VSTM trong C#" h2="Hợp nhất tài liệu VSTM gốc và hiệu suất cao bằng cách sử dụng API Aspose.Diagram for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất tệp VSTM bằng cách sử dụng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để hợp nhất các tệp VSTM trong C#" %}}
...
+ Tải tất cả các tệp VSTM với đường dẫn đầy đủ.
+ Tạo một tài liệu làm tệp cơ sở
+ Gọi phương thức liên quan để nối và hợp nhất từng tệp một.
+ Gọi phương thức Save () và truyền tên tệp (đường dẫn đầy đủ) và định dạng (VSTM) làm tham số.
+ Bây giờ bạn có thể mở và sử dụng tệp VSTM trong Microsoft Office, Adobe PDF hoặc bất kỳ chương trình tương thích nào khác.
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tệp VSTM - C#" offSpacer="" %}}
