---
title: Áp dụng chủ đề đặt trước cho VTX tài liệu qua .NET 
weight: 3050
url: /vi/net/theme/vtx/ 
description: C# mã nguồn để áp dụng chủ đề đặt trước cho tệp vtx trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Áp dụng Chủ đề cài sẵn cho VTX trong C#" h2="Gốc và hiệu suất cao áp dụng chủ đề đặt trước cho VTX tài liệu bằng cách sử dụng API Aspose.Diagram for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Áp dụng Chủ đề Đặt trước cho VTX Sử dụng Tệp C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước áp dụng chủ đề cài sẵn cho VTX Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Áp dụng Chủ đề cài sẵn cho VTX Tệp - C#" offSpacer="" %}}
