---
title: Xem hoặc chỉnh sửa siêu dữ liệu tệp VSSX qua .NET 
weight: 3050
url: /vi/net/metadata/vssx/ 
description: C# mã nguồn để chỉnh sửa hoặc xem siêu dữ liệu định dạng VSSX trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất Siêu dữ liệu VSSX trong C#" h2="Tạo ứng dụng .NET của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ các tệp VSSX bằng cách sử dụng API phía máy chủ." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để trích xuất siêu dữ liệu VSSX trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Giải nén siêu dữ liệu VSSX - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram là một Microsoft Visio thao tác định dạng tài liệu API. Người ta có thể dễ dàng tải, tạo, sửa đổi, thao tác bao gồm các phần tử daigram và chuyển đổi Visio sơ đồ sang các định dạng khác như PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF và hơn thế nữa. Đây là một phần mềm độc lập API và không yêu cầu cài đặt Microsoft Visio hoặc bất kỳ phần mềm nào khác.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Trích xuất siêu dữ liệu của VSSX qua ứng dụng trực tuyến" sectionDescription="Xem và chỉnh sửa Siêu dữ liệu thành tài liệu VSSX bằng cách truy cập [Trang web Demos Trực tiếp](https://products.aspose.app/diagram/metadata). Bản demo trực tiếp có những lợi ích sau" >}}
