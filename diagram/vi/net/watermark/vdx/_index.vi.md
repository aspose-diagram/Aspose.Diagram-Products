---
title: Hình mờ VDX tài liệu qua .NET 
weight: 3050
url: /vi/net/watermark/vdx/ 
description: C# mã nguồn để thêm hình mờ vào tệp vdx trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Thêm Hình mờ Văn bản vào VDX trong C#" h2="Hình mờ tài liệu gốc và hiệu suất cao VDX bằng cách sử dụng API Aspose.Diagram for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tạo hình mờ VDX Sử dụng tệp C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Đánh dấu nước VDX Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Hình mờ Vdx Tệp - C#" offSpacer="" %}}
