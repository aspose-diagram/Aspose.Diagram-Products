---
title: Hình mờ VSDM tài liệu qua .NET 
weight: 3050
...
{{< blocks/products/pf/i18n/upper-banner h1="Thêm Hình mờ Văn bản vào VSDM trong C#" h2="Hình mờ tài liệu gốc và hiệu suất cao VSDM bằng cách sử dụng API Aspose.Diagram for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tạo hình mờ VSDM Sử dụng tệp C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Đánh dấu nước VSDM Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Hình mờ VSDM Tệp - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram là một Microsoft Visio thao tác định dạng tài liệu API. Người ta có thể dễ dàng tải, tạo, sửa đổi, thao tác bao gồm các phần tử daigram và chuyển đổi Visio sơ đồ sang các định dạng khác như PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF và hơn thế nữa. Nó là một phần mềm độc lập API và không yêu cầu cài đặt Microsoft Visio hoặc bất kỳ phần mềm nào khác.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tuyến VSDM WaterMarker Trực tiếp" sectionDescription="Tài liệu WaterMark VSDM ngay bây giờ bằng cách truy cập [Trang web Demos Trực tiếp](https://products.aspose.app/diagram/watermark). Bản demo trực tiếp có những lợi ích sau" >}}
