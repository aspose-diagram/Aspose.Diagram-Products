...
description: Mã mẫu cho chuyển đổi VSSX sang SVG C#. Sử dụng API mã mẫu cho các tệp VSSX hàng loạt để chuyển đổi SVG trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSSX sang SVG bằng cách sử dụng C#" %}}
 ...
 Để chuyển đổi VSSX sang SVG, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp VSSX sang SVG chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi phương thức Diagram .Save với đường dẫn tệp đầu ra và SaveFileFormat.SVG làm tham số1. Tệp SVG sẽ được lưu tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị VSSX sang SVG C# Chuyển đổi" offSpacer="" %}}
