...
description: Mã mẫu cho chuyển đổi VSSX sang VTX C#. Sử dụng API mã ví dụ cho hàng loạt tệp VSSX sang chuyển đổi VTX trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSSX sang VTX bằng cách sử dụng C#" %}}

 Để chuyển đổi VSSX sang VTX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VSSX sang VTX qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp VSSX sang VTX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi phương thức Diagram .Save với đường dẫn tệp đầu ra và SaveFileFormat.VTX làm tham số1. Tệp VTX sẽ được lưu theo đường dẫn được chỉ định
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ứng dụng miễn phí để chuyển đổi VSSX sang VTX" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi cho [Chuyển đổi VSSX sang VTX](https://products.aspose.app/diagram/conversion/vssx-to-vtx) với những lợi ích sau đây." >}}
