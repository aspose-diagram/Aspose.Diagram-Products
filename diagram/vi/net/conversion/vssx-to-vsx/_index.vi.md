...
description: Mã mẫu cho chuyển đổi VSSX sang VSX C#. Sử dụng API mã mẫu cho các tệp VSSX hàng loạt để chuyển đổi VSX trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSSX sang VSX bằng cách sử dụng C#" %}}

 Để chuyển đổi VSSX sang VSX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VSSX sang VSX qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp VSSX sang VSX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi phương thức Diagram .Save với đường dẫn tệp đầu ra và SaveFileFormat.VSX làm tham số1. Tệp VSX sẽ được lưu theo đường dẫn được chỉ định
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ứng dụng miễn phí để chuyển đổi VSSX sang VSX" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi cho [Chuyển đổi VSSX sang VSX](https://products.aspose.app/diagram/conversion/vssx-to-vsx) với những lợi ích sau đây." >}}
