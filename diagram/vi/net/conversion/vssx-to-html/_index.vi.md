...
description: Mã mẫu cho chuyển đổi VSSX sang HTML C#. Sử dụng API mã ví dụ cho hàng loạt tệp VSSX sang chuyển đổi HTML trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp VSSX sang HTML chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi phương thức Diagram .Save với đường dẫn tệp đầu ra và SaveFileFormat.HTML làm tham số1. Tệp HTML sẽ được lưu tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị VSSX sang HTML C# Chuyển đổi" offSpacer="" %}}
