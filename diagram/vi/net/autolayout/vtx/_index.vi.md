...
{{% blocks/products/pf/agp/content h2="Cách Tự động Bố cục VTX Sử dụng Tệp C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước cho Bố cục Tự động VTX Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Bố cục Tự động VTX Tệp - C#" offSpacer="" %}}
