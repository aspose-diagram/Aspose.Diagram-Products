...
{{% blocks/products/pf/agp/content h2="Cách tự động bố trí tệp VST bằng cách sử dụng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước cho Tệp VST bố cục tự động trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tệp VST bố cục tự động - C#" offSpacer="" %}}
