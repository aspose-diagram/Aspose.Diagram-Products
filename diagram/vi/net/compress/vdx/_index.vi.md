...
{{% blocks/products/pf/agp/content h2="Cách nén tệp VDX bằng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Nén Tệp VDX trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Nén tệp VDX - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram là một Microsoft Visio thao tác định dạng tài liệu API. Người ta có thể dễ dàng tải, tạo, sửa đổi, thao tác bao gồm các phần tử daigram và chuyển đổi Visio sơ đồ sang các định dạng khác như PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF và hơn thế nữa. Đây là một phần mềm độc lập API và không yêu cầu cài đặt Microsoft Visio hoặc bất kỳ phần mềm nào khác.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tuyến VDX nén trực tuyến" sectionDescription="Nén tài liệu VDX ngay bây giờ bằng cách truy cập [Trang web Demos Trực tiếp](https://products.aspose.app/diagram/compress). Bản demo trực tiếp có những lợi ích sau" >}}
