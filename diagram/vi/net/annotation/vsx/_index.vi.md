---
title: Thêm, Chỉnh sửa & Xóa Chú thích khỏi VSX qua C# 
weight: 3050
url: /vi/net/annotation/vsx/ 
description: C# mã nguồn để chú thích VSX tệp trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Cách chú thích VSX Tệp bằng cách sử dụng C#" h2="Chú thích tài liệu gốc và hiệu suất cao VSX bằng cách sử dụng API Aspose.Diagram for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chú thích VSX Tệp bằng cách sử dụng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để chú thích VSX Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Xóa nhận xét khỏi VSX Tệp - C#" offSpacer="" %}}
