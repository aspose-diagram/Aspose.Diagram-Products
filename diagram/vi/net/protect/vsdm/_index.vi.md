---
title: Bảo vệ và khóa VSDM tài liệu qua .NET 
weight: 5580
url: /vi/net/protect/vsdm/ 
description: C# mã nguồn để khóa VSDM tệp trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Bảo vệ VSDM Tệp qua C#" h2="Bảo vệ Visio bao gồm VSDM định dạng bằng cách sử dụng Thư viện .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Bảo vệ VSDM Tệp Sử dụng C#" %}}

 Để bảo vệ tệp VSDM, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Bảo vệ VSDM Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Bảo vệ VSDM Tệp - C#" offSpacer="" %}}
