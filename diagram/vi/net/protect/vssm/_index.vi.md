---
title: Bảo vệ và khóa VSSM tài liệu qua .NET 
weight: 5580
url: /vi/net/protect/vssm/ 
description: C# mã nguồn để khóa VSSM tệp trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Bảo vệ VSSM Tệp qua C#" h2="Bảo vệ Visio bao gồm VSSM định dạng bằng cách sử dụng Thư viện .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách Bảo vệ VSSM Tệp Sử dụng C#" %}}

 Để bảo vệ tệp VSSM, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Bảo vệ VSSM Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Bảo vệ VSSM Tệp - C#" offSpacer="" %}}
