---
title: Bảo vệ và khóa VSTM tài liệu qua .NET 
weight: 5580
url: /vi/net/protect/vstm/ 
description: C# mã nguồn để khóa VSTM tệp trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Bảo vệ VSTM Tệp qua C#" h2="Bảo vệ Visio bao gồm VSTM định dạng bằng cách sử dụng Thư viện .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách bảo vệ tệp VDW bằng cách sử dụng C#" %}}
 ...
 Để bảo vệ tệp VSTM, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Bảo vệ VSTM Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Bảo vệ VSTM Tệp - C#" offSpacer="" %}}
