---
title: Vẽ geomtry vào VTX tài liệu qua .NET 
weight: 3050
url: /vi/net/drawing/vtx/ 
description: C# mã nguồn để vẽ địa lý vào tệp vtx trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vẽ Geomtry tới VTX trong C#" h2="Gốc và hiệu suất cao vẽ địa lý vào VTX tài liệu bằng cách sử dụng các API Aspose.Diagram for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách vẽ Geomtry vào VTX Tệp bằng cách sử dụng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Vẽ Geomtry vào VTX Tệp trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vẽ Geomtry vào VTX Tệp - C#" offSpacer="" %}}
