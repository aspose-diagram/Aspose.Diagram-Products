---
title: Xem VTX Định dạng Tệp qua .NET 
weight: 3320
url: /vi/net/viewer/vtx/ 
description: C# mã nguồn để tải, kết xuất và hiển thị VTX tài liệu trên .NET Framework, .NET Core, Mono hoặc COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VTX Trình xem Tệp for .NET" h2="Xem các tệp Microsoft Visio VTX trong trình duyệt mà không yêu cầu ứng dụng Visio hoặc Office Tự động hoá." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
