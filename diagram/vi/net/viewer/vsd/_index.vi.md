---
title: Xem VSD Định dạng Tệp qua .NET 
weight: 470
url: /vi/net/viewer/vsd/ 
description: C# mã nguồn để tải, kết xuất và hiển thị VSD tài liệu trên .NET Framework, .NET Core, Mono hoặc COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSD Trình xem Tệp for .NET" h2="Xem các tệp Microsoft Visio VSD trong trình duyệt mà không yêu cầu ứng dụng Visio hoặc Office Tự động hoá." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSD" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Xem VSD qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# mã để xem VSD" offSpacer="" %}}

```cs

// tải tệp VSD qua một phiên bản của Diagram
var diagram = new Aspose.Diagram.Diagram("template.vsd");
// chuyển đổi VSD sang định dạng HTML
