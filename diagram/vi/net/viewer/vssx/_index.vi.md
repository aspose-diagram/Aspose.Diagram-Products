---
title: Xem VSSX Định dạng Tệp qua .NET 
weight: 1980
url: /vi/net/viewer/vssx/ 
description: C# mã nguồn để tải, kết xuất và hiển thị VSSX tài liệu trên .NET Framework, .NET Core, Mono hoặc COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX Trình xem Tệp for .NET" h2="Xem các tệp Microsoft Visio VSSX trong trình duyệt mà không yêu cầu ứng dụng Visio hoặc Office Tự động hoá." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
