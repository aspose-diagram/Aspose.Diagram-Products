---
title: Xem Định dạng Tệp VSSX qua .NET 
weight: 1980
url: /vi/net/viewer/vssx/ 
description: C# mã nguồn để tải, kết xuất và hiển thị các tài liệu VSSX trên .NET Framework, .NET Core, Mono hoặc COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Trình xem tệp VSSX for .NET" h2="Xem các tệp Microsoft Visio VSSX trong trình duyệt mà không yêu cầu ứng dụng Visio hoặc Tự động hóa Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách xem tệp VSSX bằng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để xem VSSX qua C#" %}}
...
1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi phương thức Diagram .Save với SaveFileFormat.HTML dưới dạng tham số1. Tải HTML kết quả trong trình duyệt mặc định qua Process.Start
...
{{% blocks/products/pf/agp/code-block title="C# mã để xem VSSX" offSpacer="" %}}

```cs

// tải tệp VSSX qua một phiên bản của Diagram
var diagram = new Aspose.Diagram.Diagram("template.vssx");
// chuyển đổi VSSX sang định dạng HTML
 ...
 Aspose.Diagram là một Microsoft Visio thao tác định dạng tài liệu API. Người ta có thể dễ dàng tải, tạo, sửa đổi, thao tác bao gồm các phần tử daigram và chuyển đổi Visio sơ đồ sang các định dạng khác như PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF và hơn thế nữa. Đây là một phần mềm độc lập API và không yêu cầu cài đặt Microsoft Visio hoặc bất kỳ phần mềm nào khác.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Ứng dụng miễn phí để xem VSSX" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi để [Xem VSSX](https://products.aspose.app/diagram/viewer/vssx) với những lợi ích sau đây." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp VSSX và nhấn nút \"Xem\"" >}}
