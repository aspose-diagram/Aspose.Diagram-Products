...
{{% blocks/products/pf/agp/content h2="Cách tự động bố cục tệp VDW bằng cách sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước cho Tệp VDW bố cục tự động trong Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Tệp VDW bố cục tự động - Java" offSpacer="" %}}
