---
title: Xem hoặc Chỉnh sửa Siêu dữ liệu của Tệp VSS qua Java 
weight: 3150
url: /vi/java/metadata/vss/ 
description: Java mã mẫu để chỉnh sửa hoặc xem siêu dữ liệu VSS trên Java Môi trường thời gian chạy cho Ứng dụng JSP / JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Trích xuất Siêu dữ liệu VSS trong Java" h2="Tạo ứng dụng Java của riêng bạn để thêm, chỉnh sửa, xóa hoặc trích xuất siêu dữ liệu từ các tệp VSS " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách trích xuất siêu dữ liệu VSS bằng cách sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để trích xuất siêu dữ liệu VSS trong Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Giải nén siêu dữ liệu VSS - Java" offSpacer="" %}}
