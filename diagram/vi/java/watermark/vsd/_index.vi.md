---
title: Hình mờ VSD tài liệu qua Java 
weight: 3050
url: /vi/java/watermark/vsd/ 
description: Java mã mẫu để thêm hình mờ vào VSD tài liệu trên Java Môi trường thời gian chạy cho Ứng dụng JSP / JSF và Ứng dụng máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="WaterMark VSD Định dạng trong Java" h2="Trình đánh dấu tài liệu VSD gốc sử dụng API Java phía máy chủ." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Cách tạo hình mờ VSD Tệp bằng cách sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để tạo watermark cho VSD Tệp trong Java" %}}
