---
title: Chuyển đổi VDX sang VSTX qua Java 
weight: 2150
url: /vi/java/conversion/vdx-to-vstx/ 
description: Mã chuyển đổi Java mẫu cho định dạng VDX thành VSTX tệp. Sử dụng mã ví dụ này để chuyển đổi VDX thành VSTX trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi VDX sang VSTX qua Java" h2="Xuất Microsoft Visio VDX sang VSTX bằng thư viện gốc Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VDX thành VSTX bằng cách sử dụng Java" %}}

 Để hiển thị VDX thành VSTX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VDX thành VSTX qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp VDX thành VSTX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VDX bằng một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. VSTX tệp sẽ được lưu tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi VDX thành VSTX Java" offSpacer="" %}}

```cs
// tải VDX trong một đối tượng của Diagram 
Diagram visio = new Diagram("template.vdx");
// lưu VDX dưới dạng VSTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VDX thành VSTX Bản trình diễn Trực tiếp Chuyển đổi" sectionDescription="[Chuyển đổi VDX thành VSTX](https://products.aspose.app/diagram/conversion/vdx-to-vstx) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp VDX của bạn, tệp sẽ được chuyển đổi ngay lập tức thành VSTX." >}}
