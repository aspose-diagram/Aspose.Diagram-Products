---
title: Chuyển đổi VDW sang VSX qua Java 
weight: 2840
url: /vi/java/conversion/vdw-to-vsx/ 
description: Mã chuyển đổi Java mẫu cho định dạng VDW thành tệp VSX. Sử dụng mã ví dụ này để chuyển đổi VDW sang VSX trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VDW sang VSX bằng cách sử dụng Java" %}}

 Để kết xuất VDW sang VSX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VDW sang VSX qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp VDW sang VSX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VDW với một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. Tệp VSX sẽ được lưu theo đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi VDW sang VSX Java" offSpacer="" %}}
