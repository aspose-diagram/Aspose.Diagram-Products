...
description: Mã chuyển đổi Java mẫu cho định dạng VSSX thành tệp VSDX. Sử dụng mã ví dụ này để chuyển đổi VSSX thành VSDX trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSSX thành VSDX Sử dụng Java" %}}
...
1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. VSDX tệp sẽ được lưu tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="VSSX thành VSDX Java Mã nguồn chuyển đổi" offSpacer="" %}}
