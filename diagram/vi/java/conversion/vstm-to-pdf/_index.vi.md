---
title: Chuyển đổi VSTM sang PDF qua Java 
weight: 1670
url: /vi/java/conversion/vstm-to-pdf/ 
description: Mã chuyển đổi Java mẫu cho định dạng VSTM sang tệp PDF. Sử dụng mã ví dụ này để chuyển đổi VSTM sang PDF trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi VSTM sang PDF qua Java" h2="Xuất Microsoft Visio VSTM sang PDF bằng thư viện Java gốc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển VSTM sang PDF bằng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VSTM sang PDF qua Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi VSTM sang PDF Java" offSpacer="" %}}
