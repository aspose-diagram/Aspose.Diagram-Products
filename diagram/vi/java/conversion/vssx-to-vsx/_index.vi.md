---
title: Chuyển đổi VSSX sang VSX qua Java 
weight: 5080
url: /vi/java/conversion/vssx-to-vsx/ 
description: Mã chuyển đổi Java mẫu cho định dạng VSSX thành tệp VSX. Sử dụng mã ví dụ này để chuyển đổi VSSX sang VSX trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSSX sang VSX bằng cách sử dụng Java" %}}

 Để kết xuất VSSX thành VSX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VSSX sang VSX qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp VSSX sang VSX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. Tệp VSX sẽ được lưu theo đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi VSSX sang VSX Java" offSpacer="" %}}

```cs
// tải VSSX trong một đối tượng của Diagram 
Diagram visio = new Diagram("template.vssx");
// lưu VSSX dưới dạng VSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi VSSX sang VSX" sectionDescription="[Chuyển đổi VSSX sang VSX](https://products.aspose.app/diagram/conversion/vssx-to-vsx) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp VSSX của bạn, tệp sẽ được chuyển đổi ngay lập tức sang VSX." >}}
