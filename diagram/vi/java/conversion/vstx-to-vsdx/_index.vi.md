...
description: Mã chuyển đổi Java mẫu cho định dạng VSTX thành tệp VSDX. Sử dụng mã ví dụ này để chuyển đổi VSTX thành VSDX trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSTX thành VSDX Sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VSTX sang VSDX qua Java" %}}
...
1. Tải tệp VSTX với một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. VSDX tệp sẽ được lưu tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="VSTX thành VSDX Java Mã nguồn chuyển đổi" offSpacer="" %}}
