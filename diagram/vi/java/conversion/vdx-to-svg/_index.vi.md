---
title: Chuyển đổi VDX sang SVG qua Java 
weight: 2460
url: /vi/java/conversion/vdx-to-svg/ 
description: Mã chuyển đổi Java mẫu cho định dạng VDX thành tệp SVG. Sử dụng mã ví dụ này để chuyển đổi VDX thành SVG trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi VDX sang SVG qua Java" h2="Xuất Microsoft Visio VDX sang SVG bằng cách sử dụng thư viện Java gốc." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VDX sang SVG bằng cách sử dụng Java" %}}

 Để hiển thị VDX thành SVG, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VDX sang SVG qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp VDX sang SVG chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VDX với một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. Tệp SVG sẽ được lưu tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi VDX sang SVG Java" offSpacer="" %}}

```cs
// tải VDX trong một đối tượng của Diagram 
Diagram visio = new Diagram("template.vdx");
// lưu VDX dưới dạng SVG 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi VDX sang SVG" sectionDescription="[Chuyển đổi VDX sang SVG](https://products.aspose.app/diagram/conversion/vdx-to-svg) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp VDX của bạn, nó sẽ được chuyển đổi ngay lập tức thành SVG." >}}
