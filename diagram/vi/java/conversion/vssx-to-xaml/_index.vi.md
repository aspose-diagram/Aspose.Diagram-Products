...
description: Mã chuyển đổi Java mẫu cho định dạng VSSX thành tệp XAML. Sử dụng mã ví dụ này để chuyển đổi VSSX thành XAML trong bất kỳ ứng dụng dựa trên Web hoặc Desktop Java nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSSX sang XAML bằng cách sử dụng Java" %}}
 ...
 Để kết xuất VSSX sang XAML, chúng tôi sẽ sử dụng
...
1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. Tệp XAML sẽ được lưu tại đường dẫn được chỉ định
