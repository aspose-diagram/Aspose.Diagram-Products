...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất VTX Tệp bằng cách sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Hợp nhất VTX Tệp trong Java" %}}
...
+ lưu tệp VTX đã hợp nhất tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất VTX Tệp - Java" offSpacer="" %}}
