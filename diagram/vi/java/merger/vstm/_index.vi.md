...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất VSTM Tệp bằng cách sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Hợp nhất VSTM Tệp trong Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất VSTM Tệp - Java" offSpacer="" %}}
