---
title: Hợp nhất các tệp VSSX qua Java 
weight: 2720
url: /vi/java/merger/vssx/ 
description: Java mã mẫu để kết hợp các tài liệu VSSX trên Java Môi trường thời gian chạy cho Ứng dụng JSP / JSF và Ứng dụng trên máy tính để bàn.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các Định dạng VSSX trong Java" h2="Hợp nhất tài liệu VSSX gốc bằng cách sử dụng API Java phía máy chủ." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất các tệp VSSX bằng cách sử dụng Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để hợp nhất các tệp VSSX trong Java" %}}
...
+ lưu tệp VSSX đã hợp nhất theo đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tệp VSSX - Java" offSpacer="" %}}
