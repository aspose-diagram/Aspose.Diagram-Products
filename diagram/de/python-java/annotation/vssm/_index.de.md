---
title: Anmerkung von VSSM über Python hinzufügen, bearbeiten und löschen 
weight: 3250
url: /de/python-java/annotation/vssm/ 
description: Python-Quellcode zum Annotieren der VSSM-Datei in einer beliebigen Python-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Kommentieren Sie VSSM Formate in Python" h2="Native VSSM-Dokumentannotation mit serverseitigen Python-APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="So kommentieren Sie VSSM-Dateien mit Python" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSM Dateien kommentieren - Python" offSpacer="" %}}
