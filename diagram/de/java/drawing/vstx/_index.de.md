---
title: Geometrie über Java in VSTX-Dokument zeichnen 
weight: 3050
url: /de/Java/drawing/vstx/ 
description: Java-Quellcode zum Zeichnen von Geometrie in die vstx-Datei in der Java-Laufzeitumgebung für JSP/JSF-Anwendung und Desktop-Anwendungen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Zeichnen Sie Geometrie zu VSTX in Java" h2="Native und hochleistungsfähige Zeichnungsgeometrie für VSTX-Dokument mit serverseitigen Aspose.Diagram for Java-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So zeichnen Sie Geometrie mit Java in die VSTX-Datei" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zeichnen von Geometrie in VSTX Dateien in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Geometrie in VSTX Dateien zeichnen - Java" offSpacer="" %}}
