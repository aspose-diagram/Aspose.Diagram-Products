---
title: Voreingestelltes Design über Java auf VDX Dokument anwenden 
weight: 3050
url: /de/Java/theme/vdx/ 
description: Java-Quellcode zum Anwenden des voreingestellten Designs auf die vdx-Datei in der Java-Laufzeitumgebung für JSP/JSF-Anwendung und Desktop-Anwendungen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voreingestelltes Design auf VDX in Java anwenden" h2="Native und leistungsstarke Anwendung des voreingestellten Designs auf das VDX-Dokument mithilfe von serverseitigen Aspose.Diagram for Java-APIs, ohne die Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So wenden Sie ein voreingestelltes Design mit Java auf die Datei VDX an" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Anwenden des voreingestellten Designs auf VDX Dateien in Java" %}}
