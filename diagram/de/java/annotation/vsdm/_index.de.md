---
title: Anmerkung von VSDM über Java hinzufügen, bearbeiten und löschen 
weight: 3250
url: /de/java/annotation/vsdm/ 
description: Java-Quellcode zum Kommentieren der VSDM-Datei in Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Kommentieren Sie VSDM Formate in Java" h2="Native VSDM-Dokumentannotation mit serverseitigen Java-APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="So kommentieren Sie VSDM-Dateien mit Java" %}}

 Um die Datei VSDM zu kommentieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte für Anmerkungs-VSDM-Dateien in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDM Dateien kommentieren - Java" offSpacer="" %}}
