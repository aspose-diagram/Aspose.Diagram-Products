---
title: Konvertieren Sie VSTM in VSX über Java 
weight: 4450
url: /de/java/conversion/vstm-to-vsx/ 
description: Beispiel-Umwandlungscode Java für das VSTM-Format in eine VSX-Datei. Verwenden Sie diesen Beispielcode, um VSTM in VSX in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTM in VSX über Java" h2="Exportieren Sie Microsoft Visio VSTM nach VSX unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTM in VSX mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSTM-Dateien in nur wenigen Codezeilen problemlos in VSX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTM-zu-VSX-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie das VSTM in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vstm");
// Speichern Sie VSTM als VSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM-zu-VSX-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSTM in VSX](https://products.aspose.app/diagram/conversion/vstm-to-vsx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
