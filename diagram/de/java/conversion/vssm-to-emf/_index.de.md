...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können die VSSM-Datei in nur wenigen Codezeilen einfach in EMF konvertieren.
...
{{% blocks/products/pf/agp/code-block title="VSSM zu EMF Java Conversion-Quellcode" offSpacer="" %}}
