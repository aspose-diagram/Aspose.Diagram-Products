---
title: Konvertieren Sie VSSM in JPEG über Java 
weight: 310
url: /de/java/conversion/vssm-to-jpeg/ 
description: Beispiel-Umwandlungscode Java für das VSSM-Format in eine JPEG-Datei. Verwenden Sie diesen Beispielcode, um VSSM in jeder Web- oder Desktop-Java-basierten Anwendung in JPEG zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSSM in JPEG über Java" h2="Exportieren Sie Microsoft Visio VSSM mithilfe der nativen Java-Bibliothek in JPEG." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSSM in JPEG mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSSM in JPEG über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VSSM-Dateien in nur wenigen Codezeilen ganz einfach in JPEG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSSM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die JPEG-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSSM-zu-JPEG-Java-Umwandlungsquellcode" offSpacer="" %}}
