...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSSM in VSTX mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können die VSSM-Datei in nur wenigen Codezeilen einfach in VSTX umwandeln.
...
{{% blocks/products/pf/agp/code-block title="VSSM bis VSTX Java Conversion-Quellcode" offSpacer="" %}}
