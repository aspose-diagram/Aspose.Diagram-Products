---
title: Konvertieren Sie VSSM in XPS über Java 
weight: 1640
url: /de/java/conversion/vssm-to-xps/ 
description: Beispiel-Umwandlungscode Java für das VSSM-Format in eine XPS-Datei. Verwenden Sie diesen Beispielcode, um VSSM in einer beliebigen Web- oder Desktop-Java-basierten Anwendung in XPS zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSSM in XPS über Java" h2="Exportieren Sie Microsoft Visio VSSM unter Verwendung der nativen Java-Bibliothek nach XPS." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSSM in XPS mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSSM in XPS über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VSSM-Dateien in nur wenigen Codezeilen problemlos in XPS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSSM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die XPS-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSSM-zu-XPS-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VSSM in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vssm");
// Speichern Sie VSSM als XPS 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSM-zu-XPS-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSSM in XPS](https://products.aspose.app/diagram/conversion/vssm-to-xps) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
