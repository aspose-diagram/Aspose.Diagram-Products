---
title: Konvertieren Sie VSTX in EMF über Java 
weight: 3050
url: /de/java/conversion/vstx-to-emf/ 
description: Beispiel-Umwandlungscode Java für das VSTX-Format in eine EMF-Datei. Verwenden Sie diesen Beispielcode, um VSTX in EMF in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTX in EMF über Java" h2="Exportieren Sie Microsoft Visio VSTX mithilfe der nativen Java-Bibliothek nach EMF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSTX-Dateien in nur wenigen Codezeilen problemlos in EMF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die VSTX-Datei mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die EMF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTX-zu-EMF-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VSTX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vstx");
// Speichern Sie VSTX als EMF 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX-zu-EMF-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSTX in EMF](https://products.aspose.app/diagram/conversion/vstx-to-emf) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
