...
description: Beispiel-Umwandlungscode Java für das VSTX-Format in eine TIFF-Datei. Verwenden Sie diesen Beispielcode, um VSTX in TIFF in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTX in TIFF mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSTX-Dateien in nur wenigen Codezeilen ganz einfach in TIFF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die VSTX-Datei mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die TIFF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX-zu-TIFF-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSTX in TIFF](https://products.aspose.app/diagram/conversion/vstx-to-tiff) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
