---
title: Konvertieren Sie VSSM in XAML über Java 
weight: 4840
url: /de/java/conversion/vssm-to-xaml/ 
description: Beispiel-Umwandlungscode Java für das VSSM-Format in eine XAML-Datei. Verwenden Sie diesen Beispielcode zum Konvertieren von VSSM in XAML innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSSM in XAML über Java" h2="Exportieren Sie Microsoft Visio VSSM in XAML unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSSM mit Java in XAML" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSSM in XAML über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können die VSSM-Datei in nur wenigen Codezeilen problemlos in XAML konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSSM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die XAML-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSSM-zu-XAML-Java-Umwandlungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSM-zu-XAML-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSSM in XAML](https://products.aspose.app/diagram/conversion/vssm-to-xaml) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
