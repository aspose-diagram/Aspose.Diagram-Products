---
title: Konvertieren Sie VSSM in VSTM über Java 
weight: 360
url: /de/java/conversion/vssm-to-vstm/ 
description: Beispiel-Umwandlungscode Java für das VSSM-Format in die VSTM-Datei. Verwenden Sie diesen Beispielcode, um VSSM in VSTM in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSSM in VSTM über Java" h2="Exportieren Sie Microsoft Visio VSSM nach VSTM unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSSM in VSTM mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSSM in VSTM über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VSSM-Dateien in nur wenigen Codezeilen problemlos in VSTM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSSM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSTM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSSM-zu-VSTM-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VSSM in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vssm");
// Speichern Sie VSSM als VSTM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSM-zu-VSTM-Konvertierungs-Live-Demos" sectionDescription="[Konvertieren Sie VSSM in VSTM](https://products.aspose.app/diagram/conversion/vssm-to-vstm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
