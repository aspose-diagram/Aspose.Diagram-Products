...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSSM in VSTM mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können die VSSM-Datei in nur wenigen Codezeilen einfach in VSTM umwandeln.
...
{{% blocks/products/pf/agp/code-block title="VSSM bis VSTM Java Conversion-Quellcode" offSpacer="" %}}
