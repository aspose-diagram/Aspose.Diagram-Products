...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSSM in VSDM mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können die VSSM-Datei in nur wenigen Codezeilen einfach in VSDM umwandeln.
...
{{% blocks/products/pf/agp/code-block title="VSSM bis VSDM Java Conversion-Quellcode" offSpacer="" %}}
