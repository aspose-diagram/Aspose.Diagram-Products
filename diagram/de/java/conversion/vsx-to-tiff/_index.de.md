...
description: Beispiel-Umwandlungscode Java für das VSX-Format in eine TIFF-Datei. Verwenden Sie diesen Beispielcode, um VSX in TIFF in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX in TIFF mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSX-Dateien in nur wenigen Codezeilen ganz einfach in TIFF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die TIFF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSX-zu-TIFF-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSX in TIFF](https://products.aspose.app/diagram/conversion/vsx-to-tiff) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
