...
description: Beispiel-Umwandlungscode Java für das VTX-Format in eine TIFF-Datei. Verwenden Sie diesen Beispielcode, um VTX in TIFF in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX in TIFF mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VTX-Dateien in nur wenigen Codezeilen ganz einfach in TIFF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die TIFF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{< blocks/products/pf/agp/demobox sectionTitle="VTX-zu-TIFF-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VTX in TIFF](https://products.aspose.app/diagram/conversion/vtx-to-tiff) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
