---
title: Konvertieren Sie VSTX in VSX über Java 
weight: 2240
url: /de/java/conversion/vstx-to-vsx/ 
description: Beispiel-Umwandlungscode Java für das VSTX-Format in eine VSX-Datei. Verwenden Sie diesen Beispielcode, um VSTX in VSX in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTX in VSX über Java" h2="Exportieren Sie Microsoft Visio VSTX nach VSX unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTX in VSX mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSTX-Dateien in nur wenigen Codezeilen problemlos in VSX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die VSTX-Datei mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTX-zu-VSX-Java-Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VSTX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vstx");
// Speichern Sie VSTX als VSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX-zu-VSX-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSTX in VSX](https://products.aspose.app/diagram/conversion/vstx-to-vsx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
