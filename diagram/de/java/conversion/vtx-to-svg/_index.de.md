---
title: Konvertieren Sie VTX in SVG über Java 
weight: 5020
url: /de/java/conversion/vtx-to-svg/ 
description: Beispiel-Umwandlungscode Java für das VTX-Format in eine SVG-Datei. Verwenden Sie diesen Beispielcode, um VTX in einer beliebigen Web- oder Desktop-Java-basierten Anwendung in SVG umzuwandeln.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VTX in SVG über Java" h2="Exportieren Sie Microsoft Visio VTX mithilfe der nativen Java-Bibliothek in SVG." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VTX-Dateien in nur wenigen Codezeilen ganz einfach in SVG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die SVG-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VTX-zu-SVG-Java-Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VTX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vtx");
// Speichern Sie VTX als SVG 
