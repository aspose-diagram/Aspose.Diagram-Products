---
title: VSTM über Java in JPEG konvertieren 
weight: 1240
url: /de/java/conversion/vstm-to-jpeg/ 
description: Beispiel-Umwandlungscode Java für das VSTM-Format in eine JPEG-Datei. Verwenden Sie diesen Beispielcode, um VSTM in JPEG in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM über Java in JPEG konvertieren" h2="Exportieren Sie Microsoft Visio VSTM in JPEG mithilfe der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTM in JPEG mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSTM in JPEG über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VSTM-Dateien in nur wenigen Codezeilen ganz einfach in JPEG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die JPEG-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTM-zu-JPEG-Java-Konvertierungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos zur Umwandlung von VSTM in JPEG" sectionDescription="[Konvertieren Sie VSTM in JPEG](https://products.aspose.app/diagram/conversion/vstm-to-jpeg) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
