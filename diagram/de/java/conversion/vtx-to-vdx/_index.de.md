---
title: VTX über Java in VDX umwandeln 
weight: 1070
url: /de/java/conversion/vtx-to-vdx/ 
description: Beispiel-Umwandlungscode Java für das VTX-Format in eine VDX-Datei. Verwenden Sie diesen Beispielcode, um VTX in VDX in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VTX über Java in VDX umwandeln" h2="Exportieren Sie Microsoft Visio VTX mithilfe der nativen Java-Bibliothek nach VDX." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX in VDX mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VTX in VDX über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VTX-Dateien in nur wenigen Codezeilen problemlos in VDX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VDX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VTX-zu-VDX-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VTX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vtx");
// Speichern Sie VTX als VDX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VTX-zu-VDX-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VTX in VDX](https://products.aspose.app/diagram/conversion/vtx-to-vdx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
