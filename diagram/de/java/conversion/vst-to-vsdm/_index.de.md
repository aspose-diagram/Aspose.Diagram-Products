---
title: Konvertieren Sie VST in VSDM über Java 
weight: 780
url: /de/java/conversion/vst-to-vsdm/ 
description: Beispiel-Umwandlungscode Java für das VST-Format in eine VSDM-Datei. Verwenden Sie diesen Beispielcode, um VST in VSDM in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VST in VSDM über Java" h2="Exportieren Sie Microsoft Visio VST unter Verwendung der nativen Java-Bibliothek nach VSDM." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VST in VSDM mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VST in VSDM über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VST-Dateien in nur wenigen Codezeilen problemlos in VSDM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VST-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSDM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VST-zu-VSDM-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die VST in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vst");
// Speichern Sie VST als VSDM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VST-zu-VSDM-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VST in VSDM](https://products.aspose.app/diagram/conversion/vst-to-vsdm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
