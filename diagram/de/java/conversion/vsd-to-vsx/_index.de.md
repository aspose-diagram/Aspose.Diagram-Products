---
title: Konvertieren Sie VSD über Java in VSX 
weight: 1480
url: /de/java/conversion/vsd-to-vsx/ 
description: Beispiel-Umwandlungscode Java für das Format VSD in eine VSX-Datei. Verwenden Sie diesen Beispielcode, um VSD innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung in VSX zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSD über Java in VSX" h2="Exportieren Sie Microsoft Visio VSD mithilfe der nativen Java-Bibliothek nach VSX." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSD mit Java in VSX" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können die VSD-Datei in nur wenigen Codezeilen problemlos in VSX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSD mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSD zu VSX Java Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die VSD in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vsd");
// speichern Sie VSD als VSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD zu VSX Conversion Live-Demos" sectionDescription="[Konvertieren Sie VSD in VSX](https://products.aspose.app/diagram/conversion/vsd-to-vsx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
