---
title: Konvertieren Sie VTX in PNG über Java 
weight: 4580
url: /de/java/conversion/vtx-to-png/ 
description: Beispiel-Umwandlungscode Java für das VTX-Format in eine PNG-Datei. Verwenden Sie diesen Beispielcode, um VTX in einer beliebigen Web- oder Desktop-Java-basierten Anwendung in PNG umzuwandeln.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VTX in PNG über Java" h2="Exportieren Sie Microsoft Visio VTX mithilfe der nativen Java-Bibliothek in PNG." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VTX-Dateien in nur wenigen Codezeilen ganz einfach in PNG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die PNG-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VTX-zu-PNG-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VTX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vtx");
// VTX als PNG speichern 
