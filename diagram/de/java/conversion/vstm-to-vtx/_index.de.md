---
title: Konvertieren Sie VSTM in VTX über Java 
weight: 740
url: /de/java/conversion/vstm-to-vtx/ 
description: Beispiel-Umwandlungscode Java für das VSTM-Format in eine VTX-Datei. Verwenden Sie diesen Beispielcode, um VSTM in VTX in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTM in VTX über Java" h2="Exportieren Sie Microsoft Visio VSTM nach VTX unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTM in VTX mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSTM in VTX über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VSTM-Dateien in nur wenigen Codezeilen problemlos in VTX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VTX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTM-zu-VTX-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie das VSTM in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vstm");
// Speichern Sie VSTM als VTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM-zu-VTX-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSTM in VTX](https://products.aspose.app/diagram/conversion/vstm-to-vtx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
