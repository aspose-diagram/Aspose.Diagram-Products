---
title: Konvertieren Sie VSTX in JPEG über Java 
weight: 4880
url: /de/java/conversion/vstx-to-jpeg/ 
description: Beispiel-Umwandlungscode Java für das VSTX-Format in eine JPEG-Datei. Verwenden Sie diesen Beispielcode zum Konvertieren von VSTX in JPEG in jeder Web- oder Desktop-Java-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTX in JPEG über Java" h2="Exportieren Sie Microsoft Visio VSTX mithilfe der nativen Java-Bibliothek in JPEG." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSTX-Dateien in nur wenigen Codezeilen ganz einfach in JPEG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die VSTX-Datei mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die JPEG-Datei wird unter dem angegebenen Pfad gespeichert
