---
title: Wandeln Sie VSD über Java in VSSM um 
weight: 620
url: /de/java/conversion/vsd-to-vssm/ 
description: Beispiel-Umwandlungscode Java für das Format VSD in eine VSSM-Datei. Verwenden Sie diesen Beispielcode, um VSD in einer beliebigen Web- oder Desktop-Java-basierten Anwendung in VSSM zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie VSD über Java in VSSM um" h2="Exportieren Sie Microsoft Visio VSD mithilfe der nativen Java-Bibliothek nach VSSM." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSD mit Java in VSSM" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSD in VSSM über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können die VSD-Datei in nur wenigen Codezeilen problemlos in VSSM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSD mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSSM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSD zu VSSM Java-Conversion-Quellcode" offSpacer="" %}}

```cs
// Laden Sie die VSD in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vsd");
// speichern Sie VSD als VSSM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD zu VSSM-Umwandlungs-Live-Demos" sectionDescription="[Wandeln Sie VSD in VSSM um](https://products.aspose.app/diagram/conversion/vsd-to-vssm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
