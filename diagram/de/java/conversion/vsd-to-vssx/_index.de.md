---
title: Konvertieren Sie VSD über Java in VSSX 
weight: 4650
url: /de/java/conversion/vsd-to-vssx/ 
description: Beispiel-Umwandlungscode Java für das Format VSD in eine VSSX-Datei. Verwenden Sie diesen Beispielcode, um VSD innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung in VSSX zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSD über Java in VSSX" h2="Exportieren Sie Microsoft Visio VSD mithilfe der nativen Java-Bibliothek nach VSSX." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSD mit Java in VSSX" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können die VSD-Datei in nur wenigen Codezeilen problemlos in VSSX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSD mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSD zu VSSX Java Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die VSD in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vsd");
// speichern Sie VSD als VSSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD zu VSSX-Konvertierungs-Live-Demos" sectionDescription="[Wandeln Sie VSD in VSSX um](https://products.aspose.app/diagram/conversion/vsd-to-vssx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
