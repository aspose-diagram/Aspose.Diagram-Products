---
title: Schützen und sperren Sie VDX Dokument über .NET 
weight: 5580
url: /de/net/protect/vdx/ 
description: C#-Quellcode zum Sperren der Datei VDX auf den Plattformen .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Schützen Sie VDX Dateien über C#" h2="Schützen Sie Visio einschließlich des VDX-Formats mit der .NET-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So schützen Sie VDX-Datei mit C#" %}}

 Um die Datei VDX zu schützen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Schützen von VDX Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX Dateien schützen - C#" offSpacer="" %}}
