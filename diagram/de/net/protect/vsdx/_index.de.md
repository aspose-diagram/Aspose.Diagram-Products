---
title: Schützen und sperren Sie VSDX Dokument über .NET 
weight: 5580
url: /de/net/protect/vsdx/ 
description: C#-Quellcode zum Sperren der Datei VSDX auf den Plattformen .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Schützen Sie VSDX Dateien über C#" h2="Schützen Sie Visio einschließlich des VSDX-Formats mit der .NET-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So schützen Sie VSDX-Datei mit C#" %}}

 Um die Datei VSDX zu schützen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Schützen von VSDX Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX Dateien schützen - C#" offSpacer="" %}}
