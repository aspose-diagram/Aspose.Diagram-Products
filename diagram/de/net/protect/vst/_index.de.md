---
title: VST-Dokument über .NET schützen und sperren 
weight: 5580
url: /de/net/protect/vst/ 
description: C# Quellcode zum Sperren der VST-Datei auf den Plattformen .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Schützen Sie VST-Dateien über C#" h2="Schützen Sie Visio einschließlich des VST-Formats mit der Bibliothek .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So schützen Sie eine VST-Datei mit C#" %}}

 Um die VST-Datei zu schützen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Schützen von VST-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VST-Dateien schützen - C#" offSpacer="" %}}
