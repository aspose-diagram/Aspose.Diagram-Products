...
{{< blocks/products/pf/i18n/upper-banner h1="VSX Formate in C# zusammenführen" h2="Native und hochleistungsfähige VSX Dokumentenzusammenführung mit serverseitigen Aspose.Diagram for .NET APIs, ohne die Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="So führen Sie VSX-Datei mit C# zusammen" %}}
...
+ Rufen Sie die Save()-Methode auf und übergeben Sie den Dateinamen (vollständiger Pfad) und das Format (VSX) als Parameter.
+ Jetzt können Sie die Datei VSX in Microsoft Office, Adobe PDF oder jedem anderen kompatiblen Programm öffnen und verwenden.
