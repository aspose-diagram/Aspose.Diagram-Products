...
{{% blocks/products/pf/agp/content h2="So führen Sie VSTM-Datei mit C# zusammen" %}}
...
+ Rufen Sie die Save()-Methode auf und übergeben Sie den Dateinamen (vollständiger Pfad) und das Format (VSTM) als Parameter.
+ Jetzt können Sie die Datei VSTM in Microsoft Office, Adobe PDF oder jedem anderen kompatiblen Programm öffnen und verwenden.
