---
title: VSDX Dateien über .NET zusammenführen 
weight: 460
url: /de/net/merger/vsdx/ 
description: C# Quellcode zum Kombinieren von VSDX Dokumenten auf .NET Framework, .NET Core, Mono oder COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDX Formate in C# zusammenführen" h2="Native und hochleistungsfähige VSDX Dokumentenzusammenführung mit serverseitigen Aspose.Diagram for .NET APIs, ohne die Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So führen Sie VSDX-Datei mit C# zusammen" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zusammenführen von VSDX Dateien in C#" %}}
...
+ Laden Sie alle VSDX-Dateien mit vollständigem Pfad.
...
{{% blocks/products/pf/agp/code-block title="VSDX Dateien zusammenführen - C#" offSpacer="" %}}
