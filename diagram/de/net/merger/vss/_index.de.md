...
{{% blocks/products/pf/agp/content h2="So führen Sie eine VSS-Datei mit C# zusammen" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zusammenführen von VSS-Dateien in C#" %}}
...
+ Laden Sie alle VSS-Dateien mit vollständigem Pfad.
...
+ Rufen Sie die Methode Save() auf und übergeben Sie den Dateinamen (vollständiger Pfad) und das Format (VSS) als Parameter.
+ Jetzt können Sie die VSS-Datei in Microsoft Office, Adobe PDF oder jedem anderen kompatiblen Programm öffnen und verwenden.
...
{{% blocks/products/pf/agp/code-block title="VSS-Dateien zusammenführen - C#" offSpacer="" %}}
