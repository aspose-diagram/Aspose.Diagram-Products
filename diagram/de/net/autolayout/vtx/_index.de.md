---
title: Auto-Layout VTX-Dokument über .NET 
weight: 3050
url: /de/net/autolayout/vtx/ 
description: C#-Quellcode für die vtx-Datei mit automatischem Layout auf den Plattformen .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Automatisches Layout einer VTX-Datei mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte für Auto-Layout-VTX-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Auto-Layout-VTX-Dateien - C#" offSpacer="" %}}
