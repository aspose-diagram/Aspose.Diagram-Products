---
title: Auto-Layout VSDM-Dokument über .NET 
weight: 3050
url: /de/net/autolayout/vsdm/ 
description: C#-Quellcode für die vsdm-Datei mit automatischem Layout auf den Plattformen .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Automatisches Layout einer VSDM-Datei mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte für Auto-Layout-VSDM-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Auto-Layout-VSDM-Dateien - C#" offSpacer="" %}}
