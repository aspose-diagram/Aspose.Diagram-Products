---
title: Auto-Layout VSTM-Dokument über .NET 
weight: 3050
url: /de/net/autolayout/vstm/ 
description: C#-Quellcode für die vstm-Datei mit automatischem Layout auf den Plattformen .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Automatisches Layout einer VSTM-Datei mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte für Auto-Layout-VSTM-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Auto-Layout-VSTM-Dateien - C#" offSpacer="" %}}
