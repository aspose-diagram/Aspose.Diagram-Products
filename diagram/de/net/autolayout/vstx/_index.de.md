---
title: Auto-Layout VSTX-Dokument über .NET 
weight: 3050
url: /de/net/autolayout/vstx/ 
description: C#-Quellcode für die vstx-Datei mit automatischem Layout auf den Plattformen .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Automatisches Layout einer VSTX-Datei mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte für Auto-Layout-VSTX-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Auto-Layout-VSTX-Dateien - C#" offSpacer="" %}}
