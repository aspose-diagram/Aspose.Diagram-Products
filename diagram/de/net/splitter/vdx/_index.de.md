---
title: VDX-Dateien über .NET aufteilen 
weight: 1300
url: /de/net/splitter/vdx/ 
description: C# Quellcode zum Aufteilen der vdx-Datei auf .NET Framework, .NET Core, Mono Plattformen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDX in C# aufteilen" h2="Nativer und leistungsstarker VDX-Dokumentensplitter mit serverseitigen Aspose.Diagram for .NET-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So teilen Sie eine VDX-Datei mit C#" %}}

 Um die VDX-Datei aufzuteilen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Teilen von VDX-Dateien in C#" %}}
...
+ Laden Sie die VDX-Datei mit vollständigem Pfad zum Teilen.
...
{{% blocks/products/pf/agp/code-block title="Geteilte VDX-Dateien - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram ist eine Manipulation des Microsoft Visio-Dokumentformats API. Man kann einfach Diagrammelemente laden, erstellen, modifizieren, manipulieren und Visio-Diagramme in andere Formate wie PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF und mehr konvertieren. Es ist ein eigenständiges API und erfordert keine Installation von Microsoft Visio oder anderer Software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online-VDX-Split-Live-Demos" sectionDescription="Teilen Sie VDX-Dokumente jetzt auf, indem Sie unsere besuchen [Live-Demos-Website](https://products.aspose.app/diagram/splitter). Die Live-Demo hat die folgenden Vorteile" >}}
