---
title: Anzeigen von VDX Dateiformaten über .NET 
weight: 5140
url: /de/net/viewer/vdx/ 
description: C# Quellcode zum Laden, Rendern und Anzeigen von VDX Dokumenten auf .NET Framework, .NET Core, Mono oder COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDX Dateibetrachter for .NET" h2="Zeigen Sie Microsoft Visio VDX-Dateien im Browser an, ohne dass eine Visio-Anwendung oder Office-Automatisierung erforderlich ist." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Anzeigen von VDX über C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# Code zum Anzeigen von VDX" offSpacer="" %}}

```cs

// VDX-Datei über eine Instanz von Diagram laden
var diagram = new Aspose.Diagram.Diagram("template.vdx");
// Konvertieren Sie VDX in das HTML-Format
