---
title: VDX-Dateiformate über .NET anzeigen 
weight: 5140
...
{{% blocks/products/pf/agp/content h2="So zeigen Sie eine VDX-Datei mit C# an" %}}

 Um die VDX-Datei anzuzeigen, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Diagram macht es den Entwicklern leicht, die VDX-Datei mit nur wenigen Codezeilen anzuzeigen.

{{% /blocks/products/pf/agp/text %}}

1. VDX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.Save mit SaveFileFormat.HTML als Parameter auf1. Laden Sie das resultierende HTML im Standardbrowser über Process.Start
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram ist eine Manipulation des Microsoft Visio-Dokumentformats API. Man kann einfach Diagrammelemente laden, erstellen, modifizieren, manipulieren und Visio-Diagramme in andere Formate wie PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF und mehr konvertieren. Es ist ein eigenständiges API und erfordert keine Installation von Microsoft Visio oder anderer Software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Anzeigen von VDX" sectionDescription="Sehen Sie sich unsere Live-Demos an [VDX anzeigen](https://products.aspose.app/diagram/viewer/vdx) mit folgenden Vorteilen." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach die VDX-Datei hoch und klicken Sie auf die Schaltfläche \"Anzeigen\"." >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Laden Sie bei Bedarf die VDX-Datei über den Link herunter" >}}
