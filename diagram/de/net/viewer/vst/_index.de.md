---
title: VST-Dateiformate über .NET anzeigen 
weight: 4690
url: /de/net/viewer/vst/ 
description: C# Quellcode zum Laden, Rendern und Anzeigen von VST-Dokumenten auf .NET Framework, .NET Core, Mono oder COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VST-Dateibetrachter for .NET" h2="Sehen Sie sich Microsoft Visio VST-Dateien im Browser an, ohne dass eine Visio Anwendung oder Office Automatisierung erforderlich ist." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VST" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Anzeigen von VST über C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Anzeigen von VST" offSpacer="" %}}

```cs

// VST-Datei über eine Instanz von Diagram laden
var diagram = new Aspose.Diagram.Diagram("template.vst");
// Konvertieren Sie VST in das HTML-Format
