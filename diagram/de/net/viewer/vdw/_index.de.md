---
title: VDW-Dateiformate über .NET anzeigen 
weight: 3480
url: /de/net/viewer/vdw/ 
description: C# Quellcode zum Laden, Rendern und Anzeigen von VDW-Dokumenten auf .NET Framework, .NET Core, Mono oder COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW-Dateibetrachter for .NET" h2="Sehen Sie sich Microsoft Visio VDW-Dateien im Browser an, ohne dass eine Visio Anwendung oder Office Automatisierung erforderlich ist." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDW" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Anzeigen von VDW über C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-Code zum Anzeigen von VDW" offSpacer="" %}}

```cs

// VDW-Datei über eine Instanz von Diagram laden
var diagram = new Aspose.Diagram.Diagram("template.vdw");
// Konvertieren Sie VDW in das HTML-Format
