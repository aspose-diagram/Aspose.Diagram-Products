---
title: Anzeigen von VTX Dateiformaten über .NET 
weight: 3320
url: /de/net/viewer/vtx/ 
description: C# Quellcode zum Laden, Rendern und Anzeigen von VTX Dokumenten auf .NET Framework, .NET Core, Mono oder COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VTX Dateibetrachter for .NET" h2="Zeigen Sie Microsoft Visio VTX-Dateien im Browser an, ohne dass eine Visio-Anwendung oder Office-Automatisierung erforderlich ist." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Anzeigen von VTX über C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# Code zum Anzeigen von VTX" offSpacer="" %}}

```cs

// VTX-Datei über eine Instanz von Diagram laden
var diagram = new Aspose.Diagram.Diagram("template.vtx");
// Konvertieren Sie VTX in das HTML-Format
