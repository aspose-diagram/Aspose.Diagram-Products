---
title: Organigramm im VST-Dokument über .NET erstellen 
weight: 3050
url: /de/net/organizationchart/vst/ 
description: C# Quellcode zum Erstellen eines Organigramms in einer vst-Datei auf .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Organigramm in VST in C# erstellen" h2="Erstellen Sie nativ und leistungsstark Organigramme in VST-Dokumenten mit serverseitigen Aspose.Diagram for .NET APIs, ohne die Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So erstellen Sie ein Organigramm in einer VST-Datei mit C#" %}}

 Um ein Organigramm in einer VST-Datei zu erstellen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Erstellen eines Organigramms in VST-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Organigramm in VST-Dateien erstellen – C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram ist eine Manipulation des Microsoft Visio-Dokumentformats API. Man kann einfach Diagrammelemente laden, erstellen, modifizieren, manipulieren und Visio-Diagramme in andere Formate wie PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF und mehr konvertieren. Es ist ein eigenständiges API und erfordert keine Installation von Microsoft Visio oder anderer Software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online-VST-Organigramm-Live-Demos im CompactTree-Stil" sectionDescription="Erstellen Sie jetzt ein Organigramm im CompactTree-Stil in VST-Dokumenten, indem Sie unsere besuchen [Live-Demos-Website](https://products.aspose.app/diagram/organizationchart). Die Live-Demo hat die folgenden Vorteile" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Es erstellt sofort ein Organigramm im CompactTree-Stil in VST-Dokumenten." >}}
