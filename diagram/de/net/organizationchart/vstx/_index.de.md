---
title: Organigramm im Dokument VSTX über .NET erstellen 
weight: 3050
url: /de/net/organizationchart/vstx/ 
description: C#-Quellcode zum Erstellen des Organigramms in der Datei vstx auf den Plattformen .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Organigramm in VSTX in C# erstellen" h2="Erstellen Sie nativ und leistungsstark Organigramme im VSTX-Dokument mit serverseitigen Aspose.Diagram for .NET-APIs, ohne die Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So erstellen Sie ein Organigramm in der Datei VSTX mit C#" %}}
