...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX in TIFF mit C#" %}}
...
1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.TIFF als Parameter auf1. Die TIFF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VTX-zu-TIFF-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in TIFF" sectionDescription="Sehen Sie sich unsere Live-Demos an [VTX-zu-TIFF-Konvertierung](https://products.aspose.app/diagram/conversion/vtx-to-tiff) mit folgenden Vorteilen." >}}
