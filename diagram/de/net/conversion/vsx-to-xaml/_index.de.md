---
title: Konvertieren Sie VSX in XAML über C# 
weight: 1060
url: /de/net/conversion/vsx-to-xaml/ 
description: Beispielcode für die Konvertierung von VSX in XAML C#. Verwenden Sie API Beispielcode für die Stapelkonvertierung von VSX-Dateien in XAML in VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSX in XAML über C#" h2="Exportieren Sie Microsoft® Visio VSX-Dateien in XAML auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.XAML als Parameter auf1. Die XAML-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VSX-zu-XAML-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSX in XAML" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSX-zu-XAML-Konvertierung](https://products.aspose.app/diagram/conversion/vsx-to-xaml) mit folgenden Vorteilen." >}}
