---
title: Konvertieren Sie VSX über C# in XAML 
weight: 1060
url: /de/net/conversion/vsx-to-xaml/ 
description: Beispielcode für die Umwandlung von VSX in XAML C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSX Dateien in XAML innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSX über C# in XAML" h2="Exportieren Sie Microsoft® Visio VSX-Dateien in XAML auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX mit C# in XAML" %}}

 Um VSX in XAML zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSX in XAML über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können VSX-Dateien in nur wenigen Codezeilen einfach laden und in XAML konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.XAML als Parameter auf1. Die XAML-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSX in XAML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSX in XAML" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSX in XAML-Konvertierung](https://products.aspose.app/diagram/conversion/vsx-to-xaml) mit folgenden Vorteilen." >}}
