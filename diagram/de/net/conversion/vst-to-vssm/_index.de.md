...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VST mit C# in VSSM" %}}
...
1. VST-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSSM als Parameter auf1. VSSM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VST in VSSM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VST in VSSM" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VST in VSSM](https://products.aspose.app/diagram/conversion/vst-to-vssm) mit folgenden Vorteilen." >}}
