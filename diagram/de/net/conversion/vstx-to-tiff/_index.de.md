...
description: Beispielcode für die Umwandlung von VSTX in TIFF C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSTX Dateien in TIFF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTX mit C# in TIFF" %}}
...
1. Laden Sie die Datei VSTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.TIFF als Parameter auf1. Die TIFF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSTX in TIFF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSTX in TIFF" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSTX in TIFF-Konvertierung](https://products.aspose.app/diagram/conversion/vstx-to-tiff) mit folgenden Vorteilen." >}}
