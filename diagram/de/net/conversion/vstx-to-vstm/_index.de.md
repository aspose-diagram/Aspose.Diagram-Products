---
title: Konvertieren Sie VSTX über C# in VSTM 
weight: 3010
url: /de/net/conversion/vstx-to-vstm/ 
description: Beispielcode für die Umwandlung von VSTX in VSTM C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSTX-Dateien in VSTM innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTX über C# in VSTM" h2="Exportieren Sie Microsoft® Visio VSTX-Dateien nach VSTM auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTX in VSTM mit C#" %}}

 Um VSTX in VSTM zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSTX in VSTM über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET Entwickler können VSTX-Dateien in nur wenigen Codezeilen einfach laden und in VSTM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die VSTX-Datei mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSTM als Parameter auf1. Die VSTM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VSTX-zu-VSTM-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSTX in VSTM" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSTX-zu-VSTM-Konvertierung](https://products.aspose.app/diagram/conversion/vstx-to-vstm) mit folgenden Vorteilen." >}}
