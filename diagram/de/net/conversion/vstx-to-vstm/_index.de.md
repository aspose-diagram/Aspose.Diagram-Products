---
title: Wandeln Sie VSTX über C# in VSTM um 
weight: 3010
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSTX in VSTM mit C#" %}}

 Um VSTX in VSTM umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VSTX-Dateien in VSTM laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSTM als Parameter auf1. VSTM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VSTX in VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSTX in VSTM" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VSTX in VSTM](https://products.aspose.app/diagram/conversion/vstx-to-vstm) mit folgenden Vorteilen." >}}
