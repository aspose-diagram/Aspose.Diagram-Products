---
title: Konvertieren Sie VDW in VDX über C# 
weight: 2390
url: /de/net/conversion/vdw-to-vdx/ 
description: Beispielcode für die Umwandlung von VDW in VDX C#. Verwenden Sie API Beispielcode für Batch-VDW-Dateien zur VDX Konvertierung innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VDW in VDX über C#" h2="Exportieren Sie Microsoft® Visio VDW-Dateien nach VDX auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VDW mit C# in VDX" %}}

 Um VDW in VDX umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VDW in VDX über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können VDW-Dateien in nur wenigen Codezeilen einfach laden und in VDX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VDW-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VDX als Parameter auf1. VDX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VDW in VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VDW in VDX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VDW in VDX](https://products.aspose.app/diagram/conversion/vdw-to-vdx) mit folgenden Vorteilen." >}}
