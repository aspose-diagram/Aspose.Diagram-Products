---
title: Konvertieren Sie VTX über C# in XPS 
weight: 4320
url: /de/net/conversion/vtx-to-xps/ 
description: Beispielcode für die Umwandlung von VTX in XPS C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VTX Dateien in XPS innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VTX über C# in XPS" h2="Exportieren Sie Microsoft® Visio VTX-Dateien nach XPS auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX mit C# in XPS" %}}
 ...
 Um VTX in XPS umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können ganz einfach VTX-Dateien in nur wenigen Codezeilen laden und in XPS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.XPS als Parameter auf1. Die XPS-Datei wird unter dem angegebenen Pfad gespeichert
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in XPS" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VTX in XPS](https://products.aspose.app/diagram/conversion/vtx-to-xps) mit folgenden Vorteilen." >}}
