---
title: Wandeln Sie VSTX über C# in VSSX um 
weight: 3420
url: /de/net/conversion/vstx-to-vssx/ 
description: Beispielcode für die Umwandlung von VSTX in VSSX C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSTX Dateien in VSSX innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie VSTX über C# in VSSX um" h2="Exportieren Sie Microsoft® Visio VSTX-Dateien nach VSSX auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSTX in VSSX mit C#" %}}

 Um VSTX in VSSX umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VSTX-Dateien in VSSX laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSSX als Parameter auf1. VSSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VSTX in VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSTX in VSSX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VSTX in VSSX](https://products.aspose.app/diagram/conversion/vstx-to-vssx) mit folgenden Vorteilen." >}}
