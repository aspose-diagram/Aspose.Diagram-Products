---
title: Wandeln Sie VTX über C# in VSSM um 
weight: 350
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VTX in VSSM mit C#" %}}

 Um VTX in VSSM umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VTX-Dateien in VSSM laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSSM als Parameter auf1. VSSM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VTX in VSSM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in VSSM" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VTX in VSSM](https://products.aspose.app/diagram/conversion/vtx-to-vssm) mit folgenden Vorteilen." >}}
