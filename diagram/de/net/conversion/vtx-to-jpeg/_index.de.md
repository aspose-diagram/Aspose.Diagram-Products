...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können ganz einfach VTX-Dateien in nur wenigen Codezeilen laden und in JPEG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.JPEG als Parameter auf1. Die JPEG-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VTX-zu-JPEG-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in JPEG" sectionDescription="Sehen Sie sich unsere Live-Demos an [VTX in JPEG-Konvertierung](https://products.aspose.app/diagram/conversion/vtx-to-jpeg) mit folgenden Vorteilen." >}}
