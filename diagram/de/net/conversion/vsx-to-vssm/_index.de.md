---
title: Konvertieren Sie VSX in VSSM über C# 
weight: 1290
url: /de/net/conversion/vsx-to-vssm/ 
description: Beispielcode für die Konvertierung von VSX in VSSM C#. Verwenden Sie API Beispielcode für die Stapelkonvertierung von VSX-Dateien in VSSM innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSX in VSSM über C#" h2="Exportieren Sie Microsoft® Visio VSX-Dateien nach VSSM auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSX in VSSM mit C#" %}}
 ...
 Um VSX in VSSM zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET Entwickler können VSX-Dateien in nur wenigen Codezeilen einfach laden und in VSSM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSSM als Parameter auf1. Die VSSM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VSX-zu-VSSM-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSX in VSSM" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSX-zu-VSSM-Konvertierung](https://products.aspose.app/diagram/conversion/vsx-to-vssm) mit folgenden Vorteilen." >}}
