---
title: Konvertieren Sie VTX über C# in PNG 
weight: 2790
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX mit C# in PNG" %}}
 ...
 Um VTX in PNG umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können ganz einfach VTX-Dateien in nur wenigen Codezeilen laden und in PNG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.PNG als Parameter auf1. Die PNG-Datei wird unter dem angegebenen Pfad gespeichert
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in PNG" sectionDescription="Sehen Sie sich unsere Live-Demos an [VTX in PNG-Konvertierung](https://products.aspose.app/diagram/conversion/vtx-to-png) mit folgenden Vorteilen." >}}
