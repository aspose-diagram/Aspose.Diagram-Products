...
{{% blocks/products/pf/agp/content h2="Konvertieren von VTX in VSX mit C#" %}}

 Um VTX in VSX umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VTX-Dateien in VSX laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSX als Parameter auf1. VSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VTX in VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in VSX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VTX in VSX](https://products.aspose.app/diagram/conversion/vtx-to-vsx) mit folgenden Vorteilen." >}}
