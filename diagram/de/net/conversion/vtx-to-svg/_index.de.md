---
title: Konvertieren Sie VTX über C# in SVG 
weight: 3630
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX mit C# in SVG" %}}
 ...
 Um VTX in SVG umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können ganz einfach VTX-Dateien in nur wenigen Codezeilen laden und in SVG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.SVG als Parameter auf1. Die SVG-Datei wird unter dem angegebenen Pfad gespeichert
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in SVG" sectionDescription="Sehen Sie sich unsere Live-Demos an [VTX in SVG-Konvertierung](https://products.aspose.app/diagram/conversion/vtx-to-svg) mit folgenden Vorteilen." >}}
