---
title: Wandeln Sie VSX über C# in VDX um 
weight: 5190
url: /de/net/conversion/vsx-to-vdx/ 
description: Beispielcode für die Umwandlung von VSX in VDX C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSX Dateien in VDX innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie VSX über C# in VDX um" h2="Exportieren Sie Microsoft® Visio VSX-Dateien nach VDX auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSX in VDX mit C#" %}}

 Um VSX in VDX umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VSX-Dateien in VDX laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VDX als Parameter auf1. VDX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VSX in VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSX in VDX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VSX in VDX](https://products.aspose.app/diagram/conversion/vsx-to-vdx) mit folgenden Vorteilen." >}}
