---
title: Wandeln Sie VSDX über C# in VSSM um 
weight: 2040
url: /de/net/conversion/vsdx-to-vssm/ 
description: Beispielcode für die Umwandlung von VSDX in VSSM C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSDX Dateien in VSSM innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie VSDX über C# in VSSM um" h2="Exportieren Sie Microsoft® Visio VSDX-Dateien nach VSSM auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSDX in VSSM mit C#" %}}

 Um VSDX in VSSM umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSDX in VSSM über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VSDX-Dateien in VSSM laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSDX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSSM als Parameter auf1. VSSM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VSDX in VSSM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSDX in VSSM" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VSDX in VSSM](https://products.aspose.app/diagram/conversion/vsdx-to-vssm) mit folgenden Vorteilen." >}}
