---
title: Konvertieren Sie VDW in TIFF über C# 
weight: 2010
url: /de/net/conversion/vdw-to-tiff/ 
description: Beispielcode für die Umwandlung von VDW in TIFF C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VDW-Dateien in TIFF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VDW in TIFF über C#" h2="Exportieren Sie Microsoft® Visio VDW-Dateien in TIFF auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VDW in TIFF mit C#" %}}

 Um VDW in TIFF umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VDW in TIFF über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können VDW-Dateien in nur wenigen Codezeilen einfach laden und in TIFF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VDW-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.TIFF als Parameter auf1. Die TIFF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VDW-zu-TIFF-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VDW in TIFF" sectionDescription="Sehen Sie sich unsere Live-Demos an [Konvertierung von VDW in TIFF](https://products.aspose.app/diagram/conversion/vdw-to-tiff) mit folgenden Vorteilen." >}}
