---
title: Konvertieren Sie VTX in SWF über C# 
weight: 3490
url: /de/net/conversion/vtx-to-swf/ 
description: Beispielcode für die Konvertierung von VTX in SWF C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VTX-Dateien in SWF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VTX in SWF über C#" h2="Exportieren Sie Microsoft® Visio VTX-Dateien in SWF auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX mit C# in SWF" %}}

 Um VTX in SWF zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VTX in SWF über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können VTX-Dateien in nur wenigen Codezeilen einfach laden und in SWF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.SWF als Parameter auf1. Die SWF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VTX in SWF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in SWF" sectionDescription="Sehen Sie sich unsere Live-Demos an [VTX-zu-SWF-Konvertierung](https://products.aspose.app/diagram/conversion/vtx-to-swf) mit folgenden Vorteilen." >}}
