---
title: Konvertieren Sie VDW in VSSM über C# 
weight: 4550
url: /de/net/conversion/vdw-to-vssm/ 
description: Beispielcode für die Umwandlung von VDW in VSSM C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VDW-Dateien in VSSM innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VDW in VSSM über C#" h2="Exportieren Sie Microsoft® Visio VDW-Dateien nach VSSM auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VDW in VSSM mit C#" %}}

 Um VDW in VSSM zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VDW in VSSM über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können VDW-Dateien in nur wenigen Codezeilen einfach laden und in VSSM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VDW-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSSM als Parameter auf1. Die VSSM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VDW-zu-VSSM-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VDW in VSSM" sectionDescription="Sehen Sie sich unsere Live-Demos an [VDW-zu-VSSM-Konvertierung](https://products.aspose.app/diagram/conversion/vdw-to-vssm) mit folgenden Vorteilen." >}}
