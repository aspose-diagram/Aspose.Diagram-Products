---
title: Konvertieren Sie VSDX über C# in XPS 
weight: 3310
url: /de/net/conversion/vsdx-to-xps/ 
description: Beispielcode für die Umwandlung von VSDX in XPS C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSDX Dateien in XPS innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSDX über C# in XPS" h2="Exportieren Sie Microsoft® Visio VSDX-Dateien nach XPS auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSDX mit C# in XPS" %}}

 Um VSDX in XPS umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSDX in XPS über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können ganz einfach VSDX-Dateien in nur wenigen Codezeilen laden und in XPS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSDX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.XPS als Parameter auf1. Die XPS-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSDX in XPS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSDX in XPS" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VSDX in XPS](https://products.aspose.app/diagram/conversion/vsdx-to-xps) mit folgenden Vorteilen." >}}
