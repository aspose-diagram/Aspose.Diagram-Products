---
title: VSTX über C# in SWF konvertieren 
weight: 1910
url: /de/net/conversion/vstx-to-swf/ 
description: Beispielcode für die Umwandlung von VSTX in SWF C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSTX Dateien in SWF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTX über C# in SWF konvertieren" h2="Exportieren Sie Microsoft® Visio VSTX-Dateien in SWF auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTX mit C# in SWF" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können problemlos VSTX-Dateien in nur wenigen Codezeilen laden und in SWF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.SWF als Parameter auf1. Die SWF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSTX in SWF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSTX in SWF" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSTX in SWF-Konvertierung](https://products.aspose.app/diagram/conversion/vstx-to-swf) mit folgenden Vorteilen." >}}
