---
title: Wandeln Sie VSDX über C# in VSTX um 
weight: 1690
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSDX in VSTX mit C#" %}}

 Um VSDX in VSTX umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VSDX-Dateien in VSTX laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSDX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSTX als Parameter auf1. VSTX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VSDX in VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSDX in VSTX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VSDX in VSTX](https://products.aspose.app/diagram/conversion/vsdx-to-vstx) mit folgenden Vorteilen." >}}
