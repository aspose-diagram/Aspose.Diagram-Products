---
title: Konvertieren Sie VSDX über C# in VSDM 
weight: 4040
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können VSDX-Dateien in nur wenigen Codezeilen einfach laden und in VSDM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSDX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSDM als Parameter auf1. Die VSDM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSDX in VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSDX in VSDM" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSDX-zu-VSDM-Umwandlung](https://products.aspose.app/diagram/conversion/vsdx-to-vsdm) mit folgenden Vorteilen." >}}
