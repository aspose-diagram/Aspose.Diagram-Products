---
title: Konvertieren Sie VSTX in VSSM über C# 
weight: 2060
url: /de/net/conversion/vstx-to-vssm/ 
description: Beispielcode für die Umwandlung von VSTX in VSSM C#. Verwenden Sie API Beispielcode für die Stapelkonvertierung von VSTX-Dateien in VSSM innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTX in VSSM über C#" h2="Exportieren Sie Microsoft® Visio VSTX-Dateien nach VSSM auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSTX in VSSM mit C#" %}}

 Um VSTX in VSSM zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSTX in VSSM über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können VSTX-Dateien in nur wenigen Codezeilen einfach laden und in VSSM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die VSTX-Datei mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSSM als Parameter auf1. Die VSSM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VSTX-zu-VSSM-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSTX in VSSM" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSTX-zu-VSSM-Konvertierung](https://products.aspose.app/diagram/conversion/vstx-to-vssm) mit folgenden Vorteilen." >}}
