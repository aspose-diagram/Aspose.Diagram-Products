---
title: Wandeln Sie VSTX über C# in VSDM um 
weight: 4110
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSTX in VSDM mit C#" %}}
 ...
 Um VSTX in VSDM umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VSTX-Dateien in VSDM laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSDM als Parameter auf1. VSDM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VSTX in VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSTX in VSDM" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VSTX in VSDM](https://products.aspose.app/diagram/conversion/vstx-to-vsdm) mit folgenden Vorteilen." >}}
