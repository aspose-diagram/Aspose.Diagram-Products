...
description: Beispielcode für die Konvertierung von VTX in BMP C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VTX Dateien in BMP innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können ganz einfach VTX-Dateien in nur wenigen Codezeilen laden und in BMP konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.BMP als Parameter auf1. Die BMP-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VTX in BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in BMP" sectionDescription="Sehen Sie sich unsere Live-Demos an [VTX in BMP-Konvertierung](https://products.aspose.app/diagram/conversion/vtx-to-bmp) mit folgenden Vorteilen." >}}
