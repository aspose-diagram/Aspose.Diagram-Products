---
title: Wandeln Sie VTX über C# in VSDX um 
weight: 2270
url: /de/net/conversion/vtx-to-vsdx/ 
description: Beispielcode für die Umwandlung von VTX in VSDX C#. Verwenden Sie API Beispielcode für Batch-VTX-Dateien zur VSDX Konvertierung innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie VTX über C# in VSDX um" h2="Exportieren Sie Microsoft® Visio VTX-Dateien nach VSDX auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX mit C# in VSDX" %}}

 Um VTX in VSDX umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VTX in VSDX über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können VTX-Dateien in nur wenigen Codezeilen einfach laden und in VSDX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSDX als Parameter auf1. VSDX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt eine VTX-zu-VSDX-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in VSDX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VTX in VSDX](https://products.aspose.app/diagram/conversion/vtx-to-vsdx) mit folgenden Vorteilen." >}}
