...
description: Beispielcode für die Umwandlung von VTX in VSDX C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VTX Dateien in VSDX innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VTX in VSDX mit C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VTX-Dateien in VSDX laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSDX als Parameter auf1. VSDX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VTX in VSDX C#" offSpacer="" %}}
