---
title: Wandeln Sie VTX über C# in VSDM um 
weight: 3550
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VTX in VSDM mit C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VTX-Dateien in VSDM laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSDM als Parameter auf1. VSDM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VTX in VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in VSDM" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VTX in VSDM](https://products.aspose.app/diagram/conversion/vtx-to-vsdm) mit folgenden Vorteilen." >}}
