---
title: Wandeln Sie VSDX über C# in VDX um 
weight: 130
url: /de/net/conversion/vsdx-to-vdx/ 
description: Beispielcode für die Umwandlung von VSDX in VDX C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSDX Dateien in VDX innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie VSDX über C# in VDX um" h2="Exportieren Sie Microsoft® Visio VSDX-Dateien nach VDX auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSDX mit C# in VDX" %}}

 Um VSDX in VDX umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSDX in VDX über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können ganz einfach VSDX-Dateien in nur wenigen Codezeilen laden und in VDX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSDX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VDX als Parameter auf1. Die VDX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSDX in VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSDX in VDX" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSDX-zu-VDX-Umwandlung](https://products.aspose.app/diagram/conversion/vsdx-to-vdx) mit folgenden Vorteilen." >}}
