---
title: Konvertieren Sie VSDX über C# in PDF 
weight: 680
url: /de/net/conversion/vsdx-to-pdf/ 
description: Beispielcode für die Konvertierung von VSDX in PDF C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSDX Dateien in PDF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSDX über C# in PDF" h2="Exportieren Sie Microsoft® Visio VSDX-Dateien in PDF auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSDX mit C# in PDF" %}}

 Um VSDX in PDF zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSDX in PDF über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können VSDX-Dateien in nur wenigen Codezeilen einfach laden und in PDF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSDX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.PDF als Parameter auf1. Die PDF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSDX in PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSDX in PDF" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSDX in PDF-Konvertierung](https://products.aspose.app/diagram/conversion/vsdx-to-pdf) mit folgenden Vorteilen." >}}
