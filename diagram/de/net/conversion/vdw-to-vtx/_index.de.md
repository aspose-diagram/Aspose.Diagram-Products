...
description: Beispielcode für die Umwandlung von VDW in VTX C#. Verwenden Sie API Beispielcode für Batch-VDW-Dateien zur VTX Konvertierung innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VDW mit C# in VTX" %}}
...
1. VDW-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VTX als Parameter auf1. VTX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VDW in VTX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VDW in VTX](https://products.aspose.app/diagram/conversion/vdw-to-vtx) mit folgenden Vorteilen." >}}
