...
description: Beispielcode für die Umwandlung von VTX in HTML C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VTX Dateien in HTML innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können ganz einfach VTX-Dateien in nur wenigen Codezeilen laden und in HTML konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.HTML als Parameter auf1. Die HTML-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VTX in HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in HTML" sectionDescription="Sehen Sie sich unsere Live-Demos an [VTX in HTML-Konvertierung](https://products.aspose.app/diagram/conversion/vtx-to-html) mit folgenden Vorteilen." >}}
