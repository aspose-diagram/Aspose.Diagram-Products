---
title: Wandeln Sie VSDX über C# in VSX um 
weight: 3370
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSDX in VSX mit C#" %}}

 Um VSDX in VSX umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VSDX-Dateien in VSX laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSDX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSX als Parameter auf1. VSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSDX in VSX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VSDX in VSX](https://products.aspose.app/diagram/conversion/vsdx-to-vsx) mit folgenden Vorteilen." >}}
