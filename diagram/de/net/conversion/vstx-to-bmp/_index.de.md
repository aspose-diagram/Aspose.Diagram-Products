---
title: Konvertieren Sie VSTX über C# in BMP 
weight: 4850
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTX mit C# in BMP" %}}

 Um VSTX in BMP umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können ganz einfach VSTX-Dateien in nur wenigen Codezeilen laden und in BMP konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.BMP als Parameter auf1. Die BMP-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSTX in BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSTX in BMP" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSTX in BMP-Konvertierung](https://products.aspose.app/diagram/conversion/vstx-to-bmp) mit folgenden Vorteilen." >}}
