---
title: Wandeln Sie VSX über C# in VSDX um 
weight: 1950
url: /de/net/conversion/vsx-to-vsdx/ 
description: Beispielcode für die Umwandlung von VSX in VSDX C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSX Dateien in VSDX innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie VSX über C# in VSDX um" h2="Exportieren Sie Microsoft® Visio VSX-Dateien nach VSDX auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSX in VSDX mit C#" %}}

 Um VSX in VSDX umzuwandeln, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSX in VSDX über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können mit nur wenigen Codezeilen problemlos VSX-Dateien in VSDX laden und konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSX mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSDX als Parameter auf1. VSDX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VSX in VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSX in VSDX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VSX in VSDX](https://products.aspose.app/diagram/conversion/vsx-to-vsdx) mit folgenden Vorteilen." >}}
