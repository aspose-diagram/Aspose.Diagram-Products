---
title: Konvertieren Sie VSDX über C# in JPEG 
weight: 2930
url: /de/net/conversion/vsdx-to-jpeg/ 
description: Beispielcode für die Umwandlung von VSDX in JPEG C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSDX-Dateien in JPEG innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSDX über C# in JPEG" h2="Exportieren Sie Microsoft® Visio VSDX-Dateien in JPEG auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSDX mit C# in JPEG" %}}

 Um VSDX in JPEG zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSDX in JPEG über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können ganz einfach VSDX-Dateien in nur wenigen Codezeilen laden und in JPEG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSDX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.JPEG als Parameter auf1. Die JPEG-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VSDX-zu-JPEG-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSDX in JPEG" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSDX in JPEG-Konvertierung](https://products.aspose.app/diagram/conversion/vsdx-to-jpeg) mit folgenden Vorteilen." >}}
