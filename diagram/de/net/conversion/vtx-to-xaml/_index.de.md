...
description: Beispielcode für die Umwandlung von VTX in XAML C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VTX Dateien in XAML innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
1. Laden Sie die Datei VTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.XAML als Parameter auf1. Die XAML-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VTX in XAML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in XAML" sectionDescription="Sehen Sie sich unsere Live-Demos an [VTX in XAML-Konvertierung](https://products.aspose.app/diagram/conversion/vtx-to-xaml) mit folgenden Vorteilen." >}}
