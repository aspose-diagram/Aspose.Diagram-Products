---
title: Konvertieren Sie VSX über C# in HTML 
weight: 3410
url: /de/net/conversion/vsx-to-html/ 
description: Beispielcode für die Umwandlung von VSX in HTML C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSX Dateien in HTML innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSX über C# in HTML" h2="Exportieren Sie Microsoft® Visio VSX-Dateien in HTML auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX mit C# in HTML" %}}

 Um VSX in HTML zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSX in HTML über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können ganz einfach VSX-Dateien in nur wenigen Codezeilen laden und in HTML konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.HTML als Parameter auf1. Die HTML-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSX in HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSX in HTML" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSX in HTML-Konvertierung](https://products.aspose.app/diagram/conversion/vsx-to-html) mit folgenden Vorteilen." >}}
