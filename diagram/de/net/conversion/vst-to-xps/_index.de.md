---
title: Konvertieren Sie VST in XPS über C# 
weight: 3700
url: /de/net/conversion/vst-to-xps/ 
description: Beispielcode für die Umwandlung von VST in XPS C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VST-Dateien in XPS in VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VST in XPS über C#" h2="Exportieren Sie Microsoft® Visio VST-Dateien nach XPS auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VST in XPS mit C#" %}}

 Um VST in XPS zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VST in XPS über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können VST-Dateien in nur wenigen Codezeilen einfach laden und in XPS konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VST-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.XPS als Parameter auf1. Die XPS-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VST-zu-XPS-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VST in XPS" sectionDescription="Sehen Sie sich unsere Live-Demos an [Konvertierung von VST in XPS](https://products.aspose.app/diagram/conversion/vst-to-xps) mit folgenden Vorteilen." >}}
