...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VST mit C# in VSTM" %}}
...
1. VST-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSTM als Parameter auf1. VSTM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VST in VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VST in VSTM" sectionDescription="Sehen Sie sich unsere Live-Demos an [Umwandlung von VST in VSTM](https://products.aspose.app/diagram/conversion/vst-to-vstm) mit folgenden Vorteilen." >}}
