---
title: Wandeln Sie VSTX über C# in EMF um 
weight: 4090
url: /de/net/conversion/vstx-to-emf/ 
description: Beispielcode für die Umwandlung von VSTX in EMF C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSTX Dateien in EMF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Wandeln Sie VSTX über C# in EMF um" h2="Exportieren Sie Microsoft® Visio VSTX-Dateien nach EMF auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können ganz einfach VSTX-Dateien in nur wenigen Codezeilen laden und in EMF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSTX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.EMF als Parameter auf1. Die EMF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSTX in EMF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSTX in EMF" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSTX in EMF-Konvertierung](https://products.aspose.app/diagram/conversion/vstx-to-emf) mit folgenden Vorteilen." >}}
