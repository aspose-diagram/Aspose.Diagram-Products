---
title: Geometrie über .NET in VSTM-Dokument zeichnen 
weight: 3050
url: /de/net/drawing/vstm/ 
description: C#-Quellcode zum Zeichnen von Geometrie in vstm-Datei auf .NET Framework-, .NET Core-, Mono-Plattformen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Zeichnen Sie Geometrie zu VSTM in C#" h2="Native und hochleistungsfähige Zeichnungsgeometrie für VSTM-Dokument mit serverseitigen Aspose.Diagram for .NET-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So zeichnen Sie Geometrie mit C# in die VSTM-Datei" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zeichnen von Geometrie in VSTM Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Geometrie in VSTM Dateien zeichnen - C#" offSpacer="" %}}
