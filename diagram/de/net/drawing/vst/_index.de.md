---
title: Geometrie über .NET in VST-Dokument zeichnen 
weight: 3050
url: /de/net/drawing/vst/ 
description: C# Quellcode zum Zeichnen von Geometrie in eine vst-Datei auf den Plattformen .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Zeichnen Sie Geometrie in VST in C#" h2="Native und leistungsstarke Zeichnungsgeometrie für VST-Dokumente mit serverseitigen Aspose.Diagram for .NET-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So zeichnen Sie Geometrie mit C# in eine VST-Datei" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zeichnen von Geometrie in VST-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Geometrie in VST-Dateien zeichnen - C#" offSpacer="" %}}
