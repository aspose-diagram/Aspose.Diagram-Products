---
title: Anmerkung aus VSS über C# hinzufügen, bearbeiten und löschen 
weight: 3050
url: /de/net/annotation/vss/ 
description: C# Quellcode zum Annotieren der VSS-Datei auf den Plattformen .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="So kommentieren Sie eine VSS-Datei mit C#" h2="Native und leistungsstarke VSS-Dokumentannotation mit serverseitigen Aspose.Diagram for .NET-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So kommentieren Sie eine VSS-Datei mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Annotieren von VSS-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Kommentar aus VSS-Dateien löschen - C#" offSpacer="" %}}
