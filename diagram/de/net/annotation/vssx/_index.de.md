---
title: Anmerkung von VSSX über C# hinzufügen, bearbeiten und löschen 
weight: 3050
url: /de/net/annotation/vssx/ 
description: C#-Quellcode zum Kommentieren der Datei VSSX auf den Plattformen .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX-Datei mit C# kommentieren" h2="Native und hochleistungsfähige VSSX-Dokumentannotation mit serverseitigen Aspose.Diagram for .NET-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="VSSX-Datei mit C# kommentieren" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Kommentieren von VSSX Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Kommentar aus VSSX Dateien löschen - C#" offSpacer="" %}}
