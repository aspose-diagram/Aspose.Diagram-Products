---
title: VST-Dokument über .NET komprimieren 
weight: 3050
url: /de/net/compress/vst/ 
description: C# Quellcode zum Komprimieren der vst-Datei auf den Plattformen .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VST in C# komprimieren" h2="Nativer und leistungsstarker VST-Dokumentkomprimierer mit serverseitigen Aspose.Diagram for .NET-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So komprimieren Sie eine VST-Datei mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Komprimieren von VST-Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VST-Dateien komprimieren - C#" offSpacer="" %}}
