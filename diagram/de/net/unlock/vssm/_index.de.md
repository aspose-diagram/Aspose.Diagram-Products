---
title: Entsperren Sie VSSM Dokument über .NET 
weight: 5680
url: /de/net/unlock/vssm/ 
description: C# Quellcode zum Entsperren der Datei VSSM auf den Plattformen .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Entsperren Sie VSSM Dateien über C#" h2="Entfernen Sie den Schutz von Visio einschließlich des VSSM-Formats mithilfe der .NET-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So entsperren Sie die Datei VSSM mit C#" %}}

 Um die Datei VSSM zu entsperren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Entsperren von VSSM Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Entsperren Sie VSSM Dateien - C#" offSpacer="" %}}
