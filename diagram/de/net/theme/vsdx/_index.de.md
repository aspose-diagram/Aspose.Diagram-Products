---
title: Voreingestelltes Design über .NET auf VSDX Dokument anwenden 
weight: 3050
url: /de/net/theme/vsdx/ 
description: C#-Quellcode zum Anwenden des voreingestellten Designs auf die Datei vsdx auf den Plattformen .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voreingestelltes Design auf VSDX in C# anwenden" h2="Native und leistungsstarke Anwendung des voreingestellten Designs auf das VSDX-Dokument mithilfe von serverseitigen Aspose.Diagram for .NET-APIs, ohne die Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So wenden Sie ein voreingestelltes Design mit C# auf die Datei VSDX an" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Anwenden des voreingestellten Designs auf VSDX Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Voreingestelltes Design auf VSDX Dateien anwenden - C#" offSpacer="" %}}
