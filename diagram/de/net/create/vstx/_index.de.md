---
title: Erstellen Sie VSTX Dateien über C# 
url: /de/net/create-vstx/ 
description: C# Beispielcode zum Generieren von VSTX Dokumenten. Verwenden Sie diesen Code zum Erstellen von VSTX-Dateien in VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTX Dokumente über C# erstellen" h2="Native und hochleistungsfähige VSTX-Erstellung (Portable Document Format) programmgesteuert mit serverseitigen .NET-APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="VSTX" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="So erstellen Sie VSTX über C#" %}}

{{% blocks/products/pf/agp/text %}}

 Für die Entwickler ist es einfach, VSTX in nur wenigen Codezeilen zu erstellen, zu laden, zu ändern und zu konvertieren, während verschiedene Berichtsanwendungen für die Datenverarbeitung ausgeführt werden.

{{% /blocks/products/pf/agp/text %}}

1. Fügen Sie den Namespace in Ihre Klassendatei ein1. Diagram-Klasseninstanz erstellen.1. Greifen Sie auf die erste Seite von diagram zu.1. Fügen Sie Text auf der Seite hinzu.1. Verwenden Sie die Save-Methode, um diagram als VSTX-Datei zu speichern.
