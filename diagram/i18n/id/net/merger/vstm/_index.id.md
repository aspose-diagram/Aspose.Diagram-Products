...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan File VSTM Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menggabungkan File VSTM di C#" %}}
...
+ Muat semua file VSTM dengan path lengkap.
...
+ Panggil metode Save() dan berikan nama file (path lengkap) dan format (VSTM) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan file VSTM di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan File VSTM - C#" offSpacer="" %}}
