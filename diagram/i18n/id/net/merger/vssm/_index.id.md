...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan File VSSM Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menggabungkan File VSSM di C#" %}}
...
+ Muat semua file VSSM dengan path lengkap.
...
+ Panggil metode Save() dan berikan nama file (path lengkap) dan format (VSSM) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan file VSSM di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan File VSSM - C#" offSpacer="" %}}
