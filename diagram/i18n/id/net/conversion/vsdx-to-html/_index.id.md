---
title: Konversikan VSDX ke HTML melalui C# 
weight: 5270
url: /id/net/conversion/vsdx-to-html/ 
description: Contoh kode untuk konversi VSDX ke HTML C#. Gunakan API kode contoh untuk kumpulan VSDX file ke konversi HTML dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSDX ke HTML melalui C#" h2="Ekspor file Microsoft® Visio VSDX ke HTML pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDX ke HTML Menggunakan C#" %}}

 Untuk mengonversi VSDX ke HTML, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi VSDX ke HTML melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi VSDX file ke HTML hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDX dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file keluaran dan SaveFileFormat.HTML sebagai parameter1. File HTML akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSDX ke HTML C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDX ke HTML" sectionDescription="Periksa demo langsung kami untuk [VSDX ke konversi HTML](https://products.aspose.app/diagram/conversion/vsdx-to-html) dengan manfaat sebagai berikut." >}}
