---
title: Konversikan VST ke XPS melalui C# 
weight: 3700
url: /id/net/conversion/vst-to-xps/ 
description: Contoh kode untuk konversi VST ke XPS C#. Gunakan API kode contoh untuk file batch VST ke konversi XPS dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VST ke XPS melalui C#" h2="Ekspor file Microsoft® Visio VST ke XPS pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VST ke XPS Menggunakan C#" %}}

 Untuk mengonversi VST ke XPS, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi VST ke XPS melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file VST ke XPS hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VST dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.XPS sebagai parameter1. File XPS akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VST ke XPS C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VST ke XPS" sectionDescription="Periksa demo langsung kami untuk [Konversi VST ke XPS](https://products.aspose.app/diagram/conversion/vst-to-xps) dengan manfaat sebagai berikut." >}}
