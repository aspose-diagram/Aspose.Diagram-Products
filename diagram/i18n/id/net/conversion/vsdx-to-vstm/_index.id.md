---
title: Konversikan VSDX ke VSTM melalui C# 
weight: 2990
url: /id/net/conversion/vsdx-to-vstm/ 
description: Contoh kode untuk konversi VSDX ke VSTM C#. Gunakan API kode contoh untuk kumpulan VSDX file ke konversi VSTM dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSDX ke VSTM melalui C#" h2="Ekspor file Microsoft® Visio VSDX ke VSTM di .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDX ke VSTM Menggunakan C#" %}}
 ...
 Untuk mengonversi VSDX ke VSTM, kami akan menggunakan
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET pengembang dapat dengan mudah memuat & mengonversi VSDX file ke VSTM hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDX dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.VSTM sebagai parameter1. File VSTM akan disimpan di jalur yang ditentukan
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDX ke VSTM" sectionDescription="Periksa demo langsung kami untuk [VSDX ke konversi VSTM](https://products.aspose.app/diagram/conversion/vsdx-to-vstm) dengan manfaat sebagai berikut." >}}
