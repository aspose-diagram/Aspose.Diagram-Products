---
title: Konversikan VSDM ke VSSM melalui C# 
weight: 3780
url: /id/net/conversion/vsdm-to-vssm/ 
description: Contoh kode untuk konversi VSDM ke VSSM C#. Gunakan API kode contoh untuk file batch VSDM ke konversi VSSM dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSDM ke VSSM melalui C#" h2="Ekspor file Microsoft® Visio VSDM ke VSSM pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDM ke VSSM Menggunakan C#" %}}
 ...
 Untuk mengonversi VSDM ke VSSM, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi VSDM ke VSSM melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file VSDM ke VSSM hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDM dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.VSSM sebagai parameter1. File VSSM akan disimpan di jalur yang ditentukan
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDM ke VSSM" sectionDescription="Periksa demo langsung kami untuk [Konversi VSDM ke VSSM](https://products.aspose.app/diagram/conversion/vsdm-to-vssm) dengan manfaat sebagai berikut." >}}
