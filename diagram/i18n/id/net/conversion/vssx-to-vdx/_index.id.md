---
title: Konversi VSSX ke VDX melalui C# 
weight: 90
url: /id/net/conversion/vssx-to-vdx/ 
description: Contoh kode untuk konversi VSSX ke VDX C#. Gunakan API kode contoh untuk file batch VSSX ke konversi VDX dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi VSSX ke VDX melalui C#" h2="Ekspor file Microsoft® Visio VSSX ke VDX pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSSX ke VDX Menggunakan C#" %}}
 ...
 Untuk mengonversi VSSX ke VDX, kami akan menggunakan
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET pengembang dapat dengan mudah memuat & mengonversi file VSSX ke VDX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSSX dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.VDX sebagai parameter1. File VDX akan disimpan di jalur yang ditentukan
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSSX ke VDX" sectionDescription="Periksa demo langsung kami untuk [Konversi VSSX ke VDX](https://products.aspose.app/diagram/conversion/vssx-to-vdx) dengan manfaat sebagai berikut." >}}
