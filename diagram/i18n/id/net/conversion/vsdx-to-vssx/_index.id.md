---
title: Konversikan VSDX ke VSSX melalui C# 
weight: 3270
url: /id/net/conversion/vsdx-to-vssx/ 
description: Contoh kode untuk konversi VSDX ke VSSX C#. Gunakan API kode contoh untuk kumpulan VSDX file ke konversi VSSX dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSDX ke VSSX melalui C#" h2="Ekspor file Microsoft® Visio VSDX ke VSSX pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDX ke VSSX Menggunakan C#" %}}
 ...
 Untuk mengonversi VSDX ke VSSX, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi VSDX ke VSSX melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi VSDX file ke VSSX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDX dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.VSSX sebagai parameter1. File VSSX akan disimpan di jalur yang ditentukan
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDX ke VSSX" sectionDescription="Periksa demo langsung kami untuk [VSDX ke konversi VSSX](https://products.aspose.app/diagram/conversion/vsdx-to-vssx) dengan manfaat sebagai berikut." >}}
