---
title: Konversikan VSDM ke VSTM melalui C# 
weight: 1460
url: /id/net/conversion/vsdm-to-vstm/ 
description: Contoh kode untuk konversi VSDM ke VSTM C#. Gunakan API kode contoh untuk file batch VSDM ke konversi VSTM dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSDM ke VSTM melalui C#" h2="Ekspor file Microsoft® Visio VSDM ke VSTM pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDM ke VSTM Menggunakan C#" %}}
 ...
 Untuk mengonversi VSDM ke VSTM, kami akan menggunakan
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET pengembang dapat dengan mudah memuat & mengonversi file VSDM ke VSTM hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDM dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.VSTM sebagai parameter1. File VSTM akan disimpan di jalur yang ditentukan
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDM ke VSTM" sectionDescription="Periksa demo langsung kami untuk [Konversi VSDM ke VSTM](https://products.aspose.app/diagram/conversion/vsdm-to-vstm) dengan manfaat sebagai berikut." >}}
