---
title: Wyświetl lub edytuj metadane plików VSTM za pomocą .NET 
weight: 3050
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki wyodrębniania metadanych VSTM w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Wyodrębnianie metadanych VSTM — C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram to manipulacja formatem dokumentów firmy Microsoft Visio API. Można łatwo ładować, tworzyć, modyfikować, manipulować, w tym elementami daigramów i konwertować Visio diagramy do innych formatów, takich jak PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF i inne. Jest to samodzielny API i nie wymaga instalacji Microsoft Visio ani żadnego innego oprogramowania.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Wyodrębnij metadane VSTM za pośrednictwem aplikacji online" sectionDescription="Przeglądaj i edytuj metadane do dokumentów VSTM, odwiedzając nasz [Witryna demonstracyjna na żywo](https://products.aspose.app/diagram/metadata). Demo na żywo ma następujące zalety" >}}
