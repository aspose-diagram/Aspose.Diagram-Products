...
{{% blocks/products/pf/agp/content h2="Jak automatycznie układać plik VST za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki dla plików VST z automatycznym układem w C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Pliki VST z automatycznym układem — C#" offSpacer="" %}}
