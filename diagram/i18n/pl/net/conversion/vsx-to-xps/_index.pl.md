...
description: Przykładowy kod konwersji VSX do XPS C#. Użyj przykładowego kodu API dla plików wsadowych VSX do konwersji XPS w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSX na XPS za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSX do XPS w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję VSX do XPS C#" offSpacer="" %}}
