...
description: Przykładowy kod konwersji VSD na VSSX C#. Użyj API przykładowego kodu dla plików wsadowych VSD do konwersji VSSX w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET programiści mogą łatwo ładować i konwertować VSD pliki do VSSX w zaledwie kilku linijkach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSD z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSSX jako parametrami1. Plik VSSX zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSD na VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSD na VSSX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VSD na VSSX](https://products.aspose.app/diagram/conversion/vsd-to-vssx) z następującymi korzyściami." >}}
