---
title: Konwertuj VDW na JPEG przez C# 
weight: 1030
url: /pl/net/conversion/vdw-to-jpeg/ 
description: Przykładowy kod konwersji VDW do JPEG C#. Użyj przykładowego kodu API dla wsadowych plików VDW do konwersji JPEG w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VDW na JPEG przez C#" h2="Eksportuj pliki Microsoft® Visio VDW do formatu JPEG na .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VDW na JPEG przy użyciu C#" %}}

 Aby przekonwertować VDW na JPEG, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDW na JPEG za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VDW do formatu JPEG w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VDW z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.JPEG jako parametrami1. Plik JPEG zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VDW do JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VDW na JPEG" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VDW do JPEG](https://products.aspose.app/diagram/conversion/vdw-to-jpeg) z następującymi korzyściami." >}}
