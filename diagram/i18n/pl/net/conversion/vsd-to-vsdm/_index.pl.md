---
title: Konwertuj VSD na VSDM przez C# 
weight: 5030
url: /pl/net/conversion/vsd-to-vsdm/ 
description: Przykładowy kod konwersji VSD na VSDM C#. Użyj API przykładowego kodu dla plików wsadowych VSD do konwersji VSDM w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSD na VSDM przez C#" h2="Eksportuj pliki Microsoft® VisioVSD do VSDM na .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSD na VSDM za pomocą C#" %}}

 Aby przekonwertować VSD na VSDM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSD na VSDM za pośrednictwem C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSD do VSDM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSD z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSDM jako parametrami1. Plik VSDM zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje konwersję VSD na VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VSD na VSDM" sectionDescription="Sprawdź nasze prezentacje na żywo dla [VSD do konwersji VSDM](https://products.aspose.app/diagram/conversion/vsd-to-vsdm) z następującymi korzyściami." >}}
