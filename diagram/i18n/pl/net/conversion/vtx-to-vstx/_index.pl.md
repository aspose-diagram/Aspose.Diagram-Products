---
title: Konwertuj VTX na VSTX przez C# 
weight: 1250
url: /pl/net/conversion/vtx-to-vstx/ 
description: Przykładowy kod konwersji VTX do VSTX C#. Użyj przykładowego kodu API dla plików wsadowych VTX do konwersji VSTX w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VTX na VSTX przez C#" h2="Eksportuj pliki Microsoft® Visio VTX do VSTX na .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VTX na VSTX za pomocą C#" %}}

 Aby przekonwertować VTX na VSTX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VTX na VSTX za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VTX na VSTX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VTX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSTX jako parametrami1. Plik VSTX zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję VTX do VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VTX na VSTX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VTX do VSTX](https://products.aspose.app/diagram/conversion/vtx-to-vstx) z następującymi korzyściami." >}}
