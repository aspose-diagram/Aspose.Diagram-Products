...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSX na VSDX za pomocą C#" %}}

 Aby przekonwertować VSX na VSDX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSX na VSDX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSX do VSDX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSDX jako parametrami1. VSDX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje VSX do VSDX C# konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezpłatna aplikacja do konwersji VSX na VSDX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [VSX do konwersji VSDX](https://products.aspose.app/diagram/conversion/vsx-to-vsdx) z następującymi korzyściami." >}}
