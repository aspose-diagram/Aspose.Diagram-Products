...
description: Przykładowy kod konwersji VDX do VSDM C#. Użyj przykładowego kodu API dla wsadowych plików VDX do konwersji VSDM w ramach VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na VSDM za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VDX do VSDM w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VDX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSDM jako parametrami1. Plik VSDM zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję VDX do VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VDX na VSDM" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VDX do VSDM](https://products.aspose.app/diagram/conversion/vdx-to-vsdm) z następującymi korzyściami." >}}
