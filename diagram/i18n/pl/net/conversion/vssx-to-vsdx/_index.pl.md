...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSSX na VSDX przy użyciu C#" %}}

 Aby przekonwertować VSSX na VSDX, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSSX na VSDX przez C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VSSX na VSDX w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VSSX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.VSDX jako parametrami1. VSDX plik zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod pokazuje VSSX do VSDX C# konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezpłatna aplikacja do konwersji VSSX na VSDX" sectionDescription="Sprawdź nasze prezentacje na żywo dla [VSSX do konwersji VSDX](https://products.aspose.app/diagram/conversion/vssx-to-vsdx) z następującymi korzyściami." >}}
