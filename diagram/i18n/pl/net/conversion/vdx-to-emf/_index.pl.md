---
title: Konwertuj VDX na EMF przez C# 
weight: 3440
url: /pl/net/conversion/vdx-to-emf/ 
description: Przykładowy kod konwersji VDX do EMF C#. Użyj przykładowego kodu API dla wsadowych plików VDX do konwersji EMF w VB.NET, Asp.NET lub dowolnej aplikacji opartej na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VDX na EMF przez C#" h2="Eksportuj pliki Microsoft® Visio VDX do EMF w .NET Framework, .NET Core, Mono lub COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VDX na EMF za pomocą C#" %}}

 Aby przekonwertować VDX na EMF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na EMF za pomocą C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET programiści mogą łatwo ładować i konwertować pliki VDX na EMF w zaledwie kilku wierszach kodu.

{{% /blocks/products/pf/agp/text %}}

1. Załaduj plik VDX z instancją klasy Diagram1. Wywołaj metodę Diagram.Save ze ścieżką pliku wyjściowego i SaveFileFormat.EMF jako parametrami1. Plik EMF zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="Ten przykładowy kod przedstawia konwersję VDX na EMF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do konwersji VDX na EMF" sectionDescription="Sprawdź nasze prezentacje na żywo dla [Konwersja VDX do EMF](https://products.aspose.app/diagram/conversion/vdx-to-emf) z następującymi korzyściami." >}}
