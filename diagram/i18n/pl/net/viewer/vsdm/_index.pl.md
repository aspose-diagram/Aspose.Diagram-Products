---
title: Wyświetl formaty plików VSDM za pośrednictwem .NET 
weight: 1210
url: /pl/net/viewer/vsdm/ 
description: C# kod źródłowy do ładowania, renderowania i wyświetlania dokumentów VSDM w .NET Framework, .NET Core, Mono lub COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Przeglądarka plików VSDM for .NET" h2="Wyświetlaj pliki Microsoft Visio VSDM w przeglądarce bez konieczności korzystania z aplikacji Visio lub automatyzacji pakietu Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wyświetlić plik VSDM za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wyświetlić VSDM za pośrednictwem C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kod do wyświetlenia VSDM" offSpacer="" %}}

```cs

// załaduj plik VSDM za pośrednictwem wystąpienia Diagram
var diagram = new Aspose.Diagram.Diagram("template.vsdm");
// przekonwertować VSDM na format HTML
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram to manipulacja formatem dokumentów firmy Microsoft Visio API. Można łatwo ładować, tworzyć, modyfikować, manipulować, w tym elementami daigramów i konwertować Visio diagramy do innych formatów, takich jak PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF i inne. Jest to samodzielny API i nie wymaga instalacji Microsoft Visio ani żadnego innego oprogramowania.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do przeglądania VSDM" sectionDescription="Sprawdź nasze prezentacje na żywo, aby [Zobacz VSDM](https://products.aspose.app/diagram/viewer/vsdm) z następującymi korzyściami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij plik VSDM i naciśnij przycisk „Widok”" >}}
