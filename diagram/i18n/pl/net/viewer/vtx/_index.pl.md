---
title: Wyświetl formaty plików VTX za pośrednictwem .NET 
weight: 3320
url: /pl/net/viewer/vtx/ 
description: C# kod źródłowy do ładowania, renderowania i wyświetlania dokumentów VTX w .NET Framework, .NET Core, Mono lub COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Przeglądarka plików VTX for .NET" h2="Wyświetlaj pliki Microsoft Visio VTX w przeglądarce bez konieczności korzystania z aplikacji Visio lub automatyzacji pakietu Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wyświetlić plik VTX za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wyświetlić VTX za pośrednictwem C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kod do wyświetlenia VTX" offSpacer="" %}}

```cs

// załaduj plik VTX za pośrednictwem wystąpienia Diagram
var diagram = new Aspose.Diagram.Diagram("template.vtx");
// przekonwertować VTX na format HTML
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram to manipulacja formatem dokumentów firmy Microsoft Visio API. Można łatwo ładować, tworzyć, modyfikować, manipulować, w tym elementami daigramów i konwertować Visio diagramy do innych formatów, takich jak PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF i inne. Jest to samodzielny API i nie wymaga instalacji Microsoft Visio ani żadnego innego oprogramowania.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do przeglądania VTX" sectionDescription="Sprawdź nasze prezentacje na żywo, aby [Zobacz VTX](https://products.aspose.app/diagram/viewer/vtx) z następującymi korzyściami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij plik VTX i naciśnij przycisk „Widok”" >}}
