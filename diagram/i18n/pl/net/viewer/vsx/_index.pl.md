---
title: Wyświetl formaty plików VSX za pośrednictwem .NET 
weight: 1720
url: /pl/net/viewer/vsx/ 
description: C# kod źródłowy do ładowania, renderowania i wyświetlania dokumentów VSX w .NET Framework, .NET Core, Mono lub COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Przeglądarka plików VSX for .NET" h2="Wyświetlaj pliki Microsoft Visio VSX w przeglądarce bez konieczności korzystania z aplikacji Visio lub automatyzacji pakietu Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak wyświetlić plik VSX za pomocą C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby wyświetlić VSX przez C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# kod do wyświetlenia VSX" offSpacer="" %}}

```cs

// załaduj plik VSX za pośrednictwem wystąpienia Diagram
var diagram = new Aspose.Diagram.Diagram("template.vsx");
// przekonwertować VSX na format HTML
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram to manipulacja formatem dokumentów firmy Microsoft Visio API. Można łatwo ładować, tworzyć, modyfikować, manipulować, w tym elementami daigramów i konwertować Visio diagramy do innych formatów, takich jak PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF i inne. Jest to samodzielny API i nie wymaga instalacji Microsoft Visio ani żadnego innego oprogramowania.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Darmowa aplikacja do przeglądania VSX" sectionDescription="Sprawdź nasze prezentacje na żywo, aby [Zobacz VSX](https://products.aspose.app/diagram/viewer/vsx) z następującymi korzyściami." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij plik VSX i naciśnij przycisk „Widok”" >}}
