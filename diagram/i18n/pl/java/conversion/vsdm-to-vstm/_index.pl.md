...
description: Przykładowy kod konwersji Java dla formatu VSDM do pliku VSTM. Użyj tego przykładowego kodu, aby przekonwertować VSDM na VSTM w dowolnej aplikacji opartej na sieci Web lub komputerowej Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSDM na VSTM za pomocą Java" %}}
 ...
 Aby renderować VSDM do VSTM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSDM na VSTM za pomocą Java" %}}
...
1. Załaduj plik VSDM z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VSTM zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VSDM do VSTM Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VSDM do VSTM" sectionDescription="[Konwertuj VSDM na VSTM](https://products.aspose.app/diagram/conversion/vsdm-to-vstm) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik VSDM, zostanie on natychmiast przekonwertowany do VSTM." >}}
