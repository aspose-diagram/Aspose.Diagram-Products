...
description: Przykładowy kod konwersji Java dla formatu VSTX do pliku VSSM. Użyj tego przykładowego kodu, aby przekonwertować VSTX na VSSM w dowolnej aplikacji internetowej lub desktopowej Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSTX na VSSM za pomocą Java" %}}
 ...
 Aby renderować VSTX do VSSM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTX na VSSM za pomocą Java" %}}
...
1. Załaduj plik VSTX z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VSSM zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VSTX do VSSM Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VSTX do VSSM" sectionDescription="[Konwertuj VSTX na VSSM](https://products.aspose.app/diagram/conversion/vstx-to-vssm) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik VSTX, zostanie on natychmiast przekonwertowany do VSSM." >}}
