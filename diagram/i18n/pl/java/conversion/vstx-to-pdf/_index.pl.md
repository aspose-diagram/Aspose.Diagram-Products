---
title: Konwertuj VSTX na PDF przez Java 
weight: 4860
url: /pl/java/conversion/vstx-to-pdf/ 
description: Przykładowy kod konwersji Java dla formatu VSTX do pliku PDF. Użyj tego przykładowego kodu, aby przekonwertować VSTX na PDF w dowolnej aplikacji opartej na sieci Web lub na komputerze Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konwertuj VSTX na PDF przez Java" h2="Eksportuj Microsoft Visio VSTX do formatu PDF przy użyciu natywnej biblioteki Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSTX na PDF za pomocą Java" %}}

 Aby wyrenderować VSTX do formatu PDF, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTX na PDF za pomocą Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java programiści mogą łatwo przekonwertować plik VSTX do formatu PDF w zaledwie kilku wierszach kodu.
...
{{% blocks/products/pf/agp/code-block title="VSTX do PDF Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Prezentacje na żywo z konwersją VSTX do PDF" sectionDescription="[Konwertuj VSTX na PDF](https://products.aspose.app/diagram/conversion/vstx-to-pdf) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
