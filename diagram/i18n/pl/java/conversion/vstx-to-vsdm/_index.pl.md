...
description: Przykładowy kod konwersji Java dla formatu VSTX do pliku VSDM. Użyj tego przykładowego kodu, aby przekonwertować VSTX na VSDM w dowolnej aplikacji opartej na sieci Web lub na komputerze Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSTX na VSDM za pomocą Java" %}}
 ...
 Aby renderować VSTX do VSDM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSTX na VSDM za pomocą Java" %}}
...
1. Załaduj plik VSTX z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VSDM zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VSTX do VSDM Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VSTX do VSDM" sectionDescription="[Konwertuj VSTX na VSDM](https://products.aspose.app/diagram/conversion/vstx-to-vsdm) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
