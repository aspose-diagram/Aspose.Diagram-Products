...
description: Przykładowy kod konwersji Java dla formatu VSS do pliku VSSX. Użyj tego przykładowego kodu, aby przekonwertować VSS na VSSX w dowolnej aplikacji opartej na sieci Web lub Desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSS na VSSX za pomocą Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSS na VSSX za pomocą Java" %}}
...
1. Załaduj plik VSS z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VSSX zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VSS do VSSX Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VSS do VSSX" sectionDescription="[Konwertuj VSS na VSSX](https://products.aspose.app/diagram/conversion/vss-to-vssx) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
