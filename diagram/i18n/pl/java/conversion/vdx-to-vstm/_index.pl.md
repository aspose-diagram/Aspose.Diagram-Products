...
description: Przykładowy kod konwersji Java dla formatu VDX do pliku VSTM. Użyj tego przykładowego kodu, aby przekonwertować VDX na VSTM w dowolnej aplikacji internetowej lub desktopowej Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VDX na VSTM za pomocą Java" %}}
 ...
 Aby renderować VDX do VSTM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VDX na VSTM za pomocą Java" %}}
...
1. Załaduj plik VDX z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VSTM zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VDX do VSTM Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VDX do VSTM" sectionDescription="[Konwertuj VDX na VSTM](https://products.aspose.app/diagram/conversion/vdx-to-vstm) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Nie ma potrzeby pobierania Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Nie musisz pisać żadnego kodu." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Po prostu prześlij swój plik VDX, zostanie on natychmiast przekonwertowany do VSTM." >}}
