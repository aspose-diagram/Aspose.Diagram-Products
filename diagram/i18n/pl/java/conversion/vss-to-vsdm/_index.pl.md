...
description: Przykładowy kod konwersji Java dla formatu VSS do pliku VSDM. Użyj tego przykładowego kodu, aby przekonwertować VSS na VSDM w dowolnej aplikacji opartej na sieci Web lub Desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Jak przekonwertować VSS na VSDM za pomocą Java" %}}

 Aby renderować VSS do VSDM, użyjemy
...
{{% blocks/products/pf/agp/feature-section-col title="Kroki, aby przekonwertować VSS na VSDM za pomocą Java" %}}
...
1. Załaduj plik VSS z instancją klasy Diagram1. Wywołaj metodę Diagram.save ze ścieżką pliku wyjściowego i SaveFileFormat jako parametrami1. Plik VSDM zostanie zapisany pod określoną ścieżką
...
{{% blocks/products/pf/agp/code-block title="VSS do VSDM Java Kod źródłowy konwersji" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Konwersja na żywo z VSS do VSDM" sectionDescription="[Konwertuj VSS na VSDM](https://products.aspose.app/diagram/conversion/vss-to-vsdm) teraz, odwiedzając naszą stronę Live Demos. Demo na żywo ma następujące zalety" >}}
