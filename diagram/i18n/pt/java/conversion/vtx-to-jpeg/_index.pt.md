...
description: Exemplo de código de conversão Java do formato VTX para arquivo JPEG. Use este código de exemplo para converter VTX para JPEG em qualquer aplicativo baseado em Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VTX para JPEG via Java" h2="Exporte o Microsoft Visio VTX para JPEG usando a biblioteca nativa Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java os desenvolvedores podem facilmente converter arquivos VTX para JPEG em apenas algumas linhas de código.
