---
title: Mesclar arquivos VSS via .NET 
weight: 5110
url: /pt/net/merger/vss/ 
description: C# código-fonte para combinar documentos VSS em .NET Framework, .NET Core, Mono ou COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mesclar formatos VSS em C#" h2="Fusão de documentos VSS nativos e de alto desempenho usando APIs Aspose.Diagram for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Como mesclar o arquivo VSS usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para mesclar arquivos VSS em C#" %}}
...
+ Carregue todos os arquivos VSS com caminho completo.
+ Faça um documento como o arquivo base
+ Chame o método relevante para concatenar e mesclar arquivos um por um.
+ Chame o método Save() e passe o nome do arquivo (caminho completo) e o formato (VSS) como parâmetro.
+ Agora você pode abrir e usar o arquivo VSS no Microsoft Office, Adobe PDF ou qualquer outro programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Mesclar arquivos VSS - C#" offSpacer="" %}}
