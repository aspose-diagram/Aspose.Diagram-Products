---
title: Mesclar arquivos VSSX via .NET 
weight: 3770
url: /pt/net/merger/vssx/ 
description: C# código-fonte para combinar documentos VSSX em .NET Framework, .NET Core, Mono ou COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mesclar formatos VSSX em C#" h2="Fusão de documentos VSSX nativos e de alto desempenho usando APIs Aspose.Diagram for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como mesclar o arquivo VSSX usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para mesclar arquivos VSSX em C#" %}}
...
+ Agora você pode abrir e usar o arquivo VSSX no Microsoft Office, Adobe PDF ou qualquer outro programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Mesclar arquivos VSSX - C#" offSpacer="" %}}
