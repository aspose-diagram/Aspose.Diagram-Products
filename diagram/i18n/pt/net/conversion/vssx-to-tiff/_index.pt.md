---
title: Converter VSSX para TIFF via C# 
weight: 4380
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX para TIFF usando C#" %}}
 ...
 Para converter VSSX para TIFF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX para TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos VSSX para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.TIFF como parâmetros1. O arquivo TIFF será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX para TIFF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VSSX para TIFF](https://products.aspose.app/diagram/conversion/vssx-to-tiff) com os seguintes benefícios." >}}
