---
title: Converter VSSX para HTML via C# 
weight: 4240
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX para HTML usando C#" %}}
 ...
 Para converter VSSX para HTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX para HTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos VSSX para HTML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.HTML como parâmetros1. O arquivo HTML será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX para HTML" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VSSX para HTML](https://products.aspose.app/diagram/conversion/vssx-to-html) com os seguintes benefícios." >}}
