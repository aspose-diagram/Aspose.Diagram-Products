...
{{% blocks/products/pf/agp/content h2="Como converter VTX para SVG usando C#" %}}

 Para converter VTX para SVG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VTX para SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos VTX para SVG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.SVG como parâmetros1. O arquivo SVG será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de VTX para SVG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VTX para SVG" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VTX para SVG](https://products.aspose.app/diagram/conversion/vtx-to-svg) com os seguintes benefícios." >}}
