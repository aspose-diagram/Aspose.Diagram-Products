---
title: Converter VSSX para XAML via C# 
weight: 1970
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX para XAML usando C#" %}}
 ...
 Para converter VSSX para XAML, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter arquivos VSSX para XAML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.XAML como parâmetros1. O arquivo XAML será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX para XAML" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VSSX para XAML](https://products.aspose.app/diagram/conversion/vssx-to-xaml) com os seguintes benefícios." >}}
