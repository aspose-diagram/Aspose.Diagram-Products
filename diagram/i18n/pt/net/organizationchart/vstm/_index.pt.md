---
title: Criar organograma no documento VSTM via .NET 
weight: 3050
url: /pt/net/organizationchart/vstm/ 
description: C# código-fonte para criar organograma no arquivo vstm em .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Criar organograma no VSTM em C#" h2="Criação de organograma nativo e de alto desempenho em documento VSTM usando APIs Aspose.Diagram for .NET do lado do servidor, sem o uso de nenhum software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como criar organograma no arquivo VSTM usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para criar organograma em arquivos VSTM em C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Criar organograma em arquivos VSTM - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram é uma manipulação de formato de documento da Microsoft Visio API. Pode-se facilmente carregar, criar, modificar, manipular incluindo elementos de diagrama e converter diagramas Visio para outros formatos, como PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF e muito mais. É um API autônomo e não requer que o Microsoft Visio ou qualquer outro software seja instalado.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo on-line do organograma do estilo CompactTree do VSTM" sectionDescription="Crie um organograma estilo CompactTree em documentos VSTM agora mesmo, visitando nosso [Site de demonstrações ao vivo](https://products.aspose.app/diagram/organizationchart). A demonstração ao vivo tem os seguintes benefícios" >}}
