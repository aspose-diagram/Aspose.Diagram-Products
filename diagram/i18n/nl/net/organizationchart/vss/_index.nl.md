---
title: Organigram maken in VSS-document via .NET 
weight: 3050
url: /nl/net/organizationchart/vss/ 
description: C# broncode om organigram te maken in vss-bestand op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Organigram maken in VSS in C#" h2="Native en high-performance creëren organigram in VSS-document met server-side Aspose.Diagram for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe maak je een organigram in een VSS-bestand met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het maken van een organigram in VSS-bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Organigram maken in VSS-bestanden - C#" offSpacer="" %}}
