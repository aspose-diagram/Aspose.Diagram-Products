---
title: VSS-bestanden samenvoegen via .NET 
weight: 5110
url: /nl/net/merger/vss/ 
description: C# broncode om VSS-documenten te combineren op .NET Framework, .NET Core, Mono of COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSS-indelingen samenvoegen in C#" h2="Native en krachtige VSS-documentfusie met server-side Aspose.Diagram for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe een VSS-bestand samen te voegen met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het samenvoegen van VSS-bestanden in C#" %}}
...
+ Laad alle VSS-bestanden met het volledige pad.
...
+ Roep de methode Save() aan en geef de bestandsnaam (volledig pad) en formaat (VSS) door als parameter.
+ Nu kunt u het VSS-bestand openen en gebruiken in Microsoft Office, Adobe PDF of een ander compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="VSS-bestanden samenvoegen - C#" offSpacer="" %}}
