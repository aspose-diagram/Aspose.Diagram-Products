---
title: Metadata van VSDM-bestanden bekijken of bewerken via .NET 
weight: 3050
url: /nl/net/metadata/vsdm/ 
description: C# broncode om metadata in VSDM-indeling te bewerken of te bekijken op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraheer VSDM-metadata in C#" h2="Bouw uw eigen .NET-apps om metadata uit VSDM-bestanden toe te voegen, te bewerken, te verwijderen of te extraheren met behulp van server-side API\'s." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe VSDM-metadata te extraheren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het extraheren van VSDM-metadata in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDM-metadata extraheren - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram is een Microsoft Visio manipulatie van documentindeling API. Men kan gemakkelijk inclusief daigram-elementen laden, creëren, wijzigen, manipuleren en Visio-diagrammen converteren naar andere formaten zoals PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF en meer. Het is een standalone API en vereist geen installatie van Microsoft Visio of andere software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Metadata van VSDM extraheren via online app" sectionDescription="Bekijk en bewerk metadata naar VSDM-documenten door naar onze [Live demo\'s website](https://products.aspose.app/diagram/metadata). De live demo heeft de volgende voordelen:" >}}
