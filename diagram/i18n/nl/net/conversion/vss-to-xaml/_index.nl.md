---
title: Converteer VSS naar XAML via C# 
weight: 1340
url: /nl/net/conversion/vss-to-xaml/ 
description: Voorbeeldcode voor conversie van VSS naar XAML C#. Gebruik API voorbeeldcode voor batch VSS-bestanden naar XAML-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VSS naar XAML via C#" h2="Exporteer Microsoft® Visio VSS-bestanden naar XAML op .NET Framework, .NET Core, Mono of COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe VSS naar XAML te converteren met C#" %}}

 Om VSS naar XAML te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSS naar XAML te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen VSS-bestanden gemakkelijk laden en converteren naar XAML in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSS-bestand met een instantie van Diagram class1. Roep de Diagram.Save-methode aan met pad naar uitvoerbestand en SaveFileFormat.XAML als parameters1. XAML-bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont VSS naar XAML C#-conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app om VSS naar XAML te converteren" sectionDescription="Check onze live demo\'s voor [VSS naar XAML conversie](https://products.aspose.app/diagram/conversion/vss-to-xaml) met volgende voordelen." >}}
