---
title: Converteer VST naar HTML via C# 
weight: 1560
url: /nl/net/conversion/vst-to-html/ 
description: Voorbeeldcode voor conversie van VST naar HTML C#. Gebruik API voorbeeldcode voor batch VST-bestanden naar HTML-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VST naar HTML via C#" h2="Exporteer Microsoft® Visio VST-bestanden naar HTML op .NET Framework, .NET Core, Mono of COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe VST naar HTML te converteren met C#" %}}

 Om VST naar HTML te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VST naar HTML te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen eenvoudig VST-bestanden laden en converteren naar HTML in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VST-bestand met een instantie van Diagram class1. Roep de Diagram.Save-methode aan met pad naar uitvoerbestand en SaveFileFormat.HTML als parameters1. HTML-bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont VST naar HTML C#-conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app om VST naar HTML te converteren" sectionDescription="Check onze live demo\'s voor [VST naar HTML-conversie](https://products.aspose.app/diagram/conversion/vst-to-html) met volgende voordelen." >}}
