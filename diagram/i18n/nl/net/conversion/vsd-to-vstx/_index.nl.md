...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSD naar VSTX te converteren via C#" %}}
...
1. Laad VSD bestand met een instantie van Diagram class1. Roep de Diagram.Save-methode aan met pad naar uitvoerbestand en SaveFileFormat.VSTX als parameters1. VSTX-bestand wordt opgeslagen op het opgegeven pad
