...
{{% blocks/products/pf/agp/content h2="Hoe VSD naar VDX te converteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSD naar VDX te converteren via C#" %}}
...
1. Laad VSD bestand met een instantie van Diagram class1. Roep de Diagram.Save-methode aan met pad naar uitvoerbestand en SaveFileFormat.VDX als parameters1. VDX-bestand wordt opgeslagen op het opgegeven pad
