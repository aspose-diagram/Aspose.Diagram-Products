...
{{% blocks/products/pf/agp/content h2="Hoe VSSX naar VTX te converteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSSX naar VTX te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen eenvoudig VSSX-bestanden laden en converteren naar VTX in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSSX-bestand met een instantie van Diagram class1. Roep de Diagram.Save-methode aan met pad naar uitvoerbestand en SaveFileFormat.VTX als parameters1. VTX-bestand wordt opgeslagen op het opgegeven pad
