...
{{% blocks/products/pf/agp/content h2="Hoe VSTX naar PDF te converteren met Java" %}}

 Om VSTX naar PDF te renderen, gebruiken we
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java ontwikkelaars kunnen VSTX-bestanden eenvoudig in slechts een paar regels code naar PDF converteren.
