---
title: Converteer VSDX naar XAML via Java 
weight: 250
url: /nl/java/conversion/vsdx-to-xaml/ 
description: Voorbeeld Java-conversiecode voor VSDX-indeling naar XAML-bestand. Gebruik deze voorbeeldcode om VSDX naar XAML te converteren binnen elke web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VSDX naar XAML via Java" h2="Exporteer Microsoft Visio VSDX naar XAML met behulp van native Java-bibliotheek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VSDX naar XAML converteert met Java" %}}

 Om VSDX naar XAML weer te geven, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSDX te converteren naar XAML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het VSDX-bestand gemakkelijk converteren naar XAML in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSDX bestand met een instantie van Diagram class1. Roep Diagram.save-methode aan met pad naar uitvoerbestand en SaveFileFormat als parameters1. XAML-bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="VSDX naar XAML Java Broncode voor conversie" offSpacer="" %}}

```cs
// laad de VSDX in een object van Diagram 
Diagram visio = new Diagram("template.vsdx");
// sla VSDX op als XAML 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDX naar XAML-conversie Live-demo\'s" sectionDescription="[Converteer VSDX naar XAML](https://products.aspose.app/diagram/conversion/vsdx-to-xaml) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw VSDX-bestand, het wordt onmiddellijk geconverteerd naar XAML." >}}
