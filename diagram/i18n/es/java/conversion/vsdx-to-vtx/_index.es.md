...
description: Ejemplo de código de conversión Java para formato VSDX a archivo VTX. Utilice este código de ejemplo para convertir VSDX a VTX dentro de cualquier aplicación basada en Java web o de escritorio.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir VSDX a VTX usando Java" %}}
 ...
 Para renderizar VSDX a VTX, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSDX a VTX con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión VSDX a VTX Java" offSpacer="" %}}
