---
title: Convierta VSX a XPS a través de Java 
weight: 280
url: /es/java/conversion/vsx-to-xps/ 
description: Ejemplo de código de conversión Java para formato VSX a archivo XPS. Utilice este código de ejemplo para convertir VSX a XPS dentro de cualquier aplicación basada en Web o Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta VSX a XPS a través de Java" h2="Exporte Microsoft Visio VSX a XPS usando la biblioteca Java nativa." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente un archivo VSX a XPS con solo unas pocas líneas de código.
