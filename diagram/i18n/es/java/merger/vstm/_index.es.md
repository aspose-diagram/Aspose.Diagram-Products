...
{{% blocks/products/pf/agp/content h2="Cómo fusionar archivos VSTM usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para fusionar archivos VSTM en Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Fusionar archivos VSTM - Java" offSpacer="" %}}
