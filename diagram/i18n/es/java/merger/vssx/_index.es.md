---
title: Combinar archivos VSSX a través de Java 
weight: 2720
url: /es/java/merger/vssx/ 
description: Java código de muestra para combinar documentos VSSX en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar formatos VSSX en Java" h2="Fusión nativa de documentos VSSX usando API Java del lado del servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar archivos VSSX usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para fusionar archivos VSSX en Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Fusionar archivos VSSX - Java" offSpacer="" %}}
