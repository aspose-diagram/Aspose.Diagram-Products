---
title: Convertir VSTM a VSDX a través de C# 
weight: 4400
url: /es/net/conversion/vstm-to-vsdx/ 
description: Código de muestra para la conversión de VSTM a VSDX C#. Utilice API código de ejemplo para archivos VSTM por lotes para VSDX conversión dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTM a VSDX a través de C#" h2="Exporte archivos VSTM Visio de Microsoft® a VSDX en .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir VSTM a VSDX usando C#" %}}

 Para convertir VSTM a VSDX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir VSTM a VSDX a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos VSTM a VSDX con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo VSTM con una instancia de la clase Diagram1. Llame al método Diagram.Save con la ruta del archivo de salida y SaveFileFormat.VSDX como parámetros1. El archivo VSDX se guardará en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de VSTM a VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir VSTM a VSDX" sectionDescription="Consulte nuestras demostraciones en vivo para [Conversión de VSTM a VSDX](https://products.aspose.app/diagram/conversion/vstm-to-vsdx) con los siguientes beneficios." >}}
