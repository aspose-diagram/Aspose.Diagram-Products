---
title: Convierta VST a BMP a través de C# 
weight: 2070
url: /es/net/conversion/vst-to-bmp/ 
description: Código de muestra para la conversión de VST a BMP C#. Utilice el código de ejemplo API para la conversión de archivos VST por lotes a BMP dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta VST a BMP a través de C#" h2="Exporte archivos VST de Microsoft® Visio a BMP en .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir VST a BMP usando C#" %}}

 Para convertir VST a BMP, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir VST a BMP a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos VST a BMP con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo VST con una instancia de la clase Diagram1. Llame al método Diagram.Save con la ruta del archivo de salida y SaveFileFormat.BMP como parámetros1. El archivo BMP se guardará en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de VST a BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir VST a BMP" sectionDescription="Consulte nuestras demostraciones en vivo para [Conversión de VST a BMP](https://products.aspose.app/diagram/conversion/vst-to-bmp) con los siguientes beneficios." >}}
