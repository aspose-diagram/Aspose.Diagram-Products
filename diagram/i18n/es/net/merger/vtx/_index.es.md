---
title: Combinar archivos VTX a través de .NET 
weight: 4330
url: /es/net/merger/vtx/ 
description: C# código fuente para combinar documentos VTX en .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar formatos VTX en C#" h2="Fusión de documentos VTX nativos y de alto rendimiento utilizando API Aspose.Diagram for .NET del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar archivos VTX usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para fusionar archivos VTX en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Fusionar archivos VTX - C#" offSpacer="" %}}
