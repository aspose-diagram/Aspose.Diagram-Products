---
title: Combinar archivos VSX a través de .NET 
weight: 1260
url: /es/net/merger/vsx/ 
description: C# código fuente para combinar documentos VSX en .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar formatos VSX en C#" h2="Fusión de documentos VSX nativos y de alto rendimiento mediante API Aspose.Diagram for .NET del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar archivos VSX usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para fusionar archivos VSX en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Fusionar archivos VSX - C#" offSpacer="" %}}
