...
description: C# mã nguồn để nén tệp vssm trên Nền tảng .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Nén VSSM trong C#" h2="Máy nén tài liệu VSSM gốc và hiệu suất cao sử dụng API Aspose.Diagram for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách nén tệp VSSM bằng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Nén Tệp VSSM trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Nén tệp VSSM - C#" offSpacer="" %}}
