---
title: Xem VSDX Định dạng Tệp qua .NET 
weight: 5350
url: /vi/net/viewer/vsdx/ 
description: C# mã nguồn để tải, kết xuất và hiển thị VSDX tài liệu trên .NET Framework, .NET Core, Mono hoặc COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDX Trình xem Tệp for .NET" h2="Xem các tệp Microsoft Visio VSDX trong trình duyệt mà không yêu cầu ứng dụng Visio hoặc Tự động hóa Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Xem VSDX qua C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# mã để xem VSDX" offSpacer="" %}}

```cs

// tải tệp VSDX qua một phiên bản của Diagram
var diagram = new Aspose.Diagram.Diagram("template.vsdx");
// chuyển đổi VSDX sang định dạng HTML
