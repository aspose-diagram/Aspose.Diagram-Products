---
title: Hình mờ tài liệu VDX qua .NET 
weight: 3050
...
{{% blocks/products/pf/agp/content h2="Cách làm mờ tệp VDX bằng cách sử dụng C#" %}}

 Để làm mờ tệp VDX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Đánh dấu vết mờ tệp VDX trong C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tệp Vdx hình mờ - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram là một Microsoft Visio thao tác định dạng tài liệu API. Người ta có thể dễ dàng tải, tạo, sửa đổi, thao tác bao gồm các phần tử daigram và chuyển đổi Visio sơ đồ sang các định dạng khác như PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF và hơn thế nữa. Đây là một phần mềm độc lập API và không yêu cầu cài đặt Microsoft Visio hoặc bất kỳ phần mềm nào khác.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Bản demo trực tuyến VDX WaterMark Live" sectionDescription="Tài liệu về WaterMark VDX ngay bây giờ bằng cách truy cập [Trang web Demos Trực tiếp](https://products.aspose.app/diagram/watermark). Bản demo trực tiếp có những lợi ích sau" >}}
