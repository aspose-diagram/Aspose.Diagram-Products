...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất VSDX tệp bằng cách sử dụng C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Hợp nhất VSDX Tệp trong C#" %}}
...
+ Tải tất cả VSDX tệp với đường dẫn đầy đủ.
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất VSDX Tệp - C#" offSpacer="" %}}
