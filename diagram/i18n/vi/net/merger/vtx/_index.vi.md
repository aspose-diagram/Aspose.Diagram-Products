---
title: Hợp nhất các tệp VTX qua .NET 
weight: 4330
url: /vi/net/merger/vtx/ 
description: C# mã nguồn để kết hợp các tài liệu VTX trên .NET Framework, .NET Core, Mono hoặc COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hợp nhất các Định dạng VTX trong C#" h2="Hợp nhất tài liệu VTX gốc và hiệu suất cao bằng cách sử dụng API Aspose.Diagram for .NET phía máy chủ mà không cần sử dụng bất kỳ phần mềm nào như Microsoft hoặc Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cách hợp nhất tệp VTX bằng C#" %}}

 Để hợp nhất tệp VTX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước để Hợp nhất Tệp VTX trong C#" %}}
...
+ Tải tất cả các tệp VTX với đường dẫn đầy đủ.
+ Tạo một tài liệu làm tệp cơ sở
+ Gọi phương thức liên quan để nối và hợp nhất từng tệp một.
+ Gọi phương thức Save () và truyền tên tệp (đường dẫn đầy đủ) và định dạng (VTX) làm tham số.
+ Bây giờ bạn có thể mở và sử dụng tệp VTX trong Microsoft Office, Adobe PDF hoặc bất kỳ chương trình tương thích nào khác.
...
{{% blocks/products/pf/agp/code-block title="Hợp nhất các tệp VTX - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram là một Microsoft Visio thao tác định dạng tài liệu API. Người ta có thể dễ dàng tải, tạo, sửa đổi, thao tác bao gồm các phần tử daigram và chuyển đổi Visio sơ đồ sang các định dạng khác như PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF và hơn thế nữa. Đây là một phần mềm độc lập API và không yêu cầu cài đặt Microsoft Visio hoặc bất kỳ phần mềm nào khác.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tuyến VTX Merger Live" sectionDescription="Hợp nhất các tài liệu VTX ngay bây giờ bằng cách truy cập [Trang web Demos Trực tiếp](https://products.aspose.app/diagram/merger). Bản demo trực tiếp có những lợi ích sau" >}}
