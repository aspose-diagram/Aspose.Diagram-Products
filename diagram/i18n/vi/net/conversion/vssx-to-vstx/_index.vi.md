...
description: Mã mẫu cho chuyển đổi VSSX sang VSTX C#. Sử dụng API mã ví dụ cho hàng loạt tệp VSSX sang chuyển đổi VSTX trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSSX sang VSTX bằng cách sử dụng C#" %}}

 Để chuyển đổi VSSX sang VSTX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VSSX sang VSTX qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi tệp VSSX sang VSTX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi phương thức Diagram .Save với đường dẫn tệp đầu ra và SaveFileFormat.VSTX làm tham số1. Tệp VSTX sẽ được lưu theo đường dẫn đã chỉ định
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ứng dụng miễn phí để chuyển đổi VSSX sang VSTX" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi cho [Chuyển đổi VSSX sang VSTX](https://products.aspose.app/diagram/conversion/vssx-to-vstx) với những lợi ích sau đây." >}}
