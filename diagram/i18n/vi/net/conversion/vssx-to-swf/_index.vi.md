...
description: Mã mẫu cho chuyển đổi VSSX sang SWF C#. Sử dụng API mã mẫu cho các tệp VSSX hàng loạt để chuyển đổi SWF trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp VSSX sang SWF chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi phương thức Diagram .Save với đường dẫn tệp đầu ra và SaveFileFormat.SWF làm tham số1. Tệp SWF sẽ được lưu tại đường dẫn được chỉ định
