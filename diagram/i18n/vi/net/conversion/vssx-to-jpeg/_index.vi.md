...
description: Mã mẫu cho chuyển đổi VSSX sang JPEG C#. Sử dụng API mã ví dụ cho hàng loạt tệp VSSX sang chuyển đổi JPEG trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp VSSX sang JPEG chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi phương thức Diagram .Save với đường dẫn tệp đầu ra và SaveFileFormat.JPEG làm tham số1. Tập tin JPEG sẽ được lưu theo đường dẫn đã chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị VSSX sang JPEG C# Chuyển đổi" offSpacer="" %}}
