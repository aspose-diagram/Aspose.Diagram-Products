---
title: Chuyển đổi VSS sang PDF qua C# 
weight: 2050
url: /vi/net/conversion/vss-to-pdf/ 
description: Mã mẫu để chuyển đổi VSS sang PDF C#. Sử dụng API mã ví dụ cho hàng loạt tệp VSS sang chuyển đổi PDF trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Chuyển đổi VSS sang PDF qua C#" h2="Xuất tệp Microsoft® Visio VSS sang PDF trên .NET Framework, .NET Core, Mono hoặc COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSS sang PDF bằng C#" %}}

 Để chuyển đổi VSS sang PDF, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VSS sang PDF qua C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET các nhà phát triển có thể dễ dàng tải và chuyển đổi các tệp VSS sang PDF chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSS với một phiên bản của lớp Diagram1. Gọi phương thức Diagram .Save với đường dẫn tệp đầu ra và SaveFileFormat.PDF dưới dạng tham số1. Tệp PDF sẽ được lưu theo đường dẫn đã chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị VSS sang PDF C# Chuyển đổi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ứng dụng miễn phí để chuyển đổi VSS sang PDF" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi cho [VSS chuyển đổi sang PDF](https://products.aspose.app/diagram/conversion/vss-to-pdf) với những lợi ích sau đây." >}}
