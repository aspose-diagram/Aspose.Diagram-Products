...
description: Mã mẫu cho chuyển đổi VSSX thành VSDX C#. Sử dụng API mã mẫu cho các tệp VSSX hàng loạt để VSDX chuyển đổi trong VB .NET, Asp .NET hoặc bất kỳ ứng dụng dựa trên .NET nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VSSX thành VSDX Sử dụng C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET nhà phát triển có thể dễ dàng tải và chuyển đổi tệp VSSX thành VSDX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSSX với một phiên bản của lớp Diagram1. Gọi phương thức Diagram .Save với đường dẫn tệp đầu ra và SaveFileFormat. VSDX dưới dạng tham số1. VSDX tệp sẽ được lưu tại đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã mẫu này hiển thị VSSX thành Chuyển đổi VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ứng dụng miễn phí để chuyển đổi VSSX thành VSDX" sectionDescription="Kiểm tra các bản trình diễn trực tiếp của chúng tôi cho [Chuyển đổi VSSX thành VSDX](https://products.aspose.app/diagram/conversion/vssx-to-vsdx) với những lợi ích sau đây." >}}
