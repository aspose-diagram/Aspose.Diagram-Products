...
description: Mã chuyển đổi Java mẫu cho định dạng VTX thành tệp TIFF. Sử dụng mã ví dụ này để chuyển đổi VTX thành TIFF trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
...
1. Tải tệp VTX với một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. Tệp TIFF sẽ được lưu tại đường dẫn được chỉ định
