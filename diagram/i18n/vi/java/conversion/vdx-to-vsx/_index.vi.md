---
title: Chuyển đổi VDX sang VSX qua Java 
weight: 270
url: /vi/java/conversion/vdx-to-vsx/ 
description: Mã chuyển đổi Java mẫu cho định dạng VDX thành tệp VSX. Sử dụng mã ví dụ này để chuyển đổi VDX sang VSX trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
...
{{% blocks/products/pf/agp/content h2="Cách chuyển đổi VDX sang VSX bằng cách sử dụng Java" %}}

 Để kết xuất VDX sang VSX, chúng tôi sẽ sử dụng
...
{{% blocks/products/pf/agp/feature-section-col title="Các bước chuyển đổi VDX sang VSX qua Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp VDX sang VSX chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VDX với một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. Tệp VSX sẽ được lưu theo đường dẫn được chỉ định
...
{{% blocks/products/pf/agp/code-block title="Mã nguồn chuyển đổi VDX sang VSX Java" offSpacer="" %}}

```cs
// tải VDX trong một đối tượng của Diagram 
Diagram visio = new Diagram("template.vdx");
// lưu VDX dưới dạng VSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi VDX sang VSX" sectionDescription="[Chuyển đổi VDX sang VSX](https://products.aspose.app/diagram/conversion/vdx-to-vsx) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Không cần tải xuống Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Không cần phải viết bất kỳ mã nào." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp VDX của bạn, nó sẽ được chuyển đổi ngay lập tức sang VSX." >}}
