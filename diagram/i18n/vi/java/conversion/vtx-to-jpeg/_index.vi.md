...
description: Mã chuyển đổi Java mẫu cho định dạng VTX sang tệp JPEG. Sử dụng mã ví dụ này để chuyển đổi VTX sang JPEG trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
...
1. Tải tệp VTX với một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. Tập tin JPEG sẽ được lưu theo đường dẫn đã chỉ định
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi VTX sang JPEG" sectionDescription="[Chuyển đổi VTX sang JPEG](https://products.aspose.app/diagram/conversion/vtx-to-jpeg) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
