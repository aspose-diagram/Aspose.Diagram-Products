...
description: Mã chuyển đổi Java mẫu cho định dạng VSTM thành tệp TIFF. Sử dụng mã ví dụ này để chuyển đổi VSTM thành TIFF trong bất kỳ ứng dụng dựa trên Web hoặc Máy tính để bàn Java nào.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java các nhà phát triển có thể dễ dàng chuyển đổi tệp VSTM thành TIFF chỉ trong một vài dòng mã.

{{% /blocks/products/pf/agp/text %}}

1. Tải tệp VSTM với một phiên bản của lớp Diagram1. Gọi Diagram phương thức .save với đường dẫn tệp đầu ra và SaveFileFormat dưới dạng tham số1. Tệp TIFF sẽ được lưu tại đường dẫn được chỉ định
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bản trình diễn trực tiếp chuyển đổi VSTM sang TIFF" sectionDescription="[Chuyển đổi VSTM sang TIFF](https://products.aspose.app/diagram/conversion/vstm-to-tiff) ngay bây giờ bằng cách truy cập trang web Demos Trực tiếp của chúng tôi. Bản demo trực tiếp có những lợi ích sau" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Chỉ cần tải lên tệp VSTM của bạn, nó sẽ được chuyển đổi ngay lập tức thành TIFF." >}}
