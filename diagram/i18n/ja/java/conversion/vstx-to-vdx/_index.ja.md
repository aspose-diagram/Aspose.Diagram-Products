...
description: VSTX形式からVDXファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でVSTXをVDXに変換します。
---
...
1. Diagramクラスのインスタンスを含むVSTXファイルをロードします1. 出力ファイルパスとSaveFileFormatをパラメーターとして使用してDiagram.saveメソッドを呼び出します1. VDXファイルは指定されたパスに保存されます
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTXからVDXへの変換ライブデモ" sectionDescription="[VSTXをVDXに変換する](https://products.aspose.app/diagram/conversion/vstx-to-vdx) 今すぐライブデモのウェブサイトにアクセスしてください。ライブデモには次の利点があります。" >}}
