...
description: VST形式からVSSXファイルへのサンプルJava変換コード。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でVSTをVSSXに変換します。
---
...
1. Diagramクラスのインスタンスを含むVSTファイルをロードします1. 出力ファイルパスとSaveFileFormatをパラメーターとして使用してDiagram.saveメソッドを呼び出します1. VSSXファイルは指定されたパスに保存されます
