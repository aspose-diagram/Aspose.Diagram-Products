...
{{% blocks/products/pf/agp/content h2="Javaを使用してVDWファイルをマージする方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaでVDWファイルをマージする手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VDWファイルをマージする-Java" offSpacer="" %}}
