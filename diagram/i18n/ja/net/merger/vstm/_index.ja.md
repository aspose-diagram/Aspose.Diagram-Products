---
title: .NETを介してVSTMファイルをマージします 
weight: 2740
url: /ja/net/merger/vstm/ 
description: .NETフレームワーク、.NETコア、Mono、またはCOM相互運用機能でVSTMドキュメントを組み合わせるためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#のVSTM形式をマージする" h2="MicrosoftやOpenOffice、Adobe PDFなどのソフトウェアを使用せずに、サーバー側のAspose.Diagramfor .NETAPIを使用したネイティブで高性能なVSTMドキュメントのマージ。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してVSTMファイルをマージする方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#でVSTMファイルをマージする手順" %}}
...
+すべてのVSTMファイルをフルパスでロードします。
+1つのドキュメントをベースファイルとして作成します
+ファイルを1つずつ連結およびマージするための関連するメソッドを呼び出します。
+ Save（）メソッドを呼び出し、ファイル名（フルパス）とフォーマット（VSTM）をパラメーターとして渡します。
+これで、Microsoft Office、Adobe PDF、またはその他の互換性のあるプログラムでVSTMファイルを開いて使用できます。
...
{{% blocks/products/pf/agp/code-block title="VSTMファイルをマージする-C#" offSpacer="" %}}
