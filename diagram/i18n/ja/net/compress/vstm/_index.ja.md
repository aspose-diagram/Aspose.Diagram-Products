---
title: .NETを介してVSTMドキュメントを圧縮する 
weight: 3050
url: /ja/net/compress/vstm/ 
description: .NETフレームワーク、.NETコア、Monoプラットフォームでvstmファイルを圧縮するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#でVSTMを圧縮する" h2="MicrosoftやOpenOffice、Adobe PDFなどのソフトウェアを使用せずに、サーバー側のAspose.Diagramfor .NETAPIを使用するネイティブで高性能のVSTMドキュメントコンプレッサー。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してVSTMファイルを圧縮する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#でVSTファイルを圧縮する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTMファイルの圧縮-C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagramは、MicrosoftVisioドキュメント形式の操作APIです。ダイグラム要素を含むロード、作成、変更、操作を簡単に実行し、Visio図をPDF、XPS、JPEG、PNG、BMP、TIFF、SVG、EMFなどの他の形式に変換できます。これはスタンドアロンのAPIであり、MicrosoftVisioやその他のソフトウェアをインストールする必要はありません。  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="オンラインVSTMCompressライブデモ" sectionDescription="今すぐVSTドキュメントを圧縮するには、 [ライブデモのウェブサイト](https://products.aspose.app/diagram/compress)。ライブデモには次の利点があります" >}}
