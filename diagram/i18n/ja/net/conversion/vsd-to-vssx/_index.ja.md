...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET開発者は、わずか数行のコードでVSDファイルをVSSXに簡単にロードおよび変換できます。
