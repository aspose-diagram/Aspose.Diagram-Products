...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET開発者は、わずか数行のコードでVSSファイルをVSSXに簡単にロードおよび変換できます。
