...
description: VSSからVSXC#への変換のサンプルコード。 VB .NET、Asp .NET、または任意の.NETベースのアプリケーション内でのVSSファイルからVSXへのバッチ変換にはAPIサンプルコードを使用します。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#を介してVSSをVSXに変換します" h2="Microsoft®VisioVSSファイルを.NETフレームワーク、.NETコア、Mono、またはCOM相互運用機能のVSXにエクスポートします。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET開発者は、わずか数行のコードでVSSファイルをVSXに簡単にロードおよび変換できます。
