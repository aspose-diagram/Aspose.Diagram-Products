---
title: .NET経由でVTXファイル形式を表示 
weight: 3320
url: /ja/net/viewer/vtx/ 
description: .NETフレームワーク、.NETコア、Mono、またはCOM相互運用機能でVTXドキュメントをロード、レンダリング、および表示するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VTXファイルビューアfor .NET" h2="VisioアプリケーションやOfficeAutomationを必要とせずに、ブラウザでMicrosoftVisioVTXファイルを表示します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#を介してVTXを表示する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Diagramを使用すると、開発者はわずか数行のコードでVTXファイルを簡単に表示できます。
...
{{% blocks/products/pf/agp/code-block title="VTXを表示するためのC#コード" offSpacer="" %}}
