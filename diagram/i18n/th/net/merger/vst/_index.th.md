---
title: รวมไฟล์ VST ผ่าน .NET 
weight: 2900
url: /th/net/merger/vst/ 
description: C# ซอร์สโค้ดเพื่อรวมเอกสาร VST ใน .NET Framework, .NET Core, Mono หรือ COM Interop
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="รวมรูปแบบ VST ใน C#" h2="การรวมเอกสาร VST ดั้งเดิมและประสิทธิภาพสูงโดยใช้ API ฝั่งเซิร์ฟเวอร์ Aspose.Diagram for .NET โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office, Adobe PDF" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="วิธีผสานไฟล์ VST โดยใช้ C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการรวมไฟล์ VST ใน C#" %}}
...
+ โหลดไฟล์ VST ทั้งหมดที่มีเส้นทางแบบเต็ม
+ สร้างเอกสารหนึ่งฉบับเป็นไฟล์ฐาน
+ เรียกวิธีการที่เกี่ยวข้องสำหรับการต่อและรวมไฟล์ทีละไฟล์
+ เรียกใช้เมธอด Save() และส่งชื่อไฟล์ (เส้นทางแบบเต็ม) และรูปแบบ (VST) เป็นพารามิเตอร์
+ ตอนนี้คุณสามารถเปิดและใช้ไฟล์ VST ใน Microsoft Office, Adobe PDF หรือโปรแกรมอื่นๆ ที่เข้ากันได้
...
{{% blocks/products/pf/agp/code-block title="รวมไฟล์ VST - C#" offSpacer="" %}}
