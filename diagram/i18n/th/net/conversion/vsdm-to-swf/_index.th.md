...
{{% blocks/products/pf/agp/content h2="วิธีแปลง VSDM เป็น SWF โดยใช้ C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ขั้นตอนในการแปลง VSDM เป็น SWF ผ่าน C#" %}}
...
1. โหลดไฟล์ VSDM ด้วยอินสแตนซ์ของ Diagram class1. เรียกใช้เมธอด Diagram.Save ด้วยพาธไฟล์เอาต์พุตและ SaveFileFormat.SWF เป็นพารามิเตอร์1. ไฟล์ SWF จะถูกบันทึกที่เส้นทางที่ระบุ
