...
{{% blocks/products/pf/agp/content h2="Как объединить файл VDW с помощью C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению файлов VDW в C#" %}}
...
+ Загрузите все файлы VDW с полным путем.
