---
title: Объединить файлы VSSM через .NET 
weight: 2380
url: /ru/net/merger/vssm/ 
description: Исходный код C# для объединения документов VSSM в .NET Framework, .NET Core, Mono или COM Interop.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению файлов VSSM в C#" %}}
...
+ Загрузите все файлы VSSM с полным путем.
...
+ Вызвать метод Save() и передать в качестве параметра имя файла (полный путь) и формат (VSSM).
...
{{% blocks/products/pf/agp/code-block title="Объединить файлы VSSM — C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram – это манипулирование форматом документа Microsoft VisioAPI. Можно легко загружать, создавать, изменять, манипулировать элементами схемы и преобразовывать диаграммы Visio в другие форматы, такие как PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF и другие. Это автономный API и не требует установки Microsoft Visio или любого другого программного обеспечения.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Онлайн-демонстрации слияния VSSM" sectionDescription="Объедините документы VSSM прямо сейчас, посетив наш [Веб-сайт живых демонстраций](https://products.aspose.app/diagram/merger). Живая демонстрация имеет следующие преимущества" >}}
