---
title: Объединить файлы VSX через .NET 
weight: 1260
url: /ru/net/merger/vsx/ 
description: Исходный код C# для объединения документов VSX на .NET Framework, .NET Core, Mono или COM Interop.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению файлов VSX в C#" %}}
...
+ Загрузите все файлы VSX с полным путем.
...
+ Вызвать метод Save() и передать в качестве параметра имя файла (полный путь) и формат (VSX).
...
{{% blocks/products/pf/agp/code-block title="Объединение файлов VSX — C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram – это манипулирование форматом документа Microsoft VisioAPI. Можно легко загружать, создавать, изменять, манипулировать элементами схемы и преобразовывать диаграммы Visio в другие форматы, такие как PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF и другие. Это автономный API и не требует установки Microsoft Visio или любого другого программного обеспечения.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Онлайн-демонстрации слияния VSX" sectionDescription="Объедините документы VSX прямо сейчас, посетив наш [Веб-сайт живых демонстраций](https://products.aspose.app/diagram/merger). Живая демонстрация имеет следующие преимущества" >}}
