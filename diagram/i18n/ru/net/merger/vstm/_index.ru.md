---
title: Объединить файлы VSTM через .NET 
weight: 2740
url: /ru/net/merger/vstm/ 
description: Исходный код C# для объединения документов VSTM в .NET Framework, .NET Core, Mono или COM Interop.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по объединению файлов VSTM в C#" %}}
...
+ Загрузите все файлы VSTM с полным путем.
...
+ Вызвать метод Save() и передать имя файла (полный путь) и формат (VSTM) в качестве параметра.
...
{{% blocks/products/pf/agp/code-block title="Объединение файлов VSTM — C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram – это манипулирование форматом документа Microsoft VisioAPI. Можно легко загружать, создавать, изменять, манипулировать элементами схемы и преобразовывать диаграммы Visio в другие форматы, такие как PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF и другие. Это автономный API и не требует установки Microsoft Visio или любого другого программного обеспечения.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Онлайн-демонстрации слияния VSTM" sectionDescription="Объедините документы VSTM прямо сейчас, посетив наш [Веб-сайт живых демонстраций](https://products.aspose.app/diagram/merger). Живая демонстрация имеет следующие преимущества" >}}
