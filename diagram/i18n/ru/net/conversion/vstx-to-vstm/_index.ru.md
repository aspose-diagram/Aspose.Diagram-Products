...
description: Пример кода для преобразования VSTX в VSTM C#. Используйте пример кода API для пакетного преобразования файлов VSTX в VSTM в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузите файл VSTX с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSTM в качестве параметров.1. Файл VSTM будет сохранен по указанному пути
