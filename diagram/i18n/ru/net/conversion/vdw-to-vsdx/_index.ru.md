---
title: Преобразование VDW в VSDX через C# 
weight: 3900
url: /ru/net/conversion/vdw-to-vsdx/ 
description: Пример кода для преобразования VDW в VSDX C#. Используйте пример кода API для пакетного преобразования файлов VDW в VSDX в рамках VB.NET, Asp.NET или любого приложения на основе .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Преобразование VDW в VSDX через C#" h2="Экспорт файлов Microsoft® Visio VDW в VSDX на .NET Framework, .NET Core, Mono или COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Как преобразовать VDW в VSDX с помощью C#" %}}

 Чтобы преобразовать VDW в VSDX, мы будем использовать
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию VDW в VSDX через C#" %}}

{{% blocks/products/pf/agp/text %}}

 Разработчики .NET могут легко загружать и преобразовывать файлы VDW в VSDX, написав всего несколько строк кода.

{{% /blocks/products/pf/agp/text %}}

1. Загрузить файл VDW с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSDX в качестве параметров.1. VSDX файл будет сохранен по указанному пути
...
{{% blocks/products/pf/agp/code-block title="В этом примере кода показано преобразование VDW в VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Бесплатное приложение для преобразования VDW в VSDX" sectionDescription="Проверьте наши живые демонстрации для [Преобразование VDW в VSDX](https://products.aspose.app/diagram/conversion/vdw-to-vsdx) со следующими преимуществами." >}}
