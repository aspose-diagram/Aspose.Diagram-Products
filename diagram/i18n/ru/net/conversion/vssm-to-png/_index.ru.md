---
title: Преобразование VSSM в PNG через C# 
weight: 1780
...
{{% blocks/products/pf/agp/feature-section-col title="Действия по преобразованию VSSM в PNG через C#" %}}
...
1. Загрузите файл VSSM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.PNG в качестве параметров.1. Файл PNG будет сохранен по указанному пути
