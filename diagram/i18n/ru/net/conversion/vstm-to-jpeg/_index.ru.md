---
title: Преобразование VSTM в JPEG через C# 
weight: 1930
...
1. Загрузите файл VSTM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.JPEG в качестве параметров.1. Файл JPEG будет сохранен по указанному пути
