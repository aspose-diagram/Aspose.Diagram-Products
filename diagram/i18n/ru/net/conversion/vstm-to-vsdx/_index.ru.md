...
description: Пример кода для преобразования VSTM в VSDX C#. Используйте пример кода API для пакетного преобразования файлов VSTM в VSDX преобразование в VB.NET, Asp.NET или любом приложении на основе .NET.
---
...
1. Загрузите файл VSTM с экземпляром класса Diagram1. Вызовите метод Diagram.Save с путем к выходному файлу и SaveFileFormat.VSDX в качестве параметров.1. VSDX файл будет сохранен по указанному пути
