...
description: Пример кода преобразования Java для формата VSX в файл VSSM. Используйте этот пример кода для преобразования VSX в VSSM в любом веб-приложении или приложении для настольных компьютеров Java.
---
...
1. Загрузить файл VSX с экземпляром класса Diagram1. Вызовите метод Diagram.save с путем к выходному файлу и SaveFileFormat в качестве параметров.1. Файл VSSM будет сохранен по указанному пути
...
{{% blocks/products/pf/agp/code-block title="Исходный код преобразования VSX в VSSM Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Демонстрации преобразования VSX в VSSM в реальном времени" sectionDescription="[Конвертировать VSX в VSSM](https://products.aspose.app/diagram/conversion/vsx-to-vssm) прямо сейчас, посетив наш веб-сайт Live Demos. Живая демонстрация имеет следующие преимущества" >}}
