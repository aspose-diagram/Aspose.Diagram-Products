...
{{% blocks/products/pf/agp/content h2="Java Kullanarak VSSX Dosyalarını Birleştirme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java İçinde VSSX Dosyalarını Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX Dosyalarını Birleştir - Java" offSpacer="" %}}
