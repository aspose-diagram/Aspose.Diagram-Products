---
title: .NET aracılığıyla VSTM Dosyaları Meta Verilerini Görüntüleyin veya Düzenleyin 
weight: 3050
url: /tr/net/metadata/vstm/ 
description: .NET Framework, .NET Core, Mono Platformlarında VSTM biçimi meta verilerini düzenlemek veya görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM Meta Verilerini C# içinde ayıklayın" h2="Sunucu tarafı API\'lerini kullanarak VSTM dosyalarına meta veri eklemek, düzenlemek, kaldırmak veya çıkarmak için kendi .NET uygulamalarınızı oluşturun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VDW Meta Verilerini Çıkarma" %}}
 ...
 VSTM meta verilerini çıkarmak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# içinde VSTM Meta Verilerini Çıkarma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM Meta Verilerini Çıkarma - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram, bir Microsoft Visio belge biçimi düzenlemesidir API. Daigram öğeleri dahil olmak üzere kolayca yükleyebilir, oluşturabilir, değiştirebilir, işleyebilir ve Visio diyagramlarını PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF ve daha fazlası gibi diğer biçimlere dönüştürebilirsiniz. Bağımsız bir API'dir ve Microsoft Visio veya başka bir yazılımın yüklenmesini gerektirmez.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi Uygulama aracılığıyla VSTM\'nin Meta Verilerini Çıkarın" sectionDescription="Sayfamızı ziyaret ederek Meta Verileri VSTM belgelerine görüntüleyin ve düzenleyin [Canlı Demolar web sitesi](https://products.aspose.app/diagram/metadata). Canlı demo aşağıdaki avantajlara sahiptir" >}}
