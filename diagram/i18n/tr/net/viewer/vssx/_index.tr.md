---
title: VSSX Dosya Biçimlerini .NET üzerinden görüntüleyin 
weight: 1980
url: /tr/net/viewer/vssx/ 
description: .NET Framework, .NET Core, Mono veya COM Interop üzerinde VSSX belgelerini yüklemek, oluşturmak ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX Dosya Görüntüleyici for .NET" h2="Visio uygulaması veya Office Otomasyonu gerektirmeden Microsoft Visio VSSX dosyalarını tarayıcıda görüntüleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSSX\'i C# üzerinden Görüntüleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX\'i görüntülemek için C# kodu" offSpacer="" %}}

```cs

// bir Diagram örneği aracılığıyla VSSX dosyasını yükleyin
var diagram = new Aspose.Diagram.Diagram("template.vssx");
// VSSX'i HTML formatına dönüştür
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram, bir Microsoft Visio belge biçimi düzenlemesidir API. Daigram öğeleri dahil olmak üzere kolayca yükleyebilir, oluşturabilir, değiştirebilir, işleyebilir ve Visio diyagramlarını PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF ve daha fazlası gibi diğer biçimlere dönüştürebilirsiniz. Bağımsız bir API'dir ve Microsoft Visio veya başka bir yazılımın yüklenmesini gerektirmez.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="VSSX\'i Görüntülemek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSSX\'i Görüntüle](https://products.aspose.app/diagram/viewer/vssx) aşağıdaki faydaları ile." >}}
