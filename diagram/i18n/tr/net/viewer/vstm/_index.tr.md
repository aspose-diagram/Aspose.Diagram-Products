---
title: VSTM Dosya Biçimlerini .NET üzerinden görüntüleyin 
weight: 2230
url: /tr/net/viewer/vstm/ 
description: .NET Framework, .NET Core, Mono veya COM Interop üzerinde VSTM belgelerini yüklemek, oluşturmak ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM Dosya Görüntüleyici for .NET" h2="Visio uygulaması veya Office Otomasyonu gerektirmeden Microsoft Visio VSTM dosyalarını tarayıcıda görüntüleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSTM Dosyasını Görüntüleme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSTM\'yi C# aracılığıyla Görüntüleme Adımları" %}}
...
1. VSTM dosyasını bir Diagram sınıfı örneğiyle yükleyin1. Parametre olarak SaveFileFormat.HTML ile Diagram.Save yöntemini çağırın1. Elde edilen HTML'yi Process.Start aracılığıyla varsayılan tarayıcıya yükleyin
...
{{% blocks/products/pf/agp/code-block title="VSTM\'yi görüntülemek için C# kodu" offSpacer="" %}}

```cs

// VSTM dosyasını bir Diagram örneği aracılığıyla yükleyin
var diagram = new Aspose.Diagram.Diagram("template.vstm");
// VSTM'yi HTML formatına dönüştür
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram, bir Microsoft Visio belge biçimi düzenlemesidir API. Daigram öğeleri dahil olmak üzere kolayca yükleyebilir, oluşturabilir, değiştirebilir, işleyebilir ve Visio diyagramlarını PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF ve daha fazlası gibi diğer biçimlere dönüştürebilirsiniz. Bağımsız bir API'dir ve Microsoft Visio veya başka bir yazılımın yüklenmesini gerektirmez.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="VSTM\'yi Görüntülemek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSTM\'yi Görüntüle](https://products.aspose.app/diagram/viewer/vstm) aşağıdaki faydaları ile." >}}
