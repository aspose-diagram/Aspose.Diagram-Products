...
description: VTX'ten VSTM'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VTX dosyalarından VSTM'ye dönüştürme için API örnek kodunu kullanın.
---
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VTX\'i VSTM\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET geliştiricileri, yalnızca birkaç kod satırıyla VTX dosyalarını kolayca yükleyebilir ve VSTM'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VTX dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VSTM ile Diagram.Save yöntemini çağırın1. VSTM dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VTX\'ten VSTM\'ye C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VTX\'i VSTM\'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VTX\'ten VSTM\'ye dönüştürme](https://products.aspose.app/diagram/conversion/vtx-to-vstm) aşağıdaki faydaları ile." >}}
