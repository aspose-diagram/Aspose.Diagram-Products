---
title: VSD'i C# aracılığıyla VSDM'ye dönüştürün 
weight: 5030
url: /tr/net/conversion/vsd-to-vsdm/ 
description: VSD - VSDM C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu iş VSD dosyalarından VSDM'ye dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSD\'i C# aracılığıyla VSDM\'ye dönüştürün" h2="Microsoft® Visio VSD dosyalarını .NET Framework, .NET Core, Mono veya COM Interop üzerinde VSDM\'ye aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="VSD, C# Kullanılarak VSDM\'ye Nasıl Dönüştürülür" %}}

 VSD'i VSDM'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="VSD\'i C# aracılığıyla VSDM\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, yalnızca birkaç satır kodla VSD dosyalarını kolayca yükleyebilir ve VSDM'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSD dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VSDM ile Diagram.Save yöntemini çağırın1. VSDM dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VSD - VSDM C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD\'i VSDM\'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSD\'ten VSDM\'ye dönüştürme](https://products.aspose.app/diagram/conversion/vsd-to-vsdm) aşağıdaki faydaları ile." >}}
