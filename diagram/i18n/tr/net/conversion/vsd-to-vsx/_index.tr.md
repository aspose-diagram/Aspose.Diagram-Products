---
title: VSD'i C# aracılığıyla VSX'e dönüştürün 
weight: 520
url: /tr/net/conversion/vsd-to-vsx/ 
description: VSD - VSX C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu iş VSD dosyalarını VSX'e dönüştürmek için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSD\'i C# aracılığıyla VSX\'e dönüştürün" h2="Microsoft® Visio VSD dosyalarını .NET Framework, .NET Core, Mono veya COM Interop üzerinde VSX\'e aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak VSD\'i VSX\'e Dönüştürme" %}}

 VSD'i VSX'e dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="VSD\'i C# aracılığıyla VSX\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, yalnızca birkaç kod satırıyla VSD dosyalarını kolayca yükleyebilir ve VSX'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSD dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VSX ile Diagram.Save yöntemini çağırın1. VSX dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VSD - VSX C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD\'i VSX\'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSD\'ten VSX\'e dönüştürme](https://products.aspose.app/diagram/conversion/vsd-to-vsx) aşağıdaki faydaları ile." >}}
