---
title: C# aracılığıyla VTX'i PDF'ye dönüştürün 
weight: 1570
url: /tr/net/conversion/vtx-to-pdf/ 
description: VTX'ten PDF'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VTX dosyalarını PDF'ye dönüştürmek için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla VTX\'i PDF\'ye dönüştürün" h2="Microsoft® Visio VTX dosyalarını .NET Framework, .NET Core, Mono veya COM Interop üzerinde PDF\'ye aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VTX\'i PDF\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla VTX\'i PDF\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, yalnızca birkaç satır kodla VTX dosyalarını kolayca yükleyebilir ve PDF'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VTX\'ten PDF\'ye C# Dönüşümünü gösterir" offSpacer="" %}}
