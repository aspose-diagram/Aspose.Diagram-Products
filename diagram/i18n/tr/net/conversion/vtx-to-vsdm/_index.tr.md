...
description: VTX'ten VSDM'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VTX dosyalarından VSDM'ye dönüştürme için API örnek kodunu kullanın.
---
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VTX\'i VSDM\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET geliştiricileri, yalnızca birkaç kod satırıyla VTX dosyalarını kolayca yükleyebilir ve VSDM'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VTX dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VSDM ile Diagram.Save yöntemini çağırın1. VSDM dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VTX\'ten VSDM\'ye C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VTX\'i VSDM\'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VTX\'ten VSDM\'ye dönüştürme](https://products.aspose.app/diagram/conversion/vtx-to-vsdm) aşağıdaki faydaları ile." >}}
