---
title: C# aracılığıyla VSD'i VSDX'ye dönüştürün 
weight: 890
url: /tr/net/conversion/vsd-to-vsdx/ 
description: VSD - VSDX C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VSD dosyaları VSDX dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla VSD\'i VSDX\'ye dönüştürün" h2="Microsoft® Visio VSD dosyalarını .NET Framework, .NET Core, Mono veya COM Interop üzerinde VSDX\'ye aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak VSD, VSDX\'ye Nasıl Dönüştürülür" %}}

 VSD'i VSDX'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla VSD\'i VSDX\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, VSD dosyalarını yalnızca birkaç kod satırıyla kolayca yükleyebilir ve VSDX'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSD dosyasını yükleyin1. Diagram.Save yöntemini çıktı dosyası yolu ve SaveFileFormat.VSDX ile parametre olarak çağırın1. VSDX dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VSD - VSDX C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD\'i VSDX\'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSD - VSDX dönüşüm](https://products.aspose.app/diagram/conversion/vsd-to-vsdx) aşağıdaki faydaları ile." >}}
