---
title: VSS belgesini .NET aracılığıyla sıkıştır 
weight: 3050
url: /tr/net/compress/vss/ 
description: .NET Framework, .NET Core, Mono Platformlarında vss dosyasını sıkıştırmak için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# içinde VSS\'yi sıkıştır" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Diagram for .NET API\'lerini kullanan yerel ve yüksek performanslı VSS belge sıkıştırıcı." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSS Dosyası Nasıl Sıkıştırılır" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# içinde VSS Dosyalarını Sıkıştırma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSS Dosyalarını Sıkıştır - C#" offSpacer="" %}}
