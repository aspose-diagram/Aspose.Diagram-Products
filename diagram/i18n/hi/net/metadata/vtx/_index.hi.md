...
description: .NET फ्रेमवर्क, .NET कोर, Mono प्लेटफॉर्म पर वीटीएक्स प्रारूप मेटाडेटा को संपादित करने या देखने के लिए C# स्रोत कोड।
---
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके VSX मेटाडेटा कैसे निकालें" %}}
...
{{% blocks/products/pf/agp/code-block title="वीटीएक्स मेटाडेटा निकाला जा रहा है - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram एक Microsoft Visio दस्तावेज़ प्रारूप हेरफेर API है। कोई भी आसानी से लोड कर सकता है, बना सकता है, संशोधित कर सकता है, डायग्राम तत्वों सहित हेरफेर कर सकता है और Visio आरेखों को पीडीएफ, एक्सपीएस, जेपीईजी, पीएनजी, बीएमपी, टीआईएफएफ, एसवीजी, ईएमएफ और अन्य प्रारूपों में परिवर्तित कर सकता है। यह एक स्टैंडअलोन API है और इसके लिए Microsoft Visio या किसी अन्य सॉफ़्टवेयर को स्थापित करने की आवश्यकता नहीं है।  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="ऑनलाइन ऐप के माध्यम से वीटीएक्स का मेटाडेटा निकालें" sectionDescription="हमारे . पर जाकर मेटाडेटा को वीटीएक्स दस्तावेज़ों में देखें और संपादित करें [लाइव डेमो वेबसाइट](https://products.aspose.app/diagram/metadata). लाइव डेमो के निम्नलिखित लाभ हैं" >}}
