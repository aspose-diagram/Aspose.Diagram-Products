---
title: VSSM को C# के माध्यम से VSX में बदलें 
weight: 540
url: /hi/net/conversion/vssm-to-vsx/ 
description: VSSM से VSX C# रूपांतरण के लिए नमूना कोड। वीबी.NET, एएसपी.NET या किसी .NET आधारित एप्लिकेशन के भीतर वीएसएक्स रूपांतरण के लिए वीएसएसएम फाइलों के बैच के लिए API उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/feature-section-col title="वीएसएसएम को वीएसएक्स में बदलने के लिए कदम C# के माध्यम से" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर कोड की कुछ ही पंक्तियों में VSSM फ़ाइलों को आसानी से लोड और VSX में कनवर्ट कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. VSSM फ़ाइल को Diagram class . के उदाहरण के साथ लोड करें1. आउटपुट फ़ाइल पथ के साथ Diagram.Save विधि और पैरामीटर के रूप में SaveFileFormat.VSX को कॉल करें1. VSX फ़ाइल निर्दिष्ट पथ पर सहेजी जाएगी
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSM को VSX में बदलने के लिए फ्री ऐप" sectionDescription="इसके लिए हमारे लाइव डेमो देखें [वीएसएसएम से वीएसएक्स रूपांतरण](https://products.aspose.app/diagram/conversion/vssm-to-vsx) निम्नलिखित लाभों के साथ।" >}}
