...
1. Diagram वर्ग के उदाहरण के साथ VSD फ़ाइल लोड करें1. आउटपुट फ़ाइल पथ के साथ Diagram.Save विधि और पैरामीटर के रूप में SaveFileFormat.VSDM को कॉल करें1. VSDM फ़ाइल निर्दिष्ट पथ पर सहेजी जाएगी
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD को वीएसडीएम में बदलने के लिए नि:शुल्क ऐप" sectionDescription="इसके लिए हमारे लाइव डेमो देखें [VSD से वीएसडीएम रूपांतरण](https://products.aspose.app/diagram/conversion/vsd-to-vsdm) निम्नलिखित लाभों के साथ।" >}}
