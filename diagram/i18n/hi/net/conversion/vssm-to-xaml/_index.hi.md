---
title: VSSM को C# के माध्यम से XAML में कनवर्ट करें 
weight: 2830
url: /hi/net/conversion/vssm-to-xaml/ 
description: वीएसएसएम से एक्सएएमएल C# रूपांतरण के लिए नमूना कोड। वीबी.NET, एएसपी.NET या किसी भी .NET आधारित एप्लिकेशन के भीतर वीएसएसएम फाइलों के बैच के लिए एक्सएएमएल रूपांतरण के लिए API उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/feature-section-col title="VSSM को C# के माध्यम से XAML में कनवर्ट करने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर कोड की कुछ ही पंक्तियों में VSSM फ़ाइलों को आसानी से XAML में लोड और रूपांतरित कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. VSSM फ़ाइल को Diagram class . के उदाहरण के साथ लोड करें1. आउटपुट फ़ाइल पथ के साथ Diagram.Save विधि और पैरामीटर के रूप में SaveFileFormat.XAML को कॉल करें1. XAML फ़ाइल निर्दिष्ट पथ पर सहेजी जाएगी
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSM को XAML में बदलने के लिए फ्री ऐप" sectionDescription="इसके लिए हमारे लाइव डेमो देखें [वीएसएसएम से एक्सएएमएल रूपांतरण](https://products.aspose.app/diagram/conversion/vssm-to-xaml) निम्नलिखित लाभों के साथ।" >}}
