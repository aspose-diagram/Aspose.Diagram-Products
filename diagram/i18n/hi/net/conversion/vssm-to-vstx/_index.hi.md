---
title: VSSM को C# के माध्यम से VSTX में बदलें 
weight: 3640
url: /hi/net/conversion/vssm-to-vstx/ 
description: VSSM से VSTX C# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन के भीतर VSTX कनवर्ज़न में बैच VSSM फ़ाइलों के लिए API उदाहरण कोड का उपयोग करें।
---
...
{{% blocks/products/pf/agp/feature-section-col title="VSSM को C# के माध्यम से VSTX में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर कोड की कुछ ही पंक्तियों में VSSM फ़ाइलों को VSTX में आसानी से लोड और परिवर्तित कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. VSSM फ़ाइल को Diagram class . के उदाहरण के साथ लोड करें1. आउटपुट फ़ाइल पथ के साथ Diagram.Save विधि और पैरामीटर के रूप में SaveFileFormat.VSTX को कॉल करें1. VSTX फ़ाइल निर्दिष्ट पथ पर सहेजी जाएगी
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSM को VSTX में बदलने के लिए फ्री ऐप" sectionDescription="इसके लिए हमारे लाइव डेमो देखें [VSSM से VSTX रूपांतरण](https://products.aspose.app/diagram/conversion/vssm-to-vstx) निम्नलिखित लाभों के साथ।" >}}
