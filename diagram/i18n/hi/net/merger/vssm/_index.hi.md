...
description: C# वीएसएसएम दस्तावेज़ों को .NET फ्रेमवर्क, .NET कोर, Mono या COM इंटरऑप पर संयोजित करने के लिए स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="वीएसएसएम प्रारूपों को C# में मिलाएं" h2="Microsoft या Open Office, Adobe PDF जैसे किसी सॉफ़्टवेयर के उपयोग के बिना सर्वर-साइड Aspose.Diagram for .NET API का उपयोग करके मूल और उच्च प्रदर्शन VSSM दस्तावेज़ विलय।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके VSSM फ़ाइल को कैसे मर्ज करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSSM फ़ाइलों को C# में मर्ज करने के चरण" %}}
...
+ सभी वीएसएसएम फाइलों को पूर्ण पथ से लोड करें।
+ एक दस्तावेज़ को आधार फ़ाइल के रूप में बनाएं
+ फ़ाइलों को एक-एक करके संयोजित और मर्ज करने के लिए प्रासंगिक विधि को कॉल करें।
+ सहेजें () विधि को कॉल करें और फ़ाइल नाम (पूर्ण पथ) और प्रारूप (वीएसएसएम) को पैरामीटर के रूप में पास करें।
+ अब आप Microsoft Office, Adobe PDF या किसी अन्य संगत प्रोग्राम में VSSM फ़ाइल खोल और उपयोग कर सकते हैं।
...
{{% blocks/products/pf/agp/code-block title="VSSM फ़ाइलें मर्ज करें - C#" offSpacer="" %}}
