...
{{% blocks/products/pf/agp/content h2="Jak převést VST na VSTM pomocí Java" %}}

 K vykreslení VST na VSTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VST na VSTM prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor VST na VSTM pomocí několika řádků kódu.
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód konverze VST na VSTM Java" offSpacer="" %}}
