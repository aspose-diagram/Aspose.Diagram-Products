---
title: Převést VSTX na JPEG přes Java 
weight: 4880
url: /cs/java/conversion/vstx-to-jpeg/ 
description: Ukázkový konverzní kód Java pro formát VSTX na soubor JPEG. Tento příklad kódu použijte k převodu VSTX na JPEG v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSTX na JPEG přes Java" h2="Exportujte Microsoft Visio VSTX do JPEG pomocí nativní knihovny Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSTX na JPEG pomocí Java" %}}
 ...
 K vykreslení VSTX do JPEG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSTX na JPEG přes Java" %}}
...
1. Načtěte soubor VSTX s instancí třídy Diagram1. Volejte metodu Diagram.save s cestou k výstupnímu souboru a SaveFileFormat jako parametry1. Soubor JPEG bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka převodu VSTX na JPEG" sectionDescription="[Převést VSTX na JPEG](https://products.aspose.app/diagram/conversion/vstx-to-jpeg) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
