---
title: Převést VDW na VSTM přes Java 
weight: 2550
url: /cs/java/conversion/vdw-to-vstm/ 
description: Ukázkový konverzní kód Java pro formát VDW na soubor VSTM. Tento příklad kódu použijte k převodu VDW na VSTM v jakékoli webové nebo desktopové aplikaci založené na Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VDW na VSTM přes Java" h2="Exportujte Microsoft Visio VDW do VSTM pomocí nativní knihovny Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VDW na VSTM pomocí Java" %}}

 K vykreslení VDW do VSTM použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VDW na VSTM prostřednictvím Java" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři Java mohou snadno převést soubor VDW na VSTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VDW s instancí třídy Diagram1. Volejte metodu Diagram.save s cestou k výstupnímu souboru a SaveFileFormat jako parametry1. Soubor VSTM bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu VDW na VSTM Java" offSpacer="" %}}

```cs
// načíst VDW do objektu Diagram 
Diagram visio = new Diagram("template.vdw");
// uložit VDW jako VSTM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze VDW na VSTM" sectionDescription="[Převést VDW na VSTM](https://products.aspose.app/diagram/conversion/vdw-to-vstm) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Není třeba stahovat Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Není třeba psát žádný kód." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor VDW, bude okamžitě převeden na VSTM." >}}
