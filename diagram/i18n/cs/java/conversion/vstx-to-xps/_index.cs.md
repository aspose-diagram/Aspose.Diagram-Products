...
{{% blocks/products/pf/agp/content h2="Jak převést VSTX na XPS pomocí Java" %}}
 ...
 K vykreslení VSTX na XPS použijeme
...
1. Načtěte soubor VSTX s instancí třídy Diagram1. Volejte metodu Diagram.save s cestou k výstupnímu souboru a SaveFileFormat jako parametry1. Soubor XPS bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Zdrojový kód převodu VSTX na XPS Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze VSTX na XPS" sectionDescription="[Převést VSTX na XPS](https://products.aspose.app/diagram/conversion/vstx-to-xps) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor VSTX a bude okamžitě převeden na XPS." >}}
