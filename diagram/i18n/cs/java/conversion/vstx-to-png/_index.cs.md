---
title: Převést VSTX na PNG přes Java 
weight: 720
url: /cs/java/conversion/vstx-to-png/ 
description: Ukázkový konverzní kód Java pro formát VSTX na soubor PNG. Tento příklad kódu použijte k převodu VSTX na PNG v jakékoli webové nebo desktopové aplikaci založené na Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSTX na PNG přes Java" %}}
...
1. Načtěte soubor VSTX s instancí třídy Diagram1. Volejte metodu Diagram.save s cestou k výstupnímu souboru a SaveFileFormat jako parametry1. Soubor PNG bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Živá ukázka konverze VSTX na PNG" sectionDescription="[Převést VSTX na PNG](https://products.aspose.app/diagram/conversion/vstx-to-png) právě teď na naší webové stránce s živými ukázkami. Živá ukázka má následující výhody" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Stačí nahrát váš soubor VSTX, bude okamžitě převeden na PNG." >}}
