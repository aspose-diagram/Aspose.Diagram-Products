---
title: Zobrazit formáty souborů VSTM prostřednictvím .NET 
weight: 2230
url: /cs/net/viewer/vstm/ 
description: C# zdrojový kód pro načtení, vykreslení a zobrazení dokumentů VSTM na platformě .NET Framework, .NET Core, Mono nebo COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Prohlížeč souborů VSTM for .NET" h2="Zobrazte soubory Microsoft Visio VSTM v prohlížeči bez nutnosti aplikace Visio nebo Office Automation." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k zobrazení VSTM přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Diagram usnadňuje vývojářům zobrazení souboru VSTM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VSTM s instancí třídy Diagram1. Volejte metodu Diagram.Save s parametrem SaveFileFormat.HTML1. Načtěte výsledný HTML ve výchozím prohlížeči přes Process.Start
...
{{% blocks/products/pf/agp/code-block title="C# kód pro zobrazení VSTM" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram je manipulace s formátem dokumentu společnosti Microsoft VisioAPI. Lze snadno načítat, vytvářet, upravovat, manipulovat včetně prvků daigramu a převádět Visio diagramy do jiných formátů, jako jsou PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF a další. Jedná se o samostatný API a nevyžaduje instalaci Microsoft Visio ani jiného softwaru.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro zobrazení VSTM" sectionDescription="Podívejte se na naše živé ukázky [Zobrazit VSTM](https://products.aspose.app/diagram/viewer/vstm) s následujícími výhodami." >}}
