---
title: Převést VTX na PNG přes C# 
weight: 2790
url: /cs/net/conversion/vtx-to-png/ 
description: Ukázkový kód pro převod VTX na PNG C#. Použijte API ukázkový kód pro dávkový převod souborů VTX na PNG v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na PNG pomocí C#" %}}
 ...
 K převodu VTX na PNG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VTX na PNG přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX na PNG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.PNG jako parametry1. Soubor PNG bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX do PNG" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na PNG](https://products.aspose.app/diagram/conversion/vtx-to-png) s následujícími výhodami." >}}
