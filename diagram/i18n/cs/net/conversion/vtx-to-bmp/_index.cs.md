---
title: Převést VTX na BMP přes C# 
weight: 670
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na BMP pomocí C#" %}}
 ...
 K převodu VTX na BMP použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na BMP prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX do BMP pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.BMP jako parametry1. Soubor BMP bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na BMP" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na BMP](https://products.aspose.app/diagram/conversion/vtx-to-bmp) s následujícími výhodami." >}}
