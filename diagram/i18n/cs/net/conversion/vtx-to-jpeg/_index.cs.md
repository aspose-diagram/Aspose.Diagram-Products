---
title: Převést VTX na JPEG přes C# 
weight: 4730
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na JPEG pomocí C#" %}}
 ...
 K převodu VTX do JPEG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na JPEG prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX do JPEG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VTX s instancí třídy Diagram1. Volejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.JPEG jako parametry1. Soubor JPEG bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX do JPEG" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na JPEG](https://products.aspose.app/diagram/conversion/vtx-to-jpeg) s následujícími výhodami." >}}
