...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na XAML pomocí C#" %}}

 Abychom převedli VDX na XAML, použijeme
...
1. Načtěte soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.XAML jako parametry1. Soubor XAML bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VDX na XAML C#" offSpacer="" %}}
