...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na VSTX pomocí C#" %}}
 ...
 K převodu VTX na VSTX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na VSTX prostřednictvím C#" %}}
...
1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSTX jako parametry1. Soubor VSTX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na VSTX" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na VSTX](https://products.aspose.app/diagram/conversion/vtx-to-vstx) s následujícími výhodami." >}}
