---
title: Převést VSD na VSDM prostřednictvím C# 
weight: 5030
url: /cs/net/conversion/vsd-to-vsdm/ 
description: Ukázkový kód pro konverzi VSD na VSDM C#. Použijte API ukázkový kód pro dávkový převod souborů VSD na VSDM v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VSD na VSDM prostřednictvím C#" h2="Exportujte soubory Microsoft® Visio VSD do VSDM na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VSD na VSDM pomocí C#" %}}

 Abychom převedli VSD na VSDM, použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSD na VSDM prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD do VSDM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSDM jako parametry1. Soubor VSDM bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje konverzi VSD na VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na VSDM" sectionDescription="Podívejte se na naše živé ukázky [Převod VSD na VSDM](https://products.aspose.app/diagram/conversion/vsd-to-vsdm) s následujícími výhodami." >}}
