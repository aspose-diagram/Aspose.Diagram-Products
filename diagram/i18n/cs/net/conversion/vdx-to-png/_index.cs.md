---
title: Převést VDX na PNG přes C# 
weight: 590
url: /cs/net/conversion/vdx-to-png/ 
description: Ukázkový kód pro převod VDX na PNG C#. Použijte API ukázkový kód pro dávkový převod souborů VDX na PNG v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na PNG pomocí C#" %}}
 ...
 K převodu VDX na PNG použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VDX na PNG přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VDX na PNG pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.PNG jako parametry1. Soubor PNG bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX do PNG" sectionDescription="Podívejte se na naše živé ukázky [Převod VDX na PNG](https://products.aspose.app/diagram/conversion/vdx-to-png) s následujícími výhodami." >}}
