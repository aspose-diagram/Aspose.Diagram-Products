---
title: Převést VTX na VSSM přes C# 
weight: 350
url: /cs/net/conversion/vtx-to-vssm/ 
description: Ukázkový kód pro konverzi VTX na VSSM C#. Použijte API ukázkový kód pro dávkový převod souborů VTX na VSSM v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Převést VTX na VSSM přes C#" h2="Exportujte soubory Microsoft® Visio VTX do VSSM na .NET Framework, .NET Core, Mono nebo COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na VSSM pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na VSSM přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX do VSSM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSSM jako parametry1. Soubor VSSM bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na VSSM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na VSSM" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na VSSM](https://products.aspose.app/diagram/conversion/vtx-to-vssm) s následujícími výhodami." >}}
