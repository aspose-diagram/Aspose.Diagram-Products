---
title: Převést VDX na VSSX přes C# 
weight: 4210
url: /cs/net/conversion/vdx-to-vssx/ 
description: Ukázkový kód pro převod VDX na VSSX C#. Použijte API ukázkový kód pro dávkový převod souborů VDX na VSSX v rámci VB.NET, Asp.NET nebo jakékoli aplikace založené na .NET.
---
...
{{% blocks/products/pf/agp/content h2="Jak převést VDX na VSSX pomocí C#" %}}
 ...
 K převodu VDX na VSSX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VDX na VSSX přes C#" %}}
...
1. Načtěte soubor VDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSSX jako parametry1. Soubor VSSX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VDX na VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VDX na VSSX" sectionDescription="Podívejte se na naše živé ukázky [Převod VDX na VSSX](https://products.aspose.app/diagram/conversion/vdx-to-vssx) s následujícími výhodami." >}}
