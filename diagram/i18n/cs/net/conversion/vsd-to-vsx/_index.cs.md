---
title: Převést VSD na VSX přes C# 
weight: 520
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSD na VSX prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD do VSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSX jako parametry1. Soubor VSX bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na VSX" sectionDescription="Podívejte se na naše živé ukázky [Převod VSD na VSX](https://products.aspose.app/diagram/conversion/vsd-to-vsx) s následujícími výhodami." >}}
