...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na EMF prostřednictvím C#" %}}
...
1. Načtěte soubor VTX s instancí třídy Diagram1. Volejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.EMF jako parametry1. Soubor EMF bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na EMF C#" offSpacer="" %}}
