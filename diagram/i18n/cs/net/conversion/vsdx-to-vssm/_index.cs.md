---
title: Převést VSDX na VSSM přes C# 
weight: 2040
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSDX na VSSM prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSDX do VSSM pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSSM jako parametry1. Soubor VSSM bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSDX na VSSM" sectionDescription="Podívejte se na naše živé ukázky [Převod VSDX na VSSM](https://products.aspose.app/diagram/conversion/vsdx-to-vssm) s následujícími výhodami." >}}
