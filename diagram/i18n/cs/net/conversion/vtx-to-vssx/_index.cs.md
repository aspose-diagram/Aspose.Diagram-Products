---
title: Převést VTX na VSSX přes C# 
weight: 4260
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na VSSX pomocí C#" %}}
 ...
 K převodu VTX na VSSX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na VSSX prostřednictvím C#" %}}
...
1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSSX jako parametry1. Soubor VSSX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na VSSX" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na VSSX](https://products.aspose.app/diagram/conversion/vtx-to-vssx) s následujícími výhodami." >}}
