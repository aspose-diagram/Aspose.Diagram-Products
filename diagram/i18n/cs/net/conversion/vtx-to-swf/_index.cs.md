...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na SWF prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX na SWF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.SWF jako parametry1. Soubor SWF bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na SWF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX do SWF" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX do SWF](https://products.aspose.app/diagram/conversion/vtx-to-swf) s následujícími výhodami." >}}
