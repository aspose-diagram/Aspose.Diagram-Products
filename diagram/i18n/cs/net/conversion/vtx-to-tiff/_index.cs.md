---
title: Převést VTX na TIFF přes C# 
weight: 2820
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na TIFF pomocí C#" %}}
 ...
 K převodu VTX na TIFF použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na TIFF prostřednictvím C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VTX na TIFF pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načtěte soubor VTX s instancí třídy Diagram1. Volejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.TIFF jako parametry1. Soubor TIFF bude uložen do zadané cesty
