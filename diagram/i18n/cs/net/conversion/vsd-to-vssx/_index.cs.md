---
title: Převést VSD na VSSX přes C# 
weight: 2880
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSD na VSSX přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSD do VSSX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSD s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSSX jako parametry1. Soubor VSSX bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSD na VSSX" sectionDescription="Podívejte se na naše živé ukázky [Převod VSD na VSSX](https://products.aspose.app/diagram/conversion/vsd-to-vssx) s následujícími výhodami." >}}
