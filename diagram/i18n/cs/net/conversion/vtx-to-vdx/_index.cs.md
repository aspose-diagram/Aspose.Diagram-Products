...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na VDX pomocí C#" %}}
 ...
 K převodu VTX na VDX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na VDX přes C#" %}}
...
1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VDX jako parametry1. Soubor VDX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na VDX" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na VDX](https://products.aspose.app/diagram/conversion/vtx-to-vdx) s následujícími výhodami." >}}
