---
title: Převést VSDX na VDX přes C# 
weight: 130
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky k převodu VSDX na VDX přes C#" %}}

{{% blocks/products/pf/agp/text %}}

 Vývojáři .NET mohou snadno načíst a převést soubory VSDX do formátu VDX pomocí několika řádků kódu.

{{% /blocks/products/pf/agp/text %}}

1. Načíst soubor VSDX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VDX jako parametry1. Soubor VDX bude uložen do zadané cesty
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VSDX na VDX" sectionDescription="Podívejte se na naše živé ukázky [Převod VSDX na VDX](https://products.aspose.app/diagram/conversion/vsdx-to-vdx) s následujícími výhodami." >}}
