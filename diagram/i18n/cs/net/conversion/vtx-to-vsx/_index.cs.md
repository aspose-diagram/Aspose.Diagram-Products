---
title: Převést VTX na VSX přes C# 
weight: 4160
...
{{% blocks/products/pf/agp/content h2="Jak převést VTX na VSX pomocí C#" %}}
 ...
 K převodu VTX na VSX použijeme
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro převod VTX na VSX prostřednictvím C#" %}}
...
1. Načtěte soubor VTX s instancí třídy Diagram1. Zavolejte metodu Diagram.Save s cestou k výstupnímu souboru a SaveFileFormat.VSX jako parametry1. Soubor VSX bude uložen do zadané cesty
...
{{% blocks/products/pf/agp/code-block title="Tento ukázkový kód ukazuje převod VTX na VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Bezplatná aplikace pro převod VTX na VSX" sectionDescription="Podívejte se na naše živé ukázky [Převod VTX na VSX](https://products.aspose.app/diagram/conversion/vtx-to-vsx) s následujícími výhodami." >}}
