---
title: Vodoznak dokumentu VDX prostřednictvím .NET 
weight: 3050
url: /cs/net/watermark/vdx/ 
description: C# zdrojový kód pro přidání vodoznaku do souboru vdx na platformách .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Jak vytvořit vodoznak v souboru VDX pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro vodoznak souborů VDX v C#" %}}
