---
title: Rozdělit soubory VSSM přes .NET 
weight: 1300
url: /cs/net/splitter/vssm/ 
description: Zdrojový kód C# do souboru Split vssm na platformách .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Rozdělit VSSM v C#" h2="Nativní a vysoce výkonný rozdělovač dokumentů VSSM využívající rozhraní API Aspose.Diagram for .NET na straně serveru, bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Jak rozdělit soubor VSSM pomocí C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Kroky pro rozdělení souborů VSSM v C#" %}}
...
+ Načtěte soubor VSSM s úplnou cestou pro rozdělení.
...
{{% blocks/products/pf/agp/code-block title="Rozdělit soubory VSSM – C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram je manipulace s formátem dokumentu společnosti Microsoft VisioAPI. Lze snadno načítat, vytvářet, upravovat, manipulovat včetně prvků daigramu a převádět Visio diagramy do jiných formátů, jako jsou PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF a další. Jedná se o samostatný API a nevyžaduje instalaci Microsoft Visio ani jiného softwaru.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online živé ukázky VSSM Split" sectionDescription="Rozdělte dokumenty VSSM právě teď tím, že navštívíte naše [Web živé ukázky](https://products.aspose.app/diagram/splitter). Živé demo má následující výhody" >}}
