...
description: Esempio di codice di conversione Java per il formato VSTM in file JPEG. Utilizzare questo codice di esempio per convertire VSTM in JPEG all'interno di qualsiasi applicazione basata su Web o Desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire VSTM in JPEG utilizzando Java" %}}
 ...
 Per rendere VSTM in JPEG, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java gli sviluppatori possono convertire facilmente i file VSTM in JPEG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSTM con un'istanza della classe Diagram1. Chiama il metodo Diagram.save con il percorso del file di output e SaveFileFormat come parametri1. Il file JPEG verrà salvato nel percorso specificato
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo dal vivo di conversione da VSTM a JPEG" sectionDescription="[Converti VSTM in JPEG](https://products.aspose.app/diagram/conversion/vstm-to-jpeg) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
