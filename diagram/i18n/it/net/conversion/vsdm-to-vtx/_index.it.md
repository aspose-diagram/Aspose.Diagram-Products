---
title: Converti VSDM in VTX tramite C# 
weight: 4990
url: /it/net/conversion/vsdm-to-vtx/ 
description: Codice di esempio per la conversione da VSDM a VTX C#. Utilizza API codice di esempio per la conversione batch di file VSDM in VTX all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSDM in VTX tramite C#" h2="Esporta i file Microsoft® Visio VSDM in VTX su .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in VTX utilizzando C#" %}}

 Per convertire VSDM in VTX, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VSDM in VTX tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET gli sviluppatori possono caricare e convertire facilmente i file VSDM in VTX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza della classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VTX come parametri1. Il file VTX verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da VSDM a VTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VSDM in VTX" sectionDescription="Controlla le nostre demo dal vivo per [Conversione da VSDM a VTX](https://products.aspose.app/diagram/conversion/vsdm-to-vtx) con i seguenti vantaggi." >}}
