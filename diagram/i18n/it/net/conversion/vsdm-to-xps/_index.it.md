...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in XPS usando C#" %}}

 Per convertire VSDM in XPS, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente i file VSDM in XPS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza della classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.XPS come parametri1. Il file XPS verrà salvato nel percorso specificato
