---
title: Converti VSDM in JPEG tramite C# 
weight: 1920
url: /it/net/conversion/vsdm-to-jpeg/ 
description: Codice di esempio per la conversione da VSDM a JPEG C#. Utilizza API codice di esempio per la conversione batch di file VSDM in JPEG all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSDM in JPEG tramite C#" h2="Esporta i file Microsoft® Visio VSDM in JPEG su .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in JPEG utilizzando C#" %}}

 Per convertire VSDM in JPEG, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VSDM in JPEG tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET gli sviluppatori possono caricare e convertire facilmente i file VSDM in JPEG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza della classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.JPEG come parametri1. Il file JPEG verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da VSDM a JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VSDM in JPEG" sectionDescription="Controlla le nostre demo dal vivo per [Conversione da VSDM a JPEG](https://products.aspose.app/diagram/conversion/vsdm-to-jpeg) con i seguenti vantaggi." >}}
