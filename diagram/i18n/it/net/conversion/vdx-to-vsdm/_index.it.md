...
{{% blocks/products/pf/agp/content h2="Come convertire VDX in VSDM usando C#" %}}

 Per convertire VDX in VSDM, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente i file VDX in VSDM in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VDX con un'istanza della classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VSDM come parametri1. Il file VSDM verrà salvato nel percorso specificato
