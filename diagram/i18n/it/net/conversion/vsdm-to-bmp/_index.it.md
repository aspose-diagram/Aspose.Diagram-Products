---
title: Converti VSDM in BMP tramite C# 
weight: 4190
url: /it/net/conversion/vsdm-to-bmp/ 
description: Codice di esempio per la conversione da VSDM a BMP C#. Utilizza API codice di esempio per la conversione batch di file VSDM in BMP all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSDM in BMP tramite C#" h2="Esporta i file Microsoft® Visio VSDM in BMP su .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in BMP utilizzando C#" %}}

 Per convertire VSDM in BMP, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VSDM in BMP tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET gli sviluppatori possono caricare e convertire facilmente i file VSDM in BMP in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza della classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.BMP come parametri1. Il file BMP verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da VSDM a BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VSDM in BMP" sectionDescription="Controlla le nostre demo dal vivo per [Conversione da VSDM a BMP](https://products.aspose.app/diagram/conversion/vsdm-to-bmp) con i seguenti vantaggi." >}}
