---
title: Unisci file VDX tramite .NET 
weight: 3260
url: /it/net/merger/vdx/ 
description: C# codice sorgente per combinare documenti VDX su .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci formati VDX in C#" h2="Fusione di documenti VDX nativi e ad alte prestazioni utilizzando API Aspose.Diagram for .NET lato server, senza l\'uso di software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come unire file VDX usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'unione di file VDX in C#" %}}
...
+ Carica tutti i file VDX con il percorso completo.
+ Crea un documento come file di base
+ Chiama il metodo pertinente per concatenare e unire i file uno per uno.
Chiama il metodo Save() e passa il nome del file (percorso completo) e il formato (VDX) come parametro.
+ Ora puoi aprire e utilizzare il file VDX in Microsoft Office, Adobe PDF o qualsiasi altro programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Unisci file VDX - C#" offSpacer="" %}}
