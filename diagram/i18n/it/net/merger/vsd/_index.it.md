---
title: Unisci VSD file tramite .NET 
weight: 2530
url: /it/net/merger/vsd/ 
description: C# codice sorgente per combinare VSD documenti su .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci VSD formati in C#" h2="Unione di documenti nativi e ad alte prestazioni VSD utilizzando API Aspose.Diagram for .NET lato server, senza l\'uso di alcun software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Come unire VSD file utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per unire VSD file in C#" %}}
...
+ Carica tutti i VSD file con il percorso completo.
+ Crea un documento come file di base
+ Chiama il metodo pertinente per concatenare e unire i file uno per uno.
+ Chiama il metodo Save() e passa il nome del file (percorso completo) e il formato (VSD) come parametro.
Ora puoi aprire e utilizzare il file VSD in Microsoft Office, Adobe PDF o qualsiasi altro programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Unisci VSD file - C#" offSpacer="" %}}
