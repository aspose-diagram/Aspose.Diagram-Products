---
title: Unisci file VSSM tramite .NET 
weight: 2380
url: /it/net/merger/vssm/ 
description: C# codice sorgente per combinare documenti VSSM su .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci formati VSSM in C#" h2="Fusione di documenti VSSM nativi e ad alte prestazioni utilizzando API Aspose.Diagram for .NET lato server, senza l\'uso di software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Come unire file VSSM utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'unione di file VSSM in C#" %}}
...
+ Carica tutti i file VSSM con il percorso completo.
+ Crea un documento come file di base
+ Chiama il metodo pertinente per concatenare e unire i file uno per uno.
+ Chiamare il metodo Save() e passare il nome del file (percorso completo) e il formato (VSSM) come parametro.
+ Ora puoi aprire e utilizzare il file VSSM in Microsoft Office, Adobe PDF o qualsiasi altro programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Unisci file VSSM - C#" offSpacer="" %}}
