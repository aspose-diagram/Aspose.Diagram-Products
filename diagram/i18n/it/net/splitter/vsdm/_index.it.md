---
title: Dividi i file VSDM tramite .NET 
weight: 1300
url: /it/net/splitter/vsdm/ 
description: C# codice sorgente per dividere il file vsdm su .NET Framework, .NET Core, Mono Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Come dividere il file VSDM usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per dividere i file VSDM in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dividi file VSDM - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram è una manipolazione del formato del documento Visio Microsoft API. Si può facilmente caricare, creare, modificare, manipolare inclusi elementi daigram e convertire Visio diagrammi in altri formati come PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF e altro ancora. È un API autonomo e non richiede l'installazione di Microsoft Visio o di qualsiasi altro software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Dimostrazioni live split VSDM online" sectionDescription="Dividi i documenti VSDM in questo momento visitando il nostro [Sito di demo dal vivo](https://products.aspose.app/diagram/splitter). La demo dal vivo ha i seguenti vantaggi" >}}
