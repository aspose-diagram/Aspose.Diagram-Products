---
title: Comprimi il documento VSSX tramite .NET 
weight: 3050
url: /it/net/compress/vssx/ 
description: C# codice sorgente per comprimere il file vssx su .NET Framework, .NET Core, Mono Platforms.
---
...
{{% blocks/products/pf/agp/content h2="Come comprimere il file VSSX usando C#" %}}

 Per comprimere il file VSSX, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la compressione dei file VSSX in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimi file VSSX - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram è una manipolazione del formato del documento Visio Microsoft API. Si può facilmente caricare, creare, modificare, manipolare inclusi elementi daigram e convertire Visio diagrammi in altri formati come PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF e altro ancora. È un API autonomo e non richiede l'installazione di Microsoft Visio o di qualsiasi altro software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VSSX Comprimi demo dal vivo" sectionDescription="Comprimi i documenti VSSM in questo momento visitando il nostro [Sito di demo dal vivo](https://products.aspose.app/diagram/compress). La demo dal vivo ha i seguenti vantaggi" >}}
