---
title: VTX-Dokument mit Wasserzeichen über .NET 
weight: 3050
url: /de/net/watermark/vtx/ 
description: C# Quellcode zum Hinzufügen von Wasserzeichen zur vtx-Datei auf .NET Framework, .NET Core, Mono Plattformen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Textwasserzeichen zu VTX in C# hinzufügen" h2="Natives und leistungsstarkes VTX-Dokumentenwasserzeichen mit serverseitigen Aspose.Diagram for .NET-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So versehen Sie eine VTX-Datei mit einem Wasserzeichen unter Verwendung von C#" %}}

 Um die VTX-Datei mit einem Wasserzeichen zu versehen, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Versehen von VTX-Dateien mit Wasserzeichen in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Wasserzeichen-VTX-Dateien - C#" offSpacer="" %}}
