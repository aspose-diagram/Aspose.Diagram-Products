---
title: VSTM-Dokument über .NET komprimieren 
weight: 3050
url: /de/net/compress/vstm/ 
description: C# Quellcode zum Komprimieren der vstm-Datei auf .NET Framework, .NET Core, Mono Plattformen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM in C# komprimieren" h2="Nativer und leistungsstarker VSTM-Dokumentenkomprimierer mit serverseitigen Aspose.Diagram for .NET-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So komprimieren Sie eine VSTM-Datei mit C#" %}}

 Um die VSTM-Datei zu komprimieren, verwenden wir
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram ist eine Manipulation des Microsoft Visio-Dokumentformats API. Man kann einfach Diagrammelemente laden, erstellen, modifizieren, manipulieren und Visio-Diagramme in andere Formate wie PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF und mehr konvertieren. Es ist ein eigenständiges API und erfordert keine Installation von Microsoft Visio oder anderer Software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VSTM Compress Live-Demos" sectionDescription="Komprimieren Sie VST-Dokumente jetzt, indem Sie unsere besuchen [Live-Demos-Website](https://products.aspose.app/diagram/compress). Die Live-Demo hat die folgenden Vorteile" >}}
