...
{{% blocks/products/pf/agp/content h2="So führen Sie eine VDX-Datei mit C# zusammen" %}}
...
Rufen Sie die Methode Save() auf und übergeben Sie den Dateinamen (vollständiger Pfad) und das Format (VDX) als Parameter.
+ Jetzt können Sie die VDX-Datei in Microsoft Office, Adobe PDF oder jedem anderen kompatiblen Programm öffnen und verwenden.
