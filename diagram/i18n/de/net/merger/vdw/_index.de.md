---
title: VDW-Dateien über .NET zusammenführen 
weight: 4020
url: /de/net/merger/vdw/ 
description: C# Quellcode zum Kombinieren von VDW-Dokumenten auf .NET Framework, .NET Core, Mono oder COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW-Formate in C# zusammenführen" h2="Native und leistungsstarke VDW-Dokumentenzusammenführung mit serverseitigen Aspose.Diagram for .NET-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="So führen Sie eine VDW-Datei mit C# zusammen" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Zusammenführen von VDW-Dateien in C#" %}}
...
+ Laden Sie alle VDW-Dateien mit vollständigem Pfad.
...
+ Rufen Sie die Methode Save() auf und übergeben Sie als Parameter den Dateinamen (vollständiger Pfad) und das Format (VDW).
Jetzt können Sie die VDW-Datei in Microsoft Office, Adobe PDF oder jedem anderen kompatiblen Programm öffnen und verwenden.
...
{{% blocks/products/pf/agp/code-block title="VDW-Dateien zusammenführen - C#" offSpacer="" %}}
