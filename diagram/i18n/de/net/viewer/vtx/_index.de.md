---
title: VTX-Dateiformate über .NET anzeigen 
weight: 3320
...
{{% blocks/products/pf/agp/content h2="So zeigen Sie die VTX-Datei mit C# an" %}}

 Um die VTX-Datei anzuzeigen, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Diagram macht es den Entwicklern leicht, die VTX-Datei mit nur wenigen Codezeilen anzuzeigen.

{{% /blocks/products/pf/agp/text %}}

1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.Save mit SaveFileFormat.HTML als Parameter auf1. Laden Sie das resultierende HTML im Standardbrowser über Process.Start
...
{{% blocks/products/pf/agp/code-block title="C#-Code, um VTX anzuzeigen" offSpacer="" %}}
 ...
 Aspose.Diagram ist eine Manipulation des Microsoft Visio-Dokumentformats API. Man kann einfach Diagrammelemente laden, erstellen, modifizieren, manipulieren und Visio-Diagramme in andere Formate wie PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF und mehr konvertieren. Es ist ein eigenständiges API und erfordert keine Installation von Microsoft Visio oder anderer Software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Anzeigen von VTX" sectionDescription="Sehen Sie sich unsere Live-Demos an [VTX ansehen](https://products.aspose.app/diagram/viewer/vtx) mit folgenden Vorteilen." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach die VTX-Datei hoch und klicken Sie auf die Schaltfläche \"Anzeigen\"." >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Laden Sie bei Bedarf die VTX-Datei über den Link herunter" >}}
