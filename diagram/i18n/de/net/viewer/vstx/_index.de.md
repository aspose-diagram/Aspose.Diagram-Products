---
title: VSTX-Dateiformate über .NET anzeigen 
weight: 3560
...
{{% blocks/products/pf/agp/content h2="So zeigen Sie eine VSTX-Datei mit C# an" %}}

 Um die VSTX-Datei anzuzeigen, verwenden wir
...
1. Laden Sie die VSTX-Datei mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.Save mit SaveFileFormat.HTML als Parameter auf1. Laden Sie das resultierende HTML im Standardbrowser über Process.Start
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram ist eine Manipulation des Microsoft Visio-Dokumentformats API. Man kann einfach Diagrammelemente laden, erstellen, modifizieren, manipulieren und Visio-Diagramme in andere Formate wie PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF und mehr konvertieren. Es ist ein eigenständiges API und erfordert keine Installation von Microsoft Visio oder anderer Software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Anzeigen von VSTX" sectionDescription="Sehen Sie sich unsere Live-Demos an [Sehen Sie sich VSTX an](https://products.aspose.app/diagram/viewer/vstx) mit folgenden Vorteilen." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Laden Sie einfach die VSTX-Datei hoch und klicken Sie auf die Schaltfläche \"Anzeigen\"." >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Laden Sie bei Bedarf die VSTX-Datei über den Link herunter" >}}
