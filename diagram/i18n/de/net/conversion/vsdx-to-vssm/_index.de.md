...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSDX mit C# in VSSM" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können VSDX-Dateien in nur wenigen Codezeilen einfach laden und in VSSM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSDX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSSM als Parameter auf1. Die VSSM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSDX in VSSM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSDX in VSSM" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSDX-zu-VSSM-Umwandlung](https://products.aspose.app/diagram/conversion/vsdx-to-vssm) mit folgenden Vorteilen." >}}
