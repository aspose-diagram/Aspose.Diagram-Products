---
title: Konvertieren Sie VSTX in BMP über C# 
weight: 4850
url: /de/net/conversion/vstx-to-bmp/ 
description: Beispielcode für die Konvertierung von VSTX in BMP C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSTX-Dateien in BMP innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTX in BMP über C#" h2="Exportieren Sie Microsoft® Visio VSTX-Dateien nach BMP auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTX in BMP mit C#" %}}

 Um VSTX in BMP zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSTX in BMP über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-Entwickler können VSTX-Dateien in nur wenigen Codezeilen einfach laden und in BMP konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die VSTX-Datei mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.BMP als Parameter auf1. Die BMP-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VSTX-zu-BMP-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSTX in BMP" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSTX-zu-BMP-Konvertierung](https://products.aspose.app/diagram/conversion/vstx-to-bmp) mit folgenden Vorteilen." >}}
