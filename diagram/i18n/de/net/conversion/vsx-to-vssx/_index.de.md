---
title: Konvertieren Sie VSX in VSSX über C# 
weight: 5310
url: /de/net/conversion/vsx-to-vssx/ 
description: Beispielcode für die Konvertierung von VSX in VSSX C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSX-Dateien in VSSX in VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSX in VSSX über C#" h2="Exportieren Sie Microsoft® Visio VSX-Dateien nach VSSX auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX in VSSX mit C#" %}}

 Um VSX in VSSX zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET Entwickler können VSX-Dateien in nur wenigen Codezeilen einfach laden und in VSSX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSSX als Parameter auf1. Die VSSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VSX-zu-VSSX-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSX in VSSX" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSX-zu-VSSX-Konvertierung](https://products.aspose.app/diagram/conversion/vsx-to-vssx) mit folgenden Vorteilen." >}}
