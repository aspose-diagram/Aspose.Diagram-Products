---
title: Konvertieren Sie VSDX über C# in VSSX 
weight: 3270
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSDX mit C# in VSSX" %}}

 Um VSDX in VSSX zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET-Entwickler können VSDX-Dateien in nur wenigen Codezeilen einfach laden und in VSSX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSDX mit einer Instanz der Klasse Diagram1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSSX als Parameter auf1. Die VSSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Umwandlung von VSDX in VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSDX in VSSX" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSDX zu VSSX-Konvertierung](https://products.aspose.app/diagram/conversion/vsdx-to-vssx) mit folgenden Vorteilen." >}}
