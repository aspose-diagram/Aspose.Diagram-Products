---
title: Konvertieren Sie VSX in VSDM über C# 
weight: 3240
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX in VSDM mit C#" %}}

 Um VSX in VSDM zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET Entwickler können VSX-Dateien in nur wenigen Codezeilen einfach laden und in VSDM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSDM als Parameter auf1. Die VSDM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VSX-zu-VSDM-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSX in VSDM" sectionDescription="Sehen Sie sich unsere Live-Demos an [Konvertierung von VSX zu VSDM](https://products.aspose.app/diagram/conversion/vsx-to-vsdm) mit folgenden Vorteilen." >}}
