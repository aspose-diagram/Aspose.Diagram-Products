...
description: Beispielcode für die Umwandlung von VDW in VSDM C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VDW-Dateien in VSDM innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VDW in VSDM mit C#" %}}
...
1. VDW-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSDM als Parameter auf1. Die VSDM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VDW-zu-VSDM-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VDW in VSDM" sectionDescription="Sehen Sie sich unsere Live-Demos an [VDW-zu-VSDM-Konvertierung](https://products.aspose.app/diagram/conversion/vdw-to-vsdm) mit folgenden Vorteilen." >}}
