---
title: VDW über C# in VSSX konvertieren 
weight: 530
url: /de/net/conversion/vdw-to-vssx/ 
description: Beispielcode für die Umwandlung von VDW in VSSX C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VDW-Dateien in VSSX innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW über C# in VSSX konvertieren" h2="Exportieren Sie Microsoft® Visio VDW-Dateien nach VSSX auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VDW in VSSX mit C#" %}}

 Um VDW in VSSX zu konvertieren, verwenden wir
...
1. VDW-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.VSSX als Parameter auf1. Die VSSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VDW-zu-VSSX-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VDW in VSSX" sectionDescription="Sehen Sie sich unsere Live-Demos an [VDW-zu-VSSX-Konvertierung](https://products.aspose.app/diagram/conversion/vdw-to-vssx) mit folgenden Vorteilen." >}}
