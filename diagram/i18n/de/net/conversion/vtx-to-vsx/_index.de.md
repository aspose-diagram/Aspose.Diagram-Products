---
title: Konvertieren Sie VTX über C# in VSX 
weight: 4160
url: /de/net/conversion/vtx-to-vsx/ 
description: Beispielcode für die Umwandlung von VTX in VSX C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VTX-Dateien in VSX in VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VTX über C# in VSX" h2="Exportieren Sie Microsoft® Visio VTX-Dateien nach VSX auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX mit C# in VSX" %}}

 Um VTX in VSX zu konvertieren, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VTX in VSX über C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET Entwickler können VTX-Dateien in nur wenigen Codezeilen einfach laden und in VSX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.Save mit dem Ausgabedateipfad und SaveFileFormat.VSX als Parameter auf1. Die VSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die VTX-zu-VSX-C#-Konvertierung" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VTX in VSX" sectionDescription="Sehen Sie sich unsere Live-Demos an [VTX-zu-VSX-Konvertierung](https://products.aspose.app/diagram/conversion/vtx-to-vsx) mit folgenden Vorteilen." >}}
