...
description: Beispielcode für die Konvertierung von VSX in TIFF C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSX-Dateien in TIFF innerhalb von VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX in TIFF mit C#" %}}
...
1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.TIFF als Parameter auf1. Die TIFF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VSX in TIFF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSX in TIFF" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSX-zu-TIFF-Konvertierung](https://products.aspose.app/diagram/conversion/vsx-to-tiff) mit folgenden Vorteilen." >}}
