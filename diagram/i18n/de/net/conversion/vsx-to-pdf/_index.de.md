---
title: Konvertieren Sie VSX in PDF über C# 
weight: 4360
url: /de/net/conversion/vsx-to-pdf/ 
description: Beispielcode für die Konvertierung von VSX in PDF C#. Verwenden Sie API Beispielcode für die Batch-Konvertierung von VSX-Dateien in PDF in VB.NET, Asp.NET oder einer beliebigen .NET-basierten Anwendung.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSX in PDF über C#" h2="Exportieren Sie Microsoft® Visio VSX-Dateien in PDF auf .NET Framework, .NET Core, Mono oder COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX in PDF mit C#" %}}
...
1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Diagram.Save-Methode mit dem Ausgabedateipfad und SaveFileFormat.PDF als Parameter auf1. Die PDF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="Dieser Beispielcode zeigt die Konvertierung von VSX in PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Kostenlose App zum Konvertieren von VSX in PDF" sectionDescription="Sehen Sie sich unsere Live-Demos an [VSX-zu-PDF-Konvertierung](https://products.aspose.app/diagram/conversion/vsx-to-pdf) mit folgenden Vorteilen." >}}
