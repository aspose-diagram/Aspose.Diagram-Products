---
title: Teilen Sie VSDX Dateien über .NET 
weight: 1300
url: /de/net/splitter/vsdx/ 
description: C# Quellcode zum Aufteilen der vsdx-Datei auf .NET Framework, .NET Core, Mono Plattformen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Teilen Sie VSDX in C# auf" h2="Nativer und leistungsstarker VSDX Document Splitter mit serverseitigen Aspose.Diagram for .NET APIs, ohne die Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So teilen Sie eine VSDX-Datei mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Teilen von VSDX Dateien in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Teilen Sie VSDX Dateien - C#" offSpacer="" %}}
