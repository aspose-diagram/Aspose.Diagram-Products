---
title: Splitten Sie VSDM-Dateien über .NET 
weight: 1300
url: /de/net/splitter/vsdm/ 
description: C# Quellcode zum Aufteilen der vsdm-Datei auf .NET Framework, .NET Core, Mono Plattformen.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDM in C# aufteilen" h2="Nativer und leistungsstarker VSDM-Dokumentensplitter mit serverseitigen Aspose.Diagram for .NET-APIs, ohne Verwendung von Software wie Microsoft oder Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="So teilen Sie eine VSDM-Datei mit C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Teilen von VSDM-Dateien in C#" %}}
...
+ Laden Sie die VSDM-Datei mit vollständigem Pfad zum Teilen.
...
{{% blocks/products/pf/agp/code-block title="Geteilte VSDM-Dateien - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram ist eine Manipulation des Microsoft Visio-Dokumentformats API. Man kann einfach Diagrammelemente laden, erstellen, modifizieren, manipulieren und Visio-Diagramme in andere Formate wie PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF und mehr konvertieren. Es ist ein eigenständiges API und erfordert keine Installation von Microsoft Visio oder anderer Software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online-VSDM-Split-Live-Demos" sectionDescription="Teilen Sie VSDM-Dokumente jetzt auf, indem Sie unsere besuchen [Live-Demos-Website](https://products.aspose.app/diagram/splitter). Die Live-Demo hat die folgenden Vorteile" >}}
