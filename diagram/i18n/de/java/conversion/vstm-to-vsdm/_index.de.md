---
title: Konvertieren Sie VSTM in VSDM über Java 
weight: 2310
url: /de/java/conversion/vstm-to-vsdm/ 
description: Beispiel-Umwandlungscode Java für das VSTM-Format in eine VSDM-Datei. Verwenden Sie diesen Beispielcode, um VSTM in VSDM in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTM in VSDM über Java" h2="Exportieren Sie Microsoft Visio VSTM nach VSDM unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSTM in VSDM mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSTM in VSDM über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VSTM-Dateien in nur wenigen Codezeilen problemlos in VSDM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSDM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTM-zu-VSDM-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie das VSTM in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vstm");
// Speichern Sie VSTM als VSDM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM-zu-VSDM-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSTM in VSDM](https://products.aspose.app/diagram/conversion/vstm-to-vsdm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
