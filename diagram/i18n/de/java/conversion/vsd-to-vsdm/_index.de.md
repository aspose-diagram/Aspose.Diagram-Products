---
title: Konvertieren Sie VSD über Java in VSDM 
weight: 3940
url: /de/java/conversion/vsd-to-vsdm/ 
description: Beispiel-Umwandlungscode Java für das Format VSD in eine VSDM-Datei. Verwenden Sie diesen Beispielcode, um VSD innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung in VSDM zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSD über Java in VSDM" h2="Exportieren Sie Microsoft Visio VSD mithilfe der nativen Java-Bibliothek nach VSDM." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Konvertieren von VSD in VSDM mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSD in VSDM über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können die VSD-Datei in nur wenigen Codezeilen problemlos in VSDM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSD mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSDM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSD zu VSDM Java Conversion-Quellcode" offSpacer="" %}}

```cs
// Laden Sie die VSD in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vsd");
// speichern Sie VSD als VSDM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD zu VSDM-Konvertierungs-Live-Demos" sectionDescription="[Wandeln Sie VSD in VSDM um](https://products.aspose.app/diagram/conversion/vsd-to-vsdm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
