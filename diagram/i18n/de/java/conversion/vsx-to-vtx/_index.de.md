---
title: Konvertieren Sie VSX in VTX über Java 
weight: 5250
url: /de/java/conversion/vsx-to-vtx/ 
description: Beispiel-Umwandlungscode Java für das VSX-Format in eine VTX-Datei. Verwenden Sie diesen Beispielcode, um VSX in VTX in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSX in VTX über Java" h2="Exportieren Sie Microsoft Visio VSX nach VTX unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX in VTX mit Java" %}}

 Um VSX zu VTX zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSX-Dateien in nur wenigen Codezeilen problemlos in VTX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VTX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSX-zu-VTX-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VSX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vsx");
// Speichern Sie VSX als VTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSX-zu-VTX-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSX in VTX](https://products.aspose.app/diagram/conversion/vsx-to-vtx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
