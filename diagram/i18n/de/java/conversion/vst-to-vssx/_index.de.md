...
description: Beispiel-Umwandlungscode Java für das VST-Format in die VSSX-Datei. Verwenden Sie diesen Beispielcode, um VST in VSSX in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VST in VSSX mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VST-Dateien in nur wenigen Codezeilen problemlos in VSSX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VST-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VST-zu-VSSX-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die VST in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vst");
// Speichern Sie VST als VSSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VST-zu-VSSX-Konvertierungs-Live-Demos" sectionDescription="[Konvertieren Sie VST in VSSX](https://products.aspose.app/diagram/conversion/vst-to-vssx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
