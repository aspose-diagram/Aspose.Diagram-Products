---
title: Konvertieren Sie VSX in VSDX über Java 
weight: 340
url: /de/java/conversion/vsx-to-vsdx/ 
description: Beispiel-Umwandlungscode Java für das VSX-Format in die Datei VSDX. Verwenden Sie diesen Beispielcode, um VSX in VSDX innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSX in VSDX über Java" h2="Exportieren Sie Microsoft Visio VSX nach VSDX unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX mit Java in VSDX" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können die VSX-Datei in nur wenigen Codezeilen problemlos in VSDX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. VSDX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSX zu VSDX Java Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VSX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vsx");
// VSX als VSDX speichern 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSX zu VSDX Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSX in VSDX](https://products.aspose.app/diagram/conversion/vsx-to-vsdx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
