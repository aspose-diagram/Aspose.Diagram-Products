---
title: Konvertieren Sie VTX über Java in VSDM 
weight: 5290
url: /de/java/conversion/vtx-to-vsdm/ 
description: Beispiel-Umwandlungscode Java für das VTX-Format in eine VSDM-Datei. Verwenden Sie diesen Beispielcode, um VTX in VSDM in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VTX über Java in VSDM" h2="Exportieren Sie Microsoft Visio VTX mithilfe der nativen Java-Bibliothek nach VSDM." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX mit Java in VSDM" %}}

 Um VTX zu VSDM zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VTX in VSDM über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VTX-Dateien in nur wenigen Codezeilen problemlos in VSDM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSDM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VTX-zu-VSDM-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VTX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vtx");
// Speichern Sie VTX als VSDM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VTX-zu-VSDM-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VTX in VSDM](https://products.aspose.app/diagram/conversion/vtx-to-vsdm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
