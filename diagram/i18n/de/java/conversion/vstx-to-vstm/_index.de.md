---
title: Konvertieren Sie VSTX über Java in VSTM 
weight: 5150
url: /de/java/conversion/vstx-to-vstm/ 
description: Beispiel-Umwandlungscode Java für das VSTX-Format in die VSTM-Datei. Verwenden Sie diesen Beispielcode, um VSTX in VSTM in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTX über Java in VSTM" h2="Exportieren Sie Microsoft Visio VSTX nach VSTM unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTX in VSTM mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSTX-Dateien in nur wenigen Codezeilen problemlos in VSTM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die VSTX-Datei mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSTM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTX-zu-VSTM-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VSTX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vstx");
// Speichern Sie VSTX als VSTM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX-zu-VSTM-Konvertierungs-Live-Demos" sectionDescription="[Konvertieren Sie VSTX in VSTM](https://products.aspose.app/diagram/conversion/vstx-to-vstm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/java/conversion/vstx-to-vdx/" name="VSTX ZU VDX" description="Microsoft Visio-Zeichnungsformat" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/java/conversion/vstx-to-vsdm/" name="VSTX ZU VSDM" description="Microsoft Visio-Zeichnungsformat" >}}
