---
title: Konvertieren Sie VTX über Java in VSX 
weight: 3040
url: /de/java/conversion/vtx-to-vsx/ 
description: Beispiel-Umwandlungscode Java für das VTX-Format in die VSX-Datei. Verwenden Sie diesen Beispielcode, um VTX in VSX in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VTX über Java in VSX" h2="Exportieren Sie Microsoft Visio VTX mithilfe der nativen Java-Bibliothek nach VSX." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VTX mit Java in VSX" %}}

 Um VTX zu VSX zu rendern, verwenden wir
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VTX-Dateien in nur wenigen Codezeilen problemlos in VSX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VTX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VTX-zu-VSX-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VTX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vtx");
// Speichern Sie VTX als VSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VTX-zu-VSX-Konvertierungs-Live-Demos" sectionDescription="[Konvertieren Sie VTX in VSX](https://products.aspose.app/diagram/conversion/vtx-to-vsx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
