---
title: Konvertieren Sie VSTM in PDF über Java 
weight: 1670
url: /de/java/conversion/vstm-to-pdf/ 
description: Beispiel-Umwandlungscode Java für das VSTM-Format in eine PDF-Datei. Verwenden Sie diesen Beispielcode, um VSTM in einer beliebigen Web- oder Desktop-Java-basierten Anwendung in PDF zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTM in PDF über Java" h2="Exportieren Sie Microsoft Visio VSTM in PDF mithilfe der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTM in PDF mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSTM in PDF über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VSTM-Dateien in nur wenigen Codezeilen ganz einfach in PDF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die PDF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTM-zu-PDF-Java-Konvertierungsquellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos für die VSTM-zu-PDF-Konvertierung" sectionDescription="[Konvertieren Sie VSTM in PDF](https://products.aspose.app/diagram/conversion/vstm-to-pdf) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
