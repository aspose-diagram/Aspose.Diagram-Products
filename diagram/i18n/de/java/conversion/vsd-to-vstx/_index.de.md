---
title: Konvertieren Sie VSD über Java in VSTX 
weight: 940
url: /de/java/conversion/vsd-to-vstx/ 
description: Beispiel-Umwandlungscode Java für das Format VSD in eine VSTX-Datei. Verwenden Sie diesen Beispielcode, um VSD innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung in VSTX zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSD über Java in VSTX" h2="Exportieren Sie Microsoft Visio VSD mithilfe der nativen Java-Bibliothek nach VSTX." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSD mit Java in VSTX" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSD in VSTX über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können die VSD-Datei in nur wenigen Codezeilen ganz einfach in VSTX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die Datei VSD mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSTX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSD zu VSTX Java Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die VSD in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vsd");
// speichern Sie VSD als VSTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD zu VSTX-Konvertierungs-Live-Demos" sectionDescription="[Konvertieren Sie VSD in VSTX](https://products.aspose.app/diagram/conversion/vsd-to-vstx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
