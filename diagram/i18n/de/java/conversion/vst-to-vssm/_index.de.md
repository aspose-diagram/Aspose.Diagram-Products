...
description: Beispiel-Umwandlungscode Java für das VST-Format in die VSSM-Datei. Verwenden Sie diesen Beispielcode, um VST in VSSM in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VST in VSSM mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VST-Dateien in nur wenigen Codezeilen problemlos in VSSM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VST-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSSM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VST-zu-VSSM-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie die VST in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vst");
// Speichern Sie VST als VSSM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos für die VST-zu-VSSM-Konvertierung" sectionDescription="[Konvertieren Sie VST in VSSM](https://products.aspose.app/diagram/conversion/vst-to-vssm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
