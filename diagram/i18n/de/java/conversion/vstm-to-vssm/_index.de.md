---
title: Konvertieren Sie VSTM in VSSM über Java 
weight: 4370
url: /de/java/conversion/vstm-to-vssm/ 
description: Beispiel-Umwandlungscode Java für das VSTM-Format in die VSSM-Datei. Verwenden Sie diesen Beispielcode, um VSTM in VSSM in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTM in VSSM über Java" h2="Exportieren Sie Microsoft Visio VSTM nach VSSM unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTM in VSSM mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSTM in VSSM über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VSTM-Dateien in nur wenigen Codezeilen problemlos in VSSM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSSM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTM-zu-VSSM-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie das VSTM in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vstm");
// Speichern Sie VSTM als VSSM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos zur VSTM-zu-VSSM-Konvertierung" sectionDescription="[Konvertieren Sie VSTM in VSSM](https://products.aspose.app/diagram/conversion/vstm-to-vssm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
