---
title: Konvertieren Sie VSX in PDF über Java 
weight: 2950
url: /de/java/conversion/vsx-to-pdf/ 
description: Beispiel-Umwandlungscode Java für das VSX-Format in eine PDF-Datei. Verwenden Sie diesen Beispielcode, um VSX in einer beliebigen Web- oder Desktop Java-basierten Anwendung in PDF zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSX in PDF über Java" h2="Exportieren Sie Microsoft Visio VSX mithilfe der nativen Java-Bibliothek in PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX in PDF mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSX-Dateien mit nur wenigen Codezeilen ganz einfach in PDF konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die PDF-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSX-zu-PDF-Java-Konvertierungsquellcode" offSpacer="" %}}
