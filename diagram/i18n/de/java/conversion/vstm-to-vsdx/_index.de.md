---
title: Konvertieren Sie VSTM in VSDX über Java 
weight: 3670
url: /de/java/conversion/vstm-to-vsdx/ 
description: Beispiel-Umwandlungscode Java für das VSTM-Format in die Datei VSDX. Verwenden Sie diesen Beispielcode, um VSTM in VSDX innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTM in VSDX über Java" h2="Exportieren Sie Microsoft Visio VSTM nach VSDX unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTM mit Java in VSDX" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können die VSTM-Datei in nur wenigen Codezeilen problemlos in VSDX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. VSDX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTM zu VSDX Java Conversion-Quellcode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM zu VSDX Konvertierungs-Live-Demos" sectionDescription="[Konvertieren Sie VSTM in VSDX](https://products.aspose.app/diagram/conversion/vstm-to-vsdx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
