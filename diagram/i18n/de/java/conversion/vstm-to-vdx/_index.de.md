---
title: Konvertieren Sie VSTM in VDX über Java 
weight: 2440
url: /de/java/conversion/vstm-to-vdx/ 
description: Beispiel-Umwandlungscode Java für das VSTM-Format in eine VDX-Datei. Verwenden Sie diesen Beispielcode, um VSTM in VDX in jeder Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTM in VDX über Java" h2="Exportieren Sie Microsoft Visio VSTM nach VDX unter Verwendung der nativen Java-Bibliothek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSTM in VDX mit Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Schritte zum Konvertieren von VSTM in VDX über Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-Entwickler können VSTM-Dateien in nur wenigen Codezeilen problemlos in VDX konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VDX-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTM-zu-VDX-Java-Umwandlungsquellcode" offSpacer="" %}}

```cs
// Laden Sie das VSTM in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vstm");
// Speichern Sie VSTM als VDX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM-zu-VDX-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSTM in VDX](https://products.aspose.app/diagram/conversion/vstm-to-vdx) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
