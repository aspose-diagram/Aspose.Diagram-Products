---
title: Konvertieren Sie VSTX in VSDM über Java 
weight: 3350
url: /de/java/conversion/vstx-to-vsdm/ 
description: Beispiel-Umwandlungscode Java für das VSTX-Format in eine VSDM-Datei. Verwenden Sie diesen Beispielcode, um VSTX in VSDM in jeder Web- oder Desktop Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSTX in VSDM über Java" h2="Exportieren Sie Microsoft Visio VSTX mithilfe der nativen Java-Bibliothek nach VSDM." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSTX-Dateien in nur wenigen Codezeilen problemlos in VSDM konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. Laden Sie die VSTX-Datei mit einer Instanz der Klasse Diagram1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die VSDM-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSTX-zu-VSDM-Java-Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VSTX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vstx");
// Speichern Sie VSTX als VSDM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX-zu-VSDM-Konvertierung Live-Demos" sectionDescription="[Konvertieren Sie VSTX in VSDM](https://products.aspose.app/diagram/conversion/vstx-to-vsdm) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
