---
title: Konvertieren Sie VSX in PNG über Java 
weight: 1430
url: /de/java/conversion/vsx-to-png/ 
description: Beispiel-Umwandlungscode Java für das VSX-Format in eine PNG-Datei. Verwenden Sie diesen Beispielcode, um VSX in PNG innerhalb einer beliebigen Web- oder Desktop-Java-basierten Anwendung zu konvertieren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertieren Sie VSX in PNG über Java" h2="Exportieren Sie Microsoft Visio VSX mithilfe der nativen Java-Bibliothek in PNG." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="So konvertieren Sie VSX in PNG mit Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-Entwickler können VSX-Dateien in nur wenigen Codezeilen ganz einfach in PNG konvertieren.

{{% /blocks/products/pf/agp/text %}}

1. VSX-Datei mit einer Instanz der Klasse Diagram laden1. Rufen Sie die Methode Diagram.save mit dem Ausgabedateipfad und SaveFileFormat als Parameter auf1. Die PNG-Datei wird unter dem angegebenen Pfad gespeichert
...
{{% blocks/products/pf/agp/code-block title="VSX-zu-PNG-Java-Konvertierungsquellcode" offSpacer="" %}}

```cs
// Laden Sie den VSX in ein Objekt von Diagram 
Diagram visio = new Diagram("template.vsx");
// Speichern Sie VSX als PNG 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Live-Demos für die VSX-zu-PNG-Konvertierung" sectionDescription="[Konvertieren Sie VSX in PNG](https://products.aspose.app/diagram/conversion/vsx-to-png) jetzt, indem Sie unsere Live-Demo-Website besuchen. Die Live-Demo hat die folgenden Vorteile" >}}
