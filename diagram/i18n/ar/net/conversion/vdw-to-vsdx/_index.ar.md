---
title: تحويل VDW إلى VSDX عبر C# 
weight: 3900
url: /ar/net/conversion/vdw-to-vsdx/ 
description: نموذج رمز لتحويل VDW إلى VSDX C#. استخدم API رمز المثال لملفات VDW المجمعة VSDX للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VDW إلى VSDX عبر C#" h2="قم بتصدير ملفات Microsoft® Visio VDW إلى VSDX في .NET Framework ، .NET Core ، Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VDW إلى VSDX استخدام C#" %}}

 من أجل تحويل VDW إلى VSDX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VDW إلى VSDX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VDW بسهولة إلى VSDX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VDW بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat. VSDX كمعلمات1. سيتم حفظ ملف VSDX في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VDW إلى VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VDW إلى VSDX" sectionDescription="تحقق من العروض الحية لدينا ل [VDW لتحويل VSDX](https://products.aspose.app/diagram/conversion/vdw-to-vsdx) مع الفوائد التالية." >}}
