...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSTX إلى VSDX استخدام C#" %}}

 من أجل تحويل VSTX إلى VSDX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSTX إلى VSDX عبر C#" %}}
...
1. قم بتحميل ملف VSTX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat. VSDX كمعلمات1. سيتم حفظ ملف VSDX في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VSTX إلى VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSTX إلى VSDX" sectionDescription="تحقق من العروض الحية لدينا ل [تحويل VSTX إلى VSDX](https://products.aspose.app/diagram/conversion/vstx-to-vsdx) مع الفوائد التالية." >}}
