...
description: نموذج كود لتحويل VDW إلى VSX C#. استخدم API رمز المثال لملفات VDW المجمعة لتحويل VSX داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VDW إلى VSX باستخدام C#" %}}
