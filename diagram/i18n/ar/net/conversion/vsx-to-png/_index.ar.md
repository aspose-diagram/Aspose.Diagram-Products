...
description: نموذج كود لتحويل VSX إلى PNG C#. استخدم API رمز المثال لملفات VSX المجمعة لتحويل PNG داخل VB .NET أو Asp .NET أو أي تطبيق يعتمد على .NET.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSX إلى PNG باستخدام C#" %}}
 ...
 من أجل تحويل VSX إلى PNG ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوّري برامج .NET تحميل ملفات VSX وتحويلها بسهولة إلى PNG في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.PNG كمعلمات1. سيتم حفظ ملف PNG في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VSX إلى PNG C#" offSpacer="" %}}
