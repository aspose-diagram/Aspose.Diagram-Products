...
description: نموذج رمز لتحويل C# VSX إلى PDF. استخدم API مثال الكود لتحويل ملفات VSX المجمعة إلى PDF داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSX إلى PDF عبر C#" h2="قم بتصدير ملفات Microsoft® Visio VSX إلى PDF على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSX إلى PDF باستخدام C#" %}}
 ...
 من أجل تحويل VSX إلى PDF ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوّري برامج .NET تحميل ملفات VSX وتحويلها بسهولة إلى PDF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.PDF كمعلمات1. سيتم حفظ ملف PDF في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VSX إلى PDF C#" offSpacer="" %}}
