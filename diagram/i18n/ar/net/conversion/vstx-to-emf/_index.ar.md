...
description: نموذج كود لتحويل VSTX إلى EMF C#. استخدم API رمز المثال لملفات VSTX المجمعة لتحويل EMF داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSTX إلى EMF عبر C#" %}}
...
1. قم بتحميل ملف VSTX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.EMF كمعلمات1. سيتم حفظ ملف EMF في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VSTX إلى EMF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSTX إلى EMF" sectionDescription="تحقق من العروض الحية لدينا ل [تحويل VSTX إلى EMF](https://products.aspose.app/diagram/conversion/vstx-to-emf) مع الفوائد التالية." >}}
