---
title: تحويل VDW إلى TIFF عبر C# 
weight: 2010
url: /ar/net/conversion/vdw-to-tiff/ 
description: نموذج كود لتحويل VDW إلى TIFF C#. استخدم API رمز المثال لملفات VDW المجمعة لتحويل TIFF داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VDW إلى TIFF عبر C#" h2="قم بتصدير ملفات Microsoft® Visio VDW إلى TIFF على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VDW إلى TIFF باستخدام C#" %}}

 من أجل تحويل VDW إلى TIFF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VDW إلى TIFF عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج .NET تحميل وتحويل ملفات VDW إلى TIFF بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VDW بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.TIFF كمعلمات1. سيتم حفظ ملف TIFF في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية هذا تحويل VDW إلى TIFF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VDW إلى TIFF" sectionDescription="تحقق من العروض الحية لدينا ل [تحويل VDW إلى TIFF](https://products.aspose.app/diagram/conversion/vdw-to-tiff) مع الفوائد التالية." >}}
