...
description: نموذج كود لتحويل VSTX إلى XPS C#. استخدم API رمز المثال لملفات VSTX المجمعة لتحويل XPS داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSTX إلى XPS باستخدام C#" %}}
 ...
 من أجل تحويل VSTX إلى XPS ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري .NET تحميل ملفات VSTX وتحويلها بسهولة إلى XPS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSTX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.XPS كمعلمات1. سيتم حفظ ملف XPS في المسار المحدد
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSTX إلى XPS" sectionDescription="تحقق من العروض الحية لدينا ل [تحويل VSTX إلى XPS](https://products.aspose.app/diagram/conversion/vstx-to-xps) مع الفوائد التالية." >}}
