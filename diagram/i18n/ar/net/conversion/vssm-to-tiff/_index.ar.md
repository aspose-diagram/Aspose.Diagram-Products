...
description: نموذج كود لتحويل VSSM إلى TIFF C#. استخدم API رمز المثال لملفات VSSM المجمعة لتحويل TIFF داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSSM إلى TIFF باستخدام C#" %}}
 ...
 من أجل تحويل VSSM إلى TIFF ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري .NET تحميل ملفات VSSM وتحويلها بسهولة إلى TIFF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSSM بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.TIFF كمعلمات1. سيتم حفظ ملف TIFF في المسار المحدد
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSSM إلى TIFF" sectionDescription="تحقق من العروض الحية لدينا ل [تحويل VSSM إلى TIFF](https://products.aspose.app/diagram/conversion/vssm-to-tiff) مع الفوائد التالية." >}}
