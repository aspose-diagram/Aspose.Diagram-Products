...
description: نموذج كود لتحويل VSX إلى VSDM C#. استخدم API رمز المثال لملفات VSX المجمعة لتحويل VSDM داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSX إلى VSDM عبر C#" h2="قم بتصدير ملفات Microsoft® Visio VSX إلى VSDM على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSX إلى VSDM باستخدام C#" %}}
 ...
 من أجل تحويل VSX إلى VSDM ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSX إلى VSDM عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل ملفات VSX وتحويلها بسهولة إلى VSDM في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.VSDM كمعلمات1. سيتم حفظ ملف VSDM في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VSX إلى VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSX إلى VSDM" sectionDescription="تحقق من العروض الحية لدينا ل [تحويل VSX إلى VSDM](https://products.aspose.app/diagram/conversion/vsx-to-vsdm) مع الفوائد التالية." >}}
