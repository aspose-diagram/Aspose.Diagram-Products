...
description: نموذج كود لتحويل VSX إلى VSSX C#. استخدم API رمز المثال لملفات VSX المجمعة لتحويل VSSX داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSX إلى VSSX عبر C#" h2="قم بتصدير ملفات Microsoft® Visio VSX إلى VSSX على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSX إلى VSSX باستخدام C#" %}}
 ...
 من أجل تحويل VSX إلى VSSX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSX إلى VSSX عبر C#" %}}
...
1. قم بتحميل ملف VSX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.VSSX كمعلمات1. سيتم حفظ ملف VSSX في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VSX إلى VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSX إلى VSSX" sectionDescription="تحقق من العروض الحية لدينا ل [تحويل VSX إلى VSSX](https://products.aspose.app/diagram/conversion/vsx-to-vssx) مع الفوائد التالية." >}}
