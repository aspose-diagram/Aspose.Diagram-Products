---
title: إنشاء مخطط هيكلي في مستند VSS عبر .NET 
weight: 3050
url: /ar/net/organizationchart/vss/ 
description: C# كود المصدر لإنشاء مخطط هيكلي في ملف vss على .NET Framework ، .NET Core ، Mono الأنظمة الأساسية.
---
...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء مخطط هيكلي في ملف VSS باستخدام C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء مخطط هيكلي في ملفات VSS في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="إنشاء مخطط هيكلي في ملفات VSS - C#" offSpacer="" %}}
