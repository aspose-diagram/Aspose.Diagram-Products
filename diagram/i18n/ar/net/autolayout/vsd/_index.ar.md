---
title: مستند تخطيط تلقائي VSD عبر .NET 
weight: 3050
url: /ar/net/autolayout/vsd/ 
description: C# شفرة المصدر لملف vsd للتنسيق التلقائي على الأنظمة الأساسية .NET .NET الأساسية Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="مستند التخطيط التلقائي VSD باللغة C#" h2="مستند بتنسيق تلقائي أصلي وعالي الأداء VSD باستخدام واجهات برمجة تطبيقات Aspose.Diagram for .NET من جانب الخادم ، بدون استخدام أي برامج مثل Microsoft أو Open Office أو Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية التخطيط التلقائي VSD للملف باستخدام C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ملفات التخطيط التلقائي VSD في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ملفات VSD التخطيط التلقائي - C#" offSpacer="" %}}
