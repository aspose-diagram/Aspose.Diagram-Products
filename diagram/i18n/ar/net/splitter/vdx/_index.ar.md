---
title: تقسيم ملفات VDX عبر .NET 
weight: 1300
url: /ar/net/splitter/vdx/ 
description: C# شفرة المصدر لملف Split vdx على .NET Framework ، .NET Core ، Mono الأنظمة الأساسية.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تقسيم VDX في C#" h2="مقسم مستندات VDX أصلي وعالي الأداء باستخدام واجهات برمجة تطبيقات Aspose.Diagram for .NET من جانب الخادم ، بدون استخدام أي برامج مثل Microsoft أو Open Office أو Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تقسيم ملف VDX باستخدام C#" %}}

 من أجل تقسيم ملف VDX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تقسيم ملفات VDX بتنسيق C#" %}}
...
{{% blocks/products/pf/agp/code-block title="تقسيم ملفات VDX - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram هو أحد Visio تنسيق مستندات Microsoft API. يمكن للمرء بسهولة تحميل وإنشاء وتعديل ومعالجة بما في ذلك عناصر daigram وتحويل المخططات Visio إلى تنسيقات أخرى مثل PDF و XPS و JPEG و PNG و BMP و TIFF و SVG و EMF والمزيد. إنه API مستقل ولا يتطلب تثبيت Microsoft Visio أو أي برامج أخرى.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="العروض التوضيحية المباشرة لـ VDX Split Live عبر الإنترنت" sectionDescription="انقسام مستندات VDX الآن من خلال زيارة موقعنا [موقع تجريبي مباشر](https://products.aspose.app/diagram/splitter). يحتوي العرض التوضيحي المباشر على الفوائد التالية" >}}
