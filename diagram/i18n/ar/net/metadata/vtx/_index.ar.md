---
title: عرض أو تحرير البيانات الوصفية لملفات VTX عبر .NET 
weight: 3050
url: /ar/net/metadata/vtx/ 
description: C# شفرة المصدر لتعديل أو عرض البيانات الوصفية بتنسيق VTX على الأنظمة الأساسية .NET ، .NET الأساسية ، Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="استخراج بيانات VTX الوصفية في C#" h2="أنشئ تطبيقاتك البالغ عددها .NET لإضافة أو تعديل أو إزالة أو استخراج البيانات الوصفية من ملفات VTX باستخدام واجهات برمجة التطبيقات من جانب الخادم." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية استخراج بيانات VSX الوصفية باستخدام C#" %}}
 ...
 من أجل استخراج البيانات الوصفية لـ VTX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات استخراج البيانات الوصفية لـ VTX في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="استخراج البيانات الوصفية لـ VTX - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram هو أحد Visio تنسيق مستندات Microsoft API. يمكن للمرء بسهولة تحميل وإنشاء وتعديل ومعالجة بما في ذلك عناصر daigram وتحويل المخططات Visio إلى تنسيقات أخرى مثل PDF و XPS و JPEG و PNG و BMP و TIFF و SVG و EMF والمزيد. إنه API مستقل ولا يتطلب تثبيت Microsoft Visio أو أي برامج أخرى.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="استخراج البيانات الوصفية لـ VTX عبر تطبيق عبر الإنترنت" sectionDescription="عرض وتحرير البيانات الوصفية لمستندات VTX من خلال زيارة موقعنا [موقع تجريبي مباشر](https://products.aspose.app/diagram/metadata). يحتوي العرض التوضيحي المباشر على الفوائد التالية" >}}
