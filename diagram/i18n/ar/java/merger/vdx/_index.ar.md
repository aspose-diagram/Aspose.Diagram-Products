...
+ قم بتحميل مستند VDX الثاني بنسخة من فئة Diagram.
+ دمج الملفات باستخدام طريقة ().
+ احفظ ملف VDX المدمج في المسار المحدد
