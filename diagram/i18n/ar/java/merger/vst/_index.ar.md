...
{{% blocks/products/pf/agp/content h2="كيفية دمج ملفات VST باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات دمج ملفات VST في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="دمج ملفات VST - Java" offSpacer="" %}}
