...
{{% blocks/products/pf/agp/content h2="كيفية دمج ملفات VSS باستخدام Java" %}}

 لدمج ملف VSS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات دمج ملفات VSS في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="دمج ملفات VSS - Java" offSpacer="" %}}
