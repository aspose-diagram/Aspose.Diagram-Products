...
description: نموذج رمز تحويل Java لتنسيق VSX إلى ملف BMP. استخدم رمز المثال هذا لتحويل VSX إلى BMP داخل أي تطبيق يعتمد على الويب أو سطح المكتب Java.
---
...
1. قم بتحميل ملف VSX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat كمعلمات1. سيتم حفظ ملف BMP في المسار المحدد
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل VSX إلى BMP" sectionDescription="[تحويل VSX إلى BMP](https://products.aspose.app/diagram/conversion/vsx-to-bmp) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
