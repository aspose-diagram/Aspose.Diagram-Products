...
description: نموذج رمز تحويل Java لتنسيق VSTM إلى ملف VSDX. استخدم رمز المثال هذا لتحويل VSTM إلى VSDX داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSTM إلى VSDX استخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSTM إلى VSDX عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java تحويل ملف VSTM بسهولة إلى VSDX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSTM بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat كمعلمات1. سيتم حفظ ملف VSDX في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="VSTM إلى شفرة مصدر التحويل VSDX Java" offSpacer="" %}}
