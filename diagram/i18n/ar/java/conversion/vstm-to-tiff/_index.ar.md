...
description: نموذج رمز تحويل Java لتنسيق VSTM إلى ملف TIFF. استخدم رمز المثال هذا لتحويل VSTM إلى TIFF داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري Java بسهولة تحويل ملف VSTM إلى TIFF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSTM بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat كمعلمات1. سيتم حفظ ملف TIFF في المسار المحدد
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل VSTM إلى TIFF" sectionDescription="[تحويل VSTM إلى TIFF](https://products.aspose.app/diagram/conversion/vstm-to-tiff) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
