---
title: تحويل VSTM إلى SVG عبر Java 
weight: 3540
url: /ar/java/conversion/vstm-to-svg/ 
description: نموذج Java رمز تحويل لتنسيق VSTM إلى ملف SVG. استخدم رمز المثال هذا لتحويل VSTM إلى SVG داخل أي تطبيق يعتمد على الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSTM إلى SVG عبر Java" %}}
...
1. قم بتحميل ملف VSTM بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat كمعلمات1. سيتم حفظ ملف SVG في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="VSTM إلى شفرة مصدر التحويل SVG Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل VSTM إلى SVG" sectionDescription="[تحويل VSTM إلى SVG](https://products.aspose.app/diagram/conversion/vstm-to-svg) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
