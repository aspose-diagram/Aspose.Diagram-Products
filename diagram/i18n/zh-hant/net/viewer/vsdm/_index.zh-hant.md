...
{{% blocks/products/pf/agp/code-block title="C# 代碼查看 VSDM" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram 是 Microsoft Visio 文檔格式操作 API。您可以輕鬆加載、創建、修改、操作包括圖形元素在內的 Visio 圖表轉換為其他格式，例如 PDF、XPS、JPEG、PNG、BMP、TIFF、SVG、EMF 等。它是獨立的 API，不需要安裝 Microsoft Visio 或任何其他軟件。  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="用於查看 VSDM 的免費應用程序" sectionDescription="查看我們的現場演示 [查看 VSDM](https://products.aspose.app/diagram/viewer/vsdm) 具有以下好處。" >}}
