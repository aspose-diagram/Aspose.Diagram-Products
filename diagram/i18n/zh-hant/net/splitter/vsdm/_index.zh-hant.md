...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中拆分 VSDM 文件的步驟" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram 是 Microsoft Visio 文檔格式操作 API。您可以輕鬆加載、創建、修改、操作包括圖形元素在內的 Visio 圖表轉換為其他格式，例如 PDF、XPS、JPEG、PNG、BMP、TIFF、SVG、EMF 等。它是獨立的 API，不需要安裝 Microsoft Visio 或任何其他軟件。  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="在線 VSDM 拆分現場演示" sectionDescription="立即訪問我們的拆分 VSDM 文檔 [現場演示網站](https://products.aspose.app/diagram/splitter).現場演示有以下好處" >}}
