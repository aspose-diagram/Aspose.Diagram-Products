---
title: 通過 C# 將 VDW 轉換為 XPS 
weight: 4390
url: /zh-hant/net/conversion/vdw-to-xps/ 
description: VDW 到 XPS C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 VDW 文件批量轉換為 XPS。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 VDW 轉換為 XPS" h2="將 Microsoft® Visio VDW 文件導出到 .NET Framework、.NET Core、Mono 或 COM Interop 上的 XPS。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 將 VDW 轉換為 XPS" %}}

 為了將 VDW 轉換為 XPS，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 將 VDW 轉換為 XPS 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 開發人員只需幾行代碼即可輕鬆加載 VDW 文件並將其轉換為 XPS。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Diagram 類的實例加載 VDW 文件1. 以輸出文件路徑和 SaveFileFormat.XPS 作為參數調用 Diagram.Save 方法1. XPS文件將保存在指定路徑
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 VDW 到 XPS C# 的轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="將 VDW 轉換為 XPS 的免費應用程序" sectionDescription="查看我們的現場演示 [VDW 到 XPS 的轉換](https://products.aspose.app/diagram/conversion/vdw-to-xps) 具有以下好處。" >}}
