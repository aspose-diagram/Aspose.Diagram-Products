...
1. 使用 Diagram 類的實例加載 VSTM 文件1. 以輸出文件路徑和 SaveFileFormat.VSTM 作為參數調用 Diagram.Save 方法1. VSTM 文件將保存在指定路徑
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 VSTM 到 VSTM C# 的轉換" offSpacer="" %}}
