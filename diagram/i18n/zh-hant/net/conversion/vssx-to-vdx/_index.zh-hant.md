...
1. 使用 Diagram 類的實例加載 VSSX 文件1. 使用輸出文件路徑和 SaveFileFormat.VDX 作為參數調用 Diagram.Save 方法1. VDX文件將保存在指定路徑
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 VSSX 到 VDX C# 的轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="將 VSSX 轉換為 VDX 的免費應用程序" sectionDescription="查看我們的現場演示 [VSSX 到 VDX 轉換](https://products.aspose.app/diagram/conversion/vssx-to-vdx) 具有以下好處。" >}}
