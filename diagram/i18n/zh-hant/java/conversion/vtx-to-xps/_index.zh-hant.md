---
title: 通過 Java 將 VTX 轉換為 XPS 
weight: 2980
url: /zh-hant/java/conversion/vtx-to-xps/ 
description: VTX 格式到 XPS 文件的示例 Java 轉換代碼。使用此示例代碼在任何基於 Web 或桌面 Java 的應用程序中將 VTX 轉換為 XPS。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 VTX 轉換為 XPS" h2="使用本機 Java 庫將 Microsoft Visio VTX 導出到 XPS。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 VTX 轉換為 XPS" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 VTX 轉換為 XPS 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 VTX 文件轉換為 XPS。
...
{{% blocks/products/pf/agp/code-block title="VTX 到 XPS Java 轉換源代碼" offSpacer="" %}}
