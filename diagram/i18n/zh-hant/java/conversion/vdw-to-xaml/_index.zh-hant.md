...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 VDW 轉換為 XAML" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 VDW 轉換為 XAML 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 VDW 文件轉換為 XAML。
...
{{% blocks/products/pf/agp/code-block title="VDW 到 XAML Java 轉換源代碼" offSpacer="" %}}
