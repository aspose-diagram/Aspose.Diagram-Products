---
title: 通過 Java 將 VSDM 轉換為 VSX 
weight: 1610
url: /zh-hant/java/conversion/vsdm-to-vsx/ 
description: VSDM 格式到 VSX 文件的示例 Java 轉換代碼。使用此示例代碼在任何基於 Web 或桌面 Java 的應用程序中將 VSDM 轉換為 VSX。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 VSDM 轉換為 VSX" h2="使用本機 Java 庫將 Microsoft Visio VSDM 導出到 VSX。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 VSDM 轉換為 VSX" %}}

 為了將 VSDM 渲染到 VSX，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 VSDM 轉換為 VSX 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 VSDM 文件轉換為 VSX。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Diagram 類的實例加載 VSDM 文件1. 以輸出文件路徑和 SaveFileFormat 作為參數調用 Diagram.save 方法1. VSX 文件將保存在指定路徑
...
{{% blocks/products/pf/agp/code-block title="VSDM 到 VSX Java 轉換源代碼" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDM 到 VSX 轉換現場演示" sectionDescription="[將 VSDM 轉換為 VSX](https://products.aspose.app/diagram/conversion/vsdm-to-vsx) 立即訪問我們的現場演示網站。現場演示具有以下好處" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" 無需下載 Aspose API。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" 無需編寫任何代碼。" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上傳您的 VSDM 文件，它就會立即轉換為 VSX。" >}}
