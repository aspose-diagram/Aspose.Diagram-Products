...
description: Mintakód a VSDM–VSTM C# konverzióhoz. Használjon API példakódot a VSDM-fájlok kötegelt konvertálásához VB.NET-on, Asp-n.NET vagy bármely .NET-alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDM konvertálása VSTM-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSDM fájlokat VSTM-be a .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="A VSDM konvertálása VSTM-re a következővel: C#" %}}

 A VSDM VSTM-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="VSDM VSTM-vé konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET fejlesztői könnyedén betölthetik és konvertálhatják a VSDM fájlokat VSTM-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSDM-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.VSTM paraméterrel1. A VSTM fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSDM-ből VSTM-be való C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSDM konvertálásához VSTM-mé" sectionDescription="Tekintse meg élő bemutatóinkat [VSDM konvertálás VSTM-be](https://products.aspose.app/diagram/conversion/vsdm-to-vstm) a következő előnyökkel." >}}
