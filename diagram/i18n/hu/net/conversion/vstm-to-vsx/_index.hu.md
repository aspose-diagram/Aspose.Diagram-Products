---
title: "VSTM konvertálása VSX-re a következőn keresztül: C# "
weight: 2770
url: /hu/net/conversion/vstm-to-vsx/ 
description: Mintakód a VSTM–VSX C# konverzióhoz. Használjon API példakódot a VSTM-fájlok kötegelt konvertálásához VSX-vé VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM konvertálása VSX-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSTM fájlokat VSX-be .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="A VSTM konvertálása VSX-re a következővel: C#" %}}

 A VSTM VSX-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSTM konvertálása VSX-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET fejlesztői egyszerűen, néhány sornyi kóddal tölthetik be és konvertálhatják a VSTM fájlokat VSX-re.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.VSX paraméterrel1. A VSX fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSTM-ből VSX-be való C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSTM konvertálásához VSX-be" sectionDescription="Tekintse meg élő bemutatóinkat [VSTM konvertálás VSX-be](https://products.aspose.app/diagram/conversion/vstm-to-vsx) a következő előnyökkel." >}}
