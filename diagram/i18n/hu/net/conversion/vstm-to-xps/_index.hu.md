---
title: "VSTM konvertálása XPS-re a következőn keresztül: C# "
weight: 2620
url: /hu/net/conversion/vstm-to-xps/ 
description: Mintakód a VSTM-ből XPS-be C# konverzióhoz. Használjon API példakódot a VSTM-fájlok kötegelt XPS-konverziójához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM konvertálása XPS-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSTM fájlokat XPS-be .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="VSTM konvertálása XPS-re a következővel: C#" %}}

 A VSTM XPS-re konvertálásához használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSTM XPS-re konvertálásának lépései a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 A .NET fejlesztői könnyedén betölthetik és konvertálhatják a VSTM-fájlokat XPS-re, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSTM-fájl betöltése a(z) Diagram osztály egy példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormat.XPS paraméterrel1. Az XPS fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód a VSTM-ből XPS-be való C# konverziót mutatja" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a VSTM XPS-re konvertálásához" sectionDescription="Tekintse meg élő bemutatóinkat [VSTM konvertálás XPS-re](https://products.aspose.app/diagram/conversion/vstm-to-xps) a következő előnyökkel." >}}
