---
title: "VSD konvertálása VSDX-re a következőn keresztül: C# "
weight: 890
url: /hu/net/conversion/vsd-to-vsdx/ 
description: Mintakód a(z) VSD–VSDX C# konverzióhoz. Használjon API példakódot a kötegelt VSD fájlok VSDX konvertálásához VB.NET, Asp.NET vagy bármely .NET alapú alkalmazáson belül.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSD konvertálása VSDX-re a következőn keresztül: C#" h2="Exportáljon Microsoft® Visio VSD fájlokat a VSDX alkalmazásba .NET Framework, .NET Core, Mono vagy COM Interop rendszeren." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="VSD konvertálása VSDX-re a C# használatával" %}}

 A(z) VSD VSDX-re konvertálásához a következőt használjuk:
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a(z) VSD konvertálásához VSDX-re a következőn keresztül: C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET fejlesztői egyszerűen betölthetnek és konvertálhatnak VSD fájlt VSDX formátumba, mindössze néhány sornyi kóddal.

{{% /blocks/products/pf/agp/text %}}

1. VSD fájl betöltése Diagram osztály példányával1. Hívja meg a Diagram.Save metódust a kimeneti fájl elérési útjával és a SaveFileFormatVSDX paraméterrel1. VSDX fájl a megadott elérési útra kerül mentésre
...
{{% blocks/products/pf/agp/code-block title="Ez a mintakód VSD–VSDX C# konverziót mutat" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Ingyenes alkalmazás a(z) VSD konvertálásához VSDX-re" sectionDescription="Tekintse meg élő bemutatóinkat [VSD–VSDX konverzió](https://products.aspose.app/diagram/conversion/vsd-to-vsdx) a következő előnyökkel." >}}
