---
title: "VSDM-fájlok felosztása a következőn keresztül: .NET "
weight: 1300
url: /hu/net/splitter/vsdm/ 
description: C# forráskód Split vsdm fájlba .NET Framework, .NET Core, Mono Platforms rendszeren.
---
...
{{% blocks/products/pf/agp/content h2="VSDM-fájl felosztása a következővel: C#" %}}

 A VSDM fájl tömörítéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSDM-fájlok felosztásának lépései itt: C#" %}}
...
+ Töltse be a VSDM fájlt a teljes elérési úttal a felosztáshoz.
...
{{% blocks/products/pf/agp/code-block title="VSDM-fájlok felosztása – C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram egy Microsoft Visio dokumentumformátum-manipuláció API. Könnyedén betölthető, létrehozható, módosítható, manipulálható, beleértve a daigram elemeket, és konvertálható a Visio diagramok más formátumokba, mint például PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF stb. Ez egy önálló API, és nem szükséges Microsoft Visio vagy más szoftver telepítése.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VSDM Split élő demók" sectionDescription="Ossza meg a VSDM dokumentumokat most, látogassa meg webhelyünket [Élő bemutatók weboldala](https://products.aspose.app/diagram/splitter). Az élő demónak a következő előnyei vannak" >}}
