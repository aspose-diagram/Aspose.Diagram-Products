---
title: "VSSM-fájlok felosztása a következőn keresztül: .NET "
weight: 1300
url: /hu/net/splitter/vssm/ 
description: C# forráskód Split vssm fájlba .NET Framework, .NET Core, Mono Platforms rendszeren.
---
...
{{% blocks/products/pf/agp/content h2="VSSM-fájl felosztása a következővel: C#" %}}

 A VSSM fájl tömörítéséhez használjuk
...
{{% blocks/products/pf/agp/feature-section-col title="A VSSM-fájlok felosztásának lépései a következőben: C#" %}}
...
+ Töltse be a VSSM fájlt a teljes elérési úttal a felosztáshoz.
...
{{% blocks/products/pf/agp/code-block title="VSSM-fájlok felosztása – C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram egy Microsoft Visio dokumentumformátum-manipuláció API. Könnyedén betölthető, létrehozható, módosítható, manipulálható, beleértve a daigram elemeket, és konvertálható a Visio diagramok más formátumokba, mint például PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF stb. Ez egy önálló API, és nem szükséges Microsoft Visio vagy más szoftver telepítése.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VSSM Split élő demók" sectionDescription="Ossza meg a VSSM dokumentumokat most, látogassa meg webhelyünket [Élő bemutatók weboldala](https://products.aspose.app/diagram/splitter). Az élő demónak a következő előnyei vannak" >}}
