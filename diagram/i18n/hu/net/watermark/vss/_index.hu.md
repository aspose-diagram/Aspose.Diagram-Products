---
title: "Vízjel VSS-dokumentum a következőn keresztül: .NET "
weight: 3050
url: /hu/net/watermark/vss/ 
description: C# forráskód vízjel hozzáadásához a vss fájlhoz .NET Framework, .NET Core, Mono Platforms rendszeren.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Szöveges vízjel hozzáadása a VSS-hez itt: C#" h2="Natív és nagy teljesítményű VSS-dokumentum vízjel szerveroldali Aspose.Diagram for .NET API-kkal, olyan szoftverek használata nélkül, mint a Microsoft vagy az Open Office, az Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="VSS-fájl vízjelezése a következővel: C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A VSS-fájlok vízjelezésének lépései itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vízjel VSS-fájlok – C#" offSpacer="" %}}
