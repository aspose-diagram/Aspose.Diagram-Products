---
title: "VSDX dokumentum tömörítése a következőn keresztül: .NET "
weight: 3050
url: /hu/net/compress/vsdx/ 
description: C# forráskód a vsdx fájl tömörítéséhez .NET Framework, .NET Core, Mono Platformokon.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDX tömörítése itt: C#" h2="Natív és nagy teljesítményű VSDX dokumentumtömörítő szerveroldali Aspose.Diagram for .NET API-kkal, olyan szoftverek használata nélkül, mint a Microsoft vagy az Open Office, az Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="A VSDX fájl tömörítése a C# használatával" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Lépések a VSDX fájlok tömörítéséhez itt: C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX fájl tömörítése - C#" offSpacer="" %}}
