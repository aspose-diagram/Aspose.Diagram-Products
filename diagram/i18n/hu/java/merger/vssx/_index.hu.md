---
title: "VSSX fájlok egyesítése a következőn keresztül: Java "
weight: 2720
url: /hu/java/merger/vssx/ 
description: Java mintakód a VSSX dokumentumok kombinálásához a Java Runtime Environment for JSP/JSF alkalmazásokhoz és asztali alkalmazásokhoz.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX formátumok egyesítése itt: Java" h2="Natív VSSX-dokumentum-egyesítés szerveroldali Java API-kkal." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="VSSX fájlok egyesítése a következővel: Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="A VSSX fájlok egyesítésének lépései a következőben: Java" %}}
...
+ Töltse be az első VSSX-fájlt a Diagram osztály példányával.
+ Töltse be a második VSSX-dokumentumot a Diagram osztály példányával.
+ Fájlok egyesítése a combin() metódussal.
+ mentse az egyesített VSSX fájlt a megadott elérési úton
...
{{% blocks/products/pf/agp/code-block title="VSSX fájlok egyesítése – Java" offSpacer="" %}}
