...
weight: 1630
url: /fr/nodejs-java/ 
description: Aspose.Diagram pour Node.js via Java est un visio javascript API pour lire, écrire et convertir des documents Microsoft Visio comme VSDX, VDX et d'autres formats
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js Visio Fichiers API" h2="Créez, lisez, écrivez et exportez des formats Microsoft Visio, notamment VSDX, VDX, VSX, VTX et d\'autres formats à l\'aide de Node.js API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/headers/aspose_diagram-for-nodejs-java.svg" pfName="Aspose.Diagram " subTitlepfName="for Node.js via Java" downloadUrl="https://downloads.aspose.com/diagram/nodejs" >}}
...
<p>
 Aspose.Diagram pour Node.js via Java est une solution de manipulation de documents Microsoft Visio. On peut lire, écrire, protéger, exporter et imprimer des formats natifs Visio et prendre en charge certains formats d'image et de mise en page fixes couramment utilisés. Il est facile de charger des fichiers existants, de modifier les éléments du diagramme à exporter dans le format souhaité, y compris des images ou des formats à mise en page fixe tels que PDF ou XPS.
</p>

<p>
 Aspose.Diagram pour Node.js via Java est un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel. De plus, peu de tâches que l'on peut effectuer facilement comme créer des diagrammes à partir de zéro, lire ou écrire divers formats, accéder et lire les propriétés, y compris les formules d'objet Visio, exporter des diagrammes vers plusieurs formats, imprimer des diagrammes avec une haute fidélité, et bien plus encore.
</p>
...
{{< blocks/products/pf/carousel-item h3="En bref" description="Un aperçu de Aspose.Diagram pour Node.js via les capacités de Java." >}}
 ...
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    ...
    <li>
     Accéder et lire les propriétés
    </li>
   </ul>
  </div>
  <!--/left-->
...
{{< blocks/products/pf/carousel-item h3="Indépendance de la plate-forme" description="Aspose.Diagram pour Node.js via Java est du JavaScript côté serveur API basé sur Node.js. Il peut fonctionner sur les plates-formes Windows, Unix/Linux et Mac avec JDK 1.6 ou supérieur." >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Formats de fichiers pris en charge" description="Aspose.Diagram pour Node.js via Java prend en charge les formats Microsoft Visio populaires et plus encore." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Fonctionnalités avancées de Node.js Visio API
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Créer Visio documents à partir de zéro
    </h2>
    <p>
     Aspose.Diagram pour Node.js est simple et facile à utiliser. Il permet aux utilisateurs de travailler avec des diagrammes sans aucune compréhension du format sous-jacent, comme on peut créer des fichiers VSDX à partir de zéro avec seulement quelques lignes de code.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Créer le format VSDX à partir de zéro en utilisant Node.js
     </h3>
...
diagram.save("output.vsdx", aspose.diagram.SaveFileFormat.VSDX);</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Le diagramme Node.js API permet de lire les formats Microsoft Visio natifs et de fournir un accès aux données du diagramme telles que document, page, maître, forme, feuille de style, connexion, etc. Ces objets peuvent être manipulés via API et le résultat peut être écrit sur le disque dans n'importe quel format pris en charge.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
     Exporter vers des images
    </h2>
    <p>
     Les développeurs peuvent facilement charger des fichiers Visio et les exporter vers des images populaires telles que PNG, TIFF, JPEG, BMP, SVG et EMF. La bibliothèque Nodejs prend également en charge l'exportation de fichiers Visio au format PDF &amp; Formats XPS avec la plus haute fidélité.
    </p>
    <div class="codeblock" id="code">
     <h3>
...
{{< blocks/products/pf/slr-element name="API références" href="https://apireference.aspose.com/diagram/nodejs" >}}
