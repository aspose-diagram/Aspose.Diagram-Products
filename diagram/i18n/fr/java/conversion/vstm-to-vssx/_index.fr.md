...
description: Exemple de code de conversion Java pour le format VSTM en fichier VSSX. Utilisez cet exemple de code pour convertir VSTM en VSSX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTM en VSSX à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir un fichier VSTM en VSSX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSTM vers VSSX Java" offSpacer="" %}}

```cs
// charger le VSTM dans un objet de Diagram 
Diagram visio = new Diagram("template.vstm");
// enregistrer VSTM en tant que VSSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VSTM vers VSSX" sectionDescription="[Convertir VSTM en VSSX](https://products.aspose.app/diagram/conversion/vstm-to-vssx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
