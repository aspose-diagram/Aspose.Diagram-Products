---
title: Convertir VST en VTX via Java 
weight: 610
url: /fr/java/conversion/vst-to-vtx/ 
description: Exemple de code de conversion Java pour le format VST en fichier VTX. Utilisez cet exemple de code pour convertir VST en VTX dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VST en VTX via Java" h2="Exportez Microsoft Visio VST vers VTX à l\'aide de la bibliothèque native Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VST en VTX à l\'aide de Java" %}}

 Afin de rendre VST en VTX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VST en VTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier VST en VTX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VST vers VTX Java" offSpacer="" %}}

```cs
// charger le VST dans un objet de Diagram 
Diagram visio = new Diagram("template.vst");
// enregistrer VST en tant que VTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion VST en VTX" sectionDescription="[Convertir VST en VTX](https://products.aspose.app/diagram/conversion/vst-to-vtx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
