---
title: Convertir VST en VSSX via Java 
weight: 1400
url: /fr/java/conversion/vst-to-vssx/ 
description: Exemple de code de conversion Java pour le format VST en fichier VSSX. Utilisez cet exemple de code pour convertir VST en VSSX dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VST en VSSX via Java" h2="Exportez Microsoft Visio VST vers VSSX à l\'aide de la bibliothèque native Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VST en VSSX en utilisant Java" %}}

 Afin de rendre VST en VSSX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VST en VSSX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier VST en VSSX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VST vers VSSX Java" offSpacer="" %}}

```cs
// charger le VST dans un objet de Diagram 
Diagram visio = new Diagram("template.vst");
// enregistrer VST en tant que VSSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VST en VSSX" sectionDescription="[Convertir VST en VSSX](https://products.aspose.app/diagram/conversion/vst-to-vssx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
