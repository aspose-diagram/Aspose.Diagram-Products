---
title: Convertir VST en VSDM via Java 
weight: 780
url: /fr/java/conversion/vst-to-vsdm/ 
description: Exemple de code de conversion Java pour le format VST en fichier VSDM. Utilisez cet exemple de code pour convertir VST en VSDM dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VST en VSDM via Java" h2="Exportez Microsoft Visio VST vers VSDM à l\'aide de la bibliothèque native Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VST en VSDM à l\'aide de Java" %}}

 Afin de rendre VST en VSDM, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VST en VSDM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier VST en VSDM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VST vers VSDM Java" offSpacer="" %}}

```cs
// charger le VST dans un objet de Diagram 
Diagram visio = new Diagram("template.vst");
// enregistrer VST en tant que VSDM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VST en VSDM" sectionDescription="[Convertir VST en VSDM](https://products.aspose.app/diagram/conversion/vst-to-vsdm) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
