...
description: Exemple de code de conversion Java pour le format VSTM en fichier VSTX. Utilisez cet exemple de code pour convertir VSTM en VSTX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTM en VSTX à l\'aide de Java" %}}

 Afin de rendre VSTM en VSTX, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir un fichier VSTM en VSTX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSTM vers VSTX Java" offSpacer="" %}}

```cs
// charger le VSTM dans un objet de Diagram 
Diagram visio = new Diagram("template.vstm");
// enregistrer VSTM en tant que VSTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VSTM vers VSTX" sectionDescription="[Convertir VSTM en VSTX](https://products.aspose.app/diagram/conversion/vstm-to-vstx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
