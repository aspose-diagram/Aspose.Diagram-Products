...
{{% blocks/products/pf/agp/content h2="Comment convertir VST en VSSM à l\'aide de Java" %}}

 Afin de rendre VST en VSSM, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir un fichier VST en VSSM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VST vers VSSM Java" offSpacer="" %}}

```cs
// charger le VST dans un objet de Diagram 
Diagram visio = new Diagram("template.vst");
// enregistrer VST en tant que VSSM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VST en VSSM" sectionDescription="[Convertir VST en VSSM](https://products.aspose.app/diagram/conversion/vst-to-vssm) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
