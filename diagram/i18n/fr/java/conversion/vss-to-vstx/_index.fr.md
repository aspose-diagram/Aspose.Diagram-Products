...
description: Exemple de code de conversion Java pour le format VSS en fichier VSTX. Utilisez cet exemple de code pour convertir VSS en VSTX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSS en VSTX à l\'aide de Java" %}}
 ...
 Afin de rendre VSS en VSTX, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir un fichier VSS en VSTX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSS vers VSTX Java" offSpacer="" %}}

```cs
// charger le VSS dans un objet de Diagram 
Diagram visio = new Diagram("template.vss");
// enregistrer VSS en tant que VSTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VSS vers VSTX" sectionDescription="[Convertir VSS en VSTX](https://products.aspose.app/diagram/conversion/vss-to-vstx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
