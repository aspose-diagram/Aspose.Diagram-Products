...
description: Exemple de code de conversion Java pour le format VSD en fichier VDX. Utilisez cet exemple de code pour convertir VSD en VDX dans n'importe quelle application Web ou de bureau basée sur Java.
---
...
{{% blocks/products/pf/agp/code-block title="VSD vers VDX Java Code source de conversion" offSpacer="" %}}

```cs
// charger le VSD dans un objet de Diagram 
Diagram visio = new Diagram("template.vsd");
// enregistrer VSD en tant que VDX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de conversion VSD vers VDX" sectionDescription="[Convertir VSD en VDX](https://products.aspose.app/diagram/conversion/vsd-to-vdx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
