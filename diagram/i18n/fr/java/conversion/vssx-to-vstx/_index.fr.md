...
description: Exemple de code de conversion Java pour le format VSSX en fichier VSTX. Utilisez cet exemple de code pour convertir VSSX en VSTX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSSX en VSTX à l\'aide de Java" %}}

 Afin de rendre VSSX en VSTX, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir un fichier VSSX en VSTX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSSX vers VSTX Java" offSpacer="" %}}

```cs
// charger le VSSX dans un objet de Diagram 
Diagram visio = new Diagram("template.vssx");
// enregistrer VSSX en tant que VSTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VSSX vers VSTX" sectionDescription="[Convertir VSSX en VSTX](https://products.aspose.app/diagram/conversion/vssx-to-vstx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
