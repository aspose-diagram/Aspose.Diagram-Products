...
description: Exemple de code de conversion Java pour le format VSSX en fichier VSTM. Utilisez cet exemple de code pour convertir VSSX en VSTM dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSSX en VSTM à l\'aide de Java" %}}

 Afin de rendre VSSX en VSTM, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir un fichier VSSX en VSTM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSSX vers VSTM Java" offSpacer="" %}}

```cs
// charger le VSSX dans un objet de Diagram 
Diagram visio = new Diagram("template.vssx");
// enregistrer VSSX en tant que VSTM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VSSX vers VSTM" sectionDescription="[Convertir VSSX en VSTM](https://products.aspose.app/diagram/conversion/vssx-to-vstm) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
