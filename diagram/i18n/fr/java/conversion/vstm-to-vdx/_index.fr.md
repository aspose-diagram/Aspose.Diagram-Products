...
description: Exemple de code de conversion Java pour le format VSTM en fichier VDX. Utilisez cet exemple de code pour convertir VSTM en VDX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTM en VDX à l\'aide de Java" %}}

 Afin de rendre VSTM en VDX, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir un fichier VSTM en VDX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSTM vers VDX Java" offSpacer="" %}}

```cs
// charger le VSTM dans un objet de Diagram 
Diagram visio = new Diagram("template.vstm");
// enregistrer VSTM en tant que VDX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VSTM vers VDX" sectionDescription="[Convertir VSTM en VDX](https://products.aspose.app/diagram/conversion/vstm-to-vdx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
