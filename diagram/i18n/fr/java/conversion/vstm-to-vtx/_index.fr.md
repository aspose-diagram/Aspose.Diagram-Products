...
description: Exemple de code de conversion Java pour le format VSTM en fichier VTX. Utilisez cet exemple de code pour convertir VSTM en VTX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTM en VTX à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir un fichier VSTM en VTX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSTM à VTX Java" offSpacer="" %}}

```cs
// charger le VSTM dans un objet de Diagram 
Diagram visio = new Diagram("template.vstm");
// enregistrer VSTM en tant que VTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VSTM vers VTX" sectionDescription="[Convertir VSTM en VTX](https://products.aspose.app/diagram/conversion/vstm-to-vtx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
