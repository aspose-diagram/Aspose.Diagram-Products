---
title: Fusionner les fichiers VSS via .NET 
weight: 5110
url: /fr/net/merger/vss/ 
description: Code source C# pour combiner des documents VSS sur .NET Framework, .NET Core, Mono ou COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Fusionner les formats VSS dans C#" h2="Fusion de documents VSS native et hautes performances à l\'aide d\'API Aspose.Diagram for .NET côté serveur, sans l\'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment fusionner un fichier VSS à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers VSS dans C#" %}}
...
+ Chargez tous les fichiers VSS avec le chemin complet.
+ Créer un document comme fichier de base
+ Appelez la méthode appropriée pour concaténer et fusionner les fichiers un par un.
+ Appelez la méthode Save() et passez le nom du fichier (chemin complet) et le format (VSS) en paramètre.
+ Vous pouvez maintenant ouvrir et utiliser le fichier VSS dans Microsoft Office, Adobe PDF ou tout autre programme compatible.
...
{{% blocks/products/pf/agp/code-block title="Fusionner les fichiers VSS - C#" offSpacer="" %}}
