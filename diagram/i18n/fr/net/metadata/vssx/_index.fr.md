---
title: Afficher ou modifier les métadonnées des fichiers VSSX via .NET 
weight: 3050
url: /fr/net/metadata/vssx/ 
description: Code source C# pour modifier ou afficher les métadonnées au format VSSX sur .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Extraire les métadonnées VSSX dans C#" h2="Créez vos propres applications .NET pour ajouter, modifier, supprimer ou extraire des métadonnées des fichiers VSSX à l\'aide d\'API côté serveur." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment extraire les métadonnées VDW à l\'aide de C#" %}}
 ...
 Afin d'extraire les métadonnées VSSX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour extraire les métadonnées VSSX dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Extraction des métadonnées VSSX - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram est une manipulation de format de document Microsoft Visio API. On peut facilement charger, créer, modifier, manipuler, y compris des éléments de daigramme et convertir des diagrammes Visio en d'autres formats tels que PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF et plus encore. Il s'agit d'un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Extraire les métadonnées de VSSX via l\'application en ligne" sectionDescription="Afficher et modifier les métadonnées des documents VSSX en visitant notre [Site Web de démos en direct](https://products.aspose.app/diagram/metadata). La démo en direct présente les avantages suivants" >}}
