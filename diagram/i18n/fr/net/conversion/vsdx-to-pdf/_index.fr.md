---
title: Convertir VSDX en PDF via C# 
weight: 680
url: /fr/net/conversion/vsdx-to-pdf/ 
description: Exemple de code pour la conversion de VSDX en PDF C#. Utilisez API exemple de code pour la conversion de fichiers par lot VSDX en PDF dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSDX en PDF via C#" h2="Exportez des fichiers Microsoft® Visio VSDX au format PDF sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSDX en PDF en utilisant C#" %}}

 Pour convertir VSDX en PDF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSDX en PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VSDX au format PDF en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VSDX avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.PDF comme paramètres1. Le fichier PDF sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSDX en PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en PDF" sectionDescription="Consultez nos démos en direct pour [conversion de VSDX en PDF](https://products.aspose.app/diagram/conversion/vsdx-to-pdf) avec les avantages suivants." >}}
