---
title: Convertir VDW en VDX via C# 
weight: 2390
url: /fr/net/conversion/vdw-to-vdx/ 
description: Exemple de code pour la conversion VDW vers VDX C#. Utilisez l'exemple de code API pour la conversion par lot de fichiers VDW en VDX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VDW en VDX via C#" h2="Exportez des fichiers Microsoft® Visio VDW vers VDX sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDW en VDX à l\'aide de C#" %}}

 Afin de convertir VDW en VDX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VDW en VDX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VDW en VDX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VDW avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.VDX comme paramètres1. Le fichier VDX sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDW vers VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDW en VDX" sectionDescription="Consultez nos démos en direct pour [Conversion VDW en VDX](https://products.aspose.app/diagram/conversion/vdw-to-vdx) avec les avantages suivants." >}}
