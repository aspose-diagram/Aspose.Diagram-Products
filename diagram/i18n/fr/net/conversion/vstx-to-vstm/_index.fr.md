...
description: Exemple de code pour la conversion VSTX vers VSTM C#. Utilisez l'exemple de code API pour la conversion par lots de fichiers VSTX en VSTM dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSTM à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSTX vers VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSTX en VSTM" sectionDescription="Consultez nos démos en direct pour [Conversion VSTX en VSTM](https://products.aspose.app/diagram/conversion/vstx-to-vstm) avec les avantages suivants." >}}
