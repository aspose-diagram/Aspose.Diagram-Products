...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en SVG à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs .NET peuvent facilement charger et convertir des fichiers VDX en SVG en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX vers SVG C#" offSpacer="" %}}
