...
description: Exemple de code pour la conversion VSTX en VSDX C#. Utilisez API l'exemple de code pour les fichiers VSTX par lots en VSDX conversion dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre VSTX à VSDX C# Conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSTX en VSDX" sectionDescription="Consultez nos démos en direct pour [Conversion VSTX en VSDX](https://products.aspose.app/diagram/conversion/vstx-to-vsdx) avec les avantages suivants." >}}
