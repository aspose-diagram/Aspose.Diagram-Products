...
{{% blocks/products/pf/agp/content h2="Comment convertir VDW en JPEG à l\'aide de C#" %}}

 Pour convertir VDW en JPEG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VDW en JPEG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VDW au format JPEG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VDW avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.JPEG comme paramètres1. Le fichier JPEG sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDW en JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDW en JPEG" sectionDescription="Consultez nos démos en direct pour [Conversion VDW en JPEG](https://products.aspose.app/diagram/conversion/vdw-to-jpeg) avec les avantages suivants." >}}
