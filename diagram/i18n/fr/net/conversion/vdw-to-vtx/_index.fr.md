---
title: Convertir VDW en VTX via C# 
weight: 730
url: /fr/net/conversion/vdw-to-vtx/ 
description: Exemple de code pour la conversion VDW vers VTX C#. Utilisez l'exemple de code API pour la conversion par lots de fichiers VDW en VTX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VDW en VTX via C#" h2="Exportez les fichiers Microsoft® Visio VDW vers VTX sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDW en VTX à l\'aide de C#" %}}

 Afin de convertir VDW en VTX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VDW en VTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VDW en VTX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VDW avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.VTX comme paramètres1. Le fichier VTX sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDW à VTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDW en VTX" sectionDescription="Consultez nos démos en direct pour [Conversion VDW en VTX](https://products.aspose.app/diagram/conversion/vdw-to-vtx) avec les avantages suivants." >}}
