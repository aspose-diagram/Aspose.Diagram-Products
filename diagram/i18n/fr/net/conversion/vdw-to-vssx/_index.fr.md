---
title: Convertir VDW en VSSX via C# 
weight: 530
url: /fr/net/conversion/vdw-to-vssx/ 
description: Exemple de code pour la conversion VDW vers VSSX C#. Utilisez l'exemple de code API pour la conversion par lots de fichiers VDW en VSSX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VDW en VSSX via C#" h2="Exportez les fichiers Microsoft® Visio VDW vers VSSX sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDW en VSSX à l\'aide de C#" %}}

 Afin de convertir VDW en VSSX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VDW en VSSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VDW en VSSX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VDW avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.VSSX comme paramètres1. Le fichier VSSX sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDW vers VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDW en VSSX" sectionDescription="Consultez nos démos en direct pour [Conversion VDW en VSSX](https://products.aspose.app/diagram/conversion/vdw-to-vssx) avec les avantages suivants." >}}
