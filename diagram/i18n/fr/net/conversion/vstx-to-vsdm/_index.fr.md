...
description: Exemple de code pour la conversion VSTX vers VSDM C#. Utilisez l'exemple de code API pour la conversion de fichiers VSTX par lots en VSDM dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSDM à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSTX vers VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSTX en VSDM" sectionDescription="Consultez nos démos en direct pour [Conversion VSTX en VSDM](https://products.aspose.app/diagram/conversion/vstx-to-vsdm) avec les avantages suivants." >}}
