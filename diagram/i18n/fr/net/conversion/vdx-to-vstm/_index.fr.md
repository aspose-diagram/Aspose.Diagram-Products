...
description: Exemple de code pour la conversion VDX vers VSTM C#. Utilisez l'exemple de code API pour la conversion par lots de fichiers VDX en VSTM dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en VSTM à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX vers VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en VSTM" sectionDescription="Consultez nos démos en direct pour [Conversion VDX en VSTM](https://products.aspose.app/diagram/conversion/vdx-to-vstm) avec les avantages suivants." >}}
