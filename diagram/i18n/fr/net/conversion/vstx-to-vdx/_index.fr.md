...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VDX à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSTX vers VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSTX en VDX" sectionDescription="Consultez nos démos en direct pour [Conversion VSTX en VDX](https://products.aspose.app/diagram/conversion/vstx-to-vdx) avec les avantages suivants." >}}
