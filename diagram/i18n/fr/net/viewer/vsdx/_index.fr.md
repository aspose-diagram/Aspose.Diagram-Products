---
title: Afficher les formats de fichier VSDX via .NET 
weight: 5350
url: /fr/net/viewer/vsdx/ 
description: C# code source pour charger, restituer et afficher VSDX documents sur .NET Framework, .NET Core, Mono ou COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDX Visionneuse de fichiers for .NET" h2="Affichez les fichiers Microsoft Visio VSDX dans le navigateur sans nécessiter d\'application Visio ni de bureautique." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour afficher VSDX via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# code pour afficher VSDX" offSpacer="" %}}

```cs

// charger le fichier VSDX via une instance de Diagram
var diagram = new Aspose.Diagram.Diagram("template.vsdx");
// convertir VSDX au format HTML
