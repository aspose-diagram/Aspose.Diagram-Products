...
{{% blocks/products/pf/agp/content h2="Comment diviser un fichier VDX à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fractionner les fichiers VDX dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Diviser les fichiers VDX - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram est une manipulation de format de document Microsoft Visio API. On peut facilement charger, créer, modifier, manipuler, y compris des éléments de daigramme et convertir des diagrammes Visio en d'autres formats tels que PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF et plus encore. Il s'agit d'un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Démos en direct VDX Split en ligne" sectionDescription="Divisez les documents VDX dès maintenant en visitant notre [Site Web de démos en direct](https://products.aspose.app/diagram/splitter). La démo en direct présente les avantages suivants" >}}
