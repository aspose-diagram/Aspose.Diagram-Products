...
description: VSDM 형식을 PNG 파일로 변환하는 샘플 Java 변환 코드. 이 예제 코드를 사용하여 웹 또는 데스크톱 Java 기반 애플리케이션 내에서 VSDM을 PNG로 변환합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java을 통해 VSDM을 PNG로 변환" h2="기본 Java 라이브러리를 사용하여 Microsoft Visio VSDM을 PNG로 내보냅니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDM에서 PNG로의 변환 라이브 데모" sectionDescription="[VSDM을 PNG로 변환](https://products.aspose.app/diagram/conversion/vsdm-to-png) 지금 바로 라이브 데모 웹사이트를 방문하세요. 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
