...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VST를 TIFF로 변환하는 방법" %}}

 VST를 TIFF로 변환하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#를 통해 VST를 TIFF로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 개발자는 몇 줄의 코드로 VST 파일을 쉽게 로드하고 TIFF로 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. Diagram 클래스의 인스턴스로 VST 파일 로드1. 출력 파일 경로와 SaveFileFormat.TIFF를 매개변수로 사용하여 Diagram.Save 메소드를 호출합니다.1. TIFF 파일은 지정된 경로에 저장됩니다.
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 VST에서 TIFF로의 C# 변환을 보여줍니다." offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VST를 TIFF로 변환하는 무료 앱" sectionDescription="라이브 데모를 확인하십시오. [VST에서 TIFF로 변환](https://products.aspose.app/diagram/conversion/vst-to-tiff) 다음과 같은 혜택이 있습니다." >}}
