---
title: C#을(를) 통해 VSD을(를) PDF로 변환 
weight: 3150
url: /ko/net/conversion/vsd-to-pdf/ 
description: VSD에서 PDF로 C# 변환을 위한 샘플 코드입니다. VB.NET, Asp.NET 또는 모든 .NET 기반 애플리케이션 내에서 배치 VSD 파일을 PDF로 변환하는 API 예제 코드를 사용합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#을(를) 통해 VSD을(를) PDF로 변환" h2="Microsoft® Visio VSD 파일을 .NET Framework, .NET Core, Mono 또는 COM Interop에서 PDF로 내보냅니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSD을 PDF로 변환하는 방법" %}}

 VSD을(를) PDF로 변환하기 위해 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#을(를) 통해 VSD을(를) PDF로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 개발자는 몇 줄의 코드로 VSD 파일을 PDF로 쉽게 로드하고 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. Diagram 클래스의 인스턴스로 VSD 파일 로드1. 출력 파일 경로와 SaveFileFormat.PDF를 매개변수로 사용하여 Diagram.Save 메소드를 호출합니다.1. PDF 파일은 지정된 경로에 저장됩니다
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 VSD에서 PDF로 C# 변환을 보여줍니다." offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD을(를) PDF로 변환하는 무료 앱" sectionDescription="라이브 데모를 확인하십시오. [VSD에서 PDF로 변환](https://products.aspose.app/diagram/conversion/vsd-to-pdf) 다음과 같은 혜택이 있습니다." >}}
