---
title: C#를 통해 VSX를 XPS로 변환 
weight: 1760
url: /ko/net/conversion/vsx-to-xps/ 
description: VSX에서 XPS로의 C# 변환을 위한 샘플 코드입니다. VB.NET, Asp.NET 또는 .NET 기반 애플리케이션 내에서 일괄 VSX 파일을 XPS로 변환하는 API 예제 코드를 사용합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#를 통해 VSX를 XPS로 변환" h2="Microsoft® Visio VSX 파일을 .NET Framework, .NET Core, Mono 또는 COM Interop에서 XPS로 내보냅니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSX를 XPS로 변환하는 방법" %}}

 VSX를 XPS로 변환하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#를 통해 VSX를 XPS로 변환하는 단계" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSX를 XPS로 변환하는 무료 앱" sectionDescription="라이브 데모를 확인하십시오. [VSX에서 XPS로 변환](https://products.aspose.app/diagram/conversion/vsx-to-xps) 다음과 같은 혜택이 있습니다." >}}
