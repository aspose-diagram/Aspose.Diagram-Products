---
title: C#을 통해 VSTX를 PNG로 변환 
weight: 2320
url: /ko/net/conversion/vstx-to-png/ 
description: VSTX에서 PNG C#로의 변환을 위한 샘플 코드. VB.NET, Asp.NET 또는 .NET 기반 애플리케이션 내에서 일괄 VSTX 파일을 PNG로 변환하는 API 예제 코드를 사용합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#을 통해 VSTX를 PNG로 변환" h2="Microsoft® Visio VSTX 파일을 .NET Framework, .NET Core, Mono 또는 COM Interop에서 PNG로 내보냅니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSTX를 PNG로 변환하는 방법" %}}

 VSTX를 PNG로 변환하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 VSTX를 PNG로 변환하는 단계" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX를 PNG로 변환하는 무료 앱" sectionDescription="라이브 데모를 확인하십시오. [VSTX에서 PNG로 변환](https://products.aspose.app/diagram/conversion/vstx-to-png) 다음과 같은 혜택이 있습니다." >}}
