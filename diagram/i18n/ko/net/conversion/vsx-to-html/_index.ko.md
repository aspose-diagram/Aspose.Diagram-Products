---
title: C#를 통해 VSX를 HTML로 변환 
weight: 3410
url: /ko/net/conversion/vsx-to-html/ 
description: VSX에서 HTML C#로의 변환을 위한 샘플 코드. VB.NET, Asp.NET 또는 모든 .NET 기반 애플리케이션 내에서 일괄 VSX 파일을 HTML로 변환하는 API 예제 코드를 사용합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#를 통해 VSX를 HTML로 변환" h2="Microsoft® Visio VSX 파일을 .NET Framework, .NET Core, Mono 또는 COM Interop에서 HTML로 내보냅니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSX를 HTML로 변환하는 방법" %}}

 VSX를 HTML로 변환하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#를 통해 VSX를 HTML로 변환하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 VSX에서 HTML C#로의 변환을 보여줍니다." offSpacer="" %}}
