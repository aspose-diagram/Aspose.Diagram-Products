---
title: .NET을 통한 워터마크 VSDM 문서 
weight: 3050
url: /ko/net/watermark/vsdm/ 
description: .NET 프레임워크, .NET 코어, Mono 플랫폼에서 vsdm 파일에 워터마크를 추가하는 C# 소스 코드.
---
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSDM 파일을 워터마크하는 방법" %}}

 VSDM 파일에 워터마크를 지정하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 VSDM 파일 워터마킹 단계" %}}
