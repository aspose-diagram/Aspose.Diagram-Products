---
title: .NET을(를) 통해 VSSX 문서에서 조직도 만들기 
weight: 3050
url: /ko/net/organizationchart/vssx/ 
description: C# 소스 코드를 사용하여 .NET Framework, .NET Core, Mono Platforms의 vssx 파일에 조직도를 생성합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#의 VSSX에서 조직도 만들기" h2="기본 및 고성능은 Microsoft 또는 Open Office, Adobe PDF와 같은 소프트웨어를 사용하지 않고 서버측 Aspose.Diagram for .NET API를 사용하여 VSSX 문서에서 조직도를 생성합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSSX 파일에서 조직도를 만드는 방법" %}}

 VSSX 파일에서 조직도를 생성하기 위해 우리는 다음을 사용할 것입니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#의 VSSX 파일에서 조직도를 만드는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX 파일에서 조직도 만들기 - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram은(는) Microsoft Visio 문서 형식 조작API입니다. daigram 요소를 포함하여 쉽게 로드, 생성, 수정, 조작하고 Visio 다이어그램을 PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF 등과 같은 다른 형식으로 변환할 수 있습니다. 독립형 API이며 Microsoft Visio 또는 기타 소프트웨어를 설치할 필요가 없습니다.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="온라인 VSSX CompactTree 스타일 조직도 라이브 데모" sectionDescription="지금 바로 저희 웹사이트를 방문하여 VSSX 문서에서 CompactTree 스타일 조직도를 만드십시오. [라이브 데모 웹사이트](https://products.aspose.app/diagram/organizationchart). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" VSSX 문서에 CompactTree 스타일의 조직도를 즉시 생성합니다." >}}
