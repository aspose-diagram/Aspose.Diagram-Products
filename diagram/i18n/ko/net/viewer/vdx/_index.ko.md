...
{{% blocks/products/pf/agp/feature-section-col title="C#을(를) 통해 VDX를 보는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX를 보기 위한 C# 코드" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram은(는) Microsoft Visio 문서 형식 조작API입니다. daigram 요소를 포함하여 쉽게 로드, 생성, 수정, 조작하고 Visio 다이어그램을 PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF 등과 같은 다른 형식으로 변환할 수 있습니다. 독립 실행형 API이며 Microsoft Visio 또는 기타 소프트웨어를 설치할 필요가 없습니다.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="VDX를 볼 수 있는 무료 앱" sectionDescription="라이브 데모를 확인하려면 [VDX 보기](https://products.aspose.app/diagram/viewer/vdx) 다음과 같은 혜택이 있습니다." >}}
