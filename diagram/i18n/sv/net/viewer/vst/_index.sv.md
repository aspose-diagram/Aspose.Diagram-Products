---
title: Visa VST-filformat via .NET 
weight: 4690
url: /sv/net/viewer/vst/ 
description: C# källkod för att ladda, rendera och visa VST-dokument på .NET Framework, .NET Core, Mono eller COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VST File Viewer for .NET" h2="Visa Microsoft Visio VST-filer i webbläsaren utan att behöva Visio-program eller Office Automation." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VST" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att visa VST via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C#-kod för att visa VST" offSpacer="" %}}

```cs

// ladda VST-fil via en instans av Diagram
var diagram = new Aspose.Diagram.Diagram("template.vst");
// konvertera VST till HTML-format
