...
{{< blocks/products/pf/i18n/upper-banner h1="VSSM File Viewer for .NET" h2="Visa Microsoft Visio VSSM-filer i webbläsaren utan att behöva Visio-program eller Office Automation." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Så här visar du VSSM-fil med C#" %}}
 ...
 För att visa VSSM-filen kommer vi att använda
...
1. Ladda VSSM-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med SaveFileFormat.HTML som parametrar1. Ladda resulterande HTML i standardwebbläsaren via Process.Start
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram är en Microsoft Visio dokumentformatmanipulation API. Man kan enkelt ladda, skapa, ändra, manipulera inklusive daigramelement och konvertera Visio-diagram till andra format som PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF och mer. Det är en fristående API och kräver inte att Microsoft Visio eller någon annan programvara installeras.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att se VSSM" sectionDescription="Kolla våra livedemos för att [Se VSSM](https://products.aspose.app/diagram/viewer/vssm) med följande förmåner." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp VSSM-fil och tryck på \"Visa\"-knappen" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Ladda ner VSSM-fil från länken, om det behövs" >}}
