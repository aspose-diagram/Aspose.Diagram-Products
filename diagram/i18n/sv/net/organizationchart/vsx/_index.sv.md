---
title: Skapa organisationsschema i VSX-dokument via .NET 
weight: 3050
url: /sv/net/organizationchart/vsx/ 
description: C# källkod för att skapa organisationsdiagram i vsx-fil på .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Skapa organisationsschema i VSX i C#" h2="Skapa organisationsdiagram med hög prestanda i VSX-dokument med hjälp av API:er på serversidan Aspose.Diagram for .NET, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här skapar du organisationsdiagram i VSX-fil med C#" %}}
 ...
 För att skapa organisationsdiagram i VSX-fil, kommer vi att använda
