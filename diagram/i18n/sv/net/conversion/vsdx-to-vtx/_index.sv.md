...
description: Exempelkod för konvertering från VSDX till VTX C#. Använd API exempelkod för batch-VSDX-filer till VTX-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSDX till VTX med C#" %}}
 ...
 För att konvertera VSDX till VTX kommer vi att använda
...
1. Ladda filen VSDX med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.VTX som parametrar1. VTX-filen kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSDX till VTX" sectionDescription="Kolla in våra livedemos för [VSDX till VTX-konvertering](https://products.aspose.app/diagram/conversion/vsdx-to-vtx) med följande förmåner." >}}
