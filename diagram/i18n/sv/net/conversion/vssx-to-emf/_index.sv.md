...
description: Exempelkod för konvertering av VSSX till EMF C#. Använd API exempelkod för batch-VSSX-filer till EMF-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
1. Ladda VSSX-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.EMF som parametrar1. EMF-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSSX till EMF C#-konvertering" offSpacer="" %}}
