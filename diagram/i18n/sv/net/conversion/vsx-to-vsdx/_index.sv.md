...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSX till VSDX med C#" %}}

 För att konvertera VSX till VSDX kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSX till VSDX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-utvecklare kan enkelt ladda och konvertera VSX-filer till VSDX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VSX-fil med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSDX som parametrar1. VSDX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSX till VSDX C#-omvandling" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSX till VSDX" sectionDescription="Kolla in våra livedemos för [VSX till VSDX konvertering](https://products.aspose.app/diagram/conversion/vsx-to-vsdx) med följande förmåner." >}}
