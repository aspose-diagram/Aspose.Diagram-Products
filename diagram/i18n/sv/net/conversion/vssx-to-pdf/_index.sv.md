...
description: Exempelkod för konvertering av VSSX till PDF C#. Använd API exempelkod för batch-VSSX-filer till PDF-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
1. Ladda VSSX-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.PDF som parametrar1. PDF-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSSX till PDF C#-konvertering" offSpacer="" %}}
