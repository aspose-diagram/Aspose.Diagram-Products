...
description: Exempelkod för konvertering av VSS till VTX C#. Använd API exempelkod för batch-VSS-filer till VTX-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
1. Ladda VSS-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.VTX som parametrar1. VTX-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSS till VTX C#-konvertering" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSS till VTX" sectionDescription="Kolla in våra livedemos för [VSS till VTX konvertering](https://products.aspose.app/diagram/conversion/vss-to-vtx) med följande förmåner." >}}
