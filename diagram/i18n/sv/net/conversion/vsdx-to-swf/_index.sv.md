...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSDX till SWF med C#" %}}

 För att konvertera VSDX till SWF använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSDX till SWF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-utvecklare kan enkelt ladda och konvertera VSDX-filer till SWF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda filen VSDX med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.SWF som parametrar1. SWF-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSDX till SWF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSDX till SWF" sectionDescription="Kolla in våra livedemos för [VSDX till SWF-konvertering](https://products.aspose.app/diagram/conversion/vsdx-to-swf) med följande förmåner." >}}
