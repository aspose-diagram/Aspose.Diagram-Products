...
description: Exempelkod för konvertering från VSD till VSX C#. Använd API exempelkod för batch-VSD-filer till VSX-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSD till VSX med C#" %}}
 ...
 För att konvertera VSD till VSX kommer vi att använda
...
1. Ladda filen VSD med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.VSX som parametrar1. VSX-filen kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSD till VSX" sectionDescription="Kolla in våra livedemos för [VSD till VSX-konvertering](https://products.aspose.app/diagram/conversion/vsd-to-vsx) med följande förmåner." >}}
