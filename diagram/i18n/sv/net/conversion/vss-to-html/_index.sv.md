---
title: Konvertera VSS till HTML via C# 
weight: 4340
url: /sv/net/conversion/vss-to-html/ 
description: Exempelkod för konvertering av VSS till HTML C#. Använd API exempelkod för batch-VSS-filer till HTML-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VSS till HTML via C#" h2="Exportera Microsoft® Visio VSS-filer till HTML på .NET Framework, .NET Core, Mono eller COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSS till HTML med C#" %}}

 För att konvertera VSS till HTML kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSS till HTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-utvecklare kan enkelt ladda och konvertera VSS-filer till HTML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VSS-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.HTML som parametrar1. HTML-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSS till HTML C#-konvertering" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSS till HTML" sectionDescription="Kolla in våra livedemos för [VSS till HTML-konvertering](https://products.aspose.app/diagram/conversion/vss-to-html) med följande förmåner." >}}
