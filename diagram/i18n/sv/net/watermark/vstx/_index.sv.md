---
title: Vattenstämpel VSTX-dokument via .NET 
weight: 3050
url: /sv/net/watermark/vstx/ 
description: C# källkod för att lägga till vattenstämpel i vstx-filen på .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lägg till textvattenstämpel till VSTX i C#" h2="Inbyggd och högpresterande VSTX-dokumentvattenstämpel med hjälp av API:er på serversidan Aspose.Diagram for .NET, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man vattenmärker VSTX-fil med C#" %}}

 För att vattenmärka VSTX-filen kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för vattenmärkning av VSTX-filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vattenstämpel VSTX-filer - C#" offSpacer="" %}}
