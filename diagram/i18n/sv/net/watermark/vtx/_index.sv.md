---
title: Vattenstämpel VTX-dokument via .NET 
weight: 3050
url: /sv/net/watermark/vtx/ 
description: C# källkod för att lägga till vattenstämpel i vtx-filen på .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lägg till textvattenstämpel till VTX i C#" h2="Inbyggt och högpresterande vattenstämpel för VTX-dokument med Aspose.Diagram for .NET API:er på serversidan, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man vattenmärker VTX-fil med C#" %}}

 För att vattenmärka VTX-filen kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för vattenmärkning av VTX-filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vattenstämpel VTX-filer - C#" offSpacer="" %}}
