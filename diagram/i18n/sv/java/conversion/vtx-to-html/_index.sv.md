...
description: Exempel Java-konverteringskod för VTX-format till HTML-fil. Använd den här exempelkoden för att konvertera VTX till HTML i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VTX-fil till HTML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VTX-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. HTML-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="VTX till HTML Java omvandlingskällkod" offSpacer="" %}}
