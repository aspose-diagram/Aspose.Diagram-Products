...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSTM-fil till JPEG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VSTM-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. JPEG-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="VSTM till JPEG Java omvandlingskälla" offSpacer="" %}}
