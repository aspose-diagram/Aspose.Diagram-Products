...
description: Exempel Java-konverteringskod för VSSX-format till PNG-fil. Använd den här exempelkoden för att konvertera VSSX till PNG i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSSX-fil till PNG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VSSX-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. PNG-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="VSSX till PNG Java omvandlingskällkod" offSpacer="" %}}
