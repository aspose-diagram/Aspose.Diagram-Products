...
description: Exempel på Java-konverteringskod för VSTM-format till HTML-fil. Använd den här exempelkoden för att konvertera VSTM till HTML i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSTM-fil till HTML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VSTM-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. HTML-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="VSTM till HTML Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM till HTML Conversion Live Demos" sectionDescription="[Konvertera VSTM till HTML](https://products.aspose.app/diagram/conversion/vstm-to-html) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din VSTM-fil, den kommer omedelbart att konverteras till HTML." >}}
