...
description: Exempel Java-konverteringskod för VTX-format till EMF-fil. Använd den här exempelkoden för att konvertera VTX till EMF i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VTX-filer till EMF på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VTX-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. EMF-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="VTX till EMF Java omvandlingskälla" offSpacer="" %}}
