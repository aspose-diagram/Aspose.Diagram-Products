...
description: Exempel på Java-konverteringskod för VSTM-format till XAML-fil. Använd den här exempelkoden för att konvertera VSTM till XAML i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSTM-fil till XAML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VSTM-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. XAML-filen kommer att sparas på den angivna sökvägen
