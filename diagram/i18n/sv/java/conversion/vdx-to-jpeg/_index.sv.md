...
description: Exempel Java-konverteringskod för VDX-format till JPEG-fil. Använd den här exempelkoden för att konvertera VDX till JPEG i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VDX-fil till JPEG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VDX-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. JPEG-filen kommer att sparas på den angivna sökvägen
