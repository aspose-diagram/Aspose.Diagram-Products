---
title: 通过 Java 合并 VSSX 文件 
weight: 2720
url: /zh/java/merger/vssx/ 
description: Java 用于在 Java JSP/JSF 应用程序和桌面应用程序的运行时环境中组合 VSSX 文档的示例代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Java 中合并 VSSX 格式" h2="使用服务器端 Java API 的本机 VSSX 文档合并。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 Java 中合并 VSSX 文件的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="合并 VSSX 文件 - Java" offSpacer="" %}}
