---
title: 通过 Java 合并 VTX 文件 
weight: 110
url: /zh/java/merger/vtx/ 
description: Java 用于在 Java JSP/JSF 应用程序和桌面应用程序的运行时环境中组合 VTX 文档的示例代码。
---
...
{{% blocks/products/pf/agp/feature-section-col title="在 Java 中合并 VTX 文件的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="合并 VTX 文件 - Java" offSpacer="" %}}
