...
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将 VSSX 转换为 SWF" h2="无需 Adobe 即可读取、写入和导出 VSSX 到 SWF 的原生 Java 库。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SWF" pfName="Aspose.DIAGRAM" subTitlepfName="" downloadUrl="" fileiconsmall1="SWF" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
为了将 VSSX 渲染为 SWF，我们将使用 <a href="https://products.aspose.com/diagram/java">Aspose.Diagram for Java</a> API 是一个功能丰富、功能强大且易于使用的转换API for Java 平台。您可以直接从 <a href="https://repository.aspose.com/webapp/#/artifacts/browse/tree/General/repo/com/aspose/aspose-diagram">马文</a> 并通过将以下配置添加到 pom.xml 将其安装在基于 Maven 的项目中。
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.DIAGRAM API 让开发人员只需几行代码即可轻松地将 VSSX 文件转换为 SWF。
