---
title: 通过 C# 将 VSD 转换为 SVG 
weight: 2030
url: /zh/net/conversion/vsd-to-svg/ 
description: VSD 到 SVG C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 VSD 文件批量转换为 SVG。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 VSD 转换为 SVG" h2="将 Microsoft® Visio VSD 文件导出到 .NET Framework、.NET Core、Mono 或 COM Interop 上的 SVG。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 VSD 转换为 SVG" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 VSD 转换为 SVG 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 开发人员只需几行代码即可轻松加载 VSD 文件并将其转换为 SVG。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Diagram 类的实例加载 VSD 文件1. 以输出文件路径和 SaveFileFormat.SVG 作为参数调用 Diagram.Save 方法1. SVG文件将保存在指定路径
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VSD 到 SVG C# 的转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="将 VSD 转换为 SVG 的免费应用程序" sectionDescription="查看我们的现场演示 [VSD 到 SVG 的转换](https://products.aspose.app/diagram/conversion/vsd-to-svg) 具有以下好处。" >}}
