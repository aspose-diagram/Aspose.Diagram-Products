...
1. 使用 Diagram 类的实例加载 VSSX 文件1. 以输出文件路径和 SaveFileFormat.VSSM 作为参数调用 Diagram.Save 方法1. VSSM 文件将保存在指定路径
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VSSX 到 VSSM C# 的转换" offSpacer="" %}}
