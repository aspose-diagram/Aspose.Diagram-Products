...
1. 使用 Diagram 类的实例加载 VSDM 文件1. 使用输出文件路径和 SaveFileFormat.VTX 作为参数调用 Diagram.Save 方法1. VTX文件将保存在指定路径
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VSDM 到 VTX C# 的转换" offSpacer="" %}}
