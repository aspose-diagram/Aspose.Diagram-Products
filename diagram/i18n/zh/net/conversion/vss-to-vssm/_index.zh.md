...
description: VSS 到 VSSM C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 VSS 文件批量转换为 VSSM。
---
...
1. 使用 Diagram 类的实例加载 VSS 文件1. 以输出文件路径和 SaveFileFormat.VSSM 作为参数调用 Diagram.Save 方法1. VSSM 文件将保存在指定路径
