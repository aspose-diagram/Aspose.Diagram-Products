...
1. 使用 Diagram 类的实例加载 VSDM 文件1. 以输出文件路径和 SaveFileFormat.VSTX 作为参数调用 Diagram.Save 方法1. VSTX 文件将保存在指定路径
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VSDM 到 VSTX C# 的转换" offSpacer="" %}}
