---
title: Προβολή μορφών αρχείων VSS μέσω .NET 
weight: 3190
url: /el/net/viewer/vss/ 
description: C# πηγαίος κώδικας για φόρτωση, απόδοση και εμφάνιση εγγράφων VSS σε .NET Framework, .NET Core, Mono ή COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Πρόγραμμα προβολής αρχείων VSS for .NET" h2="Προβάλετε αρχεία Microsoft Visio VSS στο πρόγραμμα περιήγησης χωρίς να απαιτείται Visio εφαρμογή ή αυτοματισμός Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSS" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για προβολή VSS μέσω C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# κωδικός για προβολή VSS" offSpacer="" %}}

```cs

// φόρτωση αρχείου VSS μέσω μιας παρουσίας του Diagram
var diagram = new Aspose.Diagram.Diagram("template.vss");
// μετατροπή VSS σε μορφή HTML
