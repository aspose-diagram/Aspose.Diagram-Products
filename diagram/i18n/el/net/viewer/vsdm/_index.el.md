---
title: Προβολή μορφών αρχείων VSDM μέσω .NET 
weight: 1210
...
{{% blocks/products/pf/agp/text %}}
 ...
 Το Aspose.Diagram διευκολύνει τους προγραμματιστές να προβάλλουν το αρχείο VSDM με λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου VSDM με μια παρουσία κλάσης Diagram1. Καλέστε τη μέθοδο Diagram.Save με SaveFileFormat.HTML ως παραμέτρους1. Φόρτωση HTML που προκύπτει στο προεπιλεγμένο πρόγραμμα περιήγησης μέσω του Process.Start
 ...
 Το Aspose.Diagram είναι ένας χειρισμός μορφής εγγράφου της Microsoft Visio API. Κάποιος μπορεί εύκολα να φορτώσει, να δημιουργήσει, να τροποποιήσει, να χειριστεί συμπεριλαμβανομένων των στοιχείων daigram και να μετατρέψει Visio διαγράμματα σε άλλες μορφές όπως PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF και άλλα. Είναι αυτόνομο API και δεν απαιτεί την εγκατάσταση του Microsoft Visio ή άλλου λογισμικού.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Δωρεάν εφαρμογή για προβολή VSDM" sectionDescription="Ελέγξτε τις ζωντανές επιδείξεις μας σε [Προβολή VSDM](https://products.aspose.app/diagram/viewer/vsdm) με τα ακόλουθα οφέλη." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Κατεβάστε το αρχείο VSDM από τον σύνδεσμο, εάν απαιτείται" >}}
