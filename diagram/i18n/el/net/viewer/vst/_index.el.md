---
title: Προβολή μορφών αρχείων VST μέσω .NET 
weight: 4690
url: /el/net/viewer/vst/ 
description: C# πηγαίος κώδικας για φόρτωση, απόδοση και εμφάνιση εγγράφων VST σε .NET Framework, .NET Core, Mono ή COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Πρόγραμμα προβολής αρχείων VST for .NET" h2="Προβάλετε αρχεία Microsoft Visio VST στο πρόγραμμα περιήγησης χωρίς να απαιτείται Visio εφαρμογή ή αυτοματισμός Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VST" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για προβολή VST μέσω C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# κωδικός για προβολή VST" offSpacer="" %}}

```cs

// φόρτωση αρχείου VST μέσω μιας παρουσίας του Diagram
var diagram = new Aspose.Diagram.Diagram("template.vst");
// μετατροπή VST σε μορφή HTML
