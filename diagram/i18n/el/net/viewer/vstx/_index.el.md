---
title: Προβολή μορφών αρχείων VSTX μέσω .NET 
weight: 3560
url: /el/net/viewer/vstx/ 
description: C# πηγαίος κώδικας για φόρτωση, απόδοση και εμφάνιση εγγράφων VSTX σε .NET Framework, .NET Core, Mono ή COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Πρόγραμμα προβολής αρχείων VSTX for .NET" h2="Προβάλετε αρχεία Microsoft Visio VSTX στο πρόγραμμα περιήγησης χωρίς να απαιτείται Visio εφαρμογή ή αυτοματισμός Office." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για προβολή VSTX μέσω C#" %}}
...
1. Φόρτωση αρχείου VSTX με μια παρουσία κλάσης Diagram1. Καλέστε τη μέθοδο Diagram.Save με SaveFileFormat.HTML ως παραμέτρους1. Φόρτωση HTML που προκύπτει στο προεπιλεγμένο πρόγραμμα περιήγησης μέσω του Process.Start
...
{{% blocks/products/pf/agp/code-block title="C# κωδικός για προβολή VSTX" offSpacer="" %}}

```cs

// φόρτωση αρχείου VSTX μέσω μιας παρουσίας του Diagram
var diagram = new Aspose.Diagram.Diagram("template.vstx");
// μετατρέψτε το VSTX σε μορφή HTML
 ...
 Το Aspose.Diagram είναι ένας χειρισμός μορφής εγγράφου της Microsoft Visio API. Κάποιος μπορεί εύκολα να φορτώσει, να δημιουργήσει, να τροποποιήσει, να χειριστεί συμπεριλαμβανομένων των στοιχείων daigram και να μετατρέψει Visio διαγράμματα σε άλλες μορφές όπως PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF και άλλα. Είναι αυτόνομο API και δεν απαιτεί την εγκατάσταση του Microsoft Visio ή άλλου λογισμικού.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Δωρεάν εφαρμογή για προβολή VSTX" sectionDescription="Ελέγξτε τις ζωντανές επιδείξεις μας σε [Προβολή VSTX](https://products.aspose.app/diagram/viewer/vstx) με τα ακόλουθα οφέλη." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Απλώς ανεβάστε το αρχείο VSTX και πατήστε το κουμπί \"Προβολή\"." >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Κατεβάστε το αρχείο VSTX από τον σύνδεσμο, εάν απαιτείται" >}}
