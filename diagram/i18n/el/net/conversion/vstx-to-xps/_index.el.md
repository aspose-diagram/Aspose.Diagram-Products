...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή VSTX σε XPS μέσω C#" %}}
...
1. Φόρτωση αρχείου VSTX με μια παρουσία κλάσης Diagram1. Καλέστε τη μέθοδο Diagram.Save με τη διαδρομή αρχείου εξόδου και το SaveFileFormat.XPS ως παραμέτρους1. Το αρχείο XPS θα αποθηκευτεί στην καθορισμένη διαδρομή
