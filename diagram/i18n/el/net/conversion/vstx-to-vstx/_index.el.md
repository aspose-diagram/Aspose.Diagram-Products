...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε VSTX σε VSTX χρησιμοποιώντας C#" %}}
...
1. Φόρτωση αρχείου VSTX με μια παρουσία κλάσης Diagram1. Καλέστε τη μέθοδο Diagram.Save με τη διαδρομή αρχείου εξόδου και το SaveFileFormat.VSTX ως παραμέτρους1. Το αρχείο VSTX θα αποθηκευτεί στην καθορισμένη διαδρομή
...
{{% blocks/products/pf/agp/code-block title="Αυτό το δείγμα κώδικα δείχνει τη μετατροπή C# VSTX σε VSTX" offSpacer="" %}}
