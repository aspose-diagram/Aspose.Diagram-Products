---
title: Μετατροπή VSDX σε VDX μέσω C# 
weight: 130
url: /el/net/conversion/vsdx-to-vdx/ 
description: Δείγμα κώδικα για μετατροπή VSDX σε VDX C#. Χρησιμοποιήστε API παράδειγμα κώδικα για ομαδική μετατροπή αρχείων VSDX σε VDX εντός VB.NET, Asp.NET ή οποιασδήποτε εφαρμογής που βασίζεται σε .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Μετατροπή VSDX σε VDX μέσω C#" h2="Εξάγετε αρχεία Microsoft® Visio VSDX σε VDX σε .NET Framework, .NET Core, Mono ή COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Πώς να μετατρέψετε το VSDX σε VDX χρησιμοποιώντας το C#" %}}

 Για να μετατρέψουμε το VSDX σε VDX, θα χρησιμοποιήσουμε
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη μετατροπή του VSDX σε VDX μέσω C#" %}}

{{% blocks/products/pf/agp/text %}}

 Οι προγραμματιστές του .NET μπορούν εύκολα να φορτώσουν και να μετατρέψουν VSDX αρχεία σε VDX σε λίγες μόνο γραμμές κώδικα.

{{% /blocks/products/pf/agp/text %}}

1. Φόρτωση αρχείου VSDX με μια παρουσία της τάξης Diagram1. Καλέστε τη μέθοδο Diagram.Save με τη διαδρομή αρχείου εξόδου και το SaveFileFormat.VDX ως παραμέτρους1. Το αρχείο VDX θα αποθηκευτεί στην καθορισμένη διαδρομή
...
{{% blocks/products/pf/agp/code-block title="Αυτό το δείγμα κώδικα δείχνει τη μετατροπή VSDX σε VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Δωρεάν εφαρμογή για μετατροπή VSDX σε VDX" sectionDescription="Ελέγξτε τις ζωντανές επιδείξεις μας για [Μετατροπή VSDX σε VDX](https://products.aspose.app/diagram/conversion/vsdx-to-vdx) με τα ακόλουθα οφέλη." >}}
