---
title: Συγχώνευση αρχείων VSDX μέσω .NET 
weight: 460
url: /el/net/merger/vsdx/ 
description: C# πηγαίος κώδικας για συνδυασμό VSDX εγγράφων σε .NET Framework, .NET Core, Mono ή COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Συγχώνευση μορφών VSDX σε C#" h2="Εγγενής και υψηλής απόδοσης VSDX συγχώνευση εγγράφων χρησιμοποιώντας API από την πλευρά του διακομιστή Aspose.Diagram for .NET, χωρίς τη χρήση οποιουδήποτε λογισμικού όπως Microsoft ή Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Τρόπος συγχώνευσης VSDX αρχείου χρησιμοποιώντας το C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Βήματα για τη συγχώνευση VSDX αρχείων στο C#" %}}
...
+ Φόρτωση όλων των VSDX αρχείων με πλήρη διαδρομή.
...
{{% blocks/products/pf/agp/code-block title="Συγχώνευση αρχείων VSDX - C#" offSpacer="" %}}
