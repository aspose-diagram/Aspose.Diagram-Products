...
{{% blocks/products/pf/agp/feature-section-col title="Java内のVTXファイルをマージする手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VTXファイルをマージ-Java" offSpacer="" %}}
