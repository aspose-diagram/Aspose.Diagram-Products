...
{{% blocks/products/pf/agp/content h2="Javaを使用してVTXファイルをマージする方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaでVTXファイルをマージする手順" %}}
...
+Diagramクラスのインスタンスを含む最初のVTXファイルをロードします。
+Diagramクラスのインスタンスを含む2番目のVTXドキュメントをロードします。
+ Combine（）メソッドを使用してファイルをマージします。
+マージされたVTXファイルを指定されたパスに保存します
...
{{% blocks/products/pf/agp/code-block title="VTXファイルをマージする-Java" offSpacer="" %}}
