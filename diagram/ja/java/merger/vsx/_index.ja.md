---
title: Javaを介してVSXファイルをマージします 
weight: 5160
url: /ja/java/merger/vsx/ 
description: JSP/JSFアプリケーションとデスクトップアプリケーションのJavaランタイム環境でVSXドキュメントを組み合わせるためのJavaサンプルコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaのVSX形式をマージ" h2="サーバー側のJavaAPIを使用したネイティブVSXドキュメントのマージ。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してVSXファイルをマージする方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java内のVSXファイルをマージする手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSXファイルをマージ-Java" offSpacer="" %}}
