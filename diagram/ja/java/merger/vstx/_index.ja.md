...
description: JSP/JSFアプリケーションとデスクトップアプリケーションのJavaランタイム環境でVSTXドキュメントを組み合わせるためのJavaサンプルコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaのVSTX形式をマージ" h2="サーバー側のJavaAPIを使用したネイティブVSTXドキュメントのマージ。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java内のVSTXファイルをマージする手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTXファイルをマージ-Java" offSpacer="" %}}
