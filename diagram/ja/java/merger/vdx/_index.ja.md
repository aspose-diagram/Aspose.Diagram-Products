---
title: Javaを介してVDXファイルをマージします 
weight: 1830
url: /ja/java/merger/vdx/ 
description: JSP/JSFアプリケーションとデスクトップアプリケーションのJavaランタイム環境でVDXドキュメントを組み合わせるためのJavaサンプルコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaのVDX形式をマージ" h2="サーバー側のJavaAPIを使用したネイティブVDXドキュメントのマージ。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してVDXファイルをマージする方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java内のVDXファイルをマージする手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VDXファイルをマージ-Java" offSpacer="" %}}
