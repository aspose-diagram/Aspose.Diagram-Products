---
title: Javaを介してVDXファイルをマージ 
weight: 1830
url: /ja/java/merger/vdx/ 
description: Java JSP/JSFアプリケーションとデスクトップアプリケーションのランタイム環境でVDXドキュメントを組み合わせるためのサンプルコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaでVDX形式をマージ" h2="サーバー側のJavaAPIを使用したネイティブVDXドキュメントのマージ。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaでVDXファイルをマージする手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VDXファイルをマージする-Java" offSpacer="" %}}
