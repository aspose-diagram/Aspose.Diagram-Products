---
title: Javaを介してVSSXファイルをマージします 
weight: 2720
url: /ja/java/merger/vssx/ 
description: JSP/JSFアプリケーションとデスクトップアプリケーションのJavaランタイム環境でVSSXドキュメントを組み合わせるためのJavaサンプルコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaのVSSX形式をマージ" h2="サーバー側のJavaAPIを使用したネイティブVSSXドキュメントのマージ。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してVSSXファイルをマージする方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java内のVSSXファイルをマージする手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSXファイルをマージ-Java" offSpacer="" %}}
