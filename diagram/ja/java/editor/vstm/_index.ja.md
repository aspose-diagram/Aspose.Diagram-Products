---
title: Javaを介してVSTMファイルを編集する 
weight: 3390
url: /ja/java/editor/vstm/ 
description: JSP/JSFアプリケーションおよびデスクトップアプリケーションのJavaランタイム環境でVSTMドキュメントを編集するためのJavaサンプルコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaのVSTM形式を編集" h2="サーバー側のJavaAPIを使用するネイティブVSTMドキュメントエディタ。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してVSTMファイルを編集する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaのVSTMファイルを編集する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTMファイルの編集-Java" offSpacer="" %}}
