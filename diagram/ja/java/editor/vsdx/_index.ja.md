---
title: Javaを介してVSDXファイルを編集する 
weight: 3390
url: /ja/java/editor/vsdx/ 
description: JSP/JSFアプリケーションおよびデスクトップアプリケーションのJavaランタイム環境でVSDXドキュメントを編集するためのJavaサンプルコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="JavaのVSDX形式を編集" h2="サーバー側のJavaAPIを使用するネイティブVSDXドキュメントエディタ。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Javaを使用してVSDXファイルを編集する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="JavaのVSDXファイルを編集する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDXファイルの編集-Java" offSpacer="" %}}
