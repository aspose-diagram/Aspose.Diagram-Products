...
description: VSSX形式からVDXファイルへのJava変換コードのサンプル。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でVSSXをVDXに変換します。
---
...
{{% blocks/products/pf/agp/code-block title="VSSXからVDXJavaへの変換ソースコード" offSpacer="" %}}
