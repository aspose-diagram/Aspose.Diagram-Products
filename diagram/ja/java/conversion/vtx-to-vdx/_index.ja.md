...
description: VTX形式からVDXファイルへのJava変換コードのサンプル。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でVTXをVDXに変換します。
---
...
{{% blocks/products/pf/agp/code-block title="VTXからVDXJavaへの変換ソースコード" offSpacer="" %}}
