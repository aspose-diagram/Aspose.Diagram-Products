...
description: VTX形式からVSDMファイルへのJava変換コードのサンプル。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でVTXをVSDMに変換します。
---
...
{{% blocks/products/pf/agp/code-block title="VTXからVSDMJavaへの変換ソースコード" offSpacer="" %}}
