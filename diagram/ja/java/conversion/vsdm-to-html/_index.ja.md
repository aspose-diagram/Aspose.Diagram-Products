...
description: VSDM形式のHTMLファイルへのJava変換コードのサンプル。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でVSDMをHTMLに変換します。
---
...
{{% blocks/products/pf/agp/code-block title="VSDMからHTMLJavaへの変換ソースコード" offSpacer="" %}}
