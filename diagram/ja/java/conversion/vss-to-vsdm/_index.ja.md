...
description: VSS形式のVSDMファイルへのJava変換コードのサンプル。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でVSSをVSDMに変換します。
---
...
{{% blocks/products/pf/agp/code-block title="VSSからVSDMJavaへの変換ソースコード" offSpacer="" %}}
