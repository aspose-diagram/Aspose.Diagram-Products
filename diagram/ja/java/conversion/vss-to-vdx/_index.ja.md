...
description: VSS形式のVDXファイルへのJava変換コードのサンプル。このサンプルコードを使用して、WebまたはデスクトップJavaベースのアプリケーション内でVSSをVDXに変換します。
---
...
{{% blocks/products/pf/agp/code-block title="VSSからVDXJavaへの変換ソースコード" offSpacer="" %}}
