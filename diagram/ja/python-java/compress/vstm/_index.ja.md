---
title: Pythonを介してVSTMドキュメントを圧縮する 
weight: 3350
url: /ja/python-java/compress/vstm/ 
description: Pythonベースのアプリケーション内でvstmファイルを圧縮するためのPythonソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM形式をPythonで圧縮" h2="サーバー側のPythonAPIを使用したネイティブVSTMドキュメントの圧縮。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Pythonを使用してVSTMファイルを圧縮する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PythonのVSTMファイルを圧縮する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTMファイルを圧縮-Python" offSpacer="" %}}
