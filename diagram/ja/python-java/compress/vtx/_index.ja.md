...
{{% blocks/products/pf/agp/content h2="Pythonを使用してVTXファイルを圧縮する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PythonのVTXファイルを圧縮する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VTXファイルを圧縮-Python" offSpacer="" %}}
