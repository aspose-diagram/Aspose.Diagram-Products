...
{{% blocks/products/pf/agp/content h2="Pythonを使用してVSDMファイルを圧縮する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PythonのVSDMファイルを圧縮する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDMファイルを圧縮-Python" offSpacer="" %}}
