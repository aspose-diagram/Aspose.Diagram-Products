...
{{% blocks/products/pf/agp/content h2="Pythonを使用してVSSXファイルを圧縮する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PythonのVSSXファイルを圧縮する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSXファイルを圧縮-Python" offSpacer="" %}}
