...
{{% blocks/products/pf/agp/content h2="Pythonを使用してVSDXファイルを圧縮する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PythonのVSDXファイルを圧縮する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDXファイルを圧縮-Python" offSpacer="" %}}
