---
title: Pythonを介してVSSMドキュメントを圧縮する 
weight: 3350
url: /ja/python-java/compress/vssm/ 
description: Pythonベースのアプリケーション内でvssmファイルを圧縮するためのPythonソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSM形式をPythonで圧縮" h2="サーバー側のPythonAPIを使用したネイティブVSSMドキュメントの圧縮。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Pythonを使用してVSSMファイルを圧縮する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PythonのVSSMファイルを圧縮する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSMファイルを圧縮-Python" offSpacer="" %}}
