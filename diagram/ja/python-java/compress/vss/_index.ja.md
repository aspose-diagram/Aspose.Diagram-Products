...
{{% blocks/products/pf/agp/content h2="Pythonを使用してVSSファイルを圧縮する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="PythonのVSSファイルを圧縮する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSファイルの圧縮-Python" offSpacer="" %}}
