---
title: Pythonを介してVSDMをJPEGに変換します 
weight: 1960
url: /ja/python-java/conversion/vsdm-to-jpeg/ 
description: VSDM形式のJPEGファイルへのPython変換コードのサンプル。このサンプルコードを使用して、Pythonベースのアプリケーション内でVSDMをJPEGに変換します。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Pythonを介してVSDMをJPEGに変換します" h2="Python APIを使用して、MicrosoftVisioVSDMをJPEGにエクスポートします。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Pythonを使用してVSDMをJPEGに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pythonを介してVSDMをJPEGに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 Python開発者は、わずか数行のコードでVSDMファイルをJPEGに簡単に変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Diagramクラスのインスタンスを含むVSDMファイルをロードします1. 出力ファイルパスとSaveFileFormatをパラメーターとしてDiagram.saveメソッドを呼び出します1. JPEGファイルは指定されたパスに保存されます
...
{{% blocks/products/pf/agp/code-block title="VSDMからJPEGPythonへの変換ソースコード" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDMからJPEGへの変換ライブデモ" sectionDescription="[VSDMをJPEGに変換](https://products.aspose.app/diagram/conversion/vsdm-to-jpeg) 今すぐライブデモのウェブサイトにアクセスしてください。ライブデモには次の利点があります。" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/python-java/conversion/vsdm-to-html/" name="VSDMからHTMLへ" description="ハイパーテキストマークアップ言語" >}}
