---
title: .NETを介してVSTXファイルをマージします 
weight: 1450
url: /ja/net/merger/vstx/ 
description: .NET Framework、.NETコア、Mono、またはCOM相互運用機能でVSTXドキュメントを結合するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#のVSTX形式をマージ" h2="MicrosoftやOpenOffice、Adobe PDFなどのソフトウェアを使用せずに、サーバー側のAspose.Diagramfor .NETAPIを使用したネイティブで高性能なVSTXドキュメントの統合。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してVSTXファイルをマージする方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#内のVSTXファイルをマージする手順" %}}
...
+すべてのVSTXファイルをフルパスでロードします。
+1つのドキュメントをベースファイルとして作成します
+ファイルを1つずつ連結およびマージするための関連するメソッドを呼び出します。
+ Save（）メソッドを呼び出し、ファイル名（フルパス）とフォーマット（VSTX）をパラメーターとして渡します。
+これで、Microsoft Office、Adobe PDF、またはその他の互換性のあるプログラムでVSTXファイルを開いて使用できるようになりました。
...
{{% blocks/products/pf/agp/code-block title="VSTXファイルをマージ-C#" offSpacer="" %}}
