...
description: .NET Framework、.NETコア、Mono、またはCOM相互運用機能でVSTドキュメントを組み合わせるためのC#ソースコード。
---
...
+これで、Microsoft Office、Adobe PDF、またはその他の互換性のあるプログラムでVSTファイルを開いて使用できるようになりました。
