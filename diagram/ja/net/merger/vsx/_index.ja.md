...
description: .NETフレームワーク、.NETコア、Mono、またはCOM相互運用機能でVSXドキュメントを組み合わせるためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#でVSX形式をマージ" h2="MicrosoftやOpenOffice、Adobe PDFなどのソフトウェアを使用せずに、サーバー側のAspose.Diagramfor .NETAPIを使用したネイティブで高性能なVSXドキュメントのマージ。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#でVSXファイルをマージする手順" %}}
...
+これで、Microsoft Office、Adobe PDF、またはその他の互換性のあるプログラムでVSXファイルを開いて使用できます。
...
{{% blocks/products/pf/agp/code-block title="VSXファイルのマージ-C#" offSpacer="" %}}
