---
title: .NETを介してVDWドキュメントに組織図を作成します 
weight: 3050
url: /ja/net/organizationchart/vdw/ 
description: .NET Framework、.NETコア、Monoプラットフォームのvdwファイルに組織図を作成するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#のVDWで組織図を作成する" h2="ネイティブで高性能なため、サーバー側のAspose.Diagram for .NET APIを使用して、VDWドキュメントに組織図を作成します。MicrosoftやOpen Office、AdobePDFなどのソフトウェアは使用しません。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してVDWファイルに組織図を作成する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#のVDWファイルで組織図を作成する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VDWファイルで組織図を作成する-C#" offSpacer="" %}}
