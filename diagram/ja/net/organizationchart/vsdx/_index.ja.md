---
title: .NETを介してVSDXドキュメントに組織図を作成します 
weight: 3050
url: /ja/net/organizationchart/vsdx/ 
description: .NET Framework、.NETコア、Monoプラットフォームのvsdxファイルに組織図を作成するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#のVSDXに組織図を作成する" h2="ネイティブで高性能なため、MicrosoftやOpen Office、Adobe PDFなどのソフトウェアを使用せずに、サーバー側のAspose.Diagramfor .NETAPIを使用してVSDXドキュメントに組織図を作成します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してVSDXファイルに組織図を作成する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSDXファイルに組織図を作成する手順C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDXファイルで組織図を作成する-C#" offSpacer="" %}}
