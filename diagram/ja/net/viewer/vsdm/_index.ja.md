---
title: .NETを介してVSDMファイル形式を表示する 
weight: 1210
url: /ja/net/viewer/vsdm/ 
description: .NETフレームワーク、.NETコア、Mono、またはCOM相互運用機能でVSDMドキュメントをロード、レンダリング、および表示するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDMファイルビューアfor .NET" h2="VisioアプリケーションやOfficeAutomationを必要とせずに、ブラウザでMicrosoftVisioVSDMファイルを表示します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#を介してVSDMを表示する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDMを表示するためのC#コード" offSpacer="" %}}
