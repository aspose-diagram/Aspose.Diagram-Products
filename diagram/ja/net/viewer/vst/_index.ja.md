---
title: .NET経由でVSTファイル形式を表示 
weight: 4690
url: /ja/net/viewer/vst/ 
description: .NET Framework、.NET Core、Mono、またはCOM InteropでVSTドキュメントをロード、レンダリング、表示するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTファイルビューアfor .NET" h2="VisioアプリケーションやOfficeAutomationを必要とせずに、ブラウザーでMicrosoftVisioVSTファイルを表示します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VST" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
