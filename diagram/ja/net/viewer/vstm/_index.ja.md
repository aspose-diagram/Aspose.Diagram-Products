---
title: .NETを介してVSTMファイル形式を表示 
weight: 2230
url: /ja/net/viewer/vstm/ 
description: .NET Framework、.NETコア、Mono、またはCOM相互運用機能でVSTMドキュメントをロード、レンダリング、表示するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTMファイルビューアfor .NET" h2="VisioアプリケーションやOffice自動化を必要とせずに、ブラウザでMicrosoftVisioVSTMファイルを表示します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/code-block title="C#表示するコードVSTM" offSpacer="" %}}
