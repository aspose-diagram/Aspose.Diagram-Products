---
title: .NET経由でVSSXファイル形式を表示 
weight: 1980
url: /ja/net/viewer/vssx/ 
description: .NETフレームワーク、.NETコア、Mono、またはCOM相互運用機能でVSSXドキュメントをロード、レンダリング、および表示するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSXファイルビューアfor .NET" h2="VisioアプリケーションやOfficeAutomationを必要とせずに、ブラウザでMicrosoftVisioVSSXファイルを表示します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#を介してVSSXを表示する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSXを表示するためのC#コード" offSpacer="" %}}
