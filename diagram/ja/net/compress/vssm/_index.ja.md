...
{{% blocks/products/pf/agp/feature-section-col title="C#のVSSMファイルを圧縮する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSMファイルを圧縮-C#" offSpacer="" %}}
