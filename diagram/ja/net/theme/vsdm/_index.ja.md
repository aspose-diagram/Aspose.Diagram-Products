---
title: .NETを介してVSDMドキュメントにプリセットテーマを適用します 
weight: 3050
url: /ja/net/theme/vsdm/ 
description: .NET Framework、.NETコア、Monoプラットフォーム上のvsdmファイルにプリセットテーマを適用するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#のVSDMにプリセットテーマを適用する" h2="ネイティブで高性能なため、MicrosoftやOpen Office、Adobe PDFなどのソフトウェアを使用せずに、サーバー側のAspose.Diagramfor .NETAPIを使用してVSDMドキュメントにプリセットテーマを適用します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してVSDMファイルにプリセットテーマを適用する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="プリセットテーマをC#のVSDMファイルに適用する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="プリセットテーマをVSDMファイルに適用-C#" offSpacer="" %}}
