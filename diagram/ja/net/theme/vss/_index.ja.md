---
title: .NETを介してVSSドキュメントにプリセットテーマを適用します 
weight: 3050
url: /ja/net/theme/vss/ 
description: .NET Framework、.NETコア、Monoプラットフォーム上のvssファイルにプリセットテーマを適用するためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#のVSSにプリセットテーマを適用する" h2="ネイティブで高性能なプリセットテーマは、サーバー側のAspose.Diagram for .NET APIを使用して、MicrosoftやOpen Office、AdobePDFなどのソフトウェアを使用せずにVSSドキュメントに適用します。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してプリセットテーマをVSSファイルに適用する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#のVSSファイルにプリセットテーマを適用する手順" %}}
...
{{% blocks/products/pf/agp/code-block title="プリセットテーマをVSSファイルに適用-C#" offSpacer="" %}}
