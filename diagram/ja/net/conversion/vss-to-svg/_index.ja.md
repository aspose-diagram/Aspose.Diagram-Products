---
title: C#を介してVSSをSVGに変換する 
weight: 3090
url: /ja/net/conversion/vss-to-svg/ 
description: VSSからSVGC#への変換のサンプルコード。 VB .NET、Asp .NET、または任意の.NETベースのアプリケーション内でのバッチVSSファイルからSVGへの変換にはAPIサンプルコードを使用します。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#を介してVSSをSVGに変換する" h2="Microsoft®VisioVSSファイルを.NETFramework、.NETコア、Mono、またはCOM相互運用機能のSVGにエクスポートします。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してVSSをSVGに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#を介してVSSをSVGに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 .NET開発者は、わずか数行のコードでVSSファイルを簡単にロードしてSVGに変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Diagramクラスのインスタンスを含むVSSファイルをロードします1. 出力ファイルパスとSaveFileFormat.SVGをパラメーターとして使用してDiagram.Saveメソッドを呼び出します1. SVGファイルは指定されたパスに保存されます
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、VSSからSVGC#への変換を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSをSVGに変換する無料アプリ" sectionDescription="ライブデモをチェックしてください [VSSからSVGへの変換](https://products.aspose.app/diagram/conversion/vss-to-svg) 以下の利点があります。" >}}
