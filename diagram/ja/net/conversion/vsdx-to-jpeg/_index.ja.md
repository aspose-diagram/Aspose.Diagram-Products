---
title: C#を介してVSDXをJPEGに変換します 
weight: 2930
url: /ja/net/conversion/vsdx-to-jpeg/ 
description: VSDXからJPEGC#への変換のサンプルコード。 VB .NET、Asp .NET、または任意の.NETベースのアプリケーション内でのバッチVSDXファイルからJPEGへの変換にはAPIサンプルコードを使用します。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#を介してVSDXをJPEGに変換します" h2="Microsoft®VisioVSDXファイルを.NETフレームワーク、.NETコア、Mono、またはCOM相互運用機能のJPEGにエクスポートします。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してVSDXをJPEGに変換する方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#を介してVSDXをJPEGに変換する手順" %}}

{{% blocks/products/pf/agp/text %}}

 .NET開発者は、わずか数行のコードでVSDXファイルを簡単にロードしてJPEGに変換できます。

{{% /blocks/products/pf/agp/text %}}

1. Diagramクラスのインスタンスを含むVSDXファイルをロードします1. 出力ファイルパスとSaveFileFormat.JPEGをパラメーターとして使用してDiagram.Saveメソッドを呼び出します1. JPEGファイルは指定されたパスに保存されます
...
{{% blocks/products/pf/agp/code-block title="このサンプルコードは、VSDXからJPEGC#への変換を示しています" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDXをJPEGに変換する無料アプリ" sectionDescription="ライブデモをチェックしてください [VSDXからJPEGへの変換](https://products.aspose.app/diagram/conversion/vsdx-to-jpeg) 以下の利点があります。" >}}
