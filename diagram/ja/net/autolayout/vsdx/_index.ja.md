---
title: .NETを介したVSDXドキュメントの自動レイアウト 
weight: 3050
url: /ja/net/autolayout/vsdx/ 
description: .NET Framework、.NETコア、Monoプラットフォームでvsdxファイルを自動レイアウトするためのC#ソースコード。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#の自動レイアウトVSDXドキュメント" h2="MicrosoftやOpenOffice、Adobe PDFなどのソフトウェアを使用せずに、サーバー側のAspose.Diagramfor .NETAPIを使用したネイティブで高性能な自動レイアウトVSDXドキュメント。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#を使用してVSDXファイルを自動レイアウトする方法" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#のVSDXファイルを自動レイアウトするための手順" %}}
...
{{% blocks/products/pf/agp/code-block title="自動レイアウトVSDXファイル-C#" offSpacer="" %}}
