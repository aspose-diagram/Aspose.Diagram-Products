...
{{% blocks/products/pf/agp/content h2="كيفية التخطيط التلقائي VSTM للملف باستخدام C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ملفات التخطيط التلقائي VSTM في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ملفات VSTM التخطيط التلقائي - C#" offSpacer="" %}}
