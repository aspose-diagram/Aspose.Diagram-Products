---
title: مستند تخطيط تلقائي VSSX عبر .NET 
weight: 3050
url: /ar/net/autolayout/vssx/ 
description: C# شفرة المصدر إلى ملف التخطيط التلقائي vssx على .NET Framework ، .NET أساسي ، Mono الأنظمة الأساسية.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="مستند التخطيط التلقائي VSSX باللغة C#" h2="مستند تخطيط تلقائي أصلي وعالي الأداء VSSX باستخدام واجهات برمجة تطبيقات Aspose.Diagram for .NET من جانب الخادم ، بدون استخدام أي برنامج مثل Microsoft أو فتح Office ، Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية التخطيط التلقائي VSSX للملف باستخدام C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ملفات التخطيط التلقائي VSSX في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ملفات VSSX التخطيط التلقائي - C#" offSpacer="" %}}
