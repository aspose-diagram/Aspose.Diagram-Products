---
title: حماية وتأمين VSDM المستند عبر .NET 
weight: 5580
url: /ar/net/protect/vsdm/ 
description: C# كود المصدر لقفل VSDM الملف على .NET Framework ، .NET أساسي ، Mono الأنظمة الأساسية.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="حماية VSDM الملفات عبر C#" h2="حماية Visio بما في ذلك VSDM التنسيق باستخدام .NET المكتبة." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية حماية VSDM الملفات باستخدام C#" %}}

 من أجل حماية ملف VSDM ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات حماية ملفات VSDM في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="حماية ملفات VSDM - C#" offSpacer="" %}}
