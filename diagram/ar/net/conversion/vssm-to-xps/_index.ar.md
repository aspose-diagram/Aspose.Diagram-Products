---
title: تحويل VSSM إلى XPS عبر C# 
weight: 600
url: /ar/net/conversion/vssm-to-xps/ 
description: نموذج رمز للتحويل من VSSM إلى XPS C#. استخدم API رمز المثال لملفات الدُفعات VSSM لتحويل XPS داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSSM إلى XPS عبر C#" h2="قم بتصدير ملفات Microsoft ® Visio VSSM إلى XPS على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSSM إلى XPS باستخدام C#" %}}

 لتحويل VSSM إلى XPS ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSSM إلى XPS عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VSSM بسهولة إلى XPS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSSM بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.XPS كمعلمات1. سيتم حفظ ملف XPS في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VSSM إلى XPS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSSM إلى XPS" sectionDescription="تحقق من العروض الحية لدينا ل [VSSM لتحويل XPS](https://products.aspose.app/diagram/conversion/vssm-to-xps) مع الفوائد التالية." >}}
