---
title: تحويل VSSM إلى XAML عبر C# 
weight: 2830
url: /ar/net/conversion/vssm-to-xaml/ 
description: نموذج رمز للتحويل من VSSM إلى XAML C#. استخدم API رمز المثال لملفات الدُفعات VSSM لتحويل XAML داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSSM إلى XAML عبر C#" h2="تصدير ملفات Microsoft ® Visio VSSM إلى XAML على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSSM إلى XAML باستخدام C#" %}}

 لتحويل VSSM إلى XAML ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSSM إلى XAML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VSSM بسهولة إلى XAML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSSM بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.XAML كمعلمات1. سيتم حفظ ملف XAML في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VSSM إلى XAML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSSM إلى XAML" sectionDescription="تحقق من العروض الحية لدينا ل [VSSM لتحويل XAML](https://products.aspose.app/diagram/conversion/vssm-to-xaml) مع الفوائد التالية." >}}
