---
title: تحويل VSTX إلى XAML عبر C# 
weight: 2280
url: /ar/net/conversion/vstx-to-xaml/ 
description: نموذج رمز للتحويل من VSTX إلى XAML C#. استخدم API رمز المثال لملفات الدُفعات VSTX لتحويل XAML داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSTX إلى XAML عبر C#" h2="تصدير ملفات Microsoft ® Visio VSTX إلى XAML على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSTX إلى XAML باستخدام C#" %}}

 لتحويل VSTX إلى XAML ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSTX إلى XAML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VSTX بسهولة إلى XAML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSTX بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.XAML كمعلمات1. سيتم حفظ ملف XAML في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VSTX إلى XAML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSTX إلى XAML" sectionDescription="تحقق من العروض الحية لدينا ل [VSTX لتحويل XAML](https://products.aspose.app/diagram/conversion/vstx-to-xaml) مع الفوائد التالية." >}}
