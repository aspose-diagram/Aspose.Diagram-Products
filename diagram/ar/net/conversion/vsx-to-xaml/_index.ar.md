...
description: نموذج كود لتحويل VSX إلى XAML C#. استخدم API رمز المثال لملفات VSX المجمعة لتحويل XAML داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSX إلى XAML عبر C#" h2="قم بتصدير ملفات Microsoft® Visio VSX إلى XAML على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSX إلى XAML باستخدام C#" %}}
 ...
 من أجل تحويل VSX إلى XAML ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري .NET تحميل ملفات VSX وتحويلها بسهولة إلى XAML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.XAML كمعلمات1. سيتم حفظ ملف XAML في المسار المحدد
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSX إلى XAML" sectionDescription="تحقق من العروض الحية لدينا ل [تحويل VSX إلى XAML](https://products.aspose.app/diagram/conversion/vsx-to-xaml) مع الفوائد التالية." >}}
