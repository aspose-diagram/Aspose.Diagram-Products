---
title: تحويل VSTX إلى VSX عبر C# 
weight: 1280
url: /ar/net/conversion/vstx-to-vsx/ 
description: نموذج رمز للتحويل من VSTX إلى VSX C#. استخدم API رمز المثال لملفات الدُفعات VSTX VSX للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSTX إلى VSX عبر C#" h2="تصدير ملفات Microsoft ® Visio VSTX إلى VSX على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSTX إلى VSX باستخدام C#" %}}

 لتحويل VSTX إلى VSX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من VSTX إلى VSX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VSTX بسهولة إلى VSX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSTX بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat. VSX كمعلمات1. سيتم حفظ ملف VSX في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من VSTX إلى VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني للتحويل من VSTX إلى VSX" sectionDescription="تحقق من العروض الحية لدينا ل [VSTX إلى VSX التحويل](https://products.aspose.app/diagram/conversion/vstx-to-vsx) مع الفوائد التالية." >}}
