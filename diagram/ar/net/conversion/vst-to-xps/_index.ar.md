---
title: تحويل VST إلى XPS عبر C# 
weight: 3700
url: /ar/net/conversion/vst-to-xps/ 
description: نموذج كود لتحويل VST إلى XPS C#. استخدم API رمز المثال لملفات VST المجمعة لتحويل XPS داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VST إلى XPS عبر C#" h2="قم بتصدير ملفات Microsoft ® Visio VST إلى XPS على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VST إلى XPS باستخدام C#" %}}

 من أجل تحويل VST إلى XPS ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VST إلى XPS عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل ملفات VST وتحويلها بسهولة إلى XPS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VST بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.XPS كمعلمات1. سيتم حفظ ملف XPS في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VST إلى XPS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VST إلى XPS" sectionDescription="تحقق من العروض الحية لدينا ل [VST لتحويل XPS](https://products.aspose.app/diagram/conversion/vst-to-xps) مع الفوائد التالية." >}}
