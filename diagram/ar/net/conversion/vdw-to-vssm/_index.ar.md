...
description: نموذج رمز لتحويل VDW إلى VSSM C#. استخدم API رمز المثال لملفات VDW المجمعة VSSM للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VDW إلى VSSM استخدام C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري .NET تحميل وتحويل ملفات VDW بسهولة إلى VSSM في بضعة أسطر من التعليمات البرمجية.
