...
description: نموذج رمز لتحويل VDW إلى VSDM C#. استخدم API رمز المثال لملفات VDW المجمعة VSDM للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VDW إلى VSDM استخدام C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري .NET تحميل وتحويل ملفات VDW بسهولة إلى VSDM في بضعة أسطر من التعليمات البرمجية.
