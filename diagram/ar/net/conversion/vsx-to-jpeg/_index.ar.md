...
description: نموذج كود لتحويل VSX إلى JPEG C#. استخدم API رمز المثال لملفات VSX المجمعة لتحويل JPEG داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSX إلى JPEG باستخدام C#" %}}
 ...
 من أجل تحويل VSX إلى JPEG ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSX إلى JPEG عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج .NET تحميل ملفات VSX وتحويلها بسهولة إلى JPEG في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.JPEG كمعلمات1. سيتم حفظ ملف JPEG في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VSX إلى JPEG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSX إلى JPEG" sectionDescription="تحقق من العروض الحية لدينا ل [تحويل VSX إلى JPEG](https://products.aspose.app/diagram/conversion/vsx-to-jpeg) مع الفوائد التالية." >}}
