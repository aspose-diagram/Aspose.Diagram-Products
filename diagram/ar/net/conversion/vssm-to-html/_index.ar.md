---
title: تحويل VSSM إلى HTML عبر C# 
weight: 510
url: /ar/net/conversion/vssm-to-html/ 
description: نموذج رمز للتحويل من VSSM إلى HTML C#. استخدم API رمز المثال لملفات الدُفعات VSSM لتحويل HTML داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSSM إلى HTML عبر C#" h2="قم بتصدير ملفات Microsoft ® Visio VSSM إلى HTML على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSSM إلى HTML باستخدام C#" %}}

 سنستخدمها لتحويل VSSM إلى HTML
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSSM إلى HTML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل VSSM ملفات بسهولة إلى HTML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSSM بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.HTML كمعلمات1. سيتم حفظ ملف HTML في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من VSSM إلى HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSSM إلى HTML" sectionDescription="تحقق من العروض الحية لدينا ل [VSSM لتحويل HTML](https://products.aspose.app/diagram/conversion/vssm-to-html) مع الفوائد التالية." >}}
