---
title: حوِّل VSTX إلى SVG عبر C# 
weight: 1410
url: /ar/net/conversion/vstx-to-svg/ 
description: نموذج رمز للتحويل من VSTX إلى SVG C#. استخدم API رمز المثال لملفات الدُفعات VSTX لتحويل SVG داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="حوِّل VSTX إلى SVG عبر C#" h2="قم بتصدير ملفات Microsoft ® Visio VSTX إلى SVG على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSTX إلى SVG باستخدام C#" %}}

 من أجل تحويل VSTX إلى SVG ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من VSTX إلى SVG عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VSTX بسهولة إلى SVG في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSTX بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.SVG كمعلمات1. سيتم حفظ ملف SVG في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا VSTX لتحويل SVG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSTX إلى SVG" sectionDescription="تحقق من العروض الحية لدينا ل [VSTX لتحويل SVG](https://products.aspose.app/diagram/conversion/vstx-to-svg) مع الفوائد التالية." >}}
