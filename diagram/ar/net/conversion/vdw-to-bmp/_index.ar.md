---
title: تحويل VDW إلى BMP عبر C# 
weight: 80
url: /ar/net/conversion/vdw-to-bmp/ 
description: نموذج كود لتحويل VDW إلى BMP C#. استخدم API رمز المثال لملفات VDW المجمعة لتحويل BMP داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VDW إلى BMP عبر C#" h2="قم بتصدير ملفات Microsoft® Visio VDW إلى BMP على .NET Framework ، .NET Core ، Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VDW إلى BMP باستخدام C#" %}}

 من أجل تحويل VDW إلى BMP ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VDW إلى BMP عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج .NET تحميل وتحويل ملفات VDW إلى BMP بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VDW بنسخة من فئة Diagram1. استدعاء Diagram أسلوب حفظ مع مسار ملف الإخراج و SaveFileFormat.BMP كمعلمات1. سيتم حفظ ملف BMP في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا تحويل VDW إلى BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VDW إلى BMP" sectionDescription="تحقق من العروض الحية لدينا ل [VDW لتحويل BMP](https://products.aspose.app/diagram/conversion/vdw-to-bmp) مع الفوائد التالية." >}}
