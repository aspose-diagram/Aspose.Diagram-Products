...
description: نموذج رمز للتحويل من VSTX إلى VDX C#. استخدم API رمز المثال لملفات الدُفعات VSTX VDX للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSTX إلى VDX عبر C#" h2="تصدير ملفات Microsoft ® Visio VSTX إلى VDX على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من VSTX إلى VDX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VSTX بسهولة إلى VDX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSTX بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat. VDX كمعلمات1. سيتم حفظ ملف VDX في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من VSTX إلى VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني للتحويل من VSTX إلى VDX" sectionDescription="تحقق من العروض الحية لدينا ل [VSTX إلى VDX التحويل](https://products.aspose.app/diagram/conversion/vstx-to-vdx) مع الفوائد التالية." >}}
