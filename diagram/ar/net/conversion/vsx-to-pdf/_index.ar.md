---
title: تحويل VSX إلى PDF عبر C# 
weight: 4360
url: /ar/net/conversion/vsx-to-pdf/ 
description: نموذج رمز للتحويل من VSX إلى PDF C#. استخدم API رمز المثال للملفات المجمعة VSX لتحويل ملفات PDF داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSX إلى PDF عبر C#" h2="تصدير ملفات Microsoft ® Visio VSX إلى PDF على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSX إلى PDF باستخدام C#" %}}

 من أجل تحويل VSX إلى PDF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSX إلى PDF عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن للمطورين .NET تحميل وتحويل ملفات VSX بسهولة إلى PDF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSX بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.PDF كمعلمات1. سيتم حفظ ملف PDF في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من VSX إلى PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSX إلى PDF" sectionDescription="تحقق من العروض الحية لدينا ل [VSX لتحويل PDF](https://products.aspose.app/diagram/conversion/vsx-to-pdf) مع الفوائد التالية." >}}
