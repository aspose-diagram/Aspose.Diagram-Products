---
title: تحويل VDW إلى HTML عبر C# 
weight: 1350
url: /ar/net/conversion/vdw-to-html/ 
description: نموذج رمز لتحويل VDW إلى HTML C#. استخدم API رمز المثال لملفات VDW المجمعة لتحويل HTML داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VDW إلى HTML عبر C#" h2="قم بتصدير ملفات Microsoft® Visio VDW إلى HTML على .NET Framework ، .NET Core ، Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VDW إلى HTML باستخدام C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VDW إلى HTML عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VDW إلى HTML بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VDW بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.HTML كمعلمات1. سيتم حفظ ملف HTML في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج التعليمات البرمجية هذا تحويل VDW إلى HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VDW إلى HTML" sectionDescription="تحقق من العروض الحية لدينا ل [VDW لتحويل HTML](https://products.aspose.app/diagram/conversion/vdw-to-html) مع الفوائد التالية." >}}
