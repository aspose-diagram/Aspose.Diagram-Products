...
description: نموذج رمز لتحويل VDW إلى VDX C#. استخدم API رمز المثال لملفات VDW المجمعة VDX للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VDW إلى VDX استخدام C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري .NET تحميل وتحويل ملفات VDW بسهولة إلى VDX في بضعة أسطر من التعليمات البرمجية.
