---
title: تحويل VSSM إلى BMP عبر C# 
weight: 4270
url: /ar/net/conversion/vssm-to-bmp/ 
description: نموذج رمز للتحويل من VSSM إلى BMP C#. استخدم API رمز المثال لملفات الدُفعات VSSM لتحويل BMP داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSSM إلى BMP عبر C#" h2="قم بتصدير ملفات Microsoft ® Visio VSSM إلى BMP على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSSM إلى BMP باستخدام C#" %}}

 من أجل تحويل VSSM إلى BMP ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSSM إلى BMP عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VSSM بسهولة إلى BMP في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSSM بمثيل من فئة Diagram1. استدعاء Diagram أسلوب حفظ مع مسار ملف الإخراج و SaveFileFormat.BMP كمعلمات1. سيتم حفظ ملف BMP في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا VSSM لتحويل BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSSM إلى BMP" sectionDescription="تحقق من العروض الحية لدينا ل [VSSM لتحويل BMP](https://products.aspose.app/diagram/conversion/vssm-to-bmp) مع الفوائد التالية." >}}
