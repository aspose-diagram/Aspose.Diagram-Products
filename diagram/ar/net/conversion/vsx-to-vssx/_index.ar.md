---
title: تحويل VSX إلى VSSX عبر C# 
weight: 5310
url: /ar/net/conversion/vsx-to-vssx/ 
description: نموذج رمز للتحويل من VSX إلى VSSX C#. استخدم API رمز المثال لملفات الدُفعات VSX VSSX للتحويل داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSX إلى VSSX عبر C#" h2="تصدير ملفات Microsoft ® Visio VSX إلى VSSX على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSX إلى VSSX باستخدام C#" %}}

 لتحويل VSX إلى VSSX ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من VSX إلى VSSX عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VSX بسهولة إلى VSSX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSX بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat. VSSX كمعلمات1. سيتم حفظ ملف VSSX في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من VSX إلى VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني للتحويل من VSX إلى VSSX" sectionDescription="تحقق من العروض الحية لدينا ل [VSX إلى VSSX التحويل](https://products.aspose.app/diagram/conversion/vsx-to-vssx) مع الفوائد التالية." >}}
