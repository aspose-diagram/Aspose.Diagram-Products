---
title: تحويل VSSM إلى EMF عبر C# 
weight: 4680
url: /ar/net/conversion/vssm-to-emf/ 
description: نموذج رمز للتحويل من VSSM إلى EMF C#. استخدم API رمز المثال لملفات الدُفعات VSSM لتحويل EMF داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSSM إلى EMF عبر C#" h2="قم بتصدير ملفات Microsoft ® Visio VSSM إلى EMF على .NET Framework أو .NET Core أو Mono أو COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSSM إلى EMF باستخدام C#" %}}

 من أجل تحويل VSSM إلى EMF ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من VSSM إلى EMF عبر C#" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري .NET تحميل وتحويل ملفات VSSM بسهولة إلى EMF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSSM بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.EMF كمعلمات1. سيتم حفظ ملف EMF في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="يوضح نموذج الشفرة هذا التحويل من VSSM إلى EMF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="تطبيق مجاني لتحويل VSSM إلى EMF" sectionDescription="تحقق من العروض الحية لدينا ل [VSSM لتحويل EMF](https://products.aspose.app/diagram/conversion/vssm-to-emf) مع الفوائد التالية." >}}
