...
description: نموذج كود لتحويل VSX إلى XPS C#. استخدم API رمز المثال لملفات VSX المجمعة لتحويل XPS داخل VB .NET أو Asp .NET أو أي تطبيق قائم على .NET.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSX إلى XPS باستخدام C#" %}}
 ...
 من أجل تحويل VSX إلى XPS ، سنستخدم
...
{{% blocks/products/pf/agp/text %}}
 ...
 يمكن لمطوري .NET تحميل ملفات VSX وتحويلها بسهولة إلى XPS في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat.XPS كمعلمات1. سيتم حفظ ملف XPS في المسار المحدد
