---
title: رسم هندسيًا إلى VSTM المستند عبر .NET 
weight: 3050
url: /ar/net/drawing/vstm/ 
description: C# كود المصدر لرسم geomtry to vstm file on .NET Framework، .NET Core، Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="رسم Geomtry إلى VSTM في C#" h2="رسم أصلي وعالي الأداء لمحاولة VSTM المستند باستخدام واجهات برمجة تطبيقات Aspose.Diagram for .NET من جانب الخادم ، بدون استخدام أي برنامج مثل Microsoft أو فتح Office ، Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية رسم Geomtry إلى VSTM ملف باستخدام C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات رسم Geomtry إلى VSTM ملفات في C#" %}}
...
{{% blocks/products/pf/agp/code-block title="ارسم Geomtry إلى VSTM من الملفات - C#" offSpacer="" %}}
