...
{{% blocks/products/pf/agp/content h2="كيفية التخطيط التلقائي VDX للملف باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ملفات التخطيط التلقائي VDX في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ملفات VDX التخطيط التلقائي - Java" offSpacer="" %}}
