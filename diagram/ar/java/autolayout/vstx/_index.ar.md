...
{{% blocks/products/pf/agp/content h2="كيفية التخطيط التلقائي VSTX للملف باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ملفات التخطيط التلقائي VSTX في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ملفات VSTX التخطيط التلقائي - Java" offSpacer="" %}}
