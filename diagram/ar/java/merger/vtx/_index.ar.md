...
+ قم بتحميل مستند VTX الثاني بمثيل من فئة Diagram.
+ دمج الملفات باستخدام طريقة ().
+ احفظ الملف المدمج VTX في المسار المحدد
