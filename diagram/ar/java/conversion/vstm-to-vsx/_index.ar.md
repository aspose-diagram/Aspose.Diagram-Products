...
description: نموذج رمز تحويل Java لتنسيق VSTM إلى ملف VSX. استخدم رمز المثال هذا لتحويل VSTM إلى VSX داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSTM إلى VSX عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف VSTM إلى VSX في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSTM بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat كمعلمات1. سيتم حفظ ملف VSX في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="VSTM إلى رمز مصدر التحويل VSX Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل VSTM إلى VSX" sectionDescription="[تحويل VSTM إلى VSX](https://products.aspose.app/diagram/conversion/vstm-to-vsx) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
