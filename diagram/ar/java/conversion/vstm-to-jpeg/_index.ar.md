---
title: تحويل VSTM إلى JPEG عبر Java 
weight: 1240
url: /ar/java/conversion/vstm-to-jpeg/ 
description: نموذج Java رمز التحويل لتنسيق VSTM إلى ملف JPEG. استخدم رمز المثال هذا لتحويل VSTM إلى JPEG داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSTM إلى JPEG باستخدام Java" %}}

 من أجل تقديم VSTM إلى JPEG ، سنستخدم ملفات
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSTM إلى JPEG عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف VSTM إلى JPEG في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSTM بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat كمعلمات1. سيتم حفظ ملف JPEG في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="VSTM إلى رمز مصدر التحويل JPEG Java" offSpacer="" %}}

```cs
// تحميل VSTM في كائن Diagram 
Diagram visio = new Diagram("template.vstm");
// احفظ VSTM بتنسيق JPEG 
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل VSTM إلى JPEG" sectionDescription="[تحويل VSTM إلى JPEG](https://products.aspose.app/diagram/conversion/vstm-to-jpeg) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف VSTM الخاص بك ، وسيتم تحويله على الفور إلى JPEG." >}}
