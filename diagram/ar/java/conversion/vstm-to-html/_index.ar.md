...
description: نموذج رمز تحويل Java لتنسيق VSTM إلى ملف HTML. استخدم رمز المثال هذا لتحويل VSTM إلى HTML داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
1. قم بتحميل ملف VSTM بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat كمعلمات1. سيتم حفظ ملف HTML في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="VSTM إلى HTML Java رمز مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل VSTM إلى HTML" sectionDescription="[تحويل VSTM إلى HTML](https://products.aspose.app/diagram/conversion/vstm-to-html) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
