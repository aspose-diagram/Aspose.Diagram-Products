---
title: تحويل VSTM إلى HTML عبر Java 
weight: 1540
url: /ar/java/conversion/vstm-to-html/ 
description: نموذج Java رمز التحويل من أجل تنسيق VSTM إلى ملف HTML. استخدم رمز المثال هذا لتحويل VSTM إلى HTML داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSTM إلى HTML عبر Java" h2="تصدير Microsoft Visio VSTM إلى HTML باستخدام مكتبة Java أصلية." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSTM إلى HTML باستخدام Java" %}}

 من أجل تقديم VSTM إلى HTML ، سنستخدم
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSTM إلى HTML عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف VSTM إلى HTML في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSTM بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat كمعلمات1. سيتم حفظ ملف HTML في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="VSTM إلى شفرة مصدر التحويل HTML Java" offSpacer="" %}}

```cs
// تحميل VSTM في كائن Diagram 
Diagram visio = new Diagram("template.vstm");
// احفظ VSTM بتنسيق HTML 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM إلى عروض توضيحية مباشرة لتحويل HTML" sectionDescription="[تحويل VSTM إلى HTML](https://products.aspose.app/diagram/conversion/vstm-to-html) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" لا حاجة لتنزيل Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" لا حاجة لكتابة أي كود." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" ما عليك سوى تحميل ملف VSTM الخاص بك ، وسيتم تحويله على الفور إلى HTML." >}}
