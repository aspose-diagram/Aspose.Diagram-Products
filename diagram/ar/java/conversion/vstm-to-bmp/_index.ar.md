...
description: نموذج Java شفرة تحويل VSTM إلى ملف BMP. استخدم رمز المثال هذا لتحويل VSTM إلى BMP داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/code-block title="VSTM إلى BMP Java شفرة مصدر التحويل" offSpacer="" %}}
