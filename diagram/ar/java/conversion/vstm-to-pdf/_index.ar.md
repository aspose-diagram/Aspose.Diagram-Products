...
description: نموذج Java رمز التحويل من تنسيق VSTM إلى ملف PDF. استخدم رمز المثال هذا لتحويل VSTM إلى PDF داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSTM إلى PDF باستخدام Java" %}}
 ...
 من أجل تقديم VSTM إلى PDF ، سنستخدمه
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java يمكن للمطورين بسهولة تحويل ملف VSTM إلى PDF في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. تحميل ملف VSTM بمثيل من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat كمعلمات1. سيتم حفظ ملف PDF في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="VSTM إلى PDF Java شفرة مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM إلى عروض توضيحية مباشرة لتحويل PDF" sectionDescription="[تحويل VSTM إلى PDF](https://products.aspose.app/diagram/conversion/vstm-to-pdf) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
