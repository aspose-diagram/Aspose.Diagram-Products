...
description: نموذج Java شفرة تحويل من تنسيق VSX إلى ملف VDX. استخدم رمز المثال هذا لتحويل VSX إلى VDX داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من VSX إلى VDX عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java تحويل VSX ملف إلى VDX بسهولة في بضعة أسطر من التعليمات البرمجية.
