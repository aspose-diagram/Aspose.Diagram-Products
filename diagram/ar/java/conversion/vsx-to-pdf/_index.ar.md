---
title: تحويل VSX إلى PDF عبر Java 
weight: 2950
url: /ar/java/conversion/vsx-to-pdf/ 
description: نموذج رمز تحويل Java لتنسيق VSX إلى ملف PDF. استخدم رمز المثال هذا لتحويل VSX إلى PDF داخل أي تطبيق يعتمد على الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSX إلى PDF عبر Java" h2="تصدير Microsoft Visio VSX إلى PDF باستخدام مكتبة Java أصلية." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSX إلى PDF باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSX إلى PDF عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج Java تحويل ملف VSX إلى PDF بسهولة في بضعة أسطر من التعليمات البرمجية.

{{% /blocks/products/pf/agp/text %}}

1. قم بتحميل ملف VSX بنسخة من فئة Diagram1. استدعاء Diagram طريقة حفظ مع مسار ملف الإخراج و SaveFileFormat كمعلمات1. سيتم حفظ ملف PDF في المسار المحدد
...
{{% blocks/products/pf/agp/code-block title="VSX إلى PDF Java رمز مصدر التحويل" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="عروض توضيحية مباشرة لتحويل VSX إلى PDF" sectionDescription="[تحويل VSX إلى PDF](https://products.aspose.app/diagram/conversion/vsx-to-pdf) الآن من خلال زيارة موقع Live Demos الخاص بنا ، حيث يتمتع العرض التوضيحي المباشر بالمزايا التالية" >}}
