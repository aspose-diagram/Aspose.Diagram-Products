...
description: نموذج Java رمز التحويل من تنسيق VSX إلى ملف PDF. استخدم رمز المثال هذا لتحويل VSX إلى PDF داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java يمكن للمطورين بسهولة تحويل ملف VSX إلى PDF في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="VSX إلى PDF Java شفرة مصدر التحويل" offSpacer="" %}}
