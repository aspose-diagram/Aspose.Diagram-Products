...
description: نموذج Java رمز تحويل VSX إلى ملف XPS. استخدم رمز المثال هذا لتحويل VSX إلى XPS داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/code-block title="VSX إلى شفرة مصدر التحويل XPS Java" offSpacer="" %}}
