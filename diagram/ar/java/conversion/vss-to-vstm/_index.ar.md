...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSS إلى VSTM استخدام Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 يستطيع مطورو برامج Java تحويل ملف VSS بسهولة إلى VSTM في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="VSS إلى VSTM Java شفرة مصدر التحويل" offSpacer="" %}}
