...
description: نموذج Java شفرة تحويل من تنسيق VSX إلى ملف VSDM. استخدم رمز المثال هذا لتحويل VSX إلى VSDM داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من VSX إلى VSDM عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java تحويل VSX ملف إلى VSDM بسهولة في بضعة أسطر من التعليمات البرمجية.
