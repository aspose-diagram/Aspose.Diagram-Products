---
title: تحويل VSS إلى PDF عبر Java 
weight: 1190
url: /ar/java/conversion/vss-to-pdf/ 
description: نموذج Java رمز التحويل لتنسيق VSS إلى ملف PDF. استخدم رمز المثال هذا لتحويل VSS إلى PDF داخل أي تطبيق يستند إلى الويب أو سطح المكتب Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSS إلى PDF عبر Java" h2="تصدير Microsoft Visio VSS إلى PDF باستخدام مكتبة Java أصلية." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSS إلى PDF باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSS إلى PDF عبر Java" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Java بسهولة تحويل ملف VSS إلى PDF في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="VSS إلى PDF Java رمز مصدر التحويل" offSpacer="" %}}
