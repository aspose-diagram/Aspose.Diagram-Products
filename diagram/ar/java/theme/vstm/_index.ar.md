...
{{% blocks/products/pf/agp/content h2="كيفية تطبيق سمة محددة مسبقًا على VSTM ملف باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تطبيق المظهر المُعد مسبقًا على VSTM الملفات الموجودة في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ملفات VSTM العلامة المائية - Java" offSpacer="" %}}
