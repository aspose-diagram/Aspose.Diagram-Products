...
{{% blocks/products/pf/agp/content h2="كيفية تطبيق سمة محددة مسبقًا على ملف VST باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تطبيق السمة المعدة مسبقًا على ملفات VST في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ملفات العلامة المائية VST - Java" offSpacer="" %}}
