...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VSSM الملفات باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VSSM في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSSM - Java" offSpacer="" %}}
