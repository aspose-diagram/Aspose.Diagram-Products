...
{{% blocks/products/pf/agp/content h2="كيفية ضغط ملفات VSS باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لضغط ملفات VSS في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSS - Java" offSpacer="" %}}
