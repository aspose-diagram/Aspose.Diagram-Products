...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VSDM الملفات باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VSDM في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSDM - Java" offSpacer="" %}}
