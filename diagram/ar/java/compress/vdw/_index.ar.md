...
{{% blocks/products/pf/agp/content h2="كيفية ضغط ملفات VDW باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لضغط ملفات VDW في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VDW - Java" offSpacer="" %}}
