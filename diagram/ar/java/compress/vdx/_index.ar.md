...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VDX الملفات باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VDX في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VDX - Java" offSpacer="" %}}
