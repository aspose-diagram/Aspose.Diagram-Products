...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VSD الملفات باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VSD في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSD - Java" offSpacer="" %}}
