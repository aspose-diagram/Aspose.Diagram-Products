...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VSSX الملفات باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VSSX في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSSX - Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/java/compress/vstx/" name="VSTX" description="Microsoft Visio نموذج الرسم" >}}
