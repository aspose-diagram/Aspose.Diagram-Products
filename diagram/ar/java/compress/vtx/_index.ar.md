...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VTX الملفات باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VTX في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VTX - Java" offSpacer="" %}}
