...
{{% blocks/products/pf/agp/content h2="كيفية إنشاء مخطط هيكلي بنمط مخطط انسيابي في ملف VSS باستخدام Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات إنشاء مخطط هيكلي بنمط مخطط انسيابي في ملفات VSS في Java" %}}
...
{{% blocks/products/pf/agp/code-block title="إنشاء مخطط هيكلي بنمط مخطط انسيابي في ملفات VSS - Java" offSpacer="" %}}
