...
description: Java نموذج كود لإنشاء مستندات PDF. استخدم هذا الرمز لإنشاء ملفات PDF داخل تطبيق الويب أو سطح المكتب المستند إلى Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="إنشاء مستندات PDF عبر Java" h2="إنشاء PDF أصلي وعالي الأداء (تنسيق مستند محمول) برمجيًا باستخدام مكتبة Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
