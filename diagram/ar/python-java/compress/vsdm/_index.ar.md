...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VSDM الملفات باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VSDM في Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSDM - Python" offSpacer="" %}}
