...
{{% blocks/products/pf/agp/content h2="كيفية ضغط ملفات VST باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لضغط ملفات VST في Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VST - Python" offSpacer="" %}}
