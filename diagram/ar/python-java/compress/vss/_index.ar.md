...
{{% blocks/products/pf/agp/content h2="كيفية ضغط ملفات VSS باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لضغط ملفات VSS في Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSS - Python" offSpacer="" %}}
