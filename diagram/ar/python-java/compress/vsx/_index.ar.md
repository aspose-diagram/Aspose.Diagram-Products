...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VSX الملفات باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VSX في Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSX - Python" offSpacer="" %}}
