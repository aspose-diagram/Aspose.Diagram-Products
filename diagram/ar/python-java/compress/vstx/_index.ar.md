...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VSTX الملفات باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VSTX في Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSTX - Python" offSpacer="" %}}
