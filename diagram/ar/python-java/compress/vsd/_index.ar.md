...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VSD الملفات باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VSD في Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSD - Python" offSpacer="" %}}
