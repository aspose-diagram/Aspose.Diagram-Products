...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VSTM الملفات باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VSTM في Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VSTM - Python" offSpacer="" %}}
