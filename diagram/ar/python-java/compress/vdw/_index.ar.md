...
{{% blocks/products/pf/agp/content h2="كيفية ضغط ملفات VDW باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات لضغط ملفات VDW في Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VDW - Python" offSpacer="" %}}
