...
{{% blocks/products/pf/agp/content h2="كيفية ضغط VTX الملفات باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات ضغط ملفات VTX في Python" %}}
...
{{% blocks/products/pf/agp/code-block title="ضغط ملفات VTX - Python" offSpacer="" %}}
