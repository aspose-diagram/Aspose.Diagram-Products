---
title: حوِّل VSD إلى SVG عبر Python 
weight: 1960
url: /ar/python-java/conversion/vsd-to-svg/ 
description: نموذج Python رمز تحويل VSD إلى ملف SVG. استخدم رمز المثال هذا لتحويل VSD إلى SVG داخل أي تطبيق قائم على Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="حوِّل VSD إلى SVG عبر Python" h2="تصدير Microsoft Visio VSD إلى SVG باستخدام Python واجهات برمجة التطبيقات." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSD إلى SVG باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات التحويل من VSD إلى SVG عبر Python" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Python بسهولة تحويل ملف VSD إلى SVG في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="VSD إلى SVG Python شفرة مصدر التحويل" offSpacer="" %}}
