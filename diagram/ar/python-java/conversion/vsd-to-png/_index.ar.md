---
title: تحويل VSD إلى PNG عبر Python 
weight: 1960
url: /ar/python-java/conversion/vsd-to-png/ 
description: نموذج لشفرة تحويل Python لتنسيق VSD إلى ملف PNG. استخدم رمز المثال هذا لتحويل VSD إلى PNG داخل أي تطبيق قائم على Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSD إلى PNG عبر Python" h2="تصدير Microsoft Visio VSD إلى PNG باستخدام Python واجهات برمجة التطبيقات." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSD إلى PNG باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSD إلى PNG عبر Python" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوّري برامج Python بسهولة تحويل ملف VSD إلى PNG في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="VSD إلى PNG Python شفرة مصدر التحويل" offSpacer="" %}}
