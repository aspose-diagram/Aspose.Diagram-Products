---
title: تحويل VSSM إلى XPS عبر Python 
weight: 1960
url: /ar/python-java/conversion/vssm-to-xps/ 
description: نموذج Python رمز تحويل VSSM إلى ملف XPS. استخدم رمز المثال هذا لتحويل VSSM إلى XPS داخل أي تطبيق قائم على Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="تحويل VSSM إلى XPS عبر Python" h2="تصدير Microsoft Visio VSSM إلى XPS باستخدام Python واجهات برمجة التطبيقات." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="كيفية تحويل VSSM إلى XPS باستخدام Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="خطوات تحويل VSSM إلى XPS عبر Python" %}}

{{% blocks/products/pf/agp/text %}}

 يمكن لمطوري Python بسهولة تحويل ملف VSSM إلى XPS في بضعة أسطر من التعليمات البرمجية.
...
{{% blocks/products/pf/agp/code-block title="VSSM إلى شفرة مصدر التحويل XPS Python" offSpacer="" %}}
