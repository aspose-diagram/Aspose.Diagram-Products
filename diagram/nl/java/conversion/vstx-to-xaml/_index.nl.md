...
{{% blocks/products/pf/agp/content h2="Hoe u VSTX naar XAML converteert met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSTX te converteren naar XAML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het VSTX-bestand gemakkelijk converteren naar XAML in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="VSTX naar XAML Java Broncode voor conversie" offSpacer="" %}}
