---
title: Converteer VSDX naar VSSX via Java 
weight: 4010
url: /nl/java/conversion/vsdx-to-vssx/ 
description: Voorbeeld Java conversiecode voor VSDX formaat naar VSSX-bestand. Gebruik deze voorbeeldcode om VSDX naar VSSX te converteren binnen een web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VSDX naar VSSX via Java" h2="Exporteer Microsoft Visio VSDX naar VSSX met behulp van de native Java-bibliotheek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VSDX naar VSSX converteert met Java" %}}

 Om VSDX naar VSSX weer te geven, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSDX naar VSSX te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen VSDX bestanden gemakkelijk converteren naar VSSX in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSDX bestand met een instantie van Diagram class1. Roep Diagram.save-methode aan met pad naar uitvoerbestand en SaveFileFormat als parameters1. VSSX-bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="VSDX naar VSSX Java Broncode voor conversie" offSpacer="" %}}

```cs
// laad de VSDX in een object van Diagram 
Diagram visio = new Diagram("template.vsdx");
// sla VSDX op als VSSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDX naar VSSX-conversie live demo\'s" sectionDescription="[Converteer VSDX naar VSSX](https://products.aspose.app/diagram/conversion/vsdx-to-vssx) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw VSDX-bestand, het wordt direct geconverteerd naar VSSX." >}}
