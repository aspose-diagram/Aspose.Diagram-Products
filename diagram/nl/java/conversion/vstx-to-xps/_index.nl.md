...
{{% blocks/products/pf/agp/content h2="Hoe VSTX naar XPS te converteren met Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java ontwikkelaars kunnen VSTX-bestanden eenvoudig in slechts een paar regels code naar XPS converteren.
...
{{% blocks/products/pf/agp/code-block title="VSTX naar XPS Java Conversiebroncode" offSpacer="" %}}
