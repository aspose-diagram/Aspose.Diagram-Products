---
title: Converteer VSD naar TIFF via Java 
weight: 3120
url: /nl/java/conversion/vsd-to-tiff/ 
description: Voorbeeld Java conversiecode voor VSD formaat naar TIFF-bestand. Gebruik deze voorbeeldcode om VSD naar TIFF te converteren binnen een web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VSD naar TIFF via Java" h2="Exporteer Microsoft Visio VSD naar TIFF met behulp van native Java-bibliotheek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VSD naar TIFF converteert met Java" %}}

 Om VSD naar TIFF weer te geven, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSD naar TIFF te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het VSD-bestand gemakkelijk converteren naar TIFF in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSD bestand met een instantie van Diagram class1. Roep Diagram.save-methode aan met pad naar uitvoerbestand en SaveFileFormat als parameters1. TIFF-bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="VSD naar TIFF Java Broncode voor conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD naar TIFF-conversie Live demo\'s" sectionDescription="[Converteer VSD naar TIFF](https://products.aspose.app/diagram/conversion/vsd-to-tiff) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw VSD-bestand, het wordt direct geconverteerd naar TIFF." >}}
