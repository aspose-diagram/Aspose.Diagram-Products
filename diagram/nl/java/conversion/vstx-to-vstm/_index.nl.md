...
{{% blocks/products/pf/agp/content h2="Hoe u VSTX naar VSTM converteert met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSTX te converteren naar VSTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen VSTX bestand gemakkelijk converteren naar VSTM in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="VSTX naar VSTM Java Conversiebroncode" offSpacer="" %}}
