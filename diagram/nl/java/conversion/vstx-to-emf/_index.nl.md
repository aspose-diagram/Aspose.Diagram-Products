...
{{% blocks/products/pf/agp/content h2="Hoe u VSTX naar EMF converteert met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSTX naar EMF te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen VSTX bestanden gemakkelijk converteren naar EMF in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="VSTX naar EMF Java Broncode voor conversie" offSpacer="" %}}
