---
title: Converteer VSDX naar VSTX via Java 
weight: 950
url: /nl/java/conversion/vsdx-to-vstx/ 
description: Voorbeeld Java conversiecode voor VSDX formaat naar VSTX bestand. Gebruik deze voorbeeldcode om VSDX naar VSTX te converteren binnen elke web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VSDX naar VSTX via Java" h2="Exporteer Microsoft Visio VSDX naar VSTX met behulp van native Java-bibliotheek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VSDX naar VSTX converteert met Java" %}}

 Om VSDX weer te geven tot VSTX, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSDX te converteren naar VSTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen VSDX bestand gemakkelijk converteren naar VSTX in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSDX bestand met een instantie van Diagram class1. Roep Diagram.save-methode aan met pad naar uitvoerbestand en SaveFileFormat als parameters1. VSTX bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="VSDX naar VSTX Java Conversiebroncode" offSpacer="" %}}

```cs
// laad de VSDX in een object van Diagram 
Diagram visio = new Diagram("template.vsdx");
// sla VSDX op als VSTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDX naar VSTX conversie live demo\'s" sectionDescription="[Converteer VSDX naar VSTX](https://products.aspose.app/diagram/conversion/vsdx-to-vstx) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw VSDX-bestand, het wordt onmiddellijk geconverteerd naar VSTX." >}}
