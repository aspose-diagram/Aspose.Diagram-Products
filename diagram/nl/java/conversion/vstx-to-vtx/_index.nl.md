...
{{% blocks/products/pf/agp/content h2="Hoe u VSTX naar VTX converteert met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSTX te converteren naar VTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen VSTX bestand gemakkelijk converteren naar VTX in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="VSTX naar VTX Java Conversiebroncode" offSpacer="" %}}
