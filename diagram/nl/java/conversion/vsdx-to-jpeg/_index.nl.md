---
title: Converteer VSDX naar JPEG via Java 
weight: 5050
url: /nl/java/conversion/vsdx-to-jpeg/ 
description: Voorbeeld Java-conversiecode voor VSDX-indeling naar JPEG-bestand. Gebruik deze voorbeeldcode om VSDX naar JPEG te converteren binnen een web- of desktoptoepassing op Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VSDX naar JPEG via Java" h2="Exporteer Microsoft Visio VSDX naar JPEG met behulp van de native Java-bibliotheek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VSDX naar JPEG converteert met Java" %}}

 Om VSDX naar JPEG te renderen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSDX naar JPEG te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen VSDX bestanden gemakkelijk converteren naar JPEG in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSDX bestand met een instantie van Diagram class1. Roep Diagram.save-methode aan met pad naar uitvoerbestand en SaveFileFormat als parameters1. JPEG-bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="VSDX naar JPEG Java Conversiebroncode" offSpacer="" %}}

```cs
// laad de VSDX in een object van Diagram 
Diagram visio = new Diagram("template.vsdx");
// sla VSDX op als JPEG 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDX naar JPEG-conversie Live demo\'s" sectionDescription="[Converteer VSDX naar JPEG](https://products.aspose.app/diagram/conversion/vsdx-to-jpeg) op dit moment door onze Live Demo\'s-website te bezoeken. De live demo heeft de volgende voordelen:" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" U hoeft Aspose API niet te downloaden." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" U hoeft geen code te schrijven." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Upload gewoon uw VSDX-bestand, het wordt onmiddellijk geconverteerd naar JPEG." >}}
