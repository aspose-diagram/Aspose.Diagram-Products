...
{{% blocks/products/pf/agp/content h2="Hoe u VSTX naar TIFF converteert met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSTX naar TIFF te converteren via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen het VSTX-bestand gemakkelijk converteren naar TIFF in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="VSTX naar TIFF Java Broncode voor conversie" offSpacer="" %}}
