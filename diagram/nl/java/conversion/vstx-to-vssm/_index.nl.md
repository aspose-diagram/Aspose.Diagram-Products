...
{{% blocks/products/pf/agp/content h2="Hoe u VSTX naar VSSM converteert met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSTX te converteren naar VSSM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java ontwikkelaars kunnen VSTX bestand gemakkelijk converteren naar VSSM in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="VSTX naar VSSM Java Conversiebroncode" offSpacer="" %}}
