---
title: Comprimeer VSTM document via Java 
weight: 3350
url: /nl/java/compress/vstm/ 
description: Java broncode om vstm bestand te comprimeren op Java Runtime Environment voor JSP/JSF-applicaties en desktopapplicaties.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Comprimeer VSTM-indelingen in Java" h2="Native VSTM document comprimeren met server-side Java API\'s." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VSTM bestanden comprimeert met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het comprimeren van VSTM bestanden in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimeer VSTM bestanden - Java" offSpacer="" %}}
