...
{{% blocks/products/pf/agp/content h2="Hoe een VDW-bestand automatisch op te maken met Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor automatische opmaak van VDW-bestanden in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Automatische lay-out VDW-bestanden - Java" offSpacer="" %}}
