---
title: Converteer VTX naar PDF via Python 
weight: 1960
url: /nl/python-java/conversion/vtx-to-pdf/ 
description: Voorbeeld Python conversiecode voor VTX formaat naar PDF-bestand. Gebruik deze voorbeeldcode om VTX naar PDF te converteren binnen een op Python gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VTX naar PDF via Python" h2="Exporteer Microsoft Visio VTX naar PDF met Python API\'s." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VTX naar PDF converteert met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VTX naar PDF te converteren via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen VTX bestanden gemakkelijk converteren naar PDF in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="VTX naar PDF Python Conversiebroncode" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/python-java/conversion/vtx-to-html/" name="VTX NAAR HTML" description="Hypertekst-opmaaktaal" >}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/python-java/conversion/vtx-to-vssx/" name="VTX NAAR VSSX" description="Tekensjablonen" >}}
