...
{{% blocks/products/pf/agp/content h2="Hoe u VSD naar SWF converteert met Python" %}}

 Om VSD naar SWF weer te geven, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSD te converteren naar SWF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen VSD bestanden gemakkelijk converteren naar SWF in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="VSD naar SWF Python Broncode voor conversie" offSpacer="" %}}
