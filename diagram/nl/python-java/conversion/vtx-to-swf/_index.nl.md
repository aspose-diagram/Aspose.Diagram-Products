...
{{% blocks/products/pf/agp/content h2="Hoe u VTX naar SWF converteert met Python" %}}

 Om VTX naar SWF weer te geven, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VTX te converteren naar SWF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen VTX bestanden gemakkelijk converteren naar SWF in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="VTX naar SWF Python Broncode voor conversie" offSpacer="" %}}
