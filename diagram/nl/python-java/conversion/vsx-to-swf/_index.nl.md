...
{{% blocks/products/pf/agp/content h2="Hoe u VSX naar SWF converteert met Python" %}}

 Om VSX naar SWF weer te geven, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSX te converteren naar SWF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python ontwikkelaars kunnen VSX bestanden gemakkelijk converteren naar SWF in slechts een paar regels code.
...
{{% blocks/products/pf/agp/code-block title="VSX naar SWF Python Broncode voor conversie" offSpacer="" %}}
