...
{{% blocks/products/pf/agp/content h2="Annoteren aan VSSM bestanden met Python" %}}

 Om het VSSM bestand te annoteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor annotatie VSSM Bestanden in Java" %}}
...
+ Laad VSSM bestand door een instantie van Diagram te maken
...
{{% blocks/products/pf/agp/code-block title="Annoteer VSSM bestanden - Python" offSpacer="" %}}
