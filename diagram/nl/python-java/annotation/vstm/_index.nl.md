...
{{% blocks/products/pf/agp/content h2="Annoteren aan VSTM bestanden met Python" %}}

 Om het VSTM bestand te annoteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor annotatie VSTM Bestanden in Java" %}}
...
+ Laad VSTM bestand door een instantie van Diagram te maken
...
{{% blocks/products/pf/agp/code-block title="Annoteer VSTM bestanden - Python" offSpacer="" %}}
