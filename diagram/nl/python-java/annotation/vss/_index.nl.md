...
{{% blocks/products/pf/agp/content h2="Hoe VSS-bestanden annoteren met Python" %}}

 Om het VSS-bestand te annoteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor annotatie VSS-bestanden in Java" %}}
...
+ Laad VSS-bestand door een instantie van Diagram te maken
...
{{% blocks/products/pf/agp/code-block title="Annoteer VSS-bestanden - Python" offSpacer="" %}}
