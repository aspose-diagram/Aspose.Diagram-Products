...
{{% blocks/products/pf/agp/content h2="Annoteren aan VDX bestanden met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor annotatie VDX Bestanden in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Annoteer VDX bestanden - Python" offSpacer="" %}}
