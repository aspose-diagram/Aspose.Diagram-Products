---
title: Annotatie toevoegen, bewerken en verwijderen van VSDX via Python 
weight: 3250
url: /nl/python-java/annotation/vsdx/ 
description: Python broncode om VSDX bestanden te annoteren binnen een op Python gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Annoteer VSDX indelingen in Python" h2="Native VSDX documentannotatie met server-side Python API\'s." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Annoteren aan VSDX bestanden met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor annotatie VSDX Bestanden in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Annoteer VSDX bestanden - Python" offSpacer="" %}}
