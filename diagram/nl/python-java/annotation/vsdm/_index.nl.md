...
{{% blocks/products/pf/agp/content h2="Annoteren aan VSDM bestanden met Python" %}}

 Om het VSDM bestand te annoteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor annotatie VSDM Bestanden in Java" %}}
...
+ Laad VSDM bestand door een instantie van Diagram te maken
...
{{% blocks/products/pf/agp/code-block title="Annoteer VSDM bestanden - Python" offSpacer="" %}}
