---
title: Comprimeer VSS-document via Python 
weight: 3350
url: /nl/python-java/compress/vss/ 
description: Python broncode om vss-bestanden te comprimeren binnen elke op Python gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Comprimeer VSS-indelingen in Python" h2="Native VSS-documentcompressie met server-side Python API\'s." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe VSS-bestanden te comprimeren met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het comprimeren van VSS-bestanden in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimeer VSS-bestanden - Python" offSpacer="" %}}
