---
title: Comprimeer VDW-document via Python 
weight: 3350
url: /nl/python-java/compress/vdw/ 
description: Python broncode om het vdw-bestand te comprimeren binnen een op Python gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Comprimeer VDW-indelingen in Python" h2="Native VDW-documentcompressie met server-side Python API\'s." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="VDW-bestanden comprimeren met Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het comprimeren van VDW-bestanden in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimeer VDW-bestanden - Python" offSpacer="" %}}
