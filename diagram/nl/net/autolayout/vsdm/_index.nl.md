---
title: Automatische opmaak VSDM document via .NET 
weight: 3050
url: /nl/net/autolayout/vsdm/ 
description: C# broncode naar automatische lay-out vsdm bestand op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Automatische opmaak VSDM document in C#" h2="Native en krachtige automatische lay-out VSDM document met server-side Aspose.Diagram for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een VSDMbestand automatisch kunt indelen met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor automatische lay-out van VSDM bestanden in C#" %}}
