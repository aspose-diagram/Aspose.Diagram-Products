...
{{% blocks/products/pf/agp/content h2="Hoe u VSSX naar XAML converteert met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSSX te converteren naar XAML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen gemakkelijk VSSX bestanden laden en converteren naar XAML in slechts een paar regels code.
