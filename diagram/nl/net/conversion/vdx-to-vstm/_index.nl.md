...
{{% blocks/products/pf/agp/content h2="Hoe u VDX naar VSTM converteert met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VDX te converteren naar VSTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen gemakkelijk VDX bestanden laden en converteren naar VSTM in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VDX bestand met een instantie van Diagram class1. Roep de methode Diagram.Save met pad naar uitvoerbestand en SaveFileFormat.VSTM als parameters aan1. VSTM bestand wordt opgeslagen op het opgegeven pad
