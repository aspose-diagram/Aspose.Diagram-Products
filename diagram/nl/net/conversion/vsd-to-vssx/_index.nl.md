...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSD te converteren naar VSSX via C#" %}}
...
1. Laad VSD bestand met een instantie van Diagram class1. Roep de methode Diagram.Save met pad naar uitvoerbestand en SaveFileFormat.VSSX als parameters aan1. VSSX bestand wordt opgeslagen op het opgegeven pad
