---
title: Converteer VSS naar VSTM via C# 
weight: 3870
url: /nl/net/conversion/vss-to-vstm/ 
description: Voorbeeldcode voor conversie van VSS naar VSTM C#. Gebruik API voorbeeldcode voor batch VSS-bestanden naar VSTM-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VSS naar VSTM via C#" h2="Exporteer Microsoft® Visio VSS-bestanden naar VSTM op .NET Framework, .NET Core, Mono of COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe VSS naar VSTM te converteren met C#" %}}

 Om VSS naar VSTM te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSS naar VSTM te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen VSS-bestanden gemakkelijk laden en converteren naar VSTM in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSS-bestand met een instantie van Diagram class1. Roep de methode Diagram.Save met pad naar uitvoerbestand en SaveFileFormat.VSTM als parameters aan1. VSTM bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont VSS naar VSTM C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app om VSS naar VSTM te converteren" sectionDescription="Check onze live demo\'s voor [VSS naar VSTM conversie](https://products.aspose.app/diagram/conversion/vss-to-vstm) met volgende voordelen." >}}
