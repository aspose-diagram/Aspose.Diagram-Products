...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET ontwikkelaars kunnen VSS-bestanden gemakkelijk laden en converteren naar VSX in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSS-bestand met een instantie van Diagram class1. Roep de methode Diagram.Save met pad naar uitvoerbestand en SaveFileFormat.VSX als parameters aan1. VSX bestand wordt opgeslagen op het opgegeven pad
