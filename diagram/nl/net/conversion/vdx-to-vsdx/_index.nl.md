...
description: Voorbeeldcode voor conversie van VDX naar VSDX C#. Gebruik API voorbeeldcode voor batch-VDX-bestanden naar VSDXconversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
...
{{% blocks/products/pf/agp/content h2="VDX converteren naar VSDX met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VDX naar VSDX te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen VDX-bestanden gemakkelijk laden en converteren naar VSDX in slechts een paar regels code.
