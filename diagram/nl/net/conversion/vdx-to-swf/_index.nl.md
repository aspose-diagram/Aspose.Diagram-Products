...
{{% blocks/products/pf/agp/content h2="Hoe u VDX naar SWF converteert met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VDX te converteren naar SWF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen gemakkelijk VDX bestanden laden en converteren naar SWF in slechts een paar regels code.
