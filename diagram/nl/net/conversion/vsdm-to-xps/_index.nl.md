...
description: Voorbeeldcode voor conversie van VSDM naar XPS C#. Gebruik API voorbeeldcode voor batch-VSDM-bestanden naar XPS-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
...
{{% blocks/products/pf/agp/content h2="Hoe u VSDM naar XPS converteert met C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET ontwikkelaars kunnen gemakkelijk VSDM bestanden laden en converteren naar XPS in slechts een paar regels code.
