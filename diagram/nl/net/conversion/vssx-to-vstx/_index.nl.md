---
title: Converteer VSSX naar VSTX via C# 
weight: 2090
url: /nl/net/conversion/vssx-to-vstx/ 
description: Voorbeeldcode voor conversie van VSSX naar VSTX C#. Gebruik API voorbeeldcode voor batch VSSX-bestanden naar VSTX-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VSSX naar VSTX via C#" h2="Exporteer Microsoft® Visio VSSX bestanden naar VSTX op .NET Framework, .NET Core, Mono of COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VSSX naar VSTX converteert met C#" %}}

 Om VSSX naar VSTX te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSSX te converteren naar VSTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen gemakkelijk VSSX bestanden laden en converteren naar VSTX in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSSX bestand met een instantie van Diagram class1. Roep de methode Diagram.Save met pad naar uitvoerbestand en SaveFileFormat.VSTX als parameters aan1. VSTX bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont VSSX naar VSTX C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app om VSSX naar VSTX te converteren" sectionDescription="Check onze live demo\'s voor [VSSX naar VSTX conversie](https://products.aspose.app/diagram/conversion/vssx-to-vstx) met volgende voordelen." >}}
