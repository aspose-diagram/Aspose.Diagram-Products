---
title: Converteer VSSX naar JPEG via C# 
weight: 3810
url: /nl/net/conversion/vssx-to-jpeg/ 
description: Voorbeeldcode voor conversie van VSSX naar JPEG C#. Gebruik API voorbeeldcode voor batch-VSSX-bestanden naar JPEG-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VSSX naar JPEG via C#" h2="Exporteer Microsoft® Visio VSSX-bestanden naar JPEG op .NET Framework, .NET Core, Mono of COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VSSX naar JPEG converteert met C#" %}}

 Om VSSX naar JPEG te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSSX naar JPEG te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen gemakkelijk VSSX bestanden laden en converteren naar JPEG in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSSX bestand met een instantie van Diagram class1. Roep de Diagram.Save-methode aan met pad naar uitvoerbestand en SaveFileFormat.JPEG als parameters1. JPEG-bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont VSSX naar JPEG C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app om VSSX naar JPEG te converteren" sectionDescription="Check onze live demo\'s voor [VSSX naar JPEG-conversie](https://products.aspose.app/diagram/conversion/vssx-to-jpeg) met volgende voordelen." >}}
