...
description: Voorbeeldcode voor conversie van VSDM naar VSSM C#. Gebruik API voorbeeldcode voor batch VSDM-bestanden naar VSSM-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
...
{{% blocks/products/pf/agp/content h2="Hoe u VSDM naar VSSM converteert met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VSDM te converteren naar VSSM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen gemakkelijk VSDM bestanden laden en converteren naar VSSM in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VSDM bestand met een instantie van Diagram class1. Roep de methode Diagram.Save met pad naar uitvoerbestand en SaveFileFormat.VSSM als parameters aan1. VSSM bestand wordt opgeslagen op het opgegeven pad
