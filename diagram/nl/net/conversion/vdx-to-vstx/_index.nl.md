---
title: Converteer VDX naar VSTX via C# 
weight: 1170
url: /nl/net/conversion/vdx-to-vstx/ 
description: Voorbeeldcode voor conversie van VDX naar VSTX C#. Gebruik API voorbeeldcode voor batch VDX-bestanden naar VSTX-conversie binnen VB.NET, Asp.NET of een op .NET gebaseerde applicatie.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converteer VDX naar VSTX via C#" h2="Exporteer Microsoft® Visio VDX bestanden naar VSTX op .NET Framework, .NET Core, Mono of COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VDX naar VSTX converteert met C#" %}}

 Om VDX naar VSTX te converteren, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VDX te converteren naar VSTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen gemakkelijk VDX bestanden laden en converteren naar VSTX in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VDX bestand met een instantie van Diagram class1. Roep de methode Diagram.Save met pad naar uitvoerbestand en SaveFileFormat.VSTX als parameters aan1. VSTX bestand wordt opgeslagen op het opgegeven pad
...
{{% blocks/products/pf/agp/code-block title="Deze voorbeeldcode toont VDX naar VSTX C# Conversie" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app om VDX naar VSTX te converteren" sectionDescription="Check onze live demo\'s voor [VDX naar VSTX conversie](https://products.aspose.app/diagram/conversion/vdx-to-vstx) met volgende voordelen." >}}
