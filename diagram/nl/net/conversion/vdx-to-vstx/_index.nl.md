...
{{% blocks/products/pf/agp/content h2="Hoe VDX naar VSTX te converteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen om VDX naar VSTX te converteren via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET ontwikkelaars kunnen VDX-bestanden gemakkelijk laden en converteren naar VSTX in slechts een paar regels code.

{{% /blocks/products/pf/agp/text %}}

1. Laad VDX-bestand met een instantie van Diagram class1. Roep de Diagram.Save-methode aan met pad naar uitvoerbestand en SaveFileFormat.VSTX als parameters1. VSTX-bestand wordt opgeslagen op het opgegeven pad
