---
title: Voeg VSTM bestanden samen via .NET 
weight: 2740
url: /nl/net/merger/vstm/ 
description: C# broncode om VSTM documenten te combineren op .NET Framework, .NET Core, Mono of COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg VSTM-indelingen samen in C#" h2="Native en hoogwaardige VSTM documentfusie met behulp van server-side Aspose.Diagram for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een VSTM-bestand samenvoegt met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het samenvoegen van VSTM bestanden in C#" %}}
...
+ Laad alle VSTM bestanden met het volledige pad.
...
+ Roep de methode Save() aan en geef de bestandsnaam (volledig pad) en formaat (VSTM) door als parameter.
+ Nu kunt u het bestand VSTM openen en gebruiken in Microsoft Office, Adobe PDF of een ander compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="VSTM bestanden samenvoegen - C#" offSpacer="" %}}
