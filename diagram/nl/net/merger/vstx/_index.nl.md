---
title: Voeg VSTX bestanden samen via .NET 
weight: 1450
url: /nl/net/merger/vstx/ 
description: C# broncode om VSTX documenten te combineren op .NET Framework, .NET Core, Mono of COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Voeg VSTX-indelingen samen in C#" h2="Native en hoogwaardige VSTX documentfusie met behulp van server-side Aspose.Diagram for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een VSTX-bestand samenvoegt met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het samenvoegen van VSTX bestanden in C#" %}}
...
+ Laad alle VSTX bestanden met het volledige pad.
...
+ Roep de methode Save() aan en geef de bestandsnaam (volledig pad) en formaat (VSTX) door als parameter.
+ Nu kunt u het bestand VSTX openen en gebruiken in Microsoft Office, Adobe PDF of een ander compatibel programma.
...
{{% blocks/products/pf/agp/code-block title="VSTX bestanden samenvoegen - C#" offSpacer="" %}}
