---
title: Bescherm en vergrendel VSDM document via .NET 
weight: 5580
url: /nl/net/protect/vsdm/ 
description: C# broncode om VSDM bestand te vergrendelen op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Bescherm VSDM bestanden via C#" h2="Bescherm Visio inclusief VSDM-indeling met .NET Bibliotheek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe VSDM Bestand te beschermen met C#" %}}

 Om VSDM bestand te beschermen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het beveiligen van VSDM bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Bescherm VSDM bestanden - C#" offSpacer="" %}}
