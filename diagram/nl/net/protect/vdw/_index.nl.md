---
title: Beveilig en vergrendel VDW-document via .NET 
weight: 5580
url: /nl/net/protect/vdw/ 
description: C# broncode om VDW-bestand te vergrendelen op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Bescherm VDW-bestanden via C#" h2="Bescherm Visio inclusief VDW-indeling met .NET Bibliotheek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe VDW-bestand te beschermen met C#" %}}

 Om het VDW-bestand te beschermen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het beschermen van VDW-bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Bescherm VDW-bestanden - C#" offSpacer="" %}}
