---
title: Comprimeer VSD document via .NET 
weight: 3050
url: /nl/net/compress/vsd/ 
description: C# broncode om vsd bestand te comprimeren op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Comprimeer VSD in C#" h2="Native en krachtige VSD documentcompressor met server-side Aspose.Diagram for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u VSD bestanden comprimeert met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het comprimeren van VSD bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimeer VSD bestanden - C#" offSpacer="" %}}
