---
title: Maak een organigram in VSD document via .NET 
weight: 3050
url: /nl/net/organizationchart/vsd/ 
description: C# broncode om organigram te maken in vsd bestand op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Maak een organigram in VSD in C#" h2="Native en high-performance maak een organigram in VSD document met behulp van server-side Aspose.Diagram for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe maak je een organigram in VSD Bestand met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het maken van een organigram in VSD Bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Organigram maken in VSD bestanden - C#" offSpacer="" %}}
