---
title: Annotatie toevoegen, bewerken en verwijderen uit VST via C# 
weight: 3050
url: /nl/net/annotation/vst/ 
description: C# broncode om VST-bestand te annoteren op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Hoe u een VST-bestand kunt annoteren met C#" h2="Native en hoogwaardige VST-documentannotatie met server-side Aspose.Diagram for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe u een VST-bestand kunt annoteren met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het annoteren van VST-bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Opmerking verwijderen uit VST-bestanden - C#" offSpacer="" %}}
