---
title: VST-bestanden splitsen via .NET 
weight: 1300
url: /nl/net/splitter/vst/ 
description: C# broncode naar Split vst-bestand op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VST splitsen in C#" h2="Native en krachtige VST-documentsplitser met server-side Aspose.Diagram for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe een VST-bestand te splitsen met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het splitsen van VST-bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="VST-bestanden splitsen - C#" offSpacer="" %}}
