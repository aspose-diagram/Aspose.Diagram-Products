...
{{% blocks/products/pf/agp/content h2="Hoe VTX Bestand te ontgrendelen met C#" %}}

 Om VTX bestand te ontgrendelen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het ontgrendelen van VTX bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ontgrendel VTX bestanden - C#" offSpacer="" %}}
