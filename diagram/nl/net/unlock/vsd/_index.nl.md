---
title: Ontgrendel VSD document via .NET 
weight: 5680
url: /nl/net/unlock/vsd/ 
description: C# broncode om VSD bestand te ontgrendelen op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ontgrendel VSD bestanden via C#" h2="Verwijder de beveiliging van Visio inclusief VSD-indeling met .NET Bibliotheek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe VSD Bestand te ontgrendelen met C#" %}}

 Om VSD bestand te ontgrendelen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het ontgrendelen van VSD bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ontgrendel VSD bestanden - C#" offSpacer="" %}}
