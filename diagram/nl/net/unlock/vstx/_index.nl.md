---
title: Ontgrendel VSTX document via .NET 
weight: 5680
url: /nl/net/unlock/vstx/ 
description: C# broncode om VSTX bestand te ontgrendelen op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ontgrendel VSTX bestanden via C#" h2="Verwijder de beveiliging van Visio inclusief VSTX-indeling met .NET Bibliotheek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hoe VSTX Bestand te ontgrendelen met C#" %}}

 Om VSTX bestand te ontgrendelen, gebruiken we
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het ontgrendelen van VSTX bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Ontgrendel VSTX bestanden - C#" offSpacer="" %}}
