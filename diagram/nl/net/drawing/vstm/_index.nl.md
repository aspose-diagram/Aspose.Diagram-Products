---
title: Teken geometrie naar VSTM document via .NET 
weight: 3050
url: /nl/net/drawing/vstm/ 
description: C# broncode om geomtry naar vstm bestand te trekken op .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Teken Geomtry naar VSTM in C#" h2="Native en high-performance tekengeometrie om VSTM documenten te documenteren met behulp van server-side Aspose.Diagram for .NET API\'s, zonder het gebruik van software zoals Microsoft of Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Geomtry naar VSTM-bestand tekenen met C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Stappen voor het tekenen van geometrie naar VSTM bestanden in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Teken geometrie naar VSTM bestanden - C#" offSpacer="" %}}
