...
{{% blocks/products/pf/agp/content h2="Cómo poner una marca de agua en VSTM archivos usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para aplicar marcas de agua a VSTM archivos en Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Archivos de marca de agua VSTM - Python" offSpacer="" %}}
