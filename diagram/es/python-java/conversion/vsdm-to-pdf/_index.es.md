---
title: Convertir VSDM a PDF a través de Python 
weight: 1960
url: /es/python-java/conversion/vsdm-to-pdf/ 
description: Ejemplo de código de conversión Python para formato VSDM a archivo PDF. Utilice este código de ejemplo para convertir VSDM a PDF dentro de cualquier aplicación basada en Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSDM a PDF a través de Python" h2="Exporte Microsoft Visio VSDM a PDF usando Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir VSDM a PDF usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir VSDM a PDF a través de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Python pueden convertir fácilmente el archivo VSDM a PDF con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de VSDM a PDF Python" offSpacer="" %}}
