---
title: Crear VSDX archivos a través de Python 
url: /es/python-java/create-vsdx/ 
description: Python Código de ejemplo para generar VSDX documentos. Use este código para crear archivos VSDX dentro de cualquier aplicación basada en Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Crear VSDX documentos a través de Python" h2="Creación nativa y de alto rendimiento de VSDX (formato de documento portátil) mediante programación utilizando la biblioteca Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="VSDX" fileiconsmall2="JPG" fileiconsmall3="HTML" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Cómo crear VSDX a través de Python" %}}
