---
title: Convertir VSSM a PNG a través de Java 
weight: 170
url: /es/java/conversion/vssm-to-png/ 
description: Ejemplo de código de conversión Java para formato VSSM a archivo PNG. Utilice este código de ejemplo para convertir VSSM a PNG dentro de cualquier aplicación basada en Java web o de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSSM a PNG a través de Java" h2="Exporte Microsoft Visio VSSM a PNG utilizando la biblioteca Java nativa." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSSM a PNG con solo unas pocas líneas de código.
