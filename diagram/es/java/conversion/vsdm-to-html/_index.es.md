---
title: Convertir VSDM a HTML a través de Java 
weight: 1600
url: /es/java/conversion/vsdm-to-html/ 
description: Ejemplo de código de conversión Java para formato VSDM a archivo HTML. Utilice este código de ejemplo para convertir VSDM a HTML dentro de cualquier aplicación basada en Java web o de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSDM a HTML a través de Java" h2="Exporte Microsoft Visio VSDM a HTML utilizando la biblioteca Java nativa." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSDM a HTML con solo unas pocas líneas de código.
