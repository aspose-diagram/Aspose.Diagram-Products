...
description: Ejemplo de código de conversión Java para formato VSDX a archivo VSDM. Utilice este código de ejemplo para convertir VSDX a VSDM dentro de cualquier aplicación basada en Java web o de escritorio.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir VSDX a VSDM usando Java" %}}
 ...
 Para representar VSDX en VSDM, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSDX a VSDM con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión VSDX a VSDM Java" offSpacer="" %}}
