...
description: Muestra el código de conversión Java para el formato VSDM en el archivo VSDX. Utilice este código de ejemplo para convertir VSDM a VSDX dentro de cualquier aplicación basada en Java web o de escritorio.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSDM en VSDX con solo unas pocas líneas de código.
