---
title: Convertir VDW a VSX a través de Java 
weight: 2840
url: /es/java/conversion/vdw-to-vsx/ 
description: Muestra el código de conversión Java para el formato VDW en el archivo VSX. Utilice este código de ejemplo para convertir VDW a VSX dentro de cualquier aplicación basada en web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VDW a VSX a través de Java" h2="Exporte Microsoft Visio VDW a VSX usando la biblioteca Java nativa." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir VDW a VSX usando Java" %}}

 Para renderizar VDW a VSX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir VDW a VSX a través de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de Java pueden convertir fácilmente el archivo VDW a VSX con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo VDW con una instancia de la clase Diagram1. Llame al método Diagram.save con la ruta del archivo de salida y SaveFileFormat como parámetros1. El archivo VSX se guardará en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de VDW a VSX Java" offSpacer="" %}}

```cs
// cargar el VDW en un objeto de Diagram 
Diagram visio = new Diagram("template.vdw");
// guardar VDW como VSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de conversión de VDW a VSX" sectionDescription="[Convertir VDW a VSX](https://products.aspose.app/diagram/conversion/vdw-to-vsx) ahora mismo visitando nuestro sitio web de demostraciones en vivo. La demostración en vivo tiene los siguientes beneficios" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No es necesario descargar Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No es necesario escribir ningún código." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Simplemente cargue su archivo VDW, se convertirá instantáneamente a VSX." >}}
