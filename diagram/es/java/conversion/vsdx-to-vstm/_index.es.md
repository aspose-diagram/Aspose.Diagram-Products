...
description: Muestra el código de conversión Java para el formato VSDX en el archivo VSTM. Utilice este código de ejemplo para convertir VSDX a VSTM dentro de cualquier aplicación basada en Java web o de escritorio.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSDX en VSTM con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión de VSDX a VSTM Java" offSpacer="" %}}
