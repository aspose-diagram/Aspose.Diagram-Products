---
title: Convertir VSSM a JPEG a través de Java 
weight: 310
url: /es/java/conversion/vssm-to-jpeg/ 
description: Ejemplo de código de conversión Java para formato VSSM a archivo JPEG. Utilice este código de ejemplo para convertir VSSM a JPEG dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSSM a JPEG a través de Java" h2="Exporte Microsoft Visio VSSM a JPEG utilizando la biblioteca Java nativa." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSSM a JPEG con solo unas pocas líneas de código.
