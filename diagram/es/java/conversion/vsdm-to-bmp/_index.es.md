---
title: Convertir VSDM a BMP a través de Java 
weight: 3060
url: /es/java/conversion/vsdm-to-bmp/ 
description: Ejemplo de código de conversión Java para formato VSDM a archivo BMP. Utilice este código de ejemplo para convertir VSDM a BMP dentro de cualquier aplicación basada en Java web o de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSDM a BMP a través de Java" h2="Exporte Microsoft Visio VSDM a BMP utilizando la biblioteca Java nativa." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSDM a BMP con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión VSDM a BMP Java" offSpacer="" %}}
