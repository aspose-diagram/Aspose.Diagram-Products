---
title: Convierta VSDX a VSSX a través de Java 
weight: 4010
url: /es/java/conversion/vsdx-to-vssx/ 
description: Ejemplo de código de conversión Java para formato VSDX a archivo VSSX. Utilice este código de ejemplo para convertir VSDX a VSSX dentro de cualquier aplicación basada en Java web o de escritorio.
---
...
{{% blocks/products/pf/agp/content h2="Cómo convertir VSDX a VSSX usando Java" %}}
 ...
 Para representar VSDX en VSSX, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSDX a VSSX con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Código fuente de conversión VSDX a VSSX Java" offSpacer="" %}}
