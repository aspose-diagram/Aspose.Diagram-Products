---
title: Convierte VSDM a XPS a través de Java 
weight: 1500
url: /es/java/conversion/vsdm-to-xps/ 
description: Ejemplo de código de conversión Java para formato VSDM a archivo XPS. Utilice este código de ejemplo para convertir VSDM a XPS dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte VSDM a XPS a través de Java" h2="Exporte Microsoft Visio VSDM a XPS utilizando la biblioteca Java nativa." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSDM a XPS con solo unas pocas líneas de código.
