---
title: Convierte VSSM a XPS a través de Java 
weight: 1640
url: /es/java/conversion/vssm-to-xps/ 
description: Ejemplo de código de conversión Java para formato VSSM a archivo XPS. Utilice este código de ejemplo para convertir VSSM a XPS dentro de cualquier aplicación basada en Web o escritorio Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierte VSSM a XPS a través de Java" h2="Exporte Microsoft Visio VSSM a XPS utilizando la biblioteca Java nativa." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de Java pueden convertir fácilmente el archivo VSSM a XPS con solo unas pocas líneas de código.
