...
{{% blocks/products/pf/agp/content h2="Cómo aplicar un tema preestablecido al archivo VTX usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para aplicar un tema predeterminado a VTX archivos en Java" %}}
