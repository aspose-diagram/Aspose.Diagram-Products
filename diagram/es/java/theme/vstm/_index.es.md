...
{{% blocks/products/pf/agp/content h2="Cómo aplicar un tema preestablecido al archivo VSTM usando Java" %}}

 Para aplicar el tema predeterminado al archivo VSTM, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para aplicar un tema predeterminado a VSTM archivos en Java" %}}
