---
title: Dibuje geomtry para VSSX documento a través de Java 
weight: 3050
url: /es/Java/drawing/vssx/ 
description: Java código fuente para dibujar geometría en vssx archivo en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dibuja Geomtry a VSSX en Java" h2="Dibuje geometría nativa y de alto rendimiento para VSSX documento utilizando Aspose.Diagram for Java API del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo dibujar geometría en un archivo VSSX usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para dibujar geometría en VSSX archivos en Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Dibujar geometría en VSSX archivos - Java" offSpacer="" %}}
