---
title: Dibuje geomtry al documento VSS a través de Java 
weight: 3050
url: /es/Java/drawing/vss/ 
description: Java código fuente para dibujar geometría en el archivo vss en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dibuja Geomtry a VSS en Java" h2="Dibuje geometría nativa y de alto rendimiento para documentos VSS utilizando API Aspose.Diagram for Java del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo dibujar Geomtry en un archivo VSS usando Java" %}}

 Para dibujar geometría en un archivo VSS, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para dibujar geometría en archivos VSS en Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Dibujar geometría en archivos VSS - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram es una Microsoft Visio manipulación de formato de documento API. Uno puede cargar, crear, modificar, manipular fácilmente, incluidos los elementos de daigram, y convertir Visio diagramas a otros formatos, como PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF y más. Es un API independiente y no requiere la instalación de Microsoft Visio ni de ningún otro software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Demostraciones en vivo de Geomtry to VSS Document en línea" sectionDescription="Dibuje geometría en documentos VSS ahora mismo visitando nuestro [Sitio web de demostraciones en vivo](https://products.aspose.app/diagram/drawing). La demostración en vivo tiene los siguientes beneficios" >}}
