---
title: Documento VSS de diseño automático a través de Java 
weight: 3050
url: /es/Java/autolayout/vss/ 
description: Java código fuente para diseñar automáticamente el archivo vss en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Documento VSS de diseño automático en Java" h2="Documento VSS de diseño automático nativo y de alto rendimiento utilizando las API Aspose.Diagram for Java del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo diseñar automáticamente un archivo VSS usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para archivos VSS de diseño automático en Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Archivos VSS de diseño automático: Java" offSpacer="" %}}
