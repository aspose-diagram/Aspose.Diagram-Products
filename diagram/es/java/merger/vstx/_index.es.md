---
title: Combinar VSTX archivos a través de Java 
weight: 2430
url: /es/java/merger/vstx/ 
description: Java código de ejemplo para combinar VSTX documentos en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar VSTX formatos en Java" h2="Fusión nativa de documentos VSTX utilizando API Java del lado del servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar VSTX archivos usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para combinar VSTX archivos en Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Combinar VSTX archivos - Java" offSpacer="" %}}
