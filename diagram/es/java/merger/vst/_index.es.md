---
title: Combinar archivos VST a través de Java 
weight: 1440
url: /es/java/merger/vst/ 
description: Java código de muestra para combinar documentos VST en Java entorno de tiempo de ejecución para aplicaciones JSP/JSF y aplicaciones de escritorio.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar formatos VST en Java" h2="Fusión de documentos VST nativos utilizando las API Java del lado del servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar archivos VST usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para fusionar archivos VST en Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Combinar archivos VST - Java" offSpacer="" %}}
