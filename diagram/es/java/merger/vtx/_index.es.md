...
{{% blocks/products/pf/agp/content h2="Cómo fusionar VTX archivos usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para combinar VTX archivos en Java" %}}
...
+ guardar el archivo VTX fusionado en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Combinar VTX archivos - Java" offSpacer="" %}}
