...
description: Ejemplo de código para la conversión de VSD a VSSM C#. Utilice el código de ejemplo API para la conversión por lotes de archivos VSD a VSSM dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos VSD a VSSM con solo unas pocas líneas de código.
