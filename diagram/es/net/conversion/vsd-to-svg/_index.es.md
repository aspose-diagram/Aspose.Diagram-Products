---
title: Convertir VSD a SVG a través de C# 
weight: 2030
url: /es/net/conversion/vsd-to-svg/ 
description: Código de muestra para la conversión de VSD a SVG C#. Utilice el código de ejemplo API para la conversión por lotes de archivos VSD a SVG dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSD a SVG a través de C#" h2="Exporte archivos de Microsoft® Visio VSD a SVG en .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir VSD a SVG usando C#" %}}

 Para convertir VSD a SVG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir VSD a SVG a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos VSD a SVG con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo VSD con una instancia de la clase Diagram1. Llame al método Diagram.Save con la ruta del archivo de salida y SaveFileFormat.SVG como parámetros1. El archivo SVG se guardará en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de VSD a SVG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir VSD a SVG" sectionDescription="Consulte nuestras demostraciones en vivo para [Conversión de VSD a SVG](https://products.aspose.app/diagram/conversion/vsd-to-svg) con los siguientes beneficios." >}}
