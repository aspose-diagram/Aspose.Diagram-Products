...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos VSD a VSX con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de VSD a VSX C#" offSpacer="" %}}
