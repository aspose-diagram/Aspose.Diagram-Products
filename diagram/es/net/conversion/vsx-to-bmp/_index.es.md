...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de .NET pueden cargar y convertir fácilmente VSX archivos a BMP con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de VSX a BMP C#" offSpacer="" %}}
