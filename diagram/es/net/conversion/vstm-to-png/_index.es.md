---
title: Convertir VSTM a PNG a través de C# 
weight: 4150
url: /es/net/conversion/vstm-to-png/ 
description: Ejemplo de código para la conversión de VSTM a PNG C#. Utilice el código de ejemplo API para la conversión de archivos por lotes VSTM a PNG dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTM a PNG a través de C#" h2="Exporte archivos Microsoft® Visio VSTM a PNG en .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos VSTM a PNG con solo unas pocas líneas de código.
...
{{% blocks/products/pf/agp/code-block title="Este código de ejemplo muestra la conversión de VSTM a PNG C#" offSpacer="" %}}
