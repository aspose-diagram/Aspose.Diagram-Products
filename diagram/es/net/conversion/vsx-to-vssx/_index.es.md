---
title: Convertir VSX a VSSX a través de C# 
weight: 5310
url: /es/net/conversion/vsx-to-vssx/ 
description: Ejemplo de código para la conversión de VSX a VSSX C#. Utilice el código de ejemplo API para la conversión por lotes de archivos VSX a VSSX dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
