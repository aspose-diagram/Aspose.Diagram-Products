---
title: Convertir VSD a VSSX a través de C# 
weight: 2880
url: /es/net/conversion/vsd-to-vssx/ 
description: Ejemplo de código para la conversión de VSD a VSSX C#. Utilice el código de ejemplo API para la conversión por lotes de archivos VSD a VSSX dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos VSD a VSSX con solo unas pocas líneas de código.
