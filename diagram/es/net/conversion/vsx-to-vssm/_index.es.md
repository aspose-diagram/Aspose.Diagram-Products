---
title: Convierta VSX a VSSM a través de C# 
weight: 1290
url: /es/net/conversion/vsx-to-vssm/ 
description: Código de muestra para la conversión de VSX a VSSM C#. Utilice el código de ejemplo API para la conversión de archivos VSX por lotes a VSSM dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta VSX a VSSM a través de C#" h2="Exporte archivos VSX de Microsoft® Visio a VSSM en .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir VSX a VSSM usando C#" %}}

 Para convertir VSX a VSSM, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir VSX a VSSM a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos VSX a VSSM con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo VSX con una instancia de la clase Diagram1. Llame al método Diagram.Save con la ruta del archivo de salida y SaveFileFormat.VSSM como parámetros1. El archivo VSSM se guardará en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de VSX a VSSM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir VSX a VSSM" sectionDescription="Consulte nuestras demostraciones en vivo para [Conversión de VSX a VSSM](https://products.aspose.app/diagram/conversion/vsx-to-vssm) con los siguientes beneficios." >}}
