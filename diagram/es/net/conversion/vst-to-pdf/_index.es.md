---
title: Convierta VST a PDF a través de C# 
weight: 1100
url: /es/net/conversion/vst-to-pdf/ 
description: Código de muestra para la conversión de VST a PDF C#. Utilice el código de ejemplo API para la conversión de archivos VST por lotes a PDF dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convierta VST a PDF a través de C#" h2="Exporte archivos VST de Microsoft® Visio a PDF en .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo convertir VST a PDF usando C#" %}}

 Para convertir VST a PDF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para convertir VST a PDF a través de C#" %}}

{{% blocks/products/pf/agp/text %}}

 Los desarrolladores de .NET pueden cargar y convertir fácilmente archivos VST a PDF con solo unas pocas líneas de código.

{{% /blocks/products/pf/agp/text %}}

1. Cargue el archivo VST con una instancia de la clase Diagram1. Llame al método Diagram.Save con la ruta del archivo de salida y SaveFileFormat.PDF como parámetros1. El archivo PDF se guardará en la ruta especificada
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de VST a PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicación gratuita para convertir VST a PDF" sectionDescription="Consulte nuestras demostraciones en vivo para [Conversión de VST a PDF](https://products.aspose.app/diagram/conversion/vst-to-pdf) con los siguientes beneficios." >}}
