---
title: Convertir VSTM a HTML a través de C# 
weight: 840
url: /es/net/conversion/vstm-to-html/ 
description: Ejemplo de código para la conversión de VSTM a HTML C#. Utilice el código de ejemplo API para la conversión de archivos por lotes VSTM a HTML dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTM a HTML a través de C#" h2="Exporte archivos Microsoft® Visio VSTM a HTML en .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
