---
title: Convertir VSX a VSDM a través de C# 
weight: 3240
url: /es/net/conversion/vsx-to-vsdm/ 
description: Ejemplo de código para la conversión de VSX a VSDM C#. Utilice el código de ejemplo API para la conversión por lotes de archivos VSX a VSDM dentro de VB.NET, Asp.NET o cualquier aplicación basada en .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSX a VSDM a través de C#" h2="Exporte archivos Microsoft® Visio VSX a VSDM en .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/code-block title="Este código de muestra muestra la conversión de VSX a VSDM C#" offSpacer="" %}}
