---
title: Comprimir VDX documento a través de .NET 
weight: 3050
...
{{% blocks/products/pf/agp/content h2="Cómo comprimir el archivo VDX usando C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimir VDX archivos - C#" offSpacer="" %}}
