---
title: Comprimir VSTX documento a través de .NET 
weight: 3050
...
{{% blocks/products/pf/agp/content h2="Cómo comprimir el archivo VSTX usando C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimir VSTX archivos - C#" offSpacer="" %}}
