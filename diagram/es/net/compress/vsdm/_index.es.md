---
title: Comprimir VSDM documento a través de .NET 
weight: 3050
...
{{% blocks/products/pf/agp/content h2="Cómo comprimir el archivo VSDM usando C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimir VSDM archivos - C#" offSpacer="" %}}
