---
title: Desbloquear VSDM documento a través de .NET 
weight: 5680
url: /es/net/unlock/vsdm/ 
description: C# código fuente para desbloquear el archivo VSDM en .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloquee VSDM archivos a través de C#" h2="Elimine la protección de Visio, incluido el formato VSDM, mediante la biblioteca .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo desbloquear el archivo VSDM usando C#" %}}

 Para desbloquear el archivo VSDM, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para desbloquear VSDM archivos en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Desbloquear VSDM archivos - C#" offSpacer="" %}}
