---
title: Desbloquear VSTM documento a través de .NET 
weight: 5680
url: /es/net/unlock/vstm/ 
description: C# código fuente para desbloquear el archivo VSTM en .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloquee VSTM archivos a través de C#" h2="Elimine la protección de Visio, incluido el formato VSTM, mediante la biblioteca .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo desbloquear el archivo VSTM usando C#" %}}

 Para desbloquear el archivo VSTM, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para desbloquear VSTM archivos en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Desbloquear VSTM archivos - C#" offSpacer="" %}}
