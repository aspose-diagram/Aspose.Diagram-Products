---
title: Dividir VSSM archivos a través de .NET 
weight: 1300
...
{{% blocks/products/pf/agp/content h2="Cómo dividir el archivo VSSM usando C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dividir VSSM archivos - C#" offSpacer="" %}}
