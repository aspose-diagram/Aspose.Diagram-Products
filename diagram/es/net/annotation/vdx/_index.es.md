---
title: Agregar, editar y eliminar anotaciones de VDX a través de C# 
weight: 3050
url: /es/net/annotation/vdx/ 
description: C# código fuente para anotar el archivo VDX en .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Cómo anotar el archivo VDX usando C#" h2="Anotación de documentos VDX nativos y de alto rendimiento utilizando API Aspose.Diagram for .NET del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo anotar el archivo VDX usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para anotar VDX archivos en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Eliminar comentario de VDX Archivos - C#" offSpacer="" %}}
