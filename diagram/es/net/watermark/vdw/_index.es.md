---
title: Documento VDW de marca de agua a través de .NET 
weight: 3050
url: /es/net/watermark/vdw/ 
description: C# código fuente para agregar una marca de agua al archivo vdw en .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Agregar marca de agua de texto a VDW en C#" h2="Marca de agua de documento VDW nativa y de alto rendimiento que usa las API Aspose.Diagram for .NET del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo poner una marca de agua en un archivo VDW usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para aplicar marcas de agua a archivos VDW en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Archivos VDW de marca de agua: C#" offSpacer="" %}}
