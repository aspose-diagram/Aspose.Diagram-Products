---
title: Combinar VSSX archivos a través de .NET 
weight: 3770
url: /es/net/merger/vssx/ 
description: C# código fuente para combinar VSSX documentos en .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar VSSX formatos en C#" h2="Fusión de documentos VSSX nativos y de alto rendimiento utilizando API Aspose.Diagram for .NET del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar el archivo VSSX usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para combinar VSSX archivos en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Combinar VSSX archivos - C#" offSpacer="" %}}
