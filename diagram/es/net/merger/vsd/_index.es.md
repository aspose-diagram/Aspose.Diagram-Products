---
title: Combinar VSD archivos a través de .NET 
weight: 2530
url: /es/net/merger/vsd/ 
description: C# código fuente para combinar VSD documentos en .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar VSD formatos en C#" h2="Fusión de documentos VSD nativos y de alto rendimiento utilizando API Aspose.Diagram for .NET del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar el archivo VSD usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para combinar VSD archivos en C#" %}}
...
+ Cargue todos los archivos VSD con la ruta completa.
+ Hacer un documento como archivo base
+ Llame al método relevante para concatenar y fusionar archivos uno por uno.
+ Llame al método Save() y pase el nombre del archivo (ruta completa) y el formato (VSD) como parámetro.
+ Ahora puede abrir y usar el archivo VSD en Microsoft Office, Adobe PDF o cualquier otro programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Combinar VSD archivos - C#" offSpacer="" %}}
