---
title: Combinar VSSM archivos a través de .NET 
weight: 2380
url: /es/net/merger/vssm/ 
description: C# código fuente para combinar VSSM documentos en .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Combinar VSSM formatos en C#" h2="Fusión de documentos VSSM nativos y de alto rendimiento utilizando API Aspose.Diagram for .NET del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo fusionar el archivo VSSM usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para combinar VSSM archivos en C#" %}}
...
+ Cargue todos los archivos VSSM con la ruta completa.
+ Hacer un documento como archivo base
+ Llame al método relevante para concatenar y fusionar archivos uno por uno.
+ Llame al método Save() y pase el nombre del archivo (ruta completa) y el formato (VSSM) como parámetro.
+ Ahora puede abrir y usar el archivo VSSM en Microsoft Office, Adobe PDF o cualquier otro programa compatible.
...
{{% blocks/products/pf/agp/code-block title="Combinar VSSM archivos - C#" offSpacer="" %}}
