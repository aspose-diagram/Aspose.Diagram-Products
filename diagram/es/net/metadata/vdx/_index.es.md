...
{{% blocks/products/pf/agp/content h2="Cómo extraer VDX metadatos usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para extraer VDX metadatos en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Extracción de VDX metadatos - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram es una Microsoft Visio manipulación de formato de documento API. Uno puede cargar, crear, modificar, manipular fácilmente, incluidos los elementos de daigram, y convertir Visio diagramas a otros formatos, como PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF y más. Es un API independiente y no requiere la instalación de Microsoft Visio ni de ningún otro software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Extraer metadatos de VDX a través de la aplicación en línea" sectionDescription="Vea y edite metadatos en VDX documentos visitando nuestro [Sitio web de demostraciones en vivo](https://products.aspose.app/diagram/metadata). La demostración en vivo tiene los siguientes beneficios" >}}
