---
title: Aplicar tema preestablecido al documento VSTM a través de .NET 
weight: 3050
url: /es/net/theme/vstm/ 
description: C# código fuente para aplicar el tema predeterminado al archivo vstm en .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Aplicar tema preestablecido a VSTM en C#" h2="Aplicación nativa y de alto rendimiento del tema preestablecido al documento VSTM mediante las API Aspose.Diagram for .NET del lado del servidor, sin el uso de ningún software como Microsoft u Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cómo aplicar un tema preestablecido al archivo VSTM usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Pasos para aplicar un tema predeterminado a VSTM archivos en C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Aplicar tema preestablecido a VSTM archivos - C#" offSpacer="" %}}
