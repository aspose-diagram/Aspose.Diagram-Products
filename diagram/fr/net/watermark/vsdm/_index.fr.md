...
description: Code source C# pour ajouter un filigrane au fichier vsdm sur les plates-formes .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Comment filigraner le fichier VSDM à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Fichiers de filigrane VSDM - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram est une Microsoft Visio manipulation de format de document API. On peut facilement charger, créer, modifier, manipuler, y compris des éléments de daigramme et convertir des diagrammes Visio en d'autres formats tels que PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF et plus encore. Il s'agit d'un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="VSDM démonstrations en direct de WaterMarker en ligne" sectionDescription="WaterMark VSDM documents dès maintenant en visitant notre [Site Web de démos en direct](https://products.aspose.app/diagram/watermark). La démo en direct présente les avantages suivants" >}}
