...
description: Code source C# pour ajouter un filigrane au fichier vdx sur les plates-formes .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Comment filigraner le fichier VDX à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Fichiers de filigrane Vdx - C#" offSpacer="" %}}
