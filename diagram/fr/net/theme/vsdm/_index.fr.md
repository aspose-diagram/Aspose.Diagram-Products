---
title: Appliquer le thème prédéfini au document VSDM via .NET 
weight: 3050
url: /fr/net/theme/vsdm/ 
description: Code source C# pour appliquer le thème prédéfini au fichier vsdm sur les plates-formes .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Appliquer le thème prédéfini à VSDM dans C#" h2="Application native et hautes performances d\'un thème prédéfini au document VSDM à l\'aide d\'API côté serveur Aspose.Diagram for .NET, sans utiliser de logiciel tel que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment appliquer un thème prédéfini au fichier VSDM à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour appliquer le thème prédéfini aux fichiers VSDM dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Appliquer le thème prédéfini à VSDM fichiers - C#" offSpacer="" %}}
