...
description: Exemple de code pour la conversion de VSDX à VSDM C#. Utilisez l'exemple de code API pour les fichiers batch VSDX vers la conversion VSDM dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSDX à VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en VSDM" sectionDescription="Consultez nos démos en direct pour [Conversion VSDX à VSDM](https://products.aspose.app/diagram/conversion/vsdx-to-vsdm) avec les avantages suivants." >}}
