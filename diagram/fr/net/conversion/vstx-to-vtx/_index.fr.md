...
description: Exemple de code pour la conversion VSTX vers VTX C#. Utilisez l'exemple de code API pour la conversion par lots de fichiers VSTX en VTX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VTX à l\'aide de C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSTX en VTX" sectionDescription="Consultez nos démos en direct pour [Conversion VSTX en VTX](https://products.aspose.app/diagram/conversion/vstx-to-vtx) avec les avantages suivants." >}}
