...
description: Exemple de code pour la conversion VSTX vers XAML C#. Utilisez l'exemple de code API pour les fichiers VSTX par lots en conversion XAML dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en XAML à l\'aide de C#" %}}

 Afin de convertir VSTX en XAML, nous utiliserons
