---
title: Convertir VDX en HTML via C# 
weight: 2970
url: /fr/net/conversion/vdx-to-html/ 
description: Exemple de code pour la conversion VDX en HTML C#. Utilisez API exemple de code pour les fichiers batch VDX en conversion HTML dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VDX en HTML via C#" h2="Exportez les fichiers Microsoft® Visio VDX au format HTML sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en HTML en utilisant C#" %}}

 Pour convertir VDX en HTML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VDX en HTML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VDX au format HTML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VDX avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.HTML comme paramètres1. Le fichier HTML sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX en HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en HTML" sectionDescription="Consultez nos démos en direct pour [Conversion VDX en HTML](https://products.aspose.app/diagram/conversion/vdx-to-html) avec les avantages suivants." >}}
