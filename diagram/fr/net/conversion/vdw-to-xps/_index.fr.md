---
title: Convertir VDW en XPS via C# 
weight: 4390
url: /fr/net/conversion/vdw-to-xps/ 
description: Exemple de code pour la conversion VDW vers XPS C#. Utilisez l'exemple de code API pour la conversion de fichiers VDW par lots en XPS dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VDW en XPS via C#" h2="Exportez les fichiers Microsoft® Visio VDW vers XPS sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDW en XPS à l\'aide de C#" %}}

 Afin de convertir VDW en XPS, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VDW en XPS via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VDW en XPS en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VDW avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.XPS comme paramètres1. Le fichier XPS sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDW en XPS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDW en XPS" sectionDescription="Consultez nos démos en direct pour [Conversion VDW en XPS](https://products.aspose.app/diagram/conversion/vdw-to-xps) avec les avantages suivants." >}}
