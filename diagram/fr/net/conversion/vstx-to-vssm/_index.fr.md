...
description: Exemple de code pour la conversion VSTX vers VSSM C#. Utilisez l'exemple de code API pour les fichiers VSTX par lots vers la conversion VSSM dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSSM à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSTX vers VSSM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSTX en VSSM" sectionDescription="Consultez nos démos en direct pour [Conversion VSTX en VSSM](https://products.aspose.app/diagram/conversion/vstx-to-vssm) avec les avantages suivants." >}}
