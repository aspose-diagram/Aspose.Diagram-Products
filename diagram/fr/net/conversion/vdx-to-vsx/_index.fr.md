...
description: Exemple de code pour la conversion VDX vers VSX C#. Utilisez API l'exemple de code pour la conversion par lots de fichiers VDX en VSX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en VSX à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX vers VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en VSX" sectionDescription="Consultez nos démos en direct pour [Conversion VDX en VSX](https://products.aspose.app/diagram/conversion/vdx-to-vsx) avec les avantages suivants." >}}
