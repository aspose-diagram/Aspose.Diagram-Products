...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en XPS à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX vers XPS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en XPS" sectionDescription="Consultez nos démos en direct pour [Conversion VDX en XPS](https://products.aspose.app/diagram/conversion/vdx-to-xps) avec les avantages suivants." >}}
