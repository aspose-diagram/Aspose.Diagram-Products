...
description: Exemple de code pour la conversion VDX vers VTX C#. Utilisez l'exemple de code API pour la conversion par lot de fichiers VDX en VTX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en VTX à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX vers VTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en VTX" sectionDescription="Consultez nos démos en direct pour [Conversion VDX en VTX](https://products.aspose.app/diagram/conversion/vdx-to-vtx) avec les avantages suivants." >}}
