...
{{% blocks/products/pf/agp/content h2="Comment convertir VSDX en VSSM en utilisant C#" %}}

 Afin de convertir VSDX en VSSM, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSDX en VSSM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VSDX en VSSM en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VSDX avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.VSSM comme paramètres1. Le fichier VSSM sera enregistré dans le chemin spécifié
