...
description: Exemple de code pour la conversion VDX vers VSDM C#. Utilisez l'exemple de code API pour la conversion de fichiers VDX par lots en VSDM dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en VSDM à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX vers VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en VSDM" sectionDescription="Consultez nos démos en direct pour [Conversion VDX en VSDM](https://products.aspose.app/diagram/conversion/vdx-to-vsdm) avec les avantages suivants." >}}
