...
description: Exemple de code pour la conversion de VSDX à VSTM C#. Utilisez l'exemple de code API pour les fichiers batch VSDX vers la conversion VSTM dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSDX à VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en VSTM" sectionDescription="Consultez nos démos en direct pour [Conversion VSDX à VSTM](https://products.aspose.app/diagram/conversion/vsdx-to-vstm) avec les avantages suivants." >}}
