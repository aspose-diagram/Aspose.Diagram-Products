...
{{% blocks/products/pf/agp/content h2="Comment convertir VSDX en VDX en utilisant C#" %}}
 ...
 Afin de convertir VSDX en VDX, nous utiliserons
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSDX à VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en VDX" sectionDescription="Consultez nos démos en direct pour [Conversion VSDX à VDX](https://products.aspose.app/diagram/conversion/vsdx-to-vdx) avec les avantages suivants." >}}
