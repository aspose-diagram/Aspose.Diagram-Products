...
description: Exemple de code pour la conversion de VSTX en PNG C#. Utilisez l'exemple de code API pour la conversion de fichiers par lots VSTX en PNG dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTX en PNG via C#" h2="Exportez les fichiers Microsoft® Visio VSTX au format PNG sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en PNG en utilisant C#" %}}
 ...
 Pour convertir VSTX en PNG, nous utiliserons
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSTX en PNG" sectionDescription="Consultez nos démos en direct pour [Conversion de VSTX en PNG](https://products.aspose.app/diagram/conversion/vstx-to-png) avec les avantages suivants." >}}
