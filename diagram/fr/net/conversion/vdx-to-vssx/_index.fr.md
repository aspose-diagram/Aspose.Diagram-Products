...
description: Exemple de code pour la conversion VDX vers VSSX C#. Utilisez l'exemple de code API pour la conversion de fichiers VDX par lots en VSSX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en VSSX à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX vers VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en VSSX" sectionDescription="Consultez nos démos en direct pour [Conversion VDX en VSSX](https://products.aspose.app/diagram/conversion/vdx-to-vssx) avec les avantages suivants." >}}
