...
description: Exemple de code pour la conversion VSTX vers VSTX C#. Utilisez l'exemple de code API pour la conversion de fichiers VSTX par lots en VSTX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSTX à l\'aide de C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSTX en VSTX" sectionDescription="Consultez nos démos en direct pour [Conversion VSTX en VSTX](https://products.aspose.app/diagram/conversion/vstx-to-vstx) avec les avantages suivants." >}}
