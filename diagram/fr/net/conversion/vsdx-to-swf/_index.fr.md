...
{{% blocks/products/pf/agp/content h2="Comment convertir VSDX en SWF en utilisant C#" %}}

 Pour convertir VSDX en SWF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSDX en SWF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VSDX au format SWF en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VSDX avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.SWF comme paramètres1. Le fichier SWF sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSDX en SWF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en SWF" sectionDescription="Consultez nos démos en direct pour [conversion de VSDX en SWF](https://products.aspose.app/diagram/conversion/vsdx-to-swf) avec les avantages suivants." >}}
