---
title: Convertir VDX en VSTM via C# 
weight: 5240
url: /fr/net/conversion/vdx-to-vstm/ 
description: Exemple de code pour la conversion de VDX à VSTM C#. Utilisez l'exemple de code API pour les fichiers batch VDX vers la conversion VSTM dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VDX en VSTM via C#" h2="Exportez les fichiers Microsoft® Visio VDX vers VSTM sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en VSTM en utilisant C#" %}}

 Afin de convertir VDX en VSTM, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VDX en VSTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VDX en VSTM en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VDX avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.VSTM comme paramètres1. Le fichier VSTM sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX à VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en VSTM" sectionDescription="Consultez nos démos en direct pour [Conversion VDX à VSTM](https://products.aspose.app/diagram/conversion/vdx-to-vstm) avec les avantages suivants." >}}
