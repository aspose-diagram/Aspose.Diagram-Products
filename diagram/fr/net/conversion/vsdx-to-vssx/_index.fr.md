...
description: Exemple de code pour la conversion de VSDX à VSSX C#. Utilisez l'exemple de code API pour les fichiers batch VSDX vers la conversion VSSX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSDX à VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en VSSX" sectionDescription="Consultez nos démos en direct pour [Conversion VSDX à VSSX](https://products.aspose.app/diagram/conversion/vsdx-to-vssx) avec les avantages suivants." >}}
