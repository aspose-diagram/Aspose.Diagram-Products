...
description: Exemple de code pour la conversion de VSDX à VSTX C#. Utilisez l'exemple de code API pour les fichiers batch VSDX vers la conversion VSTX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSDX à VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en VSTX" sectionDescription="Consultez nos démos en direct pour [Conversion VSDX à VSTX](https://products.aspose.app/diagram/conversion/vsdx-to-vstx) avec les avantages suivants." >}}
