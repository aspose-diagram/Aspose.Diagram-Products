...
description: Exemple de code pour la conversion VSTX vers VSSX C#. Utilisez l'exemple de code API pour les fichiers VSTX par lots en conversion VSSX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSSX à l\'aide de C#" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSTX en VSSX" sectionDescription="Consultez nos démos en direct pour [Conversion VSTX en VSSX](https://products.aspose.app/diagram/conversion/vstx-to-vssx) avec les avantages suivants." >}}
