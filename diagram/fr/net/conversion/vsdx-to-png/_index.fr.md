---
title: Convertir VSDX en PNG via C# 
weight: 4920
url: /fr/net/conversion/vsdx-to-png/ 
description: Exemple de code pour la conversion de VSDX en PNG C#. Utilisez l'exemple de code API pour la conversion de fichiers par lots VSDX en PNG dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSDX en PNG via C#" h2="Exportez les fichiers Microsoft® Visio VSDX au format PNG sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSDX en PNG en utilisant C#" %}}

 Pour convertir VSDX en PNG, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSDX en PNG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VSDX au format PNG en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VSDX avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.PNG comme paramètres1. Le fichier PNG sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSDX en PNG C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en PNG" sectionDescription="Consultez nos démos en direct pour [Conversion de VSDX en PNG](https://products.aspose.app/diagram/conversion/vsdx-to-png) avec les avantages suivants." >}}
