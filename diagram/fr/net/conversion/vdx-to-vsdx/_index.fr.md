...
description: Exemple de code pour la conversion de VDX à VSDX C#. Utilisez l'exemple de code API pour les fichiers batch VDX vers la conversion VSDX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX à VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en VSDX" sectionDescription="Consultez nos démos en direct pour [Conversion VDX à VSDX](https://products.aspose.app/diagram/conversion/vdx-to-vsdx) avec les avantages suivants." >}}
