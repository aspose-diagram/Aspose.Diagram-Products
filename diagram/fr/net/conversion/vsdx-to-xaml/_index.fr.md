---
title: Convertir VSDX en XAML via C# 
weight: 2200
url: /fr/net/conversion/vsdx-to-xaml/ 
description: Exemple de code pour la conversion VSDX en XAML C#. Utilisez API exemple de code pour les fichiers batch VSDX en conversion XAML dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSDX en XAML via C#" h2="Exportez les fichiers Microsoft® Visio VSDX vers XAML sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSDX en XAML en utilisant C#" %}}

 Pour convertir VSDX en XAML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSDX en XAML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VSDX en XAML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VSDX avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.XAML comme paramètres1. Le fichier XAML sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSDX vers XAML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en XAML" sectionDescription="Consultez nos démos en direct pour [Conversion VSDX en XAML](https://products.aspose.app/diagram/conversion/vsdx-to-xaml) avec les avantages suivants." >}}
