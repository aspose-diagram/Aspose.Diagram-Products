---
title: Convertir VSDX en BMP via C# 
weight: 2360
url: /fr/net/conversion/vsdx-to-bmp/ 
description: Exemple de code pour la conversion VSDX en BMP C#. Utilisez API exemple de code pour les fichiers batch VSDX en conversion BMP dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSDX en BMP via C#" h2="Exportez les fichiers Microsoft® Visio VSDX vers BMP sur .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSDX en BMP en utilisant C#" %}}

 Afin de convertir VSDX en BMP, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSDX en BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VSDX en BMP en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VSDX avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.BMP comme paramètres1. Le fichier BMP sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSDX vers BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en BMP" sectionDescription="Consultez nos démos en direct pour [conversion de VSDX en BMP](https://products.aspose.app/diagram/conversion/vsdx-to-bmp) avec les avantages suivants." >}}
