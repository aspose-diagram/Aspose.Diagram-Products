...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion de VSDX à VTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSDX en VTX" sectionDescription="Consultez nos démos en direct pour [conversion de VSDX à VTX](https://products.aspose.app/diagram/conversion/vsdx-to-vtx) avec les avantages suivants." >}}
