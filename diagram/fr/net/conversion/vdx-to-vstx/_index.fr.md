...
description: Exemple de code pour la conversion VDX vers VSTX C#. Utilisez l'exemple de code API pour la conversion par lot de fichiers VDX en VSTX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en VSTX à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX vers VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en VSTX" sectionDescription="Consultez nos démos en direct pour [Conversion VDX en VSTX](https://products.aspose.app/diagram/conversion/vdx-to-vstx) avec les avantages suivants." >}}
