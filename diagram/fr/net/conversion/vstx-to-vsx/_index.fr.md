...
description: Exemple de code pour la conversion VSTX vers VSX C#. Utilisez l'exemple de code API pour la conversion par lot de fichiers VSTX en VSX dans VB.NET, Asp.NET ou toute application basée sur .NET.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSX à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VSTX vers VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VSTX en VSX" sectionDescription="Consultez nos démos en direct pour [Conversion VSTX en VSX](https://products.aspose.app/diagram/conversion/vstx-to-vsx) avec les avantages suivants." >}}
