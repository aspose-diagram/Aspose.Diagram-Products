...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en TIFF à l\'aide de C#" %}}

 Pour convertir VDX en TIFF, nous utiliserons
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX vers TIFF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en TIFF" sectionDescription="Consultez nos démos en direct pour [Conversion VDX en TIFF](https://products.aspose.app/diagram/conversion/vdx-to-tiff) avec les avantages suivants." >}}
