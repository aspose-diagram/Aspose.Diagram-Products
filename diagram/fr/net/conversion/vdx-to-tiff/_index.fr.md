...
{{% blocks/products/pf/agp/content h2="Comment convertir VDX en TIFF en utilisant C#" %}}

 Afin de convertir VDX en TIFF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VDX en TIFF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs .NET peuvent facilement charger et convertir des fichiers VDX au format TIFF en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VDX avec une instance de la classe Diagram1. Appelez la méthode Diagram.Save avec le chemin du fichier de sortie et SaveFileFormat.TIFF comme paramètres1. Le fichier TIFF sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Cet exemple de code montre la conversion VDX en TIFF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour convertir VDX en TIFF" sectionDescription="Consultez nos démos en direct pour [conversion de VDX en TIFF](https://products.aspose.app/diagram/conversion/vdx-to-tiff) avec les avantages suivants." >}}
