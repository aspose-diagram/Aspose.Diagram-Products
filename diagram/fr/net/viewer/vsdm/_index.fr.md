---
title: Afficher les formats de fichier VSDM via .NET 
weight: 1210
url: /fr/net/viewer/vsdm/ 
description: C# code source pour charger, restituer et afficher des documents VSDM sur .NET Framework, .NET Core, Mono ou COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Visionneuse de fichiers VSDM for .NET" h2="Affichez les fichiers Microsoft Visio VSDM dans le navigateur sans nécessiter l\'application Visio ou Office Automation." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour afficher VSDM via C#" %}}
...
{{% blocks/products/pf/agp/code-block title="C# code pour afficher VSDM" offSpacer="" %}}

```cs

// charger le fichier VSDM via une instance de Diagram
var diagram = new Aspose.Diagram.Diagram("template.vsdm");
// convertir VSDM au format HTML
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram est une manipulation de format de document Microsoft Visio API. On peut facilement charger, créer, modifier, manipuler, y compris des éléments de daigramme et convertir des diagrammes Visio en d'autres formats tels que PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF et plus encore. Il s'agit d'un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Application gratuite pour voir VSDM" sectionDescription="Consultez nos démos en direct pour [Voir VSDM](https://products.aspose.app/diagram/viewer/vsdm) avec les avantages suivants." >}}
