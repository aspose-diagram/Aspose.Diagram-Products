---
title: Mise en page automatique du document VSS via .NET 
weight: 3050
url: /fr/net/autolayout/vss/ 
description: C# code source vers le fichier vss de mise en page automatique sur les plates-formes .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Document VSS de mise en page automatique dans C#" h2="Document VSS de mise en page automatique native et hautes performances à l\'aide d\'API Aspose.Diagram for .NET côté serveur, sans l\'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment mettre en page automatiquement un fichier VSS à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour les fichiers VSS de mise en page automatique dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Fichiers VSS de mise en page automatique - C#" offSpacer="" %}}
