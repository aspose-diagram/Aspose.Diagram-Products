---
title: Mise en page automatique du document VSSM via .NET 
weight: 3050
url: /fr/net/autolayout/vssm/ 
description: C# code source vers le fichier de mise en page automatique vssm sur .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mise en page automatique du document VSSM dans C#" h2="Document VSSM de mise en page automatique native et hautes performances à l\'aide d\'API côté serveur Aspose.Diagram for .NET, sans l\'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment mettre en forme automatiquement le fichier VSSM à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour la disposition automatique des fichiers VSSM dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Fichiers VSSM de mise en page automatique - C#" offSpacer="" %}}
