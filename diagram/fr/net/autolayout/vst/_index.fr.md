...
{{% blocks/products/pf/agp/content h2="Comment disposer automatiquement un fichier VST à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour les fichiers VST de mise en page automatique dans C#" %}}
