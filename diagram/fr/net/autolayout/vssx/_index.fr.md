---
title: Mise en page automatique du document VSSX via .NET 
weight: 3050
url: /fr/net/autolayout/vssx/ 
description: C# code source vers le fichier de mise en page automatique vssx sur .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mise en page automatique du document VSSX dans C#" h2="Document VSSX de mise en page automatique native et hautes performances à l\'aide d\'API côté serveur Aspose.Diagram for .NET, sans l\'utilisation de logiciels tels que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment mettre en forme automatiquement le fichier VSSX à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour la disposition automatique des fichiers VSSX dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Fichiers VSSX de mise en page automatique - C#" offSpacer="" %}}
