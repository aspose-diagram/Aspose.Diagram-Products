---
title: Dessinez la géométrie dans le document VDW via .NET 
weight: 3050
url: /fr/net/drawing/vdw/ 
description: C# code source pour dessiner la géométrie dans le fichier vdw sur les plates-formes .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dessiner la géométrie sur VDW dans C#" h2="Géométrie de dessin native et hautes performances sur un document VDW à l\'aide d\'API Aspose.Diagram for .NET côté serveur, sans l\'utilisation d\'un logiciel tel que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment dessiner une géométrie dans un fichier VDW à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour dessiner la géométrie dans les fichiers VDW dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dessiner la géométrie dans les fichiers VDW - C#" offSpacer="" %}}
 ...
 Aspose.Diagram est une Microsoft Visio manipulation de format de document API. On peut facilement charger, créer, modifier, manipuler, y compris des éléments de daigramme et convertir des diagrammes Visio en d'autres formats tels que PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF et plus encore. Il s'agit d'un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Géométrie de tirage en ligne vers VDW Docum Live Demos" sectionDescription="Dessinez la géométrie dans les documents VDW dès maintenant en visitant notre [Site Web de démos en direct](https://products.aspose.app/diagram/drawing). La démo en direct présente les avantages suivants" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Il dessinera géo instantanément." >}}
