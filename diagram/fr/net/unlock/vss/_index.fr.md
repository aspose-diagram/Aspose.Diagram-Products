---
title: Déverrouiller le document VSS via .NET 
weight: 5680
url: /fr/net/unlock/vss/ 
description: Code source C# pour déverrouiller le fichier VSS sur les plates-formes .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Déverrouiller les fichiers VSS via C#" h2="Supprimez la protection de Visio, y compris le format VSS à l\'aide de la bibliothèque .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment déverrouiller le fichier VSS à l\'aide de C#" %}}

 Afin de déverrouiller le fichier VSS, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour déverrouiller les fichiers VSS dans C#" %}}

{{% blocks/products/pf/agp/text %}}

 Un déverrouillage de document de base et une concaténation avec
 [Aspose.Diagram for .NET](https://products.aspose.com/diagram/net) 
...
+ Définir le drapeau de protection sur faux
...
{{% blocks/products/pf/agp/code-block title="Déverrouiller les fichiers VSS - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/unlock/vsd/" name="Vsd" description="Microsoft Visio Dessins" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/unlock/vdx/" name="Vdx" description="Visio dessin Fichier XML" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/unlock/vssx/" name="VSSX" description="Visio Fichier de gabarit" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/unlock/vstx/" name="VSTX" description="Visio fichier modèle" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/unlock/vsdm/" name="VSDM" description="Visio Fichier de dessin prenant en charge les macros" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/unlock/vssm/" name="VSSM" description="Visio Fichier de gabarit compatible avec les macros" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/unlock/vstm/" name="VSTM" description="Visio fichier de modèle compatible avec les macros" >}}
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/unlock/vsdx/" name="VSDX" description="Visio fichier de dessin" >}}
