---
title: Déverrouillez le document VTX via .NET 
weight: 5680
url: /fr/net/unlock/vtx/ 
description: Code source C# pour déverrouiller le fichier VTX sur les plates-formes .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Déverrouiller VTX fichiers via C#" h2="Supprimez la protection de Visio, y compris le format VDW à l\'aide de la bibliothèque .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment déverrouiller le fichier VTX à l\'aide de C#" %}}

 Afin de déverrouiller le fichier VTX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour déverrouiller les fichiers VTX dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Déverrouiller VTX fichiers - C#" offSpacer="" %}}
