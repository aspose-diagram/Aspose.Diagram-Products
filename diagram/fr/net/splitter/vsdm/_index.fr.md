---
title: Fractionner VSDM fichiers via .NET 
weight: 1300
url: /fr/net/splitter/vsdm/ 
description: Code source C# pour diviser le fichier vsdm sur les plates-formes .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Diviser VSDM en C#" h2="Séparateur de documents VSDM natif et hautes performances à l\'aide d\'API Aspose.Diagram for .NET côté serveur, sans utiliser de logiciel tel que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment diviser le fichier VSDM à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fractionner VSDM fichiers dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Fractionner VSDM fichiers - C#" offSpacer="" %}}
