---
title: Protégez et verrouillez le document VSTX via .NET 
weight: 5580
url: /fr/net/protect/vstx/ 
description: Code source C# pour verrouiller le fichier VSTX sur les plates-formes .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Protégez les fichiers VSTX via C#" h2="Protégez les feuilles de calcul Visio, y compris le format VSTX à l\'aide de la bibliothèque .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment protéger le fichier VSTX à l\'aide de C#" %}}

 Afin de protéger le fichier VSTX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour protéger les fichiers VSTX dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Protéger VSTX fichiers - C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/net/protect/vsd/" name="Vsd" description="Microsoft Visio Dessins" >}}
