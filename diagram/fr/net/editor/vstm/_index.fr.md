---
title: Modifier VSTM fichiers via .NET 
...
{{% blocks/products/pf/agp/content h2="Comment modifier le fichier VSTM à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour modifier les fichiers VSTM dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Modifier VSTM fichiers - C#" offSpacer="" %}}
...
Aspose.Diagram est une Microsoft Visio manipulation de format de document API. On peut facilement charger, créer, modifier, manipuler, y compris des éléments de daigramme et convertir des diagrammes Visio en d'autres formats tels que PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF et plus encore. Il s'agit d'un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel.    
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de l\'éditeur VSTM en ligne" sectionDescription="Modifiez VSTM documents dès maintenant en visitant notre [Site Web de démos en direct](https://products.aspose.app/diagram/editor). La démo en direct présente les avantages suivants" >}}
