---
title: Modifier les fichiers VSS via .NET 
url: /fr/net/editor/vss/ 
description: Code source C# pour modifier le document VSS sur les plates-formes .NET Framework, .NET Core, Windows Azure, Mono ou Xamarin.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Modifier les formats VSS dans C#" h2="Édition de documents VSS native et hautes performances à l\'aide d\'API Aspose.Diagram for .NET côté serveur, sans l\'utilisation de logiciels tels que Microsoft ou Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="DOCX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment modifier un fichier VSS à l\'aide de C#" %}}

Pour éditer le fichier VSS, nous utiliserons <a href="https://products.aspose.com/diagram/net">Aspose.Diagram for .NET</a> API qui est une plate-forme API pour C# riche en fonctionnalités, puissante et facile à utiliser pour n'importe quel éditeur. Ouvrir <a href="https://www.nuget.org/packages/aspose.diagram">NuGet</a> gestionnaire de paquets, recherchez <b>Aspose.Diagram</b> et installer. Vous pouvez également utiliser la commande suivante à partir de la console du gestionnaire de packages.
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes de modification des fichiers VSS dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Modifier les fichiers VSS - C#" offSpacer="" %}}
...
Aspose.Diagram est une manipulation de format de document Microsoft Visio API. On peut facilement charger, créer, modifier, manipuler, y compris des éléments de daigramme et convertir des diagrammes Visio en d'autres formats tels que PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF et plus encore. Il s'agit d'un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel.    
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de l\'éditeur VSS en ligne" sectionDescription="Modifiez les documents VSS dès maintenant en visitant notre [Site Web de démos en direct](https://products.aspose.app/diagram/editor). La démo en direct présente les avantages suivants" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Téléchargez simplement vos fichiers VSS, utilisez l\'éditeur en ligne pour les éditer instantanément." >}}
