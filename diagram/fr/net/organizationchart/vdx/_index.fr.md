---
title: Créer un organigramme dans le document VDX via .NET 
weight: 3050
url: /fr/net/organizationchart/vdx/ 
description: C# code source pour créer un organigramme dans le fichier vdx sur .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un organigramme dans VDX dans C#" h2="Créez un organigramme natif et hautes performances dans un document VDX à l\'aide d\'API côté serveur Aspose.Diagram for .NET, sans utiliser de logiciel tel que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer un organigramme dans le fichier VDX à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour créer un organigramme dans VDX Fichiers dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Créer un organigramme dans Vdx fichiers - C#" offSpacer="" %}}
