---
title: Créer un organigramme dans le document VST via .NET 
weight: 3050
url: /fr/net/organizationchart/vst/ 
description: C# code source pour créer un organigramme dans un fichier vst sur .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un organigramme dans VST dans C#" h2="Créez un organigramme natif et hautes performances dans un document VST à l\'aide d\'API Aspose.Diagram for .NET côté serveur, sans utiliser de logiciel tel que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer un organigramme dans un fichier VST à l\'aide de C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour créer un organigramme dans les fichiers VST dans C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Créer un organigramme dans les fichiers VST - C#" offSpacer="" %}}
