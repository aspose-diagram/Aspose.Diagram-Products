...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour fusionner des fichiers VDX dans Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Fusionner les fichiers VDX - Java" offSpacer="" %}}
