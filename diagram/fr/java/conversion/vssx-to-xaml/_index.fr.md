...
description: Exemple de code de conversion Java pour le format VSSX en fichier XAML. Utilisez cet exemple de code pour convertir VSSX en XAML dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSSX en XAML à l\'aide de Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir un fichier VSSX en XAML en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSSX vers XAML Java" offSpacer="" %}}
