...
description: Exemple de code de conversion Java pour le format VSS vers le fichier VSDM. Utilisez cet exemple de code pour convertir VSS en VSDM dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSS en VSDM à l\'aide de Java" %}}
 ...
 Afin de rendre VSS à VSDM, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir le fichier VSS en VSDM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSS vers VSDM Java code source de conversion" offSpacer="" %}}

```cs
// charger le VSS dans un objet de Diagram 
Diagram visio = new Diagram("template.vss");
// enregistrer VSS sous VSDM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSS à VSDM démonstrations en direct de conversion" sectionDescription="[Convertir VSS en VSDM](https://products.aspose.app/diagram/conversion/vss-to-vsdm) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
