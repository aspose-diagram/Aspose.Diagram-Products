...
description: Exemple de code de conversion Java pour le format VSTX en fichier EMF. Utilisez cet exemple de code pour convertir VSTX en EMF dans n'importe quelle application Web ou de bureau basée sur Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en EMF en utilisant Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir le fichier VSTX en EMF en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTX vers EMF Java Code source de conversion" offSpacer="" %}}
