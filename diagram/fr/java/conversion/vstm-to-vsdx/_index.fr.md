---
title: Convertir VSTM en VSDX via Java 
weight: 3670
url: /fr/java/conversion/vstm-to-vsdx/ 
description: Exemple de code de conversion Java pour le format VSTM vers le fichier VSDX. Utilisez cet exemple de code pour convertir VSTM en VSDX dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTM en VSDX via Java" h2="Exportez Microsoft Visio VSTM vers VSDX à l\'aide de la bibliothèque native Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTM en VSDX en utilisant Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSTM en VSDX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier VSTM en VSDX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTM à VSDX Java code source des conversions" offSpacer="" %}}
