...
description: Exemple de code de conversion Java pour le format VSTX vers le fichier VSDM. Utilisez cet exemple de code pour convertir VSTX en VSDM dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSDM en utilisant Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir le fichier VSTX en VSDM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTX à VSDM Java code source des conversions" offSpacer="" %}}
