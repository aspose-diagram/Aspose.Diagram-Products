...
description: Exemple de code de conversion Java pour le format VSTM vers le fichier VSDM. Utilisez cet exemple de code pour convertir VSTM en VSDM dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTM en VSDM en utilisant Java" %}}

 Afin de rendre VSTM à VSDM, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir le fichier VSTM en VSDM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTM à VSDM Java code source des conversions" offSpacer="" %}}

```cs
// charger le VSTM dans un objet de Diagram 
Diagram visio = new Diagram("template.vstm");
// enregistrer VSTM sous VSDM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM à VSDM démos en direct de conversion" sectionDescription="[Convertir VSTM en VSDM](https://products.aspose.app/diagram/conversion/vstm-to-vsdm) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
