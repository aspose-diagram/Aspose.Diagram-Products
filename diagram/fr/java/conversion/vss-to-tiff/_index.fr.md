---
title: Convertir VSS en TIFF via Java 
weight: 3170
url: /fr/java/conversion/vss-to-tiff/ 
description: Exemple de code de conversion Java pour le format VSS en fichier TIFF. Utilisez cet exemple de code pour convertir VSS en TIFF dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSS en TIFF via Java" h2="Exportez Microsoft Visio VSS vers TIFF à l\'aide de la bibliothèque native Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSS en TIFF à l\'aide de Java" %}}

 Afin de rendre VSS en TIFF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSS en TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier VSS en TIFF en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VSS avec une instance de la classe Diagram1. Appelez la méthode Diagram.save avec le chemin du fichier de sortie et SaveFileFormat comme paramètres1. Le fichier TIFF sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSS vers TIFF Java" offSpacer="" %}}

```cs
// charger le VSS dans un objet de Diagram 
Diagram visio = new Diagram("template.vss");
// enregistrer VSS au format TIFF 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VSS en TIFF" sectionDescription="[Convertir VSS en TIFF](https://products.aspose.app/diagram/conversion/vss-to-tiff) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier VSS, il sera converti instantanément en TIFF." >}}
