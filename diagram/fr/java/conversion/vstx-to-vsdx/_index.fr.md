---
title: Convertir VSTX en VSDX via Java 
weight: 2100
url: /fr/java/conversion/vstx-to-vsdx/ 
description: Exemple de code de conversion Java pour le format VSTX vers le fichier VSDX. Utilisez cet exemple de code pour convertir VSTX en VSDX dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTX en VSDX via Java" h2="Exportez Microsoft Visio VSTX vers VSDX à l\'aide de la bibliothèque native Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSDX en utilisant Java" %}}

 Afin de rendre VSTX à VSDX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSTX en VSDX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier VSTX en VSDX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VSTX avec une instance de la classe Diagram1. Appelez la méthode Diagram.save avec le chemin du fichier de sortie et SaveFileFormat comme paramètres1. Le fichier VSDX sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="VSTX vers VSDX Java code source de conversion" offSpacer="" %}}

```cs
// charger le VSTX dans un objet de Diagram 
Diagram visio = new Diagram("template.vstx");
// enregistrer VSTX sous VSDX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX à VSDX démonstrations en direct de conversion" sectionDescription="[Convertir VSTX en VSDX](https://products.aspose.app/diagram/conversion/vstx-to-vsdx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier VSTX, il sera converti instantanément en VSDX." >}}
