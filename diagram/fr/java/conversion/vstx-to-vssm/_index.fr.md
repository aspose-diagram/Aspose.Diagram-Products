...
description: Exemple de code de conversion Java pour le format VSTX vers le fichier VSSM. Utilisez cet exemple de code pour convertir VSTX en VSSM dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSSM en utilisant Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir le fichier VSTX en VSSM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTX à VSSM Java code source des conversions" offSpacer="" %}}
