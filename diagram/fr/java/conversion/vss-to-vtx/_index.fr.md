...
description: Exemple de code de conversion Java pour le format VSS vers le fichier VTX. Utilisez cet exemple de code pour convertir VSS en VTX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir le fichier VSS en VTX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSS vers VTX Java code source de conversion" offSpacer="" %}}

```cs
// charger le VSS dans un objet de Diagram 
Diagram visio = new Diagram("template.vss");
// enregistrer VSS sous VTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSS à VTX démonstrations en direct de conversion" sectionDescription="[Convertir VSS en VTX](https://products.aspose.app/diagram/conversion/vss-to-vtx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
