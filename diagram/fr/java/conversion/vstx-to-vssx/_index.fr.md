...
description: Exemple de code de conversion Java pour le format VSTX vers le fichier VSSX. Utilisez cet exemple de code pour convertir VSTX en VSSX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSSX en utilisant Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir le fichier VSTX en VSSX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTX à VSSX Java code source des conversions" offSpacer="" %}}
