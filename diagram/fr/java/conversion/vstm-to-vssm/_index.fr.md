...
description: Exemple de code de conversion Java pour le format VSTM vers le fichier VSSM. Utilisez cet exemple de code pour convertir VSTM en VSSM dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTM en VSSM en utilisant Java" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir le fichier VSTM en VSSM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTM à VSSM Java code source des conversions" offSpacer="" %}}

```cs
// charger le VSTM dans un objet de Diagram 
Diagram visio = new Diagram("template.vstm");
// enregistrer VSTM sous VSSM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM à VSSM démos en direct de conversion" sectionDescription="[Convertir VSTM en VSSM](https://products.aspose.app/diagram/conversion/vstm-to-vssm) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
