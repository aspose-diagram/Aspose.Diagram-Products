---
title: Convertir VSTM en VSTX via Java 
weight: 4750
url: /fr/java/conversion/vstm-to-vstx/ 
description: Exemple de code de conversion Java pour le format VSTM vers le fichier VSTX. Utilisez cet exemple de code pour convertir VSTM en VSTX dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTM en VSTX via Java" h2="Exportez Microsoft Visio VSTM vers VSTX à l\'aide de la bibliothèque native Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTM en VSTX en utilisant Java" %}}

 Afin de rendre VSTM à VSTX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSTM en VSTX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier VSTM en VSTX en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VSTM avec une instance de la classe Diagram1. Appelez la méthode Diagram.save avec le chemin du fichier de sortie et SaveFileFormat comme paramètres1. Le fichier VSTX sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="VSTM à VSTX Java code source des conversions" offSpacer="" %}}

```cs
// charger le VSTM dans un objet de Diagram 
Diagram visio = new Diagram("template.vstm");
// enregistrer VSTM sous VSTX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM à VSTX démos en direct de conversion" sectionDescription="[Convertir VSTM en VSTX](https://products.aspose.app/diagram/conversion/vstm-to-vstx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier VSTM, il sera converti instantanément en VSTX." >}}
