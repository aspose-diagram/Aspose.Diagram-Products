---
title: Convertir VSTM en HTML via Java 
weight: 1540
url: /fr/java/conversion/vstm-to-html/ 
description: Exemple de code de conversion Java pour le format VSTM en fichier HTML. Utilisez cet exemple de code pour convertir VSTM en HTML dans n'importe quelle application Web ou de bureau Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTM en HTML via Java" h2="Exportez Microsoft Visio VSTM au format HTML à l\'aide de la bibliothèque native Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTM en HTML en utilisant Java" %}}

 Afin de rendre VSTM en HTML, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSTM en HTML via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir le fichier VSTM en HTML en quelques lignes de code seulement.

{{% /blocks/products/pf/agp/text %}}

1. Charger le fichier VSTM avec une instance de la classe Diagram1. Appelez la méthode Diagram.save avec le chemin du fichier de sortie et SaveFileFormat comme paramètres1. Le fichier HTML sera enregistré dans le chemin spécifié
...
{{% blocks/products/pf/agp/code-block title="VSTM en code source de conversion HTML Java" offSpacer="" %}}

```cs
// charger le VSTM dans un objet de Diagram 
Diagram visio = new Diagram("template.vstm");
// enregistrer VSTM au format HTML 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTM vers des démonstrations en direct de conversion HTML" sectionDescription="[Convertir VSTM en HTML](https://products.aspose.app/diagram/conversion/vstm-to-html) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Pas besoin de télécharger Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Pas besoin d\'écrire de code." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Téléchargez simplement votre fichier VSTM, il sera converti instantanément en HTML." >}}
