...
description: Exemple de code de conversion Java pour le format VSTX en fichier VDX. Utilisez cet exemple de code pour convertir VSTX en VDX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VDX à l\'aide de Java" %}}

 Afin de rendre VSTX en VDX, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir un fichier VSTX en VDX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSTX vers VDX Java" offSpacer="" %}}

```cs
// charger le VSTX dans un objet de Diagram 
Diagram visio = new Diagram("template.vstx");
// enregistrer VSTX en tant que VDX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion VSTX vers VDX" sectionDescription="[Convertir VSTX en VDX](https://products.aspose.app/diagram/conversion/vstx-to-vdx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
