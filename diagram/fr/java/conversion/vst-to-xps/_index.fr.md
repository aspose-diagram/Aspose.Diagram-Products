...
{{% blocks/products/pf/agp/content h2="Comment convertir VST en XPS en utilisant Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VST en XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Java peuvent facilement convertir un fichier VST en XPS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VST vers XPS Java" offSpacer="" %}}
