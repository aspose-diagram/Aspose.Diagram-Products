...
description: Exemple de code de conversion Java pour le format VSS vers le fichier VSSM. Utilisez cet exemple de code pour convertir VSS en VSSM dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir le fichier VSS en VSSM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSS vers VSSM Java code source de conversion" offSpacer="" %}}

```cs
// charger le VSS dans un objet de Diagram 
Diagram visio = new Diagram("template.vss");
// enregistrer VSS sous VSSM 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSS à VSSM démonstrations en direct de conversion" sectionDescription="[Convertir VSS en VSSM](https://products.aspose.app/diagram/conversion/vss-to-vssm) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
