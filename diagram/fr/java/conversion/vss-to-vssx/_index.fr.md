...
description: Exemple de code de conversion Java pour le format VSS vers le fichier VSSX. Utilisez cet exemple de code pour convertir VSS en VSSX dans n'importe quelle application Web ou de bureau Java.
---
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSS en VSSX à l\'aide de Java" %}}
 ...
 Afin de rendre VSS à VSSX, nous utiliserons
...
{{% blocks/products/pf/agp/text %}}
 ...
 Les développeurs Java peuvent facilement convertir le fichier VSS en VSSX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSS vers VSSX Java code source de conversion" offSpacer="" %}}

```cs
// charger le VSS dans un objet de Diagram 
Diagram visio = new Diagram("template.vss");
// enregistrer VSS sous VSSX 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSS à VSSX démonstrations en direct de conversion" sectionDescription="[Convertir VSS en VSSX](https://products.aspose.app/diagram/conversion/vss-to-vssx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
