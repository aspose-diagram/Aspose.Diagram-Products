---
title: Créer VSSM fichiers via Java 
url: /fr/java/create-vssm/ 
description: Java Exemple de code pour générer VSSM documents. Utilisez ce code pour créer des fichiers VSSM dans une application Web ou de bureau basée sur Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer VSSM documents via Java" h2="Création native et hautes performances de VSSM (Portable Document Format) par programmation à l\'aide de la bibliothèque Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="VSSM" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Comment créer VSSM via Java" %}}
