---
title: Dessinez la géométrie dans le document VSX via Java 
weight: 3050
url: /fr/Java/drawing/vsx/ 
description: Code source Java pour dessiner la géométrie dans le fichier vsx sur l'environnement d'exécution Java pour l'application JSP/JSF et les applications de bureau.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dessinez la géométrie sur VSX dans Java" h2="Géométrie de dessin native et hautes performances pour VSX documenter à l\'aide d\'API côté serveur Aspose.Diagram for Java, sans utiliser de logiciel tel que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment dessiner la géométrie dans le fichier VSX à l\'aide de Java" %}}

 Afin de dessiner la géométrie dans le fichier VSX, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour dessiner la géométrie dans VSX fichiers dans Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Dessiner la géométrie dans VSX fichiers - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram est une Microsoft Visio manipulation de format de document API. On peut facilement charger, créer, modifier, manipuler, y compris des éléments de daigramme et convertir des diagrammes Visio en d'autres formats tels que PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF et plus encore. Il s'agit d'un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Géométrie de dessin en ligne pour VSX documenter des démonstrations en direct" sectionDescription="Dessinez la géométrie de VSX documents dès maintenant en visitant notre [Site Web de démos en direct](https://products.aspose.app/diagram/drawing). La démo en direct présente les avantages suivants" >}}
