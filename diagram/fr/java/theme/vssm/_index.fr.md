---
title: Appliquer le thème prédéfini au document VSSM via Java 
weight: 3050
url: /fr/Java/theme/vssm/ 
description: Code source Java pour appliquer le thème prédéfini au fichier vssm sur Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Appliquer le thème prédéfini à VSSM dans Java" h2="Application native et hautes performances d\'un thème prédéfini au document VSSM à l\'aide d\'API côté serveur Aspose.Diagram for Java, sans utiliser de logiciel tel que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment appliquer un thème prédéfini au fichier VSSM à l\'aide de Java" %}}

 Afin d'appliquer un thème prédéfini au fichier VSSM, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour appliquer le thème prédéfini aux fichiers VSSM dans Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Fichiers de filigrane VSSM - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram est une Microsoft Visio manipulation de format de document API. On peut facilement charger, créer, modifier, manipuler, y compris des éléments de daigramme et convertir des diagrammes Visio en d'autres formats tels que PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF et plus encore. Il s'agit d'un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Application en ligne d\'un thème prédéfini pour VSSM documenter des démonstrations en direct" sectionDescription="Appliquez un thème prédéfini à VSSM documents dès maintenant en visitant notre [Site Web de démos en direct](https://products.aspose.app/diagram/theme). La démo en direct présente les avantages suivants" >}}
