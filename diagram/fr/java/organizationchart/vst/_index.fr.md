---
title: Créer un organigramme dans le document VST via Java 
weight: 3050
url: /fr/Java/organizationchart/vst/ 
description: Java code source pour créer un organigramme dans un fichier vst sur Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Créer un organigramme dans VST dans Java" h2="Créez un organigramme natif et hautes performances dans un document VST à l\'aide d\'API Aspose.Diagram for Java côté serveur, sans utiliser de logiciel tel que Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment créer un organigramme dans un fichier VST à l\'aide de Java" %}}

 Afin de créer un organigramme dans un fichier VST, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour créer un organigramme dans les fichiers VST dans Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Créer un organigramme dans les fichiers VST - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram est une Microsoft Visio manipulation de format de document API. On peut facilement charger, créer, modifier, manipuler, y compris des éléments de daigramme et convertir des diagrammes Visio en d'autres formats tels que PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF et plus encore. Il s'agit d'un API autonome et ne nécessite pas l'installation de Microsoft Visio ou de tout autre logiciel.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Organigramme de style VST CompactTree en ligne Démonstrations en direct" sectionDescription="Créez dès maintenant un organigramme de style CompactTree dans des documents VST en visitant notre [Site Web de démos en direct](https://products.aspose.app/diagram/organizationchart). La démo en direct présente les avantages suivants" >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Il créera instantanément un organigramme de style CompactTree dans les documents VST." >}}
