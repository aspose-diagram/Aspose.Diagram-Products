...
{{< blocks/products/pf/carousel-item h3="En bref" description="Un aperçu de Aspose.Diagram pour Python via les capacités de Java." >}}
...
{{< blocks/products/pf/carousel-item h3="Indépendance de la plate-forme" description="Aspose.Diagram pour Python via Java est côté serveur Python API basé sur Java. Il peut fonctionner sur les plates-formes Windows, Unix/Linux et Mac avec JDK 1.6 ou supérieur." >}}
<div class="diagram1 d1-python">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Fonctionnalités Python Visio API avancées
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Diagram pour Python est simple et facile à utiliser. Il permet aux utilisateurs de travailler avec des diagrammes sans aucune compréhension du format sous-jacent, comme on peut créer des fichiers VSDX à partir de zéro avec seulement quelques lignes de code.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Créez le format VSDX à partir de zéro en utilisant Python
     </h3>
...
diagram.save("output.vsdx", SaveFileFormat.VSDX)</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Les développeurs peuvent facilement charger des fichiers Visio et les exporter vers des images populaires telles que PNG, TIFF, JPEG, BMP, SVG et EMF. La bibliothèque Python prend également en charge l'exportation de fichiers Visio au format PDF &amp; Formats XPS avec la plus haute fidélité.
    </p>
    <div class="codeblock" id="code">
     <h3>
...
{{< blocks/products/pf/slr-element name="API références" href="https://apireference.aspose.com/diagram/python" >}}
