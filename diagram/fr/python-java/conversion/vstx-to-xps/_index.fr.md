---
title: Convertir VSTX en XPS via Python 
weight: 1960
url: /fr/python-java/conversion/vstx-to-xps/ 
description: Exemple de code de conversion Python pour le format VSTX en fichier XPS. Utilisez cet exemple de code pour convertir VSTX en XPS dans n'importe quelle application basée sur Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTX en XPS via Python" h2="Exportez Microsoft Visio VSTX vers XPS à l\'aide des API Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en XPS en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSTX en XPS via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement convertir le fichier VSTX en XPS en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTX à XPS Python Code source de conversion" offSpacer="" %}}
...
// enregistrer VSTX en tant que XPS 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX vers démos en direct de conversion XPS" sectionDescription="[Convertir VSTX en XPS](https://products.aspose.app/diagram/conversion/vstx-to-xps) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
...
VSTX est le format de fichier du service graphique Visio qui spécifie les flux et les stockages requis pour le rendu d'un dessin Web. Un dessin Web est un ensemble de pages de dessin, de formes, de polices, d'images, de connexions de données et d'informations de mise à jour diagram pouvant être rendues sous forme de dessin vectoriel ou raster. Les fichiers VSTX peuvent également être ouverts dans Microsoft Visio mais sont principalement enregistrés pour une utilisation sur le Web. Microsoft Visio offre la possibilité de convertir des fichiers Visio dans un certain nombre de formats de fichiers différents, notamment PNG, BMP, PDF et autres.
