---
title: Convertir VSTX en VDX via Python 
weight: 1960
url: /fr/python-java/conversion/vstx-to-vdx/ 
description: Exemple de code de conversion Python pour le format VSTX vers le fichier VDX. Utilisez cet exemple de code pour convertir VSTX en VDX dans n'importe quelle application basée sur Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTX en VDX via Python" h2="Exportez Microsoft Visio VSTX vers VDX à l\'aide des API Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VDX en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSTX en VDX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement convertir le fichier VSTX en VDX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTX à VDX Python code source des conversions" offSpacer="" %}}
