---
title: Convertir VSTX en VSDX via Python 
weight: 1960
url: /fr/python-java/conversion/vstx-to-vsdx/ 
description: Exemple de code de conversion Python pour le format VSTX vers le fichier VSDX. Utilisez cet exemple de code pour convertir VSTX en VSDX dans n'importe quelle application basée sur Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTX en VSDX via Python" h2="Exportez Microsoft Visio VSTX vers VSDX à l\'aide des API Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en VSDX en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSTX en VSDX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement convertir le fichier VSTX en VSDX en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTX à VSDX Python code source des conversions" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX à VSDX démos en direct de conversion" sectionDescription="[Convertir VSTX en VSDX](https://products.aspose.app/diagram/conversion/vstx-to-vsdx) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
