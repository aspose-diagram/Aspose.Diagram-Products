---
title: Convertir VSD en VSTM via Python 
weight: 1960
url: /fr/python-java/conversion/vsd-to-vstm/ 
description: Exemple de code de conversion Python pour le format VSD vers le fichier VSTM. Utilisez cet exemple de code pour convertir VSD en VSTM dans n'importe quelle application basée sur Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSD en VSTM via Python" h2="Exportez Microsoft Visio VSD vers VSTM à l\'aide des API Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSD en VSTM en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSD en VSTM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement convertir le fichier VSD en VSTM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSD à VSTM Python code source des conversions" offSpacer="" %}}
