---
title: Convertir VSTX en TIFF via Python 
weight: 1960
url: /fr/python-java/conversion/vstx-to-tiff/ 
description: Exemple de code de conversion Python pour le format VSTX en fichier TIFF. Utilisez cet exemple de code pour convertir VSTX en TIFF dans n'importe quelle application basée sur Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTX en TIFF via Python" h2="Exportez Microsoft Visio VSTX au format TIFF à l\'aide des API Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en TIFF en utilisant Python" %}}

 Afin de rendre VSTX au format TIFF, nous utiliserons
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSTX en TIFF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement convertir le fichier VSTX en TIFF en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTX vers TIFF Python code source de conversion" offSpacer="" %}}
