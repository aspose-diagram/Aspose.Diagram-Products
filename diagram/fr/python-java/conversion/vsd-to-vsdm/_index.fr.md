---
title: Convertir VSD en VSDM via Python 
weight: 1960
url: /fr/python-java/conversion/vsd-to-vsdm/ 
description: Exemple de code de conversion Python pour le format VSD vers le fichier VSDM. Utilisez cet exemple de code pour convertir VSD en VSDM dans n'importe quelle application basée sur Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSD en VSDM via Python" h2="Exportez Microsoft Visio VSD vers VSDM à l\'aide des API Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSD en VSDM en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSD en VSDM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement convertir le fichier VSD en VSDM en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSD à VSDM Python code source des conversions" offSpacer="" %}}
