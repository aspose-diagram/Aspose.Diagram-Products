---
title: Convertir VSTX en SVG via Python 
weight: 1960
url: /fr/python-java/conversion/vstx-to-svg/ 
description: Exemple de code de conversion Python pour le format VSTX en fichier SVG. Utilisez cet exemple de code pour convertir VSTX en SVG dans n'importe quelle application basée sur Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTX en SVG via Python" h2="Exportez Microsoft Visio VSTX vers SVG à l\'aide des API Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en SVG en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSTX en SVG via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement convertir le fichier VSTX en SVG en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTX en SVG Python Code source de conversion" offSpacer="" %}}
...
// enregistrer VSTX au format SVG 
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSTX vers des démonstrations en direct de conversion SVG" sectionDescription="[Convertir VSTX en SVG](https://products.aspose.app/diagram/conversion/vstx-to-svg) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
