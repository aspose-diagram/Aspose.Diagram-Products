---
title: Convertir VSTX en PNG via Python 
weight: 1960
url: /fr/python-java/conversion/vstx-to-png/ 
description: Exemple de code de conversion Python pour le format VSTX en fichier PNG. Utilisez cet exemple de code pour convertir VSTX en PNG dans n'importe quelle application basée sur Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSTX en PNG via Python" h2="Exportez Microsoft Visio VSTX au format PNG à l\'aide des API Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSTX en PNG en utilisant Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSTX en PNG via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement convertir le fichier VSTX en PNG en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="VSTX vers PNG Python Code source de conversion" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Démonstrations en direct de la conversion de VSTX en PNG" sectionDescription="[Convertir VSTX en PNG](https://products.aspose.app/diagram/conversion/vstx-to-png) dès maintenant en visitant notre site Web Live Demos. La démonstration en direct présente les avantages suivants" >}}
