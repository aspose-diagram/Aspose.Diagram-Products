---
title: Convertir VSS en TIFF via Python 
weight: 1960
url: /fr/python-java/conversion/vss-to-tiff/ 
description: Exemple de code de conversion Python pour le format VSS en fichier TIFF. Utilisez cet exemple de code pour convertir VSS en TIFF dans n'importe quelle application basée sur Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Convertir VSS en TIFF via Python" h2="Exportez Microsoft Visio VSS vers TIFF à l\'aide de Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Comment convertir VSS en TIFF à l\'aide de Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour convertir VSS en TIFF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Les développeurs Python peuvent facilement convertir un fichier VSS en TIFF en quelques lignes de code seulement.
...
{{% blocks/products/pf/agp/code-block title="Code source de conversion VSS vers TIFF Python" offSpacer="" %}}
