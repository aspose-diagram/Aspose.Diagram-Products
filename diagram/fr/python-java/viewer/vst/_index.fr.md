---
title: Afficher les formats de fichiers VST via Python 
weight: 3480
url: /fr/python-java/viewer/vst/ 
description: Code source Python pour charger, rendre et afficher des documents VST dans n'importe quelle application basée sur Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Visionneuse de fichiers VST pour Python" h2="Visionneuse de documents VST native utilisant les API Python côté serveur." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Étapes pour afficher VST via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python code pour voir VST" offSpacer="" %}}

```cs

// charger le fichier VST via une instance de Diagram
diagram =  Aspose.Diagram.Diagram("template.vst");
// convertir VST au format HTML puis charger le HTML résultant dans le navigateur par défaut
