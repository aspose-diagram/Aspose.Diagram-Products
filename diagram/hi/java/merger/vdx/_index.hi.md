---
title: Java के द्वारा VDX फ़ाइलें मर्ज करें 
weight: 1830
url: /hi/java/merger/vdx/ 
description: Java जेएसपी/जेएसएफ एप्लिकेशन और डेस्कटॉप एप्लिकेशन के लिए रनटाइम एनवायरनमेंट पर VDX दस्तावेज़ों को संयोजित करने के लिए Java नमूना कोड।
---
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके VDX फ़ाइलें कैसे मर्ज करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java में VDX फ़ाइलें मर्ज करने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="मर्ज करें VDX फ़ाइलें - Java" offSpacer="" %}}
