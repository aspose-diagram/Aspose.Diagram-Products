...
{{% blocks/products/pf/agp/text %}}
 ...
 Java डेवलपर कोड की कुछ ही पंक्तियों में आसानी से VSDX फ़ाइल को VSSM में बदल सकते हैं।
...
{{% blocks/products/pf/agp/code-block title="VSDX से VSSM Java रूपांतरण स्रोत कोड" offSpacer="" %}}
