---
title: VSS को VSTM में Java के माध्यम से परिवर्तित करें 
weight: 4930
url: /hi/java/conversion/vss-to-vstm/ 
description: नमूना Java वीएसएस प्रारूप के लिए वीएसटीएम फ़ाइल में रूपांतरण कोड। किसी भी वेब या डेस्कटॉप Java आधारित एप्लिकेशन में VSS को VSTM में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSS को VSTM में Java के माध्यम से परिवर्तित करें" h2="मूल Java लाइब्रेरी का उपयोग करके Microsoft Visio VSS को VSTM में निर्यात करें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके VSS को VSTM में कैसे बदलें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="वीएसएस को वीएसटीएम में बदलने के लिए कदम Java के माध्यम से" %}}

{{% blocks/products/pf/agp/text %}}

 Java डेवलपर कोड की कुछ ही पंक्तियों में आसानी से VSS फ़ाइल को VSTM में बदल सकते हैं।
...
{{% blocks/products/pf/agp/code-block title="VSS से VSTM Java रूपांतरण स्रोत कोड" offSpacer="" %}}

```cs
// VSS को Diagram के ऑब्जेक्ट में लोड करें 
Diagram visio = new Diagram("template.vss");
// वीएसएस को वीएसटीएम के रूप में सहेजें 
...
{{< blocks/products/pf/agp/demobox sectionTitle="वीएसएस से वीएसटीएम रूपांतरण लाइव डेमो" sectionDescription="[VSS को VSTM में बदलें](https://products.aspose.app/diagram/conversion/vss-to-vstm) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API डाउनलोड करने की आवश्यकता नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" कोई कोड लिखने की जरूरत नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" बस अपनी वीएसएस फाइल अपलोड करें, यह तुरंत वीएसटीएम में बदल जाएगी।" >}}
