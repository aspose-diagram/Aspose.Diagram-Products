---
title: VSX को SVG में Java के माध्यम से कनवर्ट करें 
weight: 2340
url: /hi/java/conversion/vsx-to-svg/ 
description: नमूना Java वीएसएक्स प्रारूप के लिए एसवीजी फ़ाइल में रूपांतरण कोड। किसी भी वेब या डेस्कटॉप Java आधारित एप्लिकेशन में वीएसएक्स को एसवीजी में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSX को SVG में Java के माध्यम से कनवर्ट करें" h2="मूल Java लाइब्रेरी का उपयोग करके Microsoft Visio VSX को SVG में निर्यात करें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Java का उपयोग करके VSX को SVG में कैसे बदलें" %}}
 ...
 वीएसएक्स को एसवीजी में प्रस्तुत करने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="वीएसएक्स को एसवीजी में बदलने के लिए कदम Java के माध्यम से" %}}

{{% blocks/products/pf/agp/text %}}

 Java डेवलपर कोड की कुछ ही पंक्तियों में आसानी से VSX फ़ाइल को SVG में बदल सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. VSX फ़ाइल को Diagram class . के उदाहरण के साथ लोड करें1. आउटपुट फ़ाइल पथ के साथ Diagram.save विधि को कॉल करें और पैरामीटर के रूप में SaveFileFormat1. SVG फ़ाइल निर्दिष्ट पथ पर सहेजी जाएगी
...
{{% blocks/products/pf/agp/code-block title="वीएसएक्स से एसवीजी Java रूपांतरण स्रोत कोड" offSpacer="" %}}

```cs
// VSX को Diagram के ऑब्जेक्ट में लोड करें 
Diagram visio = new Diagram("template.vsx");
// वीएसएक्स को एसवीजी के रूप में सहेजें 
...
{{< blocks/products/pf/agp/demobox sectionTitle="वीएसएक्स से एसवीजी रूपांतरण लाइव डेमो" sectionDescription="[VSX को SVG में बदलें](https://products.aspose.app/diagram/conversion/vsx-to-svg) अभी हमारी लाइव डेमो वेबसाइट पर जाकर। लाइव डेमो के निम्नलिखित लाभ हैं" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Aspose API डाउनलोड करने की आवश्यकता नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" कोई कोड लिखने की जरूरत नहीं है।" >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" बस अपनी वीएसएक्स फ़ाइल अपलोड करें, यह तुरंत एसवीजी में परिवर्तित हो जाएगी।" >}}
