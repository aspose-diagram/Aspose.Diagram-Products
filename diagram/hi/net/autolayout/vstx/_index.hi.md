---
title: ऑटो लेआउट VSTX दस्तावेज़ .NET के माध्यम से 
weight: 3050
url: /hi/net/autolayout/vstx/ 
description: .NET Framework, .NET कोर, Mono प्लेटफॉर्म पर C# ऑटो लेआउट के लिए स्रोत कोड vstx फ़ाइल।
---
...
{{% blocks/products/pf/agp/content h2="ऑटो लेआउट कैसे करें VSTX फ़ाइल का उपयोग करके C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ऑटो लेआउट के लिए चरण VSTX फ़ाइलें C# में" %}}
