---
title: ऑटो लेआउट VTX दस्तावेज़ .NET के माध्यम से 
weight: 3050
url: /hi/net/autolayout/vtx/ 
description: .NET Framework, .NET कोर, Mono प्लेटफॉर्म पर C# ऑटो लेआउट के लिए स्रोत कोड vtx फ़ाइल।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# में ऑटो लेआउट VTX दस्तावेज़" h2="Microsoft या ओपन Office, Adobe PDF जैसे किसी सॉफ़्टवेयर के उपयोग के बिना, सर्वर-साइड Aspose.Diagram for .NET API का उपयोग करते हुए मूल और उच्च प्रदर्शन ऑटो लेआउट VTX दस्तावेज़।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="ऑटो लेआउट कैसे करें VTX फ़ाइल का उपयोग करके C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="ऑटो लेआउट के लिए चरण VTX फ़ाइलें C# में" %}}
...
{{% blocks/products/pf/agp/code-block title="ऑटो लेआउट VTX फ़ाइलें - C#" offSpacer="" %}}
