...
description: .NET Framework, .NET कोर, Mono प्लेटफॉर्म पर vssx फ़ाइल में वॉटरमार्क जोड़ने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# में VSSX में टेक्स्ट वॉटरमार्क जोड़ें" h2="Microsoft या ओपन Office, Adobe PDF जैसे किसी सॉफ़्टवेयर के उपयोग के बिना सर्वर-साइड Aspose.Diagram for .NET API का उपयोग करते हुए मूल और उच्च प्रदर्शन VSSX दस्तावेज़ वॉटरमार्क।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="वॉटरमार्क कैसे करें VSSX फ़ाइल का उपयोग करके C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="वॉटरमार्किंग के चरण VSSX में फ़ाइलें C#" %}}
