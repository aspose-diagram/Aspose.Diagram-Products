...
description: VSSM से PNG C# रूपांतरण के लिए नमूना कोड। वीबी.NET, एएसपी.NET या किसी .NET आधारित एप्लिकेशन के भीतर वीएसएसएम फाइलों को पीएनजी रूपांतरण में बैच वीएसएसएम फाइलों के लिए API उदाहरण कोड का प्रयोग करें।
---
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके VSSM को PNG में कैसे बदलें" %}}
 ...
 VSSM को PNG में बदलने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="VSSM को C# के माध्यम से PNG में कनवर्ट करने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर कोड की कुछ ही पंक्तियों में आसानी से VSSM फ़ाइलों को PNG में लोड और कनवर्ट कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. VSSM फ़ाइल को Diagram class . के उदाहरण के साथ लोड करें1. आउटपुट फ़ाइल पथ के साथ Diagram.Save विधि और पैरामीटर के रूप में SaveFileFormat.PNG को कॉल करें1. पीएनजी फ़ाइल निर्दिष्ट पथ पर सहेजी जाएगी
...
{{< blocks/products/pf/agp/demobox sectionTitle="वीएसएसएम को पीएनजी में बदलने के लिए नि: शुल्क ऐप" sectionDescription="इसके लिए हमारे लाइव डेमो देखें [वीएसएसएम से पीएनजी रूपांतरण](https://products.aspose.app/diagram/conversion/vssm-to-png) निम्नलिखित लाभों के साथ।" >}}
