---
title: C# के द्वारा VSX को HTML में बदलें 
weight: 3410
url: /hi/net/conversion/vsx-to-html/ 
description: VSX से HTML C# रूपांतरण के लिए नमूना कोड। VB.NET, Asp.NET या किसी भी .NET आधारित एप्लिकेशन के अंतर्गत HTML रूपांतरण में बैच VSX फ़ाइलों के लिए API उदाहरण कोड का उपयोग करें।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# के द्वारा VSX को HTML में बदलें" h2="Microsoft® Visio VSX फ़ाइलें HTML में .NET Framework, .NET कोर, Mono या COM इंटरऑप पर निर्यात करें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# के द्वारा VSX को HTML में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर कोड की कुछ ही पंक्तियों में VSX फ़ाइलों को HTML में आसानी से लोड और रूपांतरित कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. Diagram वर्ग के उदाहरण के साथ VSX फ़ाइल लोड करें1. आउटपुट फ़ाइल पथ के साथ Diagram.Save विधि और पैरामीटर के रूप में SaveFileFormat.HTML को कॉल करें1. HTML फ़ाइल निर्दिष्ट पथ पर सहेजी जाएगी
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSX को HTML में बदलने के लिए निःशुल्क ऐप" sectionDescription="इसके लिए हमारे लाइव डेमो देखें [VSX से HTML रूपांतरण](https://products.aspose.app/diagram/conversion/vsx-to-html) निम्नलिखित लाभों के साथ।" >}}
