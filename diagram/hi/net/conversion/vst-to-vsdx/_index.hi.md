---
title: VST को VSDX से C# में बदलें 
weight: 3760
url: /hi/net/conversion/vst-to-vsdx/ 
description: VST से VSDX C# रूपांतरण के लिए नमूना कोड। बैच VST फ़ाइलों के लिए API उदाहरण कोड का उपयोग करें VSDX VB के भीतर रूपांतरण.NET, Asp.NET या कोई .NET आधारित एप्लिकेशन।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VST को VSDX से C# में बदलें" h2=".NET Framework, .NET कोर, Mono या COM इंटरऑप पर VSDX में Microsoft® Visio VST फ़ाइलें निर्यात करें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके VST को VSDX में कैसे बदलें" %}}

 VST को VSDX में बदलने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="VST को C# के माध्यम से VSDX में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर कोड की कुछ ही पंक्तियों में VST फ़ाइलों को आसानी से लोड और VSDX में परिवर्तित कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. VST फ़ाइल को Diagram class . के उदाहरण के साथ लोड करें1. पैरामीटर के रूप में Diagram.Save विधि को आउटपुट फ़ाइल पथ और SaveFileFormat.VSDX के साथ कॉल करें1. VSDX फ़ाइल निर्दिष्ट पथ पर सहेजी जाएगी
...
{{% blocks/products/pf/agp/code-block title="यह नमूना कोड VST को VSDX C# रूपांतरण दिखाता है" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="वीएसटी को VSDX में बदलने के लिए नि:शुल्क ऐप" sectionDescription="इसके लिए हमारे लाइव डेमो देखें [VST से VSDX रूपांतरण](https://products.aspose.app/diagram/conversion/vst-to-vsdx) निम्नलिखित लाभों के साथ।" >}}
