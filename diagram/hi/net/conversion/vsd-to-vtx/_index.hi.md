---
title: C# के माध्यम से VSD को VTX में बदलें 
weight: 4870
url: /hi/net/conversion/vsd-to-vtx/ 
description: VSD से VTX C# रूपांतरण के लिए नमूना कोड। बैच VSD फ़ाइलों के लिए VTX VB.NET, Asp.NET या किसी .NET आधारित एप्लिकेशन में रूपांतरण के लिए API उदाहरण कोड का उपयोग करें।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# के माध्यम से VSD को VTX में बदलें" h2=".NET Framework, .NET कोर, Mono या COM इंटरऑप पर Microsoft® Visio VSD फ़ाइलें VTX में निर्यात करें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके VSD को VTX में कैसे बदलें" %}}

 VSD को VTX में बदलने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से VSD को VTX में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 .NET डेवलपर कोड की कुछ ही पंक्तियों में VSD फ़ाइलों को VTX में आसानी से लोड और रूपांतरित कर सकते हैं।

{{% /blocks/products/pf/agp/text %}}

1. Diagram वर्ग के उदाहरण के साथ VSD फ़ाइल लोड करें1. पैरामीटर के रूप में Diagram.Save विधि को आउटपुट फ़ाइल पथ और SaveFileFormat.VTX के साथ कॉल करें1. VTX फ़ाइल निर्दिष्ट पथ पर सहेजी जाएगी
...
{{% blocks/products/pf/agp/code-block title="यह नमूना कोड VSD से VTX C# रूपांतरण दिखाता है" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD को VTX में बदलने के लिए निःशुल्क ऐप" sectionDescription="इसके लिए हमारे लाइव डेमो देखें [VSD से VTX रूपांतरण](https://products.aspose.app/diagram/conversion/vsd-to-vtx) निम्नलिखित लाभों के साथ।" >}}
