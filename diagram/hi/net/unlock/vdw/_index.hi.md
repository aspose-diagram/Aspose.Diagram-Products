---
title: VDW दस्तावेज़ को .NET के माध्यम से अनलॉक करें 
weight: 5680
url: /hi/net/unlock/vdw/ 
description: .NET Framework, .NET कोर, Mono प्लेटफ़ॉर्म पर VDW फ़ाइल को अनलॉक करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW फ़ाइलें C# के माध्यम से अनलॉक करें" h2=".NET लाइब्रेरी का उपयोग करके VDW प्रारूप सहित Visio से सुरक्षा निकालें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके VDW फ़ाइल को कैसे अनलॉक करें" %}}

 VDW फ़ाइल को अनलॉक करने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="VDW फ़ाइलों को C# में अनलॉक करने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="VDW फ़ाइलें अनलॉक करें - C#" offSpacer="" %}}
