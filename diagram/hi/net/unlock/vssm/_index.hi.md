---
title: .NET के माध्यम से VSSM दस्तावेज़ अनलॉक करें 
weight: 5680
url: /hi/net/unlock/vssm/ 
description: .NET Framework, .NET कोर, Mono प्लेटफॉर्म पर VSSM फ़ाइल को अनलॉक करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# के माध्यम से VSSM फ़ाइलें अनलॉक करें" h2=".NET लाइब्रेरी का उपयोग करके VSSM प्रारूप सहित Visio से सुरक्षा निकालें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="VSSM फ़ाइल का उपयोग करके C# कैसे अनलॉक करें" %}}

 VSSM फ़ाइल को अनलॉक करने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="C# में VSSM फ़ाइलें अनलॉक करने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSM फ़ाइलें अनलॉक करें - C#" offSpacer="" %}}
