---
title: VSSM दस्तावेज़ को .NET के माध्यम से संपीड़ित करें 
weight: 3050
url: /hi/net/compress/vssm/ 
description: .NET Framework, .NET Core, Mono प्लेटफॉर्म पर vssm फ़ाइल को संपीड़ित करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="वीएसएसएम को C# में संपीड़ित करें" h2="Microsoft या Open Office, Adobe PDF जैसे किसी सॉफ़्टवेयर के उपयोग के बिना सर्वर-साइड Aspose.Diagram for .NET API का उपयोग करते हुए मूल और उच्च प्रदर्शन VSSM दस्तावेज़ कंप्रेसर।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके VSSM फ़ाइल को कैसे संपीड़ित करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="वीएसएसएम फाइलों को C# में कंप्रेस करने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSM फ़ाइलें संपीड़ित करें - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram एक Microsoft Visio दस्तावेज़ प्रारूप हेरफेर API है। कोई भी आसानी से लोड कर सकता है, बना सकता है, संशोधित कर सकता है, डायग्राम तत्वों सहित हेरफेर कर सकता है और Visio आरेखों को पीडीएफ, एक्सपीएस, जेपीईजी, पीएनजी, बीएमपी, टीआईएफएफ, एसवीजी, ईएमएफ और अन्य प्रारूपों में परिवर्तित कर सकता है। यह एक स्टैंडअलोन API है और इसके लिए Microsoft Visio या किसी अन्य सॉफ़्टवेयर को स्थापित करने की आवश्यकता नहीं है।  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="ऑनलाइन वीएसएसएम कंप्रेस लाइव डेमो" sectionDescription="हमारे . पर जाकर अभी वीएसएसएम दस्तावेजों को संपीड़ित करें [लाइव डेमो वेबसाइट](https://products.aspose.app/diagram/compress). लाइव डेमो के निम्नलिखित लाभ हैं" >}}
