---
title: .NET के माध्यम से VDX दस्तावेज़ को संपीड़ित करें 
weight: 3050
url: /hi/net/compress/vdx/ 
description: .NET Framework, .NET कोर, Mono प्लेटफ़ॉर्म पर vdx फ़ाइल को संपीड़ित करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDX को C# में संपीडित करें" h2="Microsoft या ओपन Office, Adobe PDF जैसे किसी सॉफ़्टवेयर के उपयोग के बिना सर्वर-साइड Aspose.Diagram for .NET API का उपयोग करते हुए मूल और उच्च प्रदर्शन VDX दस्तावेज़ कंप्रेसर।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="VDX फ़ाइल को C# का उपयोग करके कैसे संपीड़ित करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# में VDX फ़ाइलें संपीड़ित करने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="संपीड़ित करें VDX फ़ाइलें - C#" offSpacer="" %}}
