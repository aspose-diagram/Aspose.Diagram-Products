...
description: .NET Framework, .NET कोर, Mono या COM इंटरऑप पर VSTX दस्तावेज़ों को लोड करने, प्रस्तुत करने और प्रदर्शित करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTX फ़ाइल व्यूअर for .NET" h2="Visio एप्लिकेशन या Office स्वचालन की आवश्यकता के बिना ब्राउज़र में Microsoft Visio VSTX फ़ाइलें देखें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# के माध्यम से VSTX देखने के चरण" %}}
...
1. Diagram वर्ग के उदाहरण के साथ VSTX फ़ाइल लोड करें1. पैरामीटर के रूप में Diagram.Save विधि को SaveFileFormat.HTML के साथ कॉल करें1. परिणामी HTML को डिफ़ॉल्ट ब्राउज़र में Process.Start . के माध्यम से लोड करें
...
{{% blocks/products/pf/agp/code-block title="देखने के लिए C# कोड VSTX" offSpacer="" %}}

```cs

// Diagram के उदाहरण के माध्यम से VSTX फ़ाइल लोड करें
var diagram = new Aspose.Diagram.Diagram("template.vstx");
// VSTX को HTML प्रारूप में बदलें
