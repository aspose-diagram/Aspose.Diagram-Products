---
title: VST दस्तावेज़ में .NET के माध्यम से प्रीसेट थीम लागू करें 
weight: 3050
url: /hi/net/theme/vst/ 
description: .NET Framework, .NET कोर, Mono प्लेटफ़ॉर्म पर vst फ़ाइल में प्रीसेट थीम लागू करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VST में प्रीसेट थीम को C# में लागू करें" h2="Microsoft या ओपन Office, Adobe PDF जैसे किसी सॉफ़्टवेयर के उपयोग के बिना सर्वर-साइड Aspose.Diagram for .NET API का उपयोग करके VST दस्तावेज़ में मूल और उच्च प्रदर्शन प्रीसेट थीम लागू करते हैं।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके VST फ़ाइल में प्रीसेट थीम कैसे लागू करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# में VST फ़ाइलों में प्रीसेट थीम लागू करने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="वीएसटी फाइलों में प्रीसेट थीम लागू करें - C#" offSpacer="" %}}
