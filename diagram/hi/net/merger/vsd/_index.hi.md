---
title: .NET के द्वारा VSD फ़ाइलें मर्ज करें 
weight: 2530
url: /hi/net/merger/vsd/ 
description: .NET Framework, .NET कोर, Mono या COM इंटरऑप पर VSD दस्तावेज़ों को संयोजित करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSD स्वरूपों को C# में मर्ज करें" h2="Microsoft या ओपन Office, Adobe PDF जैसे किसी सॉफ़्टवेयर के उपयोग के बिना सर्वर-साइड Aspose.Diagram for .NET API का उपयोग करते हुए मूल और उच्च प्रदर्शन VSD दस्तावेज़ विलय।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="VSD फ़ाइल का उपयोग करके C# को कैसे मर्ज करें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# में VSD फ़ाइलें मर्ज करने के चरण" %}}
...
+ सभी VSD फाइलों को पूर्ण पथ के साथ लोड करें।
+ एक दस्तावेज़ को आधार फ़ाइल के रूप में बनाएं
+ फ़ाइलों को एक-एक करके संयोजित और मर्ज करने के लिए प्रासंगिक विधि को कॉल करें।
+ सहेजें() विधि को कॉल करें और फ़ाइल नाम (पूर्ण पथ) और प्रारूप (VSD) को पैरामीटर के रूप में पास करें।
+ अब आप Microsoft Office, Adobe PDF या किसी अन्य संगत प्रोग्राम में VSD फ़ाइल खोल सकते हैं और उसका उपयोग कर सकते हैं।
...
{{% blocks/products/pf/agp/code-block title="मर्ज करें VSD फ़ाइलें - C#" offSpacer="" %}}
