---
title: VDW दस्तावेज़ को .NET के माध्यम से सुरक्षित और लॉक करें 
weight: 5580
url: /hi/net/protect/vdw/ 
description: C# VDW फ़ाइल को .NET Framework, .NET कोर, Mono प्लेटफ़ॉर्म पर लॉक करने के लिए स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW फ़ाइलों को C# के माध्यम से सुरक्षित रखें" h2=".NET लाइब्रेरी का उपयोग करके VDW प्रारूप सहित Visio को सुरक्षित रखें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/code-block title="VDW फ़ाइलों को सुरक्षित रखें - C#" offSpacer="" %}}
