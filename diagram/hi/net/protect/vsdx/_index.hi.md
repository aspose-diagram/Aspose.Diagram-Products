---
title: .NET के माध्यम से VSDX दस्तावेज़ को सुरक्षित और लॉक करें 
weight: 5580
url: /hi/net/protect/vsdx/ 
description: .NET Framework, .NET कोर, Mono प्लेटफॉर्म पर VSDX फ़ाइल को लॉक करने के लिए C# स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# के माध्यम से VSDX फ़ाइलें सुरक्षित करें" h2=".NET लाइब्रेरी का उपयोग करके VSDX प्रारूप सहित Visio को सुरक्षित रखें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="VSDX फ़ाइल का उपयोग करके C# को कैसे सुरक्षित रखें" %}}

 VSDX फ़ाइल को सुरक्षित रखने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="C# में VSDX फ़ाइलें सुरक्षित रखने के चरण" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX फ़ाइलें सुरक्षित करें - C#" offSpacer="" %}}
