---
title: Python के द्वारा VSTX को XPS में बदलें 
weight: 1960
url: /hi/python-java/conversion/vstx-to-xps/ 
description: XPS फ़ाइल में VSTX प्रारूप के लिए नमूना Python रूपांतरण कोड। किसी भी Python आधारित एप्लिकेशन में VSTX को XPS में बदलने के लिए इस उदाहरण कोड का उपयोग करें।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python के द्वारा VSTX को XPS में बदलें" h2="Python API का उपयोग करके Microsoft Visio VSTX को XPS में निर्यात करें।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Python का उपयोग करके VSTX को XPS में कैसे बदलें" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python के माध्यम से VSTX को XPS में बदलने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 कोड की कुछ ही पंक्तियों में Python डेवलपर आसानी से VSTX फ़ाइल को XPS में बदल सकते हैं।
...
{{% blocks/products/pf/agp/code-block title="VSTX से XPS Python रूपांतरण स्रोत कोड" offSpacer="" %}}
...
VSTX Visio ग्राफ़िक्स सेवा फ़ाइल स्वरूप है जो वेब आरेखण को प्रस्तुत करने के लिए आवश्यक स्ट्रीम और संग्रहण को निर्दिष्ट करता है। वेब आरेखण आरेखण पृष्ठों, आकृतियों, फोंट, छवियों, डेटा कनेक्शनों और diagram अद्यतन जानकारी का एक संग्रह है जिसे वेक्टर या रेखापुंज आरेखण के रूप में प्रस्तुत किया जा सकता है। VSTX फ़ाइलें Microsoft Visio में भी खोली जा सकती हैं लेकिन मुख्य रूप से वेब पर उपयोग के लिए सहेजी जाती हैं। Microsoft Visio Visio फाइलों को पीएनजी, बीएमपी, पीडीएफ और अन्य सहित कई अलग-अलग फाइल फॉर्मेट में बदलने की क्षमता प्रदान करता है।
