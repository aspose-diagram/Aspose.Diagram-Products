---
title: Python के माध्यम से VST फ़ाइल स्वरूप देखें 
weight: 3480
url: /hi/python-java/viewer/vst/ 
description: किसी भी Python आधारित एप्लिकेशन में VST दस्तावेज़ों को लोड करने, प्रस्तुत करने और प्रदर्शित करने के लिए Python स्रोत कोड।
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python के लिए VST फ़ाइल व्यूअर" h2="सर्वर-साइड Python APIs का उपयोग करके मूल VST दस्तावेज़ व्यूअर।" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="C# का उपयोग करके VST फ़ाइल कैसे देखें" %}}

 वीएसटी फाइल देखने के लिए, हम उपयोग करेंगे
...
{{% blocks/products/pf/agp/feature-section-col title="वीएसटी को Python के माध्यम से देखने के चरण" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Diagram कोड की कुछ पंक्तियों के साथ डेवलपर्स के लिए वीएसटी फ़ाइल को देखना आसान बनाता है।

{{% /blocks/products/pf/agp/text %}}

1. VST फ़ाइल को Diagram class . के उदाहरण के साथ लोड करें1. पैरामीटर के रूप में SaveFileFormat.HTML के साथ Diagram.save विधि को कॉल करें1. परिणामी HTML को डिफ़ॉल्ट ब्राउज़र में Process.Start . के माध्यम से लोड करें
...
{{% blocks/products/pf/agp/code-block title="वीएसटी देखने के लिए Python कोड" offSpacer="" %}}

```cs

// VST फ़ाइल को Diagram के उदाहरण के माध्यम से लोड करें
diagram =  Aspose.Diagram.Diagram("template.vst");
// वीएसटी को एचटीएमएल प्रारूप में कनवर्ट करें और फिर परिणामी एचटीएमएल को डिफ़ॉल्ट ब्राउज़र में लोड करें
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram एक Microsoft Visio दस्तावेज़ प्रारूप हेरफेर API है। कोई भी आसानी से लोड कर सकता है, बना सकता है, संशोधित कर सकता है, डायग्राम तत्वों सहित हेरफेर कर सकता है और Visio आरेखों को पीडीएफ, एक्सपीएस, जेपीईजी, पीएनजी, बीएमपी, टीआईएफएफ, एसवीजी, ईएमएफ और अधिक जैसे अन्य प्रारूपों में परिवर्तित कर सकता है। यह एक स्टैंडअलोन API है और इसे स्थापित करने के लिए Microsoft Visio या किसी अन्य सॉफ़्टवेयर की आवश्यकता नहीं है।  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="वीएसटी देखने के लिए मुफ्त ऐप" sectionDescription="हमारे लाइव डेमो की जांच करें [वीएसटी देखें](https://products.aspose.app/diagram/viewer/vst) निम्नलिखित लाभों के साथ।" >}}
