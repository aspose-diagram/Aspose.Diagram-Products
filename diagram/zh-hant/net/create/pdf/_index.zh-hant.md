...
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 創建 PDF 文檔" h2="使用服務器端 .NET API 以編程方式創建本機和高性能 PDF（便攜式文檔格式）。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
1. 在類文件中包含命名空間1. 創建 Diagram 類實例。1. 訪問 diagram 的第一頁。1. 在頁面中添加文本。1. 使用 Save 方法將 diagram 保存為 PDF 文件。
