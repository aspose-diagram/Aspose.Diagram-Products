...
{{% blocks/products/pf/agp/content h2="如何使用 C# 提取 VSD 元數據" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中提取 VSD 元數據的步驟" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram 是 Microsoft Visio 文檔格式操作 API。您可以輕鬆加載、創建、修改、操作包括圖形元素在內的 Visio 圖表轉換為其他格式，例如 PDF、XPS、JPEG、PNG、BMP、TIFF、SVG、EMF 等。它是一個獨立的 API，不需要安裝 Microsoft Visio 或任何其他軟件。  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="通過在線應用程序提取 VSD 的元數據" sectionDescription="訪問我們的 VSD 文檔查看和編輯元數據 [現場演示網站](https://products.aspose.app/diagram/metadata).現場演示有以下好處" >}}
