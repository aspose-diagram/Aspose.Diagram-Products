---
title: 通過 .NET 為 VSDX 文檔添加水印 
weight: 3050
url: /zh-hant/net/watermark/vsdx/ 
description: C# 將水印添加到 .NET 框架、.NET 核心、Mono 平台上的 vsdx 文件的源代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="將文本水印添加到 C# 中的 VSDX" h2="使用服務器端 Aspose.Diagram for .NET API 的本機和高性能 VSDX 文檔水印，無需使用 Microsoft 或 Open Office、Adobe PDF 等任何軟件。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 為 VSDX 文件添加水印" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="為 C# 中的 VSDX 文件添加水印的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="水印 VSDX 文件 - C#" offSpacer="" %}}
