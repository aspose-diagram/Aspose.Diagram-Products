---
title: 通過 .NET 解鎖 VDW 文檔 
weight: 5680
url: /zh-hant/net/unlock/vdw/ 
description: C# 用於在 .NET Framework、.NET 核心、Mono 平台上解鎖 VDW 文件的源代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 解鎖 VDW 文件" h2="使用 .NET 庫移除對 Visio 的保護，包括 VDW 格式。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 解鎖 VDW 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# 中解鎖 VDW 文件的步驟" %}}
