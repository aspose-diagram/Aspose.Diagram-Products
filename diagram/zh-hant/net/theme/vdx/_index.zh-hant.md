---
title: 通過 .NET 將預設主題應用到 VDX 文檔 
weight: 3050
url: /zh-hant/net/theme/vdx/ 
description: C# 源代碼將預設主題應用到 .NET Framework、.NET 核心、Mono 平台上的 vdx 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="將預設主題應用到 C# 中的 VDX" h2="本機和高性能使用服務器端 Aspose.Diagram for .NET API 將預設主題應用到 VDX 文檔，而無需使用任何軟件，例如 Microsoft 或 Open Office、Adobe PDF。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 將預設主題應用到 VDX 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="將預設主題應用到 C# 中的 VDX 個文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="將預設主題應用到 Vdx 個文件 - C#" offSpacer="" %}}
