...
1. 使用 Diagram 類的實例加載 VSTX 文件1. 使用輸出文件路徑和 SaveFileFormat.VSTX 作為參數調用 Diagram.Save 方法1. VSTX 文件將保存在指定路徑
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 VSTX 到 VSTX C# 轉換" offSpacer="" %}}
