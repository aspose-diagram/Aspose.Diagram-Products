...
description: VSTX 到 VSDX C# 轉換的示例代碼。在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中使用 API 批量 VSTX 文件到 VSDX 轉換的示例代碼。
---
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 VSTX 到 VSDX C# 的轉換" offSpacer="" %}}
