...
description: VDW 到 VSTM C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 VDW 文件批量轉換為 VSTM。
---
...
1. 使用 Diagram 類的實例加載 VDW 文件1. 以輸出文件路徑和 SaveFileFormat.VSTM 作為參數調用 Diagram.Save 方法1. VSTM 文件將保存在指定路徑
