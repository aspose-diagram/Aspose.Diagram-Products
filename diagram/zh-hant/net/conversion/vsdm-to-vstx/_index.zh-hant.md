...
{{% blocks/products/pf/agp/content h2="如何使用 C# 將 VSDM 轉換為 VSTX" %}}

 為了將 VSDM 轉換為 VSTX，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 將 VSDM 轉換為 VSTX 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 開發人員只需幾行代碼即可輕鬆加載 VSDM 文件並將其轉換為 VSTX。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Diagram 類的實例加載 VSDM 文件1. 使用輸出文件路徑和 SaveFileFormat.VSTX 作為參數調用 Diagram.Save 方法1. VSTX 文件將保存在指定路徑
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 VSDM 到 VSTX C# 轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="將 VSDM 轉換為 VSTX 的免費應用程序" sectionDescription="查看我們的現場演示 [VSDM 到 VSTX 的轉換](https://products.aspose.app/diagram/conversion/vsdm-to-vstx) 具有以下好處。" >}}
