...
description: VSTM 到 VSDX C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中批量 VSTM 文件到 VSDX 轉換。
---
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 VSTM 到 VSDX C# 的轉換" offSpacer="" %}}
