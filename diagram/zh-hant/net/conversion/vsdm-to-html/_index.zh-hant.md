---
title: 通過 C# 將 VSDM 轉換為 HTML 
weight: 920
url: /zh-hant/net/conversion/vsdm-to-html/ 
description: VSDM 到 HTML C# 轉換的示例代碼。使用 API 示例代碼在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中將 VSDM 文件批量轉換為 HTML。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 C# 將 VSDM 轉換為 HTML" h2="將 Microsoft® Visio VSDM 文件導出到 .NET Framework、.NET Core、Mono 或 COM Interop 上的 HTML。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 將 VSDM 轉換為 HTML" %}}

 為了將 VSDM 轉換為 HTML，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 C# 將 VSDM 轉換為 HTML 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 開發人員只需幾行代碼即可輕鬆加載 VSDM 文件並將其轉換為 HTML。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Diagram 類的實例加載 VSDM 文件1. 使用輸出文件路徑和 SaveFileFormat.HTML 作為參數調用 Diagram.Save 方法1. HTML文件將保存在指定路徑
...
{{% blocks/products/pf/agp/code-block title="此示例代碼顯示 VSDM 到 HTML C# 的轉換" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="將 VSDM 轉換為 HTML 的免費應用程序" sectionDescription="查看我們的現場演示 [VSDM 到 HTML 的轉換](https://products.aspose.app/diagram/conversion/vsdm-to-html) 具有以下好處。" >}}
