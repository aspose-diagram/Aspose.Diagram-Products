...
description: VDW 到 VSSM C# 轉換的示例代碼。在 VB.NET、Asp.NET 或任何基於 .NET 的應用程序中使用 API 示例代碼批量 VDW 文件到 VSSM 轉換。
---
...
1. 使用 Diagram 類的實例加載 VDW 文件1. 使用輸出文件路徑和 SaveFileFormat.VSSM 作為參數調用 Diagram.Save 方法1. VSSM 文件將保存在指定路徑
