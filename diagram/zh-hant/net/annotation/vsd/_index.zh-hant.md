---
title: 通過 C# 從 VSD 添加、編輯和刪除註釋 
weight: 3050
url: /zh-hant/net/annotation/vsd/ 
description: C# 用於註釋 .NET Framework、.NET 核心、Mono 平台上的 VSD 文件的源代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="如何使用 C# 註釋 VSD 文件" h2="使用服務器端 Aspose.Diagram for .NET API 的本機和高性能 VSD 文檔註釋，無需使用任何軟件，如 Microsoft 或 Open Office、Adobe PDF。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 註釋 VSD 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="註釋 C# 中的 VSD 文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="從 VSD 個文件中刪除評論 - C#" offSpacer="" %}}
