---
title: 通過 .NET 合併 VTX 個文件 
weight: 4330
url: /zh-hant/net/merger/vtx/ 
description: C# 源代碼，用於組合 .NET Framework、.NET Core、Mono 或 COM Interop 上的 VTX 文檔。
---
...
{{% blocks/products/pf/agp/feature-section-col title="合併 C# 中的 VTX 文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="合併 VTX 個文件 - C#" offSpacer="" %}}
