---
title: 通過 .NET 合併 VSTX 個文件 
weight: 1450
url: /zh-hant/net/merger/vstx/ 
description: C# 源代碼，用於組合 .NET Framework、.NET Core、Mono 或 COM Interop 上的 VSTX 文檔。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合併 C# 中的 VSTX 格式" h2="使用服務器端 Aspose.Diagram for .NET API 的本機和高性能 VSTX 文檔合併，無需使用任何軟件，如 Microsoft 或 Open Office、Adobe PDF。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="合併 C# 中的 VSTX 文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="合併 VSTX 個文件 - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram 是 Microsoft Visio 文檔格式操作 API。您可以輕鬆加載、創建、修改、操作包括圖形元素在內的 Visio 圖表轉換為其他格式，例如 PDF、XPS、JPEG、PNG、BMP、TIFF、SVG、EMF 等。它是一個獨立的 API，不需要安裝 Microsoft Visio 或任何其他軟件。  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="在線VSTX合併現場演示" sectionDescription="立即通過訪問我們的合併 VSTX 個文檔 [現場演示網站](https://products.aspose.app/diagram/merger).現場演示有以下好處" >}}
