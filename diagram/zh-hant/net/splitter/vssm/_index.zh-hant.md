---
title: 通過 .NET 拆分 VSSM 個文件 
weight: 1300
url: /zh-hant/net/splitter/vssm/ 
description: C# 源代碼在 .NET Framework、.NET 核心、Mono 平台上拆分 vssm 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="將 VSSM 拆分為 C#" h2="使用服務器端 Aspose.Diagram for .NET API 的本機和高性能 VSSM 文檔拆分器，無需使用任何軟件，如 Microsoft 或 Open Office、Adobe PDF。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="拆分 C# 中的 VSSM 文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="拆分 VSSM 個文件 - C#" offSpacer="" %}}
