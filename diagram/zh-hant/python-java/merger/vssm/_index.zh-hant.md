---
title: 通過 Python 合併 VSSM 個文件 
weight: 230
url: /zh-hant/python-java/merger/vssm/ 
description: Python 示例代碼，用於在任何基於 Python 的應用程序中組合 VSSM 文檔。 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合併 Python 中的 VSSM 格式" h2="使用服務器端 Python API 的本機 VSSM 文檔合併。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python 合併 VSSM 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="合併 Python 中的 VSSM 文件的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="合併 VSSM 個文件 - Python" offSpacer="" %}}
