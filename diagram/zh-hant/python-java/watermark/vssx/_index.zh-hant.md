---
title: 通過 Python 為 VSSX 文檔添加水印 
weight: 3050
url: /zh-hant/python-java/watermark/vssx/ 
description: Python 示例代碼，用於在任何基於 Python 的應用程序中向 VSSX 文檔添加水印。 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python 中的水印 VSSX 格式" h2="使用服務器端 Python API 的原生 VSSX 文檔水印。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python 為 VSSX 文件添加水印" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="為 Python 中的 VSSX 文件添加水印的步驟" %}}
...
{{% blocks/products/pf/agp/code-block title="水印 VSSX 文件 - Python" offSpacer="" %}}
