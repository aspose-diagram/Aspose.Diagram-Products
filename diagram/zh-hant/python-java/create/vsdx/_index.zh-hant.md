---
title: 通過 Python 創建 VSDX 個文件 
url: /zh-hant/python-java/create-vsdx/ 
description: Python 用於生成 VSDX 文檔的示例代碼。使用此代碼在任何基於 Python 的應用程序中創建 VSDX 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Python 創建 VSDX 文檔" h2="使用 Python 庫以編程方式創建本機和高性能 VSDX（便攜式文檔格式）。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="VSDX" fileiconsmall2="JPG" fileiconsmall3="HTML" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通過 Python 創建 VSDX" %}}
...
<!-- aboutfile Starts -->
 ...
 Visio 編程庫，能夠構建能夠生成、修改、轉換、呈現和打印VSDX文件的跨平台應用程序。 .NET Visio API 不僅可以在電子表格格式之間進行轉換，還可以將 Visio 文件呈現為圖像、VSDX、VSDX 等，從而使其成為以行業標準交換文檔的完美選擇格式。
