---
title: 通過 Java 創建 VSSX 個文件 
url: /zh-hant/java/create-vssx/ 
description: Java 用於生成 VSSX 文檔的示例代碼。使用此代碼在基於 Java 的桌面或 Web 應用程序中創建 VSSX 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 創建 VSSX 文檔" h2="使用 Java 庫以編程方式創建本機和高性能 VSSX（便攜式文檔格式）。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="VSSX" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通過 Java 創建 VSSX" %}}
