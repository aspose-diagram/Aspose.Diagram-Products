---
title: 通過 Java 創建 VSDX 個文件 
url: /zh-hant/java/create-vsdx/ 
description: Java 用於生成 VSDX 文檔的示例代碼。使用此代碼在基於 Java 的桌面或 Web 應用程序中創建 VSDX 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 創建 VSDX 文檔" h2="使用 Java 庫以編程方式創建本機和高性能 VSDX（便攜式文檔格式）。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="VSDX" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="" %}}
 ...
 在運行的應用程序中動態生成 VSDX 文件很容易。為了在不需要 MS Office 的情況下從頭開始創建 VSDX 文檔，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="如何通過 Java 創建 VSDX" %}}

{{% blocks/products/pf/agp/text %}}

 開發人員只需幾行代碼即可在運行不同的報告應用程序中輕鬆創建、加載、修改和轉換 VSDX（便攜式文檔格式）以進行數據處理。

{{% /blocks/products/pf/agp/text %}}

1. 在類文件中包含命名空間1. 創建 Diagram 類實例。1. 訪問 diagram 的第一頁。1. 在頁面中添加文本。1. 使用 save 方法將 diagram 保存為 VSDX 文件。
...
{{% blocks/products/pf/agp/code-block title="以下源代碼顯示瞭如何使用 C# 創建 VSDX 文件。" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Visio 編程庫，能夠構建能夠生成、修改、轉換、呈現和打印VSDX文件的跨平台應用程序。 .NET Visio API 不僅可以在電子表格格式之間進行轉換，還可以將 Visio 文件呈現為圖像、VSDX、HTML 等，從而使其成為以行業標準格式交換文檔的完美選擇。
