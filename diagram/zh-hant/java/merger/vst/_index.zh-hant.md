---
title: 通過 Java 合併 VST 文件 
weight: 1440
url: /zh-hant/java/merger/vst/ 
description: Java 用於在 Java JSP/JSF 應用程序和桌面應用程序的運行時環境中組合 VST 文檔的示例代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合併 Java 中的 VST 格式" h2="使用服務器端 Java API 的本機 VST 文檔合併。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 合併 VST 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 Java 中合併 VST 文件的步驟" %}}
...
+ 使用 Diagram 類的實例加載第一個 VST 文件。
+ 使用 Diagram 類的實例加載第二個 VST 文檔。
+ 使用 combine() 方法合併文件。
+ 將合併後的 VST 文件保存在指定路徑
...
{{% blocks/products/pf/agp/code-block title="合併 VST 文件 - Java" offSpacer="" %}}
