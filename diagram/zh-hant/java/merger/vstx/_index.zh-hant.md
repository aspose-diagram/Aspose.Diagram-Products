...
{{% blocks/products/pf/agp/content h2="如何使用 Java 合併 VSTX 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 Java 中合併 VSTX 文件的步驟" %}}
...
+ 使用 Diagram 類的實例加載第一個 VSTX 文件。
+ 使用 Diagram 類的實例加載第二個 VSTX 文檔。
+ 使用 combine() 方法合併文件。
+ 將合併後的 VSTX 文件保存在指定路徑
...
{{% blocks/products/pf/agp/code-block title="合併 VSTX 文件 - Java" offSpacer="" %}}
