---
title: 通過 Java 從 VSDX 添加、編輯和刪除註釋 
weight: 3250
url: /zh-hant/java/annotation/vsdx/ 
description: Java 用於註釋 Java JSP/JSF 應用程序和桌面應用程序的運行時環境中的 VSDX 文件的源代碼。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Java 中註釋 VSDX 格式" h2="使用服務器端 Java API 的原生 VSDX 文檔註釋。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 註釋 VSDX 文件" %}}
...
{{% blocks/products/pf/agp/code-block title="註釋 VSDX 個文件 - Java" offSpacer="" %}}
