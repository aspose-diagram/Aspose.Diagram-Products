...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 VTX 轉換為 PDF" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 VTX 轉換為 PDF 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 VTX 文件轉換為 PDF。
...
{{% blocks/products/pf/agp/code-block title="VTX 到 PDF Java 轉換源代碼" offSpacer="" %}}
