...
1. 使用 Diagram 類的實例加載 VSX 文件1. 以輸出文件路徑和 SaveFileFormat 作為參數調用 Diagram.save 方法1. VDX文件將保存在指定路徑
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSX 到 VDX 轉換現場演示" sectionDescription="[將 VSX 轉換為 VDX](https://products.aspose.app/diagram/conversion/vsx-to-vdx) 立即訪問我們的現場演示網站。現場演示具有以下好處" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上傳您的 VSX 文件，它將立即轉換為 VDX。" >}}
