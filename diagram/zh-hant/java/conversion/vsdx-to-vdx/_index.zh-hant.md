...
{{% blocks/products/pf/agp/content h2="如何使用 Java 將 VSDX 轉換為 VDX" %}}

 為了將 VSDX 渲染到 VDX，我們將使用
...
{{% blocks/products/pf/agp/feature-section-col title="通過 Java 將 VSDX 轉換為 VDX 的步驟" %}}

{{% blocks/products/pf/agp/text %}}

 Java 開發人員只需幾行代碼即可輕鬆地將 VSDX 文件轉換為 VDX。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Diagram 類的實例加載 VSDX 文件1. 以輸出文件路徑和 SaveFileFormat 作為參數調用 Diagram.save 方法1. VDX文件將保存在指定路徑
...
{{% blocks/products/pf/agp/code-block title="VSDX 到 VDX Java 轉換源代碼" offSpacer="" %}}
