...
{{< blocks/products/pf/i18n/upper-banner h1="通過 Java 將 VSDM 轉換為 XPS" h2="使用原生 Java 庫將 Microsoft Visio VSDM 導出到 XPS。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDM 到 XPS 轉換現場演示" sectionDescription="[將 VSDM 轉換為 XPS](https://products.aspose.app/diagram/conversion/vsdm-to-xps) 立即訪問我們的現場演示網站。現場演示具有以下好處" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上傳您的 VSDM 文件，它就會立即轉換為 XPS。" >}}
