---
title: Konversikan VSSX ke VSSM melalui Java 
weight: 1000
url: /id/java/conversion/vssx-to-vssm/ 
description: Contoh Java kode konversi untuk format VSSX ke file VSSM. Gunakan kode contoh ini untuk mengonversi VSSX ke VSSM dalam aplikasi berbasis Web atau Desktop Java apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSSX ke VSSM melalui Java" h2="Ekspor Microsoft Visio VSSX ke VSSM menggunakan pustaka Java asli." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSSX ke VSSM Menggunakan Java" %}}
 ...
 Untuk merender VSSX ke VSSM, kami akan menggunakan
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java pengembang dapat dengan mudah mengonversi file VSSX ke VSSM hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSSX dengan instance Diagram class1. Panggil metode Diagram.save dengan jalur file keluaran dan SaveFileFormat sebagai parameter1. File VSSM akan disimpan di jalur yang ditentukan
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo Langsung Konversi VSSX ke VSSM" sectionDescription="[Mengonversi VSSX ke VSSM](https://products.aspose.app/diagram/conversion/vssx-to-vssm) sekarang dengan mengunjungi situs web Demo Langsung kami. Demo langsung memiliki manfaat sebagai berikut" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Tidak perlu mengunduh Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Tidak perlu menulis kode apa pun." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Cukup unggah file VSSX Anda, itu akan langsung dikonversi ke VSSM." >}}
