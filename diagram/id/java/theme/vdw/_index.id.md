...
{{% blocks/products/pf/agp/content h2="Cara Menerapkan Tema Preset ke File VDW Menggunakan Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menerapkan Tema Preset ke File VDW di Java" %}}
...
+ Tetapkan nilai Preset ke instance Halaman melalui panggilan setPresetTheme met
