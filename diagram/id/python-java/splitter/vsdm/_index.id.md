---
title: Pisahkan VSDM Berkas melalui Python
weight: 1400
url: /id/python-java/splitter/vsdm/ 
description: Python kode sumber untuk Membagi berkas vsdm dalam aplikasi berbasis Python mana pun. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Pisahkan format VSDM dalam Python" h2="Buat Python aplikasi Anda sendiri untuk membagi VSDM file " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memisahkan VSDM Berkas Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk memisahkan VSDM Berkas menjadi Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Pisahkan VSDM Berkas - Python" offSpacer="" %}}
