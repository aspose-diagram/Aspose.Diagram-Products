---
title: Kompres dokumen VSS melalui Python 
weight: 3350
url: /id/python-java/compress/vss/ 
description: Python kode sumber untuk mengompresi berkas vss dalam aplikasi berbasis Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Kompres Format VSS di Python" h2="Kompres dokumen VSS asli menggunakan Python API sisi server." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengompresi File VSS Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah mengompresi File VSS di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Kompres File VSS - Python" offSpacer="" %}}
