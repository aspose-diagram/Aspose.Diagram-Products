...
{{% blocks/products/pf/agp/content h2="Cara Mengekstrak VSX Metadata Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengekstrak VSX Metadata di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengekstrak VSX Metadata - Python" offSpacer="" %}}
