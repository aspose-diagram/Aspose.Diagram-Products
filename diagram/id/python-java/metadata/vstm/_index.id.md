...
{{% blocks/products/pf/agp/content h2="Cara Mengekstrak VSTM Metadata Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengekstrak VSTM Metadata di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengekstrak VSTM Metadata - Python" offSpacer="" %}}
