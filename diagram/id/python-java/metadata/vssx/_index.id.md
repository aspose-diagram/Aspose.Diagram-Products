...
{{% blocks/products/pf/agp/content h2="Cara Mengekstrak VSSX Metadata Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengekstrak VSSX Metadata di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengekstrak VSSX Metadata - Python" offSpacer="" %}}
