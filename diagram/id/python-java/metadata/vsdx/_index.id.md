...
{{% blocks/products/pf/agp/content h2="Cara Mengekstrak VSDX Metadata Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengekstrak VSDX Metadata di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengekstrak VSDX Metadata - Python" offSpacer="" %}}
