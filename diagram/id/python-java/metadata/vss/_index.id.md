...
{{% blocks/products/pf/agp/content h2="Cara Mengekstrak Metadata VSS Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengekstrak Metadata VSS di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengekstrak Metadata VSS - Python" offSpacer="" %}}
