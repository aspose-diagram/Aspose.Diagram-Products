...
{{% blocks/products/pf/agp/content h2="Cara Mengekstrak VSSM Metadata Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengekstrak VSSM Metadata di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengekstrak VSSM Metadata - Python" offSpacer="" %}}
