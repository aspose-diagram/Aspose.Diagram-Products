...
{{% blocks/products/pf/agp/content h2="Cara Mengekstrak Metadata VDW Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengekstrak Metadata VDW di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengekstrak Metadata VDW - Python" offSpacer="" %}}
