...
{{% blocks/products/pf/agp/content h2="Cara Mengekstrak VSDM Metadata Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengekstrak VSDM Metadata di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengekstrak VSDM Metadata - Python" offSpacer="" %}}
