...
{{% blocks/products/pf/agp/content h2="Cara Mengekstrak VSTX Metadata Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengekstrak VSTX Metadata di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengekstrak VSTX Metadata - Python" offSpacer="" %}}
