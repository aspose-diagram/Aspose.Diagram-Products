...
{{% blocks/products/pf/agp/content h2="Cara Mengekstrak VSD Metadata Menggunakan Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengekstrak VSD Metadata di Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Mengekstrak VSD Metadata - Python" offSpacer="" %}}
