...
{{% blocks/products/pf/agp/content h2="Cara Memberi Anotasi pada VSDM Berkas Menggunakan Python" %}}

 Untuk membubuhi keterangan VSDM file, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk anotasi VSDM Berkas di Java" %}}
...
+ Muat file VSDM dengan membuat turunan dari Diagram
...
{{% blocks/products/pf/agp/code-block title="Anotasi VSDM Berkas - Python" offSpacer="" %}}
