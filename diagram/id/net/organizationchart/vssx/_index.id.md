---
title: Buat bagan organisasi di VSSX dokumen melalui .NET 
weight: 3050
url: /id/net/organizationchart/vssx/ 
description: C# kode sumber untuk membuat bagan organisasi dalam file vssx pada Platform .NET Framework, .NET Inti, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Cara Membuat Bagan Organisasi di VSSX Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Membuat Bagan Organisasi di VSSX Berkas di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Buat Bagan Organisasi di VSSX Berkas - C#" offSpacer="" %}}
