...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan File VSTX Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menggabungkan File VSTX di C#" %}}
...
+ Muat semua file VSTX dengan path lengkap.
...
+ Panggil metode Save() dan berikan nama file (path lengkap) dan format (VSTX) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan file VSTX di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan File VSTX - C#" offSpacer="" %}}
