...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan File VST Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menggabungkan File VST di C#" %}}
...
+ Muat semua file VST dengan path lengkap.
...
+ Panggil metode Save() dan berikan nama file (path lengkap) dan format (VST) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan berkas VST di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan File VST - C#" offSpacer="" %}}
