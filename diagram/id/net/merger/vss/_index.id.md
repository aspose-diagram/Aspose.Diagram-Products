...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan File VSS Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-Langkah Menggabungkan File VSS di C#" %}}
...
+ Muat semua file VSS dengan path lengkap.
...
+ Panggil metode Save() dan berikan nama file (path lengkap) dan format (VSS) sebagai parameter.
Sekarang Anda dapat membuka dan menggunakan berkas VSS di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan File VSS - C#" offSpacer="" %}}
