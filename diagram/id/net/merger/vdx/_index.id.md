...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan VDX Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-Langkah Menggabungkan VDX Berkas di C#" %}}
...
+ Muat semua VDX file dengan path lengkap.
...
+ Panggil metode Save() dan teruskan nama file (path lengkap) dan format (VDX) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan berkas VDX di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan VDX Berkas - C#" offSpacer="" %}}
