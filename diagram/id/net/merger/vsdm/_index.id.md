...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan File VSDM Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menggabungkan File VSDM di C#" %}}
...
+ Muat semua file VSDM dengan path lengkap.
...
+ Panggil metode Save() dan berikan nama file (path lengkap) dan format (VSDM) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan file VSDM di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan File VSDM - C#" offSpacer="" %}}
