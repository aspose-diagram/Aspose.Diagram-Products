...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan VSTM Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-Langkah Menggabungkan VSTM Berkas di C#" %}}
...
+ Muat semua VSTM file dengan path lengkap.
...
+ Panggil metode Save() dan teruskan nama file (path lengkap) dan format (VSTM) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan berkas VSTM di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan VSTM Berkas - C#" offSpacer="" %}}
