...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan VTX Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-Langkah Menggabungkan VTX Berkas di C#" %}}
...
+ Muat semua VTX file dengan path lengkap.
...
+ Panggil metode Save() dan teruskan nama file (path lengkap) dan format (VTX) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan berkas VTX di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan VTX Berkas - C#" offSpacer="" %}}
