...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan VSD Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-Langkah Menggabungkan VSD Berkas di C#" %}}
...
+ Muat semua VSD file dengan path lengkap.
...
+ Panggil metode Save() dan teruskan nama file (path lengkap) dan format (VSD) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan berkas VSD di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan VSD Berkas - C#" offSpacer="" %}}
