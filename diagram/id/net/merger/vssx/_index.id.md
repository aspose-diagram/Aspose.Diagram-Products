...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan VSSX Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-Langkah Menggabungkan VSSX Berkas di C#" %}}
...
+ Muat semua VSSX file dengan path lengkap.
...
+ Panggil metode Save() dan teruskan nama file (path lengkap) dan format (VSSX) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan berkas VSSX di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan VSSX Berkas - C#" offSpacer="" %}}
