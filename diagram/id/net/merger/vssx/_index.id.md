...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan File VSSX Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Menggabungkan File VSSX di C#" %}}
...
+ Muat semua file VSSX dengan path lengkap.
...
+ Panggil metode Save() dan berikan nama file (path lengkap) dan format (VSSX) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan file VSSX di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan File VSSX - C#" offSpacer="" %}}
