...
{{% blocks/products/pf/agp/content h2="Cara Menggabungkan VSX Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-Langkah Menggabungkan VSX Berkas di C#" %}}
...
+ Muat semua VSX file dengan path lengkap.
...
+ Panggil metode Save() dan teruskan nama file (path lengkap) dan format (VSX) sebagai parameter.
+ Sekarang Anda dapat membuka dan menggunakan berkas VSX di Microsoft Office, Adobe PDF, atau program lain yang kompatibel.
...
{{% blocks/products/pf/agp/code-block title="Gabungkan VSX Berkas - C#" offSpacer="" %}}
