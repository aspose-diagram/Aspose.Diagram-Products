---
title: Lindungi dan kunci VSSM dokumen melalui .NET 
weight: 5580
url: /id/net/protect/vssm/ 
description: C# kode sumber untuk mengunci file VSSM di .NET Framework, .NET Core, Mono Platform.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lindungi VSSM Berkas melalui C#" h2="Lindungi Visio termasuk format VSSM menggunakan .NET Pustaka." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Melindungi VSSM Berkas Menggunakan C#" %}}

 Untuk melindungi file VSSM, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Melindungi VSSM Berkas di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Lindungi VSSM Berkas - C#" offSpacer="" %}}
