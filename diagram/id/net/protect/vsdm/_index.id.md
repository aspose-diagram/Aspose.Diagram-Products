---
title: Lindungi dan kunci VSDM dokumen melalui .NET 
weight: 5580
url: /id/net/protect/vsdm/ 
description: C# kode sumber untuk mengunci file VSDM di .NET Framework, .NET Core, Mono Platform.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lindungi VSDM Berkas melalui C#" h2="Lindungi Visio termasuk format VSDM menggunakan .NET Pustaka." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Melindungi VSDM Berkas Menggunakan C#" %}}

 Untuk melindungi file VSDM, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Melindungi VSDM Berkas di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Lindungi VSDM Berkas - C#" offSpacer="" %}}
