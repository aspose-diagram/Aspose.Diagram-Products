---
title: Gambarkan geometri ke VTX dokumen melalui .NET 
weight: 3050
url: /id/net/drawing/vtx/ 
description: C# kode sumber untuk menggambar geomtry ke vtx file di .NET Framework, .NET Core, Mono Platform.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Gambar Geometri ke VTX di C#" h2="Gambar geometri asli dan berkinerja tinggi untuk VTX mendokumentasikan menggunakan Aspose.Diagram for .NET API sisi server, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Bagaimana Menggambar Geomtry ke VTX File Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Menggambar Geomtry ke VTX File di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Gambar Geometri ke VTX Berkas - C#" offSpacer="" %}}
