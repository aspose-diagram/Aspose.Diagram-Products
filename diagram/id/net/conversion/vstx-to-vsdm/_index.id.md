---
title: Ubah VSTX menjadi VSDM melalui C# 
weight: 4110
url: /id/net/conversion/vstx-to-vsdm/ 
description: Kode contoh untuk konversi VSTX ke VSDM C#. Gunakan API kode contoh untuk file VSTX batch ke konversi VSDM dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah VSTX menjadi VSDM melalui C#" h2="Ekspor file Microsoft® Visio VSTX ke VSDM pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSTX ke VSDM Menggunakan C#" %}}
 ...
 Untuk mengonversi VSTX menjadi VSDM, kami akan menggunakan
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET pengembang dapat dengan mudah memuat & mengonversi file VSTX menjadi VSDM hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSTX dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file keluaran dan SaveFileFormat.VSDM sebagai parameter1. VSDM file akan disimpan di jalur yang ditentukan
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSTX ke VSDM" sectionDescription="Periksa demo langsung kami untuk [VSTX menjadi VSDM konversi](https://products.aspose.app/diagram/conversion/vstx-to-vsdm) dengan manfaat sebagai berikut." >}}
