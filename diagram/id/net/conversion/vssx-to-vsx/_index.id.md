---
title: Ubah VSSX menjadi VSX melalui C# 
weight: 3340
url: /id/net/conversion/vssx-to-vsx/ 
description: Kode contoh untuk konversi VSSX ke VSX C#. Gunakan API kode contoh untuk file VSSX batch ke konversi VSX dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah VSSX menjadi VSX melalui C#" h2="Ekspor file Microsoft® Visio VSSX ke VSX pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSSX ke VSX Menggunakan C#" %}}
 ...
 Untuk mengonversi VSSX menjadi VSX, kami akan menggunakan
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET pengembang dapat dengan mudah memuat & mengonversi file VSSX menjadi VSX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSSX dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file keluaran dan SaveFileFormat.VSX sebagai parameter1. VSX file akan disimpan di jalur yang ditentukan
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSSX ke VSX" sectionDescription="Periksa demo langsung kami untuk [VSSX menjadi VSX konversi](https://products.aspose.app/diagram/conversion/vssx-to-vsx) dengan manfaat sebagai berikut." >}}
