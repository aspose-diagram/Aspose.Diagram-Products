---
title: Konversikan VSTX ke XAML melalui C# 
weight: 2280
url: /id/net/conversion/vstx-to-xaml/ 
description: Contoh kode untuk konversi VSTX ke XAML C#. Gunakan API kode contoh untuk file batch VSTX ke konversi XAML dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSTX ke XAML melalui C#" h2="Ekspor file Microsoft® Visio VSTX ke XAML pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSTX ke XAML Menggunakan C#" %}}

 Untuk mengonversi VSTX ke XAML, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi VSTX ke XAML melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file VSTX ke XAML hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSTX dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.XAML sebagai parameter1. File XAML akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSTX ke XAML C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSTX ke XAML" sectionDescription="Periksa demo langsung kami untuk [Konversi VSTX ke XAML](https://products.aspose.app/diagram/conversion/vstx-to-xaml) dengan manfaat sebagai berikut." >}}
