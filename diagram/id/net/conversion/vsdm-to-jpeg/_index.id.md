---
title: Konversikan VSDM ke JPEG melalui C# 
weight: 1920
url: /id/net/conversion/vsdm-to-jpeg/ 
description: Contoh kode untuk konversi VSDM ke JPEG C#. Gunakan API kode contoh untuk kumpulan VSDM file ke konversi JPEG dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSDM ke JPEG melalui C#" h2="Ekspor file Microsoft® Visio VSDM ke JPEG pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDM ke JPEG Menggunakan C#" %}}

 Untuk mengonversi VSDM ke JPEG, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi VSDM ke JPEG melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi VSDM file ke JPEG hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDM dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.JPEG sebagai parameter1. File JPEG akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSDM ke JPEG C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDM ke JPEG" sectionDescription="Periksa demo langsung kami untuk [VSDM ke konversi JPEG](https://products.aspose.app/diagram/conversion/vsdm-to-jpeg) dengan manfaat sebagai berikut." >}}
