---
title: Ubah VSDM menjadi VSTX melalui C# 
weight: 2750
url: /id/net/conversion/vsdm-to-vstx/ 
description: Kode contoh untuk konversi VSDM ke VSTX C#. Gunakan API kode contoh untuk file VSDM batch ke konversi VSTX dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah VSDM menjadi VSTX melalui C#" h2="Ekspor file Microsoft® Visio VSDM ke VSTX pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDM ke VSTX Menggunakan C#" %}}
 ...
 Untuk mengonversi VSDM menjadi VSTX, kami akan menggunakan
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET pengembang dapat dengan mudah memuat & mengonversi file VSDM menjadi VSTX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDM dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file keluaran dan SaveFileFormat.VSTX sebagai parameter1. VSTX file akan disimpan di jalur yang ditentukan
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDM ke VSTX" sectionDescription="Periksa demo langsung kami untuk [VSDM menjadi VSTX konversi](https://products.aspose.app/diagram/conversion/vsdm-to-vstx) dengan manfaat sebagai berikut." >}}
