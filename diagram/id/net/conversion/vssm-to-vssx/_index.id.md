---
title: Ubah VSSM menjadi VSSX melalui C# 
weight: 1390
url: /id/net/conversion/vssm-to-vssx/ 
description: Kode contoh untuk konversi VSSM ke VSSX C#. Gunakan API kode contoh untuk file VSSM batch ke konversi VSSX dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah VSSM menjadi VSSX melalui C#" h2="Ekspor file Microsoft® Visio VSSM ke VSSX pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSSM ke VSSX Menggunakan C#" %}}

 Untuk mengonversi VSSM menjadi VSSX, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi VSSM ke VSSX melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file VSSM menjadi VSSX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSSM dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file keluaran dan SaveFileFormat.VSSX sebagai parameter1. VSSX file akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSSM ke VSSX C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSSM ke VSSX" sectionDescription="Periksa demo langsung kami untuk [VSSM menjadi VSSX konversi](https://products.aspose.app/diagram/conversion/vssm-to-vssx) dengan manfaat sebagai berikut." >}}
