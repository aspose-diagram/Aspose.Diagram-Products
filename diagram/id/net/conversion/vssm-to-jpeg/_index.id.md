---
title: Konversikan VSSM ke JPEG melalui C# 
weight: 2220
url: /id/net/conversion/vssm-to-jpeg/ 
description: Contoh kode untuk konversi VSSM ke JPEG C#. Gunakan API kode contoh untuk kumpulan VSSM file ke konversi JPEG dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSSM ke JPEG melalui C#" h2="Ekspor file Microsoft® Visio VSSM ke JPEG pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSSM ke JPEG Menggunakan C#" %}}

 Untuk mengonversi VSSM ke JPEG, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi VSSM ke JPEG melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi VSSM file ke JPEG hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSSM dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.JPEG sebagai parameter1. File JPEG akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSSM ke JPEG C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSSM ke JPEG" sectionDescription="Periksa demo langsung kami untuk [VSSM ke konversi JPEG](https://products.aspose.app/diagram/conversion/vssm-to-jpeg) dengan manfaat sebagai berikut." >}}
