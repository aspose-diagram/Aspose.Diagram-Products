---
title: Ubah VSSM menjadi VDX melalui C# 
weight: 3910
url: /id/net/conversion/vssm-to-vdx/ 
description: Kode contoh untuk konversi VSSM ke VDX C#. Gunakan API kode contoh untuk file VSSM batch ke konversi VDX dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah VSSM menjadi VDX melalui C#" h2="Ekspor file Microsoft® Visio VSSM ke VDX pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSSM ke VDX Menggunakan C#" %}}

 Untuk mengonversi VSSM menjadi VDX, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi VSSM ke VDX melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file VSSM menjadi VDX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSSM dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file keluaran dan SaveFileFormat.VDX sebagai parameter1. VDX file akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSSM ke VDX C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSSM ke VDX" sectionDescription="Periksa demo langsung kami untuk [VSSM menjadi VDX konversi](https://products.aspose.app/diagram/conversion/vssm-to-vdx) dengan manfaat sebagai berikut." >}}
