---
title: Konversi VSTX ke VSDX melalui C# 
weight: 140
url: /id/net/conversion/vstx-to-vsdx/ 
description: Contoh kode untuk konversi VSTX ke VSDX C#. Gunakan API kode contoh untuk file batch VSTX ke VSDX konversi dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi VSTX ke VSDX melalui C#" h2="Ekspor file Microsoft® Visio VSTX ke VSDX pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSTX ke VSDX Menggunakan C#" %}}

 Untuk mengonversi VSTX ke VSDX, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi VSTX ke VSDX melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file VSTX ke VSDX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSTX dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file keluaran dan SaveFileFormat.VSDX sebagai parameter1. VSDX file akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSTX ke VSDX C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSTX ke VSDX" sectionDescription="Periksa demo langsung kami untuk [VSTX ke VSDX konversi](https://products.aspose.app/diagram/conversion/vstx-to-vsdx) dengan manfaat sebagai berikut." >}}
