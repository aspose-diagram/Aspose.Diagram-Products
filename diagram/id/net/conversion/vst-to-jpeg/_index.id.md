---
title: Konversi VST ke JPEG melalui C# 
weight: 1130
url: /id/net/conversion/vst-to-jpeg/ 
description: Contoh kode untuk konversi VST ke JPEG C#. Gunakan API kode contoh untuk file VST batch ke konversi JPEG dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversi VST ke JPEG melalui C#" h2="Ekspor Microsoft® Visio file VST ke JPEG pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VST ke JPEG Menggunakan C#" %}}

 Untuk mengonversi VST ke JPEG, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah Mengonversi VST ke JPEG melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file VST ke JPEG hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VST dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.JPEG sebagai parameter1. File JPEG akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VST ke JPEG C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VST ke JPEG" sectionDescription="Periksa demo langsung kami untuk [Konversi VST ke JPEG](https://products.aspose.app/diagram/conversion/vst-to-jpeg) dengan manfaat sebagai berikut." >}}
