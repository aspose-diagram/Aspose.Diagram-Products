---
title: Ubah VSDM menjadi VSDX melalui C# 
weight: 4480
url: /id/net/conversion/vsdm-to-vsdx/ 
description: Kode contoh untuk konversi VSDM ke VSDX C#. Gunakan API kode contoh untuk file VSDM batch ke konversi VSDX dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah VSDM menjadi VSDX melalui C#" h2="Ekspor file Microsoft® Visio VSDM ke VSDX pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDM ke VSDX Menggunakan C#" %}}

 Untuk mengonversi VSDM menjadi VSDX, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi VSDM ke VSDX melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file VSDM menjadi VSDX hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDM dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file keluaran dan SaveFileFormat.VSDX sebagai parameter1. VSDX file akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSDM ke VSDX C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDM ke VSDX" sectionDescription="Periksa demo langsung kami untuk [VSDM menjadi VSDX konversi](https://products.aspose.app/diagram/conversion/vsdm-to-vsdx) dengan manfaat sebagai berikut." >}}
