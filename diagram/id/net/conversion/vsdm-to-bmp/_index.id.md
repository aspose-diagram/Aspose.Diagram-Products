---
title: Konversikan VSDM ke BMP melalui C# 
weight: 4190
url: /id/net/conversion/vsdm-to-bmp/ 
description: Contoh kode untuk konversi VSDM ke BMP C#. Gunakan API kode contoh untuk kumpulan VSDM file ke konversi BMP dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSDM ke BMP melalui C#" h2="Ekspor file Microsoft® Visio VSDM ke BMP di .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDM ke BMP Menggunakan C#" %}}

 Untuk mengonversi VSDM ke BMP, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengkonversi VSDM ke BMP melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi VSDM file ke BMP hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDM dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.BMP sebagai parameter1. File BMP akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSDM ke BMP C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDM ke BMP" sectionDescription="Periksa demo langsung kami untuk [VSDM ke konversi BMP](https://products.aspose.app/diagram/conversion/vsdm-to-bmp) dengan manfaat sebagai berikut." >}}
