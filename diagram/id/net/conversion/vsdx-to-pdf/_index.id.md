---
title: Konversikan VSDX ke PDF melalui C# 
weight: 680
url: /id/net/conversion/vsdx-to-pdf/ 
description: Contoh kode untuk konversi VSDX ke PDF C#. Gunakan API kode contoh untuk kumpulan VSDX file ke konversi PDF dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSDX ke PDF melalui C#" h2="Ekspor file Microsoft® Visio VSDX ke PDF di .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDX ke PDF Menggunakan C#" %}}

 Untuk mengonversi VSDX ke PDF, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi VSDX ke PDF melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi VSDX file ke PDF hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDX dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.PDF sebagai parameter1. File PDF akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSDX ke PDF C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDX ke PDF" sectionDescription="Periksa demo langsung kami untuk [VSDX ke konversi PDF](https://products.aspose.app/diagram/conversion/vsdx-to-pdf) dengan manfaat sebagai berikut." >}}
