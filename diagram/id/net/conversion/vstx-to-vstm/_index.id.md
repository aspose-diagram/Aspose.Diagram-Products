---
title: Ubah VSTX menjadi VSTM melalui C# 
weight: 3010
url: /id/net/conversion/vstx-to-vstm/ 
description: Kode contoh untuk konversi VSTX ke VSTM C#. Gunakan API kode contoh untuk file VSTX batch ke konversi VSTM dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Ubah VSTX menjadi VSTM melalui C#" h2="Ekspor file Microsoft® Visio VSTX ke VSTM pada .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSTX ke VSTM Menggunakan C#" %}}

 Untuk mengonversi VSTX menjadi VSTM, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi VSTX ke VSTM melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi file VSTX menjadi VSTM hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSTX dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file keluaran dan SaveFileFormat.VSTM sebagai parameter1. VSTM file akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSTX ke VSTM C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSTX ke VSTM" sectionDescription="Periksa demo langsung kami untuk [VSTX menjadi VSTM konversi](https://products.aspose.app/diagram/conversion/vstx-to-vstm) dengan manfaat sebagai berikut." >}}
