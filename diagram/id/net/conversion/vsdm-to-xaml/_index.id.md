---
title: Konversikan VSDM ke XAML melalui C# 
weight: 3980
url: /id/net/conversion/vsdm-to-xaml/ 
description: Contoh kode untuk konversi VSDM ke XAML C#. Gunakan API kode contoh untuk kumpulan VSDM file ke konversi XAML dalam VB.NET, Asp.NET atau aplikasi berbasis .NET apa pun.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konversikan VSDM ke XAML melalui C#" h2="Ekspor file Microsoft® Visio VSDM ke XAML di .NET Framework, .NET Core, Mono atau COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Mengonversi VSDM ke XAML Menggunakan C#" %}}

 Untuk mengonversi VSDM ke XAML, kami akan menggunakan
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Mengonversi VSDM ke XAML melalui C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET pengembang dapat dengan mudah memuat & mengonversi VSDM file ke XAML hanya dalam beberapa baris kode.

{{% /blocks/products/pf/agp/text %}}

1. Muat file VSDM dengan instance Diagram class1. Panggil metode Diagram.Save dengan jalur file output dan SaveFileFormat.XAML sebagai parameter1. File XAML akan disimpan di jalur yang ditentukan
...
{{% blocks/products/pf/agp/code-block title="Kode contoh ini menunjukkan VSDM ke XAML C# Konversi" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplikasi Gratis untuk Mengonversi VSDM ke XAML" sectionDescription="Periksa demo langsung kami untuk [VSDM ke konversi XAML](https://products.aspose.app/diagram/conversion/vsdm-to-xaml) dengan manfaat sebagai berikut." >}}
