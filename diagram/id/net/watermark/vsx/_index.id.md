---
title: Tanda air VSX dokumen melalui .NET 
weight: 3050
url: /id/net/watermark/vsx/ 
description: C# kode sumber untuk menambahkan tanda air ke file vsx di Platform .NET Framework, .NET Inti, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Cara Memberi Tanda Air VSX Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Watermarking VSX Berkas di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tanda Air VSX Berkas - C#" offSpacer="" %}}
