---
title: Tanda air VSTX dokumen melalui .NET 
weight: 3050
url: /id/net/watermark/vstx/ 
description: C# kode sumber untuk menambahkan tanda air ke file vstx di Platform .NET Framework, .NET Inti, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Cara Memberi Tanda Air VSTX Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Watermarking VSTX Berkas di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tanda Air VSTX Berkas - C#" offSpacer="" %}}
