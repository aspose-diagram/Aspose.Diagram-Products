---
title: Tanda air VSSM dokumen melalui .NET 
weight: 3050
url: /id/net/watermark/vssm/ 
description: C# kode sumber untuk menambahkan tanda air ke file vssm di Platform .NET Framework, .NET Inti, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Tambahkan Tanda Air Teks ke VSSM di C#" h2="Tanda air dokumen VSSM asli dan berkinerja tinggi menggunakan Aspose.Diagram for .NET API sisi server, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Cara Memberi Tanda Air VSSM Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Watermarking VSSM Berkas di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tanda Air VSSM Berkas - C#" offSpacer="" %}}
