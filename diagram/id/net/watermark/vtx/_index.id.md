---
title: Tanda air VTX dokumen melalui .NET 
weight: 3050
url: /id/net/watermark/vtx/ 
description: C# kode sumber untuk menambahkan tanda air ke file vtx di Platform .NET Framework, .NET Inti, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Cara Memberi Tanda Air VTX Berkas Menggunakan C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Langkah-langkah untuk Watermarking VTX Berkas di C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Tanda Air VTX Berkas - C#" offSpacer="" %}}
