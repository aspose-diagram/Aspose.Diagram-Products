---
title: Visio Dokumen Node.js API - Aspose 
weight: 1630
url: /id/nodejs-java/ 
description: Aspose.Diagram untuk Node.js melalui Java adalah javascript visio API untuk membaca, menulis, dan mengonversi Microsoft Visio Dokumen seperti VSDX, VDX, dan format lainnya
---
{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/i18n/upper-banner h1="Node.js Visio Berkas API" h2="Buat, Baca, Tulis, dan Ekspor Microsoft Visio Format termasuk VSDX, VDX, VSX, VTX, dan format lainnya menggunakan Node.js API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/headers/aspose_diagram-for-nodejs-java.svg" pfName="Aspose.Diagram " subTitlepfName="for Node.js via Java" downloadUrl="https://downloads.aspose.com/diagram/nodejs" >}}
...
<p>
 Aspose.Diagram untuk Node.js melalui Java adalah solusi manipulasi dokumen Visio Microsoft. Seseorang dapat membaca, menulis, melindungi, mengekspor, dan mencetak format Visio asli serta mendukung beberapa format gambar dan tata letak tetap yang umum digunakan. Mudah untuk memuat file yang ada, memodifikasi elemen diagram untuk diekspor ke format yang diinginkan termasuk gambar atau format tata letak tetap seperti PDF atau XPS.
</p>

<p>
 Aspose.Diagram untuk Node.js melalui Java adalah API mandiri dan tidak memerlukan Microsoft Visio atau penginstalan perangkat lunak lainnya. Selain itu, beberapa tugas yang dapat dilakukan dengan mudah seperti membuat diagram dari awal, membaca atau menulis berbagai format, mengakses dan membaca properti termasuk Visio rumus objek, mengekspor diagram ke berbagai format, mencetak diagram dengan ketelitian tinggi, dan banyak lagi.
</p>
...
{{< blocks/products/pf/carousel-item h3="Sekilas" description="Ikhtisar Aspose.Diagram untuk Node.js melalui kemampuan Java." >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Kemerdekaan" description="Aspose.Diagram untuk Node.js melalui Java adalah JavaScript sisi server API berdasarkan Node.js. Itu dapat berjalan di platform Windows, Unix/Linux & Mac dengan JDK 1.6 atau lebih tinggi." >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Format File yang Didukung" description="Aspose.Diagram untuk Node.js melalui Java mendukung format populer Microsoft Visio dan banyak lagi." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Node.js Lanjutan Visio API Fitur
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    <h2 class="h2title">
     Buat Visio Dokumen dari Awal
    </h2>
    <p>
     Aspose.Diagram untuk Node.js sederhana dan mudah digunakan. Ini memungkinkan pengguna untuk bekerja dengan diagram tanpa pemahaman tentang format yang mendasarinya seperti seseorang dapat membuat VSDX file dari awal hanya dengan beberapa baris kode.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Buat format VSDX dari Awal menggunakan Node.js
     </h3>
...
diagram.save("output.vsdx", aspose.diagram.SaveFileFormat.VSDX);</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Diagram Node.js API mengizinkan untuk membaca format asli Microsoft Visio serta menyediakan akses ke data diagram seperti dokumen, halaman, master, bentuk, lembar gaya, koneksi, dan sebagainya. Objek ini dapat dimanipulasi melalui API, dan hasilnya dapat ditulis ke disk dalam format apa pun yang didukung.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Pengembang dapat dengan mudah memuat Visio file dan mengekspornya ke gambar populer termasuk PNG, TIFF, JPEG, BMP, SVG, dan EMF. Pustaka Nodejs juga mendukung ekspor Visio file ke PDF &amp; Format XPS dengan fidelitas tertinggi.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Ekspor Laman dari Visio VSDX Berkas ke Format PNG
     </h3>
...
{{< blocks/products/pf/slr-element name="Dokumentasi" href="https://docs.aspose.com/diagram/java/aspose-diagram-for-node-js-via-java-features/" >}}
{{< blocks/products/pf/slr-element name="Kode sumber" href="https://github.com/aspose-diagram/Aspose.Diagram-for-Java" >}}
{{< blocks/products/pf/slr-element name="API Referensi" href="https://apireference.aspose.com/diagram/nodejs" >}}
