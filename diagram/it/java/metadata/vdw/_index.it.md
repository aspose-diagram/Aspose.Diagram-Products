---
title: Visualizza o modifica i metadati dei file VDW tramite Java 
weight: 3150
url: /it/java/metadata/vdw/ 
description: Java codice di esempio per modificare o visualizzare i metadati VDW su Java Runtime Environment per applicazioni JSP/JSF e applicazioni desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Estrai metadati VDW in Java" h2="Crea le tue Java app per aggiungere, modificare, rimuovere o estrarre metadati dai file VDW " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Come estrarre i metadati VDW utilizzando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'estrazione dei metadati VDW in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Estrazione dei metadati VDW - Java" offSpacer="" %}}
