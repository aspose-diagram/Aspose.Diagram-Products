---
title: Visualizza o modifica VSDM metadati dei file tramite Java 
weight: 3150
url: /it/java/metadata/vsdm/ 
description: Java codice di esempio per modificare o visualizzare VSDM metadati su Java Runtime Environment per applicazioni JSP/JSF e applicazioni desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Estrai VSDM metadati in Java" h2="Crea le tue Java app per aggiungere, modificare, rimuovere o estrarre metadati da VSDM file " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Come estrarre VSDM metadati utilizzando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'estrazione di VSDM metadati in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Estrazione di VSDM metadati - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram è una Microsoft Visio manipolazione del formato del documento API. Si può facilmente caricare, creare, modificare, manipolare inclusi elementi daigram e convertire Visio diagrammi in altri formati come PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF e altro ancora. È un API autonomo e non richiede l'installazione di Microsoft Visio o altro software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per estrarre metadati di VSDM" sectionDescription="Visualizza e modifica i metadati in VSDM documenti visitando il nostro [Sito di demo dal vivo](https://products.aspose.app/diagram/metadata) con i seguenti vantaggi." >}}
