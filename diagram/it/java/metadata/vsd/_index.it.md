---
title: Visualizza o modifica VSD metadati dei file tramite Java 
weight: 3150
url: /it/java/metadata/vsd/ 
description: Java codice di esempio per modificare o visualizzare VSD metadati su Java Runtime Environment per applicazioni JSP/JSF e applicazioni desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Estrai VSD metadati in Java" h2="Crea le tue Java app per aggiungere, modificare, rimuovere o estrarre metadati da VSD file " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Come estrarre VSD metadati utilizzando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'estrazione di VSD metadati in Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Estrazione di VSD metadati - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram è una Microsoft Visio manipolazione del formato del documento API. Si può facilmente caricare, creare, modificare, manipolare inclusi elementi daigram e convertire Visio diagrammi in altri formati come PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF e altro ancora. È un API autonomo e non richiede l'installazione di Microsoft Visio o altro software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per estrarre metadati di VSD" sectionDescription="Visualizza e modifica i metadati in VSD documenti visitando il nostro [Sito di demo dal vivo](https://products.aspose.app/diagram/metadata) con i seguenti vantaggi." >}}
