...
{{% blocks/products/pf/agp/content h2="Come convertire VST in VSTM utilizzando Java" %}}
 ...
 Per rendere VST in VSTM, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java gli sviluppatori possono convertire facilmente i file VST in VSTM in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VST con un'istanza della classe Diagram1. Chiama il metodo Diagram.save con il percorso del file di output e SaveFileFormat come parametri1. Il file VSTM verrà salvato nel percorso specificato
