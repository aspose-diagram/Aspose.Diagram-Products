...
description: Esempio di codice di conversione Java per il formato VSDM in file VSSX. Utilizzare questo codice di esempio per convertire VSDM in VSSX all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSDM in VSSX tramite Java" h2="Esporta Microsoft Visio VSDM in VSSX utilizzando la libreria nativa Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in VSSX usando Java" %}}

 Per eseguire il rendering di VSDM in VSSX, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java gli sviluppatori possono convertire facilmente i file VSDM in VSSX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza della classe Diagram1. Chiama il metodo Diagram.save con il percorso del file di output e SaveFileFormat come parametri1. Il file VSSX verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da VSDM a VSSX Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da VSDM a VSSX" sectionDescription="[Converti VSDM in VSSX](https://products.aspose.app/diagram/conversion/vsdm-to-vssx) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file VSDM, verrà convertito istantaneamente in VSSX." >}}
