...
description: Esempio di codice di conversione Java per il formato VSDM in file PNG. Utilizzare questo codice di esempio per convertire VSDM in PNG all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in PNG usando Java" %}}

 Per rendere VSDM in PNG, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java gli sviluppatori possono convertire facilmente file VSDM in PNG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza della classe Diagram1. Chiama il metodo Diagram.save con il percorso del file di output e SaveFileFormat come parametri1. Il file PNG verrà salvato nel percorso specificato
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da VSDM a PNG" sectionDescription="[Converti VSDM in PNG](https://products.aspose.app/diagram/conversion/vsdm-to-png) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file VSDM, verrà convertito istantaneamente in PNG." >}}
