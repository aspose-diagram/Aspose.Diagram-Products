...
description: Esempio di codice di conversione Java per il formato VSTM in file XPS. Utilizzare questo codice di esempio per convertire VSTM in XPS all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire VSTM in XPS usando Java" %}}

 Per rendere VSTM in XPS, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java gli sviluppatori possono convertire facilmente i file VSTM in XPS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSTM con un'istanza della classe Diagram1. Chiama il metodo Diagram.save con il percorso del file di output e SaveFileFormat come parametri1. Il file XPS verrà salvato nel percorso specificato
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo live di conversione da VSTM a XPS" sectionDescription="[Converti VSTM in XPS](https://products.aspose.app/diagram/conversion/vstm-to-xps) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
