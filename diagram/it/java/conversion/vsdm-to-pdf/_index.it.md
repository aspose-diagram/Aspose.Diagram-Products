...
description: Esempio di codice di conversione Java per il formato VSDM in file PDF. Utilizzare questo codice di esempio per convertire VSDM in PDF all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in PDF utilizzando Java" %}}
 ...
 Per rendere VSDM in PDF, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java gli sviluppatori possono convertire facilmente file VSDM in PDF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza della classe Diagram1. Chiama il metodo Diagram.save con il percorso del file di output e SaveFileFormat come parametri1. Il file PDF verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da VSDM a PDF Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo dal vivo di conversione da VSDM a PDF" sectionDescription="[Converti VSDM in PDF](https://products.aspose.app/diagram/conversion/vsdm-to-pdf) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
