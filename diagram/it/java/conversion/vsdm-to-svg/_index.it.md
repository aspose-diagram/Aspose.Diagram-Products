...
description: Esempio di codice di conversione Java per il formato VSDM in file SVG. Utilizzare questo codice di esempio per convertire VSDM in SVG all'interno di qualsiasi applicazione basata su Web o desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSDM in SVG tramite Java" h2="Esporta Microsoft Visio VSDM in SVG utilizzando la libreria nativa Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="SVG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in SVG usando Java" %}}

 Per rendere VSDM in SVG, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java gli sviluppatori possono convertire facilmente i file VSDM in SVG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza della classe Diagram1. Chiama il metodo Diagram.save con il percorso del file di output e SaveFileFormat come parametri1. Il file SVG verrà salvato nel percorso specificato
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo dal vivo di conversione da VSDM a SVG" sectionDescription="[Converti VSDM in SVG](https://products.aspose.app/diagram/conversion/vsdm-to-svg) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
