...
description: Esempio di codice di conversione Java per il formato VSTM in file VDX. Utilizzare questo codice di esempio per convertire VSTM in VDX all'interno di qualsiasi applicazione basata su Web o Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSTM in VDX tramite Java" h2="Esporta Microsoft Visio VSTM in VDX utilizzando la libreria nativa Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSTM in VDX usando Java" %}}

 Per rendere VSTM in VDX, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java gli sviluppatori possono convertire facilmente i file VSTM in VDX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSTM con un'istanza della classe Diagram1. Chiama il metodo Diagram.save con il percorso del file di output e SaveFileFormat come parametri1. Il file VDX verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Codice sorgente di conversione da VSTM a VDX Java" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demo dal vivo di conversione da VSTM a VDX" sectionDescription="[Converti VSTM in VDX](https://products.aspose.app/diagram/conversion/vstm-to-vdx) in questo momento visitando il nostro sito Web di demo dal vivo. La demo dal vivo ha i seguenti vantaggi" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Non è necessario scaricare Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Non c\'è bisogno di scrivere alcun codice." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Basta caricare il tuo file VSTM, verrà convertito istantaneamente in VDX." >}}
