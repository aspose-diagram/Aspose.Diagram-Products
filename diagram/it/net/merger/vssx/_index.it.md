---
title: Unisci VSSX file tramite .NET 
weight: 3770
url: /it/net/merger/vssx/ 
description: C# codice sorgente per combinare VSSX documenti su .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci VSSX formati in C#" h2="Unione di documenti nativi e ad alte prestazioni VSSX utilizzando API Aspose.Diagram for .NET lato server, senza l\'uso di alcun software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come unire VSSX file utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per unire VSSX file in C#" %}}
...
+ Carica tutti i VSSX file con il percorso completo.
...
{{% blocks/products/pf/agp/code-block title="Unisci VSSX file - C#" offSpacer="" %}}
