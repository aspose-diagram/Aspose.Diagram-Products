---
title: Unisci VSTX file tramite .NET 
weight: 1450
url: /it/net/merger/vstx/ 
description: C# codice sorgente per combinare VSTX documenti su .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci VSTX formati in C#" h2="Unione di documenti nativi e ad alte prestazioni VSTX utilizzando API Aspose.Diagram for .NET lato server, senza l\'uso di alcun software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Come unire VSTX file utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per unire VSTX file in C#" %}}
...
+ Carica tutti i VSTX file con il percorso completo.
...
{{% blocks/products/pf/agp/code-block title="Unisci VSTX file - C#" offSpacer="" %}}
