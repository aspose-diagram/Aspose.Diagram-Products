---
title: Unisci file VSS tramite .NET 
weight: 5110
url: /it/net/merger/vss/ 
description: C# codice sorgente per combinare documenti VSS su .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci formati VSS in C#" h2="Fusione di documenti VSS nativi e ad alte prestazioni utilizzando API Aspose.Diagram for .NET lato server, senza l\'uso di alcun software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Come unire file VSS utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'unione di file VSS in C#" %}}
...
+ Carica tutti i file VSS con il percorso completo.
+ Crea un documento come file di base
+ Chiama il metodo pertinente per concatenare e unire i file uno per uno.
+ Chiama il metodo Save() e passa il nome del file (percorso completo) e il formato (VSS) come parametro.
Ora puoi aprire e utilizzare il file VSS in Microsoft Office, Adobe PDF o qualsiasi altro programma compatibile.
...
{{% blocks/products/pf/agp/code-block title="Unisci file VSS - C#" offSpacer="" %}}
