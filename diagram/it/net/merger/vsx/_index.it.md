---
title: Unisci VSX file tramite .NET 
weight: 1260
url: /it/net/merger/vsx/ 
description: C# codice sorgente per combinare VSX documenti su .NET Framework, .NET Core, Mono o COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci VSX formati in C#" h2="Unione di documenti nativi e ad alte prestazioni VSX utilizzando API Aspose.Diagram for .NET lato server, senza l\'uso di alcun software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="Come unire VSX file utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per unire VSX file in C#" %}}
...
+ Carica tutti i VSX file con il percorso completo.
+ Crea un documento come file di base
+ Chiama il metodo pertinente per concatenare e unire i file uno per uno.
+ Chiama il metodo Save() e passa il nome del file (percorso completo) e il formato (VSX) come parametro.
...
{{% blocks/products/pf/agp/code-block title="Unisci VSX file - C#" offSpacer="" %}}
