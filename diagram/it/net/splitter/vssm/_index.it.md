---
title: Dividi VSSM file tramite .NET 
weight: 1300
url: /it/net/splitter/vssm/ 
description: C# codice sorgente per dividere il file vssm su piattaforme .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Come dividere VSSM file utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per dividere VSSM file in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dividi VSSM file - C#" offSpacer="" %}}
