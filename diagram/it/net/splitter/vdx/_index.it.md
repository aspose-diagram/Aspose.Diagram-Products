---
title: Dividi VDX file tramite .NET 
weight: 1300
url: /it/net/splitter/vdx/ 
description: C# codice sorgente per dividere il file vdx su piattaforme .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Come dividere VDX file utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per dividere VDX file in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dividi VDX file - C#" offSpacer="" %}}
