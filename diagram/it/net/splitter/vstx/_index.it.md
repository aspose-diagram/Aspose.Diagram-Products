---
title: Dividi VSTX file tramite .NET 
weight: 1300
url: /it/net/splitter/vstx/ 
description: C# codice sorgente per dividere il file vstx su piattaforme .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Come dividere VSTX file utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per dividere VSTX file in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dividi VSTX file - C#" offSpacer="" %}}
