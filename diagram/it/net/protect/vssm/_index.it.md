---
title: Proteggi e blocca VSSM documento tramite .NET 
weight: 5580
url: /it/net/protect/vssm/ 
description: C# codice sorgente per bloccare il file VSSM su piattaforme .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Proteggi VSSM file tramite C#" h2="Proteggi Visio incluso il formato VSSM utilizzando .NET Libreria." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come proteggere il file VSSM utilizzando C#" %}}

 Per proteggere il file VSSM, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la protezione di VSSM file in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Proteggi VSSM file - C#" offSpacer="" %}}
