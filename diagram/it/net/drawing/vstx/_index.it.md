---
title: Disegna geomtry su VSTX documento tramite .NET 
weight: 3050
url: /it/net/drawing/vstx/ 
description: C# codice sorgente per disegnare geomtry su vstx file su piattaforme .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Disegna Geomtry a VSTX in C#" h2="Geomtry di disegno nativo e ad alte prestazioni per VSTX documento utilizzando API Aspose.Diagram for .NET lato server, senza l\'uso di alcun software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come disegnare la geometria su un file VSTX utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per disegnare la geometria su VSTX file in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Disegna Geomtry su VSTX file - C#" offSpacer="" %}}
