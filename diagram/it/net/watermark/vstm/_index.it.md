---
title: Documento filigrana VSTM tramite .NET 
weight: 3050
url: /it/net/watermark/vstm/ 
description: C# codice sorgente per aggiungere filigrana al file vstm su .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Aggiungi filigrana di testo a VSTM in C#" h2="Filigrana di documenti VSTM nativa e ad alte prestazioni che utilizza API Aspose.Diagram for .NET lato server, senza l\'uso di software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come filigranare il file VSTM utilizzando C#" %}}

 Per filigranare il file VSTM, useremo
...
{{% blocks/products/pf/agp/code-block title="File VSTM filigrana - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram è una manipolazione del formato del documento Visio Microsoft API. Si può facilmente caricare, creare, modificare, manipolare inclusi elementi daigram e convertire Visio diagrammi in altri formati come PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF e altro ancora. È un API autonomo e non richiede l'installazione di Microsoft Visio o di qualsiasi altro software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Dimostrazioni live online di VSTM WaterMark" sectionDescription="Documenti WaterMark VSTM in questo momento visitando il nostro [Sito di demo dal vivo](https://products.aspose.app/diagram/watermark). La demo dal vivo ha i seguenti vantaggi" >}}
