---
title: Filigrana VTX documento tramite .NET 
weight: 3050
url: /it/net/watermark/vtx/ 
description: C# codice sorgente per aggiungere filigrana al file vtx su piattaforme .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Aggiungi filigrana di testo a VTX in C#" h2="Filigrana del documento VTX nativa e ad alte prestazioni che utilizza API Aspose.Diagram for .NET lato server, senza l\'uso di alcun software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come filigranare un file VTX utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la filigrana dei file VTX in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Filigrana VTX File - C#" offSpacer="" %}}
