...
{{% blocks/products/pf/agp/content h2="Come convertire VDX in VTX utilizzando C#" %}}
 ...
 Per convertire VDX in VTX, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VDX file in VTX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VDX con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VTX come parametri1. VTX il file verrà salvato nel percorso specificato
