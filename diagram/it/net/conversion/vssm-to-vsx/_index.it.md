...
{{% blocks/products/pf/agp/content h2="Come convertire VSSM in VSX utilizzando C#" %}}
 ...
 Per convertire VSSM in VSX, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente i file VSSM in VSX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSSM con un'istanza della classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VSX come parametri1. Il file VSX verrà salvato nel percorso specificato
