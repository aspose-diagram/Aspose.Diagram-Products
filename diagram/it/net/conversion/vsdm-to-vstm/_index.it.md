...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in VSTM utilizzando C#" %}}
 ...
 Per convertire VSDM in VSTM, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VSDM file in VSTM in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VSTM come parametri1. VSTM il file verrà salvato nel percorso specificato
