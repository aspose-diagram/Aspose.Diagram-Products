...
{{% blocks/products/pf/agp/content h2="Come convertire VSTM in JPEG utilizzando C#" %}}
 ...
 Per convertire VSTM in JPEG, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VSTM file in JPEG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSTM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.JPEG come parametri1. Il file JPEG verrà salvato nel percorso specificato
