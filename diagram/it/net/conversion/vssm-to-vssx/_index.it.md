...
{{% blocks/products/pf/agp/content h2="Come convertire VSSM in VSSX utilizzando C#" %}}
 ...
 Per convertire VSSM in VSSX, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VSSM file in VSSX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSSM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VSSX come parametri1. VSSX il file verrà salvato nel percorso specificato
