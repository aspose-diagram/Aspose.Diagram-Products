---
title: Converti VDX in XAML tramite C# 
weight: 50
url: /it/net/conversion/vdx-to-xaml/ 
description: Codice di esempio per la conversione da VDX a XAML C#. Utilizza API codice di esempio per la conversione batch di file VDX in XAML all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VDX in XAML tramite C#" h2="Esporta file Microsoft® Visio VDX in XAML su .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VDX in XAML utilizzando C#" %}}

 Per convertire VDX in XAML, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VDX in XAML tramite C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da VDX a XAML C#" offSpacer="" %}}
