---
title: Converti VSS in XPS tramite C# 
weight: 4820
url: /it/net/conversion/vss-to-xps/ 
description: Codice di esempio per la conversione da VSS a XPS C#. Utilizza API codice di esempio per la conversione batch di file VSS in XPS all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSS in XPS tramite C#" h2="Esporta file VSS Microsoft® Visio in XPS su .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSS in XPS utilizzando C#" %}}

 Per convertire VSS in XPS, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VSS in XPS tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET gli sviluppatori possono caricare e convertire facilmente file VSS in XPS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSS con un'istanza di Diagram classe1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.XPS come parametri1. Il file XPS verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da VSS a XPS C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VSS in XPS" sectionDescription="Controlla le nostre demo dal vivo per [Conversione da VSS a XPS](https://products.aspose.app/diagram/conversion/vss-to-xps) con i seguenti vantaggi." >}}
