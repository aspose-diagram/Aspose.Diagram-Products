---
title: Converti VSDM in VDX tramite C# 
weight: 3930
url: /it/net/conversion/vsdm-to-vdx/ 
description: Codice di esempio per la conversione da VSDM a VDX C#. Utilizza API codice di esempio per la conversione batch di file VSDM in VDX all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSDM in VDX tramite C#" h2="Esporta file Microsoft® Visio VSDM in VDX su .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in VDX utilizzando C#" %}}

 Per convertire VSDM in VDX, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VSDM in VDX tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET gli sviluppatori possono caricare e convertire facilmente VSDM file in VDX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VDX come parametri1. VDX il file verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da VSDM a VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VSDM in VDX" sectionDescription="Controlla le nostre demo dal vivo per [conversione da VSDM a VDX](https://products.aspose.app/diagram/conversion/vsdm-to-vdx) con i seguenti vantaggi." >}}
