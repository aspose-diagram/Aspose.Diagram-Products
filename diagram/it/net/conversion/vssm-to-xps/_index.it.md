...
{{% blocks/products/pf/agp/content h2="Come convertire VSSM in XPS usando C#" %}}

 Per convertire VSSM in XPS, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente i file VSSM in XPS in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSSM con un'istanza della classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.XPS come parametri1. Il file XPS verrà salvato nel percorso specificato
