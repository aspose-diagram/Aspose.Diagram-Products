---
title: Converti VSSM in VDX tramite C# 
weight: 3910
url: /it/net/conversion/vssm-to-vdx/ 
description: Codice di esempio per la conversione da VSSM a VDX C#. Utilizza API codice di esempio per la conversione batch di file VSSM in VDX all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSSM in VDX tramite C#" h2="Esporta file Microsoft® Visio VSSM in VDX su .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSSM in VDX utilizzando C#" %}}

 Per convertire VSSM in VDX, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VSSM in VDX tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET gli sviluppatori possono caricare e convertire facilmente VSSM file in VDX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSSM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VDX come parametri1. VDX il file verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da VSSM a VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VSSM in VDX" sectionDescription="Controlla le nostre demo dal vivo per [conversione da VSSM a VDX](https://products.aspose.app/diagram/conversion/vssm-to-vdx) con i seguenti vantaggi." >}}
