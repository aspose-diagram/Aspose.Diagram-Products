...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VSDM file in XAML in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.XAML come parametri1. Il file XAML verrà salvato nel percorso specificato
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VSDM in XAML" sectionDescription="Controlla le nostre demo dal vivo per [VSDM in conversione XAML](https://products.aspose.app/diagram/conversion/vsdm-to-xaml) con i seguenti vantaggi." >}}
