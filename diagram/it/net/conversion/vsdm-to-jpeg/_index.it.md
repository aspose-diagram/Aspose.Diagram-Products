...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in JPEG utilizzando C#" %}}
 ...
 Per convertire VSDM in JPEG, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VSDM file in JPEG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.JPEG come parametri1. Il file JPEG verrà salvato nel percorso specificato
