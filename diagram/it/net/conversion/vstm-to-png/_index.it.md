...
{{% blocks/products/pf/agp/content h2="Come convertire VSTM in PNG utilizzando C#" %}}
 ...
 Per convertire VSTM in PNG, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VSTM file in PNG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSTM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.PNG come parametri1. Il file PNG verrà salvato nel percorso specificato
