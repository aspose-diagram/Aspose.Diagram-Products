...
{{% blocks/products/pf/agp/content h2="Come convertire VDX in SVG usando C#" %}}

 Per convertire VDX in SVG, useremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente i file VDX in SVG in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VDX con un'istanza della classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.SVG come parametri1. Il file SVG verrà salvato nel percorso specificato
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VDX in SVG" sectionDescription="Controlla le nostre demo dal vivo per [Conversione da VDX a SVG](https://products.aspose.app/diagram/conversion/vdx-to-svg) con i seguenti vantaggi." >}}
