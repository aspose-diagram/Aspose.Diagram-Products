...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in VSX utilizzando C#" %}}
 ...
 Per convertire VSDM in VSX, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VSDM file in VSX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VSX come parametri1. VSX il file verrà salvato nel percorso specificato
