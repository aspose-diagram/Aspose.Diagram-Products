...
{{% blocks/products/pf/agp/content h2="Come convertire VSTM in VDX utilizzando C#" %}}

 Per convertire VSTM in VDX, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VSTM file in VDX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSTM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VDX come parametri1. VDX il file verrà salvato nel percorso specificato
