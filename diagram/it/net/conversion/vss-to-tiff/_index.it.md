---
title: Converti VSS in TIFF tramite C# 
weight: 4280
url: /it/net/conversion/vss-to-tiff/ 
description: Codice di esempio per la conversione da VSS a TIFF C#. Utilizza API codice di esempio per la conversione batch di file VSS in TIFF all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSS in TIFF tramite C#" h2="Esporta file VSS Microsoft® Visio in TIFF su .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="TIFF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSS in TIFF utilizzando C#" %}}

 Per convertire VSS in TIFF, useremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VSS in TIFF tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET gli sviluppatori possono caricare e convertire facilmente i file VSS in TIFF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSS con un'istanza di Diagram classe1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.TIFF come parametri1. Il file TIFF verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da VSS a TIFF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VSS in TIFF" sectionDescription="Controlla le nostre demo dal vivo per [Conversione da VSS a TIFF](https://products.aspose.app/diagram/conversion/vss-to-tiff) con i seguenti vantaggi." >}}
