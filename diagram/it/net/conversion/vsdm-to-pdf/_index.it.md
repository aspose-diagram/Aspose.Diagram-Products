...
{{% blocks/products/pf/agp/content h2="Come convertire VSDM in PDF utilizzando C#" %}}
 ...
 Per convertire VSDM in PDF, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VSDM file in PDF in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSDM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.PDF come parametri1. Il file PDF verrà salvato nel percorso specificato
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VSDM in PDF" sectionDescription="Controlla le nostre demo dal vivo per [VSDM in PDF conversione](https://products.aspose.app/diagram/conversion/vsdm-to-pdf) con i seguenti vantaggi." >}}
