---
title: Converti VDX in VSDM tramite C# 
weight: 3430
url: /it/net/conversion/vdx-to-vsdm/ 
description: Codice di esempio per la conversione da VDX a VSDM C#. Utilizza API codice di esempio per la conversione batch di file VDX in VSDM all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VDX in VSDM tramite C#" h2="Esporta file Microsoft® Visio VDX in VSDM su .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VDX in VSDM utilizzando C#" %}}

 Per convertire VDX in VSDM, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VDX in VSDM tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET gli sviluppatori possono caricare e convertire facilmente VDX file in VSDM in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VDX con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VSDM come parametri1. VSDM il file verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da VDX a VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VDX in VSDM" sectionDescription="Controlla le nostre demo dal vivo per [conversione da VDX a VSDM](https://products.aspose.app/diagram/conversion/vdx-to-vsdm) con i seguenti vantaggi." >}}
