---
title: Converti VSSM in VSDX tramite C# 
weight: 4720
url: /it/net/conversion/vssm-to-vsdx/ 
description: Codice di esempio per la conversione da VSSM a VSDX C#. Utilizza API codice di esempio per la conversione batch di file VSSM in VSDX all'interno di VB.NET, Asp.NET o qualsiasi applicazione basata su .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSSM in VSDX tramite C#" h2="Esporta file Microsoft® Visio VSSM in VSDX su .NET Framework, .NET Core, Mono o COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSSM in VSDX utilizzando C#" %}}

 Per convertire VSSM in VSDX, utilizzeremo
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VSSM in VSDX tramite C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET gli sviluppatori possono caricare e convertire facilmente VSSM file in VSDX in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSSM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VSDX come parametri1. VSDX il file verrà salvato nel percorso specificato
...
{{% blocks/products/pf/agp/code-block title="Questo codice di esempio mostra la conversione da VSSM a VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="App gratuita per convertire VSSM in VSDX" sectionDescription="Controlla le nostre demo dal vivo per [conversione da VSSM a VSDX](https://products.aspose.app/diagram/conversion/vssm-to-vsdx) con i seguenti vantaggi." >}}
