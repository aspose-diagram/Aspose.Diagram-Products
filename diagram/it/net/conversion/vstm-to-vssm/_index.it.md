...
{{% blocks/products/pf/agp/content h2="Come convertire VSTM in VSSM utilizzando C#" %}}
 ...
 Per convertire VSTM in VSSM, utilizzeremo
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET gli sviluppatori possono caricare e convertire facilmente VSTM file in VSSM in poche righe di codice.

{{% /blocks/products/pf/agp/text %}}

1. Carica il file VSTM con un'istanza di classe Diagram1. Chiama il metodo Diagram.Save con il percorso del file di output e SaveFileFormat.VSSM come parametri1. VSSM il file verrà salvato nel percorso specificato
