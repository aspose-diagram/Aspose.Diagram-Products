---
title: Comprimi VDX documento tramite .NET 
weight: 3050
url: /it/net/compress/vdx/ 
description: C# codice sorgente per comprimere vdx file su piattaforme .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Come comprimere VDX file utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la compressione di VDX file in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimi VDX file - C#" offSpacer="" %}}
