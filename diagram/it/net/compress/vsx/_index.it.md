---
title: Comprimi VSX documento tramite .NET 
weight: 3050
url: /it/net/compress/vsx/ 
description: C# codice sorgente per comprimere vsx file su piattaforme .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/code-block title="Comprimi VSX file - C#" offSpacer="" %}}
