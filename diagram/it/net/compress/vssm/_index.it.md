---
title: Comprimi VSSM documento tramite .NET 
weight: 3050
url: /it/net/compress/vssm/ 
description: C# codice sorgente per comprimere vssm file su piattaforme .NET Framework, .NET Core, Mono.
---
...
{{% blocks/products/pf/agp/content h2="Come comprimere VSSM file utilizzando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la compressione di VSSM file in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimi VSSM file - C#" offSpacer="" %}}
