---
title: Comprimi il documento VSSM tramite .NET 
weight: 3050
url: /it/net/compress/vssm/ 
description: C# codice sorgente per comprimere il file vssm su .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Comprimi VSSM in C#" h2="Compressore di documenti VSSM nativo e ad alte prestazioni che utilizza API Aspose.Diagram for .NET lato server, senza l\'uso di software come Microsoft o Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come comprimere il file VSSM usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la compressione dei file VSSM in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Comprimi file VSSM - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram è una manipolazione del formato del documento Visio Microsoft API. Si può facilmente caricare, creare, modificare, manipolare inclusi elementi daigram e convertire Visio diagrammi in altri formati come PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF e altro ancora. È un API autonomo e non richiede l'installazione di Microsoft Visio o di qualsiasi altro software.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="VSSM online Comprimi demo dal vivo" sectionDescription="Comprimi i documenti VSSM in questo momento visitando il nostro [Sito di demo dal vivo](https://products.aspose.app/diagram/compress). La demo dal vivo ha i seguenti vantaggi" >}}
