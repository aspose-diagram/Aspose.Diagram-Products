---
title: Dividi VSDX file tramite Python
weight: 1400
url: /it/python-java/splitter/vsdx/ 
description: Python codice sorgente per dividere il file vsdx all'interno di qualsiasi applicazione basata su Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dividi il formato VSDX in Python" h2="Crea le tue Python app per dividere VSDX file " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come dividere VSDX file utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per dividere VSDX file in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Dividi VSDX file - Python" offSpacer="" %}}
