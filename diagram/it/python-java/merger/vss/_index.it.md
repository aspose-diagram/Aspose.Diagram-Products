---
title: Unisci file VSS tramite Python 
weight: 230
url: /it/python-java/merger/vss/ 
description: Python codice di esempio per combinare documenti VSS all'interno di qualsiasi applicazione basata su Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Unisci formati VSS in Python" h2="Fusione di documenti VSS nativi tramite API Python lato server." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Come unire file VSS utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'unione di file VSS in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Unisci file VSS - Python" offSpacer="" %}}
