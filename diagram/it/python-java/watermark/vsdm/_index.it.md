---
title: Filigrana VSDM documento tramite Python 
weight: 3050
url: /it/python-java/watermark/vsdm/ 
description: Python codice di esempio per aggiungere filigrana a VSDM documenti all'interno di qualsiasi applicazione basata su Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Filigrana VSDM Formati in Python" h2="Filigrana di documenti VSDM nativa che utilizza API Python lato server." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Come filigranare VSDM file utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per la filigrana di VSDM file in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Filigrana VSDM File - Python" offSpacer="" %}}
