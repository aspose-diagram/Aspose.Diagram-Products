---
title: Converti VSTM in PDF tramite Python 
weight: 1960
url: /it/python-java/conversion/vstm-to-pdf/ 
description: Esempio di codice di conversione Python per il formato VSTM in file PDF. Usa questo codice di esempio per convertire VSTM in PDF all'interno di qualsiasi applicazione basata su Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converti VSTM in PDF tramite Python" h2="Esporta Microsoft Visio VSTM in PDF utilizzando Python API." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Come convertire VSTM in PDF utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per convertire VSTM in PDF tramite Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python gli sviluppatori possono convertire facilmente VSTM file in PDF in poche righe di codice.
...
{{% blocks/products/pf/agp/code-block title="VSTM in PDF Python Codice sorgente di conversione" offSpacer="" %}}
