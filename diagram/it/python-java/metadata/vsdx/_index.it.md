---
title: Visualizza o modifica VSDX metadati dei file tramite Python 
weight: 3150
url: /it/python-java/metadata/vsdx/ 
description: Python codice di esempio per modificare o visualizzare VSDX metadati all'interno di qualsiasi applicazione basata su Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Estrai VSDX metadati in Python" h2="Crea le tue Python app per aggiungere, modificare, rimuovere o estrarre metadati da VSDX file " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come estrarre VSDX metadati utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'estrazione di VSDX metadati in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Estrazione di VSDX metadati - Python" offSpacer="" %}}
