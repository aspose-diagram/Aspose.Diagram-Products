---
title: Visualizza o modifica VDX metadati dei file tramite Python 
weight: 3150
url: /it/python-java/metadata/vdx/ 
description: Python codice di esempio per modificare o visualizzare VDX metadati all'interno di qualsiasi applicazione basata su Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Estrai VDX metadati in Python" h2="Crea le tue Python app per aggiungere, modificare, rimuovere o estrarre metadati da VDX file " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Come estrarre VDX metadati utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'estrazione di VDX metadati in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Estrazione di VDX metadati - Python" offSpacer="" %}}
