...
{{% blocks/products/pf/agp/content h2="Come estrarre VSDM metadati utilizzando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Passaggi per l\'estrazione di VSDM metadati in Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Estrazione di VSDM metadati - Python" offSpacer="" %}}
