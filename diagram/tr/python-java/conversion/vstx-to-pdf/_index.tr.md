---
title: VSTX'i Python aracılığıyla PDF'ye dönüştürün 
weight: 1960
url: /tr/python-java/conversion/vstx-to-pdf/ 
description: VSTX biçiminin PDF dosyasına örnek Python dönüştürme kodu. Herhangi bir Python tabanlı uygulamada VSTX'yi PDF'ye dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTX\'i Python aracılığıyla PDF\'ye dönüştürün" h2="Python API\'lerini kullanarak Microsoft Visio VSTX\'yi PDF\'ye dışa aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSTX PDF\'ye Nasıl Dönüştürülür" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSTX\'i Python ile PDF\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Python geliştiricileri, VSTX dosyasını yalnızca birkaç kod satırıyla kolayca PDF'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSTX - PDF Python Dönüştürme Kaynak Kodu" offSpacer="" %}}
