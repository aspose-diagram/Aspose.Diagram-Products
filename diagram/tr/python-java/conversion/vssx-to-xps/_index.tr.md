---
title: VSSX'i Python aracılığıyla XPS'e dönüştürün 
weight: 1960
url: /tr/python-java/conversion/vssx-to-xps/ 
description: VSSX biçimi için örnek Python dönüştürme kodu, XPS dosyasına. Herhangi bir Python tabanlı uygulamada VSSX'yi XPS'ye dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX\'i Python aracılığıyla XPS\'e dönüştürün" h2="Python API\'lerini kullanarak Microsoft Visio VSSX\'yi XPS\'ye aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSSX\'i XPS\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSSX\'i Python ile XPS\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Python geliştiricileri, VSSX dosyasını yalnızca birkaç kod satırıyla kolayca XPS'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSSX - XPS Python Dönüşüm Kaynak Kodu" offSpacer="" %}}
