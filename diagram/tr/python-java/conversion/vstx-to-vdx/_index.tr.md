---
title: Python aracılığıyla VSTX'i VDX'ye dönüştürün 
weight: 1960
url: /tr/python-java/conversion/vstx-to-vdx/ 
description: VSTX biçimi için VDX dosyasına örnek Python dönüştürme kodu. Herhangi bir Python tabanlı uygulamada VSTX'ü VDX'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python aracılığıyla VSTX\'i VDX\'ye dönüştürün" h2="Python API\'lerini kullanarak Microsoft Visio VSTX\'yi VDX\'e aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSTX, VDX\'ye Nasıl Dönüştürülür" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python aracılığıyla VSTX\'i VDX\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Python geliştiricileri, yalnızca birkaç kod satırıyla VSTX dosyasını VDX'ye kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSTX - VDX Python Dönüşüm Kaynak Kodu" offSpacer="" %}}
