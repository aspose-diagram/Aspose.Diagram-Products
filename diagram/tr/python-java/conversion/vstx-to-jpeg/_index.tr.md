---
title: VSTX'i Python aracılığıyla JPEG'e dönüştürün 
weight: 1960
url: /tr/python-java/conversion/vstx-to-jpeg/ 
description: VSTX biçimi için örnek Python dönüştürme kodu, JPEG dosyasına. Herhangi bir Python tabanlı uygulamada VSTX'yi JPEG'e dönüştürmek için bu örnek kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTX\'i Python aracılığıyla JPEG\'e dönüştürün" h2="Python API\'lerini kullanarak Microsoft Visio VSTX dosyasını JPEG olarak dışa aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSTX\'i JPEG\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSTX\'i Python ile JPEG\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Python geliştiricileri, VSTX dosyasını yalnızca birkaç satır kodla kolayca JPEG'e dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSTX - JPEG Python Dönüştürme Kaynak Kodu" offSpacer="" %}}
