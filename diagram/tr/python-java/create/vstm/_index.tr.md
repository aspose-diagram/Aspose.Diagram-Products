---
title: Python aracılığıyla VSTM Dosya oluşturun 
url: /tr/python-java/create-vstm/ 
description: Python VSTM belge oluşturmak için örnek kod. Herhangi bir Python tabanlı uygulamada VSTM dosyası oluşturmak için bu kodu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python aracılığıyla VSTM Belgeler oluşturun" h2="Python kitaplığını kullanarak programlı olarak yerel ve yüksek performanslı VSTM (Taşınabilir Belge Biçimi) oluşturma." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="VSTM" fileiconsmall2="JPG" fileiconsmall3="HTML" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python ile VSTM Nasıl Oluşturulur" %}}
