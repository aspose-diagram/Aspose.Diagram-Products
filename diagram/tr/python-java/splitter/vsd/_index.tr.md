...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSD Dosya Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSD Dosyayı Python içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSD Dosyayı Böl - Python" offSpacer="" %}}
