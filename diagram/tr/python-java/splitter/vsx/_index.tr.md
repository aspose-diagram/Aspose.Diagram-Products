...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSX Dosya Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSX Dosyayı Python içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSX Dosyayı Böl - Python" offSpacer="" %}}
