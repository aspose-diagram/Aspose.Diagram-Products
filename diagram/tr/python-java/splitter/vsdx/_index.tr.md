...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSDX Dosya Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSDX Dosyayı Python içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX Dosyayı Böl - Python" offSpacer="" %}}
