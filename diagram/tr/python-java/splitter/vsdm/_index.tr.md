...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSDM Dosya Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSDM Dosyayı Python içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDM Dosyayı Böl - Python" offSpacer="" %}}
