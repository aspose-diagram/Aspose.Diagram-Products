...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VTX Dosya Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VTX Dosyayı Python içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VTX Dosyayı Böl - Python" offSpacer="" %}}
