...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSSM Dosya Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSSM Dosyayı Python içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSM Dosyayı Böl - Python" offSpacer="" %}}
