...
{{% blocks/products/pf/agp/content h2="Python Kullanarak VDW Dosyaları Nasıl Bölünür" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VDW Dosyalarını Python içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VDW Dosyalarını Böl - Python" offSpacer="" %}}
