...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSTM Dosya Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSTM Dosyayı Python içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM Dosyayı Böl - Python" offSpacer="" %}}
