...
{{% blocks/products/pf/agp/content h2="Python Kullanarak VST Dosyaları Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python içinde VST Dosyalarını bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VST Dosyalarını Böl - Python" offSpacer="" %}}
