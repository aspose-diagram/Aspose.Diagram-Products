...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSSX Dosya Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSSX Dosyayı Python içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX Dosyayı Böl - Python" offSpacer="" %}}
