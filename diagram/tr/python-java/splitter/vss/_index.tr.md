...
{{% blocks/products/pf/agp/content h2="Python Kullanarak VSS Dosyalarını Bölme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python içinde VSS Dosyalarını bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSS Dosyalarını Böl - Python" offSpacer="" %}}
