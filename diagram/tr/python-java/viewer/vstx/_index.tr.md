...
{{% blocks/products/pf/agp/feature-section-col title="Python üzerinden VSTX Görüntüleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTX görüntülemek için Python kodu" offSpacer="" %}}

```cs

// Diagram örneğini kullanarak VSTX dosyasını yükleyin
diagram =  Aspose.Diagram.Diagram("template.vstx");
// VSTX'i HTML biçimine dönüştürün ve ardından ortaya çıkan HTML'yi varsayılan tarayıcıya yükleyin
