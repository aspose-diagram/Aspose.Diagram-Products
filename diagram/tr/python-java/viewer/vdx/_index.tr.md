...
{{% blocks/products/pf/agp/feature-section-col title="Python üzerinden VDX Görüntüleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX görüntülemek için Python kodu" offSpacer="" %}}

```cs

// Diagram örneğini kullanarak VDX dosyasını yükleyin
diagram =  Aspose.Diagram.Diagram("template.vdx");
// VDX'i HTML biçimine dönüştürün ve ardından ortaya çıkan HTML'yi varsayılan tarayıcıya yükleyin
