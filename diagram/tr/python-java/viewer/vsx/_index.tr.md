...
{{% blocks/products/pf/agp/feature-section-col title="Python üzerinden VSX Görüntüleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSX görüntülemek için Python kodu" offSpacer="" %}}

```cs

// Diagram örneğini kullanarak VSX dosyasını yükleyin
diagram =  Aspose.Diagram.Diagram("template.vsx");
// VSX'i HTML biçimine dönüştürün ve ardından ortaya çıkan HTML'yi varsayılan tarayıcıya yükleyin
