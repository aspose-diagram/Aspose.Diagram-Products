---
title: VSDX Dosya Biçimlerini Python aracılığıyla görüntüleyin 
weight: 3480
url: /tr/python-java/viewer/vsdx/ 
description: Python tabanlı herhangi bir uygulamada VSDX belgelerini yüklemek, oluşturmak ve görüntülemek için Python kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python için VSDX Dosya Görüntüleyici" h2="Sunucu tarafı Python API\'lerini kullanan yerel VSDX belge görüntüleyici." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python üzerinden VSDX Görüntüleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX görüntülemek için Python kodu" offSpacer="" %}}

```cs

// Diagram örneğini kullanarak VSDX dosyasını yükleyin
diagram =  Aspose.Diagram.Diagram("template.vsdx");
// VSDX'i HTML biçimine dönüştürün ve ardından ortaya çıkan HTML'yi varsayılan tarayıcıya yükleyin
