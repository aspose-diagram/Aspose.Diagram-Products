...
{{% blocks/products/pf/agp/feature-section-col title="Python üzerinden VSD Görüntüleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSD görüntülemek için Python kodu" offSpacer="" %}}

```cs

// Diagram örneğini kullanarak VSD dosyasını yükleyin
diagram =  Aspose.Diagram.Diagram("template.vsd");
// VSD'i HTML biçimine dönüştürün ve ardından ortaya çıkan HTML'yi varsayılan tarayıcıya yükleyin
