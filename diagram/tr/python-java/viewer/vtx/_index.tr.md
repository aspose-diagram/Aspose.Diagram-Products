...
{{% blocks/products/pf/agp/feature-section-col title="Python üzerinden VTX Görüntüleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VTX görüntülemek için Python kodu" offSpacer="" %}}

```cs

// Diagram örneğini kullanarak VTX dosyasını yükleyin
diagram =  Aspose.Diagram.Diagram("template.vtx");
// VTX'i HTML biçimine dönüştürün ve ardından ortaya çıkan HTML'yi varsayılan tarayıcıya yükleyin
