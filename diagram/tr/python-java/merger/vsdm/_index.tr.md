...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSDM Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python İçindeki VSDM Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDM Dosyayı Birleştir - Python" offSpacer="" %}}
