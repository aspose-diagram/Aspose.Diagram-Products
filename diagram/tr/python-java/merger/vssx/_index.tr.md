...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSSX Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python İçindeki VSSX Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX Dosyayı Birleştir - Python" offSpacer="" %}}
