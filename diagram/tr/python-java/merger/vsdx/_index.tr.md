...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSDX Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python İçindeki VSDX Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX Dosyayı Birleştir - Python" offSpacer="" %}}
