...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSTM Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python İçindeki VSTM Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM Dosyayı Birleştir - Python" offSpacer="" %}}
