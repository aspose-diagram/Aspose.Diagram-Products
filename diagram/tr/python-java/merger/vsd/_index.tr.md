...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSD Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python İçindeki VSD Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSD Dosyayı Birleştir - Python" offSpacer="" %}}
