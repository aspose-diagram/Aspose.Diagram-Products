...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VDX Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python İçindeki VDX Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX Dosyayı Birleştir - Python" offSpacer="" %}}
