...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSX Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python İçindeki VSX Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSX Dosyayı Birleştir - Python" offSpacer="" %}}
