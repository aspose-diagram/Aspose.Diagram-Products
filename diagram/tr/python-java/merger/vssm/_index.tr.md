...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSSM Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python İçindeki VSSM Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSM Dosyayı Birleştir - Python" offSpacer="" %}}
