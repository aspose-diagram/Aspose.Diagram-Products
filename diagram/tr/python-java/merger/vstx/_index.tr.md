...
{{% blocks/products/pf/agp/content h2="Python Kullanılarak VSTX Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python İçindeki VSTX Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTX Dosyayı Birleştir - Python" offSpacer="" %}}
