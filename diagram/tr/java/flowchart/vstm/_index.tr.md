...
{{% blocks/products/pf/agp/content h2="Java Kullanarak VSTM Dosyasında Akış Şeması Stili Organizasyon Şeması Nasıl Oluşturulur" %}}

 VSTM dosyasında akış şeması stili organizasyon şeması oluşturmak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="VSTM Dosyalarda Java içinde Akış Şeması Stili Organizasyon Şeması Oluşturma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM Dosyalarda Akış Şeması Stili Organizasyon Şeması Oluşturun - Java" offSpacer="" %}}
