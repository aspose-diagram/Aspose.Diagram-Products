...
{{% blocks/products/pf/agp/content h2="Java Kullanarak VSDM Dosyasında Akış Şeması Stili Organizasyon Şeması Nasıl Oluşturulur" %}}

 VSDM dosyasında akış şeması stili organizasyon şeması oluşturmak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="VSDM Dosyalarda Java içinde Akış Şeması Stili Organizasyon Şeması Oluşturma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDM Dosyalarda Akış Şeması Stili Organizasyon Şeması Oluşturun - Java" offSpacer="" %}}
