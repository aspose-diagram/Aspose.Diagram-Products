---
title: VSD Dosyayı Java ile Böl
weight: 1400
url: /tr/java/splitter/vsd/ 
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment'da vsd dosyasını Bölmek için Java kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSD Biçimi Java\'ye Böl" h2="Sunucu tarafı Java API\'lerini kullanan yerel VSD belge ayırıcı." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VSD Dosya Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSD Dosyayı Java içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSD Dosyayı Böl - Java" offSpacer="" %}}
