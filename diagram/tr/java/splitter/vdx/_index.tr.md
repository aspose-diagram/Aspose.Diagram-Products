---
title: VDX Dosyayı Java ile Böl
weight: 1400
url: /tr/java/splitter/vdx/ 
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment'da vdx dosyasını Bölmek için Java kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDX Biçimi Java\'ye Böl" h2="Sunucu tarafı Java API\'lerini kullanan yerel VDX belge ayırıcı." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VDX Dosya Nasıl Bölünür?" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VDX Dosyayı Java içinde bölme adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX Dosyayı Böl - Java" offSpacer="" %}}
