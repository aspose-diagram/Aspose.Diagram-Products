...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VSDM Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java İçindeki VSDM Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDM Dosyayı Birleştir - Java" offSpacer="" %}}
