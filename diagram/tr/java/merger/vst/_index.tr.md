---
title: VST Dosyalarını Java ile Birleştir 
weight: 1440
url: /tr/java/merger/vst/ 
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment'da VST belgelerini birleştirmek için Java örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java içindeki VST Biçimlerini Birleştir" h2="Sunucu tarafı Java API\'lerini kullanan yerel VST belge birleştirme." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak VST Dosyalarını Birleştirme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java içinde VST Dosyalarını Birleştirme Adımları" %}}
...
+ İlk VST dosyasını bir Diagram sınıfı örneğiyle yükleyin.
+ İkinci VST belgesini bir Diagram sınıfı örneğiyle yükleyin.
+ Combine() yöntemini kullanarak dosyaları birleştirin.
+ birleştirilmiş VST dosyasını belirtilen yola kaydedin
...
{{% blocks/products/pf/agp/code-block title="VST Dosyalarını Birleştir - Java" offSpacer="" %}}
