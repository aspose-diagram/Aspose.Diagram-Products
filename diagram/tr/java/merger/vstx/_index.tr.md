---
title: VSTX Dosyayı Java ile Birleştir 
weight: 2430
url: /tr/java/merger/vstx/ 
description: VSTX belgelerini Java JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Çalışma Zamanı Ortamı'nda birleştirmek için Java örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java içindeki VSTX Biçimleri Birleştir" h2="Sunucu tarafı Java API\'lerini kullanan yerel VSTX belge birleştirme." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VSTX Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java İçindeki VSTX Dosyayı Birleştirme Adımları" %}}
...
+ İlk VSTX dosyasını bir Diagram sınıfı örneğiyle yükleyin.
+ İkinci VSTX belgesini bir Diagram sınıfı örneğiyle yükleyin.
+ Combine() yöntemini kullanarak dosyaları birleştirin.
+ birleştirilmiş VSTX dosyasını belirtilen yola kaydedin
...
{{% blocks/products/pf/agp/code-block title="VSTX Dosyayı Birleştir - Java" offSpacer="" %}}
