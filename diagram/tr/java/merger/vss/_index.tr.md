---
title: VSS Dosyalarını Java ile Birleştir 
weight: 1180
url: /tr/java/merger/vss/ 
description: JSP/JSF Uygulaması ve Masaüstü Uygulamaları için Java Runtime Environment'da VSS belgelerini birleştirmek için Java örnek kod.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java içindeki VSS Biçimlerini Birleştir" h2="Sunucu tarafı Java API\'lerini kullanarak yerel VSS belgesi birleştirme." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Java Kullanarak VSS Dosyalarını Birleştirme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java içinde VSS Dosyalarını Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSS Dosyalarını Birleştir - Java" offSpacer="" %}}
