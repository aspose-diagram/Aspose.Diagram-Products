...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VTX Dosya Nasıl Birleştirilir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java İçindeki VTX Dosyayı Birleştirme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VTX Dosyayı Birleştir - Java" offSpacer="" %}}
