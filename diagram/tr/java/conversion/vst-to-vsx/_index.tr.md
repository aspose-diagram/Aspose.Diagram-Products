...
{{% blocks/products/pf/agp/text %}}
 ...
 Java geliştiricileri, yalnızca birkaç kod satırıyla VST dosyasını VSX biçimine kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VST - VSX Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
