...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VSSX\'i XAML\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSSX\'i Java aracılığıyla XAML\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, VSSX dosyasını yalnızca birkaç kod satırıyla kolayca XAML'ye dönüştürebilir.
