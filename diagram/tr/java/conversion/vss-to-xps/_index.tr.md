...
{{% blocks/products/pf/agp/content h2="Java Kullanarak VSS\'yi XPS\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla VSS\'yi XPS\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla VSS dosyasını kolayca XPS'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSS\'den XPS\'ye Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
