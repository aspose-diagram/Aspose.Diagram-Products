...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VSSX, VSDM\'ye Nasıl Dönüştürülür" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java geliştiricileri, yalnızca birkaç kod satırıyla VSSX dosyasını VSDM'ye kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSSX - VSDM Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
