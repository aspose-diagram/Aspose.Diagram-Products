...
{{% blocks/products/pf/agp/content h2="Java Kullanarak VSTX\'i PDF\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSTX\'i Java aracılığıyla PDF\'ye Dönüştürme Adımları" %}}
...
1. VSTX dosyasını bir Diagram sınıfı örneğiyle yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat ile Diagram.save yöntemini çağırın1. PDF dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="VSTX\'ten PDF\'ye Java Dönüştürme Kaynak Kodu" offSpacer="" %}}
