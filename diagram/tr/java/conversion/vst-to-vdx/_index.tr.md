...
{{% blocks/products/pf/agp/text %}}
 ...
 Java geliştiricileri, yalnızca birkaç kod satırıyla VST dosyasını VDX biçimine kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VST - VDX Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
