...
{{% blocks/products/pf/agp/text %}}
 ...
 Java geliştiricileri, yalnızca birkaç kod satırıyla VST dosyasını VSSX biçimine kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VST - VSSX Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
