...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VSSM, VSX\'ye Nasıl Dönüştürülür" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla VSSM\'i VSX\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla VSSM dosyasını VSX'ye kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSSM - VSX Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
