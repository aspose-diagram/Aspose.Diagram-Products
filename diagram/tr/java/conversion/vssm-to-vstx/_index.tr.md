...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VSSM, VSTX\'ye Nasıl Dönüştürülür" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla VSSM\'i VSTX\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla VSSM dosyasını VSTX'ye kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSSM - VSTX Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
