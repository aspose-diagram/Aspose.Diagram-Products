...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VSSX, VSTX\'ye Nasıl Dönüştürülür" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla VSSX\'i VSTX\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla VSSX dosyasını VSTX'ye kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSSX - VSTX Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
