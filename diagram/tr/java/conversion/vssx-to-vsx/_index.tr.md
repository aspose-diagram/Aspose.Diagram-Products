...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VSSX, VSX\'ye Nasıl Dönüştürülür" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java aracılığıyla VSSX\'i VSX\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Java geliştiricileri, yalnızca birkaç kod satırıyla VSSX dosyasını VSX'ye kolayca dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSSX - VSX Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
