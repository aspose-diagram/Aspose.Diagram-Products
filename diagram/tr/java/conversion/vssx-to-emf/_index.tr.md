...
{{% blocks/products/pf/agp/content h2="Java Kullanılarak VSSX\'i EMF\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java geliştiricileri, VSSX dosyasını yalnızca birkaç satır kodla kolayca EMF'ye dönüştürebilir.
...
{{% blocks/products/pf/agp/code-block title="VSSX - EMF Java Dönüşüm Kaynak Kodu" offSpacer="" %}}
