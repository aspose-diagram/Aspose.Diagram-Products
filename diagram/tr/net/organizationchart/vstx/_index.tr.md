...
{{% blocks/products/pf/agp/feature-section-col title="C# Dosyasında VSTX Dosyalarda Organizasyon Şeması Oluşturma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTX Dosyalarda Organizasyon Şeması Oluşturun - C#" offSpacer="" %}}
