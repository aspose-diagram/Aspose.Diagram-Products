---
title: .NET aracılığıyla VSDX belgesinin kilidini açın 
weight: 5680
url: /tr/net/unlock/vsdx/ 
description: .NET Framework, .NET Core, Mono Platformlarında VSDX dosyasının kilidini açmak için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# üzerinden VSDX Dosyanın Kilidini Açın" h2=".NET Kitaplığı\'nı kullanarak VSDX biçimi dahil Visio üzerindeki korumayı kaldırın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSDX Dosyasının Kilidini Açma" %}}

 VSDX dosyasının kilidini açmak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# İçinde VSDX Dosyanın Kilidini Açma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX Dosyanın Kilidini Aç - C#" offSpacer="" %}}
