...
description: VSSX'ten VSDM'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VSSX dosyalarını VSDM'ye dönüştürmek için API örnek kodunu kullanın.
---
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSSX\'i VSDM\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET geliştiricileri, yalnızca birkaç kod satırıyla VSSX dosyalarını kolayca yükleyebilir ve VSDM'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSSX dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VSDM ile Diagram.Save yöntemini çağırın1. VSDM dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VSSX\'ten VSDM\'ye C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSX\'i VSDM\'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSSX\'ten VSDM\'ye dönüştürme](https://products.aspose.app/diagram/conversion/vssx-to-vsdm) aşağıdaki faydaları ile." >}}
