---
title: C# aracılığıyla VSD'i VTX'ye dönüştürün 
weight: 4870
url: /tr/net/conversion/vsd-to-vtx/ 
description: VSD - VTX C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VSD dosyaları VTX dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla VSD\'i VTX\'ye dönüştürün" h2="Microsoft® Visio VSD dosyalarını .NET Framework, .NET Core, Mono veya COM Interop\'ta VTX\'e aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak VSD, VTX\'ye Nasıl Dönüştürülür" %}}

 VSD'i VTX'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla VSD\'i VTX\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, VSD dosyalarını yalnızca birkaç kod satırıyla kolayca yükleyebilir ve VTX'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSD dosyasını yükleyin1. Diagram.Save yöntemini çıktı dosyası yolu ve SaveFileFormat.VTX ile parametre olarak çağırın1. VTX dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VSD - VTX C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD\'i VTX\'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSD - VTX dönüşüm](https://products.aspose.app/diagram/conversion/vsd-to-vtx) aşağıdaki faydaları ile." >}}
