---
title: C# aracılığıyla VSSX'i VDX'e dönüştürün 
weight: 90
url: /tr/net/conversion/vssx-to-vdx/ 
description: VSSX'ten VDX'e C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VSSX dosyalarını VDX'e dönüştürmek için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla VSSX\'i VDX\'e dönüştürün" h2="Microsoft® Visio VSSX dosyalarını .NET Framework, .NET Core, Mono veya COM Interop üzerinde VDX\'e aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSSX\'i VDX\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla VSSX\'i VDX\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, yalnızca birkaç kod satırıyla VSSX dosyalarını kolayca yükleyebilir ve VDX'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSSX dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VDX ile Diagram.Save yöntemini çağırın1. VDX dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VSSX\'ten VDX\'e C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSX\'i VDX\'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSSX\'ten VDX\'e dönüştürme](https://products.aspose.app/diagram/conversion/vssx-to-vdx) aşağıdaki faydaları ile." >}}
