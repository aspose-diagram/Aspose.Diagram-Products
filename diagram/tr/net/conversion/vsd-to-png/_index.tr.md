---
title: VSD'i C# aracılığıyla PNG'ye dönüştürün 
weight: 1850
url: /tr/net/conversion/vsd-to-png/ 
description: VSD - PNG C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu iş VSD dosyalarını PNG'ye dönüştürmek için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSD\'i C# aracılığıyla PNG\'ye dönüştürün" h2="Microsoft® Visio VSD dosyalarını .NET Framework, .NET Core, Mono veya COM Interop\'ta PNG\'ye aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PNG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak VSD\'i PNG\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla VSD\'i PNG\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, VSD dosyalarını yalnızca birkaç satır kodla kolayca yükleyebilir ve PNG'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSD dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.PNG ile Diagram.Save yöntemini çağırın1. PNG dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VSD\'den PNG\'ye C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD\'i PNG\'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSD\'den PNG\'ye dönüştürme](https://products.aspose.app/diagram/conversion/vsd-to-png) aşağıdaki faydaları ile." >}}
