---
title: C# aracılığıyla VSD'i VSX'ye dönüştürün 
weight: 520
url: /tr/net/conversion/vsd-to-vsx/ 
description: VSD - VSX C# dönüşümü için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VSD dosyaları VSX dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla VSD\'i VSX\'ye dönüştürün" h2="Microsoft® Visio VSD dosyalarını .NET Framework, .NET Core, Mono veya COM Interop\'ta VSX\'e aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak VSD, VSX\'ye Nasıl Dönüştürülür" %}}

 VSD'i VSX'ye dönüştürmek için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla VSD\'i VSX\'ye Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, VSD dosyalarını yalnızca birkaç kod satırıyla kolayca yükleyebilir ve VSX'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSD dosyasını yükleyin1. Diagram.Save yöntemini çıktı dosyası yolu ve SaveFileFormat.VSX ile parametre olarak çağırın1. VSX dosyası belirtilen yola kaydedilecek
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSD\'i VSX\'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSD - VSX dönüşüm](https://products.aspose.app/diagram/conversion/vsd-to-vsx) aşağıdaki faydaları ile." >}}
