...
description: VSSX'ten VSSM'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VSSX dosyalarından VSSM'ye dönüştürme için API örnek kodunu kullanın.
---
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSSX\'i VSSM\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET geliştiricileri, yalnızca birkaç kod satırıyla VSSX dosyalarını kolayca yükleyebilir ve VSSM'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSSX dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VSSM ile Diagram.Save yöntemini çağırın1. VSSM dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VSSX\'ten VSSM\'ye C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSX\'i VSSM\'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSSX\'ten VSSM\'ye dönüştürme](https://products.aspose.app/diagram/conversion/vssx-to-vssm) aşağıdaki faydaları ile." >}}
