---
title: C# aracılığıyla VTX'i VSTX'e dönüştürün 
weight: 1250
url: /tr/net/conversion/vtx-to-vstx/ 
description: VTX'ten VSTX'e C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VTX dosyalarından VSTX'e dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla VTX\'i VSTX\'e dönüştürün" h2="Microsoft® Visio VTX dosyalarını .NET Framework, .NET Core, Mono veya COM Interop üzerinde VSTX\'e aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VTX\'i VSTX\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# üzerinden VTX\'i VSTX\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, yalnızca birkaç kod satırıyla VTX dosyalarını kolayca yükleyebilir ve VSTX'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VTX dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VSTX ile Diagram.Save yöntemini çağırın1. VSTX dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VTX\'ten VSTX\'e C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VTX\'i VSTX\'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VTX\'ten VSTX\'e dönüştürme](https://products.aspose.app/diagram/conversion/vtx-to-vstx) aşağıdaki faydaları ile." >}}
