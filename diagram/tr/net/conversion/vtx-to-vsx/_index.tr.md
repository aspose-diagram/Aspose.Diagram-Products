---
title: C# aracılığıyla VTX'i VSX'e dönüştürün 
weight: 4160
url: /tr/net/conversion/vtx-to-vsx/ 
description: VTX'ten VSX'e C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VTX dosyalarının VSX'e dönüştürülmesi için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla VTX\'i VSX\'e dönüştürün" h2="Microsoft® Visio VTX dosyalarını .NET Framework, .NET Core, Mono veya COM Interop üzerinde VSX\'e aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VTX\'i VSX\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# aracılığıyla VTX\'i VSX\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, yalnızca birkaç kod satırıyla VTX dosyalarını kolayca yükleyebilir ve VSX'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VTX dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VSX ile Diagram.Save yöntemini çağırın1. VSX dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VTX\'ten VSX\'e C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VTX\'i VSX\'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VTX\'ten VSX\'e dönüştürme](https://products.aspose.app/diagram/conversion/vtx-to-vsx) aşağıdaki faydaları ile." >}}
