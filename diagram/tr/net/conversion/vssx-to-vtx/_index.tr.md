---
title: C# aracılığıyla VSSX'i VTX'e dönüştürün 
weight: 1730
url: /tr/net/conversion/vssx-to-vtx/ 
description: VSSX'ten VTX'e C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VSSX dosyalarını VTX'e dönüştürme için API örnek kodunu kullanın.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# aracılığıyla VSSX\'i VTX\'e dönüştürün" h2="Microsoft® Visio VSSX dosyalarını .NET Framework, .NET Core, Mono veya COM Interop üzerinde VTX\'e aktarın." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSSX\'i VTX\'e Dönüştürme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# üzerinden VSSX\'i VTX\'e Dönüştürme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 .NET geliştiricileri, yalnızca birkaç satır kodla VSSX dosyalarını kolayca yükleyebilir ve VTX'e dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSSX dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VTX ile Diagram.Save yöntemini çağırın1. VTX dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VSSX\'ten VTX\'e C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSX\'i VTX\'e Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSSX\'ten VTX\'e dönüştürme](https://products.aspose.app/diagram/conversion/vssx-to-vtx) aşağıdaki faydaları ile." >}}
