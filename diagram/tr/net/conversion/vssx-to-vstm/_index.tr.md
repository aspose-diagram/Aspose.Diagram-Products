...
description: VSSX'ten VSTM'ye C# dönüştürme için örnek kod. VB.NET, Asp.NET veya herhangi bir .NET tabanlı uygulama içinde toplu VSSX dosyalarını VSTM'ye dönüştürmek için API örnek kodunu kullanın.
---
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSSX\'i VSTM\'ye Dönüştürme" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET geliştiricileri, yalnızca birkaç kod satırıyla VSSX dosyalarını kolayca yükleyebilir ve VSTM'ye dönüştürebilir.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSSX dosyasını yükleyin1. Çıktı dosyası yolu ve parametre olarak SaveFileFormat.VSTM ile Diagram.Save yöntemini çağırın1. VSTM dosyası belirtilen yola kaydedilecek
...
{{% blocks/products/pf/agp/code-block title="Bu örnek kod, VSSX\'ten VSTM\'ye C# Dönüşümünü gösterir" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSX\'i VSTM\'ye Dönüştürmek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSSX\'ten VSTM\'ye dönüştürme](https://products.aspose.app/diagram/conversion/vssx-to-vstm) aşağıdaki faydaları ile." >}}
