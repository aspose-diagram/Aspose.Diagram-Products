...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak VDX Dosyası Nasıl Sıkıştırılır" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# İçinde VDX Dosyayı Sıkıştırma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VDX Dosyayı Sıkıştır - C#" offSpacer="" %}}
