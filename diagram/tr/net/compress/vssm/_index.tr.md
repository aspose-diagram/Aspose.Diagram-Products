...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak VSSM Dosyası Nasıl Sıkıştırılır" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# İçinde VSSM Dosyayı Sıkıştırma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSM Dosyayı Sıkıştır - C#" offSpacer="" %}}
