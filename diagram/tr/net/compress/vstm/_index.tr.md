---
title: VSTM belgesini .NET aracılığıyla sıkıştır 
weight: 3050
url: /tr/net/compress/vstm/ 
description: .NET Framework, .NET Core, Mono Platformlarında vstm dosyasını sıkıştırmak için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM\'yi C# içinde sıkıştır" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Diagram for .NET API\'lerini kullanan yerel ve yüksek performanslı VSTM belge sıkıştırıcı." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak VSTM Dosyası Nasıl Sıkıştırılır" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM Dosyalarını Sıkıştır - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram, bir Microsoft Visio belge biçimi düzenlemesidir API. Daigram öğeleri dahil olmak üzere kolayca yükleyebilir, oluşturabilir, değiştirebilir, işleyebilir ve Visio diyagramlarını PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF ve daha fazlası gibi diğer biçimlere dönüştürebilirsiniz. Bağımsız bir API'dir ve Microsoft Visio veya başka bir yazılımın yüklenmesini gerektirmez.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi VSTM Sıkıştırma Canlı Demoları" sectionDescription="VST belgelerini şu anda ziyaret ederek sıkıştırın: [Canlı Demolar web sitesi](https://products.aspose.app/diagram/compress). Canlı demo aşağıdaki avantajlara sahiptir" >}}
