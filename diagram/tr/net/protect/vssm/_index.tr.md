---
title: VSSM belgesini .NET aracılığıyla koruyun ve kilitleyin 
weight: 5580
url: /tr/net/protect/vssm/ 
description: .NET Framework, .NET Core, Mono Platformlarında VSSM dosyasını kilitlemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSM Dosyayı C# aracılığıyla koruyun" h2=".NET Kitaplığı\'nı kullanarak VSSM biçimi dahil Visio\'i koruyun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSSM Dosyasını Nasıl Koruyabilirsiniz?" %}}

 VSSM dosyasını korumak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# İçindeki VSSM Dosyayı Koruma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSM Dosyayı Koru - C#" offSpacer="" %}}
