---
title: VSTM belgesini .NET aracılığıyla koruyun ve kilitleyin 
weight: 5580
url: /tr/net/protect/vstm/ 
description: .NET Framework, .NET Core, Mono Platformlarında VSTM dosyasını kilitlemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM Dosyayı C# aracılığıyla koruyun" h2=".NET Kitaplığı\'nı kullanarak VSTM biçimi dahil Visio\'i koruyun." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VDW Dosyası Nasıl Korunur" %}}
 ...
 VSTM dosyasını korumak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# İçindeki VSTM Dosyayı Koruma Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM Dosyayı Koru - C#" offSpacer="" %}}
