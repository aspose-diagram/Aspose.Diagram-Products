---
title: VSX Dosya Biçimlerini .NET aracılığıyla görüntüleyin 
weight: 1720
url: /tr/net/viewer/vsx/ 
description: .NET Framework, .NET Core, Mono veya COM Interop'ta VSX dokümanı yüklemek, oluşturmak ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSX Dosya Görüntüleyici for .NET" h2="Microsoft Visio VSX dosyalarını Visio uygulama veya Office Otomasyon gerektirmeden tarayıcıda görüntüleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# üzerinden VSX Görüntüleme Adımları" %}}
...
1. Diagram sınıfının bir örneğiyle VSX dosyasını yükleyin1. Parametre olarak SaveFileFormat.HTML ile Diagram.Save yöntemini çağırın1. Elde edilen HTML'yi Process.Start aracılığıyla varsayılan tarayıcıya yükleyin
...
{{% blocks/products/pf/agp/code-block title="VSX görüntülemek için C# kodu" offSpacer="" %}}

```cs

// Diagram örneğini kullanarak VSX dosyasını yükleyin
var diagram = new Aspose.Diagram.Diagram("template.vsx");
// VSX'i HTML biçimine dönüştür
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram, bir Microsoft Visio belge biçimi düzenlemesidir API. Daigram öğeleri dahil olmak üzere kolayca yükleyebilir, oluşturabilir, değiştirebilir, işleyebilir ve Visio diyagramlarını PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF ve daha fazlası gibi diğer biçimlere dönüştürebilirsiniz. Bağımsız bir API'dir ve Microsoft Visio veya başka bir yazılımın yüklenmesini gerektirmez.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Görüntülemek için Ücretsiz Uygulama VSX" sectionDescription="için canlı demolarımızı kontrol edin [VSX görüntüle](https://products.aspose.app/diagram/viewer/vsx) aşağıdaki faydaları ile." >}}
