---
title: VSS Dosya Biçimlerini .NET aracılığıyla görüntüleyin 
weight: 3190
url: /tr/net/viewer/vss/ 
description: .NET Framework, .NET Core, Mono veya COM Interop üzerinde VSS belgelerini yüklemek, oluşturmak ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSS Dosya Görüntüleyici for .NET" h2="Visio uygulaması veya Office Otomasyonu gerektirmeden Microsoft Visio VSS dosyalarını tarayıcıda görüntüleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSS" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak VSS Dosyası Nasıl Görüntülenir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# üzerinden VSS\'yi Görüntüleme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Diagram, geliştiricilerin VSS dosyasını yalnızca birkaç satır kodla görüntülemesini kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

1. Diagram sınıfının bir örneğiyle VSS dosyasını yükleyin1. Parametre olarak SaveFileFormat.HTML ile Diagram.Save yöntemini çağırın1. Elde edilen HTML'yi Process.Start aracılığıyla varsayılan tarayıcıya yükleyin
...
{{% blocks/products/pf/agp/code-block title="VSS\'yi görüntülemek için C# kodu" offSpacer="" %}}

```cs

// bir Diagram örneği aracılığıyla VSS dosyasını yükleyin
var diagram = new Aspose.Diagram.Diagram("template.vss");
// VSS'yi HTML formatına dönüştür
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram, bir Microsoft Visio belge biçimi düzenlemesidir API. Daigram öğeleri dahil olmak üzere kolayca yükleyebilir, oluşturabilir, değiştirebilir, işleyebilir ve Visio diyagramlarını PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF ve daha fazlası gibi diğer biçimlere dönüştürebilirsiniz. Bağımsız bir API'dir ve Microsoft Visio veya başka bir yazılımın yüklenmesini gerektirmez.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="VSS\'yi Görüntülemek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSS\'yi görüntüle](https://products.aspose.app/diagram/viewer/vss) aşağıdaki faydaları ile." >}}
