---
title: VSSM Dosya Biçimlerini .NET üzerinden görüntüleyin 
weight: 3180
url: /tr/net/viewer/vssm/ 
description: .NET Framework, .NET Core, Mono veya COM Interop üzerinde VSSM belgelerini yüklemek, oluşturmak ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSM Dosya Görüntüleyici for .NET" h2="Visio uygulaması veya Office Otomasyonu gerektirmeden Microsoft Visio VSSM dosyalarını tarayıcıda görüntüleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanılarak VSSM Dosyası Nasıl Görüntülenir" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VSSM\'yi C# üzerinden Görüntüleme Adımları" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Diagram, geliştiricilerin VSSM dosyasını yalnızca birkaç satır kodla görüntülemesini kolaylaştırır.

{{% /blocks/products/pf/agp/text %}}

1. VSSM dosyasını bir Diagram sınıfı örneğiyle yükleyin1. Parametre olarak SaveFileFormat.HTML ile Diagram.Save yöntemini çağırın1. Elde edilen HTML'yi Process.Start aracılığıyla varsayılan tarayıcıya yükleyin
...
{{% blocks/products/pf/agp/code-block title="VSSM\'yi görüntülemek için C# kodu" offSpacer="" %}}

```cs

// VSSM dosyasını bir Diagram örneği aracılığıyla yükleyin
var diagram = new Aspose.Diagram.Diagram("template.vssm");
// VSSM'yi HTML formatına dönüştür
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram, bir Microsoft Visio belge biçimi düzenlemesidir API. Daigram öğeleri dahil olmak üzere kolayca yükleyebilir, oluşturabilir, değiştirebilir, işleyebilir ve Visio diyagramlarını PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF ve daha fazlası gibi diğer biçimlere dönüştürebilirsiniz. Bağımsız bir API'dir ve Microsoft Visio veya başka bir yazılımın yüklenmesini gerektirmez.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="VSSM\'yi Görüntülemek için Ücretsiz Uygulama" sectionDescription="için canlı demolarımızı kontrol edin [VSSM\'yi Görüntüle](https://products.aspose.app/diagram/viewer/vssm) aşağıdaki faydaları ile." >}}
