---
title: VSTM Dosya Biçimlerini .NET aracılığıyla görüntüleyin 
weight: 2230
url: /tr/net/viewer/vstm/ 
description: .NET Framework, .NET Core, Mono veya COM Interop'ta VSTM dokümanı yüklemek, oluşturmak ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM Dosya Görüntüleyici for .NET" h2="Microsoft Visio VSTM dosyalarını Visio uygulama veya Office Otomasyon gerektirmeden tarayıcıda görüntüleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# üzerinden VSTM Görüntüleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM görüntülemek için C# kodu" offSpacer="" %}}

```cs

// Diagram örneğini kullanarak VSTM dosyasını yükleyin
var diagram = new Aspose.Diagram.Diagram("template.vstm");
// VSTM'i HTML biçimine dönüştür
