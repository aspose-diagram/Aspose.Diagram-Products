---
title: VSTX Dosya Biçimlerini .NET aracılığıyla görüntüleyin 
weight: 3560
url: /tr/net/viewer/vstx/ 
description: .NET Framework, .NET Core, Mono veya COM Interop'ta VSTX dokümanı yüklemek, oluşturmak ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTX Dosya Görüntüleyici for .NET" h2="Microsoft Visio VSTX dosyalarını Visio uygulama veya Office Otomasyon gerektirmeden tarayıcıda görüntüleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# üzerinden VSTX Görüntüleme Adımları" %}}
...
1. Diagram sınıfının bir örneğiyle VSTX dosyasını yükleyin1. Parametre olarak SaveFileFormat.HTML ile Diagram.Save yöntemini çağırın1. Elde edilen HTML'yi Process.Start aracılığıyla varsayılan tarayıcıya yükleyin
...
{{% blocks/products/pf/agp/code-block title="VSTX görüntülemek için C# kodu" offSpacer="" %}}

```cs

// Diagram örneğini kullanarak VSTX dosyasını yükleyin
var diagram = new Aspose.Diagram.Diagram("template.vstx");
// VSTX'i HTML biçimine dönüştür
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram, bir Microsoft Visio belge biçimi düzenlemesidir API. Daigram öğeleri dahil olmak üzere kolayca yükleyebilir, oluşturabilir, değiştirebilir, işleyebilir ve Visio diyagramlarını PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF ve daha fazlası gibi diğer biçimlere dönüştürebilirsiniz. Bağımsız bir API'dir ve Microsoft Visio veya başka bir yazılımın yüklenmesini gerektirmez.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Görüntülemek için Ücretsiz Uygulama VSTX" sectionDescription="için canlı demolarımızı kontrol edin [VSTX görüntüle](https://products.aspose.app/diagram/viewer/vstx) aşağıdaki faydaları ile." >}}
