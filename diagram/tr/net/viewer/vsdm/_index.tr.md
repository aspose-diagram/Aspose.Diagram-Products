---
title: VSDM Dosya Biçimlerini .NET aracılığıyla görüntüleyin 
weight: 1210
url: /tr/net/viewer/vsdm/ 
description: .NET Framework, .NET Core, Mono veya COM Interop'ta VSDM dokümanı yüklemek, oluşturmak ve görüntülemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDM Dosya Görüntüleyici for .NET" h2="Microsoft Visio VSDM dosyalarını Visio uygulama veya Office Otomasyon gerektirmeden tarayıcıda görüntüleyin." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# üzerinden VSDM Görüntüleme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDM görüntülemek için C# kodu" offSpacer="" %}}

```cs

// Diagram örneğini kullanarak VSDM dosyasını yükleyin
var diagram = new Aspose.Diagram.Diagram("template.vsdm");
// VSDM'i HTML biçimine dönüştür
