---
title: VSTM belgesini .NET aracılığıyla filigranla 
weight: 3050
url: /tr/net/watermark/vstm/ 
description: .NET Framework, .NET Core, Mono Platformlarında vstm dosyasına filigran eklemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# içinde VSTM öğesine Metin Filigranı ekleyin" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Diagram for .NET API\'lerini kullanan yerel ve yüksek performanslı VSTM belge filigranı." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSTM Dosyasını Filigran Etme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# İçindeki VSTM Dosyayı Filigran Etme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="Filigran VSTM Dosyaları - C#" offSpacer="" %}}
