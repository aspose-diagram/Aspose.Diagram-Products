---
title: .NET aracılığıyla VSSM belgesini filigranla 
weight: 3050
url: /tr/net/watermark/vssm/ 
description: .NET Framework, .NET Core, Mono Platformlarında vssm dosyasına filigran eklemek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C# içinde VSSM\'ye Metin Filigranı Ekle" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Diagram for .NET API\'lerini kullanan yerel ve yüksek performanslı VSSM belge filigranı." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSSM Dosyasını Filigran Etme" %}}

 VSSM dosyasını filigranlamak için kullanacağız
...
{{% blocks/products/pf/agp/feature-section-col title="C# içinde VSSM Dosyalarını Filigranlama Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="Filigran VSSM Dosyaları - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram, bir Microsoft Visio belge biçimi düzenlemesidir API. Daigram öğeleri dahil olmak üzere kolayca yükleyebilir, oluşturabilir, değiştirebilir, işleyebilir ve Visio diyagramlarını PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF ve daha fazlası gibi diğer biçimlere dönüştürebilirsiniz. Bağımsız bir API'dir ve Microsoft Visio veya başka bir yazılımın yüklenmesini gerektirmez.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi VSSM Filigran Canlı Demoları" sectionDescription="WaterMark VSSM belgelerini şu anda ziyaret ederek [Canlı Demolar web sitesi](https://products.aspose.app/diagram/watermark). Canlı demo aşağıdaki avantajlara sahiptir" >}}
