---
title: VSSX Dosyalarını .NET ile Böl 
weight: 1300
url: /tr/net/splitter/vssx/ 
description: .NET Framework, .NET Core, Mono Platformlarında Böl vssx dosyasına C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSSX\'i C# içinde böl" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan sunucu tarafı Aspose.Diagram for .NET API\'lerini kullanan yerel ve yüksek performanslı VSSX belge ayırıcı." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VSSX Dosyasını Bölme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# İçinde VSSX Dosyalarını Bölme Adımları" %}}
...
+ VSSX dosyasını bölme için tam yol ile yükleyin.
...
{{% blocks/products/pf/agp/code-block title="VSSX Dosyalarını Böl - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram, bir Microsoft Visio belge biçimi düzenlemesidir API. Daigram öğeleri dahil olmak üzere kolayca yükleyebilir, oluşturabilir, değiştirebilir, işleyebilir ve Visio diyagramlarını PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF ve daha fazlası gibi diğer biçimlere dönüştürebilirsiniz. Bağımsız bir API'dir ve Microsoft Visio veya başka bir yazılımın yüklenmesini gerektirmez.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Çevrimiçi VSSX Bölünmüş Canlı Demolar" sectionDescription="VSSX belgelerini şu anda ziyaret ederek bölün [Canlı Demolar web sitesi](https://products.aspose.app/diagram/splitter). Canlı demo aşağıdaki avantajlara sahiptir" >}}
