---
title: VTX Dosyayı .NET ile Böl 
weight: 1300
url: /tr/net/splitter/vtx/ 
description: .NET Framework, .NET Core, Mono Platformlarında vtx dosyasını Bölmek için C# kaynak kodu.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VTX\'i C#\'ye böl" h2="Microsoft veya Open Office, Adobe PDF gibi herhangi bir yazılım kullanmadan, sunucu tarafı Aspose.Diagram for .NET API\'lerini kullanan yerel ve yüksek performanslı VTX belge ayırıcı." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C# Kullanarak VTX Dosyasını Bölme" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="VTX Dosyayı C# İçinde Bölme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VTX Dosyayı Böl - C#" offSpacer="" %}}
