---
title: VSTM Dosyayı .NET ile Böl 
weight: 1300
...
{{% blocks/products/pf/agp/feature-section-col title="VSTM Dosyayı C# İçinde Bölme Adımları" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM Dosyayı Böl - C#" offSpacer="" %}}
