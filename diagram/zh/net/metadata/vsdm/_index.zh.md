...
description: C# 用于在 .NET 框架、.NET 核心、Mono 平台上编辑或查看 VSDM 格式元数据的源代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 C# 中提取 VSDM 元数据" h2="构建您自己的 .NET 应用，以使用服务器端 API 添加、编辑、删除或提取 VSDM 文件中的元数据。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C# 中提取 VSDM 元数据的步骤" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram 是 Microsoft Visio 文档格式操作 API。您可以轻松加载、创建、修改、操作包括图形元素在内的 Visio 图表转换为其他格式，例如 PDF、XPS、JPEG、PNG、BMP、TIFF、SVG、EMF 等。它是独立的 API，不需要安装 Microsoft Visio 或任何其他软件。  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="通过在线应用程序提取 VSDM 的元数据" sectionDescription="通过访问我们的查看和编辑元数据到 VSDM 文档 [现场演示网站](https://products.aspose.app/diagram/metadata).现场演示有以下好处" >}}
