...
description: VSSX 到 VSDX C# 转换的示例代码。在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中使用 API 示例代码批量 VSSX 文件到 VSDX 转换。
---
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VSSX 到 VSDX C# 的转换" offSpacer="" %}}
