---
title: 通过 C# 将 VSX 转换为 EMF 
weight: 3520
url: /zh/net/conversion/vsx-to-emf/ 
description: VSX 到 EMF C# 转换的示例代码。在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中使用 API 示例代码将批处理 VSX 文件转换为 EMF。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 C# 将 VSX 转换为 EMF" h2="将 Microsoft® Visio VSX 文件导出到 .NET Framework、.NET Core、Mono 或 COM Interop 上的 EMF。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 VSX 转换为 EMF" %}}

 为了将 VSX 转换为 EMF，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 VSX 转换为 EMF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 开发人员只需几行代码即可轻松加载 VSX 文件并将其转换为 EMF。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Diagram 类的实例加载 VSX 文件1. 以输出文件路径和 SaveFileFormat.EMF 作为参数调用 Diagram.Save 方法1. EMF 文件将保存在指定路径
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VSX 到 EMF C# 的转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="将 VSX 转换为 EMF 的免费应用程序" sectionDescription="查看我们的现场演示 [VSX 到 EMF 的转换](https://products.aspose.app/diagram/conversion/vsx-to-emf) 具有以下好处。" >}}
