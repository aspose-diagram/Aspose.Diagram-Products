...
{{% blocks/products/pf/agp/content h2="如何使用 C# 将 VSD 转换为 VSDM" %}}

 为了将 VSD 转换为 VSDM，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 C# 将 VSD 转换为 VSDM 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 开发人员只需几行代码即可轻松加载 VSD 文件并将其转换为 VSDM。

{{% /blocks/products/pf/agp/text %}}

1. 使用 Diagram 类的实例加载 VSD 文件1. 以输出文件路径和 SaveFileFormat.VSDM 作为参数调用 Diagram.Save 方法1. VSDM 文件将保存在指定路径
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VSD 到 VSDM C# 的转换" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="将 VSD 转换为 VSDM 的免费应用程序" sectionDescription="查看我们的现场演示 [VSD 到 VSDM 的转换](https://products.aspose.app/diagram/conversion/vsd-to-vsdm) 具有以下好处。" >}}
