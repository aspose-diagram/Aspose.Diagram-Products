...
description: VSX 到 VSDX C# 转换的示例代码。使用 API 示例代码将 VSX 文件批量转换为 VSDX 在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中的转换。
---
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VSX 到 VSDX C# 的转换" offSpacer="" %}}
