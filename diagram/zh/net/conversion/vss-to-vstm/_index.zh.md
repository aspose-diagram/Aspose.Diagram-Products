...
description: VSS 到 VSTM C# 转换的示例代码。在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中使用 API 示例代码将 VSS 文件批量转换为 VSTM。
---
...
1. 使用 Diagram 类的实例加载 VSS 文件1. 使用输出文件路径和 SaveFileFormat.VSTM 作为参数调用 Diagram.Save 方法1. VSTM 文件将保存在指定路径
