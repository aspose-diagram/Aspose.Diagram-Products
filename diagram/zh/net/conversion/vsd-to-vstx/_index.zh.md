...
description: VSD 到 VSTX C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 VSD 文件批量转换为 VSTX。
---
...
1. 使用 Diagram 类的实例加载 VSD 文件1. 使用输出文件路径和 SaveFileFormat.VSTX 作为参数调用 Diagram.Save 方法1. VSTX 文件将保存在指定路径
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VSD 到 VSTX C# 转换" offSpacer="" %}}
