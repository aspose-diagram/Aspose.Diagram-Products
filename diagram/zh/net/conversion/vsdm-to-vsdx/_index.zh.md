...
description: VSDM 到 VSDX C# 转换的示例代码。使用 API 示例代码在 VB.NET、Asp.NET 或任何基于 .NET 的应用程序中将 VSDM 文件批量转换为 VSDX。
---
...
{{% blocks/products/pf/agp/code-block title="此示例代码显示 VSDM 到 VSDX C# 转换" offSpacer="" %}}
