---
title: 通过 C# 从 VST 添加、编辑和删除注释 
weight: 3050
url: /zh/net/annotation/vst/ 
description: C# 用于在 .NET Framework、.NET Core、Mono 平台上注释 VST 文件的源代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="如何使用 C# 注释 VST 文件" h2="使用服务器端 Aspose.Diagram for .NET API 的本机和高性能 VST 文档注释，无需使用任何软件，如 Microsoft 或 Open Office、Adobe PDF。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 C# 注释 VST 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 C# 中注释 VST 文件的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="从 VST 文件中删除评论 - C#" offSpacer="" %}}
