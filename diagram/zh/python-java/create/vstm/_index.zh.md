---
title: 通过 Python 创建 VSTM 个文件 
url: /zh/python-java/create-vstm/ 
description: Python 用于生成 VSTM 文档的示例代码。使用此代码在任何基于 Python 的应用程序中创建 VSTM 文件。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Python 创建 VSTM 文档" h2="使用 Python 库以编程方式创建本机和高性能 VSTM（便携式文档格式）。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="VSTM" fileiconsmall2="JPG" fileiconsmall3="HTML" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="如何通过 Python 创建 VSTM" %}}

{{% blocks/products/pf/agp/text %}}

 开发人员只需几行代码即可在运行不同的报告应用程序中轻松创建、加载、修改和转换 VSTM（便携式文档格式）以进行数据处理。
...
<!-- aboutfile Starts -->
 ...
 Visio 编程库，能够构建能够生成、修改、转换、呈现和打印VSTM文件的跨平台应用程序。 .NET Visio API 不仅可以在电子表格格式之间进行转换，还可以将 Visio 文件呈现为图像、VSTM、VSTM 等，从而使其成为以行业标准交换文档的完美选择格式。
