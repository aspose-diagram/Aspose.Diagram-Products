---
title: 通过 Python 将 VSTX 转换为 JPEG 
weight: 1960
url: /zh/python-java/conversion/vstx-to-jpeg/ 
description: VSTX 格式到 JPEG 文件的示例 Python 转换代码。使用此示例代码在任何基于 Python 的应用程序中将 VSTX 转换为 JPEG。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Python 将 VSTX 转换为 JPEG" h2="使用 Python API 将 Microsoft Visio VSTX 导出为 JPEG。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python 将 VSTX 转换为 JPEG" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Python 将 VSTX 转换为 JPEG 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Python 开发人员只需几行代码即可轻松地将 VSTX 文件转换为 JPEG。
...
{{% blocks/products/pf/agp/code-block title="VSTX 到 JPEG Python 转换源代码" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/python-java/conversion/vstx-to-html/" name="VSTX 转 HTML" description="超文本标记语言" >}}
