---
title: 通过 Python 合并 VST 文件 
weight: 230
url: /zh/python-java/merger/vst/ 
description: Python 示例代码，用于在任何基于 Python 的应用程序中组合 VST 文档。 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合并 Python 中的 VST 格式" h2="使用服务器端 Python API 的本机 VST 文档合并。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VST" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python 合并 VST 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="在 Python 中合并 VST 文件的步骤" %}}
...
+ 使用 Diagram 类的实例加载第一个 VST 文件。
+ 使用 Diagram 类的实例加载第二个 VST 文档。
+ 使用 combine() 方法合并文件。
+ 将合并后的 VST 文件保存在指定路径
...
{{% blocks/products/pf/agp/code-block title="合并 VST 文件 - Python" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram 是 Microsoft Visio 文档格式操作 API。您可以轻松加载、创建、修改、操作包括图形元素在内的 Visio 图表转换为其他格式，例如 PDF、XPS、JPEG、PNG、BMP、TIFF、SVG、EMF 等。它是一个独立的 API，不需要安装 Microsoft Visio 或任何其他软件。  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="在线 VST 合并现场演示" sectionDescription="立即通过访问我们的合并 VST 文档 [现场演示网站](https://products.aspose.app/diagram/merger).现场演示有以下好处" >}}
