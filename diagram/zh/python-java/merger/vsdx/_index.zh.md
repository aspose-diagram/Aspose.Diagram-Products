---
title: 通过 Python 合并 VSDX 个文件 
weight: 230
url: /zh/python-java/merger/vsdx/ 
description: Python 示例代码，用于在任何基于 Python 的应用程序中组合 VSDX 文档。 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合并 Python 中的 VSDX 格式" h2="使用服务器端 Python API 的本机 VSDX 文档合并。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Python 合并 VSDX 文件" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="合并 Python 中的 VSDX 文件的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="合并 VSDX 个文件 - Python" offSpacer="" %}}
