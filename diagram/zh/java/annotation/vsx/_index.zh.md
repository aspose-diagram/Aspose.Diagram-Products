---
title: 通过 Java 从 VSX 添加、编辑和删除注释 
weight: 3250
url: /zh/java/annotation/vsx/ 
description: Java 用于注释 Java JSP/JSF 应用程序和桌面应用程序的运行时环境中的 VSX 文件的源代码。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="在 Java 中注释 VSX 格式" h2="使用服务器端 Java API 的原生 VSX 文档注释。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSX" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 注释 VSX 文件" %}}
...
{{% blocks/products/pf/agp/code-block title="注释 VSX 个文件 - Java" offSpacer="" %}}
