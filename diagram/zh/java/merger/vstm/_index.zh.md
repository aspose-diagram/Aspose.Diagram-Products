---
title: 通过 Java 合并 VSTM 个文件 
weight: 3750
url: /zh/java/merger/vstm/ 
description: Java 示例代码，用于组合 Java JSP/JSF 应用程序和桌面应用程序的运行时环境中的 VSTM 文档。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="合并 Java 中的 VSTM 格式" h2="使用服务器端 Java API 的本机 VSTM 文档合并。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="合并 Java 中的 VSTM 文件的步骤" %}}
...
{{% blocks/products/pf/agp/code-block title="合并 VSTM 个文件 - Java" offSpacer="" %}}
