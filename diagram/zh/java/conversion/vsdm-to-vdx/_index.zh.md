---
title: 通过 Java 将 VSDM 转换为 VDX 
weight: 5040
url: /zh/java/conversion/vsdm-to-vdx/ 
description: VSDM 格式到 VDX 文件的示例 Java 转换代码。使用此示例代码在任何基于 Web 或桌面 Java 的应用程序中将 VSDM 转换为 VDX。
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="通过 Java 将 VSDM 转换为 VDX" h2="使用原生 Java 库将 Microsoft Visio VSDM 导出到 VDX。" logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 VSDM 转换为 VDX" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 VSDM 转换为 VDX 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Java 开发人员只需几行代码即可轻松地将 VSDM 文件转换为 VDX。
...
{{% blocks/products/pf/agp/code-block title="VSDM 到 VDX Java 转换源代码" offSpacer="" %}}
