...
{{% blocks/products/pf/agp/content h2="如何使用 Java 将 VDX 转换为 PDF" %}}

 为了将 VDX 渲染为 PDF，我们将使用
...
{{% blocks/products/pf/agp/feature-section-col title="通过 Java 将 VDX 转换为 PDF 的步骤" %}}

{{% blocks/products/pf/agp/text %}}

 Java 开发人员只需几行代码即可轻松地将 VDX 文件转换为 PDF。
...
{{% blocks/products/pf/agp/code-block title="VDX转PDFJava转换源码" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VDX 到 PDF 转换现场演示" sectionDescription="[将 VDX 转换为 PDF](https://products.aspose.app/diagram/conversion/vdx-to-pdf) 立即访问我们的现场演示网站。现场演示具有以下好处" >}}
        ...
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" 只需上传您的 VDX 文件，它将立即转换为 PDF。" >}}
