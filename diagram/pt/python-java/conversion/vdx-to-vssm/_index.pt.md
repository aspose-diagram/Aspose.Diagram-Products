---
title: Converter VDX em VSSM via Python 
weight: 1960
url: /pt/python-java/conversion/vdx-to-vssm/ 
description: Exemplo de código de conversão Python para o formato VDX para arquivo VSSM. Use este código de exemplo para converter VDX em VSSM em qualquer aplicativo baseado em Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VDX em VSSM via Python" h2="Exporte Microsoft Visio VDX para VSSM usando Python APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VDX em VSSM usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VDX em VSSM via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem converter facilmente o arquivo VDX para VSSM em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="VDX para VSSM Python Código-fonte de conversão" offSpacer="" %}}
