---
title: Converter VDX em VSTX via Python 
weight: 1960
url: /pt/python-java/conversion/vdx-to-vstx/ 
description: Exemplo de código de conversão Python para o formato VDX para arquivo VSTX. Use este código de exemplo para converter VDX em VSTX em qualquer aplicativo baseado em Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VDX em VSTX via Python" h2="Exporte Microsoft Visio VDX para VSTX usando Python APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VDX em VSTX usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VDX em VSTX via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem converter facilmente o arquivo VDX para VSTX em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="VDX para VSTX Python Código-fonte de conversão" offSpacer="" %}}
