---
title: Converter VDX para TIFF por meio de Python 
weight: 1960
url: /pt/python-java/conversion/vdx-to-tiff/ 
description: Exemplo de código de conversão Python para o formato VDX para arquivo TIFF. Use este código de exemplo para converter VDX em TIFF em qualquer aplicativo baseado em Python.
---
...
{{% blocks/products/pf/agp/content h2="Como converter VDX para TIFF usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VDX em TIFF por meio de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem converter facilmente o arquivo VDX para TIFF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de VDX para TIFF Python" offSpacer="" %}}
