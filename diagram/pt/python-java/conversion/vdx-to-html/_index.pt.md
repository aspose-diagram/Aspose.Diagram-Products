---
title: Converter VDX em HTML por meio de Python 
weight: 1960
url: /pt/python-java/conversion/vdx-to-html/ 
description: Exemplo de código de conversão Python para formato VDX para arquivo HTML. Use este código de exemplo para converter VDX em HTML em qualquer aplicativo baseado em Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VDX em HTML por meio de Python" h2="Exporte Microsoft Visio VDX para HTML usando Python APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VDX para HTML usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VDX em HTML por meio de Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem converter facilmente o arquivo VDX para HTML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="VDX para HTML Python Código-fonte de conversão" offSpacer="" %}}
