---
title: Converter VSS para PDF via Python 
weight: 1960
url: /pt/python-java/conversion/vss-to-pdf/ 
description: Exemplo de código de conversão Python para formato VSS em arquivo PDF. Use este código de exemplo para converter VSS em PDF em qualquer aplicativo baseado em Python.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VSS para PDF via Python" h2="Exporte Microsoft Visio VSS para PDF usando Python APIs." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VSS para PDF usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSS em PDF via Python" %}}

{{% blocks/products/pf/agp/text %}}

 Python os desenvolvedores podem converter facilmente arquivos VSS em PDF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de VSS para PDF Python" offSpacer="" %}}
...
{{< blocks/products/pf/agp/other-supported-section-item href="https://products.aspose.com/diagram/python-java/conversion/vss-to-html/" name="VSS PARA HTML" description="Linguagem de marcação de hipertexto" >}}
