---
title: Documento VSS de marca d'água via Python 
weight: 3050
url: /pt/python-java/watermark/vss/ 
description: Python código de amostra para adicionar marca d'água a documentos VSS em qualquer aplicativo baseado em Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Formatos VSS de marca d\'água em Python" h2="Marca d\'água de documento VSS nativo usando APIs Python do lado do servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSS" >}}
...
{{% blocks/products/pf/agp/content h2="Como marcar arquivos VSS com marca d\'água usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para marcar arquivos VSS com marca d\'água em Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Arquivos VSS de marca d\'água - Python" offSpacer="" %}}
