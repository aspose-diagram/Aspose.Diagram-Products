---
title: Documento de marca d'água VSD via Python 
weight: 3050
url: /pt/python-java/watermark/vsd/ 
description: Python código de amostra para adicionar marca d'água a documentos VSD em qualquer aplicativo baseado em Python. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Formatos de marca d\'água VSD em Python" h2="Marca d\'água de documento VSD nativo usando APIs Python do lado do servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Como marcar arquivos VSD com marca d\'água usando Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para marca d\'água VSD Arquivos em Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Arquivos de marca d\'água VSD - Python" offSpacer="" %}}
