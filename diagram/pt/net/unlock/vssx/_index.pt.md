---
title: Desbloqueie VSSX documento via .NET 
weight: 5680
url: /pt/net/unlock/vssx/ 
description: C# código-fonte para desbloquear o arquivo VSSX nas plataformas .NET Framework, .NET Core, Mono.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Desbloqueie VSSX arquivos por meio de C#" h2="Remova a proteção de Visio incluindo o formato VSSX usando a biblioteca .NET." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como desbloquear o arquivo VSSX usando C#" %}}

 Para desbloquear o arquivo VSSX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para desbloquear VSSX arquivos em C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Desbloqueie VSSX Arquivos - C#" offSpacer="" %}}
