...
description: Código de amostra para conversão de VSSX para PNG C#. Use API código de exemplo para conversão de arquivos VSSX em lote para PNG em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos para PNG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.PNG como parâmetros1. O arquivo PNG será salvo no caminho especificado
