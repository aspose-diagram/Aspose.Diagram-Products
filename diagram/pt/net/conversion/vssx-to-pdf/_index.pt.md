...
description: Código de exemplo para conversão de VSSX para PDF C#. Use API código de exemplo para conversão de arquivos VSSX em lote para PDF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX para PDF usando C#" %}}

 Para converter VSSX para PDF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX para PDF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos VSSX em PDF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.PDF como parâmetros1. O arquivo PDF será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX para PDF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VSSX para PDF](https://products.aspose.app/diagram/conversion/vssx-to-pdf) com os seguintes benefícios." >}}
