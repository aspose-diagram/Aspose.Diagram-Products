---
title: Converter VSD para VSSM via C# 
weight: 1620
...
{{% blocks/products/pf/agp/content h2="Como converter VSD para VSSM usando C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSD arquivos para VSSM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSD com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSSM como parâmetros1. O arquivo VSSM será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSD para VSSM" sectionDescription="Confira nossas demonstrações ao vivo para [VSD para conversão VSSM](https://products.aspose.app/diagram/conversion/vsd-to-vssm) com os seguintes benefícios." >}}
