...
{{% blocks/products/pf/agp/content h2="Como converter VTX para XPS usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VTX para XPS via C#" %}}
...
1. Carregar arquivo VTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.XPS como parâmetros1. O arquivo XPS será salvo no caminho especificado
