---
title: Converter VSSX em VSTX via C# 
weight: 2090
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX em VSTX usando C#" %}}

 Para converter VSSX em VSTX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX em VSTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos em VSTX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSTX como parâmetros1. VSTX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX em VSTX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSSX para VSTX](https://products.aspose.app/diagram/conversion/vssx-to-vstx) com os seguintes benefícios." >}}
