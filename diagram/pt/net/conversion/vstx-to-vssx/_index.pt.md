---
title: Converter VSTX em VSSX via C# 
weight: 3420
...
{{% blocks/products/pf/agp/content h2="Como converter VSTX em VSSX usando C#" %}}

 Para converter VSTX em VSSX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSTX em VSSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSTX arquivos em VSSX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSSX como parâmetros1. VSSX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSTX em VSSX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSTX para VSSX](https://products.aspose.app/diagram/conversion/vstx-to-vssx) com os seguintes benefícios." >}}
