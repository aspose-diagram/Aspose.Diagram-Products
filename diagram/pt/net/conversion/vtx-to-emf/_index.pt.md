---
title: Converter VTX para EMF via C# 
weight: 980
url: /pt/net/conversion/vtx-to-emf/ 
description: Código de amostra para conversão de VTX para EMF C#. Use API código de exemplo para arquivos VTX em lote para conversão EMF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VTX para EMF via C#" h2="Exporte arquivos Microsoft® Visio VTX para EMF em .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="EMF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VTX para EMF usando C#" %}}

 Para converter VTX para EMF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VTX para EMF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos VTX para EMF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.EMF como parâmetros1. O arquivo EMF será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de VTX para EMF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VTX para EMF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VTX para EMF](https://products.aspose.app/diagram/conversion/vtx-to-emf) com os seguintes benefícios." >}}
