...
{{% blocks/products/pf/agp/content h2="Como converter VSTX em VTX usando C#" %}}

 Para converter VSTX em VTX, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSTX arquivos em VTX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VTX como parâmetros1. VTX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSTX em VTX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSTX para VTX](https://products.aspose.app/diagram/conversion/vstx-to-vtx) com os seguintes benefícios." >}}
