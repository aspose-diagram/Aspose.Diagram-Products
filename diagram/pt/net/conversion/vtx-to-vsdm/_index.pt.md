---
title: Converter VTX em VSDM via C# 
weight: 3550
...
{{% blocks/products/pf/agp/content h2="Como converter VTX em VSDM usando C#" %}}

 Para converter VTX em VSDM, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VTX arquivos em VSDM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSDM como parâmetros1. VSDM arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VTX em VSDM" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VTX para VSDM](https://products.aspose.app/diagram/conversion/vtx-to-vsdm) com os seguintes benefícios." >}}
