---
title: Converter VSD para VSTM via C# 
weight: 3960
...
{{% blocks/products/pf/agp/content h2="Como converter VSD para VSTM usando C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSD arquivos para VSTM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSD com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSTM como parâmetros1. O arquivo VSTM será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSD para VSTM" sectionDescription="Confira nossas demonstrações ao vivo para [VSD para conversão VSTM](https://products.aspose.app/diagram/conversion/vsd-to-vstm) com os seguintes benefícios." >}}
