...
description: Código de amostra para conversão de VSSX para SVG C#. Use API código de exemplo para arquivos VSSX em lote para conversão SVG em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX para SVG usando C#" %}}
 ...
 Para converter VSSX em SVG, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX em SVG via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos em SVG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.SVG como parâmetros1. O arquivo SVG será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX para SVG" sectionDescription="Confira nossas demonstrações ao vivo para [VSSX para conversão SVG](https://products.aspose.app/diagram/conversion/vssx-to-svg) com os seguintes benefícios." >}}
