...
description: Código de amostra para conversão de VSSX para BMP C#. Use API código de exemplo para arquivos em lote VSSX para conversão BMP em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX para BMP usando C#" %}}
 ...
 Para converter VSSX em BMP, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX em BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos em BMP em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.BMP como parâmetros1. O arquivo BMP será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX para BMP" sectionDescription="Confira nossas demonstrações ao vivo para [VSSX para conversão de BMP](https://products.aspose.app/diagram/conversion/vssx-to-bmp) com os seguintes benefícios." >}}
