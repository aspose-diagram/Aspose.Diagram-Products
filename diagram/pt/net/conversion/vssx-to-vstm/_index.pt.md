---
title: Converter VSSX em VSTM via C# 
weight: 3390
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX em VSTM usando C#" %}}

 Para converter VSSX em VSTM, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX em VSTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos em VSTM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSTM como parâmetros1. VSTM arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX em VSTM" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSSX para VSTM](https://products.aspose.app/diagram/conversion/vssx-to-vstm) com os seguintes benefícios." >}}
