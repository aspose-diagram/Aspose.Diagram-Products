---
title: Converter VTX para VSSM via C# 
weight: 350
...
{{% blocks/products/pf/agp/content h2="Como converter VTX para VSSM usando C#" %}}

 Para converter VTX para VSSM, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter arquivos VTX para VSSM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSSM como parâmetros1. O arquivo VSSM será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VTX para VSSM" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VTX para VSSM](https://products.aspose.app/diagram/conversion/vtx-to-vssm) com os seguintes benefícios." >}}
