...
description: Código de amostra para conversão de VSSX para XPS C#. Use API código de exemplo para arquivos de lote VSSX para conversão XPS em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos para XPS em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.XPS como parâmetros1. O arquivo XPS será salvo no caminho especificado
