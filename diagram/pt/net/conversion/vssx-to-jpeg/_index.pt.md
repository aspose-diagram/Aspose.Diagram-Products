...
description: Código de amostra para conversão de VSSX para JPEG C#. Use API código de exemplo para conversão de arquivos VSSX em lote para JPEG em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX para JPEG usando C#" %}}
 ...
 Para converter VSSX em JPEG, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos para JPEG em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.JPEG como parâmetros1. O arquivo JPEG será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX para JPEG" sectionDescription="Confira nossas demonstrações ao vivo para [VSSX para conversão JPEG](https://products.aspose.app/diagram/conversion/vssx-to-jpeg) com os seguintes benefícios." >}}
