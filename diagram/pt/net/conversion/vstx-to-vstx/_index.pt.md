---
title: Converter VSTX em VSTX via C# 
weight: 1840
...
{{% blocks/products/pf/agp/content h2="Como converter VSTX em VSTX usando C#" %}}

 Para converter VSTX em VSTX, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSTX arquivos em VSTX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSTX como parâmetros1. VSTX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSTX em VSTX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSTX para VSTX](https://products.aspose.app/diagram/conversion/vstx-to-vstx) com os seguintes benefícios." >}}
