---
title: Converter VSTX para PDF via C# 
weight: 3920
url: /pt/net/conversion/vstx-to-pdf/ 
description: Código de amostra para conversão de VSTX para PDF C#. Use API código de exemplo para conversão de arquivos VSTX em lote para PDF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VSTX para PDF via C#" h2="Exporte arquivos Microsoft® Visio VSTX para PDF em .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="PDF" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VSTX em PDF usando C#" %}}

 Para converter VSTX em PDF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSTX em PDF por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSTX arquivos em PDF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.PDF como parâmetros1. O arquivo PDF será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de VSTX para PDF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSTX para PDF" sectionDescription="Confira nossas demonstrações ao vivo para [VSTX para conversão de PDF](https://products.aspose.app/diagram/conversion/vstx-to-pdf) com os seguintes benefícios." >}}
