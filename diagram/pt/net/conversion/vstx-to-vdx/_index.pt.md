...
{{% blocks/products/pf/agp/content h2="Como converter VSTX em VDX usando C#" %}}

 Para converter VSTX em VDX, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSTX arquivos em VDX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VDX como parâmetros1. VDX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSTX em VDX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSTX para VDX](https://products.aspose.app/diagram/conversion/vstx-to-vdx) com os seguintes benefícios." >}}
