---
title: Converter VSSX em VSDM via C# 
weight: 5170
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX em VSDM usando C#" %}}

 Para converter VSSX em VSDM, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos em VSDM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSDM como parâmetros1. VSDM arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX em VSDM" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSSX para VSDM](https://products.aspose.app/diagram/conversion/vssx-to-vsdm) com os seguintes benefícios." >}}
