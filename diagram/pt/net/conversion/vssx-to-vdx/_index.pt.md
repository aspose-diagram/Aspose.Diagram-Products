---
title: Converter VSSX em VDX via C# 
weight: 90
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX em VDX usando C#" %}}

 Para converter VSSX em VDX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX em VDX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos em VDX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VDX como parâmetros1. VDX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX em VDX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSSX para VDX](https://products.aspose.app/diagram/conversion/vssx-to-vdx) com os seguintes benefícios." >}}
