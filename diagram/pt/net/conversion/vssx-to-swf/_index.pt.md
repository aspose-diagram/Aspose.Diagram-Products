---
title: Converter VSSX para SWF via C# 
weight: 4140
url: /pt/net/conversion/vssx-to-swf/ 
description: Código de exemplo para conversão de VSSX para SWF C#. Use API código de exemplo para arquivos VSSX em lote para conversão SWF em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX para SWF usando C#" %}}
 ...
 Para converter VSSX para SWF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX para SWF via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos VSSX para SWF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.SWF como parâmetros1. O arquivo SWF será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX para SWF" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VSSX para SWF](https://products.aspose.app/diagram/conversion/vssx-to-swf) com os seguintes benefícios." >}}
