---
title: Converter VSTX em VSTM via C# 
weight: 3010
...
{{% blocks/products/pf/agp/content h2="Como converter VSTX em VSTM usando C#" %}}

 Para converter VSTX em VSTM, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSTX arquivos em VSTM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSTM como parâmetros1. VSTM arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSTX em VSTM" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSTX para VSTM](https://products.aspose.app/diagram/conversion/vstx-to-vstm) com os seguintes benefícios." >}}
