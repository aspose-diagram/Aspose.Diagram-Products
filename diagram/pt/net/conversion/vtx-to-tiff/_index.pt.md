...
{{% blocks/products/pf/agp/content h2="Como converter VTX para TIFF usando C#" %}}

 Para converter VTX em TIFF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VTX em TIFF por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VTX arquivos para TIFF em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.TIFF como parâmetros1. O arquivo TIFF será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de VTX para TIFF C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VTX para TIFF" sectionDescription="Confira nossas demonstrações ao vivo para [VTX para conversão de TIFF](https://products.aspose.app/diagram/conversion/vtx-to-tiff) com os seguintes benefícios." >}}
