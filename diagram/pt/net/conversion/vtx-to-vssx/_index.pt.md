---
title: Converter VTX em VSSX via C# 
weight: 4260
...
{{% blocks/products/pf/agp/content h2="Como converter VTX em VSSX usando C#" %}}

 Para converter VTX em VSSX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VTX em VSSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VTX arquivos em VSSX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSSX como parâmetros1. VSSX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VTX em VSSX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VTX para VSSX](https://products.aspose.app/diagram/conversion/vtx-to-vssx) com os seguintes benefícios." >}}
