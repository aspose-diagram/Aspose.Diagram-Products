---
title: Converter VTX em VSTX via C# 
weight: 1250
...
{{% blocks/products/pf/agp/content h2="Como converter VTX em VSTX usando C#" %}}

 Para converter VTX em VSTX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VTX em VSTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VTX arquivos em VSTX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSTX como parâmetros1. VSTX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VTX em VSTX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VTX para VSTX](https://products.aspose.app/diagram/conversion/vtx-to-vstx) com os seguintes benefícios." >}}
