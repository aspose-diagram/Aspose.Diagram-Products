---
title: Converter VSD em VDX via C# 
weight: 3840
...
{{% blocks/products/pf/agp/content h2="Como converter VSD em VDX usando C#" %}}

 Para converter VSD em VDX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSD em VDX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSD arquivos em VDX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSD com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VDX como parâmetros1. VDX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSD em VDX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSD para VDX](https://products.aspose.app/diagram/conversion/vsd-to-vdx) com os seguintes benefícios." >}}
