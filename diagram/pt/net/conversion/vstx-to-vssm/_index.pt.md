---
title: Converter VSTX para VSSM via C# 
weight: 2060
...
{{% blocks/products/pf/agp/content h2="Como converter VSTX para VSSM usando C#" %}}

 Para converter VSTX para VSSM, usaremos
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter arquivos VSTX para VSSM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSSM como parâmetros1. O arquivo VSSM será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSTX para VSSM" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VSTX para VSSM](https://products.aspose.app/diagram/conversion/vstx-to-vssm) com os seguintes benefícios." >}}
