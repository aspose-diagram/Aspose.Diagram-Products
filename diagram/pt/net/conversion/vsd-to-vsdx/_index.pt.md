...
{{% blocks/products/pf/agp/content h2="Como converter VSD em VSDX usando C#" %}}

 Para converter VSD em VSDX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSD em VSDX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSD arquivos em VSDX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSD com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSDX como parâmetros1. VSDX arquivo será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de VSD para VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSD em VSDX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSD para VSDX](https://products.aspose.app/diagram/conversion/vsd-to-vsdx) com os seguintes benefícios." >}}
