---
title: Converter VSD em VSDM via C# 
weight: 5030
...
{{% blocks/products/pf/agp/content h2="Como converter VSD em VSDM usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSD em VSDM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSD arquivos em VSDM em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSD com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSDM como parâmetros1. VSDM arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSD em VSDM" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSD para VSDM](https://products.aspose.app/diagram/conversion/vsd-to-vsdm) com os seguintes benefícios." >}}
