---
title: Converter VSSX para VSDX via C# 
weight: 1040
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX para VSDX usando C#" %}}

 Para converter VSSX para VSDX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX para VSDX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos VSSX para VSDX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar o arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSDX como parâmetros1. VSDX arquivo será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão do VSSX para VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX para VSDX" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VSSX para VSDX](https://products.aspose.app/diagram/conversion/vssx-to-vsdx) com os seguintes benefícios." >}}
