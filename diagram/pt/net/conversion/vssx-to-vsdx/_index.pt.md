...
{{% blocks/products/pf/agp/content h2="Como converter VSSX em VSDX usando C#" %}}

 Para converter VSSX em VSDX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX em VSDX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos em VSDX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSDX como parâmetros1. VSDX arquivo será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de VSSX para VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX em VSDX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSSX para VSDX](https://products.aspose.app/diagram/conversion/vssx-to-vsdx) com os seguintes benefícios." >}}
