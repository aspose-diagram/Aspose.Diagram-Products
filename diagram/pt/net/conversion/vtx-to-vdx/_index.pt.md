---
title: Converter VTX em VDX via C# 
weight: 2170
...
{{% blocks/products/pf/agp/content h2="Como converter VTX em VDX usando C#" %}}

 Para converter VTX em VDX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VTX em VDX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VTX arquivos em VDX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VDX como parâmetros1. VDX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VTX em VDX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VTX para VDX](https://products.aspose.app/diagram/conversion/vtx-to-vdx) com os seguintes benefícios." >}}
