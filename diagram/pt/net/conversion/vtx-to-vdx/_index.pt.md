...
{{% blocks/products/pf/agp/content h2="Como converter VTX para VDX usando C#" %}}

 Para converter VTX para VDX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VTX para VDX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter arquivos VTX para VDX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VTX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VDX como parâmetros1. O arquivo VDX será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de VTX para VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VTX para VDX" sectionDescription="Confira nossas demonstrações ao vivo para [Conversão de VTX para VDX](https://products.aspose.app/diagram/conversion/vtx-to-vdx) com os seguintes benefícios." >}}
