---
title: Converter VSSX em HTML por meio de C# 
weight: 4240
url: /pt/net/conversion/vssx-to-html/ 
description: Código de amostra para conversão de VSSX para HTML C#. Use API código de exemplo para arquivos VSSX em lote para conversão HTML em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VSSX em HTML por meio de C#" h2="Exporte arquivos Microsoft® Visio VSSX para HTML em .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX para HTML usando C#" %}}

 Para converter VSSX em HTML, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX em HTML por meio de C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSSX arquivos em HTML em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSSX com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.HTML como parâmetros1. O arquivo HTML será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de VSSX para HTML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSSX para HTML" sectionDescription="Confira nossas demonstrações ao vivo para [VSSX para conversão HTML](https://products.aspose.app/diagram/conversion/vssx-to-html) com os seguintes benefícios." >}}
