---
title: Converter VSD em VSTX via C# 
weight: 2580
...
{{% blocks/products/pf/agp/content h2="Como converter VSD em VSTX usando C#" %}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 .NET os desenvolvedores podem facilmente carregar e converter VSD arquivos em VSTX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSD com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSTX como parâmetros1. VSTX arquivo será salvo no caminho especificado
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSD em VSTX" sectionDescription="Confira nossas demonstrações ao vivo para [conversão de VSD para VSTX](https://products.aspose.app/diagram/conversion/vsd-to-vstx) com os seguintes benefícios." >}}
