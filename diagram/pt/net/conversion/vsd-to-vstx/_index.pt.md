---
title: Converter VSD para VSTX via C# 
weight: 2580
url: /pt/net/conversion/vsd-to-vstx/ 
description: Código de amostra para conversão de VSD para VSTX C#. Use API código de exemplo para arquivos VSD em lote para conversão VSTX em VB.NET, Asp.NET ou qualquer aplicativo baseado em .NET.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VSD para VSTX via C#" h2="Exporte arquivos Microsoft® Visio VSD para VSTX em .NET Framework, .NET Core, Mono ou COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSD" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VSD para VSTX usando C#" %}}

 Para converter VSD em VSTX, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSD em VSTX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET os desenvolvedores podem facilmente carregar e converter VSD arquivos para VSTX em apenas algumas linhas de código.

{{% /blocks/products/pf/agp/text %}}

1. Carregar arquivo VSD com uma instância da classe Diagram1. Chame o método Diagram.Save com o caminho do arquivo de saída e SaveFileFormat.VSTX como parâmetros1. O arquivo VSTX será salvo no caminho especificado
...
{{% blocks/products/pf/agp/code-block title="Este código de amostra mostra a conversão de VSD para VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Aplicativo gratuito para converter VSD para VSTX" sectionDescription="Confira nossas demonstrações ao vivo para [VSD para conversão VSTX](https://products.aspose.app/diagram/conversion/vsd-to-vstx) com os seguintes benefícios." >}}
