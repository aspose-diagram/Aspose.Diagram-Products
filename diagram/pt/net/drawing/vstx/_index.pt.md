---
title: Desenhe geometria para documento VSTX via .NET 
weight: 3050
url: /pt/net/drawing/vstx/ 
description: C# código-fonte para desenhar geometria para o arquivo vstx em .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Desenhe geometria para VSTX em C#" h2="Geometria de desenho nativa e de alto desempenho para documento VSTX usando APIs Aspose.Diagram for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como desenhar geometria para arquivo VSTX usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para desenhar geometria para VSTX arquivos em C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Desenhar geometria para VSTX arquivos - C#" offSpacer="" %}}
