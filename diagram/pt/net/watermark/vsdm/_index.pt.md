---
title: Documento de marca d'água VSDM via .NET 
weight: 3050
url: /pt/net/watermark/vsdm/ 
description: C# código-fonte para adicionar marca d'água ao arquivo vsdm em .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Adicionar marca d\'água de texto a VSDM em C#" h2="Marca d\'água de documento VSDM nativa e de alto desempenho usando APIs Aspose.Diagram for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como marcar o arquivo VSDM com marca d\'água usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para marcar arquivos VSDM em C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Arquivos de marca d\'água VSDM - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram é uma manipulação de formato de documento Microsoft Visio API. Pode-se facilmente carregar, criar, modificar, manipular incluindo elementos de diagramas e converter diagramas Visio para outros formatos, como PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF e muito mais. É um API autônomo e não requer que o Microsoft Visio ou qualquer outro software seja instalado.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo do WaterMarker on-line VSDM" sectionDescription="documentos WaterMark VSDM agora mesmo visitando nosso [Site de demonstrações ao vivo](https://products.aspose.app/diagram/watermark). A demonstração ao vivo tem os seguintes benefícios" >}}
