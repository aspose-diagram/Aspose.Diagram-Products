---
title: Compactar VSX documento via .NET 
weight: 3050
...
{{% blocks/products/pf/agp/content h2="Como compactar arquivo VSX usando C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Compactar VSX Arquivos - C#" offSpacer="" %}}
