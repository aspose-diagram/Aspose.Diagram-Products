---
title: Compactar VDX documento via .NET 
weight: 3050
...
{{% blocks/products/pf/agp/content h2="Como compactar arquivo VDX usando C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Compactar VDX Arquivos - C#" offSpacer="" %}}
