---
title: Compactar VSTX documento via .NET 
weight: 3050
...
{{% blocks/products/pf/agp/content h2="Como compactar arquivo VSTX usando C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Compactar VSTX Arquivos - C#" offSpacer="" %}}
