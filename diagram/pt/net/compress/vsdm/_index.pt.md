---
title: Compactar VSDM documento via .NET 
weight: 3050
...
{{% blocks/products/pf/agp/content h2="Como compactar arquivo VSDM usando C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Compactar VSDM Arquivos - C#" offSpacer="" %}}
