---
title: Mesclar VSTM arquivos por meio de .NET 
weight: 2740
url: /pt/net/merger/vstm/ 
description: C# código-fonte para combinar VSTM documentos em .NET Framework, .NET Core, Mono ou COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mesclar VSTM Formatos em C#" h2="Fusão de documentos VSTM nativos e de alto desempenho usando APIs Aspose.Diagram for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Como mesclar arquivo VSTM usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para mesclar VSTM arquivos em C#" %}}
...
+ Agora você pode abrir e usar o arquivo VSTM em Microsoft Office, Adobe PDF ou qualquer outro programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Mesclar VSTM arquivos - C#" offSpacer="" %}}
