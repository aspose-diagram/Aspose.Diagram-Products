---
title: Mesclar VSSX arquivos por meio de .NET 
weight: 3770
url: /pt/net/merger/vssx/ 
description: C# código-fonte para combinar VSSX documentos em .NET Framework, .NET Core, Mono ou COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mesclar VSSX Formatos em C#" h2="Fusão de documentos VSSX nativos e de alto desempenho usando APIs Aspose.Diagram for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como mesclar arquivo VSSX usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para mesclar VSSX arquivos em C#" %}}
...
+ Carregue todos os arquivos VSSX com caminho completo.
+ Faça um documento como o arquivo base
+ Chame o método relevante para concatenar e mesclar arquivos um por um.
+ Chame o método Save() e passe o nome do arquivo (caminho completo) e o formato (VSSX) como parâmetro.
+ Agora você pode abrir e usar o arquivo VSSX em Microsoft Office, Adobe PDF ou qualquer outro programa compatível.
...
{{% blocks/products/pf/agp/code-block title="Mesclar VSSX arquivos - C#" offSpacer="" %}}
