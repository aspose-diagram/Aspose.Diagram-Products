---
title: Mesclar VSDX arquivos por meio de .NET 
weight: 460
url: /pt/net/merger/vsdx/ 
description: C# código-fonte para combinar VSDX documentos em .NET Framework, .NET Core, Mono ou COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mesclar VSDX Formatos em C#" h2="Fusão de documentos VSDX nativos e de alto desempenho usando APIs Aspose.Diagram for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como mesclar arquivo VSDX usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para mesclar VSDX arquivos em C#" %}}
...
+ Carregue todos os arquivos VSDX com caminho completo.
...
{{% blocks/products/pf/agp/code-block title="Mesclar VSDX arquivos - C#" offSpacer="" %}}
