---
title: Documento VDW de layout automático via .NET 
weight: 3050
url: /pt/net/autolayout/vdw/ 
description: C# código-fonte para arquivo vdw de layout automático em .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Documento VDW de layout automático em C#" h2="Documento VDW de layout automático nativo e de alto desempenho usando APIs Aspose.Diagram for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como fazer o layout automático do arquivo VDW usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para arquivos VDW de layout automático em C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Arquivos VDW de Layout Automático - C#" offSpacer="" %}}
