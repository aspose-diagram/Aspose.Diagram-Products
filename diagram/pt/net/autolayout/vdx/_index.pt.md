...
{{% blocks/products/pf/agp/content h2="Como Layout Automático de Arquivo VDX Usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para arquivos de layout automático VDX em C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Layout Automático de Arquivos VDX - C#" offSpacer="" %}}
