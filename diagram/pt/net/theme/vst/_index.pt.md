---
title: Aplique o tema predefinido ao documento VST via .NET 
weight: 3050
url: /pt/net/theme/vst/ 
description: C# código-fonte para aplicar o tema predefinido ao arquivo vst em .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Aplicar tema predefinido ao VST em C#" h2="Nativo e de alto desempenho aplicam o tema predefinido ao documento VST usando APIs Aspose.Diagram for .NET do lado do servidor, sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como aplicar o tema predefinido ao arquivo VST usando C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para aplicar o tema predefinido a arquivos VST em C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Aplicar tema predefinido a arquivos VST - C#" offSpacer="" %}}
