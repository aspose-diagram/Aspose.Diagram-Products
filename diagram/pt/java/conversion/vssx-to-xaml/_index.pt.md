---
title: Converter VSSX para XAML por meio de Java 
weight: 1220
url: /pt/java/conversion/vssx-to-xaml/ 
description: Exemplo de código de conversão Java para o formato VSSX para arquivo XAML. Use este código de exemplo para converter VSSX em XAML em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VSSX para XAML por meio de Java" h2="Exporte Microsoft Visio VSSX para XAML usando a biblioteca Java nativa." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Os desenvolvedores Java podem converter facilmente o arquivo VSSX em XAML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="VSSX para XAML Java Código-fonte de conversão" offSpacer="" %}}
