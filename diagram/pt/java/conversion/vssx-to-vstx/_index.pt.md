---
title: Converter VSSX em VSTX via Java 
weight: 180
url: /pt/java/conversion/vssx-to-vstx/ 
description: Exemplo de código de conversão Java para o formato VSSX para arquivo VSTX. Use este código de exemplo para converter VSSX em VSTX em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VSSX em VSTX via Java" h2="Exporte Microsoft Visio VSSX para VSTX usando a biblioteca nativa Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX em VSTX usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX em VSTX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX para VSTX Java Código-fonte de conversão" offSpacer="" %}}
