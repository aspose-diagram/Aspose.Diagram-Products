---
title: Converter VTX para XAML via Java 
weight: 1810
url: /pt/java/conversion/vtx-to-xaml/ 
description: Exemplo de código de conversão Java para formato VTX em arquivo XAML. Use este código de exemplo para converter VTX em XAML em qualquer aplicativo baseado em Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VTX para XAML via Java" h2="Exporte o Microsoft Visio VTX para XAML usando a biblioteca nativa Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java os desenvolvedores podem converter facilmente o arquivo VTX em XAML em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de VTX para XAML Java" offSpacer="" %}}

```cs
// carregue o VTX em um objeto de Diagram 
Diagram visio = new Diagram("template.vtx");
// salvar VTX como XAML 
...
{{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo de conversão de VTX para XAML" sectionDescription="[Converter VTX para XAML](https://products.aspose.app/diagram/conversion/vtx-to-xaml) agora mesmo visitando nosso site de Demonstrações ao Vivo. A demonstração ao vivo tem os seguintes benefícios" >}}
