---
title: Converter VSSX em VSDX via Java 
weight: 1860
url: /pt/java/conversion/vssx-to-vsdx/ 
description: Exemplo de código de conversão Java para o formato VSSX para arquivo VSDX. Use este código de exemplo para converter VSSX em VSDX em qualquer aplicativo baseado na Web ou Desktop Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Converter VSSX em VSDX via Java" h2="Exporte Microsoft Visio VSSX para VSDX usando a biblioteca nativa Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Como converter VSSX em VSDX usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSSX em VSDX via Java" %}}
...
{{% blocks/products/pf/agp/code-block title="VSSX para VSDX Java Código-fonte de conversão" offSpacer="" %}}
