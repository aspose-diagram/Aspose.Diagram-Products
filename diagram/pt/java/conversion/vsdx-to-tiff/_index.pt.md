---
title: Converter VSDX para TIFF por meio de Java 
weight: 2710
url: /pt/java/conversion/vsdx-to-tiff/ 
description: Exemplo de código de conversão Java para o formato VSDX para arquivo TIFF. Use este código de exemplo para converter VSDX em TIFF em qualquer aplicativo baseado na Web ou Desktop Java.
---
...
{{% blocks/products/pf/agp/content h2="Como converter VSDX para TIFF usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VSDX em TIFF por meio de Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem converter facilmente o arquivo VSDX para TIFF em apenas algumas linhas de código.
...
{{% blocks/products/pf/agp/code-block title="Código-fonte de conversão de VSDX para TIFF Java" offSpacer="" %}}
