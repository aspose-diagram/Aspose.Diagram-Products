...
{{% blocks/products/pf/agp/content h2="Como converter VTX para PDF usando Java" %}}

 Para renderizar VTX para PDF, usaremos
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para converter VTX em PDF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java os desenvolvedores podem facilmente converter arquivos VTX em PDF em apenas algumas linhas de código.
