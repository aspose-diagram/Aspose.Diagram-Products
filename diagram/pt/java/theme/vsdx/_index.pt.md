---
title: Aplique o tema predefinido ao documento VSDX via Java 
weight: 3050
url: /pt/Java/theme/vsdx/ 
description: Java código-fonte para aplicar o tema predefinido ao arquivo vsdx no Java ambiente de tempo de execução para aplicativos JSP/JSF e aplicativos de desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Aplicar tema predefinido a VSDX em Java" h2="Nativo e de alto desempenho aplicam o tema predefinido ao documento VSDX usando APIs Aspose.Diagram for Java do lado do servidor, sem o uso de qualquer software como Microsoft ou Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como aplicar o tema predefinido ao arquivo VSDX usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para aplicar o tema predefinido a VSDX arquivos em Java" %}}
