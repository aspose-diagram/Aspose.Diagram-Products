---
title: Mesclar VSSM arquivos por meio de Java 
weight: 1490
url: /pt/java/merger/vssm/ 
description: Java código de amostra para combinar VSSM documentos no Java ambiente de tempo de execução para aplicativos JSP/JSF e aplicativos de desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mesclar VSSM Formatos em Java" h2="Fusão de documentos VSSM nativos usando APIs Java do lado do servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Como mesclar VSSM arquivos usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para mesclar VSSM arquivos em Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mesclar VSSM arquivos - Java" offSpacer="" %}}
