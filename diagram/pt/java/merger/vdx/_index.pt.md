---
title: Mesclar arquivos VDX via Java 
weight: 1830
url: /pt/java/merger/vdx/ 
description: Java código de amostra para combinar documentos VDX no Java ambiente de tempo de execução para aplicativos JSP/JSF e aplicativos de desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mesclar formatos VDX em Java" h2="Fusão de documentos VDX nativos usando APIs Java do lado do servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como mesclar arquivos VDX usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para mesclar arquivos VDX em Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mesclar arquivos VDX - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram é uma manipulação de formato de documento da Microsoft Visio API. Pode-se facilmente carregar, criar, modificar, manipular incluindo elementos de diagrama e converter diagramas Visio para outros formatos, como PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF e muito mais. É um API autônomo e não requer que o Microsoft Visio ou qualquer outro software seja instalado.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Demonstrações ao vivo da fusão VDX on-line" sectionDescription="Mescle documentos VDX agora mesmo visitando nosso [Site de demonstrações ao vivo](https://products.aspose.app/diagram/merger). A demonstração ao vivo tem os seguintes benefícios" >}}
