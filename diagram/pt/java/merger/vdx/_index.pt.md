---
title: Mesclar VDX arquivos por meio de Java 
weight: 1830
url: /pt/java/merger/vdx/ 
description: Java código de amostra para combinar VDX documentos no Java ambiente de tempo de execução para aplicativos JSP/JSF e aplicativos de desktop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Mesclar VDX Formatos em Java" h2="Fusão de documentos VDX nativos usando APIs Java do lado do servidor." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Como mesclar VDX arquivos usando Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Etapas para mesclar VDX arquivos em Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Mesclar VDX arquivos - Java" offSpacer="" %}}
