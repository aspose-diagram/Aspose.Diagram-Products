---
title: .NET을(를) 통해 VSDX 문서에 조직도 만들기 
weight: 3050
url: /ko/net/organizationchart/vsdx/ 
description: .NET 프레임워크, .NET 코어, Mono 플랫폼의 vsdx 파일에 조직도를 생성하기 위한 C# 소스 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#의 VSDX 조직도 만들기" h2="기본 및 고성능은 Microsoft 또는 Open Office, Adobe PDF와 같은 소프트웨어를 사용하지 않고 서버측 Aspose.Diagram for .NET API를 사용하여 VSDX 문서에 조직도를 만듭니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSDX 파일에서 조직도를 만드는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#의 VSDX 파일에 조직도를 만드는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX 파일에서 조직도 만들기 - C#" offSpacer="" %}}
