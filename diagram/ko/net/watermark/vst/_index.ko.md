---
title: .NET을 통한 워터마크 VST 문서 
weight: 3050
url: /ko/net/watermark/vst/ 
description: C# 소스 코드를 사용하여 .NET Framework, .NET Core, Mono 플랫폼의 vst 파일에 워터마크를 추가합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#의 VST에 텍스트 워터마크 추가" h2="Microsoft 또는 Open Office, Adobe PDF와 같은 소프트웨어를 사용하지 않고 서버측 Aspose.Diagram for .NET API를 사용하는 기본 및 고성능 VST 문서 워터마크." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VST 파일을 워터마크하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 VST 파일 워터마킹 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="워터마크 VST 파일 - C#" offSpacer="" %}}
