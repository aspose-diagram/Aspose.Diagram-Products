---
title: .NET을 통한 VSTM 문서 워터마크 
weight: 3050
url: /ko/net/watermark/vstm/ 
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 플랫폼의 vstm 파일에 워터마크를 추가합니다.
---
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSTM 파일에 워터마크를 지정하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 VSTM 파일을 워터마킹하는 단계" %}}
