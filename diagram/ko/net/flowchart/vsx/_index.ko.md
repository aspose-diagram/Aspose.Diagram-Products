---
title: .NET을(를) 통해 VSX 문서에 순서도 스타일 조직도 만들기 
weight: 3050
url: /ko/net/flowchart/vsx/ 
description: C# 소스 코드를 사용하여 .NET Framework, .NET Core, Mono 플랫폼의 vsx 파일에 순서도 스타일 조직도를 만듭니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#의 VSX에 순서도 스타일 조직도 만들기" h2="기본 및 고성능은 Microsoft 또는 Open Office, Adobe PDF와 같은 소프트웨어를 사용하지 않고 서버측 Aspose.Diagram for .NET API를 사용하여 VSX 문서에 순서도 스타일 조직도를 만듭니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
