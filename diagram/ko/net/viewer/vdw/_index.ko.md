---
title: .NET을(를) 통해 VDW 파일 형식 보기 
weight: 3480
url: /ko/net/viewer/vdw/ 
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 또는 COM Interop에서 VDW 문서를 로드, 렌더링 및 표시합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW 파일 뷰어 for .NET" h2="Visio 애플리케이션 또는 Office 자동화 없이 브라우저에서 Microsoft Visio VDW 파일을 봅니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VDW" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#을(를) 통해 VDW를 보는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="VDW를 보기 위한 C# 코드" offSpacer="" %}}
