...
{{% blocks/products/pf/agp/feature-section-col title="C#을(를) 통해 VSDM을(를) 만드는 방법" %}}

{{% blocks/products/pf/agp/text %}}

 개발자는 몇 줄의 코드로 데이터 처리를 위해 실행 중인 다양한 보고 애플리케이션 내에서 VSDM을 쉽게 생성, 로드, 수정 및 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. 클래스 파일에 네임스페이스 포함1. Diagram 클래스 인스턴스를 만듭니다.1. diagram의 첫 번째 페이지에 액세스합니다.1. 페이지에 텍스트를 추가합니다.1. Save 메소드를 사용하여 diagram을 VSDM 파일로 저장합니다.
