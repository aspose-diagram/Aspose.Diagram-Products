---
title: .NET을(를) 통해 VDX 문서에 사전 설정 테마 적용 
weight: 3050
url: /ko/net/theme/vdx/ 
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 플랫폼의 vdx 파일에 사전 설정 테마를 적용합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#의 VDX에 사전 설정 테마 적용" h2="기본 및 고성능은 Microsoft 또는 Open Office, Adobe PDF와 같은 소프트웨어를 사용하지 않고 서버측 Aspose.Diagram for .NET API를 사용하여 VDX 문서에 사전 설정 테마를 적용합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VDX 파일에 사전 설정 테마를 적용하는 방법" %}}

 사전 설정 테마를 VDX 파일에 적용하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#의 VDX 파일에 사전 설정 테마를 적용하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="Vdx 파일에 사전 설정 테마 적용 - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram은(는) Microsoft Visio 문서 형식 조작API입니다. daigram 요소를 포함하여 쉽게 로드, 생성, 수정, 조작하고 Visio 다이어그램을 PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF 등과 같은 다른 형식으로 변환할 수 있습니다. 독립형 API이며 Microsoft Visio 또는 기타 소프트웨어를 설치할 필요가 없습니다.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="온라인 VDX 문서 라이브 데모에 사전 설정 테마 적용" sectionDescription="지금 바로 Google을 방문하여 VDX 문서에 사전 설정 테마를 적용하십시오. [라이브 데모 웹사이트](https://products.aspose.app/diagram/theme). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
