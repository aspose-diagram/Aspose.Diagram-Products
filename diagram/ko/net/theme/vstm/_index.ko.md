---
title: .NET을(를) 통해 VSTM 문서에 사전 설정 테마 적용 
weight: 3050
url: /ko/net/theme/vstm/ 
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 플랫폼의 vstm 파일에 사전 설정 테마를 적용합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#의 VSTM에 사전 설정 테마 적용" h2="기본 및 고성능은 Microsoft 또는 Open Office, Adobe PDF와 같은 소프트웨어를 사용하지 않고 서버측 Aspose.Diagram for .NET API를 사용하여 VSTM 문서에 사전 설정 테마를 적용합니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSTM 파일에 사전 설정 테마를 적용하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#의 VSTM 파일에 사전 설정 테마를 적용하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="VSTM 파일에 사전 설정 테마 적용 - C#" offSpacer="" %}}
