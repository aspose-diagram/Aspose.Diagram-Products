---
title: .NET을 통한 자동 레이아웃 VST 문서 
weight: 3050
url: /ko/net/autolayout/vst/ 
description: .NET Framework, .NET Core, Mono 플랫폼의 자동 레이아웃 vst 파일에 대한 C# 소스 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#의 자동 레이아웃 VST 문서" h2="Adobe PDF, Microsoft 또는 Open Office과 같은 소프트웨어를 사용하지 않고 서버측 Aspose.Diagram for .NET API를 사용하는 기본 및 고성능 자동 레이아웃 VST 문서입니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VST 파일을 자동 레이아웃하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#의 자동 레이아웃 VST 파일 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="자동 레이아웃 VST 파일 - C#" offSpacer="" %}}
