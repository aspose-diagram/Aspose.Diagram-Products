...
description: VSDM에서 XAML C#로의 변환을 위한 샘플 코드입니다. VB.NET, Asp.NET 또는 모든 .NET 기반 애플리케이션 내에서 배치 VSDM 파일을 XAML로 변환하는 API 예제 코드를 사용합니다.
---
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSDM을 XAML로 변환하는 무료 앱" sectionDescription="라이브 데모를 확인하십시오. [VSDM에서 XAML로 변환](https://products.aspose.app/diagram/conversion/vsdm-to-xaml) 다음과 같은 혜택이 있습니다." >}}
