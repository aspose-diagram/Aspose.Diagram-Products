---
title: C#를 통해 VSSM을 HTML로 변환 
weight: 510
url: /ko/net/conversion/vssm-to-html/ 
description: VSSM에서 HTML C#로의 변환을 위한 샘플 코드. VB.NET, Asp.NET 또는 모든 .NET 기반 애플리케이션 내에서 배치 VSSM 파일을 HTML로 변환하는 API 예제 코드를 사용합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#를 통해 VSSM을 HTML로 변환" h2="Microsoft® Visio VSSM 파일을 .NET Framework, .NET Core, Mono 또는 COM Interop에서 HTML로 내보냅니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSSM을 HTML로 변환하는 방법" %}}

 VSSM을 HTML로 변환하기 위해 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="C#을 통해 VSSM을 HTML로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 .NET 개발자는 몇 줄의 코드로 VSSM 파일을 쉽게 로드하고 HTML로 변환할 수 있습니다.

{{% /blocks/products/pf/agp/text %}}

1. Diagram 클래스의 인스턴스로 VSSM 파일 로드1. 출력 파일 경로와 SaveFileFormat.HTML을 매개변수로 사용하여 Diagram.Save 메소드를 호출합니다.1. HTML 파일은 지정된 경로에 저장됩니다
...
{{% blocks/products/pf/agp/code-block title="이 샘플 코드는 VSSM에서 HTML로의 C# 변환을 보여줍니다." offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSM를 HTML로 변환하는 무료 앱" sectionDescription="라이브 데모를 확인하십시오. [VSSM에서 HTML로 변환](https://products.aspose.app/diagram/conversion/vssm-to-html) 다음과 같은 혜택이 있습니다." >}}
