---
title: .NET를 통해 VSDM 문서 압축 
weight: 3050
url: /ko/net/compress/vsdm/ 
description: C# 소스 코드는 .NET Framework, .NET Core, Mono 플랫폼에서 vsdm 파일을 압축합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="C#에서 VSDM 압축" h2="Adobe PDF, Microsoft 또는 Open Office와 같은 소프트웨어를 사용하지 않고 서버측 Aspose.Diagram for .NET API를 사용하는 기본 및 고성능 VSDM 문서 압축기." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="C#을 사용하여 VSDM 파일을 압축하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="C#에서 VSD 파일을 압축하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDM 파일 압축 - C#" offSpacer="" %}}
