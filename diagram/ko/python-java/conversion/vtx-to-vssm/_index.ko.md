---
title: Python를 통해 VTX을 VSSM로 변환 
weight: 1960
url: /ko/python-java/conversion/vtx-to-vssm/ 
description: VTX 형식을 VSSM 파일로 변환하는 샘플 Python 변환 코드. 이 예제 코드를 사용하여 Python 기반 애플리케이션 내에서 VTX을 VSSM로 변환합니다.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python를 통해 VTX을 VSSM로 변환" h2="Python API를 사용하여 Microsoft Visio VTX를 VSSM으로 내보냅니다." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSSM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Python를 사용하여 VTX을 VSSM로 변환하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python를 통해 VTX을 VSSM로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Python 개발자는 몇 줄의 코드로 VTX 파일을 VSSM로 쉽게 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/code-block title="VTX에서 VSSM로 Python 전환 소스 코드" offSpacer="" %}}
