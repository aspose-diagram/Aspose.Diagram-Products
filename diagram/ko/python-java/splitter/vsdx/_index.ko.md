---
title: Python을(를) 통해 VSDX 파일 분할
weight: 1400
url: /ko/python-java/splitter/vsdx/ 
description: Python 소스 코드를 모든 Python 기반 애플리케이션 내에서 vsdx 파일로 분할합니다. 
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Python에서 VSDX 형식 분할" h2="나만의 Python 앱을 빌드하여 VSDX 파일 분할 " logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Python을 사용하여 VSDX 파일을 분할하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Python에서 VSDX 파일을 분할하는 단계" %}}
...
{{% blocks/products/pf/agp/code-block title="VSDX 파일 분할 - Python" offSpacer="" %}}
