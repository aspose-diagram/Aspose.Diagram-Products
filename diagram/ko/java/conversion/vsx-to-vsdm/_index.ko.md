...
{{% blocks/products/pf/agp/content h2="Java를 사용하여 VSX을 VSDM로 변환하는 방법" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Java를 통해 VSX을 VSDM로 변환하는 단계" %}}

{{% blocks/products/pf/agp/text %}}

 Java 개발자는 몇 줄의 코드로 VSX 파일을 VSDM로 쉽게 변환할 수 있습니다.
...
{{% blocks/products/pf/agp/code-block title="VSX에서 VSDM로 Java 전환 소스 코드" offSpacer="" %}}
