---
title: Java를 통해 VSTM 파일 병합 
weight: 3750
url: /ko/java/merger/vstm/ 
description: Java JSP/JSF 애플리케이션 및 데스크톱 애플리케이션을 위한 Java 런타임 환경에서 VSTM 문서를 결합하는 샘플 코드.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Java에서 VSTM 형식 병합" h2="서버측 Java API를 사용한 네이티브 VSTM 문서 병합." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Java을 사용하여 VSTM 파일을 병합하는 방법" %}}

 VSTM 파일을 병합하려면 다음을 사용합니다.
...
{{% blocks/products/pf/agp/feature-section-col title="Java에서 VSTM 파일 병합 단계" %}}
...
+ Diagram 클래스의 인스턴스로 첫 번째 VSTM 파일을 로드합니다.
...
{{% blocks/products/pf/agp/code-block title="VSTM 파일 병합 - Java" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram은(는) Microsoft Visio 문서 형식 조작API입니다. daigram 요소를 포함하여 쉽게 로드, 생성, 수정, 조작하고 Visio 다이어그램을 PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF 등과 같은 다른 형식으로 변환할 수 있습니다. 독립 실행형 API이며 Microsoft Visio 또는 기타 소프트웨어를 설치할 필요가 없습니다.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="온라인 VSTM 합병 라이브 데모" sectionDescription="지금 바로 VSTM 문서를 방문하여 병합하십시오. [라이브 데모 웹사이트](https://products.aspose.app/diagram/merger). 라이브 데모에는 다음과 같은 이점이 있습니다." >}}
