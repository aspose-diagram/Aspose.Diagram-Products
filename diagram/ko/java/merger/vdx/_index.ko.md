---
title: Java을(를) 통해 VDX 파일 병합 
weight: 1830
url: /ko/java/merger/vdx/ 
description: JSP/JSF 애플리케이션 및 데스크톱 애플리케이션용 Java 런타임 환경에서 VDX 문서를 결합하는 Java 샘플 코드.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Java에서 VDX 파일을 병합하는 단계" %}}
