---
title: Visa VDW-filformat via Python 
weight: 3480
url: /sv/python-java/viewer/vdw/ 
description: Python källkod för att ladda, rendera och visa VDW-dokument i valfri Python-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDW File Viewer för Python" h2="Inbyggd VDW-dokumentvisare med Python API:er på serversidan." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att visa VDW via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python-kod för att visa VDW" offSpacer="" %}}

```cs

// ladda VDW-fil via en instans av Diagram
diagram =  Aspose.Diagram.Diagram("template.vdw");
// konvertera VDW till HTML-format och ladda sedan resulterande HTML i standardwebbläsaren
