---
title: Visa VSDX filformat via Python 
weight: 3480
url: /sv/python-java/viewer/vsdx/ 
description: Python källkod för att ladda, rendera och visa VSDX dokument i valfri Python-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSDX Filvisare för Python" h2="Inbyggd VSDX dokumentvisare som använder API:er på serversidan Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att visa VSDX via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python kod för att visa VSDX" offSpacer="" %}}

```cs

// ladda VSDX fil via en instans av Diagram
diagram =  Aspose.Diagram.Diagram("template.vsdx");
// konvertera VSDX till HTML-format och ladda sedan resulterande HTML i standardwebbläsaren
