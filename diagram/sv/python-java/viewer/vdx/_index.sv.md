---
title: Visa VDX filformat via Python 
weight: 3480
url: /sv/python-java/viewer/vdx/ 
description: Python källkod för att ladda, rendera och visa VDX dokument i valfri Python-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VDX Filvisare för Python" h2="Inbyggd VDX dokumentvisare som använder API:er på serversidan Python." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att visa VDX via Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Python kod för att visa VDX" offSpacer="" %}}

```cs

// ladda VDX fil via en instans av Diagram
diagram =  Aspose.Diagram.Diagram("template.vdx");
// konvertera VDX till HTML-format och ladda sedan resulterande HTML i standardwebbläsaren
