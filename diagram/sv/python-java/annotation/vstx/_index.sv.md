---
title: Lägg till, redigera och ta bort anteckning från VSTX via Python 
weight: 3250
url: /sv/python-java/annotation/vstx/ 
description: Python källkod för att kommentera VSTX-fil i valfri Python-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Annotera VSTX-format i Python" h2="Inbyggd VSTX dokumentkommentar med hjälp av Python API:er på serversidan." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Python" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här kommenterar du VSTX filer med Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Anteckna VSTX filer - Python" offSpacer="" %}}
