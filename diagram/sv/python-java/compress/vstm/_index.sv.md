...
{{% blocks/products/pf/agp/content h2="Så här komprimerar du VSTM-filer med Python" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att komprimera VSTM filer i Python" %}}
...
{{% blocks/products/pf/agp/code-block title="Komprimera VSTM filer - Python" offSpacer="" %}}
