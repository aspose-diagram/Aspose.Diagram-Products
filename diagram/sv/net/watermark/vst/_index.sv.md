---
title: Vattenstämpel VST-dokument via .NET 
weight: 3050
url: /sv/net/watermark/vst/ 
description: C# källkod för att lägga till vattenstämpel till vst-fil på .NET Framework, .NET Core, Mono Platforms.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lägg till textvattenstämpel till VST i C#" h2="Inbyggt och högpresterande VST-dokumentvattenmärke med hjälp av API:er på serversidan Aspose.Diagram for .NET, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man vattenmärker VST-fil med C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för vattenmärkning av VST-filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vattenstämpel VST-filer - C#" offSpacer="" %}}
