---
title: Vattenstämpel VSDX dokument via .NET 
weight: 3050
url: /sv/net/watermark/vsdx/ 
description: C# källkod för att lägga till vattenstämpel i filen vsdx på .NET Framework, .NET Core, Mono plattformar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lägg till textvattenstämpel till VSDX i C#" h2="Inbyggd och högpresterande VSDX dokumentvattenstämpel med hjälp av API:er på serversidan Aspose.Diagram for .NET, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man vattenstämplar VSDX-fil med C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för vattenmärkning av VSDX-filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Vattenstämpel VSDX-filer - C#" offSpacer="" %}}
