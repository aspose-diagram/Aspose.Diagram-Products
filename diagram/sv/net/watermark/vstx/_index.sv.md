...
description: C# källkod för att lägga till vattenstämpel i filen vstx på .NET Framework, .NET Core, Mono plattformar.
---
...
{{% blocks/products/pf/agp/content h2="Hur man vattenstämplar VSTX-fil med C#" %}}
