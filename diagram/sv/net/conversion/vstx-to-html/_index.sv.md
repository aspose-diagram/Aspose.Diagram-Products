---
title: Konvertera VSTX till HTML via C# 
weight: 5300
url: /sv/net/conversion/vstx-to-html/ 
description: Exempelkod för konvertering från VSTX till HTML C#. Använd API exempelkod för batch VSTX-filer till HTML-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VSTX till HTML via C#" h2="Exportera Microsoft® Visio VSTX-filer till HTML på .NET Framework, .NET Core, Mono eller COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="HTML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSTX till HTML med C#" %}}

 För att konvertera VSTX till HTML kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSTX till HTML via C#" %}}
...
1. Ladda VSTX-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.HTML som parametrar1. HTML-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSTX till HTML C#-konvertering" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSTX till HTML" sectionDescription="Kolla in våra livedemos för [VSTX till HTML-konvertering](https://products.aspose.app/diagram/conversion/vstx-to-html) med följande förmåner." >}}
