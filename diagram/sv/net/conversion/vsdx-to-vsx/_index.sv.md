...
description: Exempelkod för konvertering från VSDX till VSX C#. Använd API exempelkod för batch-VSDX-filer till VSXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSDX till VSX med C#" %}}
 ...
 För att konvertera VSDX till VSX använder vi
...
1. Ladda filen VSDX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSX som parametrar1. VSX fil kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSDX till VSX" sectionDescription="Kolla in våra livedemos för [VSDX till VSX omvandling](https://products.aspose.app/diagram/conversion/vsdx-to-vsx) med följande förmåner." >}}
