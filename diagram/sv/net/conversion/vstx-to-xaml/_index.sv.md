---
title: Konvertera VSTX till XAML via C# 
weight: 2280
url: /sv/net/conversion/vstx-to-xaml/ 
description: Exempelkod för konvertering från VSTX till XAML C#. Använd API exempelkod för batch-VSTX-filer till XAML-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VSTX till XAML via C#" h2="Exportera Microsoft® Visio VSTX-filer till XAML på .NET Framework, .NET Core, Mono eller COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="XAML" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSTX till XAML med C#" %}}

 För att konvertera VSTX till XAML kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSTX till XAML via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-utvecklare kan enkelt ladda och konvertera VSTX-filer till XAML på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda filen VSTX med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.XAML som parametrar1. XAML-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSTX till XAML C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSTX till XAML" sectionDescription="Kolla in våra livedemos för [VSTX till XAML-konvertering](https://products.aspose.app/diagram/conversion/vstx-to-xaml) med följande förmåner." >}}
