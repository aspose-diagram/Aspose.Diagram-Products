...
description: Exempelkod för konvertering från VSDX till VSDM C#. Använd API exempelkod för batch-VSDX-filer till VSDMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSDX till VSDM med C#" %}}
 ...
 För att konvertera VSDX till VSDM använder vi
...
1. Ladda filen VSDX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSDM som parametrar1. VSDM fil kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSDX till VSDM" sectionDescription="Kolla in våra livedemos för [VSDX till VSDM omvandling](https://products.aspose.app/diagram/conversion/vsdx-to-vsdm) med följande förmåner." >}}
