...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till VSX med C#" %}}

 För att konvertera VSSX till VSX använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSSX till VSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-utvecklare kan enkelt ladda och konvertera VSSX-filer till VSX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda filen VSSX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSX som parametrar1. VSX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSX till VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSSX till VSX" sectionDescription="Kolla in våra livedemos för [VSSX till VSX omvandling](https://products.aspose.app/diagram/conversion/vssx-to-vsx) med följande förmåner." >}}
