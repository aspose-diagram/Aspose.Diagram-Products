...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSTX till VSDX med C#" %}}

 För att konvertera VSTX till VSDX använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSTX till VSDX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-utvecklare kan enkelt ladda och konvertera VSTX-filer till VSDX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda filen VSTX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSDX som parametrar1. VSDX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSTX till VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSTX till VSDX" sectionDescription="Kolla in våra livedemos för [VSTX till VSDX omvandling](https://products.aspose.app/diagram/conversion/vstx-to-vsdx) med följande förmåner." >}}
