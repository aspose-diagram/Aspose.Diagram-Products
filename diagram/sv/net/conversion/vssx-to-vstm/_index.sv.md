...
description: Exempelkod för konvertering från VSSX till VSTM C#. Använd API exempelkod för batch-VSSX-filer till VSTMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till VSTM med C#" %}}
 ...
 För att konvertera VSSX till VSTM använder vi
...
1. Ladda filen VSSX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTM som parametrar1. VSTM fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSX till VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSSX till VSTM" sectionDescription="Kolla in våra livedemos för [VSSX till VSTM omvandling](https://products.aspose.app/diagram/conversion/vssx-to-vstm) med följande förmåner." >}}
