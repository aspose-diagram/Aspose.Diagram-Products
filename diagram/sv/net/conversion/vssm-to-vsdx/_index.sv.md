...
description: Exempelkod för konvertering från VSSM till VSDX C#. Använd API exempelkod för batch-VSM-filer till VSDXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
1. Ladda VSSM-fil med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSDX som parametrar1. VSDX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSSM till VSDX C# omvandling" offSpacer="" %}}
