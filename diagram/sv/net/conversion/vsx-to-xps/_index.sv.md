...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSX till XPS med C#" %}}
 ...
 För att konvertera VSX till XPS använder vi
...
1. Ladda filen VSX med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.XPS som parametrar1. XPS-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSX till XPS C#" offSpacer="" %}}
