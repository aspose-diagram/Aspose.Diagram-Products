...
description: Exempelkod för konvertering från VSSX till VSTX C#. Använd API exempelkod för batch-VSSX-filer till VSTXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till VSTX med C#" %}}
 ...
 För att konvertera VSSX till VSTX använder vi
...
1. Ladda filen VSSX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTX som parametrar1. VSTX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSX till VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSSX till VSTX" sectionDescription="Kolla in våra livedemos för [VSSX till VSTX omvandling](https://products.aspose.app/diagram/conversion/vssx-to-vstx) med följande förmåner." >}}
