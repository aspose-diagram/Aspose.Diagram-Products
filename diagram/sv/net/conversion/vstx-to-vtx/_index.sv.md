...
description: Exempelkod för konvertering från VSTX till VTX C#. Använd API exempelkod för batch-VSTX-filer till VTXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSTX till VTX med C#" %}}
 ...
 För att konvertera VSTX till VTX använder vi
...
1. Ladda filen VSTX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VTX som parametrar1. VTX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSTX till VTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSTX till VTX" sectionDescription="Kolla in våra livedemos för [VSTX till VTX omvandling](https://products.aspose.app/diagram/conversion/vstx-to-vtx) med följande förmåner." >}}
