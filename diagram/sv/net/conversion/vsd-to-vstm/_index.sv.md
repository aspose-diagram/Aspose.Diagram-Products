...
description: Exempelkod för konvertering från VSD till VSTM C#. Använd API exempelkod för batch-VSD-filer till VSTMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSD till VSTM med C#" %}}
 ...
 För att konvertera VSD till VSTM använder vi
...
1. Ladda filen VSD med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTM som parametrar1. VSTM fil kommer att sparas på den angivna sökvägen
