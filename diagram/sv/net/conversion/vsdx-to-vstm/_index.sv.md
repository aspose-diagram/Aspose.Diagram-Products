...
description: Exempelkod för konvertering från VSDX till VSTM C#. Använd API exempelkod för batch-VSDX-filer till VSTMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSDX till VSTM med C#" %}}
 ...
 För att konvertera VSDX till VSTM använder vi
...
1. Ladda filen VSDX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTM som parametrar1. VSTM fil kommer att sparas på den angivna sökvägen
