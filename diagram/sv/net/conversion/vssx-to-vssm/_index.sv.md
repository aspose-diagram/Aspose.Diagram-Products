...
description: Exempelkod för konvertering från VSSX till VSSM C#. Använd API exempelkod för batch-VSSX-filer till VSSMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till VSSM med C#" %}}
 ...
 För att konvertera VSSX till VSSM använder vi
...
1. Ladda filen VSSX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSSM som parametrar1. VSSM fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSX till VSSM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSSX till VSSM" sectionDescription="Kolla in våra livedemos för [VSSX till VSSM omvandling](https://products.aspose.app/diagram/conversion/vssx-to-vssm) med följande förmåner." >}}
