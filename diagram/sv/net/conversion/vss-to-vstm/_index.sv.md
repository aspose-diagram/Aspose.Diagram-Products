...
description: Exempelkod för konvertering från VSS till VSTM C#. Använd API exempelkod för batch-VSS-filer till VSTMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
1. Ladda VSS-fil med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTM som parametrar1. VSTM fil kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSS till VSTM" sectionDescription="Kolla in våra livedemos för [VSS till VSTM omvandling](https://products.aspose.app/diagram/conversion/vss-to-vstm) med följande förmåner." >}}
