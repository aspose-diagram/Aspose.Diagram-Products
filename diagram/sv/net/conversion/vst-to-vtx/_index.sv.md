...
description: Exempelkod för konvertering från VST till VTX C#. Använd API exempelkod för batch-VST-filer till VTXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VST till VTX med C#" %}}
 ...
 För att konvertera VST till VTX använder vi
...
1. Ladda VST-fil med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VTX som parametrar1. VTX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VST till VTX C#-omvandling" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VST till VTX" sectionDescription="Kolla in våra livedemos för [VST till VTX omvandling](https://products.aspose.app/diagram/conversion/vst-to-vtx) med följande förmåner." >}}
