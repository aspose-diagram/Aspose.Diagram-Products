...
description: Exempelkod för konvertering från VST till VSSM C#. Använd API exempelkod för batch-VST-filer till VSSMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VST till VSSM med C#" %}}
 ...
 För att konvertera VST till VSSM använder vi
...
1. Ladda VST-fil med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSSM som parametrar1. VSSM fil kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VST till VSSM" sectionDescription="Kolla in våra livedemos för [VST till VSSM omvandling](https://products.aspose.app/diagram/conversion/vst-to-vssm) med följande förmåner." >}}
