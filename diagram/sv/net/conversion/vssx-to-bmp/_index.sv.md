---
title: Konvertera VSSX till BMP via C# 
weight: 2400
url: /sv/net/conversion/vssx-to-bmp/ 
description: Exempelkod för konvertering från VSSX till BMP C#. Använd API exempelkod för batch-VSSX-filer till BMP-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VSSX till BMP via C#" h2="Exportera Microsoft® Visio VSSX-filer till BMP på .NET Framework, .NET Core, Mono eller COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="BMP" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till BMP med C#" %}}

 För att konvertera VSSX till BMP kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSSX till BMP via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-utvecklare kan enkelt ladda och konvertera VSSX-filer till BMP på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda filen VSSX med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.BMP som parametrar1. BMP-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSX till BMP C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSSX till BMP" sectionDescription="Kolla in våra livedemos för [VSSX till BMP-konvertering](https://products.aspose.app/diagram/conversion/vssx-to-bmp) med följande förmåner." >}}
