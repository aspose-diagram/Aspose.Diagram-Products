...
description: Exempelkod för konvertering från VSTX till VSSM C#. Använd API exempelkod för batch-VSTX-filer till VSSMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSTX till VSSM med C#" %}}
 ...
 För att konvertera VSTX till VSSM använder vi
...
1. Ladda filen VSTX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSSM som parametrar1. VSSM fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSTX till VSSM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSTX till VSSM" sectionDescription="Kolla in våra livedemos för [VSTX till VSSM omvandling](https://products.aspose.app/diagram/conversion/vstx-to-vssm) med följande förmåner." >}}
