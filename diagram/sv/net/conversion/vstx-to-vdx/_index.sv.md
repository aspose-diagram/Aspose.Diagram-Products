...
description: Exempelkod för konvertering från VSTX till VDX C#. Använd API exempelkod för batch-VSTX-filer till VDXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSTX till VDX med C#" %}}
 ...
 För att konvertera VSTX till VDX använder vi
...
1. Ladda filen VSTX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VDX som parametrar1. VDX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSTX till VDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSTX till VDX" sectionDescription="Kolla in våra livedemos för [VSTX till VDX omvandling](https://products.aspose.app/diagram/conversion/vstx-to-vdx) med följande förmåner." >}}
