...
description: Exempelkod för konvertering från VSSM till VSTX C#. Använd API exempelkod för batch-VSSM-filer till VSTXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSM till VSTX med C#" %}}
 ...
 För att konvertera VSSM till VSTX använder vi
...
1. Ladda filen VSSM med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTX som parametrar1. VSTX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSM till VSTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSSM till VSTX" sectionDescription="Kolla in våra livedemos för [VSSM till VSTX omvandling](https://products.aspose.app/diagram/conversion/vssm-to-vstx) med följande förmåner." >}}
