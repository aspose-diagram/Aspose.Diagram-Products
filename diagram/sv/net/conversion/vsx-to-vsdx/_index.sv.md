...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSX till VSDX med C#" %}}
 ...
 För att konvertera VSX till VSDX använder vi
...
1. Ladda filen VSX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSDX som parametrar1. VSDX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSX till VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSX till VSDX" sectionDescription="Kolla in våra livedemos för [VSX till VSDX omvandling](https://products.aspose.app/diagram/conversion/vsx-to-vsdx) med följande förmåner." >}}
