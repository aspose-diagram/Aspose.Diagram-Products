...
description: Exempelkod för konvertering från VSS till VSTX C#. Använd API exempelkod för batch-VSS-filer till VSTXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
1. Ladda VSS-fil med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTX som parametrar1. VSTX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSS till VSTX C#-omvandling" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSS till VSTX" sectionDescription="Kolla in våra livedemos för [VSS till VSTX omvandling](https://products.aspose.app/diagram/conversion/vss-to-vstx) med följande förmåner." >}}
