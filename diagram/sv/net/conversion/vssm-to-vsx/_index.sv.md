---
title: Konvertera VSSM till VSX via C# 
weight: 540
url: /sv/net/conversion/vssm-to-vsx/ 
description: Exempelkod för konvertering från VSSM till VSX C#. Använd API exempelkod för batch-VSSM-filer till VSXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VSSM till VSX via C#" h2="Exportera Microsoft® Visio VSSM-filer till VSX på .NET Framework, .NET Core, Mono eller COM Interop." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSSM" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSM till VSX med C#" %}}

 För att konvertera VSSM till VSX använder vi
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSSM till VSX via C#" %}}

{{% blocks/products/pf/agp/text %}}

 .NET-utvecklare kan enkelt ladda och konvertera VSSM-filer till VSX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda filen VSSM med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSX som parametrar1. VSX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSM till VSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSSM till VSX" sectionDescription="Kolla in våra livedemos för [VSSM till VSX omvandling](https://products.aspose.app/diagram/conversion/vssm-to-vsx) med följande förmåner." >}}
