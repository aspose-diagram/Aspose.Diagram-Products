...
description: Exempelkod för konvertering från VSD till VSTX C#. Använd API exempelkod för batch-VSD-filer till VSTXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSD till VSTX med C#" %}}
 ...
 För att konvertera VSD till VSTX använder vi
...
1. Ladda filen VSD med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTX som parametrar1. VSTX fil kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSD till VSTX" sectionDescription="Kolla in våra livedemos för [VSD till VSTX omvandling](https://products.aspose.app/diagram/conversion/vsd-to-vstx) med följande förmåner." >}}
