...
description: Exempelkod för konvertering från VSDX till VSSM C#. Använd API exempelkod för batch-VSDX-filer till VSSMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
1. Ladda filen VSDX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSSM som parametrar1. VSSM fil kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSDX till VSSM" sectionDescription="Kolla in våra livedemos för [VSDX till VSSM omvandling](https://products.aspose.app/diagram/conversion/vsdx-to-vssm) med följande förmåner." >}}
