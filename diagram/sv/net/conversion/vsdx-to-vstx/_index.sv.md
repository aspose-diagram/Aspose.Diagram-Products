...
description: Exempelkod för konvertering från VSDX till VSTX C#. Använd API exempelkod för batch-VSDX-filer till VSTXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSDX till VSTX med C#" %}}
 ...
 För att konvertera VSDX till VSTX använder vi
...
1. Ladda filen VSDX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTX som parametrar1. VSTX fil kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSDX till VSTX" sectionDescription="Kolla in våra livedemos för [VSDX till VSTX omvandling](https://products.aspose.app/diagram/conversion/vsdx-to-vstx) med följande förmåner." >}}
