...
description: Exempelkod för konvertering från VSX till VSTM C#. Använd API exempelkod för batch-VSX-filer till VSTMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSX till VSTM med C#" %}}
 ...
 För att konvertera VSX till VSTM använder vi
...
1. Ladda filen VSX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTM som parametrar1. VSTM fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSX till VSTM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSX till VSTM" sectionDescription="Kolla in våra livedemos för [VSX till VSTM omvandling](https://products.aspose.app/diagram/conversion/vsx-to-vstm) med följande förmåner." >}}
