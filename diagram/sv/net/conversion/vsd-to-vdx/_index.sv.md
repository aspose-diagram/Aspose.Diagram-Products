...
description: Exempelkod för konvertering från VSD till VDX C#. Använd API exempelkod för batch-VSD-filer till VDXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSD till VDX med C#" %}}
 ...
 För att konvertera VSD till VDX använder vi
...
1. Ladda filen VSD med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VDX som parametrar1. VDX fil kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSD till VDX" sectionDescription="Kolla in våra livedemos för [VSD till VDX omvandling](https://products.aspose.app/diagram/conversion/vsd-to-vdx) med följande förmåner." >}}
