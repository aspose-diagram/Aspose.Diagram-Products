...
description: Exempelkod för konvertering från VSSX till VSDM C#. Använd API exempelkod för batch-VSSX-filer till VSDMkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till VSDM med C#" %}}
 ...
 För att konvertera VSSX till VSDM använder vi
...
1. Ladda filen VSSX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSDM som parametrar1. VSDM fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSX till VSDM C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSSX till VSDM" sectionDescription="Kolla in våra livedemos för [VSSX till VSDM omvandling](https://products.aspose.app/diagram/conversion/vssx-to-vsdm) med följande förmåner." >}}
