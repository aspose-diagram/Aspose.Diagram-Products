...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till VSDX med C#" %}}
 ...
 För att konvertera VSSX till VSDX använder vi
...
1. Ladda filen VSSX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSDX som parametrar1. VSDX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSX till VSDX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSSX till VSDX" sectionDescription="Kolla in våra livedemos för [VSSX till VSDX omvandling](https://products.aspose.app/diagram/conversion/vssx-to-vsdx) med följande förmåner." >}}
