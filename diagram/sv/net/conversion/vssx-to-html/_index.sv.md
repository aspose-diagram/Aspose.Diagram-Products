...
description: Exempelkod för konvertering från VSSX till HTML C#. Använd API exempelkod för batch-VSSX-filer till HTML-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till HTML med C#" %}}
 ...
 För att konvertera VSSX till HTML använder vi
...
1. Ladda filen VSSX med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.HTML som parametrar1. HTML-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSX till HTML C#" offSpacer="" %}}
