...
description: Exempelkod för konvertering från VSSM till TIFF C#. Använd API exempelkod för batch-VSM-filer till TIFF-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSM till TIFF med C#" %}}
 ...
 För att konvertera VSSM till TIFF kommer vi att använda
...
1. Ladda VSSM-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.TIFF som parametrar1. TIFF-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSSM till TIFF C#-konvertering" offSpacer="" %}}
