...
description: Exempelkod för konvertering från VST till VSTX C#. Använd API exempelkod för batch-VST-filer till VSTXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VST till VSTX med C#" %}}
 ...
 För att konvertera VST till VSTX använder vi
...
1. Ladda VST-fil med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSTX som parametrar1. VSTX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VST till VSTX C#-omvandling" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VST till VSTX" sectionDescription="Kolla in våra livedemos för [VST till VSTX omvandling](https://products.aspose.app/diagram/conversion/vst-to-vstx) med följande förmåner." >}}
