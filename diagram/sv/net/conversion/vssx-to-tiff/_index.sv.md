...
description: Exempelkod för konvertering från VSSX till TIFF C#. Använd API exempelkod för batch-VSSX-filer till TIFF-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till TIFF med C#" %}}
 ...
 För att konvertera VSSX till TIFF använder vi
...
1. Ladda filen VSSX med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.TIFF som parametrar1. TIFF-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSX till TIFF C#" offSpacer="" %}}
