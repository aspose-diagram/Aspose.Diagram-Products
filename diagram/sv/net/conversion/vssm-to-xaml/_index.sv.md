...
description: Exempelkod för konvertering från VSSM till XAML C#. Använd API exempelkod för batch-VSM-filer till XAML-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
1. Ladda VSSM-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.XAML som parametrar1. XAML-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSSM till XAML C#-konvertering" offSpacer="" %}}
