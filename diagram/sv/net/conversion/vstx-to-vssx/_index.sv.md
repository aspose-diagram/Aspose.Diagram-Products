...
description: Exempelkod för konvertering från VSTX till VSSX C#. Använd API exempelkod för batch-VSTX-filer till VSSXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSTX till VSSX med C#" %}}
 ...
 För att konvertera VSTX till VSSX använder vi
...
1. Ladda filen VSTX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VSSX som parametrar1. VSSX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSTX till VSSX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSTX till VSSX" sectionDescription="Kolla in våra livedemos för [VSTX till VSSX omvandling](https://products.aspose.app/diagram/conversion/vstx-to-vssx) med följande förmåner." >}}
