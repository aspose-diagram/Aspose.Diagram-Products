...
description: Exempelkod för konvertering från VSSX till VTX C#. Använd API exempelkod för batch-VSSX-filer till VTXkonvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till VTX med C#" %}}
 ...
 För att konvertera VSSX till VTX använder vi
...
1. Ladda filen VSSX med en instans av klassen Diagram1. Anropa Diagram.Save-metoden med utdatafilsökväg och SaveFileFormat.VTX som parametrar1. VTX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar omvandling från VSSX till VTX C#" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSSX till VTX" sectionDescription="Kolla in våra livedemos för [VSSX till VTX omvandling](https://products.aspose.app/diagram/conversion/vssx-to-vtx) med följande förmåner." >}}
