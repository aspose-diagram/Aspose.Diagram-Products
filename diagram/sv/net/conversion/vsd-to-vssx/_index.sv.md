...
description: Exempelkod för konvertering från VSD till VSSX C#. Använd API exempelkod för batch-VSD-filer till VSSX-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
1. Ladda filen VSD med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.VSSX som parametrar1. VSSX-filen kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att konvertera VSD till VSSX" sectionDescription="Kolla in våra livedemos för [VSD till VSSX-konvertering](https://products.aspose.app/diagram/conversion/vsd-to-vssx) med följande förmåner." >}}
