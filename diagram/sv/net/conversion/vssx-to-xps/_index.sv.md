...
description: Exempelkod för konvertering av VSSX till XPS C#. Använd API exempelkod för batch-VSSX-filer till XPS-konvertering inom VB.NET, Asp.NET eller någon .NET-baserad applikation.
---
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSSX till XPS med C#" %}}
 ...
 För att konvertera VSSX till XPS kommer vi att använda
...
1. Ladda VSSX-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med utdatafilsökväg och SaveFileFormat.XPS som parametrar1. XPS-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="Den här exempelkoden visar VSSX till XPS C#-konvertering" offSpacer="" %}}
