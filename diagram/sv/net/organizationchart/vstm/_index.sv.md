---
title: Skapa organisationsdiagram i VSTM dokument via .NET 
weight: 3050
url: /sv/net/organizationchart/vstm/ 
description: C# källkod för att skapa organisationsdiagram i filen vstm på .NET Framework, .NET Core, Mono plattformar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Skapa organisationsdiagram i VSTM i C#" h2="Inbyggda och högpresterande skapa organisationsdiagram i VSTM dokument med hjälp av server-side Aspose.Diagram for .NET API:er, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här skapar du organisationsdiagram i VSTM-fil med C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att skapa organisationsschema i VSTM Filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Skapa organisationsschema i VSTM filer - C#" offSpacer="" %}}
