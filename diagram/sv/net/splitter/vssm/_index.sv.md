---
title: Dela VSSM filer via .NET 
weight: 1300
url: /sv/net/splitter/vssm/ 
description: C# källkod till Split vssm-fil på .NET Framework, .NET Core, Mono Plattformar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Dela upp VSSM i C#" h2="Inbyggd och högpresterande VSSM dokumentdelare med hjälp av API:er på serversidan Aspose.Diagram for .NET, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man delar upp VSSM fil med C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att dela upp VSSM filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Dela upp VSSM filer - C#" offSpacer="" %}}
