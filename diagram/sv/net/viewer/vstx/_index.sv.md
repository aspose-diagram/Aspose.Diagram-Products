...
{{< blocks/products/pf/i18n/upper-banner h1="VSTX File Viewer for .NET" h2="Visa Microsoft Visio VSTX-filer i webbläsaren utan att behöva Visio-program eller Office Automation." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTX" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här visar du VSTX-fil med C#" %}}
 ...
 För att visa VSTX-filen kommer vi att använda
...
{{% blocks/products/pf/agp/text %}}
 ...
 Aspose.Diagram gör det enkelt för utvecklarna att se VSTX-filen med bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VSTX-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med SaveFileFormat.HTML som parametrar1. Ladda resulterande HTML i standardwebbläsaren via Process.Start
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram är en Microsoft Visio dokumentformatmanipulation API. Man kan enkelt ladda, skapa, ändra, manipulera inklusive daigramelement och konvertera Visio-diagram till andra format som PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF och mer. Det är en fristående API och kräver inte att Microsoft Visio eller någon annan programvara installeras.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att se VSTX" sectionDescription="Kolla våra livedemos för att [Se VSTX](https://products.aspose.app/diagram/viewer/vstx) med följande förmåner." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp VSTX-fil och tryck på \"Visa\"-knappen" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Ladda ner VSTX-fil från länken om det behövs" >}}
