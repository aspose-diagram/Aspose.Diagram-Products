---
title: Visa VSTM-filformat via .NET 
weight: 2230
url: /sv/net/viewer/vstm/ 
description: C# källkod för att ladda, rendera och visa VSTM-dokument på .NET Framework, .NET Core, Mono eller COM Interop.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="VSTM File Viewer for .NET" h2="Visa Microsoft Visio VSTM-filer i webbläsaren utan att behöva Visio-program eller Office Automation." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Så här visar du VSTM-fil med C#" %}}
 ...
 För att visa VSTM-filen kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att visa VSTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Aspose.Diagram gör det enkelt för utvecklarna att se VSTM-filen med bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VSTM-fil med en instans av klassen Diagram1. Anropa metoden Diagram.Save med SaveFileFormat.HTML som parametrar1. Ladda resulterande HTML i standardwebbläsaren via Process.Start
...
{{% blocks/products/pf/agp/code-block title="C#-kod för att visa VSTM" offSpacer="" %}}

```cs

// ladda VSTM-fil via en instans av Diagram
var diagram = new Aspose.Diagram.Diagram("template.vstm");
// konvertera VSTM till HTML-format
...
<!-- aboutfile Starts -->
 ...
 Aspose.Diagram är en Microsoft Visio dokumentformatmanipulation API. Man kan enkelt ladda, skapa, ändra, manipulera inklusive daigramelement och konvertera Visio-diagram till andra format som PDF, XPS, JPEG, PNG, BMP, TIFF, SVG, EMF och mer. Det är en fristående API och kräver inte att Microsoft Visio eller någon annan programvara installeras.  
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Gratis app för att se VSTM" sectionDescription="Kolla våra livedemos för att [Se VSTM](https://products.aspose.app/diagram/viewer/vstm) med följande förmåner." >}}
            ...
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp VSTM-fil och tryck på \"Visa\"-knappen" >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text=" Ladda ner VSTM-fil från länken om det behövs" >}}
