---
title: Komprimera VSSM dokument via .NET 
weight: 3050
url: /sv/net/compress/vssm/ 
description: C# källkod för att komprimera vssm fil på .NET Framework, .NET Core, Mono plattformar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Komprimera VSSM i C#" h2="Inbyggd och högpresterande VSSM-dokumentkomprimering med hjälp av Aspose.Diagram for .NET-API:er på serversidan, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här komprimerar du VSSM-fil med C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att komprimera VSSM filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Komprimera VSSM filer - C#" offSpacer="" %}}
