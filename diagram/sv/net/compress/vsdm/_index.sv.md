---
title: Komprimera VSDM dokument via .NET 
weight: 3050
url: /sv/net/compress/vsdm/ 
description: C# källkod för att komprimera vsdm fil på .NET Framework, .NET Core, Mono plattformar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Komprimera VSDM i C#" h2="Inbyggd och högpresterande VSDM-dokumentkomprimering med hjälp av Aspose.Diagram for .NET-API:er på serversidan, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här komprimerar du VSDM-fil med C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Komprimera VSDM filer - C#" offSpacer="" %}}
