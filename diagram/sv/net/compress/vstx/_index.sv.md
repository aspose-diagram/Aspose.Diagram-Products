---
title: Komprimera VSTX dokument via .NET 
weight: 3050
url: /sv/net/compress/vstx/ 
description: C# källkod för att komprimera vstx fil på .NET Framework, .NET Core, Mono plattformar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Komprimera VSTX i C#" h2="Inbyggd och högpresterande VSTX-dokumentkomprimering med hjälp av Aspose.Diagram for .NET-API:er på serversidan, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här komprimerar du VSTX-fil med C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Komprimera VSTX filer - C#" offSpacer="" %}}
