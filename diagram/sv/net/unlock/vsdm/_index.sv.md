---
title: Lås upp VSDM dokument via .NET 
weight: 5680
url: /sv/net/unlock/vsdm/ 
description: C# källkod för att låsa upp filen VSDM på .NET Framework, .NET Core, Mono plattformar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Lås upp VSDM filer via C#" h2="Ta bort skyddet från Visio inklusive formatet VSDM med hjälp av .NET bibliotek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här låser du upp VSDM-fil med C#" %}}

 För att låsa upp VSDM fil kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att låsa upp VSDM filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Lås upp VSDM filer - C#" offSpacer="" %}}
