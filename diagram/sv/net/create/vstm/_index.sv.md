...
{{% blocks/products/pf/agp/feature-section-col title="Så här skapar du VSTM via C#" %}}

{{% blocks/products/pf/agp/text %}}

 Det är lätt för utvecklarna att skapa, läsa in, ändra och konvertera VSTM i att köra olika rapporteringsapplikationer för databehandling på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Inkludera namnområdet i din klassfil1. Skapa Diagram klassinstans.1. Öppna den första sidan av diagram.1. Lägg till text på sidan.1. Använd metoden Spara för att spara diagram som VSTM-fil.
