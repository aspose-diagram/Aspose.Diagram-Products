---
title: Rita geomtry till VSTM dokument via .NET 
weight: 3050
url: /sv/net/drawing/vstm/ 
description: C# källkod för att rita geomtry till vstm fil på .NET Framework, .NET Core, Mono plattformar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Rita Geomtry till VSTM i C#" h2="Inbyggd och högpresterande ritar geometri till VSTMdokument med hjälp av Aspose.Diagram for .NET API:er på serversidan, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man ritar Geomtry till VSTM fil med C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för Rita Geomtry till VSTM filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Rita Geomtry till VSTM filer - C#" offSpacer="" %}}
