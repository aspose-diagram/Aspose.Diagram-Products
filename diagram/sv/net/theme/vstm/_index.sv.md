---
title: Använd förinställt tema på VSTM dokument via .NET 
weight: 3050
url: /sv/net/theme/vstm/ 
description: C# källkod för att tillämpa förinställt tema på vstm-filen på .NET Framework, .NET Core, Mono-plattformar.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Använd förinställt tema på VSTM i C#" h2="Inbyggt och högpresterande tillämpar förinställt tema på VSTM dokument med hjälp av API:er på serversidan Aspose.Diagram for .NET, utan användning av någon programvara som Microsoft eller Open Office, Adobe PDF." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här använder du förinställt tema på VSTM fil med C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att tillämpa förinställt tema på VSTM filer i C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Använd förinställt tema på VSTM filer - C#" offSpacer="" %}}
