...
{{< blocks/products/pf/carousel-item h3="En överblick" description="En översikt över Aspose.Diagram för Node.js via Java funktioner." >}}
...
{{< blocks/products/pf/carousel-item h3="Plattformsoberoende" description="Aspose.Diagram för Node.js via Java är JavaScript på serversidan API baserat på Node.js. Det kan köras på Windows, Unix/Linux och Mac-plattformar med JDK 1.6 eller högre." >}}
<div class="diagram1 d1-nodejs">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/carousel-item h3="Filformat som stöds" description="Aspose.Diagram för Node.js via Java stöder populära Microsoft Visio-format och mer." >}}
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Avancerade Node.js Visio API funktioner
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     Aspose.Diagram för Node.js är enkel och lätt att använda. Det låter användare arbeta med diagram utan någon förståelse för underliggande format som man kan skapa VSDX-filer från början med bara några rader kod.
    </p>
    <div class="codeblock" id="code">
     <h3>
      Skapa VSDX-format från Scratch med Node.js
     </h3>
...
diagram.save("output.vsdx", aspose.diagram.SaveFileFormat.VSDX);</code></pre>
   ...
   <div class="col-lg-12">
    ...
    <p>
     Utvecklare kan enkelt ladda Visio-filer och exportera dem till populära bilder inklusive PNG, TIFF, JPEG, BMP, SVG och EMF. Nodejs bibliotek stöder även export av Visio filer till PDF &amp; XPS-format med högsta kvalitet.
    </p>
    <div class="codeblock" id="code">
     <h3>
...
{{< blocks/products/pf/slr-element name="API Referenser" href="https://apireference.aspose.com/diagram/nodejs" >}}
