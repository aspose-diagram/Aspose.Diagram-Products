---
title: Slå ihop VSDM-filer via Java 
weight: 4810
url: /sv/java/merger/vsdm/ 
description: Java exempelkod för att kombinera VSDM-dokument på Java Runtime Environment för JSP/JSF Application och Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman VSDM-format i Java" h2="Native VSDM-dokumentsammanslagning med hjälp av Java API:er på serversidan." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDM" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man slår ihop VSDM-filer med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att slå ihop VSDM-filer i Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Slå samman VSDM-filer - Java" offSpacer="" %}}
