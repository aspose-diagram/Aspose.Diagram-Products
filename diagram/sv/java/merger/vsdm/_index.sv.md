---
title: Slå samman VSDM filer via Java 
weight: 4810
...
{{% blocks/products/pf/agp/content h2="Så här sammanfogar du VSDM-filer med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att slå samman VSDM filer i Java" %}}
