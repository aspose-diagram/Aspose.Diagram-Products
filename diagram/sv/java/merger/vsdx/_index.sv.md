---
title: Slå samman VSDX filer via Java 
weight: 760
url: /sv/java/merger/vsdx/ 
description: Java exempelkod för att kombinera VSDX dokument på Java Runtime Environment för JSP/JSF Application och Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Slå samman VSDX format i Java" h2="Inbyggd VSDX dokumentsammanslagning med hjälp av API:er på serversidan Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här sammanfogar du VSDX-filer med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att slå samman VSDX filer i Java" %}}
...
{{% blocks/products/pf/agp/code-block title="Slå samman VSDX filer - Java" offSpacer="" %}}
