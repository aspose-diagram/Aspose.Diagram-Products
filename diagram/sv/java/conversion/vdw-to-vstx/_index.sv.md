...
description: Exempel Java-konverteringskod för VDW-format till VSTX-fil. Använd den här exempelkoden för att konvertera VDW till VSTX i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VDW-fil till VSTX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VDW-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. VSTX-filen kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="VDW till VSTX Conversion Live Demos" sectionDescription="[Konvertera VDW till VSTX](https://products.aspose.app/diagram/conversion/vdw-to-vstx) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
