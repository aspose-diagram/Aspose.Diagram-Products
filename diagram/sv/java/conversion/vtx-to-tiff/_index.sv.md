...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VTX till TIFF med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VTX till TIFF via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera VTX-filen till TIFF på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VTX till TIFF Java Källkod för omvandling" offSpacer="" %}}
