...
description: Exempel på Java-konverteringskod för VSTM-format till VTX-fil. Använd den här exempelkoden för att konvertera VSTM till VTX i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSTM-filen till VTX på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VSTM till VTX Java Omvandlingskällkod" offSpacer="" %}}
