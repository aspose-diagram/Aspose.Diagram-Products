...
description: Exempel på Java-konverteringskod för VSSX-format till VDX-fil. Använd den här exempelkoden för att konvertera VSSX till VDX i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSSX-filen till VDX på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VSSX till VDX Java Omvandlingskällkod" offSpacer="" %}}
