...
description: Exempel Java-konverteringskod för VDW-format till VSDM-fil. Använd den här exempelkoden för att konvertera VDW till VSDM i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VDW-filer till VSDM på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VDW-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. VSDM-filen kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="VDW till VSDM Conversion Live Demos" sectionDescription="[Konvertera VDW till VSDM](https://products.aspose.app/diagram/conversion/vdw-to-vsdm) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
