...
description: Exempel på Java-konverteringskod för VTX-format till VSSM-fil. Använd den här exempelkoden för att konvertera VTX till VSSM i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VTX-filen till VSSM på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VTX till VSSM Java Omvandlingskällkod" offSpacer="" %}}
