...
description: Exempel på Java-konverteringskod för VSTM-format till VSSX-fil. Använd den här exempelkoden för att konvertera VSTM till VSSX i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSTM-filen till VSSX på bara några rader kod.
