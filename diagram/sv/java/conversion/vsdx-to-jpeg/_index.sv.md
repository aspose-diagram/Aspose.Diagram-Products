---
title: Konvertera VSDX till JPEG via Java 
weight: 5050
url: /sv/java/conversion/vsdx-to-jpeg/ 
description: Exempel på Java-konverteringskod för VSDX-format till JPEG-fil. Använd den här exempelkoden för att konvertera VSDX till JPEG i valfri webb- eller datorbaserad applikation Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VSDX till JPEG via Java" h2="Exportera Microsoft Visio VSDX till JPEG med inbyggt Java-bibliotek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="JPEG" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSDX till JPEG med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSDX till JPEG via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera VSDX-filen till JPEG på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VSDX till JPEG Java omvandlingskällkod" offSpacer="" %}}
