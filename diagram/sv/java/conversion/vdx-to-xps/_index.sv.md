---
title: Konvertera VDX till XPS via Java 
weight: 220
url: /sv/java/conversion/vdx-to-xps/ 
description: Exempel på konverteringskod från Java för formatet VDX till XPS-fil. Använd den här exempelkoden för att konvertera VDX till XPS i valfri webb- eller datorbaserad applikation Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VDX till XPS via Java" h2="Exportera Microsoft Visio VDX till XPS med inbyggt Java-bibliotek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VDX till XPS med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VDX till XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera VDX-filen till XPS på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VDX till XPS Java omvandlingskällkod" offSpacer="" %}}
