...
description: Exempel på konverteringskod från Java för formatet VSSX till XAML-fil. Använd den här exempelkoden för att konvertera VSSX till XAML i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSSX-filen till XAML på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VSSX till XAML Java Omvandlingskällkod" offSpacer="" %}}
