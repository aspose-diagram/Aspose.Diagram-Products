...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSSX-filen till EMF på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VSSX till EMF Java Källkod för omvandling" offSpacer="" %}}
