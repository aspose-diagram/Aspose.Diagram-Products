...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VDX-filen till VTX på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VDX till VTX Java Omvandlingskällkod" offSpacer="" %}}
