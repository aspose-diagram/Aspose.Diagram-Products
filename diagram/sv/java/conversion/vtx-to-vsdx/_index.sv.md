---
title: Konvertera VTX till VSDX via Java 
weight: 1270
url: /sv/java/conversion/vtx-to-vsdx/ 
description: Exempel på Java-konverteringskod för VTX-format till VSDX-fil. Använd den här exempelkoden för att konvertera VTX till VSDX i valfri webb- eller datorbaserad applikation Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VTX till VSDX via Java" h2="Exportera Microsoft Visio VTX till VSDX med inbyggt Java-bibliotek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VTX till VSDX med Java" %}}

 För att rendera VTX till VSDX kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VTX till VSDX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera VTX-filen till VSDX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VTX-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. VSDX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="VTX till VSDX Java omvandlingskälla" offSpacer="" %}}
