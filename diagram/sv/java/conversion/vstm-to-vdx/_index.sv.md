...
description: Exempel på Java-konverteringskod för VSTM-format till VDX-fil. Använd den här exempelkoden för att konvertera VSTM till VDX i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSTM-filen till VDX på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VSTM till VDX Java Omvandlingskällkod" offSpacer="" %}}
