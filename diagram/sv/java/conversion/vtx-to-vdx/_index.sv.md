...
description: Exempel på Java-konverteringskod för VTX-format till VDX-fil. Använd den här exempelkoden för att konvertera VTX till VDX i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VTX-filen till VDX på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VTX till VDX Java Omvandlingskällkod" offSpacer="" %}}
