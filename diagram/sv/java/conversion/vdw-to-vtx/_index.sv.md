...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VDW-filen till VTX på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VDW till VTX Java omvandlingskällkod" offSpacer="" %}}
