...
description: Exempel på Java-konverteringskod för VDX-format till VSDM-fil. Använd den här exempelkoden för att konvertera VDX till VSDM i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VDX-filen till VSDM på bara några rader kod.
