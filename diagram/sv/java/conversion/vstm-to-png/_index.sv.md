...
description: Exempel på konverteringskod från Java för formatet VSTM till PNG-fil. Använd den här exempelkoden för att konvertera VSTM till PNG i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSTM-filen till PNG på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VSTM till PNG Java Källkod för omvandling" offSpacer="" %}}
