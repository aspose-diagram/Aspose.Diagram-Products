---
title: Konvertera VSTM till XPS via Java 
weight: 4430
url: /sv/java/conversion/vstm-to-xps/ 
description: Exempel på konverteringskod från Java för formatet VSTM till XPS-fil. Använd den här exempelkoden för att konvertera VSTM till XPS i valfri webb- eller datorbaserad applikation Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VSTM till XPS via Java" h2="Exportera Microsoft Visio VSTM till XPS med inbyggt Java-bibliotek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="XPS" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VSTM till XPS med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VSTM till XPS via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera VSTM-filen till XPS på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VSTM till XPS Java omvandlingskällkod" offSpacer="" %}}
