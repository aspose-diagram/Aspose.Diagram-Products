---
title: Konvertera VDX till VSDX via Java 
weight: 1120
url: /sv/java/conversion/vdx-to-vsdx/ 
description: Exempel på Java-konverteringskod för VDX-format till VSDX-fil. Använd den här exempelkoden för att konvertera VDX till VSDX i valfri webb- eller datorbaserad applikation Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VDX till VSDX via Java" h2="Exportera Microsoft Visio VDX till VSDX med hjälp av det inbyggda Java-biblioteket." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSDX" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDX" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VDX till VSDX med Java" %}}

 För att rendera VDX till VSDX kommer vi att använda
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VDX till VSDX via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera VDX-filen till VSDX på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VDX-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. VSDX fil kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="VDX till VSDX Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Livedemonstrationer från VDX till VSDX" sectionDescription="[Konvertera VDX till VSDX](https://products.aspose.app/diagram/conversion/vdx-to-vsdx) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
