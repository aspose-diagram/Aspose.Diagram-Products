...
description: Exempel på konverteringskod från Java för formatet VTX till XPS-fil. Använd den här exempelkoden för att konvertera VTX till XPS i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/code-block title="VTX till XPS Java omvandlingskällkod" offSpacer="" %}}
