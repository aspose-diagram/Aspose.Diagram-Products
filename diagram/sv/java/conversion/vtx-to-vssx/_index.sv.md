...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VTX-filen till VSSX på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VTX till VSSX Java Omvandlingskällkod" offSpacer="" %}}
