...
description: Exempel på konverteringskod från Java för formatet VTX till XAML-fil. Använd den här exempelkoden för att konvertera VTX till XAML i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VTX-filen till XAML på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VTX till XAML Java Omvandlingskällkod" offSpacer="" %}}
