...
description: Exempel Java konverteringskod för VSSX-format till PDF-fil. Använd den här exempelkoden för att konvertera VSSX till PDF i valfri webb- eller datorbaserad applikation Java.
---
...
1. Ladda VSSX-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. PDF-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="VSSX till PDF Java Källkod för konvertering" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VSSX till PDF Conversion Live Demos" sectionDescription="[Konvertera VSSX till PDF](https://products.aspose.app/diagram/conversion/vssx-to-pdf) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
        {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" Du behöver inte ladda ned Aspose API." >}}
        {{< blocks/products/pf/agp/democard icon="fa-edit" text=" Du behöver inte skriva någon kod." >}}
        {{< blocks/products/pf/agp/democard icon="fa-file-text" text=" Ladda bara upp din VSSX-fil, den kommer omedelbart att konverteras till PDF." >}}
