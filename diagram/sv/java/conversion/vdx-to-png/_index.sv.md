...
description: Exempel Java-konverteringskod för VDX-format till PNG-fil. Använd den här exempelkoden för att konvertera VDX till PNG i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VDX-fil till PNG på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VDX-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. PNG-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="VDX till PNG Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="Livedemonstrationer för konvertering av VDX till PNG" sectionDescription="[Konvertera VDX till PNG](https://products.aspose.app/diagram/conversion/vdx-to-png) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
