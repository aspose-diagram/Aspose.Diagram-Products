...
description: Exempel på konverteringskod från Java för formatet VSTM till BMP-fil. Använd den här exempelkoden för att konvertera VSTM till BMP i valfri webb- eller datorbaserad Java-baserad applikation.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VSTM-filen till BMP på bara några rader kod.
...
{{% blocks/products/pf/agp/code-block title="VSTM till BMP Java Källkod för omvandling" offSpacer="" %}}
