---
title: Konvertera VDW till VSTM via Java 
weight: 2550
url: /sv/java/conversion/vdw-to-vstm/ 
description: Exempel Java-konverteringskod för VDW-format till VSTM-fil. Använd den här exempelkoden för att konvertera VDW till VSTM i valfri webb- eller datorbaserad applikation Java.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Konvertera VDW till VSTM via Java" h2="Exportera Microsoft Visio VDW till VSTM med hjälp av inbyggt Java-bibliotek." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="VSTM" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="DOCX" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="VDW" >}}
...
{{% blocks/products/pf/agp/content h2="Så här konverterar du VDW till VSTM med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för att konvertera VDW till VSTM via Java" %}}

{{% blocks/products/pf/agp/text %}}

 Java-utvecklare kan enkelt konvertera VDW-filer till VSTM på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VDW-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. VSTM-filen kommer att sparas på den angivna sökvägen
...
{{% blocks/products/pf/agp/code-block title="VDW till VSTM Java omvandlingskällkod" offSpacer="" %}}
...
{{< blocks/products/pf/agp/demobox sectionTitle="VDW till VSTM Conversion Live Demos" sectionDescription="[Konvertera VDW till VSTM](https://products.aspose.app/diagram/conversion/vdw-to-vstm) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
