...
description: Exempel Java-konverteringskod för VDW-format till VSSM-fil. Använd den här exempelkoden för att konvertera VDW till VSSM i valfri webb- eller datorbaserad applikation Java.
---
...
{{% blocks/products/pf/agp/text %}}
 ...
 Java-utvecklare kan enkelt konvertera VDW-fil till VSSM på bara några rader kod.

{{% /blocks/products/pf/agp/text %}}

1. Ladda VDW-fil med en instans av klassen Diagram1. Anropa Diagram.save-metoden med utdatafilsökväg och SaveFileFormat som parametrar1. VSSM-filen kommer att sparas på den angivna sökvägen
...
{{< blocks/products/pf/agp/demobox sectionTitle="VDW till VSSM Conversion Live Demos" sectionDescription="[Konvertera VDW till VSSM](https://products.aspose.app/diagram/conversion/vdw-to-vssm) just nu genom att besöka vår Live Demos-webbplats. Livedemon har följande fördelar" >}}
