---
title: Vattenstämpel VSTM dokument via Java 
weight: 3050
url: /sv/java/watermark/vstm/ 
description: Java exempelkod för att lägga till vattenstämpel i VSTM dokument i Java Runtime Environment for JSP/JSF Application and Desktop Applications.
---
{{< blocks/products/pf/main-wrap-class isAutogenPage="true" >}}
{{< blocks/products/pf/i18n/upper-banner h1="Vattenstämpel VSTM-format i Java" h2="Inbyggd VSTM dokumentvattenmärkare med hjälp av API:er på serversidan Java." logoImageSrc="https://cms.admin.containerize.com/templates/aspose/img/products/diagram/aspose_diagram-for-java.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.Diagram" subTitlepfName="for Java" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VSTM" >}}
...
{{% blocks/products/pf/agp/content h2="Hur man vattenstämplar VSTM-filer med Java" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steg för vattenmärkning av VSTM-filer i Java" %}}
