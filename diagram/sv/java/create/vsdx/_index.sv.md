---
title: Skapa VSDX filer via Java 
url: /sv/java/create-vsdx/ 
description: Java Exempelkod för att generera VSDX dokument. Använd den här koden för att skapa VSDX-filer inom en Java-baserad skrivbords- eller webbapplikation.
---
...
{{% blocks/products/pf/agp/feature-section-col title="Så här skapar du VSDX via Java" %}}
